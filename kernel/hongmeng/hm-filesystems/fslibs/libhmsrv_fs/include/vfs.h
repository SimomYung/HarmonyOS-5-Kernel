...
typedef struct {
	...
	raw_atomic_long_t pages_free;

	size_t page_metadata_size;
	raw_atomic_long_t pages_cached;
	raw_atomic_long_t pages_dirty_wb;
	raw_atomic_long_t huge_page_2m;
	raw_atomic_long_t huge_page_4m;
	raw_atomic_long_t huge_page_1g;
	raw_atomic_long_t pages_unevict;
	raw_atomic_long_t pages_free_active;
	raw_atomic_long_t pages_unmap;
	raw_atomic_long_t pages_unmap_failed;
	raw_atomic_long_t pages_isolated;
	raw_atomic_long_t workingset_refault_file;
	raw_atomic_long_t workingset_activate_file;
	raw_atomic_long_t workingset_restore_file;
	raw_atomic_long_t workingset_eviction_file;
	raw_atomic_long_t page_scanned;
	raw_atomic_long_t ashmem_total_size;  /* size that has been setted   from ioctl ASHMFD_SET_SIZE */
	raw_atomic_long_t ashmem_alloc_size;  /* size that has been alloced  from fs pagecache mapping */
	raw_atomic_long_t ashmem_free_size;   /* size that has been lrued    from ioctl ASHMFD_UNPIN */
	raw_atomic_long_t ashmem_shrink_size; /* size that has been shrinked from shrink (only for unpin) */
	raw_atomic_long_t pages_tmpfs;
	raw_atomic_long_t pages_overlayfs;
	raw_atomic_long_t pages_devfs;
	raw_atomic_long_t protect_pages_free;
	raw_atomic_long_t protect_pages_free_active;
	raw_atomic_long_t protect_overratio_reclaim_times;
	raw_atomic_long_t protect_overlimit_reclaim_times;
	raw_atomic_long_t protect_pages_reclaimed_overratio;
	raw_atomic_long_t protect_pages_reclaimed_overlimit;
	raw_atomic_long_t protect_min_fscache_pages;  /* minimum file pages when reclaim due to overratio */
} vfs_stat_fscache_t;
...
/* ksys ops */
int ksys_rename(const char *oldname, const char *newname);
...
/* ksys ops */
int ksys_lseek(int fd, int64_t offset, int whence, int64_t *pos);
...
/* ksys ops */
int ksys_ioctl(int, unsigned int, unsigned long, int);
...
int ksys_openat(int dfd, const char *filename, unsigned int flag, mode_t modes);
int ksys_close(int fd);

/* src/statfs.c */
int vfs_statfs(const char *path, struct statfs *stfs);
/* ksys ops */
int ksys_statfs(const char *path, struct statfs *stfs);
...
/* ksys ops */
ssize_t ksys_read(int fd, void *buf, size_t nbyte);
ssize_t ksys_readdir(int fd, void *buf, size_t size);
ssize_t ksys_readv(int fd, const struct iovec *vec, int vlen);
ssize_t ksys_pread(int fd, int64_t pos, void *buf, size_t nbyte);
ssize_t ksys_preadv(int fd, const struct iovec *vec, int vlen, int64_t pos);
ssize_t ksys_write(int fd, const void *buf, size_t nbyte);
ssize_t ksys_writev(int fd, const struct iovec *vec, int vlen);
ssize_t ksys_pwrite(int fd, int64_t pos, const void *buf, size_t nbyte);
ssize_t ksys_pwritev(int fd, const struct iovec *vec, int vlen, int64_t pos);
