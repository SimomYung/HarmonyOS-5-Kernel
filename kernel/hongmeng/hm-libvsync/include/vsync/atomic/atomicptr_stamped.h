 ...
 * `e_stamp`.
 */
static inline vbool_t vatomicptr_stamped_cmpxchg(vatomicptr_stamped_t *a,
						 void *e_v, vuint8_t e_stamp,
 ...
 * `e_stamp`.
 */
static inline vbool_t vatomicptr_stamped_cmpxchg_acq(vatomicptr_stamped_t *a,
						     void *e_v,
						     vuint8_t e_stamp, void *v,
						     vuint8_t stamp)
{
	void *old = NULL;
	void *exp = NULL;
 ...
 * `e_stamp`.
 */
static inline vbool_t vatomicptr_stamped_cmpxchg_rel(vatomicptr_stamped_t *a,
						     void *e_v,
						     vuint8_t e_stamp, void *v,
						     vuint8_t stamp)
{
 ...
 * `e_stamp`.
 */
static inline vbool_t vatomicptr_stamped_cmpxchg_rlx(vatomicptr_stamped_t *a,
						     void *e_v,
						     vuint8_t e_stamp, void *v,
						     vuint8_t stamp)
{
 ...
 * `e_v`.
 */
static inline vbool_t vatomicptr_stamped_attempt_stamp(vatomicptr_stamped_t *a,
						       void *e_v,
						       vuint8_t stamp)
{
	void *new_val = NULL;
 ...
 */
static inline void vatomicptr_stamped_set(vatomicptr_stamped_t *a, void *v,
					  vuint8_t stamp)
{
	ASSERT(V_ATOMICPTR_STAMPED_IS_ALIGNED(v));
 ...
 * @param stamp stamp value to set.
 */
static inline void vatomicptr_stamped_set_rel(vatomicptr_stamped_t *a, void *v,
					      vuint8_t stamp)
{
	ASSERT(V_ATOMICPTR_STAMPED_IS_ALIGNED(v));
	void *n = V_ATOMICPTR_STAMPED_COMBINE_ADDRESS_STAMP(v, stamp);
 ...
 * @param stamp stamp value to set.
 */
static inline void vatomicptr_stamped_set_rlx(vatomicptr_stamped_t *a, void *v,
					      vuint8_t stamp)
{
	ASSERT(V_ATOMICPTR_STAMPED_IS_ALIGNED(v));
	void *n = V_ATOMICPTR_STAMPED_COMBINE_ADDRESS_STAMP(v, stamp);
 ...
 */
static inline void *vatomicptr_stamped_get(vatomicptr_stamped_t *a,
					   vuint8_t *out_stamp)
{
 ...
 * @return void* address value in `a`.
 */
static inline void *vatomicptr_stamped_get_acq(vatomicptr_stamped_t *a,
					       vuint8_t *out_stamp)
{
 ...
 * @return void* address value in `a`.
 */
static inline void *vatomicptr_stamped_get_rlx(vatomicptr_stamped_t *a,
					       vuint8_t *out_stamp)
{
 ...
 */
static inline void *vatomicptr_stamped_get_pointer(vatomicptr_stamped_t *a)
{
	vuint8_t stamp = 0;
 ...
 * @return void* stored address in `a`.
 */
static inline void *vatomicptr_stamped_get_pointer_acq(vatomicptr_stamped_t *a)
{
	vuint8_t stamp = 0;
 ...
 * @return void* stored address in `a`.
 */
static inline void *vatomicptr_stamped_get_pointer_rlx(vatomicptr_stamped_t *a)
{
	vuint8_t stamp = 0;
 ...
 */
static inline vuint8_t vatomicptr_stamped_get_stamp(vatomicptr_stamped_t *a)
{
	vuint8_t stamp = 0;
 ...
 * @return stamp value in `a`.
 */
static inline vuint8_t vatomicptr_stamped_get_stamp_acq(vatomicptr_stamped_t *a)
{
	vuint8_t stamp = 0;
 ...
 * @return stamp value in `a`.
 */
static inline vuint8_t vatomicptr_stamped_get_stamp_rlx(vatomicptr_stamped_t *a)
{
	vuint8_t stamp = 0;
