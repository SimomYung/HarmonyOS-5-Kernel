...
static struct raw_rwlock ux_netdev_lock = RAW_RDLOCK_INITIALIZER;
static DLIST_HEAD(ux_netdev_list);
static struct raw_rwlock ux_devhost_lock = RAW_RDLOCK_INITIALIZER;
...
static struct raw_rwlock ux_ptype_lock = RAW_RDLOCK_INITIALIZER;
