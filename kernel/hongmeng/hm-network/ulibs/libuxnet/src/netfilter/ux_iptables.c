...
static struct raw_rwlock ipt_list_lock = RAW_RDLOCK_INITIALIZER;
static struct raw_rwlock ipt_match_list_lock = RAW_RDLOCK_INITIALIZER;
static struct raw_rwlock ipt_target_list_lock = RAW_RDLOCK_INITIALIZER;
