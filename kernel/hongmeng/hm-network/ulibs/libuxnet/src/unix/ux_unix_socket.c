			    ...
			    struct sockaddr *addr, socklen_t *addrlen, int flags)
{
	...
	if (ret == E_HM_OK) {
		// TODO how to get peer addr and here may dead lock
		pusk = usk_peer(nusk);
...
static int af_unix_getsockevent(ux_socket_t *sock, unsigned int *rcvev, unsigned int *sendev,
...
static ux_proto_ops_t usk_ops = {
	...
	.getsockevent = af_unix_getsockevent,
