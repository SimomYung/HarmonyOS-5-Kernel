...
{
	return req != NULL && req->requester_state != REQUESTER_DEFAULT && req->requester_state != REQUESTER_FROMSELF;
}
...
#define requester_frame_from_self_temp() \
	requester_frame_replace_temporarily(requester_dummy(), REQUESTER_FROMSELF)
