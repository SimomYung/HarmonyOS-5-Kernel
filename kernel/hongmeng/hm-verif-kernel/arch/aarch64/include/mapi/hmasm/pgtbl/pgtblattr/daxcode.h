...
#ifndef AARCH64_MAPI_ASM_PGTBL_PGTBLATTR_DAXCODE_H
#define AARCH64_MAPI_ASM_PGTBL_PGTBLATTR_DAXCODE_H

#include <uapi/hmasm/pgtbl/pgtblattr/daxcode.h>

#define A64_PGATTR_DAXCODE_MAPPING A64_PGTBLATTR( \
		...
		__A64_PGTBLATTR_DAXCODE_BLK1G, \
		__A64_PGTBLATTR_DAXCODE_BLK2M, \
		__A64_PGTBLATTR_DAXCODE_PAGE4K)

#define PGATTR_DAXCODE_MAPPING { \
	.a = A64_PGATTR_DAXCODE_MAPPING,\
}
...
__PGTBLATTR_MODEL_PROPERTY(DAXCODE, false, true, false, false, true, false, true, true)
