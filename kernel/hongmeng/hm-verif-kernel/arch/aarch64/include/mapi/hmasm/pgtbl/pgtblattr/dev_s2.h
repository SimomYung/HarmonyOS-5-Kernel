...
#ifndef AARCH64_MAPI_ASM_PGTBL_PGTBLATTR_DEV_S2_H
#define AARCH64_MAPI_ASM_PGTBL_PGTBLATTR_DEV_S2_H

#include <uapi/hmasm/pgtbl/pgtblattr/dev_s2.h>

#define A64_PGATTR_DEV_S2_MAPPING A64_PGTBLATTR ( \
	...
	__A64_PGTBLATTR_DEV_S2_BLK1G, \
	__A64_PGTBLATTR_DEV_S2_BLK2M, \
	__A64_PGTBLATTR_DEV_S2_PAGE4K)

#define PGATTR_DEV_S2_MAPPING { \
	.a = A64_PGATTR_DEV_S2_MAPPING \
}
...
__PGTBLATTR_MODEL_PROPERTY(DEV_S2, true, true, true, false, true, true, false, true)
