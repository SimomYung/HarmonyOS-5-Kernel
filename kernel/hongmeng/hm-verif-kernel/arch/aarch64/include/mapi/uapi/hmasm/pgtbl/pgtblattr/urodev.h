...
#ifndef AARCH64_MAPI_UAPI_ASM_PGTBL_PGTBLATTR_URODEV_H
#define AARCH64_MAPI_UAPI_ASM_PGTBL_PGTBLATTR_URODEV_H
 ...
 */
#define __A64_PGTBLATTR_URODEV_BLK1G	(__PGTBLATTR_A64BLK1G(0, 0, 1, 1, 0, 0, 0, 1, 1, \
					 __PGTBLATTR_A64LOWERBLKATTR_SH_INNER_SHAREABLE, 3, 0, \
					 __PGTBLATTR_A64LOWERBLKATTR_ATTRIDX_DEVICE_nGnRnE, 0))
#define __A64_PGTBLATTR_URODEV_BLK2M	(__PGTBLATTR_A64BLK2M(0, 0, 1, 1, 0, 0, 0, 1, 1, \
					 __PGTBLATTR_A64LOWERBLKATTR_SH_INNER_SHAREABLE, 3, 0, \
					 __PGTBLATTR_A64LOWERBLKATTR_ATTRIDX_DEVICE_nGnRnE, 0))
#define __A64_PGTBLATTR_URODEV_PAGE4K	(__PGTBLATTR_A64PAGE4K(0, 0, 1, 1, 0, 0, 1, 1, \
					 __PGTBLATTR_A64LOWERBLKATTR_SH_INNER_SHAREABLE, 3, 0, \
					 __PGTBLATTR_A64LOWERBLKATTR_ATTRIDX_DEVICE_nGnRnE, 0))
#endif
