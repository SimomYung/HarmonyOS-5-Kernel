...
JAM_INLINE void
actv_sched_sync_cpu(struct actv_s *actv);
JAM_INLINE void
...
JAM_INLINE bool
actv_sched_preempt_disabled_or_inherited(const struct actv_s *actv);
#else /* CONFIG_ATOMIC_CONTEXT_BLOCK_CHECK */
static inline bool
actv_sched_preempt_disabled_or_inherited(const struct actv_s *actv)
{
	return false;
}
#endif /* CONFIG_ATOMIC_CONTEXT_BLOCK_CHECK */
#else
static inline bool
actv_sched_need_sync(const struct actv_s *actv)
{
