...
#define THREAD_CONFIG_FLAGS_MASK_CREATE_PRE_ACTV	0x8U
/* the two bits occupied by throutine thread, see THREAD_CONFIG_FLAGS_MASK_IS_ULWT/XSTREAM */
#define THREAD_CONFIG_FLAGS_MASK_FOR_SOFTWARE_USE	0x30U
#define THREAD_CONFIG_FLAGS_MASK_IS_VFORK		0x40U

#define THREAD_CONFIG_FLAGS_MASK_IS_ULWT		0x80U
#define THREAD_CONFIG_FLAGS_MASK_IS_WORKER		0x100U
#define THREAD_CONFIG_FLAGS_MASK_IS_LSYSCALL		0x200U
#define THREAD_CONFIG_FLAGS_MASK_IS_SELFCALL		0x400U
#define THREAD_CONFIG_FLAGS_MASK_IS_HELPER		0x1000U
#define THREAD_CONFIG_FLAGS_MASK_WRITE_CRED		0x800U
#define THREAD_CONFIG_FLAGS_MASK_RESET_ON_FORK		0x2000U
#define THREAD_CONFIG_FLAGS_MASK_NEED_RESTORE_PRIO	0x4000U
#define THREAD_CONFIG_FLAGS_MASK_SERVICES_CREATE	0x8000U
...
#define thread_config_flags_is_selfcall(f)	(((f) & THREAD_CONFIG_FLAGS_MASK_IS_SELFCALL)		!= (typeof(f))0)
...
#define THREAD_LOCK_ADDR		0x40000UL
