...
#define FUTEX_MAX_HOLDER_CREFS 	(16U)

#define FUTEX_BITSET2_WR					(0x0001UL)
#define FUTEX_BITSET2_RD					(0x0002UL)
#define FUTEX_BITSET2_RWLOCK_UNBOOST_ONLY	(0x0004UL)
#define FUTEX_BITSET2_RWLOCK_PIP			(0x0008UL)

#define FUTEX_BITSET2_PIP_MASK          (FUTEX_BITSET2_RWLOCK_PIP)
/* for sys_futex_wake_ex to distinguish bitset2
 * whether it is a usage scenario of read write lock wakeup strategy,
 * because, for the convenience of expanding bitset2, each bit of bitset2 has different meanings,
 * so we need distinguish bitset2
 */
#define FUTEX_BITSET2_RWLOCK_RW_MASK    (FUTEX_BITSET2_WR | FUTEX_BITSET2_RD)
