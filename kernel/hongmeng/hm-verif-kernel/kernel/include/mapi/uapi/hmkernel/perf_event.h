...
#define __PERF_EVTCNT_ADDTIONAL_NUM	2U
...
struct __perf_event_batch_read_values_s {
	/* This two values should put before counter */
	__u64 total_time_enabled;
	__u64 total_time_running;
...
#ifdef CONFIG_AARCH64_BRBE_EL1_SUPPORT
...
#ifdef CONFIG_AARCH64_BRBE_64_ENTRY
