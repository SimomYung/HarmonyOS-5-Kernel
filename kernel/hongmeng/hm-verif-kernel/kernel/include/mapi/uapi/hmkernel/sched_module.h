...
#define __SCHED_DEADLINE_SET_CHECKPOINT_RATE 605UL
#define __SCHED_DEADLINE_GET_CHECKPOINT_RATE 606UL
...
#define SCHED_LT_FLAG_OVERUTIL_ENABLE	(1U << 12)
