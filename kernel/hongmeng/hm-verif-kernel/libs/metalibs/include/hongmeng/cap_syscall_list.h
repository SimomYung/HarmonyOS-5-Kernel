...
__SYSCALL_CAP_DEFINE1(Thread, PtraceSet, unsigned long, flags)
...
__SYSCALL_CAP_DEFINE1(Thread, CpuHwpCtrl, __u32, game_id)
...
__SYSCALL_CAP_DEFINE6(SysCtrl, PmHibernate, struct __hibernate_memory_bitmap *, orig_bm,
...
__SYSCALL_CAP_DEFINE5(SysCtrl, PmSoftwareResume, unsigned long long, pginfo_pa,
		      unsigned long long, r_pgd, unsigned long, r_enter, unsigned long *, safe_pages, int, len)
