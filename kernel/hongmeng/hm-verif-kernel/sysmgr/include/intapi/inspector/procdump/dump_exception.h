...
#endif
int dump_exception(int signum, const struct exception_info *info, bool emergency);
void dump_exception_basic(int signum, const struct exception_info *info);
int dump_exception_init(void);
#endif
