...
void memstat_cal_free_avail(uint64_t free_cache, uint64_t *free, uint64_t *avail);
 ...
 *        free pages in cache, free cache in vfs and free size of slab
 */
uint64_t memstat_free(void);
