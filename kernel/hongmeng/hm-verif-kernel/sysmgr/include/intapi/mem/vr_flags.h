...
| ONLINE         |               |                | VMALLOC_REMAP  | ACTV_CACHE | VM_JIT    | IN_COPGTBL   | WIPEONFORK |
+----------------+---------------+----------------+----------------+------------+-----------+--------------+------------+
...
| HUGETLB        | COWED         | NOCOW          | IOMAP_INIT/HHP | RAND_READ  | SEQ_READ  | backend      | backend    |
+----------------+---------------+----------------+----------------+------------+-----------+--------------+------------+
| 7              | 6             | 5              | 4              | 3          | 2         | 1            | 0          |
...
#define VR_HHP				0x00001000ULL       /* vregion that support hhp, which share the bit with VR_IOMAP_INIT */
...
#define VR_IOMAP_INIT			0x00001000ULL  /* flag for iomem, the corresponding vregion cant be released if set */
...
#define VR_HHP_PTE_RO			0x1000000000000ULL
