...
#define CLONE_IS_SELFCALL	0x04U
#define CLONE_FROM_PROCESS	0x08U
struct thread_attr {
	const char *name;
	/*
...
#define THREAD_FREEZE_SKIP		0x40000000U
...
struct thread_core_ops_s {
	...
	int (*destroy_cap)(const struct thread_s *thread);
...
#ifdef CONFIG_RESMAGR_INHERIT_FLG
#define INHERIT_MAIN_THREAD_CGROUP 1
#endif
...
#endif
#ifdef CONFIG_RESMAGR_INHERIT_FLG
    unsigned int cgroup_inherit_flg;
#endif
	uint64_t seq;
	uint64_t start_time;
