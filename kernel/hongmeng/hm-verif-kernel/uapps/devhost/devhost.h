...
static inline void backend_sec_syscall_enter(void) { backend_syscall_enter(true); }
static inline void backend_nosec_syscall_enter(void) { backend_syscall_enter(false); }
