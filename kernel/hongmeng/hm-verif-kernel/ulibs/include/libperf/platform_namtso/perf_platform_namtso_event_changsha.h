 ...
 * Description: add Namtso PMU list for changsha platform
 * Author: HISI_DRV
 * Create: Sat May 18 10:30:43 2024
 */
#ifndef LIBPERF_PLATFORM_NAMTSO_PERF_PLATFORM_NAMTSO_EVENT_CHANGSHA_H 
#define LIBPERF_PLATFORM_NAMTSO_PERF_PLATFORM_NAMTSO_EVENT_CHANGSHA_H 
