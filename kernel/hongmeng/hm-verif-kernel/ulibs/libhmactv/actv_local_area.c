...
{
	return actv_local_k.fs_info.flush_cb;
}

void hm_actv_local_set_flush_cb(__u64 flush_cb)
{
	actv_local_k.fs_info.flush_cb = flush_cb;
}

__u64 hm_actv_local_flush_stack_of(void)
{
	return actv_local_k.fs_info.flush_stack;
}

void hm_actv_local_set_flush_stack(__u64 flush_stack)
{
	actv_local_k.fs_info.flush_stack = flush_stack;
}
