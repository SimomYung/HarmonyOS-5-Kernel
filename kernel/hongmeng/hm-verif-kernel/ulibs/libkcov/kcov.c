...
{
	record_cmp_data(KCOV_CMP_SIZE(KCOV_CMP_BITS0), arg1, arg2, (__u64)__builtin_return_address(0));
}

void __sanitizer_cov_trace_cmp2(__u16 arg1, __u16 arg2)
{
	record_cmp_data(KCOV_CMP_SIZE(KCOV_CMP_BITS1), arg1, arg2, (__u64)__builtin_return_address(0));
}

void __sanitizer_cov_trace_cmp4(__u32 arg1, __u32 arg2)
{
	record_cmp_data(KCOV_CMP_SIZE(KCOV_CMP_BITS2), arg1, arg2, (__u64)__builtin_return_address(0));
}

void __sanitizer_cov_trace_cmp8(__u64 arg1, __u64 arg2)
{
	record_cmp_data(KCOV_CMP_SIZE(KCOV_CMP_BITS3), arg1, arg2, (__u64)__builtin_return_address(0));
}

void __sanitizer_cov_trace_const_cmp1(__u8 arg1, __u8 arg2)
{
	record_cmp_data(KCOV_CMP_SIZE(KCOV_CMP_BITS0) | KCOV_CMP_CONST, arg1, arg2,
			(__u64)__builtin_return_address(0));
}

void __sanitizer_cov_trace_const_cmp2(__u16 arg1, __u16 arg2)
{
	record_cmp_data(KCOV_CMP_SIZE(KCOV_CMP_BITS1) | KCOV_CMP_CONST, arg1, arg2,
			(__u64)__builtin_return_address(0));
}

void __sanitizer_cov_trace_const_cmp4(__u32 arg1, __u32 arg2)
{
	record_cmp_data(KCOV_CMP_SIZE(KCOV_CMP_BITS2) | KCOV_CMP_CONST, arg1, arg2,
			(__u64)__builtin_return_address(0));
}

void __sanitizer_cov_trace_const_cmp8(__u64 arg1, __u64 arg2)
{
	record_cmp_data(KCOV_CMP_SIZE(KCOV_CMP_BITS3) | KCOV_CMP_CONST, arg1, arg2,
			(__u64)__builtin_return_address(0));
}
