...
function(_hmsd_options dac capability encaps seharmony acl userns yama dec keyring audit skip_mod trend option)
...
function(hmsd_generate)
    cmake_parse_arguments (PARSE_ARGV 0 _gen "DAC;CAPABILITY;ENCAPS;SEHARMONY;ACL;USERNS;YAMA;DEC;KEYRING;AUDIT;SKIP_MOD" "TARGET;DIRECTORY;TREND" "FILES")

    _hmsd_all_description_files(${_gen_DIRECTORY} sd_files)
    _hmsd_options(${_gen_DAC} ${_gen_CAPABILITY} ${_gen_ENCAPS} ${_gen_SEHARMONY} ${_gen_ACL} ${_gen_USERNS} ${_gen_YAMA} ${_gen_DEC} ${_gen_KEYRING} ${_gen_AUDIT} ${_gen_SKIP_MOD} "${_gen_TREND}" hmsd_options)
