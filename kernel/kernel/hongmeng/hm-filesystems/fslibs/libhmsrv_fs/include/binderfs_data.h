...
/* If there is ACTV_BINDER_CONFIG_FILE, register as the actv binder service */
#define ACTV_BINDER_CONFIG_FILE		"/system/etc/libbinder_actv.json"
...
#define HMB_SET_IDLE_PRIORITY		_IOW('b', 6, __s32)
...
#define HMB_THREAD_RECLAIM		_IOW('b', 33, __s32)
