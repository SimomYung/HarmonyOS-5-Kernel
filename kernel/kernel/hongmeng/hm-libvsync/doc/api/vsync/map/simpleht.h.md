...
- `destroy_cb`: address of destroy callback function. Used to destroy the hashtable stored objects. 
...
> **Note:** this operation is not lock-free, if the the removal is successful. It can be super-slow. 
