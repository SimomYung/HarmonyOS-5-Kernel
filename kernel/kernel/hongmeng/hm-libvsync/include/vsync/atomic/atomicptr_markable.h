 ...
 */
static inline vbool_t vatomicptr_markable_cmpxchg(vatomicptr_markable_t *a,
						  void *e_v, vbool_t e_m,
						  void *v, vbool_t m)
{
	void *val = NULL;
	void *e = NULL;
 ...
 * address value in `a` != `e_v`, or the current mark value in `a` != `e_m`.
 */
static inline vbool_t vatomicptr_markable_cmpxchg_acq(vatomicptr_markable_t *a,
						      void *e_v, vbool_t e_m,
						      void *v, vbool_t m)
{
	void *val = NULL;
 ...
 * address value in `a` != `e_v`, or the current mark value in `a` != `e_m`.
 */
static inline vbool_t vatomicptr_markable_cmpxchg_rel(vatomicptr_markable_t *a,
						      void *e_v, vbool_t e_m,
						      void *v, vbool_t m)
{
	void *val = NULL;
 ...
 * address value in `a` != `e_v`, or the current mark value in `a` != `e_m`.
 */
static inline vbool_t vatomicptr_markable_cmpxchg_rlx(vatomicptr_markable_t *a,
						      void *e_v, vbool_t e_m,
						      void *v, vbool_t m)
{
	void *val = NULL;
 ...
 */
static inline vbool_t vatomicptr_markable_attempt_mark(vatomicptr_markable_t *a,
						       void *e_v, vbool_t m)
{
	void *new_val = NULL;
	void *ret = NULL;
 ...
 */
static inline void vatomicptr_markable_set(vatomicptr_markable_t *a, void *v,
					   vbool_t m)
{
	ASSERT(V_ATOMICPTR_MARKABLE_IS_ALIGNED(v));
 ...
 * @param m mark value to set.
 */
static inline void vatomicptr_markable_set_rel(vatomicptr_markable_t *a,
					       void *v, vbool_t m)
{
	ASSERT(V_ATOMICPTR_MARKABLE_IS_ALIGNED(v));
	void *n = V_ATOMICPTR_MARKABLE_COMBINE_ADDRESS_MARK(v, m);
 ...
 * @param m mark value to set.
 */
static inline void vatomicptr_markable_set_rlx(vatomicptr_markable_t *a,
					       void *v, vbool_t m)
{
	ASSERT(V_ATOMICPTR_MARKABLE_IS_ALIGNED(v));
	void *n = V_ATOMICPTR_MARKABLE_COMBINE_ADDRESS_MARK(v, m);
 ...
 */
static inline void *vatomicptr_markable_get(vatomicptr_markable_t *a,
					    vbool_t *out_m)
{
 ...
 * @return void* address value in `a`.
 */
static inline void *vatomicptr_markable_get_acq(vatomicptr_markable_t *a,
						vbool_t *out_m)
{
 ...
 * @return void* address value in `a`.
 */
static inline void *vatomicptr_markable_get_rlx(vatomicptr_markable_t *a,
						vbool_t *out_m)
{
 ...
 */
static inline void *vatomicptr_markable_get_pointer(vatomicptr_markable_t *a)
{
	vbool_t mark = false;
 ...
 */
static inline vbool_t vatomicptr_markable_get_mark(vatomicptr_markable_t *a)
{
	vbool_t mark = false;
 ...
 * @return true if `a` is not marked.
 */
static inline vbool_t vatomicptr_markable_get_mark_acq(vatomicptr_markable_t *a)
{
	vbool_t mark = false;
 ...
 * @return true if `a` is not marked.
 */
static inline vbool_t vatomicptr_markable_get_mark_rlx(vatomicptr_markable_t *a)
{
	vbool_t mark = false;
