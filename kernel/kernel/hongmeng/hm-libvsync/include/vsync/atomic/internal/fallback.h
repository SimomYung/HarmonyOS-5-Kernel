...
static inline void vatomic8_inc_acq(vatomic8_t *a)
{
...
static inline void vatomic16_inc_acq(vatomic16_t *a)
{
...
static inline void vatomic32_inc_acq(vatomic32_t *a)
{
...
static inline void vatomic64_inc_acq(vatomic64_t *a)
{
...
static inline void vatomicsz_inc_acq(vatomicsz_t *a)
{
...
static inline void vatomic8_sub_acq(vatomic8_t *a, vuint8_t v)
{
...
static inline void vatomic16_sub_acq(vatomic16_t *a, vuint16_t v)
{
...
static inline void vatomic32_sub_acq(vatomic32_t *a, vuint32_t v)
{
...
static inline void vatomic64_sub_acq(vatomic64_t *a, vuint64_t v)
{
...
static inline void vatomicsz_sub_acq(vatomicsz_t *a, vsize_t v)
{
...
static inline void vatomic8_dec_acq(vatomic8_t *a)
{
...
static inline void vatomic16_dec_acq(vatomic16_t *a)
{
...
static inline void vatomic32_dec_acq(vatomic32_t *a)
{
...
static inline void vatomic64_dec_acq(vatomic64_t *a)
{
...
static inline void vatomicsz_dec_acq(vatomicsz_t *a)
{
...
static inline vuint32_t vatomic32_await_neq_acq(vatomic32_t *a, vuint32_t c)
{
	vuint32_t cur = 0;
...
static inline vuint32_t vatomic32_await_neq_rlx(vatomic32_t *a, vuint32_t c)
{
	vuint32_t cur = 0;
...
static inline vuint64_t vatomic64_await_neq_acq(vatomic64_t *a, vuint64_t c)
{
	vuint64_t cur = 0;
...
static inline vuint64_t vatomic64_await_neq_rlx(vatomic64_t *a, vuint64_t c)
{
	vuint64_t cur = 0;
...
static inline void *vatomicptr_await_neq_acq(vatomicptr_t *a, void *c)
{
	void *cur = NULL;
...
static inline void *vatomicptr_await_neq_rlx(vatomicptr_t *a, void *c)
{
	void *cur = NULL;
...
static inline vuint32_t vatomic32_await_eq_acq(vatomic32_t *a, vuint32_t c)
{
	vuint32_t ret = c;
	vuint32_t o = 0;
...
static inline vuint32_t vatomic32_await_eq_rlx(vatomic32_t *a, vuint32_t c)
{
	vuint32_t ret = c;
	vuint32_t o = 0;
...
static inline vuint64_t vatomic64_await_eq_acq(vatomic64_t *a, vuint64_t c)
{
	vuint64_t ret = c;
	vuint64_t o = 0;
...
static inline vuint64_t vatomic64_await_eq_rlx(vatomic64_t *a, vuint64_t c)
{
	vuint64_t ret = c;
	vuint64_t o = 0;
...
static inline void *vatomicptr_await_eq_acq(vatomicptr_t *a, void *c)
{
	void *ret = c;
	void *o = NULL;
...
static inline void *vatomicptr_await_eq_rlx(vatomicptr_t *a, void *c)
{
	void *ret = c;
	void *o = NULL;
...
static inline V_DEPRECATED vuint32_t vatomic32_await_mask_neq(vatomic32_t *a,
							      vuint32_t m,
							      vuint32_t v)
{
	vuint32_t cur = 0;
...
static inline V_DEPRECATED vuint64_t vatomic64_await_mask_neq(vatomic64_t *a,
							      vuint64_t m,
							      vuint64_t v)
{
	vuint64_t cur = 0;
...
static inline V_DEPRECATED vuint32_t vatomic32_await_mask_eq(vatomic32_t *a,
							     vuint32_t m,
							     vuint32_t v)
{
	vuint32_t cur = 0;
...
static inline V_DEPRECATED vuint32_t vatomic32_await_mask_eq_acq(vatomic32_t *a,
								 vuint32_t m,
								 vuint32_t v)
{
	vuint32_t cur = 0;
...
static inline V_DEPRECATED vuint32_t vatomic32_await_mask_eq_rlx(vatomic32_t *a,
								 vuint32_t m,
								 vuint32_t v)
{
	vuint32_t cur = 0;
...
static inline V_DEPRECATED vuint64_t vatomic64_await_mask_eq(vatomic64_t *a,
							     vuint64_t m,
							     vuint64_t v)
{
	vuint64_t cur = 0;
...
static inline V_DEPRECATED vuint64_t vatomic64_await_mask_eq_acq(vatomic64_t *a,
								 vuint64_t m,
								 vuint64_t v)
{
	vuint64_t cur = 0;
...
static inline V_DEPRECATED vuint64_t vatomic64_await_mask_eq_rlx(vatomic64_t *a,
								 vuint64_t m,
								 vuint64_t v)
{
	vuint64_t cur = 0;
...
static inline vuint32_t vatomic32_await_le_acq(vatomic32_t *a, vuint32_t c)
{
...
static inline vuint32_t vatomic32_await_le_rlx(vatomic32_t *a, vuint32_t c)
{
...
static inline vuint32_t vatomic32_await_lt_acq(vatomic32_t *a, vuint32_t c)
{
	vuint32_t old = vatomic32_read_acq(a);
	while (!(old < c)) {
		old = vatomic32_await_neq_acq(a, old);
...
static inline vuint32_t vatomic32_await_lt_rlx(vatomic32_t *a, vuint32_t c)
{
	vuint32_t old = vatomic32_read_rlx(a);
	while (!(old < c)) {
		old = vatomic32_await_neq_rlx(a, old);
...
static inline vuint32_t vatomic32_await_ge_acq(vatomic32_t *a, vuint32_t c)
{
	vuint32_t old = vatomic32_read_acq(a);
	while (!(old >= c)) {
		old = vatomic32_await_neq_acq(a, old);
...
static inline vuint32_t vatomic32_await_ge_rlx(vatomic32_t *a, vuint32_t c)
{
	vuint32_t old = vatomic32_read_rlx(a);
	while (!(old >= c)) {
		old = vatomic32_await_neq_rlx(a, old);
...
static inline vuint32_t vatomic32_await_gt_acq(vatomic32_t *a, vuint32_t c)
{
	vuint32_t old = vatomic32_read_acq(a);
	while (!(old > c)) {
		old = vatomic32_await_neq_acq(a, old);
...
static inline vuint32_t vatomic32_await_gt_rlx(vatomic32_t *a, vuint32_t c)
{
	vuint32_t old = vatomic32_read_rlx(a);
	while (!(old > c)) {
		old = vatomic32_await_neq_rlx(a, old);
...
static inline vuint64_t vatomic64_await_le_acq(vatomic64_t *a, vuint64_t c)
{
...
static inline vuint64_t vatomic64_await_le_rlx(vatomic64_t *a, vuint64_t c)
{
...
static inline vuint64_t vatomic64_await_lt_acq(vatomic64_t *a, vuint64_t c)
{
	vuint64_t old = vatomic64_read_acq(a);
	while (!(old < c)) {
		old = vatomic64_await_neq_acq(a, old);
...
static inline vuint64_t vatomic64_await_lt_rlx(vatomic64_t *a, vuint64_t c)
{
	vuint64_t old = vatomic64_read_rlx(a);
	while (!(old < c)) {
		old = vatomic64_await_neq_rlx(a, old);
...
static inline vuint64_t vatomic64_await_ge_acq(vatomic64_t *a, vuint64_t c)
{
	vuint64_t old = vatomic64_read_acq(a);
	while (!(old >= c)) {
		old = vatomic64_await_neq_acq(a, old);
...
static inline vuint64_t vatomic64_await_ge_rlx(vatomic64_t *a, vuint64_t c)
{
	vuint64_t old = vatomic64_read_rlx(a);
	while (!(old >= c)) {
		old = vatomic64_await_neq_rlx(a, old);
...
static inline vuint64_t vatomic64_await_gt_acq(vatomic64_t *a, vuint64_t c)
{
	vuint64_t old = vatomic64_read_acq(a);
	while (!(old > c)) {
		old = vatomic64_await_neq_acq(a, old);
...
static inline vuint64_t vatomic64_await_gt_rlx(vatomic64_t *a, vuint64_t c)
{
	vuint64_t old = vatomic64_read_rlx(a);
	while (!(old > c)) {
		old = vatomic64_await_neq_rlx(a, old);
