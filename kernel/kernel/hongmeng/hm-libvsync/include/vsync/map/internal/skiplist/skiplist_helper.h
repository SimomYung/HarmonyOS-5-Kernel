...
static inline vsize_t _vskiplist_seed_get(vskiplist_seed_t *skip_seed)
{
...
static inline void _vskiplist_seed_set(vskiplist_seed_t *skip_seed,
				       vsize_t seed)
{
#if defined(VSYNC_VERIFICATION)
	(void)skip_seed;
...
static inline void _vskiplist_seed_init(vskiplist_seed_t *skip_seed,
					vsize_t rand_seed, vsize_t max_height)
{
 ...
 */
static inline vsize_t _vskiplist_get_rand_height(vskiplist_seed_t *skip_seed)
{
	vsize_t level = 1;
