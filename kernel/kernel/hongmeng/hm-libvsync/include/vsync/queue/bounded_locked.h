 ...
 * Create: Mon 14 Sep 2020 04:07:14 PM CEST
 */
 ...
 */
static inline void bounded_locked_init(bounded_locked_t *q, void **b,
				       vuint32_t s)
{
 ...
 */
static inline bounded_ret_t bounded_locked_enq(bounded_locked_t *q, void *v)
{
	ASSERT(q && "q == NULL");
	ASSERT(v && "v == NULL");
 ...
 */
static inline bounded_ret_t bounded_locked_deq(bounded_locked_t *q, void **v)
{
	ASSERT(q && "q == NULL");
	ASSERT(v && "v == NULL");
 ...
 */
static inline vbool_t bounded_locked_empty(bounded_locked_t *q)
{
	ASSERT(q && "q == NULL");
