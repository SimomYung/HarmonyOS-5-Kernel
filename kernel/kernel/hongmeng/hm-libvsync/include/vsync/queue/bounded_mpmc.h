 ...
 * Create: Wed Feb 17 10:43:51 CET 2021
 */
 ...
 */
static inline void bounded_mpmc_init(bounded_mpmc_t *q, void **b, vuint32_t s)
{
 ...
 * again.
 */
static inline bounded_ret_t bounded_mpmc_enq(bounded_mpmc_t *q, void *v)
{
	vuint32_t curr, next;
 ...
 * again.
 */
static inline bounded_ret_t bounded_mpmc_deq(bounded_mpmc_t *q, void **v)
{
	vuint32_t curr, next;
