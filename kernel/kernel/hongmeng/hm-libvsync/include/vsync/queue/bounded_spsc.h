 ...
 * Create: Mon 14 Sep 2020 04:00:32 PM CEST
 */
 ...
 */
static inline void bounded_spsc_init(bounded_spsc_t *q, void **b, vuint32_t s)
{
 ...
 */
static inline bounded_ret_t bounded_spsc_enq(bounded_spsc_t *q, void *v)
{
	ASSERT(q && "q == NULL");
	ASSERT(v && "v == NULL");
 ...
 */
static inline bounded_ret_t bounded_spsc_deq(bounded_spsc_t *q, void **v)
{
	ASSERT(q && "q == NULL");
	ASSERT(v && "v == NULL");
