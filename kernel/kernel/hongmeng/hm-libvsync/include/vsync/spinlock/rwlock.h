 ...
 * @param l address of rwlock_t object.
 */
static inline void rwlock_write_acquire(rwlock_t *l)
{
 ...
 */
static inline vbool_t rwlock_write_tryacquire(rwlock_t *l)
{
 ...
 * @param l address of rwlock_t object.
 */
static inline void rwlock_write_release(rwlock_t *l)
{
 ...
 * @param l address of rwlock_t object.
 */
static inline void rwlock_read_acquire(rwlock_t *l)
{
 ...
 * @return false, if failed to acquire the lock.
 */
static inline vbool_t rwlock_read_tryacquire(rwlock_t *l)
{
 ...
 * @param l address of rwlock_t object.
 */
static inline void rwlock_read_release(rwlock_t *l)
{
 ...
 */
static inline vbool_t rwlock_acquired_by_writer(rwlock_t *l)
{
 ...
 */
static inline vbool_t rwlock_acquired_by_readers(rwlock_t *l)
{
