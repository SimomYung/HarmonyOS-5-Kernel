 ...
 */
static inline void semaphore_init(semaphore_t *s, vuint32_t n)
{
 ...
 */
static inline void semaphore_acquire(semaphore_t *s, vuint32_t i)
{
 ...
 */
static inline vbool_t semaphore_tryacquire(semaphore_t *s, vuint32_t i)
{
 ...
 */
static inline void semaphore_release(semaphore_t *s, vuint32_t i)
{
