 ...
 * Create: Tue Jun 15 09:52:59 CEST 2021
 */
 ...
 */
static inline void seqcount_init(seqcount_t *sc)
{
	vatomic32_init(sc, 0);
}
/**
 ...
 */
static inline seqvalue_t seqcount_wbegin(seqcount_t *sc)
{
 ...
 */
static inline void seqcount_wend(seqcount_t *sc, seqvalue_t s)
{
 ...
 * @return sequence value.
 */
static inline seqvalue_t seqcount_rbegin(seqcount_t *sc)
{
 ...
 * repeat the CS.
 */
static inline vbool_t seqcount_rend(seqcount_t *sc, seqvalue_t s)
{
	vatomic_fence_acq();
