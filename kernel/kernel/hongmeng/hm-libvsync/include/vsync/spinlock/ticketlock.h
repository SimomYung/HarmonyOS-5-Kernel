 ...
 */
static inline vbool_t ticketlock_tryacquire(ticketlock_t *l)
{
 ...
 */
static inline vbool_t ticketlock_has_waiters(ticketlock_t *l)
{
	return (vatomic32_read_rlx(&l->next) - vatomic32_read_rlx(&l->owner)) >
	       1;
}
#endif
