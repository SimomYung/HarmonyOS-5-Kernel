 ...
 */
static inline void ttaslock_init(ttaslock_t *l)
{
 ...
 * @param l address of ttaslock_t object.
 */
static inline void ttaslock_acquire(ttaslock_t *l)
{
	while (true) {
 ...
 */
static inline vbool_t ttaslock_tryacquire(ttaslock_t *l)
{
 ...
 * @param l address of ttaslock_t object.
 */
static inline void ttaslock_release(ttaslock_t *l)
{
