 ...
 */
static inline void range_policy_record_init(range_policy_t *policy,
					    vuint32_t max)
{
	ASSERT(policy);
	policy->range = max;
 ...
 */
static inline vuint32_t range_policy_get_range(range_policy_t *policy)
{
	ASSERT(policy);
	return policy->range;
}
 ...
 * @param policy address of `range_policy_t` object
 */
static inline void range_policy_record_success(range_policy_t *policy)
{
	ASSERT(policy);
 ...
 * @param policy address of `range_policy_t` object
 */
static inline void range_policy_record_fail(range_policy_t *policy)
{
	ASSERT(policy);
