 ...
 */
static inline void quack_init(quack_t *s)
{
 ...
 */
static inline void quack_push(quack_t *q, quack_node_t *n)
{
 ...
 */
static inline vbool_t quack_is_empty(quack_t *const q)
{
 ...
 */
static inline quack_node_t *quack_popall(quack_t *q)
{
 ...
 */
static inline quack_node_t *quack_reverse(quack_node_t *n)
{
