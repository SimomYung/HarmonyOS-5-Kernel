 ...
 * Create: Wed Feb 17 10:30:38 CET 2021
 */
#ifndef XBO_H
#define XBO_H
/*******************************************************************************
 ...
 */
static inline void xbo_init(xbo_t *xbo, vuint32_t min, vuint32_t max,
			    vuint32_t factor)
{
 ...
 */
static inline void xbo_backoff(xbo_t *xbo, xbo_cb *nop, xbo_cb *cb)
{
#ifndef VSYNC_VERIFICATION
 ...
 * @param xbo exponential backoff datastructure
 */
static inline void xbo_reset(xbo_t *xbo)
{
#ifndef VSYNC_VERIFICATION
	xbo->value = xbo->min;
#endif
...
static inline int xbo_nop(void)
{
	volatile int k = 0;
	return k;
}
