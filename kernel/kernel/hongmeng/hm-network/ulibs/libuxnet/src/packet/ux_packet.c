...
STATIC_DEFINE_RAW_RWLOCK(ux_packet_lock);
...
static int ux_packet_getsockevent(ux_sock_t *sk, unsigned int *rcvev, unsigned int *sendev, unsigned int *errev)
{
...
static ux_packet_sock_t *ux_packet_sock_alloc_and_init(ux_socket_t *sock, int domain, int type, int protocol)
{
	...
	pktsk->sk.getsockevent = ux_packet_getsockevent;
