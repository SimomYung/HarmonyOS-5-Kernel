...
/* when load policy with SEC_SERVICE_ALL means not split policy,
 * because services from sysmgr to keymgr not contain all class,
 * so define SEC_SERVICE_ALL as 0x80 instead of ((1 << SEC_SERVICE_NUM) - 1).
 */
#define SEC_SERVICE_ALL (0x80)
#define SEC_SERVICE_NUM (8u)
