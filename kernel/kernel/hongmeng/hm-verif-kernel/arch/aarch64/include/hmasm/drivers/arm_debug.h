...
#define DEBUG_REG_WRITE_CASE_WCR_KDP(idx)			\
	case idx:						\
	({							\
		kdp_wcr##idx##_disable();			\
	});							\
	break
...
#define DEBUG_REG_WRITE_CASE_WCR(DBGREG, idx, val)	DEBUG_REG_WRITE_CASE_WCR_KDP(idx)
