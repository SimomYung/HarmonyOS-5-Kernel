...
static inline void arch_kexception_init_stack(__maybe_unused unsigned int cpu) {}

extern __noreturn void
restore_regs_to_el1h(const struct arch_regs *regs);
...
extern void
__arch_dump_registers(const struct arch_regs *regs, bool is_panic, const char *prompt);
...
extern void __noreturn
arch_handle_data_fault(struct arch_uctx *uctx, struct arch_cpu_local_s *cpu_local,
		       u64 esr);

extern void __noreturn
arch_handle_instruction_fault(struct arch_uctx *uctx, struct arch_cpu_local_s *cpu_local);

extern void __noreturn
arch_handle_debug_fault(struct arch_uctx *uctx, struct arch_cpu_local_s *cpu_local);

extern void __noreturn
arch_handle_single_step_fault(struct arch_uctx *uctx, struct arch_cpu_local_s *cpu_local);

extern void __noreturn
arch_handle_wp_fault(struct arch_uctx *uctx, struct arch_cpu_local_s *cpu_local);

extern void __noreturn
arch_handle_bp_fault(struct arch_uctx *uctx, struct arch_cpu_local_s *cpu_local);

extern void __noreturn
arch_handle_und_ins_fault(struct arch_uctx *uctx, struct arch_cpu_local_s *cpu_local);

extern void __noreturn
arch_handle_pac_fault(struct arch_uctx *uctx, struct arch_cpu_local_s *cpu_local);
