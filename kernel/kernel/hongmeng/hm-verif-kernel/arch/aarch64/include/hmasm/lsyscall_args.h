...
#define STK_BUF_NR_OPEN_BY_HANDLE_AT 0u
#define STK_BUF_NR_OPEN_BY_HANDLE_AT_COMPAT 3u
int arch_open_by_handle_at_native_xfer_hook(bool fastpath, struct actv_s *caller, struct actv_s *callee);
...
int arch_open_by_handle_at_compat_xfer_hook(bool fastpath, struct actv_s *caller, struct actv_s *callee);
