...
#ifndef AARCH64_MAPI_ASM_PGTBL_PGTBLATTR_KCODE_H
#define AARCH64_MAPI_ASM_PGTBL_PGTBLATTR_KCODE_H

#include <uapi/hmasm/pgtbl/pgtblattr/kcode.h>

#define A64_PGATTR_KCODE_MAPPING A64_PGTBLATTR ( \
...
#define PGATTR_KCODE_MAPPING { \
	.a = A64_PGATTR_KCODE_MAPPING \
}
...
__PGTBLATTR_MODEL_PROPERTY(KCODE, false, true, false, true, false, false, false, false)
