...
#ifndef AARCH64_MAPI_ASM_PGTBL_PGTBLATTR_UNCDATA_H
#define AARCH64_MAPI_ASM_PGTBL_PGTBLATTR_UNCDATA_H

#include <uapi/hmasm/pgtbl/pgtblattr/uncdata.h>

#define A64_PGATTR_UNCDATA_MAPPING A64_PGTBLATTR ( \
...
#define PGATTR_UNCDATA_MAPPING { \
	.a = A64_PGATTR_UNCDATA_MAPPING \
}
...
__PGTBLATTR_MODEL_PROPERTY(UNCDATA, false, true, true, false, true, true, false, false)
