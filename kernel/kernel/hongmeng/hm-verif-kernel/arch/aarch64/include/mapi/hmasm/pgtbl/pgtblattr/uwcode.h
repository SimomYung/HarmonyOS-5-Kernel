...
#ifndef AARCH64_MAPI_ASM_PGTBL_PGTBLATTR_UWCODE_H
#define AARCH64_MAPI_ASM_PGTBL_PGTBLATTR_UWCODE_H

#include <uapi/hmasm/pgtbl/pgtblattr/uwcode.h>

#define A64_PGATTR_UWCODE_MAPPING A64_PGTBLATTR ( \
...
#define PGATTR_UWCODE_MAPPING { \
	.a = A64_PGATTR_UWCODE_MAPPING \
}
...
__PGTBLATTR_MODEL_PROPERTY(UWCODE, false, true, true, false, true, true, true, false)
