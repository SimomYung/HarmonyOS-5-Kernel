 ...
 * Description: Page table attribute for kcode
 * Author: Huawei OS Kernel Lab
 * Created: Tue Jan 25 2022
 */

#ifndef AARCH64_MAPI_UAPI_ASM_PGTBL_PGTBLATTR_KCODE_H
#define AARCH64_MAPI_UAPI_ASM_PGTBL_PGTBLATTR_KCODE_H
 ...
 * when XN = 1, PXN = 0, AP21 = 2, access permission is RE, executable for privilege els.
 */
#define __A64_PGTBLATTR_KCODE_BLK1G (__PGTBLATTR_A64BLK1G(0, 0, 1, 0, 0, 0, 0, 0, 1, \
				     __PGTBLATTR_A64LOWERBLKATTR_SH_INNER_SHAREABLE, 2, 0, \
				     __PGTBLATTR_A64LOWERBLKATTR_ATTRIDX_NORMAL, 0))
#define __A64_PGTBLATTR_KCODE_BLK2M (__PGTBLATTR_A64BLK2M(0, 0, 1, 0, 0, 0, 0, 0, 1, \
				     __PGTBLATTR_A64LOWERBLKATTR_SH_INNER_SHAREABLE, 2, 0, \
				     __PGTBLATTR_A64LOWERBLKATTR_ATTRIDX_NORMAL, 0))
#define __A64_PGTBLATTR_KCODE_PAGE4K (__PGTBLATTR_A64PAGE4K(0, 0, 1, 0, 0, 0, 0, 1, \
				     __PGTBLATTR_A64LOWERBLKATTR_SH_INNER_SHAREABLE, 2, 0, \
				     __PGTBLATTR_A64LOWERBLKATTR_ATTRIDX_NORMAL, 0))
