...
static __pgtblhdlr_inline __bool
__pgtblhdlr_rawfmt_a64s2ttbrreg_is_valid(const struct __pgtblhdlr_rawucfg_a64s2_s *cfg,
					 const struct __pgtblhdlr_rawfmt_a64s2ttbrreg_s *raw)
{
	return ____IS(raw->v);
}
...
static __pgtblhdlr_inline __bool
__pgtblhdlr_rawfmt_a64s2pgentry_is_valid(const struct __pgtblhdlr_rawucfg_a64s2_s *cfg,
					 const struct __pgtblhdlr_rawfmt_a64s2pgentry_s *raw)
{
