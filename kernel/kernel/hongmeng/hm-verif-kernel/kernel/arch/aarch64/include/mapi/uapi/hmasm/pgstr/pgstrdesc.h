...
{ \
	return ____IS((raw->u.rawv & (t)(__UL(__A64_PGSTR_MARK_MASK))) != (t)(__UL(__A64_PGSTR_MARK_NONE))); \
} \
static __pgtblhdlr_inline __bool \
...
#define __pgtblhdlr_rawfmt_a64pgstr_top_is_valid(c, r)		____pgtblhdlr_rawfmt_a64pgstr_top_is_valid((r))
#define __pgtblhdlr_rawfmt_a64pgstr_top_is_zero(c, r)		____pgtblhdlr_rawfmt_a64pgstr_top_is_zero((r))
#define __pgtblhdlr_rawfmt_a64pgstr_mid_is_valid(c, r)  	____pgtblhdlr_rawfmt_a64pgstr_mid_is_valid((r))
#define __pgtblhdlr_rawfmt_a64pgstr_mid_is_zero(c, r)		____pgtblhdlr_rawfmt_a64pgstr_mid_is_zero((r))
#define __pgtblhdlr_rawfmt_a64pgstr_p4k_is_valid(c, r)		____pgtblhdlr_rawfmt_a64pgstr_p4k_is_valid((r))
