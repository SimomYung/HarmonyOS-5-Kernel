...
#ifndef AARCH64_MAPI_UAPI_ASM_PGTBL_PGTBLATTR_UDEV_H
#define AARCH64_MAPI_UAPI_ASM_PGTBL_PGTBLATTR_UDEV_H
 ...
 */
#define __A64_PGTBLATTR_UDEV_BLK1G	(__PGTBLATTR_A64BLK1G(0, 0, 1, 1, 0, 0, 0, 1, 1, \
					 __PGTBLATTR_A64LOWERBLKATTR_SH_INNER_SHAREABLE, 1, 0, \
					 __PGTBLATTR_A64LOWERBLKATTR_ATTRIDX_DEVICE_nGnRnE, 0))
#define __A64_PGTBLATTR_UDEV_BLK2M	(__PGTBLATTR_A64BLK2M(0, 0, 1, 1, 0, 0, 0, 1, 1, \
					 __PGTBLATTR_A64LOWERBLKATTR_SH_INNER_SHAREABLE, 1, 0, \
					 __PGTBLATTR_A64LOWERBLKATTR_ATTRIDX_DEVICE_nGnRnE, 0))
#define __A64_PGTBLATTR_UDEV_PAGE4K	(__PGTBLATTR_A64PAGE4K(0, 0, 1, 1, 0, 0, 1, 1, \
					 __PGTBLATTR_A64LOWERBLKATTR_SH_INNER_SHAREABLE, 1, 0, \
					 __PGTBLATTR_A64LOWERBLKATTR_ATTRIDX_DEVICE_nGnRnE, 0))
#endif
