...
#ifndef AARCH64_MAPI_UAPI_ASM_PGTBL_PGTBLATTR_UNCRODATA_H
#define AARCH64_MAPI_UAPI_ASM_PGTBL_PGTBLATTR_UNCRODATA_H
 ...
 * when XN = 1, PXN = 1, AP21 = 3, access permission is R, not executable for all els.
 */
#define __A64_PGTBLATTR_UNCRODATA_BLK1G (__PGTBLATTR_A64BLK1G(0, 0, 1, 1, 0, 0, 0, 1, 1, \
					 __PGTBLATTR_A64LOWERBLKATTR_SH_INNER_SHAREABLE, 3, 0, \
					 __PGTBLATTR_A64LOWERBLKATTR_ATTRIDX_NORMAL_NC, 0))
#define __A64_PGTBLATTR_UNCRODATA_BLK2M (__PGTBLATTR_A64BLK2M(0, 0, 1, 1, 0, 0, 0, 1, 1, \
					 __PGTBLATTR_A64LOWERBLKATTR_SH_INNER_SHAREABLE, 3, 0, \
					 __PGTBLATTR_A64LOWERBLKATTR_ATTRIDX_NORMAL_NC, 0))
#define __A64_PGTBLATTR_UNCRODATA_PAGE4K (__PGTBLATTR_A64PAGE4K(0, 0, 1, 1, 0, 0, 1, 1, \
					  __PGTBLATTR_A64LOWERBLKATTR_SH_INNER_SHAREABLE, 3, 0, \
					  __PGTBLATTR_A64LOWERBLKATTR_ATTRIDX_NORMAL_NC, 0))
