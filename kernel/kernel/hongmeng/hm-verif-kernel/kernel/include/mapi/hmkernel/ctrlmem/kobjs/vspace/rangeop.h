...
#define __ctrlmem_kobj_vspace_rangeop_unmap_urecord_mkparec(_pa, _is_present, _is_fragile, _order)	\
	(((_pa) | ((_is_present) ? __CTRLMEM_KOBJ_VSPACE_RANGEOP_UNMAP_URECORD_PAREC_PRESENT : (__u64)(0UL))) \
		...
		| ((_is_present) ? ((__u64)(_order) << __CTRLMEM_KOBJ_VSPACE_RANGEOP_UNMAP_URECORD_PAREC_SHIFT_P) : \
				(__u64)(0ULL)))

#define __ctrlmem_kobj_vspace_rangeop_unmap_urecord_mkvarec(_va, _n)	\
	(((_va) & __CTRLMEM_KOBJ_VSPACE_RANGEOP_UNMAP_URECORD_VAREC_MASK) | \
	 ((_n) & __CTRLMEM_KOBJ_VSPACE_RANGEOP_UNMAP_URECORD_VAREC_N))
