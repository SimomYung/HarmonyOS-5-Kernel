...
lock_order(36, cnode, vm, vcpu, driver, fdtable, vspace, kvspace, pmem, cspace, pages, irq, \
...
lock_order(26, vnotify, vm, vcpu, futex, vspace, kvspace, irq, driver, timekeep, \
...
lock_order(11, lt, deadline, timekeep, kev, kconsole, timer, isolate, hmpsf, curr_actv, perf_tp_events, irq, sched_avg)
...
lock_order(3, curr_actv, kconsole, timekeep, kev)
lock_order(0, actv_binder, NULL)
lock_order(10, vm, vcpu, actv_pool, sched, futex, cpuctx, timer, irq, kconsole, kev, timekeep)
lock_order(10, vcpu, actv_pool, sched, futex, cpuctx, timer, irq, kconsole, kev, timekeep, curr_actv)
