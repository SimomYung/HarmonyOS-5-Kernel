...
static inline bool lock_trace_check_hold_lock(__maybe_unused unsigned int curr_cpu) { return false; }
static inline bool lock_trace_check_curr_lock(__maybe_unused unsigned int curr_cpu,
						__maybe_unused unsigned int lock_type) {return false; }
static inline void lock_trace_check(__maybe_unused unsigned int curr_cpu) { }
