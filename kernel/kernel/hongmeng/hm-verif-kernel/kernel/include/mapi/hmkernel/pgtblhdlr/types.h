...
static __pgtblhdlr_inline void __PGTBLHDLR_NAMING_LOWERCASE(pgentry_zero)
	(const struct ____PGCONFIG *cfg, enum ____PGENTRY_TYPE t, struct ____PGENTRY e)
{
	switch (t) {
#define PGTBLHDLR_RAWCFG(raw)
#define PGTBLHDLR_RAWFMT(raw)
...
static inline __always_inline bool
pgentry_is_valid(struct pgentry_type_s type, const struct pgcfg_s *cfg, struct pgentry_s e)
{
	return __pgtblhdlr_pgentry_is_valid(type.t, container_of(&cfg->c.cfg.ucfg,
...
static inline __always_inline bool
pgentry_val_is_fragile(struct pgentry_type_s type, const struct pgcfg_s *cfg, __pgtblhdlr_rawfmt_base_t v)
{
	return false;
}

static inline __always_inline paddr_t
pgentry_is_fragile(struct pgentry_type_s type, const struct pgcfg_s *cfg, struct pgentry_s e) \
{
	return false;
}

static inline __always_inline __pgtblhdlr_rawfmt_base_t
pgentry_val_set_fragile(struct pgentry_type_s type, const struct pgcfg_s *cfg, __pgtblhdlr_rawfmt_base_t v)
{
	return v;
}

static inline __always_inline __pgtblhdlr_rawfmt_base_t
pgentry_val_set_nofragile(struct pgentry_type_s type, const struct pgcfg_s *cfg, __pgtblhdlr_rawfmt_base_t v)
{
	return v;
}
