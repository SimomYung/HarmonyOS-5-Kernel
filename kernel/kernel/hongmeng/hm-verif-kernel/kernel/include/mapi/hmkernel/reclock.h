...
static inline void __rec_spinlock_init(struct rec_spinlock_s *lock, __maybe_unused unsigned int lock_type)
{
...
static inline bool __rec_spinlock_trylock(struct rec_spinlock_s *lock, unsigned int ownerid,
					__maybe_unused bool need_trace)
{
#ifdef CONFIG_REC_SPINLOCK_WFE
