...
#define COOKIE_PIN_TIMEOUT_US 200U
#define WAIT_PREFER_COOKIE_MATCH_TIMEOUT_US 4000U
struct core_sched_s {
...
bool smt_expeller_trans_check(struct tcb_s *src_tcb, struct tcb_s *des_tcb,
			      bool restore, enum sched_trans_method method);
bool smt_expeller_trans(struct tcb_s *src_tcb, struct tcb_s *des_tcb,
			bool restore, enum sched_trans_method method);
#endif
...
#ifdef CONFIG_HM_SCHED_TRANS
static inline bool
smt_expeller_trans_check(struct tcb_s *src_tcb, struct tcb_s *des_tcb,
			 bool restore, enum sched_trans_method method)
{
...
static inline bool
smt_expeller_trans(struct tcb_s *src_tcb, struct tcb_s *des_tcb,
		   bool restore, enum sched_trans_method method)
{
	UNUSED(src_tcb, des_tcb, restore, method);
	return false;
