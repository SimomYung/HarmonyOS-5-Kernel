...
#endif
extern int
tcb_tid_of(struct tcb_s *tcb);
extern int
tcb_pid_of(struct tcb_s *tcb);
extern unsigned int
...
extern bool double_tcb_trylock(struct tcb_s *src_tcb, struct tcb_s *des_tcb);
...
/* Lock/unlock the tcb and the sched tcb of it */
extern void sched_tcb_lock(struct tcb_s *tcb, struct tcb_s **p_sched_tcb);
extern void sched_tcb_unlock(struct tcb_s *tcb, struct tcb_s *sched_tcb);
