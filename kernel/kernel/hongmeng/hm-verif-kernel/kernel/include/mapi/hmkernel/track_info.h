...
#define TRACK_INFO_SMP_CALL_SEND    	0
#define TRACK_INFO_SMP_CALL_RECV_ENTRY	1
#define TRACK_INFO_SMP_CALL_RECV_EXIT	2
...
#include <hmkernel/track_info/track_info_list.h>
#undef DEFINE_TRACK_INFO
#undef TRACK_INFO_CALL_GEN
#undef TRACK_INFO_PROTO_GEN
