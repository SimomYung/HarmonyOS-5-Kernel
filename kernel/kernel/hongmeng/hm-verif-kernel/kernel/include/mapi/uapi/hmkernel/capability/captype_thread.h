...
#define THREAD_AMU_INFO_SIZE	64
...
#define THREAD_STAT_REAL_R0		0x800UL
...
#define THREAD_STAT_AMU			0x80000UL
#define THREAD_LOCK_ADDR		0x200000UL
...
struct sysarg_thread_stat {
	...
	__u8 tcb_amu_info[THREAD_AMU_INFO_SIZE];
	/*
