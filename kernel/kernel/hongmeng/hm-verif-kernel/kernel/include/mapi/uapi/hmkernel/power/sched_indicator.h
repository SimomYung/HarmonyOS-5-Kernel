...
enum {
	...
	FREQ_STAT_MAX_UTIL		= (1 << 7)
};
#define DEFAULT_REPORTING_POLICY \
	(FREQ_STAT_CPU_LOAD | FREQ_STAT_TOP_TASK | FREQ_STAT_MAX_UTIL)
...
struct __sched_ind_cluster_data {
	...
	__bool is_mips_mem_update[DFC_MEM_TYPE_NUM]; /* for mips mem */
...
#define __SCHED_IND_CMD_FREQ_PID 0xF10U
#define __SCHED_IND_CMD_SPEED_PID 0xF11U
#define __SCHED_IND_CMD_PID_CONTROL_ENABLE 0xF12U
#define __SCHED_IND_CMD_PID_CONTROL_TARGET_LOAD 0xF13U
