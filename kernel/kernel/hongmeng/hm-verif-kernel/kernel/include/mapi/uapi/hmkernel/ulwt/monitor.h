...
enum {
	...
	SILK_NATIVE_OPS_MMAP,
	SILK_NATIVE_OPS_RT_SIGTIMEDWAIT,
	SILK_NATIVE_OPS_RT_SIGSUSPEND,
	SILK_NATIVE_OPS_TKILL,
	SILK_NATIVE_OPS_FUTEX,
	SILK_NATIVE_OPS_EXECVE,
