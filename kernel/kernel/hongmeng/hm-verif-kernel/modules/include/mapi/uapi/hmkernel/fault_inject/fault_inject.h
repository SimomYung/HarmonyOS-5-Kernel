...
enum __fault_inject_pri_access_type {
	...
	__FAULT_INJECT_PRI_ACCESS_E0PD1,
...
#ifdef CONFIG_PACXO
	__FAULT_INJECT_PACXO_XOM_READ,
	__FAULT_INJECT_PACXO_XOM_WRITE,
	__FAULT_INJECT_PACXO_USER_KEY,
	__FAULT_INJECT_PACXO_KERNEL_KEY,
#endif
#ifdef CONFIG_DICP
	__FAULT_INJECT_DICP_USER_KEY,
	__FAULT_INJECT_DICP_USER_KEY_MODIFY,
	__FAULT_INJECT_DICP_RANDOM_SEED,
	__FAULT_INJECT_DICP_RANDOM_SEED_MODIFY,
#endif
	__FAULT_INJECT_PAC_CFI_FUNC_TABLE,
	__FAULT_INJECT_PAC_UNKNOWN,
};

enum __fault_inject_sec_region_type {
	__FAULT_INJECT_SEC_REGION_KERNEL_IMG_PGTBL_RO = 0,
	__FAULT_INJECT_SEC_REGION_KERNEL_KDEV_PGTBL_RO,
	__FAULT_INJECT_SEC_REGION_KERNEL_PAGES_PGTBL_RO,
	__FAULT_INJECT_SEC_REGION_KERNEL_KSTACK_PGTBL_RO,
	__FAULT_INJECT_SEC_REGION_KERNEL_CTRLMEM_PGTBL_RO,
	__FAULT_INJECT_SEC_REGION_KERNEL_CODE,
...
enum __fault_inject_kdp_type {
	...
	__FAULT_INJECT_KDP_DTB_RO,
	__FAULT_INJECT_KDP_DATA_INVISIBLE,
	__FAULT_INJECT_KDP_MAP_DTB,
	__FAULT_INJECT_KDP_WRITE_KCODE,
	__FAULT_INJECT_KDP_WRITE_KDATA,
	__FAULT_INJECT_KDP_WRITE_KSTACK,
	__FAULT_INJECT_KDP_WRITE_SYSCONF,
	__FAULT_INJECT_KDP_WRITE_PADDR,
	__FAULT_INJECT_KDP_UNKNOWN,
};

enum __fault_inject_hkip_type {
	__FAULT_INJECT_HKIP_SMC_FILTER = 0,
	__FAULT_INJECT_HKIP_UNKNOWN,
};
