...
extern struct __ctrlmem_kobj_vspace_s *ctrlmem_kobj_vspace_spawn_for_copgtable(void *pages_linear_va,
							  struct __ctrlmem_kobj_pcache_s *pcache,
							  struct __ctrlmem_kobj_vspace_s *main_kobjvs);
extern int kobjvs_copgtable_pgdbuilder_init(struct kobjvs_pgdbuilder_s *pgdbuilder,
				  const struct process_s *process);
#endif
#endif
