...
__paddr_t ctrlmem_sysconf_klayout_hibernate_info_addr(void);
...
extern int ctrlmem_sysconf_track_info_set(bool pause);
extern int ctrlmem_sysconf_write_exception(__u32 reason, __u32 exception_cnode_idx, __u64 exception_pc);

extern int ctrlmem_exp_table_init(struct sysmgr_except_table *extable);
extern int ctrlmem_exp_table_fixup_nopf(bool *need_pagefault);
extern int ctrlmem_exp_table_fixup_pf(void);
