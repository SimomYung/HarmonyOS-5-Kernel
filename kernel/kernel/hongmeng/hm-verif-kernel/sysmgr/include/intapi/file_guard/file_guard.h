...
void fg_report_usb_audit(effective_block_rule_t *block_rule_data, const char *usb_fname);
...
int lookup_effective_block_rule(pid_t pid, uint32_t mask, effective_block_rule_t *block_rule);

fg_file_type_t fs_match_tag_policy_rules(const char *tag_name);
