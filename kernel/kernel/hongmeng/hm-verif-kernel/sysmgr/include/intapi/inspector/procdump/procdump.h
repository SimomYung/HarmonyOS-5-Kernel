...
{
	dp_printf(impl, "Release: %s  ulibs version: %d fs version: %d  actv version: %d\n\
		  mem version: %d  affinity version: %d  actv signal version: %d\n",
		  HMKERNEL_RELEASE, VERSION_ULIBS, VERSION_FS, VERSION_ACTV, VERSION_MEM,
...
ssize_t procdump_read_ulong_from_vspace(const struct dump_impl *impl, struct vspace_s *src_vspace,
		uintptr_t dst_addr, uintptr_t src_addr, unsigned int addr_model);
