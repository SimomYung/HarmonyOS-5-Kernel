...
#define FILE_F_PAGE_SEQ_READ		(unsigned)MMAP_FL_PAGE_SEQ_READ
#define FILE_F_PAGE_MONITOR_FAULT	(unsigned)MMAP_FL_PAGE_MONITOR_FAULT
...
int file_page_set_info(uintptr_t va, void *data);
