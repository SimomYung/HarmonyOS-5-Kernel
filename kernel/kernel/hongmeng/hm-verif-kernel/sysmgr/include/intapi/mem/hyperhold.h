...
uint64_t memcg_data_size(struct memcg_s *memcg, int type);
...
static inline uint64_t memcg_data_size(struct memcg_s *memcg, int type)
{
	UNUSED(memcg, type);
	return E_HM_OK;
}
...
bool hyperhold_is_full(void);
bool hyperhold_is_enable(void);
bool hyperhold_is_inited(void);
void hyperhold_enable(void);
uint64_t hyperhold_io_latency_show(enum hyperhold_io_latency io_latency);
...
char *hyperhold_device(void);
struct raw_mutex *hyperhold_global_mutex(void);
int hyperhold_set_space_size(unsigned long space_size);
uint32_t hyperhold_extent_size(void);
...
static inline bool hyperhold_is_full(void)
{
	return false;
}
static inline bool hyperhold_is_enable(void)
{
	return false;
}
static inline bool hyperhold_is_inited(void)
{
	return false;
}
static inline void hyperhold_enable(void) {}
static inline uint64_t hyperhold_io_latency_show(enum hyperhold_io_latency io_latency)
{
	UNUSED(io_latency);
	return E_HM_OK;
}
...
static inline char *hyperhold_device(void)
{
	return NULL;
}
static inline struct raw_mutex *hyperhold_global_mutex(void)
{
	return NULL;
}
...
static inline uint32_t hyperhold_extent_size(void)
{
	return 0U;
}
