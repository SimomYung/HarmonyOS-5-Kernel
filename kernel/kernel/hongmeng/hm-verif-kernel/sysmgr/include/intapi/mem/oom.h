...
#define OOM_KILL_DISABLE	0U
#define OOM_KILL_ENABLE		1U
...
#endif
bool oom_target_is_oom_killing(struct process_s *target);
void oom_target_set_oom_killing(struct process_s *target);
void oom_target_clear_oom_killing(struct process_s *target);
