...
#define PAF_IGNORE_WM	__PAF_EMRG
...
/* could use kern zone to alloc */
#define PAF_USE_KZ		(uint32_t)0x00200000
/* alloc from compact */
#define PAF_COMPACT		(uint32_t)0x00400000
/* prefer alloc from kern zone */
#define PAF_PREFER_KZ		(uint32_t)0x00800000
...
#define PAF_HKIP_EXECLUDED	(PAF_ZMASK | PAF_USE_KZ | PAF_USE_CMA)
#else
#define PAF_HKIP (0)
