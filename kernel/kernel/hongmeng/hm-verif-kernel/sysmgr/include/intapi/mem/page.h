...
__attribute__((noinline)) void dump_pgstr_maybe(struct vspace_s *vspace, uintptr_t abort_addr);
...
#define MIGRATE_FLAG_MASK	PAGE_FLAG_CAST(0x00000060)    /* inherit page flags when migrate */
/*
...
static inline bool page_is_file_shmem(struct page_s *pg)
{
