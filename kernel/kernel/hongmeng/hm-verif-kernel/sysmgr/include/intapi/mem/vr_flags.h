...
|                |               |                |                | HHP_PTE_RO	| SLAB_PAGE | VR_SKIP_MERGE| VR_HHP     |
+----------------+---------------+----------------+----------------+------------+-----------+--------------+------------+
...
#define VR_SLAB_PAGE			0x4000000000000ULL /* vregion is mapped into slab page region */
/* the ptes of the vregion are all read only, remove the flags when forkvs online */
#define VR_HHP_PTE_RO			0x8000000000000ULL
