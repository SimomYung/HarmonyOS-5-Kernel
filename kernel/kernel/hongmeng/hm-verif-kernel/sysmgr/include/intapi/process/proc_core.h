...
#define PROCESS_IN_USERHANDLER		0x1 /* the process has a thread which is in user handler */
#define PROCESS_IN_USERHANDLER_FLAG	0x2 /* user handler is being or has been executed */
#define PROCESS_REIN_USERHANDLER_FLAG	0x4 /* the process has a thread which has reined user handler */
#endif
