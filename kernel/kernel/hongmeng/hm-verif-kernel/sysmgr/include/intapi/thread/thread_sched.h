...
int thread_sched_xdep_infer_ctrl(struct sched_xdep_infer_ctrl_s *args,
				 struct xdep_infer_info_s *report, ssize_t report_size);
#else
...
__cpuset_t update_affinity_for_compat_thread(struct thread_s *thread, __cpuset_t cpuset);
#endif
