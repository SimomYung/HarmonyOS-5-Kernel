...
int tracemgr_tp_enable_probe(struct tracepoint *tp);
int tracemgr_tp_disable_probe(struct tracepoint *tp);
...
static inline int tracemgr_futex_wait(unsigned int futex_type, __u64 *ptimeout)
{
