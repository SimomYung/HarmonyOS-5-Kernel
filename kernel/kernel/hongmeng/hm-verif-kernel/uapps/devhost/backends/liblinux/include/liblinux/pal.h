...
extern int liblinux_pal_usermap_munmap_sp(unsigned long addr, unsigned long len, int pid);
...
#define RAW_RDLOCK_INITIALIZER {.owner = {{.align_id = 0ULL}, {.align_pc = 0ULL}}, .lock = 0U, .waiters = 0U, \
				.attr = {.wrhold = 0U, .shared = 0U, .xdep = 0U, .xdep_trace = 0U, .reserved = 0U}, \
				.lock_id = 0U}
