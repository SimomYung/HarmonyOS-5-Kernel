...
__attribute__((weak)) void liblinux_enter_basic(void)
{
}
...
static inline void __dh_linux_syscall_enter_basic(void)
{
	liblinux_enter_basic();
}
...
static inline void lnxbase_helper_ctor_init(struct dh_backend_ctor *ctor)
{
	...
	ctor->syscall_enter_basic = __dh_linux_syscall_enter_basic;
