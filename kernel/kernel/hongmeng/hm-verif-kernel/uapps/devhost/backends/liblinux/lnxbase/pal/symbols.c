...
EXPORT_SYMBOL(liblinux_pal_strcpy_from_user);
...
EXPORT_SYMBOL(liblinux_pal_thread_freezer_count);
EXPORT_SYMBOL(liblinux_pal_thread_set_freezable);
EXPORT_SYMBOL(liblinux_pal_thread_try_to_freeze);
EXPORT_SYMBOL(liblinux_pal_thread_freezing);

/* liblinux/process.c */
EXPORT_SYMBOL(liblinux_pal_process_dormancy_check);
/* liblinux/lock.c */
