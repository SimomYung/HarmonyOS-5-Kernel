...
enum udk_rq_flags_bits {
	...
	__UDK_REQ_FLAGS_DRV_0,
	__UDK_REQ_FLAGS_DRV_1,
	__UDK_REQ_FLAGS_DRV_2,
	__UDK_REQ_FLAGS_DRV_3,
	__UDK_REQ_FLAGS_DRV_4,
};

/* use 5 bits for driver flag enum */
enum udk_drv_req_flags_bits {
	__UDK_DRV_IN = 1,
	__UDK_DRV_OUT,
	__UDK_DRV_MAX = 31,
};

#define UDK_DRV_REQ_OP_DRV_IN		(__UDK_DRV_IN << (int)(__UDK_REQ_FLAGS_DRV_0))
#define UDK_DRV_REQ_OP_DRV_OUT		(__UDK_DRV_OUT << (int)(__UDK_REQ_FLAGS_DRV_0))
#define UDK_DRV_REQ_OP_DRV_MAX		(__UDK_DRV_MAX << (int)(__UDK_REQ_FLAGS_DRV_0))
...
enum req_process_stage_enum {
	...
	REQ_PROC_STAGE_NVME_ISSUE_CMD,
	REQ_PROC_STAGE_NVME_COMPLETE_CMD,
#endif
	REQ_PROC_STAGE_MAX
};
...
static inline bool udk_bio_op_is_flush(struct udk_bio *bio)
{
	return ((bio->bi_rw & UDK_REQ_FLUSH) != 0 ? true : false);
}
