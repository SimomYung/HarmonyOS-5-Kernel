...
DEFINE_SYSCALL_BASIC_NO_EXIT_HDLR(drvhandler_devhost_block_check_feature,
...
DEFINE_SYSCALL_BASIC_NO_EXIT_HDLR(drvhandler_devhost_block_run_queue,
				  unsigned long long, sender, unsigned long, credential,
...
DEFINE_SYSCALL_BASIC_NO_EXIT_HDLR(drvhandler_devhost_block_direct_access,
				  unsigned long long, sender, unsigned long, credential,
				  unsigned long, file_id,
...
DEFINE_SYSCALL_BASIC_NO_EXIT_HDLR(drvhandler_devhost_block_submit_bio,
				  unsigned long long, sender, unsigned long, credential,
...
DEFINE_SYSCALL_BASIC_NO_EXIT_HDLR(drvhandler_devhost_block_submit_cmd,
				  unsigned long long, sender, unsigned long, credential,
...
DEFINE_SYSCALL_BASIC_NO_EXIT_HDLR(drvhandler_devhost_block_register_bio_notify,
				  unsigned long long, sender, unsigned long, credential,
