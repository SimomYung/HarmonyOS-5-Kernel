...
#define DEFINE_SYSCALL_BASIC_HDLR(name, ...) \
	DEFINE_ACTVHDLR_HOOK_ALS(name, backend_basic_syscall_enter, backend_syscall_exit, __VA_ARGS__)

#define DEFINE_SYSCALL_BASIC_NO_EXIT_HDLR(name, ...) \
	DEFINE_ACTVHDLR_PREHOOK_ALS(name, backend_basic_syscall_enter, __VA_ARGS__)
