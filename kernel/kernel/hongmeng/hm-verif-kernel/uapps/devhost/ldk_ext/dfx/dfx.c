...
#ifdef PAC_FWCFI_SYSSERVICE
extern void (*const __dfx_ro_after_init_hdlr_start []) (void);
extern void (*const __dfx_ro_after_init_hdlr_end []) (void);
#endif
...
#ifdef PAC_FWCFI_SYSSERVICE
	ext_hdlr_init((uintptr_t)&__dfx_ro_after_init_hdlr_start, (uintptr_t)(&__dfx_ro_after_init_hdlr_end));
#endif
