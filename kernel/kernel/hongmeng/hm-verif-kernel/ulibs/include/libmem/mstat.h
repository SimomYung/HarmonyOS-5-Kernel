...
struct memstat_fs_stat_s {
	...
	uint64_t nr_shmem_swapout_succ; /* shmem pages swapout times */
	uint64_t nr_shmem_swapout_fail; /* shmem pages swapout times */
	uint64_t nr_shmem_swapin_succ;  /* shmem pages swapin times */
	uint64_t nr_shmem_swapin_fail;  /* shmem pages swapin times */
