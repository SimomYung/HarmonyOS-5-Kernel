...
#define SLAB_NAME_LEN 48U
#ifdef CONFIG_KASAN_DUMPSTACK
#define SLAB_MAX_LOWER_BOUND	3856U
#else
...
#define SLAB_STORE_FREE		0x10U // bit4

/* slab page is alloc from sequestered region and the va won't return to system */
#define SLAB_SEQUESTERED	0x20000000
#define SLAB_REGION_MASK       0x20000000
...
bool slab_ptr_is_valid(struct slab_ator *s_ator, uintptr_t ptr);
