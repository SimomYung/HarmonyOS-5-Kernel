...
({									\
	BUG_ON((unsigned long)(x) != 0 &&				\
		((unsigned long)(x) < (unsigned long)PAGE_OFFSET ||	\
		(unsigned long)(x) >= PAGE_END));			\
...
#define __is_lm_address(addr)	((u64)(addr) >= PAGE_OFFSET && (u64)(addr) < PAGE_END)
