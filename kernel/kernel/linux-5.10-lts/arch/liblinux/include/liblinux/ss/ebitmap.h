...
static inline unsigned int ebitmap_next_positive(struct ebitmap *e, struct ebitmap_node ** n, unsigned int bit)
{
...
static inline int ebitmap_node_get_bit(const struct ebitmap_node * n, unsigned int bit)
{
