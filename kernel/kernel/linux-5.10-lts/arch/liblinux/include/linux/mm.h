...
#define liblinux_unlink_file_vma liblinux_unlink_file_vma
int liblinux_unlink_file_vma(struct vm_area_struct *vma);
#define liblinux_link_file_vma liblinux_link_file_vma
int liblinux_link_file_vma(struct mm_struct *mm, struct vm_area_struct *vma);
