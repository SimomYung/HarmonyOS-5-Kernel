...
extern oal_uint32 hmac_config_edca_param_set(mac_vap_stru *mac_vap, oal_uint16 len, oal_uint8 *param);
extern oal_uint32 hmac_config_cca_bypass_set(mac_vap_stru *mac_vap, oal_uint16 len, oal_uint8 *param);
#endif
