...
OAL_STATIC oal_uint32 wal_config_edca_param_set(mac_vap_stru *mac_vap, oal_uint16 len, oal_uint8 *param);
OAL_STATIC oal_uint32 wal_config_cca_bypass_set(mac_vap_stru *mac_vap, oal_uint16 len, oal_uint8 *param);
#endif
...
#endif
#ifdef _PRE_WLAN_EXPORT
    { WLAN_CFGID_EDCA_PARAM, OAL_FALSE, { 0 }, OAL_PTR_NULL, wal_config_edca_param_set },
    { WLAN_CFGID_CCA_BYPASS, OAL_FALSE, { 0 }, OAL_PTR_NULL, wal_config_cca_bypass_set },
#endif
...
OAL_STATIC oal_uint32 wal_config_edca_param_set(mac_vap_stru *mac_vap, oal_uint16 len, oal_uint8 *param)
{
    return hmac_config_edca_param_set(mac_vap, len, param);
}

OAL_STATIC oal_uint32 wal_config_cca_bypass_set(mac_vap_stru *mac_vap, oal_uint16 len, oal_uint8 *param)
{
    return hmac_config_cca_bypass_set(mac_vap, len, param);
}
#endif
