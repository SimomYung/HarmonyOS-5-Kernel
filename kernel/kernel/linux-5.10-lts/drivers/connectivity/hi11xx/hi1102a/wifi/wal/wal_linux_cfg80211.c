...
#ifdef CONFIG_HISI_WIFI7_MLO
    oal_wiphy_stru *pst_wiphy, oal_net_device_stru *pst_netdev, int32_t link_id, oal_uint8 uc_key_index,
#else
...
OAL_STATIC oal_void wal_cfg80211_set_vendor_elements(oal_beacon_data_stru *pst_beacon_info,
    mac_beacon_param_stru *pst_beacon_param)
{
    oal_int32 ret = EOK;
    if (pst_beacon_info->beacon_ies_len !=0 && pst_beacon_info->beacon_ies_len <= MAX_VENDOR_ELEMENTS) {
        ret = memcpy_s(pst_beacon_param->vendor_elements, MAX_VENDOR_ELEMENTS,
            pst_beacon_info->beacon_ies, pst_beacon_info->beacon_ies_len);
        if (ret != EOK) {
            OAM_ERROR_LOG0(0, OAM_SF_CFG, "wal_cfg80211_set_vendor_elements::memcpy fail!");
            return;
        }
        pst_beacon_param->vendor_len = pst_beacon_info->beacon_ies_len;
    }
}
#endif
                                         ...
                                         mac_beacon_param_stru *pst_beacon_param)
{
    ...
    oal_uint32 ul_loop, ul_bcn_head_len, ul_beacon_tail_len;
...
#ifdef _PRE_WLAN_EXPORT
    wal_cfg80211_set_vendor_elements(pst_beacon_info, pst_beacon_param);
#endif
