...
OAL_STATIC oal_uint8 g_nb_power_enable = 1;
#endif
...
#ifdef _PRE_WLAN_EXPORT
OAL_STATIC oal_uint32 wal_hipriv_nb_power_enable(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param);
#endif
#endif
...
#ifdef _PRE_WLAN_EXPORT
    /* 设置是否从ini读取窄带功率参数 hipriv.sh "wlan0 nb_power_enable 0/1" */
    { "nb_power_enable", wal_hipriv_nb_power_enable },
    { "cwparam", wal_hipriv_cwparam_set },
    { "cca_bypass", wal_hipriv_cca_bypass_set },
#endif
#endif
    ...
    wal_wifi_priv_cmd_stru *priv_cmd)
{
    ...
    if (oal_copy_to_user(priv_cmd->puc_buf, &sync_tsf, sizeof(sync_tsf_stru))) {
        OAM_ERROR_LOG0(0, OAM_SF_CFG, "{wal_ioctl_copy_current_tsf_to_user::Failed to copy ioctl_data to user !}");
    }
}
...
oal_void wal_hipriv_init_mac_addr_from_efuse(oal_void)
{
    oal_int32 ret;
    ...
    if (pst_net_dev == NULL) {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "{wal_hipriv_init_mac_addr_from_efuse::pst_net_dev return null ptr!}\r\n");
        wlan_pm_close();
        return;
    }
    /* 调用oal_dev_get_by_name后，必须调用oal_dev_put使net_dev的引用计数减一 */
...
#ifdef _PRE_PLAT_FEATURE_CUSTOMIZE
    g_wlan_customize.en_random_mac_addr_connect = OAL_TRUE;
#endif
...
OAL_STATIC oal_uint32 wal_hipriv_autorate_param(oal_net_device_stru *net_dev, oal_int8 *param)
{
    ...
    mac_cfg_set_autorate_param autorate_param =
    {
        ...
        0, /* 当前档位 */
        7,
        {{85, -90, NARROW_BW_10M, 111, 3, 170, {0, 0}, WLAN_AUTORATE_RATELV_6M},  /* 5G 0档位参数5M-6m */
        ...
        {85, -90, NARROW_BW_10M, 111, 2, 170, {0, 0}, WLAN_AUTORATE_RATELV_6M },  /* 2G 0档位参数5M-6m */
...
oal_uint32 wal_hipriv_nb_power_enable(oal_net_device_stru *net_dev, oal_int8 *param)
{
    oal_int32 ret;
    oal_uint32 offset;
    oal_int8 ac_arg[WAL_HIPRIV_CMD_NAME_MAX_LEN];
    ...
    g_nb_power_enable = (oal_uint8)oal_atoi(ac_arg);
    wal_hipriv_autorate_param(net_dev, "autorate");
    return OAL_SUCC;
}


oal_uint32 wal_hipriv_cwparam_set(oal_net_device_stru *net_dev, oal_int8 *param)
{
    wal_msg_write_stru write_msg;
    oal_int32 ret;
    oal_uint32 offset;
    mac_cfg_edca_param_stru *edca_param;
    oal_int8 ac_arg[WAL_HIPRIV_CMD_NAME_MAX_LEN];
    ...
    ***************************************************************************/
    ...
    wal_write_msg_hdr_init(&write_msg, WLAN_CFGID_EDCA_PARAM, sizeof(mac_cfg_edca_param_stru));
    
    edca_param = (mac_cfg_edca_param_stru *)(write_msg.auc_value);
    
    memset_s(edca_param, OAL_SIZEOF(mac_cfg_edca_param_stru), 0, OAL_SIZEOF(mac_cfg_edca_param_stru));

    ret = wal_get_cmd_one_arg(param, ac_arg, OAL_SIZEOF(ac_arg), &offset);
    if (ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_cwparam_set::wal_get_cmd_one_arg fail err_code [%d]!}", ret);
        return ret;
    }

    edca_param->ac_type = (oal_uint8)oal_atoi(ac_arg);
    ...
    edca_param->cwmin = (oal_uint8)oal_atoi(ac_arg);
    ...
    edca_param->cwmax = (oal_uint8)oal_atoi(ac_arg);

    ret = wal_send_cfg_event(net_dev, WAL_MSG_TYPE_WRITE,
                             WAL_MSG_WRITE_MSG_HDR_LENGTH + sizeof(mac_cfg_edca_param_stru),
                             (oal_uint8 *)&write_msg, OAL_FALSE, NULL);
    if (oal_unlikely(ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_cwparam_set::return err code [%d]!}\r\n", ret);
        return (oal_uint32)ret;
    }
...
oal_uint32 wal_hipriv_cca_bypass_set(oal_net_device_stru *net_dev, oal_int8 *param)
{
    wal_msg_write_stru write_msg;
    oal_int32 ret;
    oal_uint32 offset;
    ...
    ***************************************************************************/
    ...
    wal_write_msg_hdr_init(&write_msg, WLAN_CFGID_CCA_BYPASS, sizeof(oal_uint8));

    ret = wal_get_cmd_one_arg(param, ac_arg, OAL_SIZEOF(ac_arg), &offset);
    if (ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_cca_bypass_set::wal_get_cmd_one_arg fail err_code [%d]!}", ret);
        return ret;
    }

    val = (oal_uint8)oal_atoi(ac_arg);

    write_msg.auc_value[0] = val;

    ret = wal_send_cfg_event(net_dev, WAL_MSG_TYPE_WRITE,
                             WAL_MSG_WRITE_MSG_HDR_LENGTH + sizeof(oal_uint8),
                             (oal_uint8 *)&write_msg, OAL_FALSE, NULL);
    if (oal_unlikely(ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_cca_bypass_set::return err code [%d]!}\r\n", ret);
        return (oal_uint32)ret;
    }
