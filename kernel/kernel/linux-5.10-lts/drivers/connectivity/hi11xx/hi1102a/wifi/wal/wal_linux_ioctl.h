...
#define EXPORT_2G_NB_PARAM_OFFSET       6
#endif
...
oal_uint32 wal_hipriv_cwparam_set(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param);
oal_uint32 wal_hipriv_cca_bypass_set(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param);
#endif
