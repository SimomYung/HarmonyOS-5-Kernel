...
typedef enum {
    ...
    CHR_PLAT_DRV_ERROR_CLOSE_TTY_REAMAIN_DATA = 0x8f,
    CHR_PLAT_DRV_ERROR_B_UART_RX_PKT_ERROR = 0x90,
    CHR_PLAT_DRV_ERROR_G_UART_RX_PKT_ERROR = 0x91,
    ...
    CHR_PLAT_DRV_ERROR_SSI_OPEN = 0xEB,
    ...
    CHR_PLAT_DRV_ERROR_WIFI_DEV_SYSTEM_PANIC = 0x142,
    CHR_PLAT_DRV_ERROR_BFG_DEV_SYSTEM_PANIC = 0x143,
