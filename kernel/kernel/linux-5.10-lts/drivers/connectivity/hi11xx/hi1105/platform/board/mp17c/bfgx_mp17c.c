...
STATIC struct bfgx_subsys_dev_desc g_bfgx_dev_desc[] = {
    ...
    {
        .name = HW_SLE_DEV_NAME, .uart = BUART, .get_driver_desc = get_sle_default_drv_desc
    },
    {
        .name = HW_OFF_FIND_DEV_NAME, .uart = BUART, .get_driver_desc = get_off_find_default_drv_desc,
    },
    {
...
struct bfgx_prj_desc *mp17c_bfgx_prj_desc_init(void)
{
    return &g_prj_desc;
}

void mp17c_prj_desc_remove(void)
{
}
