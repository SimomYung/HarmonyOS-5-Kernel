 ...
 *
 * Description: Rectifying MP17C Exceptions.
...
OAL_STATIC bool is_single_wifi_mp17c(void);
OAL_STATIC bool is_chip_force_reset_mp17c(void);
OAL_STATIC bool is_ir_mode_need_dfr_mp17c(uint32_t subsys_type);
...
OAL_STATIC int32_t firmware_download_mode_combo_mp17c(excp_comm_t *node_ptr);
OAL_STATIC int32_t firmware_download_mode_separate_mp17c(excp_comm_t *node_ptr);
OAL_STATIC int32_t mp17c_wifi_firmware_download_do(excp_comm_t *node_ptr);
...
OAL_STATIC reset_handler_t g_w_sys_func = {
    ...
    .firmware_download_do = mp17c_wifi_firmware_download_do,
...
OAL_STATIC reset_handler_t g_reset_handler = {
    .is_ir_mode_need_dfr = is_ir_mode_need_dfr_mp17c,
    .is_chip_force_reset = is_chip_force_reset_mp17c,
    .is_single_wifi = is_single_wifi_mp17c,
    ...
    .firmware_download_mode_combo = firmware_download_mode_combo_mp17c,
    .firmware_download_mode_separate = firmware_download_mode_separate_mp17c,
    .firmware_download_fail_do = NULL,
...
OAL_STATIC excp_search_table_t g_excp_table[EXCEPTION_TYPE_BOTTOM] = {
    ...
    [BUART_SYSTEM_RESET]      = {BUART_SYSTEM_RESET,      EXCP_ALL_SYS,    ALL_CORE,    NULL}, /* 全系统恢复 */
    [GUART_SYSTEM_RESET]      = {GUART_SYSTEM_RESET,      EXCP_ALL_SYS,    ALL_CORE,    NULL}, /* 全系统恢复 */
    [WIFI_SYSTEM_RESET]       = {WIFI_SYSTEM_RESET,       EXCP_ALL_SYS,    ALL_CORE,    NULL}, /* 全系统恢复 */
};
...
OAL_STATIC excp_panic_table_t g_panic_table[] = {
    {BUART_PANIC, BUART},
    {GUART_PANIC, GUART},
    {BUART_SYSTEM_RESET, BUART},
    {GUART_SYSTEM_RESET, GUART}
};

OAL_STATIC excp_chip_cfg_t g_chip_cfg = {
    .chip_type = BOARD_VERSION_MP17C,
    .chip_name = BOARD_VERSION_NAME_MP17C,
...
excp_chip_cfg_t *get_mp17c_chip_cfg(void)
{
    return &g_chip_cfg;
}
