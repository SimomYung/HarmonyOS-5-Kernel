...
/* After MP16C */
#define MP16C_SSI_SEL_CTRL   0x7C
#define MP16C_SSI_SSI_CTRL   0x80

/* After MP17c */
#define SSI_CTRL_AON_CRG_SEL 0xC0
#define SSI_CTRL_AON_CRG_RST_EN_CLKEN 0xC4
#define SSI_SSI_RPT_STS_31 0xE0 // [12:10] cur_sts_w
#define SSI_SSI_RPT_STS_32 0xE4 // [6:4] cur_sts_b
#define SSI_SSI_RPT_STS_33 0xE8 // [12:10] cur_sts_com [2:0] cur_sts_g
...
#define SSI_MODULE_MASK_GPIO             (1 << 21)
#define SSI_MODULE_MASK_OFF_FIND_LOG     (1 << 22)
#define SSI_MODULE_MASK_PM_TRACE         (1 << 23)
#define SSI_MODULE_MASK_WCPU_DEVICE_LOG  (1 << 24)
#define SSI_MODULE_MASK_BCPU_DEVICE_LOG  (1 << 25)
#define SSI_MODULE_MASK_GCPU_DEVICE_LOG  (1 << 26)
#define SSI_MODULE_MASK_TRG_B_PANIC      (1 << 27)
#define SSI_MODULE_MASK_TRG_G_PANIC      (1 << 28)

#define SSI_MODULE_MASK_BFGXCTRL (SSI_MODULE_MASK_BCTRL | SSI_MODULE_MASK_GFCTRL | SSI_MODULE_MASK_SLECTRL)

#define SSI_MODULE_MASK_COMM (SSI_MODULE_MASK_AON | SSI_MODULE_MASK_ARM_REG | SSI_MODULE_MASK_GPIO | \
                              ...
                              SSI_MODULE_MASK_PMU | SSI_MODULE_MASK_PM_TRACE)
...
#define SSI_MODULE_MASK_OFF_FIND  (SSI_MODULE_MASK_AON_CUT | SSI_MODULE_MASK_ARM_REG | SSI_MODULE_MASK_OFF_FIND_LOG)
...
typedef enum _ssi_err_type_ {
    ...
    SSI_ERR_B_HEART_TIMEOUT,
    SSI_ERR_G_HEART_TIMEOUT,
    SSI_ERR_B_TRIGER_PANIC,
    SSI_ERR_G_TRIGER_PANIC,
    SSI_ERR_BUT
} ssi_err_type;
...
typedef struct _ssi_err_stru_ {
    ...
    uint32_t (*ssi_get_control_flag)(ssi_err_type etype);
} ssi_err_stru;
