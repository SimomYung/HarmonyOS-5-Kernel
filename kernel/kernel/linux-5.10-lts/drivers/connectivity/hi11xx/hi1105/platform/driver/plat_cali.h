...
#define OAL_SLE_NVRAM_DATA_LENGTH     28
...
#define OAL_SLE_CAL_NVRAM_NAME        "SLEPOW"
#define OAL_SLE_CAL_NVRAM_NUMBER      385
#define OAL_SLE_COF_NVRAM_NAME        "SLECOF"
#define OAL_SLE_COF_NVRAM_NUMBER      386
#define OAL_SLE_COE_NVRAM_NAME        "SLECOE"
#define OAL_SLE_COE_NVRAM_NUMBER      387
#define OAL_SLE_VERIFY_NUM_SIZE       4
#define OAL_BT_CALI_SWITCH_OFFSET     84
#define OAL_BT_CALI_SWITCH_MASK       0x80000000
#define OAL_SLE_FST_COF_SIZE          100
#define OAL_SLE_SEC_COF_SIZE          84
#define OAL_SLE_THR_COF_SIZE          24
#define OAL_SLE_COF_NVRAM_OFFSET1     88 /* 功率曲线ini参数偏移起始值 */
#define OAL_SLE_COF_NVRAM_OFFSET2     (OAL_SLE_COF_NVRAM_OFFSET1 + OAL_SLE_FST_COF_SIZE)
#define OAL_SLE_COF_NVRAM_OFFSET3     (OAL_SLE_COF_NVRAM_OFFSET2 + OAL_SLE_SEC_COF_SIZE + 16)

#define OAL_SLE_NVRAM_VERIFY          0x1107CCAB
...
typedef struct {
    ...
    uint32_t nv_number;
    uint32_t verify;
    int32_t (*post_process)(uint32_t nv_number, const char *nv_name, uint32_t offset, uint32_t length, uint32_t verify);
} bfgx_nv_table_stru;
...
typedef struct  {
    wlan_cali_lodiv_para_stru lodiv_cali_data_2g[FE_CALI_ALL_CHN_NUMS];
    wlan_cali_lodiv_para_stru lodiv_cali_data_5g[FE_CALI_ALL_CHN_NUMS][BT_WL_CALI_SUB_BAND_NUM];
} cali_data_lodiv_data;
...
typedef struct {
    ...
    cali_data_lodiv_data lodiv_cali_data;
