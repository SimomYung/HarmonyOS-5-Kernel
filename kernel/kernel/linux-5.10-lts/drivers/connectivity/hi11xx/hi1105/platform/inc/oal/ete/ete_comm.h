 ...
 *
 * Description: ete/ete_comm.h header file
...
void pcie_ete_rx_chan_clken(uintptr_t base_address, uint32_t chan_idx, uint32_t enable);
void pcie_ete_tx_chan_clken(uintptr_t base_address, uint32_t chan_idx, uint32_t enable);
