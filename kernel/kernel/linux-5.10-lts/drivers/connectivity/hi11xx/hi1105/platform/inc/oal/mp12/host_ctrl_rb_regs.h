...
#ifndef MP12_HOST_CTRL_RB_REGS_H
#define MP12_HOST_CTRL_RB_REGS_H

/* This file is generated automatically. Do not modify it */
#define HOST_CTRL_RB_BASE    (0x04905000)
...
typedef union {
    struct {
        ...
        unsigned int tx_ch0_memcp_done : 1; /* 2 */
...
typedef union {
    struct {
        ...
        unsigned int tx_ch1_memcp_done : 1; /* 2 */
        unsigned int reserved0 : 29; /* 3:31 */
    } bits;
    unsigned int as_dword;
} hreg_tx_ch1_status;
...
typedef union {
    struct {
        ...
        unsigned int tx_ch2_memcp_done : 1; /* 2 */
        unsigned int reserved0 : 29; /* 3:31 */
    } bits;
    unsigned int as_dword;
} hreg_tx_ch2_status;
...
typedef union {
    struct {
        ...
        unsigned int tx_ch3_memcp_done : 1; /* 2 */
        unsigned int reserved0 : 29; /* 3:31 */
    } bits;
    unsigned int as_dword;
} hreg_tx_ch3_status;
...
typedef union {
    struct {
        ...
        unsigned int tx_ch4_memcp_done : 1; /* 2 */
        unsigned int reserved0 : 29; /* 3:31 */
    } bits;
    unsigned int as_dword;
} hreg_tx_ch4_status;
...
typedef union {
    struct {
        ...
        unsigned int rx_ch0_memcp_done : 1; /* 2 */
        unsigned int reserved0 : 29; /* 3:31 */
    } bits;
    unsigned int as_dword;
} hreg_rx_ch0_status;
...
typedef union {
    struct {
        ...
        unsigned int rx_ch1_memcp_donw : 1; /* 2 */
        unsigned int reserved0 : 29; /* 3:31 */
    } bits;
    unsigned int as_dword;
} hreg_rx_ch1_status;
...
typedef union {
    struct {
        ...
        unsigned int rx_ch2_memcp_done : 1; /* 2 */
        unsigned int reserved0 : 29; /* 3:31 */
    } bits;
    unsigned int as_dword;
} hreg_rx_ch2_status;
...
typedef union {
    struct {
        ...
        unsigned int rx_ch3_memcp_done : 1; /* 2 */
        unsigned int reserved0 : 29; /* 3:31 */
    } bits;
    unsigned int as_dword;
} hreg_rx_ch3_status;
...
typedef union {
    struct {
        ...
        unsigned int rx_ch4_memcp_done : 1; /* 2 */
        unsigned int reserved0 : 29; /* 3:31 */
    } bits;
    unsigned int as_dword;
} hreg_rx_ch4_status;
...
typedef union {
    struct {
        ...
        unsigned int rx_ch5_memcp_done : 1; /* 2 */
        unsigned int reserved0 : 29; /* 3:31 */
    } bits;
    unsigned int as_dword;
} hreg_rx_ch5_status;
...
/* HOST_CRG_CLKEN 0xd00 */
typedef union {
    struct {
        unsigned int cfg_host_pcie_pclk_clken : 1; /* 0 */
        unsigned int cfg_host_ete_clken : 1; /* 1 */
        unsigned int reserved0 : 30; /* 2:31 */
    } bits;
    unsigned int as_dword;
} hreg_host_crg_clken;
#define HOST_CTRL_RB_HOST_CRG_CLKEN_OFF    0xd00
#define HOST_CTRL_RB_HOST_CRG_CLKEN_REG \
    (HOST_CTRL_RB_BASE + HOST_CTRL_RB_HOST_CRG_CLKEN_OFF)

/* HOST_CRG_DIV_PCLK 0xd04 */
typedef union {
    struct {
        unsigned int cfg_host_pcie_pclk_load_div_en : 1; /* 0 */
        unsigned int cfg_host_pcie_pclk_div : 3; /* 1:3 */
        unsigned int reserved0 : 28; /* 4:31 */
    } bits;
    unsigned int as_dword;
} hreg_host_crg_div_pclk;
#define HOST_CTRL_RB_HOST_CRG_DIV_PCLK_OFF    0xd04
#define HOST_CTRL_RB_HOST_CRG_DIV_PCLK_REG \
    (HOST_CTRL_RB_BASE + HOST_CTRL_RB_HOST_CRG_DIV_PCLK_OFF)

/* HOST_CRG_SOFT_RST 0xd08 */
typedef union {
    struct {
        unsigned int cfg_host_soft_rst_pcie_phy_por_sel : 1; /* 0 */
        unsigned int cfg_host_soft_rst_pcie_phy_por_n : 1; /* 1 */
        unsigned int reserved0 : 30; /* 2:31 */
    } bits;
    unsigned int as_dword;
} hreg_host_crg_soft_rst;
#define HOST_CTRL_RB_HOST_CRG_SOFT_RST_OFF    0xd08
#define HOST_CTRL_RB_HOST_CRG_SOFT_RST_REG \
    (HOST_CTRL_RB_BASE + HOST_CTRL_RB_HOST_CRG_SOFT_RST_OFF)

/* HOST_CRG_ETE_AUTOCG_BYPASS 0xd0c */
typedef union {
    struct {
        unsigned int cfg_host_ete_autocg_bypass : 1; /* 0 */
        unsigned int reserved0 : 31; /* 1:31 */
    } bits;
    unsigned int as_dword;
} hreg_host_crg_ete_autocg_bypass;
#define HOST_CTRL_RB_HOST_CRG_ETE_AUTOCG_BYPASS_OFF    0xd0c
#define HOST_CTRL_RB_HOST_CRG_ETE_AUTOCG_BYPASS_REG \
    (HOST_CTRL_RB_BASE + HOST_CTRL_RB_HOST_CRG_ETE_AUTOCG_BYPASS_OFF)
...
#define HOST_CTRL_RB_PCIE_SLV_ADDR_CFG0_W0_OFF    0xE00
...
typedef union {
    struct {
        unsigned int soc_slv_araddr_w0_l_msb : 1; /* 0 */
        unsigned int reserved0 : 31; /* 1:31 */
    } bits;
    unsigned int as_dword;
} hreg_pcie_slv_addr_cfg0_w0_l_msb;
#define HOST_CTRL_RB_PCIE_SLV_ADDR_CFG0_W0_L_MSB_OFF    0xE04
#define HOST_CTRL_RB_PCIE_SLV_ADDR_CFG0_W0_L_MSB_REG \
    (HOST_CTRL_RB_BASE + HOST_CTRL_RB_PCIE_SLV_ADDR_CFG0_W0_L_MSB_OFF)
...
#define HOST_CTRL_RB_PCIE_SLV_ADDR_CFG1_W0_OFF    0xE08
...
typedef union {
    struct {
        unsigned int soc_slv_awaddr_w0_l_msb : 1; /* 0 */
        unsigned int reserved0 : 31; /* 1:31 */
    } bits;
    unsigned int as_dword;
} hreg_pcie_slv_addr_cfg1_w0_l_msb;
#define HOST_CTRL_RB_PCIE_SLV_ADDR_CFG1_W0_L_MSB_OFF    0xE0C
#define HOST_CTRL_RB_PCIE_SLV_ADDR_CFG1_W0_L_MSB_REG \
    (HOST_CTRL_RB_BASE + HOST_CTRL_RB_PCIE_SLV_ADDR_CFG1_W0_L_MSB_OFF)
...
#define HOST_CTRL_RB_PCIE_SLV_ADDR_CFG0_SDIO_OFF    0xE10
...
typedef union {
    struct {
        unsigned int soc_slv_araddr_sdio_l_msb : 1; /* 0 */
        unsigned int reserved0 : 31; /* 1:31 */
    } bits;
    unsigned int as_dword;
} hreg_pcie_slv_addr_cfg0_sdio_l_msb;
#define HOST_CTRL_RB_PCIE_SLV_ADDR_CFG0_SDIO_L_MSB_OFF    0xE14
#define HOST_CTRL_RB_PCIE_SLV_ADDR_CFG0_SDIO_L_MSB_REG \
    (HOST_CTRL_RB_BASE + HOST_CTRL_RB_PCIE_SLV_ADDR_CFG0_SDIO_L_MSB_OFF)
...
#define HOST_CTRL_RB_PCIE_SLV_ADDR_CFG1_SDIO_OFF    0xE18
...
typedef union {
    struct {
        unsigned int soc_slv_awaddr_sdio_l_msb : 1; /* 0 */
        unsigned int reserved0 : 31; /* 1:31 */
    } bits;
    unsigned int as_dword;
} hreg_pcie_slv_addr_cfg1_sdio_l_msb;
#define HOST_CTRL_RB_PCIE_SLV_ADDR_CFG1_SDIO_L_MSB_OFF    0xE1C
#define HOST_CTRL_RB_PCIE_SLV_ADDR_CFG1_SDIO_L_MSB_REG \
    (HOST_CTRL_RB_BASE + HOST_CTRL_RB_PCIE_SLV_ADDR_CFG1_SDIO_L_MSB_OFF)
...
typedef union {
    struct {
        unsigned int soc_slv_araddr_aon_l_msb : 1; /* 0 */
        unsigned int reserved0 : 31; /* 1:31 */
    } bits;
    unsigned int as_dword;
} hreg_pcie_slv_addr_cfg0_aon_l_msb;
#define HOST_CTRL_RB_PCIE_SLV_ADDR_CFG0_AON_L_MSB_OFF    0xE24
#define HOST_CTRL_RB_PCIE_SLV_ADDR_CFG0_AON_L_MSB_REG \
    (HOST_CTRL_RB_BASE + HOST_CTRL_RB_PCIE_SLV_ADDR_CFG0_AON_L_MSB_OFF)
...
#define HOST_CTRL_RB_PCIE_SLV_ADDR_CFG1_AON_OFF    0xE28
...
typedef union {
    struct {
        unsigned int soc_slv_awaddr_aon_l_msb : 1; /* 0 */
        unsigned int reserved0 : 31; /* 1:31 */
    } bits;
    unsigned int as_dword;
} hreg_pcie_slv_addr_cfg1_aon_l_msb;
#define HOST_CTRL_RB_PCIE_SLV_ADDR_CFG1_AON_L_MSB_OFF    0xE2C
#define HOST_CTRL_RB_PCIE_SLV_ADDR_CFG1_AON_L_MSB_REG \
    (HOST_CTRL_RB_BASE + HOST_CTRL_RB_PCIE_SLV_ADDR_CFG1_AON_L_MSB_OFF)
...
typedef union {
    struct {
        unsigned int pcie_test_pcie0_pipe_clken : 1; /* 0 */
        unsigned int reserved0 : 31; /* 1:31 */
    } bits;
    unsigned int as_dword;
} hreg_pcie_test_pcie0_pipe_clken;
#define HOST_CTRL_RB_PCIE_TEST_PCIE0_PIPE_CLKEN_OFF    0xF74
#define HOST_CTRL_RB_PCIE_TEST_PCIE0_PIPE_CLKEN_REG \
    (HOST_CTRL_RB_BASE + HOST_CTRL_RB_PCIE_TEST_PCIE0_PIPE_CLKEN_OFF)

/*  0xF7C */
typedef union {
    struct {
        unsigned int ete_cfg_len : 2; /* 0:1 */
        unsigned int reserved0 : 30; /* 2:31 */
    } bits;
    unsigned int as_dword;
} hreg_ete_len_cfg;
#define HOST_CTRL_RB_ETE_LEN_CFG_OFF    0xF7C
#define HOST_CTRL_RB_ETE_LEN_CFG_REG \
    (HOST_CTRL_RB_BASE + HOST_CTRL_RB_ETE_LEN_CFG_OFF)
