...
#ifndef MP12_PCIE_CTRL_RB_REGS_H
#define MP12_PCIE_CTRL_RB_REGS_H

/* This file is generated automatically. Do not modify it */
#define PCIE_CTRL_RB_BASE    (0x04903000)
...
/* PCIE MEM参数控制寄存器 0x118 */
typedef union {
    struct {
        unsigned int pcie_ete_sp_ram_tmod_h_s28 : 32; /* 0:31 */
    } bits;
    unsigned int as_dword;
} hreg_pcie_mem_sp_ram_tmode_h_s28;
#define PCIE_CTRL_RB_PCIE_MEM_SP_RAM_TMODE_H_S28_OFF    0x118
#define PCIE_CTRL_RB_PCIE_MEM_SP_RAM_TMODE_H_S28_REG \
    (PCIE_CTRL_RB_BASE + PCIE_CTRL_RB_PCIE_MEM_SP_RAM_TMODE_H_S28_OFF)

/* PCIE MEM参数控制寄存器 0x11C */
typedef union {
    struct {
        unsigned int pcie_ete_sp_ram_tmod_l_s28 : 32; /* 0:31 */
    } bits;
    unsigned int as_dword;
} hreg_pcie_mem_sp_ram_tmode_l_s28;
#define PCIE_CTRL_RB_PCIE_MEM_SP_RAM_TMODE_L_S28_OFF    0x11C
#define PCIE_CTRL_RB_PCIE_MEM_SP_RAM_TMODE_L_S28_REG \
    (PCIE_CTRL_RB_BASE + PCIE_CTRL_RB_PCIE_MEM_SP_RAM_TMODE_L_S28_OFF)

/* PCIE MEM参数控制寄存器 0x120 */
typedef union {
    struct {
        unsigned int pcie_ete_tp_ram_tmod_s28 : 32; /* 0:31 */
    } bits;
    unsigned int as_dword;
} hreg_pcie_mem_tp_ram_tmode_s28;
#define PCIE_CTRL_RB_PCIE_MEM_TP_RAM_TMODE_S28_OFF    0x120
#define PCIE_CTRL_RB_PCIE_MEM_TP_RAM_TMODE_S28_REG \
    (PCIE_CTRL_RB_BASE + PCIE_CTRL_RB_PCIE_MEM_TP_RAM_TMODE_S28_OFF)

/* PCIE MEM参数控制寄存器 0x124 */
typedef union {
    struct {
        unsigned int pcie_mem_power_mode : 3; /* 0:2 */
        unsigned int reserved0 : 29; /* 3:31 */
    } bits;
    unsigned int as_dword;
} hreg_pcie_mem_power_mode;
#define PCIE_CTRL_RB_PCIE_MEM_POWER_MODE_OFF    0x124
#define PCIE_CTRL_RB_PCIE_MEM_POWER_MODE_REG \
    (PCIE_CTRL_RB_BASE + PCIE_CTRL_RB_PCIE_MEM_POWER_MODE_OFF)
...
typedef union {
    struct {
        ...
        unsigned int link_dowm_irq_mask : 1; /* 14 */
...
typedef union {
    struct {
        ...
        unsigned int reserved1 : 7; /* 25:31 */
    } bits;
    unsigned int as_dword;
} hreg_pcie_cfg;
...
typedef union {
    struct {
        ...
        unsigned int reserved0 : 8; /* 12:19 */
...
typedef union {
    struct {
        ...
        unsigned int reserved2 : 30; /* 2:31 */
    } bits;
    unsigned int as_dword;
...
typedef union {
    struct {
        ...
        unsigned int pcie_core_rst_n_status : 1; /* 6 */
        unsigned int reserved0 : 25; /* 7:31 */
    } bits;
    unsigned int as_dword;
} hreg_pcie_phy_cfg;
...
typedef union {
    ...
    unsigned int as_dword;
} hreg_pcie_host_xfer_pending;
#define PCIE_CTRL_RB_PCIE_HOST_XFER_PENDING_OFF    0x650
#define PCIE_CTRL_RB_PCIE_HOST_XFER_PENDING_REG \
    (PCIE_CTRL_RB_BASE + PCIE_CTRL_RB_PCIE_HOST_XFER_PENDING_OFF)

/* PCIE MONITOR清除寄存器 0x654 */
typedef union {
    struct {
        unsigned int pcie_monitor_clr : 1; /* 0 */
        unsigned int reserved0 : 31; /* 1:31 */
    } bits;
    unsigned int as_dword;
} hreg_pcie_monitor_clr;
#define PCIE_CTRL_RB_PCIE_MONITOR_CLR_OFF    0x654
#define PCIE_CTRL_RB_PCIE_MONITOR_CLR_REG \
    (PCIE_CTRL_RB_BASE + PCIE_CTRL_RB_PCIE_MONITOR_CLR_OFF)

/* PCIE 手动 0x658 */
typedef union {
    struct {
        unsigned int mannual_link_down_clr : 1; /* 0 */
        unsigned int reserved0 : 31; /* 1:31 */
    } bits;
    unsigned int as_dword;
} hreg_pcie_mannual_link_dowm_clr;
#define PCIE_CTRL_RB_PCIE_MANNUAL_LINK_DOWM_CLR_OFF    0x658
#define PCIE_CTRL_RB_PCIE_MANNUAL_LINK_DOWM_CLR_REG \
    (PCIE_CTRL_RB_BASE + PCIE_CTRL_RB_PCIE_MANNUAL_LINK_DOWM_CLR_OFF)

/* WLMAC提前唤醒PCIE使能 0x65C */
typedef union {
    struct {
        unsigned int wlmac_tx_xfer_pending_enable : 1; /* 0 */
        unsigned int reserved0 : 31; /* 1:31 */
    } bits;
    unsigned int as_dword;
} hreg_wlmac_tx_xfer_pending_enable;
#define PCIE_CTRL_RB_WLMAC_TX_XFER_PENDING_ENABLE_OFF    0x65C
#define PCIE_CTRL_RB_WLMAC_TX_XFER_PENDING_ENABLE_REG \
    (PCIE_CTRL_RB_BASE + PCIE_CTRL_RB_WLMAC_TX_XFER_PENDING_ENABLE_OFF)

/* HOST_CRG_PCIE_CLKEN 0x700 */
typedef union {
    struct {
        unsigned int cfg_pcie_pcs_man_clken : 1; /* 0 */
        unsigned int cfg_pcie_dbi_man_clken : 1; /* 1 */
        unsigned int reserved0 : 30; /* 2:31 */
    } bits;
    unsigned int as_dword;
...
typedef union {
    struct {
        ...
        unsigned int cfg_pcie_dbi_autocg_bypass : 1; /* 1 */
        unsigned int reserved0 : 30; /* 2:31 */
    } bits;
    unsigned int as_dword;
...
/* PCIE MAC顶层固接的寄存器 0x750 */
typedef union {
    struct {
        unsigned int misc_phy_clk_req_n : 1; /* 0 */
        unsigned int misc_phy_mac_rxstartblock : 1; /* 1 */
        unsigned int misc_phy_mac_rxsyncheader : 2; /* 2:3 */
        unsigned int misc_phy_mac_localfs : 6; /* 4:9 */
        unsigned int misc_phy_mac_locallf : 6; /* 10:15 */
        unsigned int misc_phy_mac_fomfeedback : 8; /* 16:23 */
        unsigned int misc_phy_clk_req_n_sel : 1; /* 24 */
        unsigned int reserved0 : 7; /* 25:31 */
    } bits;
    unsigned int as_dword;
} hreg_pcie_mac_tie_reg;
#define PCIE_CTRL_RB_PCIE_MAC_TIE_REG_OFF    0x750
#define PCIE_CTRL_RB_PCIE_MAC_TIE_REG_REG \
    (PCIE_CTRL_RB_BASE + PCIE_CTRL_RB_PCIE_MAC_TIE_REG_OFF)

/* PIPE间信号位宽不一致寄存器 0x760 */
typedef union {
    struct {
        unsigned int misc_mac_phy_txmargin_h : 3; /* 0:2 */
        unsigned int reserved0 : 29; /* 3:31 */
    } bits;
    unsigned int as_dword;
} hreg_pipe_signal_width_mismatch;
#define PCIE_CTRL_RB_PIPE_SIGNAL_WIDTH_MISMATCH_OFF    0x760
#define PCIE_CTRL_RB_PIPE_SIGNAL_WIDTH_MISMATCH_REG \
    (PCIE_CTRL_RB_BASE + PCIE_CTRL_RB_PIPE_SIGNAL_WIDTH_MISMATCH_OFF)

/* PCIE TRACER地址信息 0x764 */
typedef union {
    struct {
        unsigned int cfg_pcie_tracer_read_addr : 8; /* 0:7 */
        unsigned int ltssm_tracer_last_waddr : 8; /* 8:15 */
        unsigned int reserved0 : 16; /* 16:31 */
    } bits;
    unsigned int as_dword;
} hreg_pcie_tracer_addr;
#define PCIE_CTRL_RB_PCIE_TRACER_ADDR_OFF    0x764
#define PCIE_CTRL_RB_PCIE_TRACER_ADDR_REG \
    (PCIE_CTRL_RB_BASE + PCIE_CTRL_RB_PCIE_TRACER_ADDR_OFF)

/* PCIE TRACER模块模式配置 0x768 */
typedef union {
    struct {
        unsigned int cfg_ltssm_tracer_mask : 6; /* 0:5 */
        unsigned int cfg_ltssm_tracer_cap_mode : 1; /* 6 */
        unsigned int cfg_ltssm_tracer_recap : 1; /* 7 */
        unsigned int reserved0 : 24; /* 8:31 */
    } bits;
    unsigned int as_dword;
} hreg_pcie_tracer_mode_cfg;
#define PCIE_CTRL_RB_PCIE_TRACER_MODE_CFG_OFF    0x768
#define PCIE_CTRL_RB_PCIE_TRACER_MODE_CFG_REG \
    (PCIE_CTRL_RB_BASE + PCIE_CTRL_RB_PCIE_TRACER_MODE_CFG_OFF)

/* PCIE TRACE结果寄存器 0x76C */
typedef union {
    struct {
        unsigned int ltssm_tracer_raddr : 32; /* 0:31 */
    } bits;
    unsigned int as_dword;
} hreg_pcie_tracer_result;
#define PCIE_CTRL_RB_PCIE_TRACER_RESULT_OFF    0x76C
#define PCIE_CTRL_RB_PCIE_TRACER_RESULT_REG \
    (PCIE_CTRL_RB_BASE + PCIE_CTRL_RB_PCIE_TRACER_RESULT_OFF)

/* axi rs自动门控旁路寄存器 0x770 */
typedef union {
    struct {
        unsigned int pcieslv_rs_auto_cg_bypass : 1; /* 0 */
        unsigned int pciemst_rs_auto_cg_bypass : 1; /* 1 */
        unsigned int reserved0 : 30; /* 2:31 */
    } bits;
    unsigned int as_dword;
} hreg_axi_rs_auto_cg_bypass;
#define PCIE_CTRL_RB_AXI_RS_AUTO_CG_BYPASS_OFF    0x770
#define PCIE_CTRL_RB_AXI_RS_AUTO_CG_BYPASS_REG \
    (PCIE_CTRL_RB_BASE + PCIE_CTRL_RB_AXI_RS_AUTO_CG_BYPASS_OFF)

/* UPSPHY_2TO1MUX的TEST复用配置 0x07A8 */
typedef union {
    struct {
        unsigned int misc_test2mux_tx_data : 32; /* 0:31 */
    } bits;
    unsigned int as_dword;
} hreg_upsphy_2to1_ctrl0;
#define PCIE_CTRL_RB_upsphy_2to1_ctrl0_OFF    0x07A8
#define PCIE_CTRL_RB_upsphy_2to1_ctrl0_REG \
    (PCIE_CTRL_RB_BASE + PCIE_CTRL_RB_upsphy_2to1_ctrl0_OFF)

/* UPSPHY_2TO1MUX的TEST复用配置 0x07AC */
typedef union {
    struct {
        unsigned int misc_test2mux_tx_data_k : 4; /* 0:3 */
        unsigned int misc_test2mux_tx_onezeros : 1; /* 4 */
        unsigned int misc_test2mux_tx_compliance : 1; /* 5 */
        unsigned int misc_test2mux_tx_parttern : 2; /* 6:7 */
        unsigned int misc_test2mux_tx_detect_rx : 1; /* 8 */
        unsigned int misc_test2mux_tx_elecidle : 1; /* 9 */
        unsigned int misc_test2mux_tx_swing : 1; /* 10 */
        unsigned int misc_test2mux_tx_deemp : 5; /* 11:15 */
        unsigned int misc_test2mux_tx_margin : 6; /* 16:21 */
        unsigned int reserved0 : 10; /* 22:31 */
    } bits;
    unsigned int as_dword;
} hreg_upsphy_2to1_ctrl1;
#define PCIE_CTRL_RB_upsphy_2to1_ctrl1_OFF    0x07AC
#define PCIE_CTRL_RB_upsphy_2to1_ctrl1_REG \
    (PCIE_CTRL_RB_BASE + PCIE_CTRL_RB_upsphy_2to1_ctrl1_OFF)

/* UPSPHY_2TO1MUX的TEST复用配置 0x07B0 */
typedef union {
    struct {
        unsigned int misc_test2mux_clk_sel_0 : 1; /* 0 */
        unsigned int misc_test2mux_clk_sel_1 : 1; /* 1 */
        unsigned int misc_test2mux_clk_sel_2 : 1; /* 2 */
        unsigned int misc_test2mux_clk_req : 1; /* 3 */
        unsigned int misc_test2mux_buf_mode : 1; /* 4 */
        unsigned int misc_test2mux_buf_width : 1; /* 5 */
        unsigned int misc_test2mux_pwdn_0 : 1; /* 6 */
        unsigned int misc_test2mux_pwdn_1 : 1; /* 7 */
        unsigned int misc_test2mux_pwdn_2 : 1; /* 8 */
        unsigned int misc_test2mux_pwdn_3 : 1; /* 9 */
        unsigned int misc_test2mux_rate_0 : 1; /* 10 */
        unsigned int misc_test2mux_rate_1 : 1; /* 11 */
        unsigned int misc_test2mux_bypass_codec : 1; /* 12 */
        unsigned int misc_test2mux_rx_polarity : 1; /* 13 */
        unsigned int misc_test2mux_rx_eq_training : 1; /* 14 */
        unsigned int misc_test2mux_rx_standby : 1; /* 15 */
        unsigned int misc_test2mux_rx_termination : 1; /* 16 */
        unsigned int reserved0 : 15; /* 17:31 */
    } bits;
    unsigned int as_dword;
} hreg_upsphy_2to1_ctrl2;
#define PCIE_CTRL_RB_upsphy_2to1_ctrl2_OFF    0x07B0
#define PCIE_CTRL_RB_upsphy_2to1_ctrl2_REG \
    (PCIE_CTRL_RB_BASE + PCIE_CTRL_RB_upsphy_2to1_ctrl2_OFF)

/*  0x07B4 */
typedef union {
    struct {
        unsigned int misc_pcie_clk_sel0 : 1; /* 0 */
        unsigned int misc_pcie_clk_sel1 : 1; /* 1 */
        unsigned int misc_pcie_clk_sel2 : 1; /* 2 */
        unsigned int reserved0 : 1; /* 3 */
        unsigned int misc_pcie_clk_req : 1; /* 4 */
        unsigned int misc_pcie_rx_eq_training : 1; /* 5 */
        unsigned int misc_pcie_tx_oneszeros : 1; /* 6 */
        unsigned int misc_pcie_rx_termination : 1; /* 7 */
        unsigned int misc_pcie_rate1 : 1; /* 8 */
        unsigned int misc_pcie_bypass_codec : 1; /* 9 */
        unsigned int misc_pcie_tx_pattern0 : 1; /* 10 */
        unsigned int misc_pcie_tx_pattern1 : 1; /* 11 */
        unsigned int misc_pcie_buf_mode : 1; /* 12 */
        unsigned int reserved1 : 1; /* 13 */
        unsigned int reserved2 : 1; /* 14 */
        unsigned int reserved3 : 17; /* 15:31 */
    } bits;
    unsigned int as_dword;
} hreg_ups_ctrl3;
#define PCIE_CTRL_RB_ups_ctrl3_OFF    0x07B4
#define PCIE_CTRL_RB_ups_ctrl3_REG \
    (PCIE_CTRL_RB_BASE + PCIE_CTRL_RB_ups_ctrl3_OFF)

/* UPS PHY配置寄存器 0x07B8 */
typedef union {
    struct {
        unsigned int misc_ups_phy_mode_0 : 1; /* 0 */
        unsigned int misc_ups_phy_mode_1 : 1; /* 1 */
        unsigned int misc_ups_serdes_arch : 1; /* 2 */
        unsigned int pcie_debug_sel : 1; /* 3 */
        unsigned int reserved0 : 28; /* 4:31 */
    } bits;
    unsigned int as_dword;
} hreg_ups_ctl0;
#define PCIE_CTRL_RB_UPS_CTL0_OFF    0x07B8
#define PCIE_CTRL_RB_UPS_CTL0_REG \
    (PCIE_CTRL_RB_BASE + PCIE_CTRL_RB_UPS_CTL0_OFF)

/*  0x7BC */
typedef union {
    struct {
        unsigned int test_rst_n : 1; /* 0 */
        unsigned int apb_resetn : 1; /* 1 */
        unsigned int phy_rst_h : 1; /* 2 */
        unsigned int phy_rst_l : 1; /* 3 */
        unsigned int iso_enb_l : 1; /* 4 */
        unsigned int iso_enb_h : 1; /* 5 */
        unsigned int reserved0 : 26; /* 6:31 */
    } bits;
    unsigned int as_dword;
} hreg_ups_phy_cfg2;
#define PCIE_CTRL_RB_UPS_PHY_CFG2_OFF    0x7BC
#define PCIE_CTRL_RB_UPS_PHY_CFG2_REG \
    (PCIE_CTRL_RB_BASE + PCIE_CTRL_RB_UPS_PHY_CFG2_OFF)

/*  0x07C0 */
typedef union {
    struct {
        unsigned int misc_pci_no_use0 : 32; /* 0:31 */
    } bits;
    unsigned int as_dword;
} hreg_upsphy_3to1_ctrl2;
#define PCIE_CTRL_RB_upsphy_3to1_ctrl2_OFF    0x07C0
#define PCIE_CTRL_RB_upsphy_3to1_ctrl2_REG \
    (PCIE_CTRL_RB_BASE + PCIE_CTRL_RB_upsphy_3to1_ctrl2_OFF)

/*  0x07C4 */
typedef union {
    struct {
        unsigned int misc_pci_no_use1 : 32; /* 0:31 */
    } bits;
    unsigned int as_dword;
} hreg_upsphy_3to1_ctrl3;
#define PCIE_CTRL_RB_upsphy_3to1_ctrl3_OFF    0x07C4
#define PCIE_CTRL_RB_upsphy_3to1_ctrl3_REG \
    (PCIE_CTRL_RB_BASE + PCIE_CTRL_RB_upsphy_3to1_ctrl3_OFF)

/*  0x07C8 */
typedef union {
    struct {
        unsigned int atb_sel : 2; /* 0:1 */
        unsigned int ldo_vrefsel : 3; /* 2:4 */
        unsigned int rcv_clk1_pwrdnb : 1; /* 5 */
        unsigned int rcv_clk0_pwrdnb : 1; /* 6 */
        unsigned int rcv_pwrdnb : 1; /* 7 */
        unsigned int rcv_dc_enb : 1; /* 8 */
        unsigned int rcv_div : 1; /* 9 */
        unsigned int drv_clk_sel : 1; /* 10 */
        unsigned int drv_term_ctrl : 4; /* 11:14 */
        unsigned int drv_amp_ctrl : 4; /* 15:18 */
        unsigned int drv_pwrdnb : 1; /* 19 */
        unsigned int io_mode_sel : 1; /* 20 */
        unsigned int reserved0 : 11; /* 21:31 */
    } bits;
    unsigned int as_dword;
} hreg_pcie_io;
#define PCIE_CTRL_RB_PCIE_IO_OFF    0x07C8
#define PCIE_CTRL_RB_PCIE_IO_REG \
    (PCIE_CTRL_RB_BASE + PCIE_CTRL_RB_PCIE_IO_OFF)

/*  0x0780 */
typedef union {
    struct {
        unsigned int upsphy_p2aux_clk_bypass : 1; /* 0 */
        unsigned int phy2pm_pipe_auxclk_en : 1; /* 1 */
        unsigned int reserved0 : 30; /* 2:31 */
    } bits;
    unsigned int as_dword;
} hreg_upsphy_clk_switch_bypass;
#define PCIE_CTRL_RB_UPSPHY_CLK_SWITCH_BYPASS_OFF    0x0780
#define PCIE_CTRL_RB_UPSPHY_CLK_SWITCH_BYPASS_REG \
    (PCIE_CTRL_RB_BASE + PCIE_CTRL_RB_UPSPHY_CLK_SWITCH_BYPASS_OFF)

/*  0x784 */
typedef union {
    struct {
        unsigned int pcie_phy_decode_err_status : 1; /* 0 */
        unsigned int reserved0 : 31; /* 1:31 */
    } bits;
    unsigned int as_dword;
} hreg_phy_rx_status_err_status;
#define PCIE_CTRL_RB_PHY_RX_STATUS_ERR_STATUS_OFF    0x784
#define PCIE_CTRL_RB_PHY_RX_STATUS_ERR_STATUS_REG \
    (PCIE_CTRL_RB_BASE + PCIE_CTRL_RB_PHY_RX_STATUS_ERR_STATUS_OFF)

/*  0x788 */
typedef union {
    struct {
        unsigned int phy_deocde_err_clr : 1; /* 0 */
        unsigned int pcie_phy_decode_err_mask : 1; /* 1 */
        unsigned int reserved0 : 30; /* 2:31 */
    } bits;
    unsigned int as_dword;
} hreg_phy_rx_status_err_control;
#define PCIE_CTRL_RB_PHY_RX_STATUS_ERR_CONTROL_OFF    0x788
#define PCIE_CTRL_RB_PHY_RX_STATUS_ERR_CONTROL_REG \
    (PCIE_CTRL_RB_BASE + PCIE_CTRL_RB_PHY_RX_STATUS_ERR_CONTROL_OFF)

/*  0x790 */
typedef union {
    struct {
        unsigned int phy_apb_timeout_value : 6; /* 0:5 */
        unsigned int reserved0 : 26; /* 6:31 */
    } bits;
    unsigned int as_dword;
} hreg_phy_apb_timeout_rpotect;
#define PCIE_CTRL_RB_PHY_APB_TIMEOUT_RPOTECT_OFF    0x790
#define PCIE_CTRL_RB_PHY_APB_TIMEOUT_RPOTECT_REG \
    (PCIE_CTRL_RB_BASE + PCIE_CTRL_RB_PHY_APB_TIMEOUT_RPOTECT_OFF)

/*  0x820 */
typedef union {
    struct {
        unsigned int cldo2_osc_ring_en : 1; /* 0 */
        unsigned int cldo2_osc_ring_sel : 2; /* 1:2 */
        unsigned int reserved0 : 29; /* 3:31 */
    } bits;
    unsigned int as_dword;
} hreg_cldo2_osc_ring_ctrl;
#define PCIE_CTRL_RB_CLDO2_OSC_RING_CTRL_OFF    0x820
#define PCIE_CTRL_RB_CLDO2_OSC_RING_CTRL_REG \
    (PCIE_CTRL_RB_BASE + PCIE_CTRL_RB_CLDO2_OSC_RING_CTRL_OFF)

/*  0x850 */
typedef union {
    struct {
        unsigned int wlmac_wr_back_fifo_clr : 1; /* 0 */
        unsigned int wlmac_wr_back_fifo_werror : 1; /* 1 */
        unsigned int wlmac_wr_back_fifo_rerror : 1; /* 2 */
        unsigned int reserved0 : 29; /* 3:31 */
    } bits;
    unsigned int as_dword;
} hreg_wlmac_write_back_fifo_dbg;
#define PCIE_CTRL_RB_WLMAC_WRITE_BACK_FIFO_DBG_OFF    0x850
#define PCIE_CTRL_RB_WLMAC_WRITE_BACK_FIFO_DBG_REG \
    (PCIE_CTRL_RB_BASE + PCIE_CTRL_RB_WLMAC_WRITE_BACK_FIFO_DBG_OFF)
...
typedef union {
    ...
    unsigned int as_dword;
} hreg_wlmac_write_back_write1;
#define PCIE_CTRL_RB_WLMAC_WRITE_BACK_WRITE1_OFF    0x860
#define PCIE_CTRL_RB_WLMAC_WRITE_BACK_WRITE1_REG \
    (PCIE_CTRL_RB_BASE + PCIE_CTRL_RB_WLMAC_WRITE_BACK_WRITE1_OFF)
...
typedef union {
    ...
    unsigned int as_dword;
} hreg_wlmac_write_back_write2;
#define PCIE_CTRL_RB_WLMAC_WRITE_BACK_WRITE2_OFF    0x864
#define PCIE_CTRL_RB_WLMAC_WRITE_BACK_WRITE2_REG \
    (PCIE_CTRL_RB_BASE + PCIE_CTRL_RB_WLMAC_WRITE_BACK_WRITE2_OFF)

/*  0x900 */
typedef union {
    struct {
        unsigned int remap_atu_tx_l : 32; /* 0:31 */
    } bits;
    unsigned int as_dword;
} hreg_remap_atu_tx_mask_l;
#define PCIE_CTRL_RB_REMAP_ATU_TX_MASK_L_OFF    0x900
#define PCIE_CTRL_RB_REMAP_ATU_TX_MASK_L_REG \
    (PCIE_CTRL_RB_BASE + PCIE_CTRL_RB_REMAP_ATU_TX_MASK_L_OFF)

/*  0x904 */
typedef union {
    struct {
        unsigned int remap_atu_tx_h : 16; /* 0:15 */
        unsigned int reserved0 : 16; /* 16:31 */
    } bits;
    unsigned int as_dword;
} hreg_remap_atu_tx_mask_h;
#define PCIE_CTRL_RB_REMAP_ATU_TX_MASK_H_OFF    0x904
#define PCIE_CTRL_RB_REMAP_ATU_TX_MASK_H_REG \
    (PCIE_CTRL_RB_BASE + PCIE_CTRL_RB_REMAP_ATU_TX_MASK_H_OFF)

/*  0x908 */
typedef union {
    struct {
        unsigned int remap_atu_rx_l : 32; /* 0:31 */
    } bits;
    unsigned int as_dword;
} hreg_remap_atu_rx_mask_l;
#define PCIE_CTRL_RB_REMAP_ATU_RX_MASK_L_OFF    0x908
#define PCIE_CTRL_RB_REMAP_ATU_RX_MASK_L_REG \
    (PCIE_CTRL_RB_BASE + PCIE_CTRL_RB_REMAP_ATU_RX_MASK_L_OFF)

/*  0x90C */
typedef union {
    struct {
        unsigned int remap_atu_rx_h : 16; /* 0:15 */
        unsigned int reserved0 : 16; /* 16:31 */
    } bits;
    unsigned int as_dword;
} hreg_remap_atu_rx_mask_h;
#define PCIE_CTRL_RB_REMAP_ATU_RX_MASK_H_OFF    0x90C
#define PCIE_CTRL_RB_REMAP_ATU_RX_MASK_H_REG \
    (PCIE_CTRL_RB_BASE + PCIE_CTRL_RB_REMAP_ATU_RX_MASK_H_OFF)

/*  0x910 */
typedef union {
    struct {
        unsigned int remap_pl_reg_l : 32; /* 0:31 */
    } bits;
    unsigned int as_dword;
} hreg_remap_pl_reg_mask_l;
#define PCIE_CTRL_RB_REMAP_PL_REG_MASK_L_OFF    0x910
#define PCIE_CTRL_RB_REMAP_PL_REG_MASK_L_REG \
    (PCIE_CTRL_RB_BASE + PCIE_CTRL_RB_REMAP_PL_REG_MASK_L_OFF)

/*  0x914 */
typedef union {
    struct {
        unsigned int remap_pl_reg_h : 16; /* 0:15 */
        unsigned int reserved0 : 16; /* 16:31 */
    } bits;
    unsigned int as_dword;
} hreg_remap_pl_reg_mask_h;
#define PCIE_CTRL_RB_REMAP_PL_REG_MASK_H_OFF    0x914
#define PCIE_CTRL_RB_REMAP_PL_REG_MASK_H_REG \
    (PCIE_CTRL_RB_BASE + PCIE_CTRL_RB_REMAP_PL_REG_MASK_H_OFF)

/*  0x920 */
typedef union {
    struct {
        unsigned int remap_glb_bypass : 1; /* 0 */
        unsigned int remap_atu_bypass : 1; /* 1 */
        unsigned int remap_pl_bypass : 1; /* 2 */
        unsigned int remap_pl_pcie_cfg_en : 1; /* 3 */
        unsigned int reserved0 : 28; /* 4:31 */
    } bits;
    unsigned int as_dword;
} hreg_remap_bypass_reg;
#define PCIE_CTRL_RB_REMAP_BYPASS_REG_OFF    0x920
#define PCIE_CTRL_RB_REMAP_BYPASS_REG_REG \
    (PCIE_CTRL_RB_BASE + PCIE_CTRL_RB_REMAP_BYPASS_REG_OFF)
