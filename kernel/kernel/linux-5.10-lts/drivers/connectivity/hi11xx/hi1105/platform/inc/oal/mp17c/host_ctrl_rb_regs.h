...
#ifndef MP17C_HOST_CTRL_RB_REGS_H
#define MP17C_HOST_CTRL_RB_REGS_H

/* This file is generated automatically. Do not modify it */
#define HOST_CTRL_RB_BASE    (0x04985000)
...
typedef union {
    ...
    unsigned int as_dword;
} hreg_host_crg_autocg_bypass;
#define HOST_CTRL_RB_HOST_CRG_AUTOCG_BYPASS_OFF    0xd0c
#define HOST_CTRL_RB_HOST_CRG_AUTOCG_BYPASS_REG \
    (HOST_CTRL_RB_BASE + HOST_CTRL_RB_HOST_CRG_AUTOCG_BYPASS_OFF)
...
typedef union {
    struct {
        unsigned int ete_cg_fsm_sts : 3; /* 0:2 */
        unsigned int reserved0 : 29; /* 3:31 */
    } bits;
    unsigned int as_dword;
} hreg_ete_auto_cg_sts;
#define HOST_CTRL_RB_ETE_AUTO_CG_STS_OFF    0xF78
#define HOST_CTRL_RB_ETE_AUTO_CG_STS_REG \
    (HOST_CTRL_RB_BASE + HOST_CTRL_RB_ETE_AUTO_CG_STS_OFF)
