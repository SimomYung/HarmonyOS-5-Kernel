...
#ifdef CONFIG_HISI_WIFI7_MLO
extern void oal_inform_assoc_link_id(oal_net_device_stru *net_device, uint8_t event_type);
#endif
...
extern uint32_t oal_cfg80211_new_sta(oal_net_device_stru *pst_net_device,
                                     ...
                                     oal_gfp_enum_uint8 en_gfp);
extern void oal_cfg80211_mic_failure(oal_net_device_stru *net_device,
...
extern void oal_kobject_uevent_env_sta_join(oal_net_device_stru *pst_net_device,
                                            const uint8_t *puc_mac_addr);
extern void oal_kobject_uevent_env_sta_leave(oal_net_device_stru *net_device, const unsigned char *mac_addr);
#endif
...
#endif
#endif
extern void oal_cfg80211_pmksa_candidate_notify(oal_net_device_stru *dev, int index,
    const uint8_t *bssid, bool preauth, oal_gfp_enum_uint8 gfp);
