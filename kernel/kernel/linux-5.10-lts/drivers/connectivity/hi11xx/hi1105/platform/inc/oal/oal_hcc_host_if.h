...
typedef int32_t (*hmac_tcp_ack_process_func)(uint32_t dev_id);
typedef oal_bool_enum_uint8 (*hmac_tcp_ack_need_schedule_func)(uint32_t dev_id);
#else
...
extern unsigned long g_hcc_ready_msg_time;
