...
struct oal_bssid_infomation {
    ...
    uint8_t bit_delay_block_ack : 1,           /* 能力位: 阻塞延迟应答 */
            ...
            bit_very_high_throughput : 1,
            bit_ftm : 1,
            bit_high_efficiency : 1,
            bit_er_bss : 1;
    uint8_t bit_colocated_ap : 1,
            bit_probe_rsp_active : 1,
            bit_members_colocated_ap : 1,
            bit_oct_supported : 1,
            bit_colocated_with_6g : 1,
            bit_extremely_high_throughput : 1,
            bit_resv1 : 2;
    uint8_t bit_resv3;
} DECLARE_PACKED;
...
/* 函数声明 */
extern oal_bool_enum_uint8 oal_netbuf_is_dhcp_port(oal_udp_header_stru *udp_hdr);
extern oal_bool_enum_uint8 oal_netbuf_is_nd(oal_ipv6hdr_stru *ipv6hdr);
extern oal_bool_enum_uint8 oal_netbuf_is_dhcp6(oal_ipv6hdr_stru *ipv6hdr);

extern oal_bool_enum_uint8 oal_netbuf_is_tcp_ack6(oal_ipv6hdr_stru *ipv6hdr);
extern uint16_t oal_netbuf_select_queue(oal_netbuf_stru *pst_buf);
extern oal_bool_enum_uint8 oal_netbuf_is_tcp_ack(oal_ip_header_stru *ip_hdr);
extern oal_bool_enum_uint8 oal_netbuf_is_icmp(oal_ip_header_stru *ip_hdr);
