...
typedef enum {
    ...
    OAL_ERR_CODE_SECURITY_INSTALL_BIGTK = (OAL_ERR_CODE_SECURITY_BASE + 21),
    OAL_ERR_CODE_SECURITY_GET_BIGTK = (OAL_ERR_CODE_SECURITY_BASE + 22),
    ...
    /* multi link特性 */
    OAL_ERR_CODE_ML_BASE = 30300,
    OAL_ERR_CODE_ML_MISMATCH_LINK_BSS = (OAL_ERR_CODE_ML_BASE + 0),
    OAL_ERR_CODE_ML_LINK_SWITCH_REFUSE = (OAL_ERR_CODE_ML_BASE + 1),
