...
#define  PCIE_HISI_VENDOR_ID_MPXX        (0xED2E)
...
#define  PCIE_HISI_DEVICE_ID_MP17CMPW    (0xa001)
#define  PCIE_HISI_DEVICE_ID_MP17C       (0xa002)
#define  PCIE_HISI_DEVICE_ID_MP12        (0xEEED)
...
typedef struct _pcie_wlan_callback_group_ {
    ...
    pcie_callback_stru pcie_mac_common_isr_callback;
} pcie_wlan_callback_group_stru;

typedef struct {
    pcie_callback_stru pcie_d2h_rx_isr_cb;
} pcie_frw_cb_group_stru;
...
extern int32_t g_pcie_rc_idx_dual;
...
int32_t oal_pcie_get_link_quality_info(hcc_bus *pst_bus, uint32_t *h2d_ber, uint32_t *d2h_ber);
...
extern int32_t g_pcie_pm_linkdown_switch;
extern int32_t g_wlan_wakeup_delay_enable;
