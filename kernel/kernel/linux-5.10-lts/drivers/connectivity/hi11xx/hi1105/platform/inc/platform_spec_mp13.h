...
#define WLAN_CHIP_MAX_NUM_PER_BOARD 2
#else
#define WLAN_CHIP_MAX_NUM_PER_BOARD 1
#endif
#define WLAN_VAP_SUPPORT_MAX_NUM_LIMIT 6

#define WLAN_MEM_MIB_SIZE1 1320 /* mib结构体大小 */
#define WLAN_MEM_MIB_CNT1  5    /* mib结构体数量,对齐业务vap数量 */

#ifdef _PRE_PRODUCT_ID_E5
#define SDT_USER_MAX_USER_LIMIT 36
#else
...
#define GT_DEVICE_MAX_NUM_PER_CHIP 2 /* 每个chip支持hal device的最大个数，HOST按最大规格定义,HOST看不见DBDC规格 */
/* 整个BOARD支持的最大的hal device数目 */
#define GT_DEVICE_SUPPORT_MAX_NUM_SPEC (WLAN_CHIP_MAX_NUM_PER_BOARD * GT_DEVICE_MAX_NUM_PER_CHIP)

#define GT_SERVICE_DEVICE_MAX_NUM_PER_CHIP 1 /* 每个chip支持业务device的最大个数 */
#define GT_SERVICE_DEVICE_SUPPORT_MAX_NUM_SPEC (WLAN_CHIP_MAX_NUM_PER_BOARD * GT_SERVICE_DEVICE_MAX_NUM_PER_CHIP)

#define GT_SERVICE_AP_MAX_NUM_PER_DEVICE  2 /* 业务AP的规格，将之前的WLAN_SERVICE_VAP_MAX_NUM_PER_DEVICE修改 */
#define GT_SERVICE_STA_MAX_NUM_PER_DEVICE 3 /* 业务STA的规格 */
#define GT_AP_STA_COEXIST_VAP_NUM         0 /* 业务ap sta共存时vap数目,mp13后续有STA+AP共存的情况 */
...
#define GT_WLAN_SERVICE_VAP_MAX_NUM_PER_DEVICE 5   /* GT业务VAP个数(原本应该用AP个数+STA个数（这个表示芯片最大支持能力 */

/* 整个BOARD支持的最大的GT VAP数目 */
#define GT_VAP_SUPPORT_MAX_NUM_LIMIT  \
    (GT_CONFIG_VAP_MAX_NUM_PER_DEVICE + GT_SERVICE_VAP_MAX_NUM_PER_DEVICE)

/* 整个BOARD支持的最大GT业务VAP的数目不包括配置vap */
#define GT_SERVICE_VAP_SUPPORT_MAX_NUM_LIMIT GT_SERVICE_VAP_MAX_NUM_PER_DEVICE

#define GT_ASSOC_USER_MAX_NUM 16 /* mp16关联用户的最大个数 */
/*
 ...
 */
#define GT_USER_MAX_USER_LIMIT 20
