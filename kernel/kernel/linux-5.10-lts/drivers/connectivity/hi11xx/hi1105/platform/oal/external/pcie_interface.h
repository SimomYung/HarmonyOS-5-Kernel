...
int bsp_pcie_enumerate(u32 rc_id);
int bsp_iot_pcie_power_on(u32 rc_id);
int bsp_iot_pcie_power_off(u32 rc_id);
int bsp_pcie_power_notifiy_register(u32 rc_id, int (*poweron)(void *data),
                                    int (*poweroff)(void *data), void *data);
