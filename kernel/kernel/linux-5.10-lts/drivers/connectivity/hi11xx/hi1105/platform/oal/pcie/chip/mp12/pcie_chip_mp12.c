...
#include "mp12/host_ctrl_rb_regs.h"
...
#undef THIS_FILE_ID
#define THIS_FILE_ID OAM_FILE_ID_PCIE_CHIP_MP12_C
...
#define W_TRACE_CTL_RB_BASE         0x04190000
...
#define DEV_PCIE_SDIO_SEL           0x64 /* mp12 寄存器地址与mp6c不同 */
...
static pcie_phy_adapter g_pcie_phyv2_adapter[] = {
    {NULL, MP12_PCIE_PHY_DA_RX0_CDR_KI_OFF, 16, 16, 0x0},
    {NULL, MP12_PCIE_PHY_RX_GS_ATT_OFF, 0, 9, 0x1FF},
    {NULL, MP12_PCIE_PHY_RX_GS_ATT_OFF, 16, 12, 0x222},
    {NULL, MP12_PCIE_PHY_RX_GS_GAIN_OFF, 0, 12, 0x0},
    {NULL, MP12_PCIE_PHY_RX_GS_GAIN_OFF, 16, 12, 0x444},
    {NULL, MP12_PCIE_PHY_GS_ADAPE_OFF, 0, 1, 0x1},
    {NULL, MP12_PCIE_PHY_GS_ADAPE_OFF, 2, 1, 0x0},
    {NULL, MP12_PCIE_PHY_GS_ADAPE_OFF, 4, 1, 0x1},
    {NULL, MP12_PCIE_PHY_GS_ADAPE_OFF, 5, 1, 0x1},
    {NULL, MP12_PCIE_PHY_GS_WINDOW_OFF, 2, 2, 0x1},
    {NULL, MP12_PCIE_PHY_GS_WINDOW_OFF, 6, 2, 0x1},
    {NULL, MP12_PCIE_PHY_GS_WINDOW_OFF, 8, 2, 0x1},
    {NULL, MP12_PCIE_PHY_RXCTRL_GSA_OFF, 4, 1, 0x1},
    {NULL, MP12_PCIE_PHY_RXCTRL_GSA_OFF, 23, 4, 0xC},
    {NULL, MP12_PCIE_PHY_RX_EQ_CFG_OFF, 4, 2, 0x1},
    {NULL, MP12_PCIE_PHY_RX_EQ_CFG_OFF, 8, 1, 0x1},
    {NULL, MP12_PCIE_PHY_RX_EQ_CFG_OFF, 16, 8, 0x30},
    {NULL, MP12_PCIE_PHY_GL_KI_FINE_OFF, 0, 3, 0x5},
    {NULL, MP12_PCIE_PHY_DA_RX0_CDR_KP_OFF, 21, 3, 0x5},
    {NULL, MP12_PCIE_PHY_EBUF_RD_THRD_OFF, 8, 8, 0x20},
    {NULL, MP12_PCIE_PHY_DCC_WAIT_TIMER_OFF, 6, 4, 0x5},
    {NULL, MP12_PCIE_PHY_DCC_WAIT_TIMER_OFF, 10, 4, 0x8},
    {NULL, MP12_PCIE_PHY_TERMKCTRL0_OFF, 0, 8, 0x7B},
};
...
static uintptr_t oal_pcie_get_pcs_paddr_mp12(oal_pci_dev_stru *pst_pci_dev, oal_pcie_res *pst_pci_res,
                                             uint32_t dump_type)
{
    int32_t ret;
    pci_addr_map st_map;
    uint32_t phy_paddr = MP12_PCIE_PHY_BASE_ADDRESS;
...
static void* oal_pcie_get_ctrl_address_mp12(oal_pci_dev_stru *pst_pci_dev, oal_pcie_res *pst_pci_res)
{
...
int32_t oal_pcie_get_bar_region_info_mp12(oal_pcie_res *pst_pci_res, oal_pcie_region **, uint32_t *);
...
{
    return 0x800000; // pkt mem for test, by acp port
}

static int32_t oal_pcie_voltage_bias_init_mp12(oal_pcie_res *pst_pci_res)
{
    oal_print_mpxx_log(MPXX_LOG_ERR, "oal_pcie_chip_info_init_mp12 is not implement!");
    return OAL_SUCC;
}

static int32_t oal_pcie_host_slave_address_switch_mp12(oal_pcie_res *pst_pci_res, uint64_t src_addr,
...
static int32_t oal_pcie_dyn_mp12(oal_pcie_res *pst_pci_res, uint32_t request_speed)
{
    oal_udelay(50); // delay 50 us
    return OAL_SUCC;
}

static int32_t oal_pcie_config_slave_mp12(oal_pcie_res *pst_pci_res, oal_pci_slave_config_type slave_type)
{
    int32_t ret;
...
OAL_STATIC void oal_frw_msg_int_mask_mp12(oal_pcie_res *pst_pci_res)
{
    hreg_host_intr_mask intr_mask;
...
OAL_STATIC void oal_frw_msg_int_unmask_mp12(oal_pcie_res *pst_pci_res)
{
    hreg_host_intr_mask intr_mask;
...
static int32_t oal_pcie_check_gen_mp12(oal_pci_dev_stru *pst_pci_dev, oal_pcie_res *pst_pci_res)
{
    void *pcie_ctrl = NULL;
    uint32_t link_speed;
...
static int32_t oal_pcie_check_ltssm_mp12(oal_pci_dev_stru *pst_pci_dev, oal_pcie_res *pst_pci_res)
{
    void *pcie_ctrl = NULL;
    uint32_t link_sts;
    pcie_ctrl = oal_pcie_get_ctrl_address(pst_pci_dev, pst_pci_res);
...
static void oal_pcie_get_link_spend_sts_mp12(oal_pci_dev_stru *pst_pci_dev, oal_pcie_res *pst_pci_res,
...
static void oal_pcie_chip_info_cb_init(pcie_chip_cb *cb, int32_t device_id)
{
    ...
    cb->pcie_config_slave = oal_pcie_config_slave_mp12;
    cb->pcie_voltage_bias_init = oal_pcie_voltage_bias_init_mp12;
    cb->pcie_get_bar_region_info = oal_pcie_get_bar_region_info_mp12;
    cb->pcie_set_outbound_membar = oal_pcie_set_outbound_membar_mp12;
    cb->pcie_set_inbound_membar = oal_pcie_set_inbound_membar_mp12;
    cb->pcie_host_slave_address_switch = oal_pcie_host_slave_address_switch_mp12;
    ...
    cb->pcie_dyn_change_linkspeed = oal_pcie_dyn_mp12;
    cb->frw_msg_int_mask = oal_frw_msg_int_mask_mp12;
    cb->frw_msg_int_unmask = oal_frw_msg_int_unmask_mp12;
    cb->pcie_check_gen = oal_pcie_check_gen_mp12;
    cb->pcie_check_ltssm = oal_pcie_check_ltssm_mp12;
    cb->pcie_get_link_spend_sts = oal_pcie_get_link_spend_sts_mp12;
    cb->pcie_get_ctrl_address = oal_pcie_get_ctrl_address_mp12;
    cb->pcie_get_pcs_paddr = oal_pcie_get_pcs_paddr_mp12;
}

int32_t oal_pcie_chip_info_init_mp12(oal_pcie_res *pst_pci_res, int32_t device_id)
{
    oal_print_mpxx_log(MPXX_LOG_INFO, "oal_pcie_chip_info_init_mp12");
...
static int32_t oal_pcie_linkup_prepare_fixup(int32_t ep_idx)
{
    ...
    oal_pcie_device_phy_config_by_ssi(MP12_PCIE_PHY_BASE_ADDRESS);
#endif
    if (pcs_trace_linkup_flag() == 0) {
        return OAL_SUCC;
    }
    pcie_pcs_tracer_start(MP12_PCIE_PHY_BASE_ADDRESS, PCS_TRACER_LINK, 0, PCIE_PCS_DUMP_BY_SSI);
...
static int32_t oal_pcie_linkup_fail_fixup(int32_t ep_idx)
{
    ...
    pcie_pcs_tracer_dump(MP12_PCIE_PHY_BASE_ADDRESS, 0, PCIE_PCS_DUMP_BY_SSI);
    return OAL_SUCC;
}
