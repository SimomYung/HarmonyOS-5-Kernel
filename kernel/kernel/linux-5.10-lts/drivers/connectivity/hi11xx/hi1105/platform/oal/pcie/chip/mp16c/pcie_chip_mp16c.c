...
static pcie_phy_adapter g_pcie_phy_adapter[] = {
...
static pcie_phy_adapter g_pcie_phyv2_adapter[] = {
    {NULL, MP16C_PCIE_PHY_PLL_CKGCTRLR0_OFF, 6, 11, 0x0},
    {NULL, MP16C_PCIE_PHY_PLL_CKGCTRLR1_OFF, 6, 11, 0x0},
    {NULL, MP16C_PCIE_PHY_DA_RX0_CDR_KI_OFF, 16, 16, 0x0},
    {NULL, MP16C_PCIE_PHY_RX_GS_ATT_OFF, 0, 9, 0x1FF},
    {NULL, MP16C_PCIE_PHY_RX_GS_ATT_OFF, 16, 12, 0x222},
    {NULL, MP16C_PCIE_PHY_RX_GS_GAIN_OFF, 0, 12, 0x0},
    {NULL, MP16C_PCIE_PHY_RX_GS_GAIN_OFF, 16, 12, 0x222},
    {NULL, MP16C_PCIE_PHY_GS_ADAPE_OFF, 0, 1, 0x1},
    {NULL, MP16C_PCIE_PHY_GS_ADAPE_OFF, 2, 1, 0x0},
    {NULL, MP16C_PCIE_PHY_GS_ADAPE_OFF, 4, 2, 0x3},
    {NULL, MP16C_PCIE_PHY_GS_WINDOW_OFF, 2, 1, 0x1},
    {NULL, MP16C_PCIE_PHY_GS_WINDOW_OFF, 6, 4, 0x5},
    {NULL, MP16C_PCIE_PHY_RXCTRL_GSA_OFF, 23, 4, 0xC},
    {NULL, MP16C_PCIE_PHY_RXCTRL_GSA_OFF, 4, 1, 0x1},
    {NULL, MP16C_PCIE_PHY_RX_EQ_CFG_OFF, 16, 8, 0x30},
    {NULL, MP16C_PCIE_PHY_RX_EQ_CFG_OFF, 8, 1, 0x1},
    {NULL, MP16C_PCIE_PHY_RX_EQ_CFG_OFF, 4, 2, 0x1},
    {NULL, MP16C_PCIE_PHY_RXUPDTCTRL_OFF, 28, 3, 0x7},
    {NULL, MP16C_PCIE_PHY_GL_KI_FINE_OFF, 0, 3, 0x5},
    {NULL, MP16C_PCIE_PHY_DA_RX0_CDR_KP_OFF, 21, 3, 0x5},
    {NULL, MP16C_PCIE_PHY_EBUF_RD_THRD_OFF, 8, 8, 0x20},
    {NULL, MP16C_PCIE_PHY_DCC_WAIT_TIMER_OFF, 6, 8, 0x85},
    {NULL, MP16C_PCIE_PHY_TERMKCTRL0_OFF, 0, 8, 0x7A},
    {NULL, MP16C_PCIE_PHY_PMA_INTF_LANE_SIG_CTRL_EN_0_OFF, 1, 2, 0x3},
    {NULL, MP16C_PCIE_PHY_PMA_INTF_LANE_SIG_CTRL_EN_0_OFF, 1, 6, 0x0},
    {NULL, MP16C_PCIE_PHY_PMA_INTF_LANE_SIG_CTRL_EN_2_OFF, 0, 4, 0xF},
    {NULL, MP16C_PCIE_PHY_PMA_INTF_LANE_SIG_CTRL_VAL_2_OFF, 0, 11, 0x600},
};
...
int32_t oal_pcie_get_phy_adapter_info_mp16c(pcie_phy_adapter **phy_adapter, uint32_t *phy_adapter_size)
{
    if (get_mpxx_subchip_version() == CHIP_VERSION_MPW) {
        ...
        *phy_adapter_size = (uint32_t)oal_array_size(g_pcie_phy_adapter);
        *phy_adapter = g_pcie_phy_adapter;
    }
    return OAL_SUCC;
}
...
static uintptr_t oal_pcie_get_pcs_paddr_mp16c(oal_pci_dev_stru *pst_pci_dev, oal_pcie_res *pst_pci_res,
                                              uint32_t dump_type)
{
    int32_t ret;
    pci_addr_map st_map;
...
static void* oal_pcie_get_ctrl_address_mp16c(oal_pci_dev_stru *pst_pci_dev, oal_pcie_res *pst_pci_res)
{
...
int32_t oal_pcie_set_inbound_membar_mp16c(oal_pcie_res *pst_pci_res);
...
static int32_t oal_pcie_check_gen_mp16c(oal_pci_dev_stru *pst_pci_dev, oal_pcie_res *pst_pci_res)
{
    void *pcie_ctrl = NULL;
    uint32_t link_speed;
...
static int32_t oal_pcie_check_ltssm_mp16c(oal_pci_dev_stru *pst_pci_dev, oal_pcie_res *pst_pci_res)
{
    void *pcie_ctrl = NULL;
    uint32_t link_sts;
    pcie_ctrl = oal_pcie_get_ctrl_address(pst_pci_dev, pst_pci_res);
...
static void oal_pcie_get_link_spend_sts_mp16c(oal_pci_dev_stru *pst_pci_dev, oal_pcie_res *pst_pci_res,
...
static void oal_pcie_chip_info_cb_init(pcie_chip_cb *cb, int32_t device_id)
{
    ...
    cb->pcie_set_inbound_membar = oal_pcie_set_inbound_membar_mp16c;
    ...
    cb->pcie_check_gen = oal_pcie_check_gen_mp16c;
    cb->pcie_check_ltssm = oal_pcie_check_ltssm_mp16c;
    cb->pcie_get_link_spend_sts = oal_pcie_get_link_spend_sts_mp16c;
    cb->pcie_get_ctrl_address = oal_pcie_get_ctrl_address_mp16c;
    cb->pcie_get_pcs_paddr = oal_pcie_get_pcs_paddr_mp16c;
}
...
int32_t oal_pcie_chip_info_init_mp16c(oal_pcie_res *pst_pci_res, int32_t device_id)
{
    ...
    if (get_mpxx_subchip_version() == CHIP_VERSION_MPW) {
        pst_pci_res->chip_info.phy_version = PCIE_PHY_VERSION2; // 支持phy2.0
    } else {
...
static int32_t oal_pcie_linkup_prepare_fixup(int32_t ep_idx)
{
    ...
    pcie_pcs_tracer_start(MP16C_PCIE_PHY_BASE_ADDRESS, PCS_TRACER_LINK, 0, PCIE_PCS_DUMP_BY_SSI);
...
static int32_t oal_pcie_linkup_fail_fixup(int32_t ep_idx)
{
    ...
    pcie_pcs_tracer_dump(MP16C_PCIE_PHY_BASE_ADDRESS, 0, PCIE_PCS_DUMP_BY_SSI);
    return OAL_SUCC;
}
