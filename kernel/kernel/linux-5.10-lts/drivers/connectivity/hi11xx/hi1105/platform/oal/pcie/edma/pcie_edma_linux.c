...
OAL_STATIC int32_t oal_pcie_edma_power_action(hcc_bus *pst_bus, hcc_bus_power_action_type action)
{
    ...
    if (action == HCC_BUS_POWER_UP) {
        ...
        ret = oal_pcie_pm_control(pst_pci_lres->pst_pcie_dev, g_pcie_rc_idx, PCIE_POWER_ON);
        ...
        oal_pcie_power_notifiy_register(pst_pci_lres->pst_pcie_dev, g_pcie_rc_idx, NULL, NULL, NULL);
        if (ret) {
...
OAL_STATIC int32_t oal_pcie_edma_suspend_handler(void *data)
{
    ...
    oal_pcie_power_notifiy_register(pst_pci_lres->pst_pcie_dev, g_pcie_rc_idx,
...
int32_t oal_pcie_edma_suspend(oal_pci_dev_stru *pst_pci_dev, oal_pm_message_t state)
{
    ...
    oal_pcie_power_notifiy_register(pst_pci_lres->pst_pcie_dev, g_pcie_rc_idx, NULL,
