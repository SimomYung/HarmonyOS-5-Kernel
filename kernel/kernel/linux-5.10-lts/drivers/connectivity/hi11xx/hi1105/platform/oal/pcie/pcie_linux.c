...
OAL_STATIC const oal_pci_device_id_stru g_pcie_id_tab[] = {
    ...
    { PCIE_HISI_VENDOR_ID_0, PCIE_HISI_DEVICE_ID_MP12, PCI_ANY_ID, PCI_ANY_ID }, /* mp12 tmp PCIE */
    { 0, }
};
...
{
    ktime_t time_start, time_devack;
    uint64_t trans_devack_us;
    uint64_t wakeup_delay_us;

    time_start = ktime_get();
    oal_pcie_ete_wake_powerup_handler(data);
