...
OAL_STATIC int32_t pcie_pcs_deye_cali_dfe(pcs_reg_ops *reg_ops, uintptr_t base_addr, uint8_t *buff, int32_t size)
{
    uint32_t value;
    int32_t ret = 0;
    int32_t offset = 0;
...
OAL_STATIC int32_t pcie_pcs_deye_cali_ctle_p1(pcs_reg_ops *reg_ops, uintptr_t base_addr, uint8_t *buff, int32_t size)
{
    uint32_t value;
    int32_t ret = 0;
    int32_t offset = 0;
...
OAL_STATIC int32_t pcie_pcs_deye_cali_ctle_p2(pcs_reg_ops *reg_ops, uintptr_t base_addr, uint8_t *buff, int32_t size)
{
    uint32_t value;
    int32_t ret = 0;
    int32_t offset = 0;
...
uint32_t pcie_pcs_deye_para_result_printv1(pcs_reg_ops *reg_ops, uintptr_t base_addr, uint8_t *buff, int32_t size)
{
    ...
    ret = pcie_pcs_deye_cali_ctle_p1(reg_ops, base_addr, buff + offset, size - offset);
    if (ret <= 0) {
        return -OAL_ENOMEM;
    }
    offset += ret;

    ret = pcie_pcs_deye_cali_ctle_p2(reg_ops, base_addr, buff + offset, size - offset);
    if (ret <= 0) {
        return -OAL_ENOMEM;
    }
    offset += ret;

    ret = pcie_pcs_deye_cali_dfe(reg_ops, base_addr, buff + offset, size - offset);
    if (ret <= 0) {
        return -OAL_ENOMEM;
    }
    offset += ret;
