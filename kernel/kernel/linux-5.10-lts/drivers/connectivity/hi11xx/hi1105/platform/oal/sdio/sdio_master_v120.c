 ...
 *
 * Description:sdio master ip driver, v120
 * Author: @CompanyNameTag
 */

#define HISI_LOG_TAG "[SDIO_V120]"
#include "oal_util.h"
#include "oal_sdio_host_if.h"
#include "sdio_master_v120.h"

/* v120 sdio function1 registers */
...
#define HISDIO_REG_FUNC1_MSG_HIGH_FROM_DEV   0x2b  /* notify master, slave had got the msg, master rev the msg ack */

#define HISDIO_EXTEND_BASE_ADDR 0x30
#define HISDIO_FUNC1_EXTEND_REG_BASE 0x3c

int32_t sdio_master_ip_init_v120(struct oal_sdio *sdio)
{
    ...
    oal_print_mpxx_log(MPXX_LOG_INFO, "sdio master v120 ip init");
    return OAL_SUCC;
}
