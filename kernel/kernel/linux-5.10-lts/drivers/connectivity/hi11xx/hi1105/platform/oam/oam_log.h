...
#define get_vap_id(comb_para) (uint8_t)(((comb_para) >> 0x18) & 0xf)
#define get_log_lev(comb_para) (uint8_t)(((comb_para) >> 0x1c) & 0xf)
#define get_feature_id(comb_para) (uint8_t)(((comb_para) >> 0x10) & 0xff)
