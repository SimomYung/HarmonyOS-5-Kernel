...
#define WAIT_DEVACK_MSEC_MAX          100
...
#define WAIT_WKUP_DEVACK_TIMEOUT_MSEC 1500
...
#define PLAT_SUSPEND_TIMEOUT 1000   // suspend timeout 1000ms
...
enum BFGX_POWER_ON_EXCEPTION_ENUM {
    ...
    BFGX_POWER_ALREADY_DOWNLOAD = 11,   /* bfgx已加载 */
...
struct pm_top {
    ...
    struct wlan_pm_s *wlan_pm_info_dev1;
#endif
