...
typedef enum {
    ...
    WLAN_CFG_CAP_LP_CAP_SWITCH,
    WLAN_CFG_CAP_ENHANCED_PHY_CAP_SWITCH,
    ...
    WLAN_CFG_CAP_MIN_FAST_PS_IDLE_P2P,  // How many 20ms
    WLAN_CFG_CAP_MAX_FAST_PS_IDLE_P2P,
    WLAN_CFG_CAP_AUTO_FAST_PS_THRESH_SCREENON_P2P,
    WLAN_CFG_CAP_AUTO_FAST_PS_THRESH_SCREENOFF_P2P,
    ...
    WLAN_CFG_PHY_LUT_ACCESS,
#ifdef _PRE_WLAN_FEATURE_TAS_ANT_SWITCH
    WLAN_CFG_RF_RX_INSERTION_LOSS_DIFF_TAS,
    WLAN_CFG_RF_LP_RX_INSERTION_LOSS_DIFF_TAS,
    WLAN_CFG_RF_AMEND_RSSI_TAS,
    WLAN_CFG_TPC_RU_MAX_POW_DIFF_TAS,
    WLAN_CFG_MAX_TXPWR_BASE_DIFF_TAS,
#endif
    /* WUR定制化开关 */
    WLAN_CFG_SUPPORT_WUR_SWITCH,
    WLAN_CFG_FEM_TYPE,
    WLAN_CFG_DPD_SUPPORT_11B,
    /* MLSR链路切换算法开关 */
    WLAN_CFG_MLSR_SWITCH_ALG_EN,
    WLAN_CFG_MLSR_SWITCH_PPS_TH_L,
    WLAN_CFG_MLSR_SWITCH_PPS_TH_H,
    WLAN_CFG_MLSR_SWITCH_RSSI_TH_L,
    WLAN_CFG_MLSR_SWITCH_RSSI_TH_H,
    WLAN_CFG_MLSR_SWITCH_GOODPUT_TH,
    WLAN_CFG_MLSR_SWITCH_PREFER_FACTOR,

    WLAN_CFG_EMLSR_TRANSATION_DELAY,
    WLAN_CFG_EMLSR_PADDING_DELAY,
    WLAN_CFG_TRIANGLE_SLOPE,
    WLAN_CFG_TAS_GPIO,
    WLAN_CFG_SAR_SLIDE_POW_OFFSET,
    WLAN_CFG_SUPPORT_OMI_BW_SWITCH,
#ifdef _PRE_WLAN_FEATURE_TAS_ANT_SWITCH
    WLAN_CFG_TAS_ABF_EN_SWITCH,
#endif
    WLAN_CFG_COEX_FEATURE_BITMAP,
    WLAN_CFG_CAP_BUTT,
} wlan_cap_cfg_enum;
...
typedef struct {
    ...
    uint8_t wlan_go_assoc_user_max_num;
    uint8_t rsv;
