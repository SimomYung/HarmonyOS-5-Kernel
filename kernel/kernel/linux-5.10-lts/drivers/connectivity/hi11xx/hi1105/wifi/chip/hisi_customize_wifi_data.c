...
wlan_cust_cfg_cmd g_wifi_cfg_host[WLAN_CFG_HOST_BUTT] = {
    ...
    {"wlan_feature_miracast_sink",     WLAN_CFG_HOST_MIRACAST_SINK_SWITCH,
     &g_cust_cap.miracast_sink_switch, sizeof(g_cust_cap.miracast_sink_switch), WLAN_CUST_NUM_1, OAL_FALSE},
    ...
    {"chba_dbac_chan_follow_switch", WLAN_CFG_HOST_CHBA_DBAC_CHAN_FOLLOW_SWITCH,
     ...
     WLAN_CUST_NUM_1, OAL_FALSE},
#endif
    {"expand_feature_switch_bitmap", WLAN_CFG_HOST_EXPAND_FEATURE_SWITCH_BITMAP,
     &g_cust_cap.expand_feature_switch_bitmap, sizeof(g_cust_cap.expand_feature_switch_bitmap), WLAN_CUST_NUM_1,
     OAL_FALSE},
    {"reduce_pwr_2g_40mhz_channel_bitmap", WLAN_CFG_HOST_REDUCE_PWR_2G_40MHZ_CHANNEL_BITMAP,
     ...
     WLAN_CUST_NUM_1, OAL_FALSE},
    {"wlan_go_assoc_user_max_num", WLAN_CFG_HOST_WLAN_GO_ASSOC_USER_MAX_NUM,
     &g_cust_host.wlan_go_assoc_user_max_num, sizeof(g_cust_host.wlan_go_assoc_user_max_num),
     WLAN_CUST_NUM_1, OAL_FALSE},
};
...
wlan_cust_cfg_cmd g_wifi_cfg_cap[WLAN_CFG_CAP_BUTT] = {
    ...
    /* 11be协议增加定制化开关 */
    {"11be_switch_mask",          WLAN_CFG_CAP_11BE_SWITCH, &g_cust_cap.wifi_11be_switch_mask,
     sizeof(g_cust_cap.wifi_11be_switch_mask),   WLAN_CUST_NUM_1, OAL_FALSE},
    ...
    {"lp_cap_mask", WLAN_CFG_CAP_LP_CAP_SWITCH,
     &g_cust_cap.lp_cap_mask, sizeof(g_cust_cap.lp_cap_mask), WLAN_CUST_NUM_1, OAL_FALSE},
    {"enhanced_phy_cap_mask", WLAN_CFG_CAP_ENHANCED_PHY_CAP_SWITCH,
     &g_cust_cap.enhanced_phy_cap_mask, sizeof(g_cust_cap.enhanced_phy_cap_mask), WLAN_CUST_NUM_1, OAL_FALSE},
    ...
    {"min_fast_ps_idle_p2p", WLAN_CFG_CAP_MIN_FAST_PS_IDLE_P2P,
     &g_cust_cap.p2p_fast_ps.wlan_min_fast_ps_idle_p2p,
     sizeof(g_cust_cap.p2p_fast_ps.wlan_min_fast_ps_idle_p2p), WLAN_CUST_NUM_1, OAL_FALSE},
    {"max_fast_ps_idle_p2p", WLAN_CFG_CAP_MAX_FAST_PS_IDLE_P2P,
     &g_cust_cap.p2p_fast_ps.wlan_max_fast_ps_idle_p2p,
     sizeof(g_cust_cap.p2p_fast_ps.wlan_max_fast_ps_idle_p2p), WLAN_CUST_NUM_1, OAL_FALSE},
    {"auto_fast_ps_thresh_screen_on_p2p",  WLAN_CFG_CAP_AUTO_FAST_PS_THRESH_SCREENON_P2P,
     &g_cust_cap.p2p_fast_ps.wlan_auto_ps_thresh_screen_on_p2p,
     sizeof(g_cust_cap.p2p_fast_ps.wlan_auto_ps_thresh_screen_on_p2p), WLAN_CUST_NUM_1, OAL_FALSE},
    {"auto_fast_ps_thresh_screen_off_p2p", WLAN_CFG_CAP_AUTO_FAST_PS_THRESH_SCREENOFF_P2P,
     &g_cust_cap.p2p_fast_ps.wlan_auto_ps_thresh_screen_off_p2p,
     sizeof(g_cust_cap.p2p_fast_ps.wlan_auto_ps_thresh_screen_off_p2p), WLAN_CUST_NUM_1, OAL_FALSE},
    ...
    {"phy_lut_access", WLAN_CFG_PHY_LUT_ACCESS,
     &g_cust_cap.phy_lut_access, sizeof(g_cust_cap.phy_lut_access), WLAN_CUST_NUM_1, OAL_FALSE},
#ifdef _PRE_WLAN_FEATURE_TAS_ANT_SWITCH
    {"rf_rx_insertion_loss_diff_tas", WLAN_CFG_RF_RX_INSERTION_LOSS_DIFF_TAS, &g_cust_cap.rf_tas_loss_diff,
     sizeof(g_cust_cap.rf_tas_loss_diff), WLAN_CUST_NUM_1, OAL_FALSE},
    {"rf_lp_rx_insertion_loss_diff_tas", WLAN_CFG_RF_LP_RX_INSERTION_LOSS_DIFF_TAS, &g_cust_cap.rf_tas_lp_loss_diff,
     sizeof(g_cust_cap.rf_tas_lp_loss_diff), WLAN_CUST_NUM_1, OAL_FALSE},
    {"rf_rssi_amend_tas", WLAN_CFG_RF_AMEND_RSSI_TAS, &g_cust_cap.rf_tas_rssi_amend[0],
     sizeof(g_cust_cap.rf_tas_rssi_amend[0]), oal_array_size(g_cust_cap.rf_tas_rssi_amend), OAL_FALSE},
    {"cfg_tpc_ru_max_pow_diff_tas", WLAN_CFG_TPC_RU_MAX_POW_DIFF_TAS, &g_cust_cap.tas_tpc_ru_pow_diff,
     sizeof(g_cust_cap.tas_tpc_ru_pow_diff), WLAN_CUST_NUM_1, OAL_FALSE},
    {"nvram_max_txpwr_base_diff_tas", WLAN_CFG_MAX_TXPWR_BASE_DIFF_TAS, &g_cust_cap.tas_max_txpwr_base_diff,
     sizeof(g_cust_cap.tas_max_txpwr_base_diff), WLAN_CUST_NUM_1, OAL_FALSE},
#endif
    {"support_wur_switch", WLAN_CFG_SUPPORT_WUR_SWITCH,
     &g_cust_cap.support_wur_switch, sizeof(g_cust_cap.support_wur_switch), WLAN_CUST_NUM_1, OAL_FALSE},
    {"fem_type",  WLAN_CFG_FEM_TYPE,
     g_cust_cap.fem_type, sizeof(g_cust_cap.fem_type[0]), WLAN_CUST_NUM_3, OAL_FALSE},
    {"dpd_support_11b", WLAN_CFG_DPD_SUPPORT_11B,
     &g_cust_cap.dpd_support_11b, sizeof(g_cust_cap.dpd_support_11b), WLAN_CUST_NUM_1, OAL_FALSE},
    {"mlsr_switch_alg_en", WLAN_CFG_MLSR_SWITCH_ALG_EN,
     &g_cust_cap.mlsr_switch_alg_en, sizeof(g_cust_cap.mlsr_switch_alg_en), WLAN_CUST_NUM_1, OAL_FALSE},
    {"mlsr_switch_pps_low_th", WLAN_CFG_MLSR_SWITCH_PPS_TH_L,
     &g_cust_cap.mlsr_switch_pps_low_th, sizeof(g_cust_cap.mlsr_switch_pps_low_th), WLAN_CUST_NUM_1, OAL_FALSE},
    {"mlsr_switch_pps_high_th", WLAN_CFG_MLSR_SWITCH_PPS_TH_H,
     &g_cust_cap.mlsr_switch_pps_high_th, sizeof(g_cust_cap.mlsr_switch_pps_high_th), WLAN_CUST_NUM_1, OAL_FALSE},
    {"mlsr_switch_rssi_low_th", WLAN_CFG_MLSR_SWITCH_RSSI_TH_L,
     &g_cust_cap.mlsr_switch_rssi_low_th, sizeof(g_cust_cap.mlsr_switch_rssi_low_th), WLAN_CUST_NUM_1, OAL_FALSE},
    {"mlsr_switch_rssi_high_th", WLAN_CFG_MLSR_SWITCH_RSSI_TH_H,
     &g_cust_cap.mlsr_switch_rssi_high_th, sizeof(g_cust_cap.mlsr_switch_rssi_high_th), WLAN_CUST_NUM_1, OAL_FALSE},
    {"mlsr_switch_goodput_th", WLAN_CFG_MLSR_SWITCH_GOODPUT_TH,
     &g_cust_cap.mlsr_switch_goodput_th, sizeof(g_cust_cap.mlsr_switch_goodput_th), WLAN_CUST_NUM_1, OAL_FALSE},
    {"mlsr_switch_prefer_factor", WLAN_CFG_MLSR_SWITCH_PREFER_FACTOR,
     &g_cust_cap.mlsr_switch_prefer_factor, sizeof(g_cust_cap.mlsr_switch_prefer_factor), WLAN_CUST_NUM_1, OAL_FALSE},
#ifdef _PRE_WLAN_FEATURE_EMLSR
    {"emlsr_transition_delay", WLAN_CFG_EMLSR_TRANSATION_DELAY,
     &g_cust_cap.emlsr_transation_delay, sizeof(g_cust_cap.emlsr_transation_delay), WLAN_CUST_NUM_1, OAL_FALSE},
    {"emlsr_padding_delay", WLAN_CFG_EMLSR_PADDING_DELAY,
     &g_cust_cap.emlsr_padding_delay, sizeof(g_cust_cap.emlsr_padding_delay), WLAN_CUST_NUM_1, OAL_FALSE},
#endif
    {"triangle_slope",  WLAN_CFG_TRIANGLE_SLOPE,
     &g_cust_cap.triangle_slope, sizeof(g_cust_cap.triangle_slope), WLAN_CUST_NUM_1, OAL_FALSE},
    {"tas_gpio_ctrl", WLAN_CFG_TAS_GPIO,
     &g_cust_cap.tas_gpio_ctrl, sizeof(g_cust_cap.tas_gpio_ctrl), WLAN_CUST_NUM_1, OAL_FALSE},
    {"sar_slide_pow_offset", WLAN_CFG_SAR_SLIDE_POW_OFFSET,
     g_cust_cap.sar_slide_pow_offset, sizeof(g_cust_cap.sar_slide_pow_offset[0]), WLAN_CUST_NUM_3, OAL_FALSE},
    {"support_omi_bw_switch", WLAN_CFG_SUPPORT_OMI_BW_SWITCH,
     &g_cust_cap.support_omi_bw_switch, sizeof(g_cust_cap.support_omi_bw_switch), WLAN_CUST_NUM_1, OAL_FALSE},
#ifdef _PRE_WLAN_FEATURE_TAS_ANT_SWITCH
    {"tas_abf_en", WLAN_CFG_TAS_ABF_EN_SWITCH,
     &g_cust_cap.tas_abf_en, sizeof(g_cust_cap.tas_abf_en), WLAN_CUST_NUM_1, OAL_FALSE},
#endif
    {"coex_feature_bitmap", WLAN_CFG_COEX_FEATURE_BITMAP, &g_cust_cap.coex_feature_bitmap,
     sizeof(g_cust_cap.coex_feature_bitmap), WLAN_CUST_NUM_1, OAL_FALSE },
};
