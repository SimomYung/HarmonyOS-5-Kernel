...
{
    uint32_t band_idx;
    wlan_cali_2g_20m_save_stru *cali_data_2g_20m = (wlan_cali_2g_20m_save_stru *)hmac_get_cali_data_save_addr(
...
{
    uint32_t band_idx;
    wlan_cali_5g_20m_save_stru *cali_data_5g_20m = (wlan_cali_5g_20m_save_stru *)hmac_get_cali_data_save_addr(
        mem_addr, WLAN_CALI_DATA_C0_5G_20M + rf_idx * WLAN_CALI_DATA_C0_BUTT);
    wlan_cali_5g_80m_save_stru *cali_data_5g_80m = (wlan_cali_5g_80m_save_stru *)hmac_get_cali_data_save_addr(
    ...
    if (hmac_get_max_5g_bw() < WLAN_BANDWIDTH_160) {
        return 0;
    }
