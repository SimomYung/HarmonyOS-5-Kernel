...
uint16_t g_cur_sar_txpwr_lvl = 1000;
...
#endif
    .cust_dpd_param = { // bisheng 线性fem参数，防止ini参数缺失后 device参数错误
        .dpd_eng_mu_post_2g = {0x7, 0x7, 0x7, 0x7},
        .dpd_eng_mu_pre_2g = {0x7, 0x7, 0x7, 0x7},
        .dpd_eng_mu_post_5g = {0x7, 0x7, 0x7, 0x7},
        .dpd_eng_mu_pre_5g = {0x7, 0x7, 0x7, 0x7},
        .dpd_cal_eng_mu_post_2g = {0x7ff448, 0x7ff448, 0x7ff448, 0x7ff448},
        .dpd_cal_eng_mu_pre_2g = {0xBBB, 0xBBB, 0xBBB, 0xBBB},
        .dpd_cal_eng_mu_post_5g = {0x7ff448, 0x7ff448, 0x7ff448, 0x7ff448},
        .dpd_cal_eng_mu_pre_5g = {0xBBB, 0xBBB, 0xBBB, 0xBBB},
        .dpd_tpc_cali_code_2g = {6, 12, 23, 33},
        .dpd_tpc_min_2g = {11, 21, 29, 41},
        .dpd_tpc_cali_code_5g = {8, 13, 16, 27},
        .dpd_tpc_min_5g = {11, 15, 25, 35},
        .dpd_core_alpha_2g = {4, 3, 3, 2},
        .dpd_core_scale_2g = {0x300, 0x300, 0x100, 0x2C0},
        .dpd_vtc_scale_2g = {0x800, 0x800, 0x800, 0x800},
        .dpd_core_alpha_5g = {5, 5, 4, 3},
        .dpd_core_scale_5g = {0x300, 0x300, 0x110, 0x100},
        .dpd_vtc_scale_5g = {0x578, 0x578, 0x578, 0x578},
#ifdef _PRE_WLAN_FEATURE_6G_EXTEND
        .dpd_core_alpha_6g = {4, 4, 4, 4},
        .dpd_core_scale_6g = {0x200, 0x200, 0x200, 0x200},
        .dpd_vtc_scale_6g = {0x800, 0x800, 0x800, 0x800},
#endif
    },
};
...
static conn_nve_tas_particion_stru g_cust_tas_nvram_info = {}; /* TAS NVRAM数据 */
#endif
...
#ifdef _PRE_WLAN_FEATURE_TAS_ANT_SWITCH
    {&g_cust_dyn_pow.dpn_tas_para[0].dpn_tas[WLAN_BW_CAP_20M][WLAN_5G_BAND_IDX0],
     &g_cust_tas_nvram_info.tas_pow_cal_data.delta_gain_tas_5g_20[WLAN_5G_BAND_IDX0],
     oal_array_size(g_cust_dyn_pow.dpn_tas_para[0].dpn_tas[WLAN_BW_CAP_20M])},
    {&g_cust_dyn_pow.dpn_tas_para[0].dpn_tas[WLAN_BW_CAP_40M][WLAN_5G_BAND_IDX0],
     &g_cust_tas_nvram_info.tas_pow_cal_data.delta_gain_tas_5g_40[WLAN_5G_BAND_IDX0],
     oal_array_size(g_cust_dyn_pow.dpn_tas_para[0].dpn_tas[WLAN_BW_CAP_40M])},
    {&g_cust_dyn_pow.dpn_tas_para[0].dpn_tas[WLAN_BW_CAP_80M][WLAN_5G_BAND_IDX0],
     &g_cust_tas_nvram_info.tas_pow_cal_data.delta_gain_tas_5g_80[WLAN_5G_BAND_IDX0],
     oal_array_size(g_cust_dyn_pow.dpn_tas_para[0].dpn_tas[WLAN_BW_CAP_80M])},
    {&g_cust_dyn_pow.dpn_tas_para[0].dpn_tas[WLAN_BW_CAP_160M][WLAN_5G_BAND_IDX0],
     &g_cust_tas_nvram_info.tas_pow_cal_data.delta_gain_tas_5g_160[WLAN_5G_BAND_IDX0],
     oal_array_size(g_cust_dyn_pow.dpn_tas_para[0].dpn_tas[WLAN_BW_CAP_160M])},
#endif
/* 此位置之前成员顺序禁止修改 */
#ifdef _PRE_WLAN_FEATURE_6G_EXTEND
...
#ifdef _PRE_WLAN_FEATURE_TAS_ANT_SWITCH
    {&g_cust_dyn_pow.dpn_tas_para[1].dpn_tas[WLAN_BW_CAP_20M][WLAN_5G_BAND_IDX0],
     &g_cust_tas_nvram_info.tas_pow_cal_data.delta_gain_tas_5g_20[WLAN_5G_BAND_IDX0],
     oal_array_size(g_cust_dyn_pow.dpn_tas_para[1].dpn_tas[WLAN_BW_CAP_20M])},
    {&g_cust_dyn_pow.dpn_tas_para[1].dpn_tas[WLAN_BW_CAP_40M][WLAN_5G_BAND_IDX0],
     &g_cust_tas_nvram_info.tas_pow_cal_data.delta_gain_tas_5g_40[WLAN_5G_BAND_IDX0],
     oal_array_size(g_cust_dyn_pow.dpn_tas_para[1].dpn_tas[WLAN_BW_CAP_40M])},
    {&g_cust_dyn_pow.dpn_tas_para[1].dpn_tas[WLAN_BW_CAP_80M][WLAN_5G_BAND_IDX0],
     &g_cust_tas_nvram_info.tas_pow_cal_data.delta_gain_tas_5g_80[WLAN_5G_BAND_IDX0],
     oal_array_size(g_cust_dyn_pow.dpn_tas_para[1].dpn_tas[WLAN_BW_CAP_80M])},
    {&g_cust_dyn_pow.dpn_tas_para[1].dpn_tas[WLAN_BW_CAP_160M][WLAN_5G_BAND_IDX0],
     &g_cust_tas_nvram_info.tas_pow_cal_data.delta_gain_tas_5g_160[WLAN_5G_BAND_IDX0],
     oal_array_size(g_cust_dyn_pow.dpn_tas_para[1].dpn_tas[WLAN_BW_CAP_160M])},
#endif
#ifdef _PRE_WLAN_FEATURE_6G_EXTEND
...
void hwifi_cust_rf_rssi_check_mp16(void)
{
    ...
    for (chan_idx = 0; chan_idx < CUS_NUM_5G_AMEND_RSSI_NUM; ++chan_idx) {
        cus_check_val(g_cust_cap.rf_tas_rssi_amend[chan_idx], WLAN_RF_RSSI_AMEND_TH_HIGH,
            WLAN_RF_RSSI_AMEND_TH_LOW, 0x0);
        for (rf_idx = 0; rf_idx < HD_EVENT_RF_NUM; rf_idx++) {
...
void hwifi_cust_rf_lp_loss_check_mp16(void)
{
    ...
    for (chan_idx = 0; chan_idx < MAC_NUM_5G_BAND; ++chan_idx) {
        ...
        cus_check_val(g_cust_cap.rf_lp_loss.gain_db_5g[chan_idx], RF_LP_LOSS_GAIN_DB_MAX,
            RF_LP_LOSS_GAIN_DB_MIN, 0x0);
        cus_check_val(g_cust_cap.rf_tas_lp_loss_diff,
            RF_LP_LOSS_GAIN_DB_MAX - g_cust_cap.rf_lp_loss.gain_db_5g[chan_idx],
            RF_LP_LOSS_GAIN_DB_MIN + g_cust_cap.rf_lp_loss.gain_db_5g[chan_idx], 0x0);
    }
}
...
void hwifi_cust_rf_check_mp16(void)
{
    ...
    for (rf_idx = 0; rf_idx < HD_EVENT_RF_NUM; rf_idx++) {
        ...
        for (chan_idx = 0; chan_idx < MAC_NUM_5G_BAND; ++chan_idx) {
            ...
            cus_check_val(g_cust_cap.rf_tas_loss_diff,
                RF_LINE_TXRX_GAIN_DB_MAX - g_cust_rf_front.rf_loss_gain_db.gain_db_5g[chan_idx][rf_idx],
                RF_LINE_TXRX_GAIN_DB_5G_MIN + g_cust_rf_front.rf_loss_gain_db.gain_db_5g[chan_idx][rf_idx], 0x0);
        }
#ifdef _PRE_WLAN_FEATURE_6G_EXTEND
    ...
    for (chan_idx = 0; chan_idx < HAL_MAX_BAND_NUM; ++chan_idx) {
        for (rf_idx = 0; rf_idx < HD_EVENT_RF_NUM; rf_idx++) {
...
{
    uint8_t param_idx;
    uint8_t param_num[HAL_MAX_BAND_NUM] = {oal_array_size(g_cust_pow.txpwr_base_2g_params[WLAN_RF_CHANNEL_ZERO]),
    ...
    uint8_t *para_addr[HAL_MAX_BAND_NUM] = {g_cust_pow.txpwr_base_2g_params[rf_idx],
...
static void hwifi_cust_4k_check(void)
{
    ...
    if (board_main_clk_freq() != CLK_76P8) {
...
static int32_t hwifi_cust_sar_slide_val_check(void)
{
    ...
    for (band_idx = 0; band_idx < HAL_MAX_BAND_NUM; band_idx++) {
...
#ifdef _PRE_WLAN_FEATURE_TAS_ANT_SWITCH
            if (rf_idx != WLAN_RF_TAS_ANT_IDX) {
                continue;
            }
            for (band_idx = 0; band_idx < MAC_NUM_5G_BAND; band_idx++) {
                cus_check_val(g_cust_dyn_pow.dpn_tas_para[lvl_idx].dpn_tas[mode_idx][band_idx],
                              CUS_DY_CALI_5G_VAL_DPN_MAX, CUS_DY_CALI_5G_VAL_DPN_MIN, 0);
            }
#endif
        }
...
#ifdef _PRE_WLAN_FEATURE_TAS_ANT_SWITCH
int16_t *g_tas_fcc_ce_data_addr[] = {
    &g_cust_pow.tas_fcc_ce_param.fcc_txpwr_limit_5g_20m[0],
    &g_cust_pow.tas_fcc_ce_param.fcc_txpwr_limit_5g_20m[6],
    &g_cust_pow.tas_fcc_ce_param.fcc_txpwr_limit_5g_20m[12],
    &g_cust_pow.tas_fcc_ce_param.fcc_txpwr_limit_5g_20m[18],
    &g_cust_pow.tas_fcc_ce_param.fcc_txpwr_limit_5g_40m[0],
    &g_cust_pow.tas_fcc_ce_param.fcc_txpwr_limit_5g_40m[6],
    &g_cust_pow.tas_fcc_ce_param.fcc_txpwr_limit_5g_80m[0],
    &g_cust_pow.tas_fcc_ce_param.fcc_txpwr_limit_5g_160m[0],
};

uint8_t g_tas_fcc_ce_data_num[] = {
    HAL_NUM_5G_20M_SIDE_BAND,
    HAL_NUM_5G_20M_SIDE_BAND,
    HAL_NUM_5G_20M_SIDE_BAND,
    HAL_NUM_5G_20M_SIDE_BAND,
    HAL_NUM_5G_40M_SIDE_BAND,
    HAL_5G_40M_SIDE_BAND_ALL - HAL_NUM_5G_40M_SIDE_BAND,
    oal_array_size(g_cust_pow.tas_fcc_ce_param.fcc_txpwr_limit_5g_80m),
    oal_array_size(g_cust_pow.tas_fcc_ce_param.fcc_txpwr_limit_5g_160m),
};
#endif
...
#ifdef _PRE_WLAN_FEATURE_TAS_ANT_SWITCH
#define CUS_FCC_CE_TAS_DATA_ADDR_NUM 8
static void hwifi_get_tas_fcc_ce_cn_txpwr_cmd_id(regdomain_enum_uint8 regdomain_type, int16_t rf_idx,
    int16_t *start_idx, int16_t *end_idx)
{
    int16_t fcc_start_id = NVRAM_PARA_FCC_TAS_START_INDEX;
    int16_t fcc_end_id = NVRAM_PARA_FCC_TAS_END_INDEX_BUTT;
    int16_t ce_start_id = NVRAM_PARA_CE_TAS_START_INDEX;
    int16_t ce_end_id = NVRAM_PARA_CE_TAS_END_INDEX_BUTT;
    int16_t cn_start_id = NVRAM_PARA_CN_TAS_START_INDEX;
    int16_t cn_end_id = NVRAM_PARA_CN_TAS_END_INDEX_BUTT;
    if (regdomain_type == REGDOMAIN_ETSI) {
        *start_idx = hwifi_get_pow_cfg_idx(ce_start_id);
        *end_idx = hwifi_get_pow_cfg_idx(ce_end_id);
    } else if (regdomain_type == REGDOMAIN_CN) {
        *start_idx = hwifi_get_pow_cfg_idx(cn_start_id);
        *end_idx = hwifi_get_pow_cfg_idx(cn_end_id);
    } else {
        *start_idx = hwifi_get_pow_cfg_idx(fcc_start_id);
        *end_idx = hwifi_get_pow_cfg_idx(fcc_end_id);
    }
}

static void hwifi_need_refresh_tas_txpwr_data(regdomain_enum_uint8 regdomain_type, uint8_t rf_idx)
{
    int16_t start_idx = 0;
    int16_t end_idx = 0;
    int16_t cfg_id;

    hwifi_get_tas_fcc_ce_cn_txpwr_cmd_id(regdomain_type, rf_idx, &start_idx, &end_idx);
    if (end_idx - start_idx != CUS_FCC_CE_TAS_DATA_ADDR_NUM) {
        oam_error_log2(0, 0, "hwifi_need_refresh_tas_txpwr_data:tas custom num %d and mem addr num %d not match",
            end_idx - start_idx, CUS_FCC_CE_TAS_DATA_ADDR_NUM);
        return;
    }
    if (rf_idx != WLAN_RF_TAS_ANT_IDX) {
        return;
    ...
    for (cfg_id = start_idx; cfg_id < end_idx; cfg_id++) {
        g_wifi_cfg_pow[cfg_id].data_addr = (uint8_t *)g_tas_fcc_ce_data_addr[cfg_id - start_idx];
        g_wifi_cfg_pow[cfg_id].data_type = sizeof(int16_t);
        g_wifi_cfg_pow[cfg_id].data_num = g_tas_fcc_ce_data_num[cfg_id - start_idx];
    }
    return;
}

static void hwifi_config_init_tas_sar_ctrl_cmd(uint8_t rf_idx)
{
    int16_t cfg_id;
    int16_t start_idx = NVRAM_PARA_TAS_SAR_START_INDEX;
    int16_t end_idx = NVRAM_PARA_TAS_SAR_END_INDEX_BUTT;
    if (end_idx - start_idx != oal_array_size(g_cust_pow.tas_sar_ctrl_params)) {
        oam_error_log2(0, 0, "hwifi_config_init_tas_sar_ctrl_cmd:custom num %d and mem addr num %d not match",
            end_idx - start_idx, oal_array_size(g_cust_pow.tas_sar_ctrl_params));
        return;
    }
    if (rf_idx != WLAN_RF_TAS_ANT_IDX) {
        return;
    ...
    for (cfg_id = start_idx; cfg_id < end_idx; cfg_id++) {
        g_wifi_cfg_pow[cfg_id].data_addr =
            &g_cust_pow.tas_sar_ctrl_params[cfg_id - start_idx].sar_ctrl_params[0];
        g_wifi_cfg_pow[cfg_id].data_type =
            (uint8_t)(sizeof(g_cust_pow.tas_sar_ctrl_params[cfg_id - start_idx].sar_ctrl_params[0]));
        g_wifi_cfg_pow[cfg_id].data_num =
            (uint8_t)oal_array_size(g_cust_pow.tas_sar_ctrl_params[cfg_id - start_idx].sar_ctrl_params);
    }
}
#endif
/*
...
#ifdef _PRE_WLAN_FEATURE_TAS_ANT_SWITCH
    hwifi_need_refresh_tas_txpwr_data(regdomain_type, rf_idx);
#endif
}
#ifdef _PRE_WLAN_FEATURE_6G_EXTEND
/*
...
#endif
#ifdef _PRE_WLAN_FEATURE_TAS_ANT_SWITCH
        hwifi_config_init_tas_sar_ctrl_cmd(rf_idx);
#endif
    }
}
...
static uint32_t hwifi_cust_read_nvram_dpd_state_mp16(void)
{
    ...
    return conn_nve_get_data_status(CONN_STATUS_DPD, OAL_FALSE);
}
...
#ifdef _PRE_WLAN_FEATURE_TAS_ANT_SWITCH
static int32_t hwifi_cust_get_tas_nvram_mp16(void)
{
#if defined(CONFIG_NVE_AP_KERNEL) || defined(CONFIG_HISILICON_PLATFORM)
    int32_t ret;
    struct external_nve_info_user info;
    int8_t idx;

    memset_s(&info, sizeof(info), 0, sizeof(info));
    if (strcpy_s(info.nv_name, sizeof(info.nv_name), CONN_NVE_TAS_NAME) != EOK) {
        oam_warning_log1(0, OAM_SF_CUSTOM, "hwifi_cust_get_tas_nvram_params_mp16::write nv_name failed, size[%lu]!",
            sizeof(info.nv_name));
        return INI_FILE_TIMESPEC_UNRECONFIG;
    }
    info.nv_name[sizeof(info.nv_name) - 1] = '\0';
    info.nv_number = CONN_NVE_TAS_NUM;
    info.valid_size = sizeof(g_cust_tas_nvram_info.tas_pow_cal_data.delta_gain_tas_5g_20);
    info.nv_operation = NV_READ;
    oam_warning_log1(0, OAM_SF_CUSTOM, "hwifi_cust_get_tas_nvram_params_mp16::TAS NV size[%lu]!", info.valid_size);
    ret = external_nve_direct_access_interface(&info);
    if (ret < -1) {
        oam_warning_log1(0, OAM_SF_CUSTOM, "hwifi_cust_get_tas_nvram_params_mp16::get TAS NV fail, ret[%lu]!", ret);
        return INI_FILE_TIMESPEC_UNRECONFIG;
    }
    /* 检查TAS NV是否修改 */
    if (oal_memcmp(info.nv_data, g_cust_tas_nvram_info.tas_pow_cal_data.delta_gain_tas_5g_20, info.valid_size) == 0) {
        oam_warning_log0(0, OAM_SF_CUSTOM, "hwifi_cust_get_tas_nvram_mp16:tas nv didn't updated");
        return INI_FILE_TIMESPEC_UNRECONFIG;
    }
    for (idx = 0; idx < WICAL_TAS_BW_NUM; idx++) {
        if (memcpy_s((uint8_t *)(g_cust_tas_nvram_info.tas_pow_cal_data.delta_gain_tas_5g_20) + info.valid_size * idx,
            info.valid_size, info.nv_data, info.valid_size) != EOK) {
            oam_warning_log1(0, OAM_SF_CUSTOM, "hwifi_cust_get_tas_nvram_mp16:copy data failed,idx=%d", idx);
            return INI_FILE_TIMESPEC_UNRECONFIG;
        }
    }
#endif
...
#ifdef _PRE_WLAN_FEATURE_TAS_ANT_SWITCH
#define NV_DPN_DATA_2G_NUM DYN_PWR_CUST_2G_SNGL_MODE_BUTT * WLAN_ANT_NUM_FOUR
#define NV_DPN_DATA_5G_NUM WLAN_BANDWIDTH_BUTT * WLAN_ANT_NUM_FOUR

void hwifi_update_nv_dpn_tas(uint32_t cfg_id, uint32_t data_id, uint32_t cfg_half)
{
    uint32_t tas_cfg_idx;
    if (cfg_id < NV_DPN_DATA_2G_NUM + NV_DPN_DATA_5G_NUM ||
        cfg_id >= NV_DPN_DATA_2G_NUM + NV_DPN_DATA_5G_NUM + WLAN_BANDWIDTH_BUTT) {
        return;
    }
    /* g_wifi_cfg_dpn_nv排列顺序为：
     * 2G --> 共计 DYN_PWR_CUST_2G_SNGL_MODE_BUTT * WLAN_ANT_NUM_FOUR 个
     * 5G --> 共计 WLAN_BANDWIDTH_BUTT * WLAN_ANT_NUM_FOUR 个
     * TAS --> 共计 WLAN_BANDWIDTH_BUTT 个
     * 6G --> 共计 WLAN_BANDWIDTH_BUTT * WLAN_ANT_NUM_FOUR 个
     * 由于TAS与5G C0 DPN共用但NV不共用，因此遍历时某cfg_id的tas dpn数据对应的5G C0的cfg_id应该为：
     * NV_DPN_DATA_2G_NUM + (cfg_id - NV_DPN_DATA_2G_NUM - NV_DPN_DATA_5G_NUM) * WLAN_ANT_NUM_FOUR
     */
    tas_cfg_idx = NV_DPN_DATA_2G_NUM + (cfg_id - NV_DPN_DATA_2G_NUM - NV_DPN_DATA_5G_NUM) * WLAN_ANT_NUM_FOUR;
    g_wifi_cfg_dpn_nv[cfg_id].ini_data_addr[data_id] =
        g_wifi_cfg_dpn_nv[tas_cfg_idx].ini_data_addr[data_id] -
        g_wifi_cfg_dpn_nv[tas_cfg_idx].nv_data_addr[data_id].delta_gain[0] +
        g_wifi_cfg_dpn_nv[cfg_id].nv_data_addr[data_id].delta_gain[0];
    g_wifi_cfg_dpn_nv[cfg_id + cfg_half].ini_data_addr[data_id] =
        g_wifi_cfg_dpn_nv[tas_cfg_idx + cfg_half].ini_data_addr[data_id] -
        g_wifi_cfg_dpn_nv[tas_cfg_idx + cfg_half].nv_data_addr[data_id].delta_gain[1] +
        g_wifi_cfg_dpn_nv[cfg_id + cfg_half].nv_data_addr[data_id].delta_gain[1];
    oam_warning_log2(0, OAM_SF_CUSTOM, "hwifi_update_nv_dpn::nv tas data[%d][%d]!",
        g_wifi_cfg_dpn_nv[cfg_id].nv_data_addr[data_id].delta_gain[0],
        g_wifi_cfg_dpn_nv[cfg_id + cfg_half].nv_data_addr[data_id].delta_gain[1]);
}
#endif
    ...
    for (cfg_id = 0; cfg_id < cfg_half; cfg_id++) {
        for (data_id = 0; data_id < g_wifi_cfg_dpn_nv[cfg_id].ini_data_num; data_id++) {
            ...
            g_wifi_cfg_dpn_nv[cfg_id + cfg_half].ini_data_addr[data_id] +=
                g_wifi_cfg_dpn_nv[cfg_id + cfg_half].nv_data_addr[data_id].delta_gain[1];
#ifdef _PRE_WLAN_FEATURE_TAS_ANT_SWITCH
            hwifi_update_nv_dpn_tas(cfg_id, data_id, cfg_half);
#endif
...
static int32_t wal_read_2g_dpd_data_from_nv(uint32_t rf_idx, uint8_t *mem_addr)
{
    uint32_t band_idx;
    mp1x_wlan_cali_2g_20m_save_stru *cali_data_2g_20m = (mp1x_wlan_cali_2g_20m_save_stru *)hmac_get_cali_data_save_addr(
        mem_addr, WLAN_CALI_DATA_C0_2G_20M + rf_idx * WLAN_CALI_DATA_C0_BUTT);
    for (band_idx = 0; band_idx < WLAN_2G_CALI_BAND_NUM; band_idx++) {
        if (memcpy_s(&cali_data_2g_20m->cali_data[band_idx].dpd_cali_data,
            sizeof(mp1x_wlan_cali_dpd_para_stru), &g_cust_nvram_info.dpd_cal_data.cali_data_2g[rf_idx][band_idx],
            sizeof(mp1x_wlan_cali_dpd_para_stru)) != EOK) {
...
static int32_t wal_read_2g_dpd_data_from_nv_mp12(uint32_t rf_idx, uint8_t *mem_addr)
{
    uint32_t band_idx;
    uint8_t dpd_lvl;
    uint8_t *dest;
    uint8_t *src;
    mp12_wlan_cali_2g_20m_save_stru *cali_data_2g_20m = (mp12_wlan_cali_2g_20m_save_stru *)hmac_get_cali_data_save_addr(
        mem_addr, WLAN_CALI_DATA_C0_2G_20M + rf_idx * WLAN_CALI_DATA_C0_BUTT);
    for (band_idx = 0; band_idx < WLAN_2G_CALI_BAND_NUM; band_idx++) {
        for (dpd_lvl = 0; dpd_lvl < WLAN_DPD_TPC_LEVEL_NUM; dpd_lvl++) {
            dest = (uint8_t *)(&cali_data_2g_20m->cali_data[band_idx].dpd_cali_data.dpd_cali_para[dpd_lvl]);
            src = (uint8_t *)(&g_cust_nvram_info.dpd_cal_data.cali_data_2g[rf_idx][band_idx].dpd_cali_para[dpd_lvl]);
            if (memcpy_s(dest, sizeof(mp12_wlan_cali_dpd_lut_stru), src, sizeof(mp12_wlan_cali_dpd_lut_stru)) != EOK) {
                return INI_FILE_TIMESPEC_RECONFIG;
            }
        }
    }
...
static int32_t wal_read_5g_dpd_data_from_nv(uint32_t rf_idx, uint8_t *mem_addr)
{
    uint32_t band_idx;
    mp1x_wlan_cali_5g_20m_save_stru *cali_data_5g_20m = (mp1x_wlan_cali_5g_20m_save_stru *)hmac_get_cali_data_save_addr(
        mem_addr, WLAN_CALI_DATA_C0_5G_20M + rf_idx * WLAN_CALI_DATA_C0_BUTT);
    mp1x_wlan_cali_5g_80m_save_stru *cali_data_5g_80m = (mp1x_wlan_cali_5g_80m_save_stru *)hmac_get_cali_data_save_addr(
        mem_addr, WLAN_CALI_DATA_C0_5G_80M + rf_idx * WLAN_CALI_DATA_C0_BUTT);
    wlan_cali_5g_160m_save_stru *cali_data_5g_160m = (wlan_cali_5g_160m_save_stru *)hmac_get_cali_data_save_addr(
        mem_addr, WLAN_CALI_DATA_C0_5G_160M + rf_idx * WLAN_CALI_DATA_C0_BUTT);
    for (band_idx = 0; band_idx < WLAN_5G_20M_CALI_BAND_NUM; band_idx++) {
        if (memcpy_s(&cali_data_5g_20m->cali_data[band_idx].dpd_cali_data,
            sizeof(mp1x_wlan_cali_dpd_para_stru), &g_cust_nvram_info.dpd_cal_data.cali_data_5g_20[rf_idx][band_idx],
            sizeof(mp1x_wlan_cali_dpd_para_stru)) != EOK || \
            memcpy_s(&cali_data_5g_80m->cali_data[band_idx].dpd_cali_data,
            sizeof(mp1x_wlan_cali_dpd_para_stru), &g_cust_nvram_info.dpd_cal_data.cali_data_5g_80[rf_idx][band_idx],
            sizeof(mp1x_wlan_cali_dpd_para_stru)) != EOK) {
            return INI_FILE_TIMESPEC_RECONFIG;
        }
    }
    for (band_idx = 0; band_idx < WLAN_5G_160M_CALI_BAND_NUM; band_idx++) {
        if (memcpy_s(&cali_data_5g_160m->cali_data[band_idx].dpd_cali_data,
            sizeof(mp1x_wlan_cali_dpd_para_stru), &g_cust_nvram_info.dpd_cal_data.cali_data_5g_160[rf_idx][band_idx],
            sizeof(mp1x_wlan_cali_dpd_para_stru)) != EOK) {
            return INI_FILE_TIMESPEC_RECONFIG;
        }
    }
...
static int32_t wal_read_5g_dpd_data_from_nv_mp12(uint32_t rf_idx, uint8_t *mem_addr)
{
    uint32_t band_idx;
    uint8_t dpd_lvl;
    uint8_t *dest_5g_20m;
    ...
    uint8_t *src_5g_20m;
    uint8_t *src_5g_80m;
    mp12_wlan_cali_5g_20m_save_stru *cali_data_5g_20m = (mp12_wlan_cali_5g_20m_save_stru *)hmac_get_cali_data_save_addr(
        mem_addr, WLAN_CALI_DATA_C0_5G_20M + rf_idx * WLAN_CALI_DATA_C0_BUTT);
    mp12_wlan_cali_5g_80m_save_stru *cali_data_5g_80m = (mp12_wlan_cali_5g_80m_save_stru *)hmac_get_cali_data_save_addr(
        mem_addr, WLAN_CALI_DATA_C0_5G_80M + rf_idx * WLAN_CALI_DATA_C0_BUTT);
    for (band_idx = 0; band_idx < WLAN_5G_20M_CALI_BAND_NUM; band_idx++) {
        for (dpd_lvl = 0; dpd_lvl < WLAN_DPD_TPC_LEVEL_NUM; dpd_lvl++) {
            dest_5g_20m = (uint8_t *)(&cali_data_5g_20m->cali_data[band_idx].dpd_cali_data.dpd_cali_para[dpd_lvl]);
            dest_5g_80m = (uint8_t *)(&cali_data_5g_80m->cali_data[band_idx].dpd_cali_data.dpd_cali_para[dpd_lvl]);
            src_5g_20m = (uint8_t *)
                (&g_cust_nvram_info.dpd_cal_data.cali_data_5g_20[rf_idx][band_idx].dpd_cali_para[dpd_lvl]);
            src_5g_80m = (uint8_t *)
                (&g_cust_nvram_info.dpd_cal_data.cali_data_5g_80[rf_idx][band_idx].dpd_cali_para[dpd_lvl]);
            if (memcpy_s(dest_5g_20m, sizeof(mp12_wlan_cali_dpd_lut_stru),
                src_5g_20m, sizeof(mp12_wlan_cali_dpd_lut_stru)) != EOK || \
                memcpy_s(dest_5g_80m, sizeof(mp12_wlan_cali_dpd_lut_stru),
                src_5g_80m, sizeof(mp12_wlan_cali_dpd_lut_stru)) != EOK) {
                return INI_FILE_TIMESPEC_RECONFIG;
            }
        }
    }
...
#ifdef _PRE_WLAN_FEATURE_6G_EXTEND
static int32_t wal_read_6g_dpd_data_from_nv(uint32_t rf_idx, mp1x_wlan_cali_data_para_stru *cali_data)
{
    uint32_t band_idx;
    for (band_idx = 0; band_idx < WLAN_6G_20M_CALI_BAND_NUM; band_idx++) {
        if (memcpy_s(&cali_data->rf_cali_data[rf_idx].cali_data_6g_20m.cali_data[band_idx].dpd_cali_data,
            sizeof(mp1x_wlan_cali_dpd_para_stru), &g_cust_nvram_info.dpd_cal_data.cali_data_6g_20[rf_idx][band_idx],
            sizeof(mp1x_wlan_cali_dpd_para_stru)) != EOK || \
            memcpy_s(&cali_data->rf_cali_data[rf_idx].cali_data_6g_80m.cali_data[band_idx].dpd_cali_data,
            sizeof(mp1x_wlan_cali_dpd_para_stru), &g_cust_nvram_info.dpd_cal_data.cali_data_6g_80[rf_idx][band_idx],
            sizeof(mp1x_wlan_cali_dpd_para_stru)) != EOK) {
            return INI_FILE_TIMESPEC_RECONFIG;
        }
    }
    for (band_idx = 0; band_idx < WLAN_6G_160M_CALI_BAND_NUM; band_idx++) {
        if (memcpy_s(&cali_data->rf_cali_data[rf_idx].cali_data_6g_160m.cali_data[band_idx].dpd_cali_data,
            sizeof(mp1x_wlan_cali_dpd_para_stru), &g_cust_nvram_info.dpd_cal_data.cali_data_6g_160[rf_idx][band_idx],
            sizeof(mp1x_wlan_cali_dpd_para_stru)) != EOK) {
            return INI_FILE_TIMESPEC_RECONFIG;
        }
    }
...
void wal_nv_dpd_data_print(uint32_t rf_idx)
{
    int32_t chip_type = get_mpxx_subchip_type();
    uint8_t dpd_lvl;
    uint16_t int_delay;
    mp1x_wlan_cali_dpd_lut_stru *dpd_cali_lut = NULL;
    if (rf_idx != 1 || chip_type != BOARD_VERSION_MP17C) {
        return;
    }
    for (dpd_lvl = 0; dpd_lvl < WLAN_DPD_TPC_LEVEL_NUM; dpd_lvl++) {
        dpd_cali_lut = &g_cust_nvram_info.dpd_cal_data.cali_data_5g_80[rf_idx][1].dpd_cali_para[dpd_lvl];
        int_delay = dpd_cali_lut->dpd_glue_lut[33] & 0x1FF; // int delay index 33
        oal_io_print("wal_nv_dpd_data_print::rf %d, dpd lvl %d, int_delay 0x%x, glue_lut[0x%x]",
            rf_idx, dpd_lvl, int_delay, dpd_cali_lut->dpd_glue_lut[0]);
    }
}
...
void wal_get_nv_dpd_data_mp16(void)
{
    int32_t ret = 0;
    uint32_t rf_idx;
    uint32_t rf_max_num = hmac_get_rf_num();
    uint8_t *mem_addr = get_cali_data_buf_addr();
    mp1x_wlan_cali_data_para_stru *cali_data = (mp1x_wlan_cali_data_para_stru *)mem_addr;
    uint32_t dpd_calied_chn = hwifi_cust_read_nvram_dpd_state_mp16();
    /* 分通道判断NV DPD数据是否ready */
    for (rf_idx = 0; rf_idx < rf_max_num; rf_idx++) {
        if (dpd_calied_chn & BIT(rf_idx)) {
            ret += wal_read_2g_dpd_data_from_nv(rf_idx, mem_addr);
        }
        if ((dpd_calied_chn >> HD_EVENT_RF_NUM) & BIT(rf_idx)) {
            ret += wal_read_5g_dpd_data_from_nv(rf_idx, mem_addr);
            wal_nv_dpd_data_print(rf_idx);
        }
        if (hmac_get_band_num() < WLAN_CALI_BAND_6G) {
            continue;
        }
        if ((dpd_calied_chn >> (HD_EVENT_RF_NUM * WLAN_CALI_BAND_6G)) & BIT(rf_idx)) {
...
void wal_get_nv_dpd_data_mp12(void)
{
    int32_t ret = 0;
    uint32_t rf_idx;
    uint32_t rf_max_num = hmac_get_rf_num();
    ...
    for (rf_idx = 0; rf_idx < rf_max_num; rf_idx++) {
        if (dpd_calied_chn & BIT(rf_idx)) {
            ret += wal_read_2g_dpd_data_from_nv_mp12(rf_idx, mem_addr);
        }
        if ((dpd_calied_chn >> HD_EVENT_RF_NUM) & BIT(rf_idx)) {
            ret += wal_read_5g_dpd_data_from_nv_mp12(rf_idx, mem_addr);
        }
    }
    if (oal_unlikely(ret != 0)) {
        oal_io_print("wal_read dpd data from_nv failed, ret[%d].\r\n", ret);
...
static int32_t hwifi_custom_host_read_ram_init_mp16(void)
{
    int32_t nv_read_ret = 0;
#ifdef HISI_CONN_NVE_SUPPORT
    /* 检查conn_nve初始化结果 */
    ...
    /* 读取nvram参数是否修改 */
    nv_read_ret += hwifi_cust_get_nvram_mp16();
#ifdef _PRE_WLAN_FEATURE_TAS_ANT_SWITCH
    nv_read_ret += hwifi_cust_get_tas_nvram_mp16();
#endif
#endif
    return nv_read_ret;
}
...
void hwifi_rf_cali_data_host_addr_init_mp16(void)
{
    ...
    pcie_if_hostca_to_devva(HCC_EP_WIFI_DEV, get_cali_data_buf_phy_addr(HCC_EP_WIFI_DEV), &host_dev_addr);
...
static int32_t hwifi_hcc_custom_ini_data_buf_mp16(uint16_t us_syn_id)
{
    ...
    max_data_len = hcc->tx_max_buf_len;
...
uint32_t hwifi_hcc_customize_h2d_data_cfg_mp16(void)
{
    ...
    if ((wlan_chip_custom_host_read_cfg_init()) != OAL_SUCC) {
        oam_warning_log0(0, OAM_SF_CFG, "hwifi_hcc_customize_h2d_data_cfg data init fail");
    }
    ...
    uint8_t *cust_param, int32_t param_len, uint8_t cfg_id)
{
    ...
    while (remain_len > 0) {
        ...
        if (oal_unlikely(ret != OAL_SUCC)) {
            oam_error_log2(0, OAM_SF_ANY, "{hwifi_custom_data_send::cutsom data cfg id[%d] fail[%d]!}", cfg_id, ret);
        }
        data += data_len;
...
static uint32_t hwifi_cust_nv_fcc_ce_pow_data_send(oal_net_device_stru *cfg_net_dev)
{
    ...
    for (band_idx = WLAN_CALI_BAND_2G; band_idx < HAL_MAX_BAND_NUM; band_idx++) {
...
#ifdef _PRE_WLAN_FEATURE_TAS_ANT_SWITCH
uint32_t hwifi_cust_tas_nv_fcc_ce_pow_data_send(oal_net_device_stru *cfg_net_dev)
{
    uint32_t ret;
    ret = hwifi_custom_data_send(cfg_net_dev, (uint8_t *)&(g_cust_pow.tas_fcc_ce_param),
        sizeof(hal_cfg_custom_tas_fcc_txpwr_limit_stru), WLAN_CFGID_SET_TAS_CUS_FCC_CE_POW);
    if (ret != OAL_SUCC) {
        oam_error_log2(0, 0, "hwifi_cust_tas_nv_fcc_ce_pow_data_send::fail[%d] rf[%d]", ret, WLAN_RF_TAS_ANT_IDX);
        return ret;
    }
    return ret;
}
...
static void hwifi_set_voe_custom_param_mp16(void)
{
    ...
    g_st_mac_device_custom_cfg.st_voe_custom_cfg.bit_11r_mlo =
        (g_cust_cap.voe_switch_mask & BIT6) ? OAL_TRUE : OAL_FALSE;
    return;
}
...
static uint32_t hwifi_memcpy_sar_ctrl_pow(wlan_sar_trigger_cfg_stru *sar_trigger_param,
    uint8_t lvl_num, uint16_t dest_len)
{
...
#ifdef _PRE_WLAN_FEATURE_TAS_ANT_SWITCH
    if (g_tas_switch_status == OAL_TRUE) {
        if (memcpy_s(sar_trigger_param->sar_avg_pow.sar_ctrl_params[WLAN_RF_TAS_ANT_IDX],
            sizeof(wlan_cust_tas_sar_cfg_stru), &g_cust_pow.tas_sar_ctrl_params[lvl_num],
            sizeof(wlan_cust_tas_sar_cfg_stru)) != EOK) {
            return OAL_FAIL;
        }
    }
#endif
...
#ifdef _PRE_WLAN_FEATURE_TAS_ANT_SWITCH
    g_cur_sar_txpwr_lvl = (uint16_t)lvl_num + 1000; // 更新当前SAR档位，格式10xx，1000为默认值
#endif
    if ((lvl_num <= CUS_NUM_OF_SAR_LVL) && (lvl_num > 0)) {
        lvl_num--;
        if ((hwifi_memcpy_sar_ctrl_pow(sar_trigger_param, lvl_num, dest_len) == OAL_FAIL) ||
