...
typedef enum {
    ...
    WLAN_CFG_HOST_MIRACAST_SINK_ENABLE, /* miracast特性开关 */
    WLAN_CFG_HOST_MIRACAST_SINK_SWITCH, /* miracast_sink开关 */
    ...
    WLAN_CFG_HOST_EXPAND_FEATURE_SWITCH_BITMAP,
    WLAN_CFG_HOST_REDUCE_PWR_2G_40MHZ_CHANNEL_BITMAP, /* 2G 40MHz降功率中心信道BITMAP */
    WLAN_CFG_HOST_WLAN_GO_ASSOC_USER_MAX_NUM, /* GO最大关联用户数 */
    WLAN_CFG_HOST_BUTT,
} wlan_host_cfg_enum;
...
extern uint16_t g_cur_sar_txpwr_lvl;
