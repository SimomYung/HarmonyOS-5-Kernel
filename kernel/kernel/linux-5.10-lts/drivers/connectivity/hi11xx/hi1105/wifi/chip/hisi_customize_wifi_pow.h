...
#ifdef _PRE_WLAN_FEATURE_TAS_ANT_SWITCH
    /* FCC TAS边带最大目标发射功率 */
    NVRAM_PARA_FCC_TAS_START_INDEX,
    NVRAM_PARA_FCC_5G_20M_TAS_0 = NVRAM_PARA_FCC_TAS_START_INDEX,
    NVRAM_PARA_FCC_5G_20M_TAS_1,
    NVRAM_PARA_FCC_5G_20M_TAS_2,
    NVRAM_PARA_FCC_5G_20M_TAS_3,
    NVRAM_PARA_FCC_5G_40M_TAS_0,
    NVRAM_PARA_FCC_5G_40M_TAS_1,
    NVRAM_PARA_FCC_5G_80M_TAS,
    NVRAM_PARA_FCC_5G_160M_TAS,
    NVRAM_PARA_FCC_TAS_END_INDEX_BUTT,
    /* CE TAS边带最大目标发射功率 */
    NVRAM_PARA_CE_TAS_START_INDEX,
    NVRAM_PARA_CE_5G_20M_TAS_0 = NVRAM_PARA_CE_TAS_START_INDEX,
    NVRAM_PARA_CE_5G_20M_TAS_1,
    NVRAM_PARA_CE_5G_20M_TAS_2,
    NVRAM_PARA_CE_5G_20M_TAS_3,
    NVRAM_PARA_CE_5G_40M_TAS_0,
    NVRAM_PARA_CE_5G_40M_TAS_1,
    NVRAM_PARA_CE_5G_80M_TAS,
    NVRAM_PARA_CE_5G_160M_TAS,
    NVRAM_PARA_CE_TAS_END_INDEX_BUTT,
    /* CN TAS边带最大目标发射功率 */
    NVRAM_PARA_CN_TAS_START_INDEX,
    NVRAM_PARA_CN_5G_20M_TAS_0 = NVRAM_PARA_CN_TAS_START_INDEX,
    NVRAM_PARA_CN_5G_20M_TAS_1,
    NVRAM_PARA_CN_5G_20M_TAS_2,
    NVRAM_PARA_CN_5G_20M_TAS_3,
    NVRAM_PARA_CN_5G_40M_TAS_0,
    NVRAM_PARA_CN_5G_40M_TAS_1,
    NVRAM_PARA_CN_5G_80M_TAS,
    NVRAM_PARA_CN_5G_160M_TAS,
    NVRAM_PARA_CN_TAS_END_INDEX_BUTT,
    /* TAS SAR功率控制 */
    NVRAM_PARA_TAS_SAR_START_INDEX,
    NVRAM_PARA_SAR_LVL1_TAS = NVRAM_PARA_TAS_SAR_START_INDEX,
    NVRAM_PARA_SAR_LVL2_TAS,
    NVRAM_PARA_SAR_LVL3_TAS,
    NVRAM_PARA_SAR_LVL4_TAS,
    NVRAM_PARA_SAR_LVL5_TAS,
    NVRAM_PARA_SAR_LVL6_TAS,
    NVRAM_PARA_SAR_LVL7_TAS,
    NVRAM_PARA_SAR_LVL8_TAS,
    NVRAM_PARA_SAR_LVL9_TAS,
    NVRAM_PARA_SAR_LVL10_TAS,
    NVRAM_PARA_SAR_LVL11_TAS,
    NVRAM_PARA_SAR_LVL12_TAS,
    NVRAM_PARA_SAR_LVL13_TAS,
    NVRAM_PARA_SAR_LVL14_TAS,
    NVRAM_PARA_SAR_LVL15_TAS,
    NVRAM_PARA_SAR_LVL16_TAS,
    NVRAM_PARA_SAR_LVL17_TAS,
    NVRAM_PARA_SAR_LVL18_TAS,
    NVRAM_PARA_SAR_LVL19_TAS,
    NVRAM_PARA_SAR_LVL20_TAS,
    NVRAM_PARA_TAS_SAR_END_INDEX_BUTT,
#endif
#ifdef _PRE_WLAN_FEATURE_11BE
    NVRAM_MRU_MAX_POWER_2G_C0,
    NVRAM_MRU_MAX_POWER_2G_C1,
    NVRAM_MRU_MAX_POWER_5G_C0,
    NVRAM_MRU_MAX_POWER_5G_C1,
#ifdef _PRE_WLAN_FEATURE_6G_EXTEND
    NVRAM_MRU_MAX_POWER_6G_C0,
    NVRAM_MRU_MAX_POWER_6G_C1,
#endif
    NVRAM_MRU_2X2_MAX_POWER_2G_C0,
    NVRAM_MRU_2X2_MAX_POWER_2G_C1,
    NVRAM_MRU_2X2_MAX_POWER_5G_C0,
    NVRAM_MRU_2X2_MAX_POWER_5G_C1,
#ifdef _PRE_WLAN_FEATURE_6G_EXTEND
    NVRAM_MRU_2X2_MAX_POWER_6G_C0,
    NVRAM_MRU_2X2_MAX_POWER_6G_C1,
#endif

    NVRAM_PARA_TPC_MRU_POWER_2G_20M,
    NVRAM_PARA_TPC_MRU_POWER_2G_40M,
    NVRAM_PARA_TPC_MRU_POWER_5G_20M,
    NVRAM_PARA_TPC_MRU_POWER_5G_40M,
    NVRAM_PARA_TPC_MRU_POWER_5G_80M,
    NVRAM_PARA_TPC_MRU_POWER_5G_160M,
#ifdef _PRE_WLAN_FEATURE_6G_EXTEND
    NVRAM_PARA_TPC_MRU_POWER_6G_20M,
    NVRAM_PARA_TPC_MRU_POWER_6G_40M,
    NVRAM_PARA_TPC_MRU_POWER_6G_80M,
    NVRAM_PARA_TPC_MRU_POWER_6G_160M,
#endif
#endif
    WLAN_CFG_DPD_ENG_MU_POST_2G,
    WLAN_CFG_DPD_ENG_MU_PRE_2G,
    WLAN_CFG_DPD_ENG_MU_POST_5G,
    WLAN_CFG_DPD_ENG_MU_PRE_5G,
    WLAN_CFG_CAL_ENG_MU_POST_2G,
    WLAN_CFG_CAL_ENG_MU_PRE_2G,
    WLAN_CFG_CAL_ENG_MU_POST_5G,
    WLAN_CFG_CAL_ENG_MU_PRE_5G,
    WLAN_CFG_DPD_TPC_CALI_CODE_2G,
    WLAN_CFG_DPD_TPC_MIN_2G,
    WLAN_CFG_DPD_TPC_CALI_CODE_5G,
    WLAN_CFG_DPD_TPC_MIN_5G,
    WLAN_CFG_DPD_CORE_ALPHA_2G,
    WLAN_CFG_DPD_CORE_SCALE_2G,
    WLAN_CFG_DPD_VTC_SCALE_2G,
    WLAN_CFG_DPD_CORE_ALPHA_5G,
    WLAN_CFG_DPD_CORE_SCALE_5G,
    WLAN_CFG_DPD_VTC_SCALE_5G,
#ifdef _PRE_WLAN_FEATURE_6G_EXTEND
    WLAN_CFG_DPD_CORE_ALPHA_6G,
    WLAN_CFG_DPD_CORE_SCALE_6G,
    WLAN_CFG_DPD_VTC_SCALE_6G,
#endif
    WLAN_CFG_DAC_SPUR_OPT,
    WLAN_CFG_SAW_DET_AMP,
