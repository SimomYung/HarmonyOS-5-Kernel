...
OAL_STATIC wlan_cfg_cmd g_wifi_config_cmds[] = {
    ...
    { "min_fast_ps_idle_p2p",               WLAN_CFG_INIT_MIN_FAST_PS_IDLE_P2P },
    { "max_fast_ps_idle_p2p",               WLAN_CFG_INIT_MAX_FAST_PS_IDLE_P2P },
    { "auto_fast_ps_thresh_screen_on_p2p",  WLAN_CFG_INIT_AUTO_FAST_PS_THRESH_SCREENON_P2P },
    { "auto_fast_ps_thresh_screen_off_p2p", WLAN_CFG_INIT_AUTO_FAST_PS_THRESH_SCREENOFF_P2P },
    /* 低功耗代理 */
    ...
    {"nb_power_enable",                 WLAN_CFG_INIT_NB_POWER_ENABLE},
#endif
...
int32_t *hwifi_get_g_host_init_params(void)
{
    ...
    if (hcc_get_main_dev() == HCC_EP_WIFI_DEV1) {
        return hwifi_get_g_host_init_params_dev1();
    }
#endif
...
#ifdef _PRE_WLAN_EXPORT
void host_params_init_export(void)
{
    g_host_init_params[WLAN_CFG_INIT_EFUSE_MAC_ADDR] = -1;
    g_host_init_params[WLAN_CFG_INIT_EFUSE_MAC_ADDR_2BYTE] = 0;
    g_host_init_params[WLAN_CFG_INIT_5G_POW_PARA_L0] = 0x06f030aa;
    g_host_init_params[WLAN_CFG_INIT_5G_POW_PARA_L1] = 0x06f030aa;
    g_host_init_params[WLAN_CFG_INIT_5G_POW_PARA_L2] = 0x06f030aa;
    g_host_init_params[WLAN_CFG_INIT_5G_POW_PARA_L3] = 0x06f020aa;
    g_host_init_params[WLAN_CFG_INIT_5G_POW_PARA_L4] = 0x06f02096;
    g_host_init_params[WLAN_CFG_INIT_5G_POW_PARA_L5] = 0x06f0005a;
    g_host_init_params[WLAN_CFG_INIT_2G_POW_PARA_L0] = 0x3ff020aa;
    g_host_init_params[WLAN_CFG_INIT_2G_POW_PARA_L1] = 0x3ff020aa;
    g_host_init_params[WLAN_CFG_INIT_2G_POW_PARA_L2] = 0x3ff020aa;
    g_host_init_params[WLAN_CFG_INIT_2G_POW_PARA_L3] = 0x3ff020aa;
    g_host_init_params[WLAN_CFG_INIT_2G_POW_PARA_L4] = 0x3ff02096;
    g_host_init_params[WLAN_CFG_INIT_2G_POW_PARA_L5] = 0x3ff0205a;
    g_host_init_params[WLAN_CFG_INIT_NB_POWER_ENABLE] = 0;
}
#endif
...
void host_params_init_first(void)
{
    ...
    g_host_init_params[WLAN_CFG_INIT_MIN_FAST_PS_IDLE_P2P] = WLAN_MIN_FAST_PS_IDLE;
    g_host_init_params[WLAN_CFG_INIT_MAX_FAST_PS_IDLE_P2P] = WLAN_MAX_FAST_PS_IDLE;
    g_host_init_params[WLAN_CFG_INIT_AUTO_FAST_PS_THRESH_SCREENON_P2P] = WLAN_AUTO_FAST_PS_SCREENON;
    g_host_init_params[WLAN_CFG_INIT_AUTO_FAST_PS_THRESH_SCREENOFF_P2P] = WLAN_AUTO_FAST_PS_SCREENOFF;
...
OAL_STATIC void hwifi_custom_adapt_device_ini_p2p_fast_ps_check_cnt(uint8_t *puc_data, uint32_t *pul_data_len)
{
    hmac_to_dmac_cfg_custom_data_stru st_syn_msg;
    int32_t  l_ret;
    ...
    st_syn_msg.en_syn_id = CUSTOM_CFGID_INI_PS_FAST_P2P_CHECK_CNT_ID;

    st_syn_msg.auc_msg_body[BYTE_OFFSET_0] = g_wlan_min_fast_ps_idle_p2p;
    st_syn_msg.auc_msg_body[BYTE_OFFSET_1] = g_wlan_max_fast_ps_idle_p2p;
    st_syn_msg.auc_msg_body[BYTE_OFFSET_2] = g_wlan_auto_ps_screen_on_p2p;
    st_syn_msg.auc_msg_body[BYTE_OFFSET_3] = g_wlan_auto_ps_screen_off_p2p;
    st_syn_msg.len = sizeof(st_syn_msg) - CUSTOM_MSG_DATA_HDR_LEN;
    ...
    *pul_data_len += sizeof(st_syn_msg);
    ...
    oam_warning_log4(0, OAM_SF_CFG, "{hwifi_custom_adapt_device_ini_fast_p2p_ps_check_cnt:fast_ps idle min/max[%d/%d], \
        auto_ps thresh screen on/off[%d/%d]}", g_wlan_min_fast_ps_idle_p2p, g_wlan_max_fast_ps_idle_p2p,
        g_wlan_auto_ps_screen_on_p2p, g_wlan_auto_ps_screen_off_p2p);
}
...
int32_t hwifi_custom_adapt_device_ini_param(uint8_t *puc_data)
{
    ...
    hwifi_custom_adapt_device_ini_p2p_fast_ps_check_cnt(puc_data + data_len, &data_len);
