...
typedef enum {
    ...
    WLAN_CFG_INIT_MIN_FAST_PS_IDLE_P2P,
    WLAN_CFG_INIT_MAX_FAST_PS_IDLE_P2P,
    WLAN_CFG_INIT_AUTO_FAST_PS_THRESH_SCREENON_P2P,
    WLAN_CFG_INIT_AUTO_FAST_PS_THRESH_SCREENOFF_P2P,
