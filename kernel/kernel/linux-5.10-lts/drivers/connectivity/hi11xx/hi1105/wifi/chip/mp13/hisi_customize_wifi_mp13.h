...
extern uint8_t g_nb_power_enable;
#endif

int hwifi_config_init(int32_t cus_tag);
...
uint32_t hwifi_get_sar_ctrl_params_mp13(uint8_t lvl_num_temp, uint8_t *data_addr, uint16_t *data_len,
    uint16_t dest_len);
