...
/* mp13 整个BOARD支持的最大的WIFI VAP数目 与单芯片时保持一致 */
#define WLAN_VAP_SUPPORT_MAX_NUM_LIMIT_MP13 (WLAN_CONFIG_VAP_MAX_NUM_PER_DEVICE + \
    WLAN_SERVICE_VAP_MAX_NUM_PER_DEVICE_MP13)
/* board组播用户数 与单芯片时保持一致 */
#define WLAN_MULTI_USER_MAX_NUM_LIMIT_MP13 WLAN_SERVICE_VAP_MAX_NUM_PER_DEVICE_MP13
#else
...
#define HAL_MAX_HW_VAP_NUM_MP13      16 /* HW VAP最大数量 */
