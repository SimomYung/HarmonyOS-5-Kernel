...
#define WLAN_DEVICE_MAX_NUM_PER_CHIP_MP16 2 /* 每个chip支持hal device的最大个数 */

#define HAL_MAX_VAP_NUM_MP16 4 /* 06 HAL VAP最大数量 */
#define HAL_MAX_HW_VAP_NUM_MP16      16 /* HW VAP最大数量 */
