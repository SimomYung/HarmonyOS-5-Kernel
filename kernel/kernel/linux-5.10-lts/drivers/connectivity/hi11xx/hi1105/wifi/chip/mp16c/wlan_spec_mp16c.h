...
#define WLAN_DEVICE_MAX_NUM_PER_CHIP_MP16C 2 /* 每个chip支持hal device的最大个数 */

#define WLAN_SERVICE_VAP_MAX_NUM_PER_DEVICE_MP16C 4 /* mp16c WIFI业务VAP个数 */

/* mp16c 整个BOARD支持的最大的WIFI VAP数目 4个业务VAP + 1个配置vap */
#define WLAN_VAP_SUPPORT_MAX_NUM_LIMIT_MP16C (WLAN_SERVICE_DEVICE_SUPPORT_MAX_NUM_SPEC * \
    (WLAN_CONFIG_VAP_MAX_NUM_PER_DEVICE + WLAN_SERVICE_VAP_MAX_NUM_PER_DEVICE_MP16C))

#define HAL_MAX_VAP_NUM_MP16C 4 /* 06 HAL VAP最大数量 */
#define HAL_MAX_HW_VAP_NUM_MP16C      16 /* HW VAP最大数量 */
