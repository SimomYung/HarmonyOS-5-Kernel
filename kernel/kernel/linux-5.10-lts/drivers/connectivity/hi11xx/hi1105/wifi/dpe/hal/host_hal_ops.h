...
typedef hal_host_device_stru *(*host_rx_get_mpdu_link_func)(oal_netbuf_stru *mpdu);
typedef void (*host_chip_mac_ptr_rpt_init_func)(void);
typedef void (*host_set_mac_ptr_rpt_regs_func)(uintptr_t ring_ptr_rpt_mode);
typedef void (*host_chip_irq_init_func)(void);
typedef void (*host_get_rx_msdu_list_func)(void);
...
typedef uint32_t (*host_csi_config_func)(uint8_t vap_idx, uint16_t len, uint8_t *param);
...
typedef uint32_t (*host_tx_get_msdu_info_devva_func)(hal_host_tx_msdu_ring_stru *, hal_tx_ring_table_addr_stru *);
typedef uint8_t (*host_tx_get_msdu_dscr_len_func)(void);
typedef void (*host_tx_set_ring_table_base_addr_func)(uint32_t);
typedef uint32_t (*host_tx_init_tid_ring_table_func)(uint8_t, uint8_t, hal_tx_ring_table_addr_val_stru *);
...
typedef void (*host_unmask_soc_host_intr_func)(hal_host_device_stru *hal_device);

struct hal_common_ops_stru {
    host_chip_mac_ptr_rpt_init_func host_chip_mac_ptr_rpt_init;
    host_set_mac_ptr_rpt_regs_func host_set_mac_ptr_rpt_regs;
    host_chip_irq_init_func        host_chip_irq_init;
    host_get_rx_msdu_list_func     host_get_rx_msdu_list;
    ...
    host_unmask_soc_host_intr_func host_unmask_soc_host_intr;
};
