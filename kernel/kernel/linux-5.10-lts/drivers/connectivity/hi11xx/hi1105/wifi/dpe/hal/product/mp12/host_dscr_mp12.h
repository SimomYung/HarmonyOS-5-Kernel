...
#ifndef HOST_DSCR_MP12_H
#define HOST_DSCR_MP12_H
...
#define MP12_RX_MSDU_DSCR_LEN    (sizeof(mp12_rx_msdu_dscr_stru))
#define MP12_TX_MSDU_DSCR_LEN    (sizeof(mp12_tx_msdu_dscr_stru))
#define MP12_D2H_RX_RING_RESET   (MP12_RING_RESET_NORM_DATA_FREE_RING_MASK | \
                                  MP12_RING_RESET_SMALL_DATA_FREE_RING_MASK)
...
} mp12_tx_msdu_info_stru;

typedef struct {
    uint32_t msdu_addr_lsb;
    uint32_t msdu_addr_msb;
} mp12_tx_msdu_addr_stru;
...
typedef struct {
    ...
    int8_t  reserved3;
    int8_t  reserved4;
} mp12_rx_msdu_dscr_stru;

#define MP12_TX_RING_TABLE_LEN (sizeof(hal_tx_msdu_ring_info_stru))
#define MP12_TX_RING_TABLE_WORD_NUM (MP12_TX_RING_TABLE_LEN / sizeof(uint32_t))
typedef struct {
    /* word 0-3 */
    ...
    uint32_t desc_table_addr_sel        : 1;
    uint32_t ml2_dup_en                 : 5;

    /* word 5 */
    uint32_t ml0_tx_msdu_info_ring_rptr : 16;
    uint32_t ml0_rptr_seq_num           : 12;
    uint32_t reserved0                  : 4;
} hal_tx_msdu_ring_info_stru;

typedef union {
    uint32_t words[MP12_TX_RING_TABLE_WORD_NUM];
    hal_tx_msdu_ring_info_stru ring_info;
} mp12_tx_msdu_ring_table_stru;

#pragma pack(push, 1)

struct  mp12_ftm_word0 {
...
typedef struct  mp12_ftm_word0 mp12_ftm_word0_stru;

struct mp12_ftm_word1 {
    uint8_t  snr_ant[HAL_HOST_MAX_RF_NUM];
    int8_t   rssi_hltf[HAL_HOST_MAX_RF_NUM];
} DECLARE_PACKED;
typedef struct mp12_ftm_word1 mp12_ftm_word1_stru;

typedef struct {
    uint16_t agc_code_ant : 8; /* [8..0]    */
    uint16_t reserved : 8;        /* [15..9]  */
} mp12_ftm_agc_code_stru;

struct mp12_ftm_word2 {
    mp12_ftm_agc_code_stru st_agc_code_ant[HAL_HOST_MAX_RF_NUM];
} DECLARE_PACKED;
typedef struct mp12_ftm_word2 mp12_ftm_word2_stru;

struct mp12_ftm_word3 {
    mp12_ftm_agc_code_stru nd_agc_code_ant[HAL_HOST_MAX_RF_NUM];
} DECLARE_PACKED;
typedef struct mp12_ftm_word3 mp12_ftm_word3_stru;

struct mp12_ftm_word4 {
...
typedef struct mp12_ftm_word4 mp12_ftm_word4_stru;

struct mp12_ftm_word5 {
    uint64_t ra : 48;           /* [47..0]    */
    uint64_t bit_reserved : 16; /* [63..48]  */
} DECLARE_PACKED;
typedef struct mp12_ftm_word5 mp12_ftm_word5_stru;

struct mp12_ftm_word6 {
    uint64_t ta : 48;           /* [47..0]    */
    uint64_t bit_reserved : 16; /* [63..48]  */
} DECLARE_PACKED;
typedef struct mp12_ftm_word6 mp12_ftm_word6_stru;

struct mp12_ftm_word7 {
    uint64_t timestamp : 48;     /* [47..0]    */
    uint64_t bit_reserved : 16;  /* [63..48]  */
} DECLARE_PACKED;
typedef struct mp12_ftm_word7 mp12_ftm_word7_stru;

struct mp12_ftm_word8 {
    uint64_t tx_time : 48;      /* [47..0]    */
    uint64_t bit_reserved : 16; /* [63..48]  */
} DECLARE_PACKED;
typedef struct mp12_ftm_word8 mp12_ftm_word8_stru;

struct mp12_ftm_word9 {
    uint64_t rx_time : 48;      /* [47..0]    */
    uint64_t bit_reserved : 16; /* [63..48]  */
} DECLARE_PACKED;
typedef struct mp12_ftm_word9 mp12_ftm_word9_stru;

struct mp12_ftm_word10 {
...
typedef struct mp12_ftm_word10 mp12_ftm_word10_stru;

struct mp12_ftm_dscr {
    mp12_ftm_word0_stru word0;
    mp12_ftm_word1_stru word1;
    mp12_ftm_word2_stru word2;
    mp12_ftm_word3_stru word3;
    mp12_ftm_word4_stru word4;
    mp12_ftm_word5_stru word5;
    mp12_ftm_word6_stru word6;
    mp12_ftm_word7_stru word7;
    mp12_ftm_word8_stru word8;
    mp12_ftm_word9_stru word9;
    mp12_ftm_word10_stru word10;
} DECLARE_PACKED;
typedef struct mp12_ftm_dscr mp12_ftm_dscr_stru;
...
typedef struct mp12_csi_ppu mp12_csi_ppu_stru;

#pragma pack(pop)
hal_ring_mac_regs_info* mp12_get_ring_mac_regs(void);
void mp12_host_chip_mac_ptr_rpt_init(void);
void mp12_host_set_mac_ptr_rpt_regs(uintptr_t ring_ptr_rpt_mode);
uint32_t mp12_rx_host_start_dscr_queue(uint8_t hal_dev_id);
int32_t mp12_rx_host_stop_dscr_queue(uint8_t hal_dev_id);
void mp12_tx_ba_info_dscr_get(uint8_t *ba_info_data, hal_tx_ba_info_stru *tx_ba_info);
void mp12_tx_msdu_dscr_info_get(oal_netbuf_stru *netbuf, hal_tx_msdu_dscr_info_stru *tx_msdu_info);
void mp12_host_ba_ring_regs_init(uint8_t hal_dev_id);
void mp12_host_ring_tx_init(uint8_t hal_dev_id);
int32_t mp12_rx_host_init_dscr_queue(uint8_t hal_dev_id);
hal_host_device_stru *mp12_host_rx_get_mpdu_link(hal_host_device_stru *origin_dev, oal_netbuf_stru *mpdu);
uint32_t mp12_rx_mpdu_que_len(hal_host_device_stru *pst_device);
...
oal_netbuf_stru *mp12_rx_get_next_sub_msdu(hal_host_device_stru *hal_device, oal_netbuf_stru *netbuf);
uint32_t mp12_host_rx_reset_smac_handler(hal_host_device_stru *hal_dev);
uint32_t mp12_host_rx_proc_msdu_dscr(hal_host_device_stru *hal_dev, oal_netbuf_stru *netbuf);
...
void mp12_rx_free_res(hal_host_device_stru *hal_device);
void mp12_rx_alloc_list_free(hal_host_device_stru *hal_dev, hal_host_rx_alloc_list_stru *alloc_list);
uint8_t mp12_rx_ring_reg_init(hal_host_device_stru *hal_dev, hal_host_ring_ctl_stru *rctl, uint8_t ring_id);
