...
#define MP16C_PCIE_CTRL_RB_BASE 0x40108000
...
#define MP16C_RING_RESET_PPDU_FREE_RING_MASK         0x1
#define MP16C_RING_RESET_NORM_MGMT_FREE_RING_MASK    0x2
#define MP16C_RING_RESET_SMALL_MGMT_FREE_RING_MASK   0x4
#define MP16C_RING_RESET_LARGE_MGMT_FREE_RING_MASK   0x8
#define MP16C_RING_RESET_NORM_DATA_FREE_RING_MASK    0x10
#define MP16C_RING_RESET_SMALL_DATA_FREE_RING_MASK   0x20
#define MP16C_RING_RESET_PPDU_COMP_RING_MASK         0x40
#define MP16C_RING_RESET_MGMT_COMP_RING_MASK         0x80
#define MP16C_RING_RESET_DATA_COMP_RING_MASK         0x100
#define MP16C_RING_RESET_PPDU_HOST_FREE_RING_MASK    0x200
...
#define MAC_TMU_REG_VAP_TSFTIMER_RDVALL_STATUS_0_REG (MAC_TMU_REG_BASE + 0x1104) /* VAP tsf(低32bit), 单位us */
#define MP16C_W_SOFT_INT_SET_AON_REG (MP16C_GLB_CTL_RB_BASE_BASE + 0x134)
#define MP16C_PCIE_HOST_INTR_RAW_STATUS_REG (MP16C_PCIE_CTRL_RB_BASE + 0x2E4) /* PCIE屏蔽前中断上报 */
#define MP16C_PCIE_HOST_INTR_MASK_REG (MP16C_PCIE_CTRL_RB_BASE + 0x2E8) /* PCIE屏蔽 */
#define MP16C_PCIE_HOST_INTR_STATUS_REG (MP16C_PCIE_CTRL_RB_BASE + 0x2EC) /* PCIE屏蔽后中断上报 */
/* MAC 通用定时器 */
typedef enum {
    MP16C_MAC_COMMON_TIMER_0 = 0,
    MP16C_MAC_COMMON_TIMER_1,
    MP16C_MAC_COMMON_TIMER_2,
    MP16C_MAC_COMMON_TIMER_3,
    MP16C_MAC_COMMON_TIMER_4,
    MP16C_MAC_COMMON_TIMER_5,
    MP16C_MAC_COMMON_TIMER_6,
    MP16C_MAC_COMMON_TIMER_7,

    MP16C_MAC_COMMON_TIMER_BUTT,
} mp16c_mac_common_timer_idx;

#define MP16C_MAC_COMMON_TIMER_OFFSET 0x4
#define MP16C_MAC_MAX_COMMON_TIMER 7 /* 通用定时器个数，下表0~7 */
...
#define MP16C_PCIE_CTRL_RB_MAC_N2_INTR_STATUS_OFFSET              6
#define MP16C_PCIE_CTRL_RB_MAC_N2_INTR_STATUS_MASK                0x40
...
void mp16c_host_unmask_soc_host_intr(hal_host_device_stru *hal_device);
