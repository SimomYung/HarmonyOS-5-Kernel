 ...
 * 功能说明 : mp17c_mpw host 描述符
 * 作    者 :
 * 创建日期 : 2021年2月22日
 */

#ifndef HOST_SNIFFER_MP17C_MPW_H
#define HOST_SNIFFER_MP17C_MPW_H
...
#define MEM_RX_PPDU_DSCR_MPW_SIZE1 636  /* 注：同device侧size */
#define MEM_RX_PPDU_DSCR_MPW_SIZE (MEM_RX_PPDU_DSCR_MPW_SIZE1 + 24)
...
typedef struct {
    ...
    /* word 3 */
    int8_t rpt_rssi_0ch_msb; /* rpt_rssi_0ch_msb 主20M的天线0的RSSI 高8bit，单位：0.25dBm，表示-128~127dBm */
    int8_t rpt_rssi_1ch_msb; /* rpt_rssi_1ch_msb 主20M的天线1的RSSI 高8bit，单位：0.25dBm，表示-128~127dBm */
    ...
    uint32_t rsv1                      : 12;
    uint32_t rpt_rssi_0ch_lsb          : 2; /* 主20M的天线0的RSSI 低2bit，单位：0.25dBm，表示-128~127dBm */
    uint32_t rpt_rssi_1ch_lsb          : 2; /* 主20M的天线1的RSSI 低2bit，单位：0.25dBm，表示-128~127dBm */
...
} mp17c_mpw_rx_ppdu_vector_info_stru;
...
} mp17c_mpw_rx_ppdu_user_info_stru;

#define MP17C_MPW_SNIFFER_RX_PPDU_RSV_NUM 14
/* 接收ppdu描述信息 */
typedef struct {
    /* word0-8 */
    mp17c_mpw_rx_ppdu_vector_info_stru rx_ppdu_vector_info;
    /* word9-22 */
    uint32_t reserve[MP17C_MPW_SNIFFER_RX_PPDU_RSV_NUM];
    /* word23-28 */
    mp17c_mpw_rx_ppdu_user_info_stru   rx_ppdu_user_info;
} mp17c_mpw_rx_ppdu_dscr_stru;

typedef struct {
    oal_dlist_head_stru entry;
    edma_paddr_t paddr;
    mp17c_mpw_rx_ppdu_dscr_stru hw_ppdu_data;
} hal_host_rx_ppdu_dscr_stru;
#pragma pack(pop)

void mp17c_mpw_rx_set_ring_regs(hal_host_ring_ctl_stru *rx_ring_ctl);
