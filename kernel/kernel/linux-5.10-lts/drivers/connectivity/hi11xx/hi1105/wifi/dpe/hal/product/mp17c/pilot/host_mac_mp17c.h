...
#ifndef HOST_MAC_MP17C_H
#define HOST_MAC_MP17C_H
...
#define MP17C_GLBA_CTL_RB_BASE (0x4000000)

/* master: 0x0407_0000~0x0407_ffff slave: 0x0408_0000~0x0408_ffff */
#define MP17C_MAC_BANK_REG_OFFSET 0x10000
/* master: 0x4006_0000~0x          slave: 0x400a_0000~0x */
#define MP17C_PHY_BANK_REG_OFFSET 0x50000
/* host mac中断屏蔽bit位 */
#define MAC_GLB_REG_CFG_HOST_INTR_MASK_SMAC_INTR_MASK          0x10000
/* host mac数据帧接收完成中断 */
#define MAC_COMMON_REG_RPT_HOST_INTR_RX_COMPLETE_MASK           0x4000
...
#define MAC_GLB_REG_SMAC_INTR_CLR_REG                        (MAC_GLB_REG_BASE + 0x42C) /* SMAC中断清除寄存器 */
#define MAC_GLB_REG_SMAC_INTR_STATUS_REG                     (MAC_GLB_REG_BASE + 0x52C) /* 上报到SMAC的中断状态寄存器 */
#define MAC_GLB_REG_SMAC_INTR_MASK_REG                       (MAC_GLB_REG_BASE + 0x430) /* SMAC中断屏蔽寄存器 */

/* rx ring reset ctrl,每个bit对应1个ring */
#define MP17C_RING_RESET_NORM_DATA_FREE_RING_MASK    0x1
#define MP17C_RING_RESET_SMALL_DATA_FREE_RING_MASK   0x2
#define MP17C_RING_RESET_NORM_MGMT_FREE_RING_MASK    0x4
#define MP17C_RING_RESET_SMALL_MGMT_FREE_RING_MASK   0x8
#define MP17C_RING_RESET_LARGE_MGMT_FREE_RING_MASK   0x10
#define MP17C_RING_RESET_PPDU_FREE_RING_MASK         0x20
#define MP17C_RING_RESET_PPDU_HOST_FREE_RING_MASK    0x40
#define MP17C_RING_RESET_DATA_COMP_RING_MASK         0x80
#define MP17C_RING_RESET_MGMT_COMP_RING_MASK         0x100
#define MP17C_RING_RESET_PPDU_COMP_RING_MASK         0x200
...
#define MP17C_W_SOFT_INT_SET_AON_REG (MP17C_GLBA_CTL_RB_BASE + 0x134)

/* MAC 通用定时器 */
#define MP17C_MAC_COMMON_TIMER_OFFSET 0x4
#define MP17C_MAC_MAX_COMMON_TIMER 7 /* 通用定时器个数 */
#define MP17C_MAC_COMMON_REG_RPT_HOST_INTR_DATA_RING_OVERRUN_OFFSET  18
#define MP17C_MAC_COMMON_REG_RPT_HOST_INTR_DATA_RING_OVERRUN_MASK    0x40000
#define MP17C_MAC_COMMON_REG_RPT_HOST_INTR_SMALL_RING_EMPTY_OFFSET   17
#define MP17C_MAC_COMMON_REG_RPT_HOST_INTR_SMALL_RING_EMPTY_MASK     0x20000
#define MP17C_MAC_COMMON_REG_RPT_HOST_INTR_NORM_RING_EMPTY_OFFSET    16
#define MP17C_MAC_COMMON_REG_RPT_HOST_INTR_NORM_RING_EMPTY_MASK      0x10000
#define MP17C_MAC_COMMON_REG_RPT_HOST_INTR_RX_COMPLETE_OFFSET        14
#define MP17C_MAC_COMMON_REG_RPT_HOST_INTR_RX_COMPLETE_MASK          0x4000

#define mp17c_check_is_mac_common_reg_addr(_addr)    \
...
void mp17c_host_intr_regs_init(uint8_t hal_dev_id);
void mp17c_host_common_intr_regs_init(void);
