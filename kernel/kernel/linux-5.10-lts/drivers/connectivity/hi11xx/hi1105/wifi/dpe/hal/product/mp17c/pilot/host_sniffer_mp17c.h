...
#ifndef HOST_SNIFFER_MP17C_H
#define HOST_SNIFFER_MP17C_H
...
} mp17c_rx_ppdu_vector_info_stru;
...
} mp17c_rx_ppdu_user_info_stru;

#define MP17C_SNIFFER_RX_PPDU_RSV_NUM 12
/* 接收ppdu描述信息 */
typedef struct {
    /* word 0-8 */
    mp17c_rx_ppdu_vector_info_stru rx_ppdu_vector_info;
    /* word 9-20 */
    uint32_t reserve[MP17C_SNIFFER_RX_PPDU_RSV_NUM];
    /* word 21-26 */
    mp17c_rx_ppdu_user_info_stru   rx_ppdu_user_info;
} mp17c_rx_ppdu_dscr_stru;

typedef struct {
    oal_dlist_head_stru entry;
    edma_paddr_t paddr;
    mp17c_rx_ppdu_dscr_stru hw_ppdu_data;
} hal_host_rx_ppdu_dscr_stru;
#pragma pack(pop)

void mp17c_rx_set_ring_regs(hal_host_ring_ctl_stru *rx_ring_ctl);
