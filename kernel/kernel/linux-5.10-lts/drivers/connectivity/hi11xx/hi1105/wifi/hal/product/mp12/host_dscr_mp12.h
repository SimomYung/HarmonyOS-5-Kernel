...
#define MP12_RX_MSDU_DSCR_LEN    52
...
#define MP12_TX_RING_INFO_LEN 40
#define MP12_TX_RING_INFO_WORD_NUM (MP12_TX_RING_INFO_LEN / sizeof(uint32_t))
typedef union {
    uint32_t words[MP12_TX_RING_INFO_WORD_NUM];
    struct {
