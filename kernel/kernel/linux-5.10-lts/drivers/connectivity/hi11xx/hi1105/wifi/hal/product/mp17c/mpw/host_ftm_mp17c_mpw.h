...
* 创建日期   : 2020年12月8日
*/
#ifndef HOST_FTM_MP17C_MPW_H
#define HOST_FTM_MP17C_MPW_H
...
#define HAL_HOST_MP17C_RF_NUM    2
...
typedef struct {
    ...
    uint8_t   ftm_snr_ant[HAL_HOST_MP17C_RF_NUM];
    int8_t    ftm_rssi_ant[HAL_HOST_MP17C_RF_NUM];
