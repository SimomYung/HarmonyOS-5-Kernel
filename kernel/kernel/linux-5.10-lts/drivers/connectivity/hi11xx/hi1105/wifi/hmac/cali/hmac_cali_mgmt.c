...
#include "../chip/mp13/cali_array_init_mp13.h"
...
static mp1x_wlan_cali_chn_stru g_hmac_chn_cali_data;
static mp1x_wlan_cali_rf_20m_para_stru g_hmac_scan_all_ch_cali_data[HAL_HOST_MAX_RF_NUM];
static mp1x_wlan_cali_data_20m_common_para_stru g_hmac_20m_cali_common_data;
static mp12_wlan_cali_chn_stru g_hmac_chn_cali_data_mp12;
static mp12_wlan_cali_rf_20m_para_stru g_hmac_scan_all_ch_cali_data_mp12[HAL_HOST_MAX_RF_NUM];
static mp12_wlan_cali_data_20m_common_para_stru g_hmac_20m_cali_common_data_mp12;
uint8_t g_open_wifi_cali = OAL_TRUE;
uint32_t g_wifi_fac_cali_chain = 0;
...
int16_t g_as_mp15_625k_80m_tone_lut[NUM_80M_SNGL_TONE_1_4_CIRCLE * NUM_80M_SNGL_TONE_1_CIRCLE + 1] = {
    1159, 1157, 1153, 1146, 1136, 1124, 1109, 1091,
    1070, 1047, 1022, 994, 963, 931, 896, 858,
    819, 778, 735, 690, 644, 596, 546, 495,
    443, 390, 336, 281, 226, 170, 114, 57, 0
...
int16_t g_as_mp15_625k_160m_tone_lut[NUM_160M_SNGL_TONE_1_4_CIRCLE * NUM_BW_SNGL_TONE_1_CIRCLE + 1] = {
    1159, 1158, 1157, 1155, 1153, 1150, 1146, 1141,
    1136, 1130, 1124, 1117, 1109, 1100, 1091, 1081,
    1070, 1059, 1047, 1035, 1022, 1008, 994, 979,
    963, 947, 931, 913, 896, 877, 858, 839,
...
int16_t g_as_mp15_625k_320m_tone_lut[NUM_320M_SNGL_TONE_1_4_CIRCLE * NUM_BW_SNGL_TONE_1_CIRCLE + 1] = {
    1159, 1158, 1158, 1158, 1157, 1156, 1155, 1154, 1153, 1151, 1150, 1148, 1146, 1144, 1141, 1139,
    1136, 1133, 1130, 1127, 1124, 1120, 1117, 1113, 1109, 1104, 1100, 1096, 1091, 1086, 1081, 1076,
    1070, 1065, 1059, 1053, 1047, 1041, 1035, 1028, 1022, 1015, 1008, 1001, 994, 986, 979, 971,
    963, 955, 947, 939, 931, 922, 913, 905, 896, 886, 877, 868, 858, 849, 839, 829,
...
int16_t g_as_mp15_625k_640m_tone_lut[NUM_640M_SNGL_TONE_1_4_CIRCLE * NUM_BW_SNGL_TONE_1_CIRCLE + 1] = {
    1159, 1159, 1158, 1158, 1158, 1158, 1158, 1157, 1157, 1157, 1156, 1156, 1155, 1155, 1154, 1154,
    1153, 1152, 1151, 1151, 1150, 1149, 1148, 1147, 1146, 1145, 1144, 1143, 1141, 1140, 1139, 1138,
    1136, 1135, 1133, 1132, 1130, 1129, 1127, 1126, 1124, 1122, 1120, 1118, 1117, 1115, 1113, 1111,
    1109, 1107, 1104, 1102, 1100, 1098, 1096, 1093, 1091, 1088, 1086, 1083, 1081, 1078, 1076, 1073,
...
int16_t g_as_mp15_80m_tone_lut[NUM_80M_SNGL_TONE_1_4_CIRCLE + 1] = {
    1159, 1153, 1136, 1109, 1070, 1022, 963, 896, 819, 735, 644, 546, 443, 336, 226, 114, 0,
};

int16_t g_as_mp15_160m_tone_lut[NUM_160M_SNGL_TONE_1_4_CIRCLE + 1] = {
    1159, 1153, 1136, 1109, 1070, 1022, 963, 896, 819, 735, 644, 546, 443, 336, 226, 114, 0
};

int16_t g_as_mp15_320m_tone_lut[NUM_320M_SNGL_TONE_1_4_CIRCLE + 1] = {
    1159, 1157, 1153, 1146, 1136, 1124, 1109, 1091,
    1070, 1047, 1022, 994, 963, 931, 896, 858,
    819, 778, 735, 690, 644, 596, 546, 495,
    443, 390, 336, 281, 226, 170, 114, 57, 0
...
int16_t g_as_mp15_640m_tone_lut[NUM_640M_SNGL_TONE_1_4_CIRCLE + 1] = {
    1159, 1158, 1157, 1155, 1153, 1150, 1146, 1141, 1136, 1130, 1124, 1117, 1109, 1100, 1091, 1081,
    1070, 1059, 1047, 1035, 1022, 1008, 994, 979, 963, 947, 931, 913, 896, 877, 858, 839,
    819, 799, 778, 757, 735, 713, 690, 667, 644, 620, 596, 571, 546, 521, 495, 469,
    443, 417, 390, 363, 336, 309, 281, 254, 226, 198, 170, 142, 114, 85, 57, 28, 0
...
/*
 * 函 数 名  : hmac_send_matrix_data
 * 功能描述  : 下发matrix校准数据共用函数
 * 1.日    期  : 2020年2月17日
 *   作    者  : wifi
 *   修改内容  : 新生成函数
 */
uint32_t hmac_send_matrix_data(mac_vap_stru *mac_vap, oal_netbuf_stru *netbuf,
    uint8_t *data, int32_t remain_len_temp)
{
    ...
    uint16_t                frame_len;
    uint32_t                ret;
    int32_t remain_len = remain_len_temp;
    ...
    while (remain_len > 0) {
        ...
        if (memcpy_s(data_dst, WLAN_LARGE_NETBUF_SIZE, data - remain_len, (uint32_t)frame_len) != EOK) {
...
uint32_t hmac_cali_data_send(mac_vap_stru *pst_mac_vap, uint16_t **pus_matrix_data_addr, uint32_t addr_len,
    uint32_t *aul_matrix_data_size, uint32_t data_len)
{
    ...
    oal_netbuf_stru *pst_netbuf_matrix_data =
        oal_mem_netbuf_alloc(OAL_NORMAL_NETBUF, WLAN_LARGE_NETBUF_SIZE, OAL_NETBUF_PRIORITY_MID);
    ...
    for (matrix_idx = 0; matrix_idx < data_len; matrix_idx++) {
        l_remain_len    = (int32_t)aul_matrix_data_size[matrix_idx];
        puc_matrix_addr = (uint8_t *)pus_matrix_data_addr[matrix_idx];
...
/*
 * 函 数 名  : hmac_send_cali_matrix_data_mp13
 * 功能描述  : 下发校准用到的矩阵信息
 * 1.日    期  : 2018年4月8日
 *   作    者  : wifi
 *   修改内容  : 新生成函数
...
{
    uint16_t               *pus_matrix_data_addr[MP13_CALI_MATRIX_DATA_NUMS] = {
    ...
    uint32_t                aul_matrix_data_size[MP13_CALI_MATRIX_DATA_NUMS] = {
    ...
    return hmac_cali_data_send(mac_vap, pus_matrix_data_addr, MP13_CALI_MATRIX_DATA_NUMS,
        aul_matrix_data_size, MP13_CALI_MATRIX_DATA_NUMS);
}

/*
 * 函 数 名  : hmac_send_mp15_cali_matrix_data
 * 功能描述  : 下发mp15校准用到的矩阵信息
 * 1.日    期  : 2018年4月8日
 *   作    者  : wifi
 *   修改内容  : 新生成函数
 */
...
{
    uint16_t               *pus_matrix_data_addr[MP13_CALI_MATRIX_DATA_NUMS] = {
        (uint16_t *)g_mp15_rxiq_h_comp_40m[0], (uint16_t *)g_mp15_rxiq_h_comp_80m_fpga[0],
        (uint16_t *)g_mp15_rxiq_h_comp_80m[0], (uint16_t *)g_mp15_rxiq_40m_h_comp_160m[0],
        (uint16_t *)g_mp15_rxiq_h_comp_160m[0], (uint16_t *)g_mp15_rxiq_h_comp_320m[0],
        (uint16_t *)g_mp15_txiq_h_comp_80m[0], (uint16_t *)g_mp15_txiq_h_comp_160m_fpga[0],
        (uint16_t *)g_mp15_txiq_h_comp_160m[0], (uint16_t *)g_mp15_2g_txiq_h_comp_320m[0],
        (uint16_t *)g_mp15_txiq_h_comp_320m[0], (uint16_t *)g_mp15_txiq_h_comp_640m[0],
        (uint16_t *)g_corram_data_20m, (uint16_t *)g_corram_data_40m, (uint16_t *)g_corram_data_80m,
        g_as_mp15_625k_80m_tone_lut, g_as_mp15_625k_160m_tone_lut, g_as_mp15_625k_320m_tone_lut,
        g_as_mp15_625k_640m_tone_lut, g_as_mp15_80m_tone_lut, g_as_mp15_160m_tone_lut,
        g_as_mp15_320m_tone_lut, g_as_mp15_640m_tone_lut
    };
...
static uint32_t hmac_send_cali_matrix_data_proc(
    mac_vap_stru *mac_vap, uint16_t **matrix_data_addr, uint32_t *matrix_data_size, uint32_t matrix_data_nums)
{
    oal_netbuf_stru *data = oal_mem_netbuf_alloc(OAL_NORMAL_NETBUF, WLAN_LARGE_NETBUF_SIZE, OAL_NETBUF_PRIORITY_MID);
    ...
    if (data == NULL) {
        oam_error_log1(mac_vap->uc_vap_id, OAM_SF_CALIBRATE,
            "{hmac_send_cali_matrix_data::data alloc null SIZE[%d].}", WLAN_LARGE_NETBUF_SIZE);
        return OAL_ERR_CODE_ALLOC_MEM_FAIL;
    }

    for (matrix_idx = 0; matrix_idx < matrix_data_nums; matrix_idx++) {
        ...
        /* 调用公共下发接口 */
        ret = hmac_send_matrix_data(mac_vap, data, param, remain_len);
        if (ret != OAL_SUCC) {
...
/*
 * 函 数 名  : hmac_send_cali_matrix_data_mp16
 * 功能描述  : 下发mp16校准用到的矩阵信息
 * 1.日    期  : 2018年4月8日
 *   作    者  : wifi
 *   修改内容  : 新生成函数
 */
...
{
    uint32_t matrix_data_nums = MP16_CALI_MATRIX_DATA_NUMS;
    uint16_t *matrix_data_addr[MP16_CALI_MATRIX_DATA_NUMS] = { (uint16_t *)g_dpd_corram_data_128bits };
    uint32_t matrix_data_size[MP16_CALI_MATRIX_DATA_NUMS] = {
        WLAN_CALI_DPD_CORRAM_DATA_128BITS_LEN * sizeof(uint32_t),  /* 大小:32bit * 3072 = 12288 Byte */
    };

    return hmac_send_cali_matrix_data_proc(mac_vap, matrix_data_addr, matrix_data_size, matrix_data_nums);
}

uint32_t hmac_send_cali_matrix_data_mp16c(mac_vap_stru *mac_vap)
{
    uint32_t matrix_data_nums = MP16_CALI_MATRIX_DATA_NUMS;
    uint16_t *matrix_data_addr[MP16_CALI_MATRIX_DATA_NUMS] = { (uint16_t *)g_dpd_corram_data_64bits };
    uint32_t matrix_data_size[MP16_CALI_MATRIX_DATA_NUMS] = {
        WLAN_CALI_DPD_CORRAM_DATA_64BITS_LEN * sizeof(uint32_t),  /* 大小:32bit * 3072 = 12288 Byte */
    };
...
uint32_t hmac_send_cali_data_mp13(mac_vap_stru *mac_vap, wlan_h2d_cali_data_type_enum_uint8 data_type)
{
    oal_netbuf_stru          *pst_netbuf_cali_data = NULL;
    mp13_cali_param_stru   *pst_cali_data = NULL;
    uint8_t                *puc_param = NULL;
    uint32_t                ret;
    int32_t                 l_remain_len;
    uint8_t                 uc_chan_idx;
    ...
    oam_info_log0(mac_vap->uc_vap_id, OAM_SF_CALIBRATE, "hmac_send_cali_data:start!");
    puc_mem_addr = get_cali_data_buf_addr();
    if (puc_mem_addr == NULL) {
        return OAL_ERR_CODE_PTR_NULL; // coverity err 61 fix
    }
    pst_cali_data = (mp13_cali_param_stru *)puc_mem_addr;
    ...
    for (uc_chan_idx = 0; uc_chan_idx < WLAN_RF_CHANNEL_NUMS; uc_chan_idx++) {
        ...
        if (en_save_all == OAL_FALSE) {
            ...
            oam_warning_log1(mac_vap->uc_vap_id, OAM_SF_CALIBRATE,
        ...
        while (l_remain_len > 0) {
            ret = hmac_post_cali_data_event(mac_vap, pst_netbuf_cali_data, puc_param, &l_remain_len);
            if (ret != OAL_SUCC) {
                oal_netbuf_free(pst_netbuf_cali_data);
                return ret;
            }
    ...
    oam_info_log0(mac_vap->uc_vap_id, OAM_SF_CALIBRATE, "hmac_send_cali_data:end!");
    oal_netbuf_free(pst_netbuf_cali_data);

    return OAL_SUCC;
}

uint32_t hmac_send_cali_data_mp15(mac_vap_stru *mac_vap, wlan_h2d_cali_data_type_enum_uint8 data_type)
{
    oal_netbuf_stru          *pst_netbuf_cali_data = NULL;
    mp15_cali_param_stru   *pst_mp15_cali_data = NULL;
    uint8_t                *puc_param = NULL;
    uint32_t                ret;
    int32_t                 l_remain_len;
    uint8_t                 uc_chan_idx;
    ...
    pst_mp15_cali_data = (mp15_cali_param_stru *)puc_mem_addr;
    pst_mp15_cali_data->en_need_close_fem_cali = g_en_need_close_fem_cali;
    hmac_dump_cali_result_mp15();
    ...
    for (uc_chan_idx = 0; uc_chan_idx < WLAN_RF_CHANNEL_NUMS; uc_chan_idx++) {
        /* 单通道下发wifi校准长度 */
        l_remain_len  = MP15_SINGLE_CHAN_CALI_DATA_BUF_LEN - sizeof(pst_mp15_cali_data->dog_tag);
        pst_mp15_cali_data += uc_chan_idx;
        en_save_all = pst_mp15_cali_data->en_save_all;
        ...
        puc_param = (uint8_t *)(&(pst_mp15_cali_data->st_2gcali_param)) + l_remain_len;
        while (l_remain_len > 0) {
            ret = hmac_post_cali_data_event(mac_vap, pst_netbuf_cali_data, puc_param, &l_remain_len);
            if (ret != OAL_SUCC) {
                oal_netbuf_free(pst_netbuf_cali_data);
 ...
 * 功能描述  : 获取2g当前信道校准下发数据
 */
void hmac_set_2g_chn_cali_data(mp1x_wlan_cali_data_para_stru *cali_data, uint8_t subband_idx,
    wlan_bandwidth_type_enum_uint8 bandwidth)
{
    mp1x_wlan_cali_2g_20m_save_stru *cali_data_2g = NULL;
    uint8_t rf_idx;
    wlan_cali_2g_dbdc_para_stru *dbdc_data_2g = NULL;

    for (rf_idx = 0; rf_idx < hmac_get_rf_num(); rf_idx++) {
        cali_data_2g = &cali_data->rf_cali_data[rf_idx].cali_data_2g_20m;
        memcpy_s(&g_hmac_chn_cali_data.cali_data[rf_idx], sizeof(mp1x_wlan_cali_basic_para_stru),
            &cali_data_2g->cali_data[subband_idx], sizeof(mp1x_wlan_cali_basic_para_stru));
    }

    for (rf_idx = 0; rf_idx < hmac_get_slave_rf_num(); rf_idx++) {
        dbdc_data_2g = &cali_data->dbdc_cali_data[rf_idx].cali_data_2g_dbdc;
        memcpy_s(&g_hmac_chn_cali_data.dbdc_cali_data[rf_idx], sizeof(wlan_cali_dbdc_basic_para_stru),
            &dbdc_data_2g->cali_data_20[subband_idx], sizeof(wlan_cali_dbdc_basic_para_stru));
    }
}

void hmac_set_2g_chn_cali_data_mp12(mp12_wlan_cali_data_para_stru *cali_data, uint8_t subband_idx,
    wlan_bandwidth_type_enum_uint8 bandwidth)
{
    mp12_wlan_cali_2g_20m_save_stru *cali_data_2g = NULL;
    uint8_t rf_idx;

    for (rf_idx = 0; rf_idx < hmac_get_rf_num(); rf_idx++) {
        cali_data_2g = &cali_data->rf_cali_data[rf_idx].cali_data_2g_20m;
        memcpy_s(&g_hmac_chn_cali_data_mp12.cali_data[rf_idx], sizeof(mp12_wlan_cali_basic_para_stru),
            &cali_data_2g->cali_data[subband_idx], sizeof(mp12_wlan_cali_basic_para_stru));
    }
}
 ...
 * 功能描述  : 获取6g当前信道校准下发数据
 */
void hmac_set_6g_chn_cali_data(mp1x_wlan_cali_data_para_stru *cali_data, uint8_t subband_idx,
    wlan_bandwidth_type_enum_uint8 bandwidth)
{
    uint8_t rf_idx;
    wlan_cali_dbdc_basic_para_stru *dbdc_chn_cali_data = NULL;
    mp1x_wlan_cali_basic_para_stru *chn_cali_data = NULL;
    ...
    for (rf_idx = 0; rf_idx < hmac_get_rf_num(); rf_idx++) {
        ...
        memcpy_s(&g_hmac_chn_cali_data.cali_data[rf_idx], sizeof(mp1x_wlan_cali_basic_para_stru),
                 chn_cali_data, sizeof(mp1x_wlan_cali_basic_para_stru));
    }

    for (rf_idx = 0; rf_idx < hmac_get_slave_rf_num(); rf_idx++) {
        cali_data_6g_dbdc = &cali_data->dbdc_cali_data[rf_idx].cali_data_6g_dbdc;
        if (bandwidth <= WLAN_BANDWIDTH_40) {
            dbdc_chn_cali_data = &cali_data_6g_dbdc->cali_data_20[subband_idx];
        } else if (bandwidth == WLAN_BANDWIDTH_80) {
            dbdc_chn_cali_data = &cali_data_6g_dbdc->cali_data_80[subband_idx];
        } else {
            dbdc_chn_cali_data = &cali_data_6g_dbdc->cali_data_160[subband_idx];
        }
        memcpy_s(&g_hmac_chn_cali_data.dbdc_cali_data[rf_idx],
 ...
 * 功能描述  : 获取5g当前信道校准下发数据
 */
void hmac_set_5g_chn_cali_data(mp1x_wlan_cali_data_para_stru *cali_data, uint8_t subband_idx,
    wlan_bandwidth_type_enum_uint8 bandwidth)
{
    uint8_t rf_idx;
    wlan_cali_dbdc_basic_para_stru *dbdc_chn_cali_data = NULL;
    ...
    for (rf_idx = 0; rf_idx < hmac_get_slave_rf_num(); rf_idx++) {
        cali_data_5g_dbdc = &cali_data->dbdc_cali_data[rf_idx].cali_data_5g_dbdc;
        if (bandwidth <= WLAN_BANDWIDTH_40) {
            dbdc_chn_cali_data = &cali_data_5g_dbdc->cali_data_20[subband_idx];
        } else if (bandwidth == WLAN_BANDWIDTH_80) {
            dbdc_chn_cali_data = &cali_data_5g_dbdc->cali_data_80[subband_idx];
        } else {
            dbdc_chn_cali_data = &cali_data_5g_dbdc->cali_data_160[subband_idx];
        }
...
void hmac_set_5g_chn_cali_data_mp12(mp12_wlan_cali_data_para_stru *cali_data, uint8_t subband_idx,
    wlan_bandwidth_type_enum_uint8 bandwidth)
{
    uint8_t rf_idx;
    mp12_wlan_cali_basic_para_stru *chn_cali_data = NULL;
    ...
    for (rf_idx = 0; rf_idx < hmac_get_rf_num(); rf_idx++) {
        ...
        memcpy_s(&g_hmac_chn_cali_data_mp12.cali_data[rf_idx], sizeof(mp12_wlan_cali_basic_para_stru),
                 chn_cali_data, sizeof(mp12_wlan_cali_basic_para_stru));
    }
}
/*
...
void hmac_set_chn_cali_data_mp12(wlan_cali_band_enum_uint8 wlan_cali_band, uint8_t subband_idx,
    wlan_bandwidth_type_enum_uint8 bandwidth)
{
    uint8_t *mem_addr = get_cali_data_buf_addr();
    mp12_wlan_cali_data_para_stru *cali_data = (mp12_wlan_cali_data_para_stru *)mem_addr;
    if (wlan_cali_band == WLAN_CALI_BAND_2G) {
        hmac_set_2g_chn_cali_data_mp12(cali_data, subband_idx, bandwidth);
    } else {
        hmac_set_5g_chn_cali_data_mp12(cali_data, subband_idx, bandwidth);
    }
}
...
void hmac_set_20m_basic_cali_data(wlan_cali_20m_basic_para_stru *cali_data_20m,
    mp1x_wlan_cali_basic_para_stru *cali_data)
{
...
void hmac_set_20m_basic_cali_data_mp12(wlan_cali_20m_basic_para_stru *cali_data_20m,
    mp12_wlan_cali_basic_para_stru *cali_data)
{
    memcpy_s(&cali_data_20m->rxdc_cali_data, sizeof(wlan_cali_rxdc_para_stru),
        &cali_data->rxdc_cali_data, sizeof(wlan_cali_rxdc_para_stru));
    memcpy_s(&cali_data_20m->txpwr_cali_data, sizeof(wlan_cali_txpwr_para_stru),
 ...
 */
void hmac_set_2g_20m_cali_data(mp1x_wlan_cali_data_para_stru *cali_data)
{
    uint8_t rf_idx;
    int32_t ret = EOK;
    uint8_t chn_idx;
...
void hmac_set_2g_20m_cali_data_mp12(mp12_wlan_cali_data_para_stru *cali_data)
{
    uint8_t rf_idx;
    int32_t ret = EOK;
    uint8_t chn_idx;
    ...
    for (rf_idx = 0; rf_idx < rf_num; rf_idx++) {
        cali_data_2g = &cali_data->rf_cali_data[rf_idx].cali_data_2g_20m;
        cali_data_2g_20m = &g_hmac_scan_all_ch_cali_data_mp12[rf_idx].cali_data_2g;
        for (chn_idx = 0; chn_idx < WLAN_2G_CALI_BAND_NUM; chn_idx++) {
            hmac_set_20m_basic_cali_data_mp12(&cali_data_2g_20m->chn_cali_data[chn_idx],
                &cali_data_2g->cali_data[chn_idx]);
        }
    }
    if (ret != EOK) {
        oam_error_log0(0, OAM_SF_ANY, "hmac_set_2g_20m_cali_data_mp12: memcopy fail!\n");
    }
}
/*
 ...
 */
void hmac_set_5g_20m_cali_data(mp1x_wlan_cali_data_para_stru *cali_data)
{
    uint8_t rf_idx;
    uint8_t chn_idx;
    mp1x_wlan_cali_5g_20m_save_stru *cali_data_5g = NULL;
...
void hmac_set_5g_20m_cali_data_mp12(mp12_wlan_cali_data_para_stru *cali_data)
{
    uint8_t rf_idx;
    uint8_t chn_idx;
    mp12_wlan_cali_5g_20m_save_stru *cali_data_5g = NULL;
    wlan_cali_5g_20m_para_stru *cali_data_5g_20m = NULL;
    uint8_t rf_num = hmac_get_rf_num();

    for (rf_idx = 0; rf_idx < rf_num; rf_idx++) {
        cali_data_5g = &cali_data->rf_cali_data[rf_idx].cali_data_5g_20m;
        cali_data_5g_20m = &g_hmac_scan_all_ch_cali_data_mp12[rf_idx].cali_data_5g;

        for (chn_idx = 0; chn_idx < WLAN_5G_20M_CALI_BAND_NUM; chn_idx++) {
            hmac_set_20m_basic_cali_data_mp12(&cali_data_5g_20m->chn_cali_data[chn_idx],
                &cali_data_5g->cali_data[chn_idx]);
        }
    }
}
 ...
 */
void hmac_set_6g_20m_cali_data(mp1x_wlan_cali_data_para_stru *cali_data)
{
    uint8_t rf_idx;
    uint8_t chn_idx;
...
wlan_cali_dbdc_basic_para_stru *hmac_get_dbdc_basic_cali_data_addr(mp1x_wlan_cali_data_para_stru *cali_data,
...
void hmac_set_scan_dbdc_cali_data(void)
{
    ...
    uint8_t rf_slave_num = hmac_get_slave_scan_rf_num();
    ...
    for (rf_idx = 0; rf_idx < rf_slave_num; rf_idx++) {
        for (wlan_cali_band = WLAN_CALI_BAND_2G; wlan_cali_band < HAL_MAX_BAND_NUM; wlan_cali_band++) {
            for (chn_idx = 0; chn_idx < chn_num[wlan_cali_band]; chn_idx++) {
                scan_cali_data = hmac_get_scan_basic_cali_data_addr(rf_slave_idx + rf_idx, wlan_cali_band, chn_idx);
                dbdc_cali_data = hmac_get_dbdc_basic_cali_data_addr(cali_data,
                    rf_idx, wlan_cali_band, chn_idx);
...
void hmac_set_scan_cali_data(mac_vap_stru *mac_vap)
{
    ...
    memcpy_s(&g_hmac_20m_cali_common_data.common_cali_data, sizeof(mp1x_wlan_cali_common_para_stru),
        &cali_data->common_cali_data, sizeof(mp1x_wlan_cali_common_para_stru));
    g_hmac_20m_cali_common_data.open_wifi_cali = g_open_wifi_cali;
    if (g_en_need_close_fem_cali == OAL_TRUE) {
        g_hmac_20m_cali_common_data.open_wifi_cali = OAL_FALSE;
    }
    g_hmac_20m_cali_common_data.fac_cali_chain = g_wifi_fac_cali_chain & 0xFFFF;
#if (_PRE_OS_VERSION_LINUX == _PRE_OS_VERSION)
    g_hmac_20m_cali_common_data.cali_cnt = g_custom_cali_cnt;
#endif
}

void hmac_set_scan_cali_data_mp12(mac_vap_stru *mac_vap)
{
    uint8_t *mem_addr = get_cali_data_buf_addr();
    mp12_wlan_cali_data_para_stru *cali_data = (mp12_wlan_cali_data_para_stru *)mem_addr;
    uint32_t *check_hw_status = NULL;
    ...
    hmac_set_2g_20m_cali_data_mp12(cali_data);
    hmac_set_5g_20m_cali_data_mp12(cali_data);
    /* wifi打开前清空fem status维测信息 */
    check_hw_status = cali_data->common_cali_data.cali_ctl_data.check_hw_status;
    for (rf_id = 0; rf_id < MP12_HD_EVENT_RF_NUM; rf_id++) {
        check_hw_status[rf_id] &= ~WLAN_FEM_PA_STATUS_MASK;
    }
    cali_data->common_cali_data.cali_ctl_data.fem_error_band = 0;
    cali_data->common_cali_data.cali_ctl_data.curr_bt_on_flag = 0;
    cali_data->common_cali_data.cali_ctl_data.curr_gle_on_flag = 0;
    memcpy_s(&g_hmac_20m_cali_common_data_mp12.common_cali_data, sizeof(mp12_wlan_cali_common_para_stru),
        &cali_data->common_cali_data, sizeof(mp12_wlan_cali_common_para_stru));
    g_hmac_20m_cali_common_data_mp12.open_wifi_cali = g_open_wifi_cali;
    if (g_en_need_close_fem_cali == OAL_TRUE) {
        g_hmac_20m_cali_common_data_mp12.open_wifi_cali = OAL_FALSE;
    }
    g_hmac_20m_cali_common_data_mp12.fac_cali_chain = g_wifi_fac_cali_chain & 0xFFFF;
#if (_PRE_OS_VERSION_LINUX == _PRE_OS_VERSION)
    g_hmac_20m_cali_common_data_mp12.cali_cnt = g_custom_cali_cnt;
#endif
}
...
int32_t hmac_get_cali_data_send_len(h2d_cali_trans_stru *h2d_cali_trans)
{
    ...
    switch (h2d_cali_trans->cali_data_type) {
        case WLAN_CURRENT_WORK_CHN:
            data_len =  sizeof(mp1x_wlan_cali_chn_stru);
            break;
        case WLAN_SCAN_ALL_CHN:
            data_len =  sizeof(mp1x_wlan_cali_rf_20m_para_stru) * rf_num;
            break;
        case WLAN_CALI_CTL:
            data_len =  sizeof(mp1x_wlan_cali_data_20m_common_para_stru);
            break;
        case WLAN_CALI_CTL_EXT:
            data_len =  sizeof(mp1x_wlan_cali_common_ext_stru);
            break;
        case WLAN_SCAN_ALL_CHN_SLAVE:
            data_len =  sizeof(mp1x_wlan_cali_rf_20m_para_stru) * rf_slave_num;
            break;
        default:
             oam_error_log1(0, OAM_SF_CALIBRATE,
...
int32_t hmac_get_cali_data_send_len_mp12(h2d_cali_trans_stru *h2d_cali_trans)
{
    uint8_t rf_num = hmac_get_rf_num();
    size_t data_len = 0;
    ...
    switch (h2d_cali_trans->cali_data_type) {
        case WLAN_CURRENT_WORK_CHN:
            data_len =  sizeof(mp12_wlan_cali_chn_stru);
            break;
        case WLAN_SCAN_ALL_CHN:
            data_len =  sizeof(mp12_wlan_cali_rf_20m_para_stru) * rf_num;
            break;
        case WLAN_CALI_CTL:
            data_len =  sizeof(mp12_wlan_cali_data_20m_common_para_stru);
            break;
        case WLAN_CALI_CTL_EXT:
            data_len =  sizeof(mp12_wlan_cali_common_ext_stru);
            break;
        default:
            oam_error_log1(0, OAM_SF_CALIBRATE,
                "hmac_get_cali_data_send_len_mp12 fail::cali_data_type[%d].}", h2d_cali_trans->cali_data_type);
            break;
    }
    return (int32_t)data_len;
}
...
uint8_t *hmac_get_cali_data_send_addr(h2d_cali_trans_stru *h2d_cali_trans)
{
    ...
    uint8_t rf_slave_idx = hmac_get_slave_scan_rf_start_idx();
    uint8_t *mem_addr = get_cali_data_buf_addr();
    mp1x_wlan_cali_data_para_ext_stru *cali_data = (mp1x_wlan_cali_data_para_ext_stru *)mem_addr;
    ...
    switch (h2d_cali_trans->cali_data_type) {
        ...
        case WLAN_CALI_CTL:
            ...
            break;
        case WLAN_CALI_CTL_EXT:
            data_addr = (uint8_t *)(&cali_data->common_cali_data_ext);
            break;
        case WLAN_SCAN_ALL_CHN_SLAVE:
            data_addr = (uint8_t *)(&g_hmac_scan_all_ch_cali_data[rf_slave_idx]);
            break;
        default:
            oam_error_log1(0, OAM_SF_CALIBRATE,
...
uint8_t *hmac_get_cali_data_send_addr_mp12(h2d_cali_trans_stru *h2d_cali_trans)
{
    uint8_t *data_addr = NULL;
    uint8_t *mem_addr = get_cali_data_buf_addr();
    mp12_wlan_cali_data_para_ext_stru *cali_data = (mp12_wlan_cali_data_para_ext_stru *)mem_addr;

    switch (h2d_cali_trans->cali_data_type) {
        case WLAN_CURRENT_WORK_CHN:
            data_addr = (uint8_t *)(&g_hmac_chn_cali_data_mp12);
            break;
        case WLAN_SCAN_ALL_CHN:
            data_addr = (uint8_t *)(&g_hmac_scan_all_ch_cali_data_mp12[0]);
            break;
        case WLAN_CALI_CTL:
            data_addr = (uint8_t *)(&g_hmac_20m_cali_common_data_mp12);
            break;
        case WLAN_CALI_CTL_EXT:
            data_addr = (uint8_t *)(&cali_data->common_cali_data_ext);
            break;
        default:
            oam_error_log1(0, OAM_SF_CALIBRATE,
                "hmac_get_cali_data_send_addr_mp12 fail::cali_data_type[%d].}", h2d_cali_trans->cali_data_type);
            break;
    }
    return data_addr;
}
...
/*
 * 函 数 名  : hmac_post_cali_data_event_mp16
 * 功能描述  : 校准数据下发抛事件
 */
static uint32_t hmac_post_cali_data_event_mp16(mac_vap_stru *mac_vap, oal_netbuf_stru *netbuf,
    uint8_t *cali_data, int32_t *remain_len, h2d_cali_trans_stru *h2d_cali_trans)
{
    ...
    evt_mem = frw_event_alloc_m(sizeof(dmac_tx_event_stru));
    if (evt_mem == NULL) {
        oam_error_log0(mac_vap->uc_vap_id, OAM_SF_CALIBRATE, "{hmac_post_cali_data_event::event_mem null.}");
        return OAL_ERR_CODE_PTR_NULL;
    }
    ...
    if (ret != EOK) {
        oam_error_log0(mac_vap->uc_vap_id, OAM_SF_CALIBRATE, "hmac_post_cali_data_event::memcpy fail!");
        frw_event_free_m(evt_mem);
        return OAL_FAIL;
    }
    ...
    *remain_len -= h2d_cali_trans->curr_send_data_len;
    ...
    if (oal_unlikely(ret != OAL_SUCC)) {
        oam_error_log3(mac_vap->uc_vap_id, OAM_SF_CALIBRATE,
            "{hmac_post_cali_data_event::dispatch event fail ret[%d], remain_len[%d] trans_len[%d].}",
...
uint16_t g_cali_data_trans_id = 0;
uint32_t hmac_send_cali_data_mp16(mac_vap_stru *mac_vap, h2d_cali_trans_stru *h2d_cali_trans)
{
    ...
    int32_t                    remain_len;
#ifndef _PRE_EMU
    param = wlan_chip_get_cali_data_send_addr(h2d_cali_trans);
    remain_len = wlan_chip_get_cali_data_send_len(h2d_cali_trans);
    if (param == NULL || remain_len == 0 || mac_vap == NULL) {
        return OAL_FAIL;
    }

    h2d_cali_trans->cali_data_total_len = remain_len;
    h2d_cali_trans->netbuf_idx = 0;
    h2d_cali_trans->trans_id = g_cali_data_trans_id;
    g_cali_data_trans_id++;
    param += remain_len;
    ...
    while (remain_len > 0) {
        ret = hmac_post_cali_data_event_mp16(mac_vap, netbuf, param, &remain_len, h2d_cali_trans);
        if (ret != OAL_SUCC) {
            oal_netbuf_free(netbuf);
            return ret;
        }
        h2d_cali_trans->netbuf_idx++;
    }
    oam_warning_log3(mac_vap->uc_vap_id, OAM_SF_CALIBRATE,
        "{hmac_send_cali_data::trans id %d data type %d len %d succ!}",
        h2d_cali_trans->trans_id, h2d_cali_trans->cali_data_type, h2d_cali_trans->cali_data_total_len);
    oal_netbuf_free(netbuf);
#endif
    return OAL_SUCC;
}
    ...
    uint8_t work_cali_data_sub_type)
{
    ...
    oal_bool_enum_uint8 free_old_cali_data = OAL_TRUE;
#ifdef _PRE_WLAN_CHBA_MGMT
    ...
    /* CHBA csa补救需要回old chan进行补救，老信道数据不需释放，否则device此时仍为旧信道找不到校准数据，补救结束后释放即可 */
    if (mac_is_chba_mode(mac_vap) && chan_switch_info->csa_lost_device_num > 0) {
        oam_warning_log0(mac_vap->uc_vap_id, OAM_SF_CFG,
            "{hmac_chan_switch_to_new_chan_check::chba save lost device, NO free old cali data!}");
        free_old_cali_data = OAL_FALSE;
    }
#endif
    /* 下发新校准数据前，先清理老信道数据 */
    if (free_old_cali_data == OAL_TRUE) {
        if (hmac_config_send_event(mac_vap, WLAN_CFGID_CLEAR_OLD_CHAN_CALI_DATA, 0, NULL) != OAL_SUCC) {
            oam_warning_log0(mac_vap->uc_vap_id, 0, "{hmac_cali_send_work_channel_cali_data:free cali data fail}");
        }
    }

    cali_data_req_info.channel = *channel;
    cali_data_req_info.mac_vap_id = mac_vap->uc_vap_id;
    cali_data_req_info.work_cali_data_sub_type = work_cali_data_sub_type;
    ...
    wlan_bandwidth_type_enum_uint8 cali_bandwidth, wlan_cali_band_enum_uint8 wlan_cali_band)
{
    ...
    wlan_chip_set_chn_cali_data(wlan_cali_band, subband_idx, cali_bandwidth);
    ret = hmac_send_cali_data_mp16(mac_vap, &h2d_cali_trans);
    if (ret != OAL_SUCC) {
...
void hmac_update_2g_all_band_cali_data_mp12(cali_data_req_stru *cali_data_req_info)
{
    uint8_t subband_idx;
    uint16_t center_freq = hmac_get_center_freq_from_freq_chnnum(&cali_data_req_info->channel);
    uint8_t curr_subband_idx = wlan_rf_cali_div_cali_2g_band_idx(WLAN_RF_CALI_TX_PWR, WLAN_BANDWIDTH_40, center_freq);
...
void hmac_update_5g_cur_band_cali_data_mp16(cali_data_req_stru *cali_data_req_info)
{
    ...
    if (curr_cali_bandwidth == WLAN_BANDWIDTH_160) {
        memcpy_s(&channel_temp, sizeof(mac_channel_stru), &(cali_data_req_info->channel), sizeof(mac_channel_stru));
...
void hmac_update_5g_cur_band_cali_data_mp12(cali_data_req_stru *cali_data_req_info)
{
    wlan_bandwidth_type_enum_uint8 cali_bandwidth;
    wlan_bandwidth_type_enum_uint8 curr_cali_bandwidth = hmac_cali_get_wlan_bandwidth(&cali_data_req_info->channel);
    uint16_t center_freq = hmac_get_center_freq_from_freq_chnnum(&cali_data_req_info->channel);
    ...
    /* 5G当前信道所在band的所有支持带宽都下发 */
    for (cali_bandwidth = WLAN_BANDWIDTH_40; cali_bandwidth <= WLAN_BANDWIDTH_80; cali_bandwidth++) {
        if (cali_bandwidth == curr_cali_bandwidth) {
            continue;
        }
        subband_idx = wlan_rf_cali_div_cali_5g_band_idx(WLAN_RF_CALI_TX_PWR, cali_bandwidth, center_freq);
...
#ifdef _PRE_WLAN_FEATURE_6G_EXTEND
void hmac_update_6g_cur_band_cali_data_mp16(cali_data_req_stru *cali_data_req_info)
{
    uint8_t subband_idx;
    wlan_bandwidth_type_enum_uint8 cali_bandwidth;
    wlan_bandwidth_type_enum_uint8 curr_cali_bandwidth = hmac_cali_get_wlan_bandwidth(&cali_data_req_info->channel);
...
wlan_bandwidth_type_enum_uint8 hmac_cali_get_wlan_bandwidth(mac_channel_stru *chn_para)
{
    ...
    } else if ((chn_para->en_bandwidth <= WLAN_BAND_WIDTH_40MINUS) || (chn_para->en_bandwidth == WLAN_BAND_WIDTH_40M)) {
        return WLAN_BANDWIDTH_40;
    } else if ((chn_para->en_bandwidth <= WLAN_BAND_WIDTH_80MINUSMINUS) ||
                (chn_para->en_bandwidth == WLAN_BAND_WIDTH_80M)) {
...
static void hmac_update_csa_channel_cali_data_mp12(cali_data_req_stru *cali_data_req_info)
{
    uint8_t band;
    uint8_t subband_idx;
    wlan_bandwidth_type_enum_uint8 cali_bandwidth;
...
/*
 * 函 数 名  : hmac_update_cur_chn_cali_data_mp16
 * 功能描述  : 根据信道信息更新当前信道校准数据
 */
void hmac_update_cur_chn_cali_data_mp16(cali_data_req_stru *cali_data_req_info)
{
    ...
    oam_warning_log3(cali_data_req_info->mac_vap_id, OAM_SF_CALIBRATE,
        "{hmac_update_cur_chn_cali_data_mp16::get cali data info: channel[%d] bw[%d], cali_data_sub_type %d}",
    ...
    if (wlan_cali_band == WLAN_CALI_BAND_2G) {
        ...
        hmac_update_5g_cur_band_cali_data_mp16(cali_data_req_info);
#ifdef _PRE_WLAN_FEATURE_6G_EXTEND
    } else if (wlan_cali_band == WLAN_CALI_BAND_6G) {
        hmac_update_6g_cur_band_cali_data_mp16(cali_data_req_info);
#endif
    }
}

void hmac_update_cur_chn_cali_data_mp12(cali_data_req_stru *cali_data_req_info)
{
    wlan_cali_band_enum_uint8 wlan_cali_band = wlan_get_cali_band(&cali_data_req_info->channel);

    oam_warning_log3(0, OAM_SF_CALIBRATE,
        "{hmac_update_cur_chn_cali_data_mp12::get cali data info: channel[%d] bw[%d], cali_data_sub_type %d}",
        cali_data_req_info->channel.uc_chan_number,
        cali_data_req_info->channel.en_bandwidth,
        cali_data_req_info->work_cali_data_sub_type);
    /* 1、csa type只下发当前所需要的bw,待csa结束后释放old的3个bw补充new的 */
    if (cali_data_req_info->work_cali_data_sub_type == CALI_DATA_CSA_TYPE) {
        hmac_update_csa_channel_cali_data_mp12(cali_data_req_info);
        return;
    }
    /* 2、normal join需要多下发 */
    if (wlan_cali_band == WLAN_CALI_BAND_2G) {
        hmac_update_2g_all_band_cali_data_mp12(cali_data_req_info);
    } else {
        hmac_update_5g_cur_band_cali_data_mp12(cali_data_req_info);
    }
}
...
static void hmac_save_cali_data_end(uint16_t *cali_times)
{
    ...
    (*cali_times)++;
    set_cali_update_channel_info((uint32_t)(*cali_times));
...
void hmac_first_powon_cali_completed(void)
{
    if (hmac_get_wlan_first_power_on_cali_flag() == OAL_TRUE) {
        ...
        oam_warning_log0(0, OAM_SF_CALIBRATE, "{hmac_first_powon_cali_completed:power on and cali completed!}");
    }
}
...
uint32_t hmac_save_cali_event_mp13(frw_event_mem_stru *event_mem)
{
    ...
    if (memcpy_s(start_addr, remain_len, payload->auc_payoald, copy_len) != EOK) {
...
uint32_t hmac_save_cali_event_mp15(frw_event_mem_stru *event_mem)
{
    ...
    cali_data_size = MP15_CALI_DATA_BUF_LEN - (sizeof(cali_data->dog_tag) << BIT_OFFSET_1);

    /*  如果上次数据传输异常中断，本次数据传输重新开始  */
    ...
    /* 通道1的校准数据 */
    if (cali_data_len >= (MP15_SINGLE_CHAN_CALI_DATA_BUF_LEN - sizeof(cali_data->dog_tag))) {
        cali_data++;
        remain_len  = cali_data_size - cali_data_len;
    } else {
        remain_len  = (cali_data_size >> BIT_OFFSET_1) - cali_data_len;
    ...
    if (cali_data_size == cali_data_len) {
        cali_data_len = 0;
        hmac_dump_cali_result_mp15();
        hmac_get_mp15_cali_data_for_bt20dbm();
    }
    ...
    wlan_d2h_cali_data_type_enum_uint8 data_type)
{
    ...
    if (data_type == WLAN_CALI_DATA_COMMON_EXT) {
        /* common extend校准数据，放在最后传输，传输完成后立即返回结束上传 */
        return;
    }
...
uint32_t hmac_get_cali_data_size(wlan_d2h_cali_data_type_enum_uint8 data_type)
{
    ...
    uint32_t data_size[WLAN_CALI_DATA_C0_BUTT] = {
        sizeof(mp1x_wlan_cali_2g_20m_save_stru), 0, sizeof(mp1x_wlan_cali_5g_20m_save_stru), 0,
        sizeof(mp1x_wlan_cali_5g_80m_save_stru), sizeof(wlan_cali_5g_160m_save_stru),
#ifdef _PRE_WLAN_FEATURE_6G_EXTEND
    ...
    if (data_type == WLAN_CALI_DATA_COMMON) {
        return sizeof(mp1x_wlan_cali_common_para_stru);
    }
    if (data_type >= WLAN_CALI_DATA_DBDC_C0 && data_type <= WLAN_CALI_DATA_DBDC_C3) {
        return sizeof(wlan_cali_dbdc_para_stru);
    }
    if (data_type == WLAN_CALI_DATA_COMMON_EXT) {
        return sizeof(mp1x_wlan_cali_common_ext_stru);
    }
    return 0;
}

uint32_t hmac_get_cali_data_size_mp12(wlan_d2h_cali_data_type_enum_uint8 data_type)
{
    uint8_t data_idx;
    uint32_t data_size[WLAN_CALI_DATA_C0_BUTT] = {
        sizeof(mp12_wlan_cali_2g_20m_save_stru), 0, sizeof(mp12_wlan_cali_5g_20m_save_stru), 0,
        sizeof(mp12_wlan_cali_5g_80m_save_stru), 0,
        0, 0, 0, 0,
    };
    if (data_type < WLAN_CALI_DATA_DBDC) {
        data_idx = data_type % (WLAN_CALI_DATA_C0_BUTT);
    ...
    if (data_type == WLAN_CALI_DATA_COMMON) {
        return sizeof(mp12_wlan_cali_common_para_stru);
    }
    if (data_type == WLAN_CALI_DATA_COMMON_EXT) {
        return sizeof(mp12_wlan_cali_common_ext_stru);
    }
    return 0;
}

uint8_t *hmac_get_slave_cali_data_save_addr_mp16(uint8_t *mem_addr,
    wlan_d2h_cali_data_type_enum_uint8 data_type)
{
    uint8_t slave_data_idx = data_type - WLAN_CALI_DATA_DBDC_C0 - hmac_get_slave_scan_rf_start_idx();
    mp1x_wlan_cali_data_para_stru *cali_data = (mp1x_wlan_cali_data_para_stru *)mem_addr;
    if (data_type - WLAN_CALI_DATA_DBDC_C0 < hmac_get_slave_rf_start_idx()) {
        oam_error_log1(0, OAM_SF_ANY, "hmac_get_slave_cali_data_save_addr_mp16::data type %d!", data_type);
        return (uint8_t *)(&cali_data->dbdc_cali_data[0]);
    }

    return (uint8_t *)(&cali_data->dbdc_cali_data[slave_data_idx]);
}

uint8_t *hmac_get_slave_cali_data_save_addr_mp17c(uint8_t *mem_addr,
    wlan_d2h_cali_data_type_enum_uint8 data_type)
{
    uint8_t slave_data_idx = data_type - WLAN_CALI_DATA_DBDC_C0 - hmac_get_slave_rf_start_idx();
    mp1x_wlan_cali_data_para_ext_stru *cali_data = (mp1x_wlan_cali_data_para_ext_stru *)mem_addr;
    if (data_type - WLAN_CALI_DATA_DBDC_C0 < hmac_get_slave_scan_rf_start_idx()) {
        oam_error_log1(0, OAM_SF_ANY, "hmac_get_slave_cali_data_save_addr_mp17c::data type %d!", data_type);
        return (uint8_t *)(&cali_data->cali_data.dbdc_cali_data[0]);
    }

    return (uint8_t *)(&cali_data->cali_data.dbdc_cali_data[slave_data_idx]);
}
    ...
    wlan_d2h_cali_data_type_enum_uint8 data_type)
{
    ...
    if (data_type >= WLAN_CALI_DATA_DBDC_C0 && data_type <= WLAN_CALI_DATA_DBDC_C3) {
        return wlan_chip_get_slave_cali_data_save_addr(cali_data, data_type);
    }
    for (data_idx = 0; data_idx < data_type; data_idx++) {
        /* 辅路数据前面WLAN_CALI_DATA_DBDC枚举值已计算，这里不做重复计算，避免offset计算错误 */
        if (data_idx < WLAN_CALI_DATA_DBDC_C0 || data_idx > WLAN_CALI_DATA_DBDC_C3) {
            addr_offset += wlan_chip_get_cali_data_size(data_idx);
        }
    }
...
uint16_t *hmac_save_cali_event_get_cali_times(uint8_t *mem_addr)
{
    mp1x_wlan_cali_data_para_stru *cali_data = (mp1x_wlan_cali_data_para_stru *)mem_addr;

    return &cali_data->common_cali_data.cali_ctl_data.cali_update_info.us_cali_time;
}

uint16_t *hmac_save_cali_event_get_cali_times_mp12(uint8_t *mem_addr)
{
    mp12_wlan_cali_data_para_stru *cali_data = (mp12_wlan_cali_data_para_stru *)mem_addr;
...
uint32_t hmac_save_cali_event_mp16(frw_event_mem_stru *event_mem)
{
    ...
    wlan_d2h_cali_data_type_enum_uint8 data_type;
    uint8_t                        *mem_addr = (uint8_t *)get_cali_data_buf_addr();
    mac_vap_stru *mac_vap = (mac_vap_stru *)mac_res_get_mac_vap(event->st_event_hdr.uc_vap_id);
    if ((mac_vap == NULL) || (mem_addr == NULL)) {
        oam_error_log0(0, OAM_SF_ANY, "{hmac_save_cali_event::mac_res_get_mac_vap fail or mem_addr null}");
        return OAL_ERR_CODE_PTR_NULL;
    }
    ...
    payload = (hal_cali_hal2hmac_payload_stru *)oal_netbuf_data(cali_save_event->pst_netbuf);
    if (payload == NULL) {
        oam_error_log0(0, OAM_SF_ANY, "{hmac_save_cali_event::payload null}");
        oal_netbuf_free(cali_save_event->pst_netbuf);
        return OAL_ERR_CODE_PTR_NULL;
    }
    ...
    if (remain_len == 0) {
        cali_data_size = wlan_chip_get_cali_data_size(data_type);
        remain_len = cali_data_size;
        dest_addr = hmac_get_cali_data_save_addr((uint8_t *)mem_addr, data_type);
    }

    frame_len = CALI_DATA_NETBUF_SEND_LEN - sizeof(payload->packet_idx) - sizeof(payload->auc_payoald[0]);
    copy_len = oal_min(remain_len, frame_len);
    if (memcpy_s(dest_addr, remain_len, &payload->auc_payoald[1], copy_len) != EOK) {
        oam_error_log0(0, OAM_SF_ANY, "hmac_save_cali_event::memcpy fail!");
        oal_netbuf_free(cali_save_event->pst_netbuf);
        return OAL_FAIL;
    }
    ...
    if (remain_len == 0) {
        dest_addr = NULL;
        cali_times = wlan_chip_save_cali_event_get_cali_times(mem_addr);
        hmac_send_cali_data_event(mac_vap, cali_times, data_type);
    }
...
{
    mp13_bt20dbm_txcal_param_stru *puc_bt20dbm_cali_data = NULL;
    uint32_t cali_size_20dbm;
    uint32_t uc_chan_idx;
    uint32_t txdc_index;
    mp13_cali_param_stru          *pst_cali_data = NULL;
    oam_info_log0(0, OAM_SF_ANY, "[20dbm]start to get 20dbm cali data from wlan");
    pst_cali_data = (mp13_cali_param_stru *)get_cali_data_buf_addr();
    if (pst_cali_data == NULL) {
        return;
    }
    puc_bt20dbm_cali_data = (mp13_bt20dbm_txcal_param_stru *)wifi_get_bt_cali_data_buf(&cali_size_20dbm);
    if (puc_bt20dbm_cali_data == NULL) {
        return;
    }
    for (uc_chan_idx = 0; uc_chan_idx < MP13_2G_CHANNEL_NUM; uc_chan_idx++) {
...
OAL_STATIC void hmac_get_mp15_cali_pow_data_for_bt20dbm(mp15_bt20dbm_txcal_chn_stru *bt20dbm_cali_data,
    mp15_2g_tx_power_comp_val_stru *tx_power_cmp_2g)
{
    bt20dbm_cali_data->st_20dbmtxpwr.us_atx_pwr_cmp = tx_power_cmp_2g->us_atx_pwr_cmp;
    bt20dbm_cali_data->st_20dbmtxpwr.us_ppa_cmp = tx_power_cmp_2g->us_ppa_cmp;
    bt20dbm_cali_data->st_20dbmtxpwr.uc_dtx_pwr_cmp = tx_power_cmp_2g->uc_dtx_pwr_cmp;
    oam_warning_log3(0, OAM_SF_ANY, "[20dbm]:uc_atx_pwr_cmp:=0x%x us_ppa_cmp:=0x%x uc_dtx_pwr_cmp:=0x%x",
        bt20dbm_cali_data->st_20dbmtxpwr.us_atx_pwr_cmp, bt20dbm_cali_data->st_20dbmtxpwr.us_ppa_cmp,
        bt20dbm_cali_data->st_20dbmtxpwr.uc_dtx_pwr_cmp);
}

OAL_STATIC void hmac_get_mp15_cali_iq_data_for_bt20dbm(mp15_bt20dbm_txcal_chn_stru *bt20dbm_cali_data,
    mp15_new_txiq_comp_stru *txiq_cmp)
{
    uint32_t tx_index;
    // 补充TXIQ补偿值
    for (tx_index = 0; tx_index < MP15_CALI_TXIQ_GAIN_LVL_NUM; tx_index++) {
        bt20dbm_cali_data->l_txiq_cmp_alpha[tx_index] = txiq_cmp->l_txiq_cmp_alpha[tx_index];
        bt20dbm_cali_data->l_txiq_cmp_beta[tx_index] = txiq_cmp->l_txiq_cmp_beta[tx_index];
        oam_warning_log2(0, OAM_SF_ANY, "[20dbm]:l_txiq_cmp_alpha:=0x%x l_txiq_cmp_beta:=0x%x",
            txiq_cmp->l_txiq_cmp_alpha[tx_index], txiq_cmp->l_txiq_cmp_beta[tx_index]);
    }
}

OAL_STATIC void hmac_get_mp15_cali_txdc_data_for_bt20dbm(mp15_bt20dbm_txcal_chn_stru *bt20dbm_cali_data,
    mp15_txdc_comp_val_stru *cali_param)
{
    memcpy_s(&bt20dbm_cali_data->st_txdc_cmp_val, sizeof(bt20dbm_cali_data->st_txdc_cmp_val),
        cali_param, sizeof(mp15_txdc_comp_val_stru));
}

OAL_STATIC void hmac_get_mp15_cali_logen_data_for_bt20dbm(mp15_bt20dbm_txcal_chn_stru *bt20dbm_cali_data,
    mp15_logen_comp_val_stru *cali_param)
{
    memcpy_s(&bt20dbm_cali_data->cali_logen_cmp, sizeof(bt20dbm_cali_data->cali_logen_cmp),
        cali_param, sizeof(mp15_logen_comp_val_stru));
}

void hmac_get_mp15_cali_data_for_bt20dbm(void)
{
    mp15_bt20dbm_txcal_param_stru *bt20dbm_cali_data = NULL;
    uint32_t cali_size_20dbm;
    uint32_t chan_idx;
    mp15_cali_param_stru *pst_cali_data = NULL;
    mp15_bt20dbm_txcal_chn_stru *bt20dbm_txcali_param = NULL;

    oam_warning_log1(0, OAM_SF_ANY, "[20dbm]start to get 20dbm cali data from wlan len[%d]",
        sizeof(mp15_bt20dbm_txcal_param_stru));
    pst_cali_data = (mp15_cali_param_stru *)get_cali_data_buf_addr();
    if (pst_cali_data == NULL) {
        return;
    }
    bt20dbm_cali_data = (mp15_bt20dbm_txcal_param_stru *)wifi_get_bt_cali_data_buf(&cali_size_20dbm);
    if (bt20dbm_cali_data == NULL) {
        oam_error_log0(0, OAM_SF_ANY, "[20dbm]:start get bt20dbm_cali_data null");
        return;
    }
    for (chan_idx = 0; chan_idx < MP13_2G_CHANNEL_NUM; chan_idx++) {
        bt20dbm_txcali_param = &bt20dbm_cali_data->bt20dbm_txcali_chn_param[chan_idx];
        oam_warning_log1(0, OAM_SF_ANY, "[20dbm]:start get the chan_idx:=0x%x cali data", chan_idx);
        hmac_get_mp15_cali_iq_data_for_bt20dbm(bt20dbm_txcali_param,
            &pst_cali_data->st_2gcali_param.ast_new_txiq_cmp[chan_idx][MP15_CALI_SISO]);
        hmac_get_mp15_cali_pow_data_for_bt20dbm(bt20dbm_txcali_param,
            &pst_cali_data->st_2gcali_param.ast_cali_tx_power_cmp_2g[chan_idx]);
        hmac_get_mp15_cali_txdc_data_for_bt20dbm(bt20dbm_txcali_param,
            &pst_cali_data->st_2gcali_param.ast_txdc_cmp_val[chan_idx]);
        hmac_get_mp15_cali_logen_data_for_bt20dbm(bt20dbm_txcali_param,
            &pst_cali_data->st_2gcali_param.ast_cali_logen_cmp[chan_idx]);
    }
    bt20dbm_cali_data->rc_cmp_code = pst_cali_data->st_rc_r_c_cali_data.uc_rc_cmp_code;
    bt20dbm_cali_data->ext_lna_failure = pst_cali_data->elna_det[WLAN_BAND_2G].check_elna_status;
}

/*
 * 函 数 名  : hmac_set_close_fem_cali_status
 * 功能描述  : 设置校准时是否需要关fem
 * 1.日    期  : 2019年10月25日
 *   作    者  : wifi
 *   修改内容  : 新生成函数
...
uint32_t hmac_config_d2h_up_vmin(mac_vap_stru *mac_vap, uint8_t len, uint8_t *p_param)
{
    ...
    uint8_t vmin_abnormal_flag = *(uint8_t *)p_param;
    uint32_t err_id = 0;
    mpxx_board_info *bd_info = get_hi110x_board_info();

    switch (vmin_abnormal_flag) {
        case WLAN_VMIN_ABNROMAL_TYPE_PLL_REG_WRITE:
            err_id = CHR_PLAT_DRV_ERROR_VMIN_WLAN_PLL_REG_WRITE_FAIL;
            break;
        case WLAN_VMIN_ABNROMAL_TYPE_PHY_REG_WRITE:
            err_id = CHR_PLAT_DRV_ERROR_VMIN_WLAN_PHY_REG_WRITE_FAIL;
            break;
        default:
            break;
    }
    ...
    if (err_id == 0) {
        oam_error_log1(0, OAM_SF_ANY, "hmac_config_d2h_up_vmin:error_abnormal_flag [%d] !", vmin_abnormal_flag);
        return OAL_SUCC;
    }
