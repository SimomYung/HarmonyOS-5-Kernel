...
uint8_t *hmac_get_cali_data_save_addr(uint8_t *cali_data, wlan_d2h_cali_data_type_enum_uint8 data_type);
...
OAL_STATIC OAL_INLINE uint8_t hmac_get_slave_rf_num(void)
{
    return g_wlan_spec_cfg->max_slave_rf_num;
}

OAL_STATIC OAL_INLINE uint8_t hmac_get_slave_scan_rf_num(void)
{
    return g_wlan_spec_cfg->max_slave_scan_rf_num;
}
OAL_STATIC OAL_INLINE uint8_t hmac_get_band_num(void)
{
    return g_wlan_spec_cfg->max_band_num;
}
OAL_STATIC OAL_INLINE uint8_t hmac_get_max_5g_bw(void)
{
    return g_wlan_spec_cfg->max_5g_bw;
}

OAL_STATIC OAL_INLINE uint8_t hmac_get_slave_scan_rf_start_idx(void)
{
    return g_wlan_spec_cfg->slave_scan_rf_start_idx;
}

OAL_STATIC OAL_INLINE uint8_t hmac_get_slave_rf_start_idx(void)
{
    return g_wlan_spec_cfg->max_rf_num - g_wlan_spec_cfg->max_slave_rf_num;
}
