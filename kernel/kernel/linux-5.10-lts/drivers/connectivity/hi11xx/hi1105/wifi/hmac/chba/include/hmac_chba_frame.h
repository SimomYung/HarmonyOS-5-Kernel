...
typedef enum {
    CHBA_NEGOACTION_HIGH_PRIORITY = 0,
    CHBA_NEGOACTION_LOW_PRIORITY = 1
} chba_negoaction_priority_flag_enum;
...
uint32_t hmac_chba_rx_mgmt(hmac_vap_stru *hmac_vap, dmac_wlan_crx_event_stru *rx_mgmt_event, oal_netbuf_stru *netbuf);
