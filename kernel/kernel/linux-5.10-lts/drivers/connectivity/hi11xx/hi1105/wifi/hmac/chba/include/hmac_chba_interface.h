...
#define HMAC_CHBA_USER_ASSOC_PRIV_IE_MAX_LEN 255 /* chba私有app ie最大长度 */
...
typedef struct {
    uint8_t op_id; /* cancel connection notfiy id */
    uint8_t peer_mac_addr[WLAN_MAC_ADDR_LEN];
} hmac_chba_cancel_conn_notify_stru;
...
void hmac_chba_vap_set_chba_mode(mac_vap_stru *mac_vap, mac_cfg_add_vap_param_stru *param);
#endif
