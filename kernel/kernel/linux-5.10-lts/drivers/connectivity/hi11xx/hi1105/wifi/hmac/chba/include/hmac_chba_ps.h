...
/* 目前认为在一个统计周期里1000000bytes以上包为极大流量，解决华为分享场景爬坡问题 */
#define HUGE_PACKET_BYTES_THREASHOLD 500000
/* 两次采样间隔大于等于150ms认为是大采样间隔 */
#define LARGE_TIME_INTERVAL 150
/* 大采样间隔在过去5个采样周期中出现3次及以上，则切到33333333 */
#define TIME_INTERVAL_THRESHOLD 3
...
typedef enum {
    CHBA_PS_DEFALUT_TYPE = 0,
    CHBA_PS_SOF_BUS_ASK_ALL_AWAKE = 1, /* 软总线要求保持全醒 */
} chba_ps_service_type_enum; /* chba低功耗业务侧特殊配置模式 */
