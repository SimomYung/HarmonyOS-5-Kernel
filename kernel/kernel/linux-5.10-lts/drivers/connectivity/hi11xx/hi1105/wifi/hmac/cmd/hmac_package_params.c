...
uint32_t hmac_package_fastsleep3_params(
    mac_vap_stru *mac_vap, uint32_t *params, uint8_t *new_params, uint16_t *new_params_len)
{
    fastsleep3_param_stru *fastsleep3_para = NULL;
    if (hmac_package_check_stru_size(sizeof(fastsleep3_param_stru)) != OAL_SUCC) {
        return OAL_FAIL;
    }
    fastsleep3_para = (fastsleep3_param_stru *)new_params;

    fastsleep3_para->fastsleep3_start_listen_time = params[BYTE_OFFSET_0];
    fastsleep3_para->fastsleep3_sleep_rtc_time = params[BYTE_OFFSET_1];
    fastsleep3_para->fastsleep3_rtc_wakeup_work_time = params[BYTE_OFFSET_2];
    fastsleep3_para->fastsleep3_total_rx_cnt_per_period = params[BYTE_OFFSET_3];
    fastsleep3_para->fastsleep3_wakeup_rx_cnt_per_period = params[BYTE_OFFSET_4];
    *new_params_len = sizeof(fastsleep3_param_stru);
    return OAL_SUCC;
}
    ...
    mac_vap_stru *mac_vap, uint32_t *params, uint8_t *new_params, uint16_t *new_params_len)
{
    ...
    phy_event_cfg->wp_event2_type_sel = params[BYTE_OFFSET_4];
    phy_event_cfg->wp_event3_type_sel = params[BYTE_OFFSET_5];
    *new_params_len = sizeof(mac_cfg_phy_event_rpt_stru);
    return OAL_SUCC;
}
#endif
