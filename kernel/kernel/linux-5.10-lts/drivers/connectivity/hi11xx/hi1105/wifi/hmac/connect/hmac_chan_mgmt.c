...
static mac_mvap_state_trans_enum hmac_mvap_channel_switch_state_trans(mac_vap_stru *mac_vap,
    mac_mvap_state_enum cur_mvap_state, mac_mvap_state_enum new_mvap_state,
    mac_mvap_chan_switch_type_enum chan_switch_type)
{
    mac_mvap_state_trans_enum state_trans = g_chan_switch_state_trans_table[cur_mvap_state][new_mvap_state];
 ...
 */
static uint32_t hmac_sub_vap_from_up_vap_array(const mac_vap_stru *link_down_vap,
    mac_vap_stru *up_vap_array[WLAN_SERVICE_VAP_MAX_NUM_PER_DEVICE], uint32_t up_vap_num)
{
    uint32_t k = 0;
    uint32_t idx;
...
oal_bool_enum_uint8 hmac_mld_link_switch_channel_valid(mac_vap_stru *link_down_vap, mac_vap_stru *link_up_vap)
{
    ...
    mac_mvap_state_enum cur_mvap_state;
    mac_mvap_state_enum new_mvap_state;
    mac_mvap_state_trans_enum state_trans;
