 ...
 */
#ifdef _PRE_WLAN_FEATURE_11BE
/* WLAN_EHT_MODE是最后一个枚举，03 05编译时不包含EHT，数组大小要区分是否支持11be */
uint8_t g_auc_avail_protocol_mode[WLAN_PROTOCOL_BUTT][WLAN_PROTOCOL_BUTT] = {
    { WLAN_LEGACY_11A_MODE, WLAN_PROTOCOL_BUTT,   WLAN_PROTOCOL_BUTT,   WLAN_PROTOCOL_BUTT,
      ...
      WLAN_PROTOCOL_BUTT,   WLAN_PROTOCOL_BUTT,   WLAN_LEGACY_11A_MODE, WLAN_PROTOCOL_BUTT,
      WLAN_PROTOCOL_BUTT,   WLAN_LEGACY_11A_MODE },    // 11A
    { WLAN_PROTOCOL_BUTT,   WLAN_LEGACY_11B_MODE, WLAN_LEGACY_11B_MODE, WLAN_LEGACY_11B_MODE,
      ...
      WLAN_PROTOCOL_BUTT,   WLAN_PROTOCOL_BUTT,   WLAN_LEGACY_11B_MODE, WLAN_PROTOCOL_BUTT,
      WLAN_PROTOCOL_BUTT,   WLAN_LEGACY_11B_MODE },    // 11B
    { WLAN_PROTOCOL_BUTT,   WLAN_PROTOCOL_BUTT,   WLAN_LEGACY_11G_MODE, WLAN_LEGACY_11G_MODE,
      ...
      WLAN_PROTOCOL_BUTT,   WLAN_LEGACY_11G_MODE, WLAN_LEGACY_11G_MODE, WLAN_PROTOCOL_BUTT,
      WLAN_PROTOCOL_BUTT,   WLAN_LEGACY_11G_MODE },    // 11G
    { WLAN_PROTOCOL_BUTT,   WLAN_LEGACY_11B_MODE, WLAN_LEGACY_11G_MODE, WLAN_MIXED_ONE_11G_MODE,
      ...
      WLAN_PROTOCOL_BUTT,   WLAN_PROTOCOL_BUTT },    // ONE_11G
    { WLAN_PROTOCOL_BUTT,   WLAN_PROTOCOL_BUTT,   WLAN_LEGACY_11G_MODE, WLAN_MIXED_ONE_11G_MODE,
      ...
      WLAN_PROTOCOL_BUTT,   WLAN_PROTOCOL_BUTT,   WLAN_PROTOCOL_BUTT,   WLAN_PROTOCOL_BUTT,
      WLAN_PROTOCOL_BUTT,   WLAN_PROTOCOL_BUTT },    // TWO_11G
    { WLAN_LEGACY_11A_MODE, WLAN_LEGACY_11B_MODE, WLAN_LEGACY_11G_MODE, WLAN_MIXED_ONE_11G_MODE,
      ...
      WLAN_PROTOCOL_BUTT,   WLAN_HT_11G_MODE,     WLAN_HT_MODE,         WLAN_PROTOCOL_BUTT,
      WLAN_PROTOCOL_BUTT,   WLAN_HT_MODE },    // HT
    { WLAN_LEGACY_11A_MODE, WLAN_LEGACY_11B_MODE, WLAN_LEGACY_11G_MODE, WLAN_MIXED_ONE_11G_MODE,
      WLAN_MIXED_ONE_11G_MODE, WLAN_HT_MODE,      WLAN_VHT_MODE,        WLAN_HT_ONLY_MODE,
      WLAN_HT_ONLY_MODE,    WLAN_PROTOCOL_BUTT,   WLAN_VHT_MODE,        WLAN_PROTOCOL_BUTT,
      WLAN_PROTOCOL_BUTT,   WLAN_VHT_MODE },    // VHT
    { WLAN_PROTOCOL_BUTT,   WLAN_PROTOCOL_BUTT,   WLAN_PROTOCOL_BUTT,   WLAN_PROTOCOL_BUTT,
      WLAN_PROTOCOL_BUTT,   WLAN_HT_ONLY_MODE,    WLAN_HT_ONLY_MODE,    WLAN_HT_ONLY_MODE,
      WLAN_HT_ONLY_MODE,    WLAN_HT_ONLY_MODE,    WLAN_HT_ONLY_MODE,    WLAN_PROTOCOL_BUTT,
      WLAN_PROTOCOL_BUTT,   WLAN_HT_ONLY_MODE },    // HT_ONLY
    { WLAN_PROTOCOL_BUTT,   WLAN_PROTOCOL_BUTT,   WLAN_PROTOCOL_BUTT,   WLAN_PROTOCOL_BUTT,
      WLAN_PROTOCOL_BUTT,   WLAN_PROTOCOL_BUTT,   WLAN_VHT_ONLY_MODE,   WLAN_PROTOCOL_BUTT,
      WLAN_VHT_ONLY_MODE,   WLAN_PROTOCOL_BUTT,   WLAN_PROTOCOL_BUTT,   WLAN_PROTOCOL_BUTT,
      WLAN_PROTOCOL_BUTT,   WLAN_PROTOCOL_BUTT },    // VHT_ONLY
    { WLAN_PROTOCOL_BUTT,   WLAN_PROTOCOL_BUTT,   WLAN_LEGACY_11G_MODE, WLAN_LEGACY_11G_MODE,
      WLAN_LEGACY_11G_MODE, WLAN_HT_11G_MODE,     WLAN_PROTOCOL_BUTT,   WLAN_HT_ONLY_MODE,
      WLAN_PROTOCOL_BUTT,   WLAN_HT_11G_MODE,     WLAN_PROTOCOL_BUTT,   WLAN_PROTOCOL_BUTT,
      WLAN_PROTOCOL_BUTT,   WLAN_PROTOCOL_BUTT },    // HT_11G
    { WLAN_LEGACY_11A_MODE, WLAN_LEGACY_11B_MODE, WLAN_LEGACY_11G_MODE, WLAN_MIXED_ONE_11G_MODE,
      WLAN_MIXED_ONE_11G_MODE, WLAN_HT_MODE,      WLAN_VHT_MODE,        WLAN_HT_ONLY_MODE,
      WLAN_VHT_ONLY_MODE,   WLAN_PROTOCOL_BUTT,   WLAN_HE_MODE,         WLAN_PROTOCOL_BUTT,
      WLAN_PROTOCOL_BUTT,   WLAN_HE_MODE },    /* he */
    { WLAN_PROTOCOL_BUTT,   WLAN_PROTOCOL_BUTT,   WLAN_PROTOCOL_BUTT,   WLAN_PROTOCOL_BUTT,
      WLAN_PROTOCOL_BUTT,   WLAN_PROTOCOL_BUTT,   WLAN_PROTOCOL_BUTT,   WLAN_PROTOCOL_BUTT,
      WLAN_PROTOCOL_BUTT,   WLAN_PROTOCOL_BUTT,   WLAN_PROTOCOL_BUTT,   WLAN_HT_ONLY_MODE_2G,
      WLAN_PROTOCOL_BUTT,   WLAN_PROTOCOL_BUTT },    /* ht_only_2g */
    { WLAN_PROTOCOL_BUTT,   WLAN_PROTOCOL_BUTT,   WLAN_PROTOCOL_BUTT,   WLAN_PROTOCOL_BUTT,
      WLAN_PROTOCOL_BUTT,   WLAN_PROTOCOL_BUTT,   WLAN_PROTOCOL_BUTT,   WLAN_PROTOCOL_BUTT,
      WLAN_PROTOCOL_BUTT,   WLAN_PROTOCOL_BUTT,   WLAN_PROTOCOL_BUTT,   WLAN_PROTOCOL_BUTT,
      WLAN_VHT_ONLY_MODE_2G,   WLAN_PROTOCOL_BUTT },    /* vht_only_2g */
    { WLAN_LEGACY_11A_MODE, WLAN_LEGACY_11B_MODE, WLAN_LEGACY_11G_MODE, WLAN_MIXED_ONE_11G_MODE,
      WLAN_MIXED_ONE_11G_MODE, WLAN_HT_MODE,      WLAN_VHT_MODE,        WLAN_HT_ONLY_MODE,
      WLAN_VHT_ONLY_MODE,   WLAN_PROTOCOL_BUTT,   WLAN_HE_MODE,         WLAN_PROTOCOL_BUTT,
      WLAN_PROTOCOL_BUTT,   WLAN_EHT_MODE },  /* eht */
};
#else
uint8_t g_auc_avail_protocol_mode[WLAN_PROTOCOL_BUTT][WLAN_PROTOCOL_BUTT] = {
    { WLAN_LEGACY_11A_MODE, WLAN_PROTOCOL_BUTT,   WLAN_PROTOCOL_BUTT,   WLAN_PROTOCOL_BUTT,
...
/* buffer size: Extended Buffer Size × 1024 + Buffer Size */
OAL_STATIC OAL_INLINE uint16_t hmac_addba_get_buffer_size(uint16_t buffer_size)
{
    return buffer_size % ADDBA_EXTENDED_BUFFER_SIZE_UNIT;
}

OAL_STATIC OAL_INLINE uint8_t hmac_addba_get_extended_buffer_size(uint16_t buffer_size)
{
    return (uint8_t)(buffer_size / ADDBA_EXTENDED_BUFFER_SIZE_UNIT);
}
    ...
    hmac_ba_rx_stru *addba_rsp, uint8_t tid, uint8_t status)
{
    ...
    if (oal_any_null_ptr3(hmac_vap, data, addba_rsp)) {
        oam_error_log0(0, OAM_SF_BA, "{hmac_mgmt_encap_addba_rsp::hmac_vap or data or addba_rsp is null.}");
        return OAL_ERR_CODE_PTR_NULL;
    }
    /*************************************************************************/
    /*                        Management Frame Format                        */
...
static void hmac_tx_addba_req_set_ba_info(hmac_tid_ba_stru *hmac_tid, dmac_ba_tx_stru *tx_ba)
{
    /* 更新对应的TID信息 */
    hmac_tid->st_ba_tx_info.en_ba_status = DMAC_BA_INPROGRESS;
    hmac_tid->st_ba_tx_info.uc_dialog_token = tx_ba->uc_dialog_token;
    hmac_tid->st_ba_tx_info.uc_ba_policy = tx_ba->uc_ba_policy;
}
    ...
    mac_action_mgmt_args_stru *action_args)
{
    ...
    hmac_tid = hmac_get_tid_ba_info(hmac_user, tidno);
    /* 申请ADDBA_REQ管理帧内存 */
    addba_req = hmac_mgmt_ba_session_alloc(mac_vap->uc_vap_id);
    if (addba_req == NULL || hmac_tid == NULL) {
        return OAL_ERR_CODE_PTR_NULL;
    }
    ...
    hmac_tx_addba_req_set_ba_info(hmac_tid, &st_tx_ba);
...
uint32_t hmac_mgmt_tx_delba(hmac_vap_stru *hmac_vap, hmac_user_stru *hmac_user, mac_action_mgmt_args_stru *action_args)
{
    ...
    if (initiator == MAC_RECIPIENT_DELBA) {
        ...
        hmac_tx_ba_session_decr(hmac_vap, hmac_tid->uc_tid_no);
    ...
    uint32_t frame_body_len)
{
    ...
    hmac_tid = hmac_get_tid_ba_info(hmac_user, tid);
    if (hmac_tid == NULL) {
        return OAL_ERR_CODE_PTR_NULL;
    }
    if (hmac_tid->pst_ba_rx_info != NULL) {
        oam_warning_log1(mac_vap->uc_vap_id, OAM_SF_BA,
    ...
    if (ba_rx_info == NULL) {
        oam_warning_log1(mac_vap->uc_vap_id, OAM_SF_BA, "{hmac_mgmt_rx_addba_req::alloc fail. tid[%d].}", tid);
        return OAL_ERR_CODE_PTR_NULL;
    }

    hmac_tid->pst_ba_rx_info = ba_rx_info;
    ...
    hmac_process_addba_req_exten_ie(ba_rx_info, hmac_user, (uint8_t *)payload, frame_body_len, tid);
    ...
    /* 判断建立能否成功 */
    status = hmac_mgmt_check_set_rx_ba_ok(hmac_vap, hmac_user, ba_rx_info, dev, hmac_tid);
    if (status == MAC_SUCCESSFUL_STATUSCODE) {
        hmac_tid->pst_ba_rx_info->en_ba_status = DMAC_BA_INPROGRESS;
    }
    ...
    if ((status != MAC_SUCCESSFUL_STATUSCODE) || (ret != 0)) {
        ...
        /* pst_ba_rx_info修改为在函数中置空，与其他调用一致 */
        hmac_ba_reset_rx_handle(dev, hmac_user, tid, OAL_FALSE);
    }
    ...
    uint16_t us_err_code, oal_bool_enum_uint8 en_is_protected)
{
    ...
    /* 增加发送去关联帧时的维测信息 */
    oam_warning_log4(pst_mac_vap->uc_vap_id, OAM_SF_MLOG,
...
OAL_STATIC void hmac_mgmt_update_qos_by_ie(mac_ies_info *ies_info, mac_vap_stru *mac_vap,
 ...
 * 修改内容 : 新生成函数
 */
void hmac_mgmt_update_assoc_user_qos_table(mac_ies_info *ies_info, hmac_user_stru *hmac_user)
{
    mac_vap_stru *mac_vap = NULL;
    ...
    hmac_mgmt_update_qos_by_ie(ies_info, mac_vap, &hmac_user);
}
...
{
#ifdef _PRE_WLAN_FEATURE_11BE
    /* 根据mac_user是否携带eht ie设置user的协议模式 */
    if (mac_user_is_eht_user(&hmac_user->st_user_base_info) == OAL_TRUE) {
        mac_user_set_protocol_mode(mac_user, WLAN_EHT_MODE);
        return;
    }
#endif
 ...
 *   修改内容  : 新生成函数
 */
uint8_t hmac_add_user_rates(hmac_user_stru *pst_hmac_user, uint8_t uc_rates_cnt_temp, uint8_t *puc_rates)
{
    uint8_t uc_rates_cnt = uc_rates_cnt_temp;
...
#ifdef _PRE_WLAN_FEATURE_ML
    hmac_mld_tx_mgmt_change_addr(pst_mac_vap, pst_netbuf_mgmt_tx);
#endif
...
void hmac_calc_tx_ampdu_maxsize(mac_user_stru *mac_user, wlan_protocol_enum_uint8 protocol_mode)
{
    ...
    } else if (protocol_mode == WLAN_EHT_MODE) {
        /* EHT(0-7): maximum length of A-MPDU = 2 ^ (23 + Maximum A-MPDU Length Exponent) - 1 */
        mac_user->ampdu_maxsize = (uint32_t)(1U << (23 +
            mac_user->st_eht_hdl.st_eht_cap_ie.eht_mac_cap.bit_max_ampdu_length_exponent)) - 1;
        // 115523200: the upper bound of A-MPDU size
        mac_user->ampdu_maxsize = oal_min(mac_user->ampdu_maxsize, 115523200);
    } else {
    ...
    mac_vap_stru *mac_vap, hmac_user_stru *hmac_user, mac_vht_hdl_stru *vht_hdl, uint8_t *vht_cap_ie, uint16_t msg_idx)
{
    ...
    if (hmac_user->en_user_vendor_vht_capable == OAL_TRUE) {
        vht_hdl->us_max_mpdu_length = 3895; // 最大长度3895 对接三星兼容性处理
    }
    ...
    if ((vht_hdl->bit_vht_txop_ps == OAL_TRUE) && (mac_mib_get_txopps(mac_vap) == OAL_TRUE)) {
...
OAL_STATIC void hmac_process_rates_ie_in_assoc_frame(
    mac_vap_stru *mac_vap, hmac_user_stru *hmac_user, mac_ies_info *ies_info)
{
    uint8_t *rates_ie = NULL;
    uint8_t rates_num;

    rates_ie = mac_find_ie(MAC_EID_RATES, ies_info);
    if (rates_ie == NULL) {
 ...
 *   修改内容  : 新生成函数
 */
uint32_t hmac_ie_proc_assoc_user_legacy_rate(mac_ies_info *ies_info, hmac_user_stru *pst_hmac_user)
{
    mac_user_stru *pst_mac_user = NULL;
    mac_vap_stru *pst_mac_vap = NULL;
    if (ies_info == NULL || pst_hmac_user == NULL) {
    ...
    /* 1.处理基础速率集 */
    hmac_process_rates_ie_in_assoc_frame(pst_mac_vap, pst_hmac_user, ies_info);
    /* 2.处理扩展梳理集 */
    hmac_process_ext_rates_ie_in_assoc_frame(pst_mac_vap, pst_hmac_user, ies_info);
    if (pst_hmac_user->st_op_rates.uc_rs_nrates == 0) {
