...
hmac_hid2d_chan_stru g_aus_channel_candidate_list_5g[HMAC_HID2D_CHANNEL_NUM_5G] = {
    ...
    {73,    0,      36,    WLAN_BAND_WIDTH_160PLUSPLUSPLUS},
    {74,    1,      40,    WLAN_BAND_WIDTH_160MINUSPLUSPLUS},
    {75,    2,      44,    WLAN_BAND_WIDTH_160PLUSMINUSPLUS},
    {76,    3,      48,    WLAN_BAND_WIDTH_160MINUSMINUSPLUS},
    {77,    4,      52,    WLAN_BAND_WIDTH_160PLUSPLUSMINUS},
    {78,    5,      56,    WLAN_BAND_WIDTH_160MINUSPLUSMINUS},
    {79,    6,      60,    WLAN_BAND_WIDTH_160PLUSMINUSMINUS},
    {80,    7,      64,    WLAN_BAND_WIDTH_160MINUSMINUSMINUS},
    {81,    8,      100,   WLAN_BAND_WIDTH_160PLUSPLUSPLUS},
    {82,    9,      104,   WLAN_BAND_WIDTH_160MINUSPLUSPLUS},
    {83,    10,     108,   WLAN_BAND_WIDTH_160PLUSMINUSPLUS},
    {84,    11,     112,   WLAN_BAND_WIDTH_160MINUSMINUSPLUS},
    {85,    12,     116,   WLAN_BAND_WIDTH_160PLUSPLUSMINUS},
    {86,    13,     120,   WLAN_BAND_WIDTH_160MINUSPLUSMINUS},
    {87,    14,     124,   WLAN_BAND_WIDTH_160PLUSMINUSMINUS},
    {88,    15,     128,   WLAN_BAND_WIDTH_160MINUSMINUSMINUS},
#endif
};
...
int32_t wal_hid2d_gso_mode(oal_net_device_stru *net_dev, uint8_t ctrl)
{
    ...
    oam_warning_log1(0, OAM_SF_ANY, "wal_hid2d_gso_mode::ctrl = %d", ctrl);
    if (ctrl == DISABLE) {
...
uint32_t wal_hipriv_hid2d_presentation_init(oal_net_device_stru *net_dev, int8_t *cmd)
{
    ...
    hisilicon_net_dev = wal_config_get_cmd_netdev("Hisilicon0", OAL_STRLEN("Hisilicon0"));
