...
typedef struct {
    uint8_t   *frame_ies;         /* 帧体指针 */
    int32_t   frame_len;          /* 帧体长度 */
    uint8_t   *inheritance_ies;   /* per-STA profile指针 */
    int32_t   inheritance_ie_len; /* per-STA profile长度 */
} mac_ies_info;
...
#define MAC_ADDBA_EXTENSION_IE_LEN   1   /* addba extended parameter set长度 */
...
#define MAC_WLAN_CHIP_OUI_HUAWEI         0xac853d
#define MAC_WLAN_CHIP_OUI_TYPE_1_HUAWEI  0x82
#define MAC_WLAN_CHIP_OUI_TYPE_2_HUAWEI  0x20
