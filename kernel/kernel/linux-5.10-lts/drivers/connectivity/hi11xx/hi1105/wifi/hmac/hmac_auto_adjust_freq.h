...
#ifndef _PRE_WLAN_FEATURE_COMPETE_OPT
...
#else
#define WLAN_IRQ_THROUGHPUT_THRESHOLD_HIGH 20 /* mbps */
#define WLAN_IRQ_THROUGHPUT_THRESHOLD_LOW  15 /* mbps */

#define WLAN_IRQ_PPS_THRESHOLD_HIGH 250 /* pps */
#define WLAN_IRQ_PPS_THRESHOLD_LOW  50  /* pps */
#endif

#define WLAN_CPU_FREQ_THROUGHPUT_THRESHOLD_HIGH 800 /* mbps */
#define WLAN_CPU_FREQ_THROUGHPUT_THRESHOLD_LOW  500 /* mbps */

#define WLAN_CPU_FREQ_PPS_THRESHOLD_HIGH 60000 /* pps */
#define WLAN_CPU_FREQ_PPS_THRESHOLD_LOW  20000 /* pps */
...
#define WLAN_ASPM_SWITCH_OPEN_PROTECT_CNT 300
...
typedef struct {
    ...
    uint16_t hcc_aspm_switch_off_protect_cnt;
...
extern uint8_t g_wlan_freq_timer_period;
