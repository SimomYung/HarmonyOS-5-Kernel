...
static inline void mac_mib_set_BeaconProtectionEnabled(mac_vap_stru *mac_vap, uint8_t val)
{
    mac_vap->pst_mib_info->st_wlan_mib_sta_config.dot11BeaconProtectionEnabled = !!val;
}

static inline uint8_t mac_mib_get_BeaconProtectionEnabled(mac_vap_stru *mac_vap)
{
    return mac_vap->pst_mib_info->st_wlan_mib_sta_config.dot11BeaconProtectionEnabled;
}
#endif
