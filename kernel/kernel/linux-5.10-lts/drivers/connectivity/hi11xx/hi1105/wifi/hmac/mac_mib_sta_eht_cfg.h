...
static inline void mac_mib_set_EHTEMLSROptionImplemented(mac_vap_stru *mac_vap, oal_bool_enum_uint8 en_val)
{
    mac_vap->pst_mib_info->wlan_mib_eht_sta_config.dot11EHTEMLSROptionImplemented = en_val;
}

static inline uint8_t mac_mib_get_EHTEMLSROptionImplemented(mac_vap_stru *mac_vap)
{
    return mac_vap->pst_mib_info->wlan_mib_eht_sta_config.dot11EHTEMLSROptionImplemented;
}

static inline void mac_mib_set_EHTEMLSROptionActivated(mac_vap_stru *mac_vap, oal_bool_enum_uint8 en_val)
{
    mac_vap->pst_mib_info->wlan_mib_eht_sta_config.dot11EHTEMLSROptionActivated = en_val;
}

static inline uint8_t mac_mib_get_EHTEMLSROptionActivated(mac_vap_stru *mac_vap)
{
    return mac_vap->pst_mib_info->wlan_mib_eht_sta_config.dot11EHTEMLSROptionActivated;
}
