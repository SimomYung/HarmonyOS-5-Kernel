...
OAL_STATIC void mac_set_he_mac_capinfo_field(mac_vap_stru *mac_vap, uint8_t *puc_buffer)
{
    ...
    ***************************************************************************/
    ...
    /* WiFi6 关联请求帧 trigger_mac_padding_duration 配置，仅在关联请求帧生效一次 */
    if (g_ax_triggered_mac_padding_val > 0) {
        pst_he_mac_capinfo->bit_trigger_mac_padding_duration = g_ax_triggered_mac_padding_val - 1;
        g_ax_triggered_mac_padding_val = 0;
    }
