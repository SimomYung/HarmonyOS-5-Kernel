...
void hmac_sta_up_update_assoc_rsp_sr_params(mac_ies_info *ies_info,
                                            ...
                                            hmac_user_stru *pst_hmac_user);
void hmac_sta_up_update_he_nfrp_params(mac_ies_info *ies_info, hmac_vap_stru *hmac_sta,
...
uint32_t hmac_proc_he_6ghz_band_cap_ie(mac_vap_stru *mac_vap, hmac_user_stru *hmac_user, uint8_t *payload);
#endif
