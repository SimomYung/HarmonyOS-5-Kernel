...
uint32_t hmac_check_opmode_notify(hmac_vap_stru *hmac_vap, uint8_t *mac_hdr,
                                  mac_ies_info *ies_info, hmac_user_stru *hmac_user)
{
    ...
    opmode_notify_ie = mac_find_ie(MAC_EID_OPMODE_NOTIFY, ies_info);
                                          ...
                                          oal_netbuf_stru *netbuf)
{
    ...
    /* 获取帧体指针 */
    data = (uint8_t *)(uintptr_t)mac_get_rx_cb_mac_header_addr(rx_ctrl);
