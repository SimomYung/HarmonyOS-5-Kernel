...
typedef struct {
    ...
    mac_psm_query_stat_stru query_stat;
    uint8_t query_completed_flag;
} hmac_lowpower_stat_query_stru;
...
typedef struct hmac_device_tag {
    ...
    mac_mld_mode_switch_enum mld_mode_switch_state; /* 当前MLD模式切换状态 */
#endif
    hmac_lowpower_stat_query_stru lowpower_stat_query;
} hmac_device_stru;
