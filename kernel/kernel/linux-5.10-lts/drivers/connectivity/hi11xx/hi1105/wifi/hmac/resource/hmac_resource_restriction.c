...
typedef enum {
    ...
    HMAC_MVAP_COEX_SUPPORT_CHIP_MP17C = BIT(BOARD_VERSION_MP17C),
    HMAC_MVAP_COEX_SUPPORT_CHIP_MP12 = BIT(BOARD_VERSION_MP12),
    HMAC_MVAP_COEX_SUPPORT_CHIP_ALL = HMAC_MVAP_COEX_SUPPORT_CHIP_MP13 | HMAC_MVAP_COEX_SUPPORT_CHIP_MP15 |
                                      ...
                                      HMAC_MVAP_COEX_SUPPORT_CHIP_GF61 | HMAC_MVAP_COEX_SUPPORT_CHIP_MP17C |
                                      HMAC_MVAP_COEX_SUPPORT_CHIP_MP12,
} hmac_mvap_coex_chip_type_enum;

#define HMAC_MVAP_CHIP_TYPE_NOT_SUPPORT (HMAC_MVAP_COEX_SUPPORT_CHIP_MP13 | HMAC_MVAP_COEX_SUPPORT_CHIP_MP15)
typedef enum {
    HMAC_LEGACY_AP_STA_SUPPORT_CHIP_BITMAP = HMAC_MVAP_COEX_SUPPORT_CHIP_ALL & (~HMAC_MVAP_CHIP_TYPE_NOT_SUPPORT),
    HMAC_LEGACY_AP_GO_SUPPORT_CHIP_BITMAP = HMAC_MVAP_COEX_SUPPORT_CHIP_ALL & (~HMAC_MVAP_CHIP_TYPE_NOT_SUPPORT),
    HMAC_LEGACY_AP_GC_SUPPORT_CHIP_BITMAP = HMAC_MVAP_COEX_SUPPORT_CHIP_ALL & (~HMAC_MVAP_CHIP_TYPE_NOT_SUPPORT),
    HMAC_LEGACY_AP_CHBA_SUPPORT_CHIP_BITMAP = HMAC_MVAP_COEX_SUPPORT_CHIP_ALL & (~HMAC_MVAP_CHIP_TYPE_NOT_SUPPORT),
    HMAC_DUAL_STA_SUPPORT_CHIP_BITMAP = HMAC_MVAP_COEX_SUPPORT_CHIP_ALL & (~HMAC_MVAP_COEX_SUPPORT_CHIP_MP12),
    ...
    HMAC_GO_GO_SUPPORT_CHIP_BITMAP = HMAC_MVAP_COEX_SUPPORT_CHIP_ALL & (~HMAC_MVAP_CHIP_TYPE_NOT_SUPPORT),
    HMAC_GO_GC_SUPPORT_CHIP_BITMAP = HMAC_MVAP_COEX_SUPPORT_CHIP_ALL & (~HMAC_MVAP_CHIP_TYPE_NOT_SUPPORT),
    HMAC_GO_CHBA_SUPPORT_CHIP_BITMAP = HMAC_MVAP_COEX_SUPPORT_CHIP_ALL,
    HMAC_GC_GC_SUPPORT_CHIP_BITMAP = HMAC_MVAP_COEX_SUPPORT_CHIP_ALL & (~HMAC_MVAP_CHIP_TYPE_NOT_SUPPORT),
    HMAC_GC_CHBA_SUPPORT_CHIP_BITMAP = HMAC_MVAP_COEX_SUPPORT_CHIP_ALL,
    HMAC_LEGACY_STA_GO_GO_SUPPORT_CHIP_BITMAP = HMAC_MVAP_COEX_SUPPORT_CHIP_ALL & (~HMAC_MVAP_CHIP_TYPE_NOT_SUPPORT),
    HMAC_LEGACY_STA_GO_GC_SUPPORT_CHIP_BITMAP = HMAC_MVAP_COEX_SUPPORT_CHIP_ALL & (~HMAC_MVAP_CHIP_TYPE_NOT_SUPPORT),
    HMAC_LEGACY_STA_GO_CHBA_SUPPORT_CHIP_BITMAP = HMAC_MVAP_COEX_SUPPORT_CHIP_ALL,
    HMAC_LEGACY_STA_GC_GC_SUPPORT_CHIP_BITMAP = HMAC_MVAP_COEX_SUPPORT_CHIP_ALL & (~HMAC_MVAP_CHIP_TYPE_NOT_SUPPORT),
...
{
#ifdef _PRE_WLAN_FEATURE_MULTI_AP /* 支持多AP场景，无需检查，直接返回OAL_FALSE */
    return OAL_FALSE;
#else
...
{
#ifdef _PRE_WLAN_FEATURE_MULTI_AP /* 支持多AP场景，无需检查，直接返回HMAC_MULTI_VAP_STATE_SUPPORT */
