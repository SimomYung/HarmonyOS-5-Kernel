...
OAL_STATIC void mac_vap_init_eht_phy_mib(mac_vap_stru *mac_vap)
{
    ...
    mac_mib_set_EHTBeamformeeSSLessThanOrEqualTo80(mac_vap->pst_mib_info, MIN_EHT_SOUNDING_NDP_NSS);
    mac_mib_set_EHTBeamformeeSSEqualTo160(mac_vap->pst_mib_info, MIN_EHT_SOUNDING_NDP_NSS);
