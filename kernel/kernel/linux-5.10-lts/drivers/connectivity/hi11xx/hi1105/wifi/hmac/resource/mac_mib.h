...
#ifdef _PRE_WLAN_FEATURE_WUR
static inline void mac_mib_set_WUROptionImplemented(mac_vap_stru *mac_vap, uint8_t val)
{
    mac_vap->pst_mib_info->wlan_mib_wur_sta_config.dot11WUROptionImplemented = val;
}

static inline uint8_t mac_mib_get_WUROptionImplemented(mac_vap_stru *mac_vap)
{
    return mac_vap->pst_mib_info->wlan_mib_wur_sta_config.dot11WUROptionImplemented;
}

static inline void mac_mib_set_WURFDMAChannelSwitchImplemented(mac_vap_stru *mac_vap, uint8_t val)
{
    mac_vap->pst_mib_info->wlan_mib_wur_sta_config.dot11WURFDMAChannelSwitchImplemented = val;
}

static inline uint8_t mac_mib_get_WURFDMAChannelSwitchImplemented(mac_vap_stru *mac_vap)
{
    return mac_vap->pst_mib_info->wlan_mib_wur_sta_config.dot11WURFDMAChannelSwitchImplemented;
}

static inline void mac_mib_set_WURDiscoveryImplemented(mac_vap_stru *mac_vap, uint8_t val)
{
    mac_vap->pst_mib_info->wlan_mib_wur_sta_config.dot11WURDiscoveryImplemented = val;
}

static inline uint8_t mac_mib_get_WURDiscoveryImplemented(mac_vap_stru *mac_vap)
{
    return mac_vap->pst_mib_info->wlan_mib_wur_sta_config.dot11WURDiscoveryImplemented;
}

static inline void mac_mib_set_WURNeighborDiscoveryImplemented(mac_vap_stru *mac_vap, uint8_t val)
{
    mac_vap->pst_mib_info->wlan_mib_wur_sta_config.dot11WURNeighborDiscoveryImplemented = val;
}

static inline uint8_t mac_mib_get_WURNeighborDiscoveryImplemented(mac_vap_stru *mac_vap)
{
    return mac_vap->pst_mib_info->wlan_mib_wur_sta_config.dot11WURNeighborDiscoveryImplemented;
}

static inline void mac_mib_set_WURBeaconPeriod(mac_vap_stru *mac_vap, uint32_t val)
{
    mac_vap->pst_mib_info->wlan_mib_wur_sta_config.dot11WURBeaconPeriod = val;
}

static inline uint32_t mac_mib_get_WURBeaconPeriod(mac_vap_stru *mac_vap)
{
    return mac_vap->pst_mib_info->wlan_mib_wur_sta_config.dot11WURBeaconPeriod;
}

static inline void mac_mib_set_WURDiscoveryPeriod(mac_vap_stru *mac_vap, uint32_t val)
{
    mac_vap->pst_mib_info->wlan_mib_wur_sta_config.dot11WURDiscoveryPeriod = val;
}

static inline uint32_t mac_mib_get_WURDiscoveryPeriod(mac_vap_stru *mac_vap)
{
    return mac_vap->pst_mib_info->wlan_mib_wur_sta_config.dot11WURDiscoveryPeriod;
}
#endif
#endif
