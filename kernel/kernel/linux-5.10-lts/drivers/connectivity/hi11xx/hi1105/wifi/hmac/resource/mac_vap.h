...
typedef struct {
    ...
    uint8_t custom_switch_11be : 1,
            custom_switch_mlo : 1,
            custom_switch_emlsr : 1,
            reserved_11be      : 5;
    uint8_t rsv_11be[NUM_3_BYTES];
#endif
    ...
    uint8_t nbw_mode; /* 是nbw mode也是CHBA，CHBA不一定是NBW */
#endif
...
{
    return (oal_bool_enum_uint8)(mac_vap->en_11ax_hal_cap == OAL_TRUE);
}

static inline oal_bool_enum_uint8 is_custom_open_11ax_switch(mac_vap_stru *mac_vap)
{
    return (oal_bool_enum_uint8)(mac_vap->en_11ax_custom_switch == OAL_TRUE);
}
...
{
    return (oal_bool_enum_uint8)(mac_vap->bit_multi_bssid_custom_switch == OAL_TRUE);
}

static inline oal_bool_enum_uint8 is_custom_open_htc_tom(mac_vap_stru *mac_vap)
{
    return (oal_bool_enum_uint8)((mac_vap->bit_htc_include_custom_switch == OAL_TRUE) && \
        (mac_vap->bit_om_include_custom_switch == OAL_TRUE));
}
...
static inline oal_bool_enum_uint8 mac_vap_is_he_eht_protocol(mac_vap_stru *mac_vap)
{
#ifdef _PRE_WLAN_FEATURE_11BE
    return (oal_bool_enum_uint8)(mac_vap->en_protocol == WLAN_EHT_MODE || mac_vap->en_protocol == WLAN_HE_MODE);
#else
    return (oal_bool_enum_uint8)(mac_vap->en_protocol == WLAN_HE_MODE);
#endif
}
...
#ifdef _PRE_WLAN_FEATURE_11BE
static inline uint8_t is_custom_open_11be_switch(mac_vap_stru *mac_vap)
{
    return (uint8_t)(mac_vap->custom_switch_11be == OAL_TRUE);
}
static inline uint8_t is_custom_open_mlo_switch(mac_vap_stru *mac_vap)
{
    return (uint8_t)(mac_vap->custom_switch_mlo == OAL_TRUE);
}
static inline uint8_t is_custom_open_emlsr_switch(mac_vap_stru *mac_vap)
{
    return (uint8_t)(mac_vap->custom_switch_emlsr == OAL_TRUE);
}
#endif
static inline uint8_t mac_vap_is_work_eht_protocol(mac_vap_stru *mac_vap)
{
#ifdef _PRE_WLAN_FEATURE_11BE
    return (mac_vap->en_protocol == WLAN_EHT_MODE);
#else
    return OAL_FALSE;
#endif
}
...
{
    return (oal_bool_enum_uint8)(mac_vap->en_vap_mode == WLAN_VAP_MODE_BSS_AP);
}
static inline oal_bool_enum_uint8 is_sta(mac_vap_stru *mac_vap)
{
    return (oal_bool_enum_uint8)(mac_vap->en_vap_mode == WLAN_VAP_MODE_BSS_STA);
}
static inline oal_bool_enum_uint8 is_p2p_dev(mac_vap_stru *mac_vap)
{
    return (oal_bool_enum_uint8)(mac_vap->en_p2p_mode == WLAN_P2P_DEV_MODE);
}
static inline oal_bool_enum_uint8 is_p2p_go(mac_vap_stru *mac_vap)
{
    return (oal_bool_enum_uint8)(mac_vap->en_p2p_mode == WLAN_P2P_GO_MODE);
}
static inline oal_bool_enum_uint8 is_p2p_cl(mac_vap_stru *mac_vap)
{
    return (oal_bool_enum_uint8)(mac_vap->en_p2p_mode == WLAN_P2P_CL_MODE);
}
static inline oal_bool_enum_uint8 is_legacy_vap(mac_vap_stru *mac_vap)
{
    return (oal_bool_enum_uint8)(mac_vap->en_p2p_mode == WLAN_LEGACY_VAP_MODE);
}
...
{
    return (oal_bool_enum_uint8)(mac_vap->en_radar_detector_is_supp == OAL_TRUE);
}
#endif
...
{
    return (oal_bool_enum_uint8)((mac_vap->st_channel.en_band == WLAN_BAND_2G) &&
        (mac_vap->st_cap_flag.bit_2g_custom_siso == OAL_TRUE));
}
static inline oal_bool_enum_uint8 mac_vap_is_5g_spec_siso(mac_vap_stru *mac_vap)
{
    return (oal_bool_enum_uint8)((mac_vap->st_channel.en_band == WLAN_BAND_5G) &&
        (mac_vap->st_cap_flag.bit_5g_custom_siso == OAL_TRUE));
}
...
uint32_t mac_device_find_up_vaps(mac_device_stru *mac_device, mac_vap_stru **mac_vap_array, uint32_t vap_array_num);
...
extern oal_bool_enum_uint8 mac_vap_can_not_start_he_protocol(mac_vap_stru *mac_vap);
extern oal_bool_enum_uint8 mac_vap_p2p_bw_back_to_40m(mac_vap_stru *mac_vap,
    uint8_t channel,  wlan_channel_bandwidth_enum_uint8 *channel_bw);
extern oal_bool_enum_uint8 mac_vap_avoid_dbac_close_vht_protocol(mac_vap_stru *mac_vap);
