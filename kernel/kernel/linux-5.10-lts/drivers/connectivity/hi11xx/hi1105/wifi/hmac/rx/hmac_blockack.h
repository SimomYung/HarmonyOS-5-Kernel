...
/* 8 UNION定义 */
/* 9 OTHERS定义 */
extern void hmac_rx_free_netbuf_list(oal_netbuf_head_stru *netbuf_hdr, uint16_t num_buf);
/* 10 inline函数定义 */
/*
...
uint8_t hmac_mgmt_check_set_rx_ba_ok(hmac_vap_stru *pst_hmac_vap, hmac_user_stru *pst_hmac_user,
    hmac_ba_rx_stru *pst_ba_rx_info, mac_device_stru *pst_device, hmac_tid_ba_stru *pst_tid_info);
