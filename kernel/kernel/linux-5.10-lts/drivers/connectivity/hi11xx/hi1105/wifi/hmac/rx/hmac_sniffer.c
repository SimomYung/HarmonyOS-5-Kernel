...
uint32_t hmac_monitor_report_frame_to_sdt(mac_rx_ctl_stru *pst_cb_ctrl, oal_netbuf_stru *pst_curr_netbuf)
{
    ...
    pst_frame_hdr = (mac_ieee80211_frame_stru *)(uintptr_t)mac_get_rx_cb_mac_header_addr(pst_cb_ctrl);
...
uint8_t hmac_sniffer_filter_frame(hmac_device_stru *hmac_device, mac_rx_ctl_stru *rxctl)
{
    ...
    frame_hdr = (mac_ieee80211_frame_stru *)(uintptr_t)mac_get_rx_cb_mac_header_addr(rxctl);
...
bool hmac_host_rx_sniffer_is_on(hal_host_device_stru *hal_device)
{
...
uint32_t hmac_sniffer_device_rx_proc(uint8_t hal_dev_id, oal_netbuf_stru *netbuf, mac_rx_ctl_stru *rx_ctl)
{
