...
typedef struct {
    uint8_t dot11WUROptionImplemented                                 : 1;
    uint8_t dot11WURFDMAChannelSwitchImplemented                      : 1;
    uint8_t dot11WURDiscoveryImplemented                              : 1;
    uint8_t dot11WURNeighborDiscoveryImplemented                      : 1;
    uint8_t dot11EstimatedServiceParametersOutboundOptionImplemented  : 1; /* 不使用 */
    uint8_t dot11RSNAOperatingChannelValidationActivated              : 1; /* 不使用 */
    uint8_t rsv                                                       : 2;

    uint32_t dot11WURBeaconPeriod;
    uint32_t dot11WURDiscoveryPeriod;
    uint32_t dot11LocallyAdministeredMACConfig;                     /* 不使用 */
} wlan_mib_Dot11WURStationConfigEntry_stru;
...
typedef struct {
    ...
    ****************************************************************************/
    ...
    wlan_mib_Dot11EHTStationConfigEntry_stru wlan_mib_eht_sta_config;
    wlan_mib_Dot11EHTPhyCapabilities_stru    wlan_mib_eht_phy_cap_config;

    wlan_mib_Dot11EHTOperationInfo_stru      wlan_mib_eht_oper_info_config;
    wlan_mib_Dot11EHTPPEThresholds_stru      wlan_mib_eht_ppe_thresholds_config;
#endif
#if defined(_PRE_WLAN_FEATURE_WUR)
    wlan_mib_Dot11WURStationConfigEntry_stru wlan_mib_wur_sta_config;
#endif
    /***************************************************************************
