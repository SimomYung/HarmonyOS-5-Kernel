...
typedef enum {
    ...
    MAC_ALG_CFG_ATF_USER_START,
    MAC_ALG_CFG_ATF_USER_VAL,
    MAC_ALG_CFG_ATF_USER_END,
#endif

    MAC_ALG_MLSR_SWITCH_START,
    MAC_ALG_MLSR_SWITCH_ENABLE,
    MAC_ALG_MLSR_SWITCH_LOG,
    MAC_ALG_MLSR_5G_LOW_RSSI_TH,
    MAC_ALG_MLSR_2G_LOW_RSSI_TH,
    MAC_ALG_MLSR_PER_TH,
    MAC_ALG_MLSR_PPS_TH,
    MAC_ALG_MLSR_INTF_TH,
    MAC_ALG_MLSR_TX_FAIL_RATIO_TH,
    MAC_ALG_MLSR_SWITCH_END,

    MAC_ALG_CFG_EMLSR_SCH_START,
    MAC_ALG_CFG_EMLSR_SCH_ENABLE,
    MAC_ALG_CFG_EMLSR_SCH_WEIGHT,
    MAC_ALG_CFG_EMLSR_SCH_DEBUG,
    MAC_ALG_CFG_EMLSR_SCH_STRATEGY,
    MAC_ALG_CFG_EMLSR_SCH_END,

    MAC_ALG_CFG_SU_PUNC_START,
    MAC_ALG_CFG_SU_PUNC_ENABLE,
    MAC_ALG_CFG_SU_PUNC_FOLLOW_BSS,
    MAC_ALG_CFG_SU_PUNC_BITMAP,
    MAC_ALG_CFG_SU_PUNC_LOG,
    MAC_ALG_CFG_SU_PUNC_PRIM_CHAN_BUSY_TH,
    MAC_ALG_CFG_SU_PUNC_CHAN_BUSY_TH,
    MAC_ALG_CFG_SU_PUNC_GAIN_TH,
    MAC_ALG_CFG_SU_PUNC_TX_FAIL_TH,
    MAC_ALG_CFG_SU_PUNC_END,

    MAC_ALG_CFG_SMARTANT_START,
    MAC_ALG_CFG_SMARTANT_MODE,
    MAC_ALG_CFG_SMARTANT_FIX_ANT,
    MAC_ALG_CFG_SMARTANT_DEBUG,
    MAC_ALG_CFG_SMARTANT_END,
    MAC_ALG_CFG_BUTT,

    MAC_ALG_CFG_AI_CSMA_EDCA_START,
    MAC_ALG_CFG_AI_CSMA_EDCA_PARAM_CFG,
    MAC_ALG_CFG_AI_CSMA_EDCA_END,
...
typedef struct {
    ...
    uint8_t cwmin;
    uint8_t cwmax;
} mac_ioctl_alg_ai_csma_edca_stru;
/* 算法参数枚举，参数值 */
typedef struct {
...
typedef struct {
    ...
    uint16_t atf_user_val;
} atf_cfg_user_val_stru;

typedef struct {
    mac_ioctl_alg_param_stru mac_alg_param;
    atf_cfg_user_val_stru user_val;
} atf_cfg_user_param_stru;
#endif
