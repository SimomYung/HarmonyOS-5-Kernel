...
typedef enum {
    ...
    HAL_RX_NO_DESC = 0x7,  /* mp17c使用 */
    HAL_RX_CCMP_REPLAY_FAILURE = 0x8,
    HAL_RX_RING_ERR = 0x8, /* mp17c使用,free ring empty或cmp ring full,或msdu too big其包括包长大于配置值或包个数大于配置值 */
...
typedef enum {
    HAL_WLAN_CRX_EVENT_SUB_TYPE_RX = 0, /* WLAN CRX 流程 */
#if (defined(_PRE_WLAN_FEATURE_FTM) || defined(_PRE_WLAN_FEATURE_CSI))
    HAL_EVENT_DMAC_FTM_IRQ = 1, /* FTM中断 */
#endif
#ifdef _PRE_WLAN_FEATURE_11AX
    HAL_WLAN_CRX_EVENT_SUB_RPT_HE_ROM = 2,
#endif
    HAL_WLAN_CRX_EVENT_SUB_TYPE_RX_PPDU = 3,
    HAL_WLAN_CRX_EVENT_SUB_TYPE_COMM_RX_PPDU = 4,
#ifdef _PRE_WLAN_FEATURE_LP_V2
    HAL_WLAN_CRX_EVENT_SUB_TYPE_LP_RX = 5,
#endif
    HAL_WLAN_CRX_EVENT_SUB_TYPE_COMM_RX_MPDU = 6,
...
typedef enum {
    ...
    WLAN_PHY_PROTOCOL_MODE_11B_PLUS = 6,                                     /* 11b+ */
    ...
    WLAN_PHY_PROTOCOL_MODE_EHT = 12,                                         /* 11be EHT SU/MU */
    WLAN_PHY_PROTOCOL_MODE_EHT_TB = 13,                                      /* 11be EHT TB */
    WLAN_PHY_PROTOCOL_BUTT = 14,
#else
...
typedef enum {
    WLAN_HE_MRU_SIZE_52_26,
    WLAN_HE_MRU_SIZE_106_26,
    WLAN_HE_MRU_SIZE_484_242,
    WLAN_HE_MRU_SIZE_996_484,
    WLAN_HE_MRU_SIZE_996_484_242,
    WLAN_HE_MRU_SIZE_2X996_484,
    WLAN_HE_MRU_SIZE_3X996,
    WLAN_HE_MRU_SIZE_3X996_484,

    WLAN_HE_MRU_SIZE_BUTT,
} wlan_he_mrusize_enum;
...
typedef enum {
    ...
    WLAN_RU_SIZE_996,
    WLAN_RU_SIZE_1992,
    WLAN_EHT_MRU_SIZE_52_26,            /* mru */
    WLAN_EHT_MRU_SIZE_106_26,           /* mru */
    WLAN_EHT_MRU_SIZE_484_242,          /* mru */
    WLAN_EHT_MRU_SIZE_996_484,          /* mru */
    WLAN_EHTE_MRU_SIZE_996_484_242,     /* mru */
    WLAN_EHT_MRU_SIZE_2X996_484,        /* mru */
    WLAN_EHT_MRU_SIZE_3X996,            /* mru */
    WLAN_EHT_MRU_SIZE_3X996_484,        /* mru */
    WLAN_RU_SIZE_BUTT,
} wlan_rusize_enum;
