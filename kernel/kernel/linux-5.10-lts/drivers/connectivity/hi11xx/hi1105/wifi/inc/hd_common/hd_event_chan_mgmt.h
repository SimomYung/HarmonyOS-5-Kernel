...
typedef struct {
    ...
    wlan_channel_bandwidth_enum_uint8 en_band_force_switch_bit0; /* 恢复40M带宽命令 */
...
typedef struct {
    uint8_t curr_vap_id; /* 发送/接收omn帧的vap */
    mac_vap_state_enum_uint8 vap_status;
    uint8_t resv[2];
} emlsr_vap_rpt_stru;
