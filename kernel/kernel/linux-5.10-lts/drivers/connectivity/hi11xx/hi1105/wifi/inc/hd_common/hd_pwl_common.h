 ...
 * 功能说明 : pwl host/dev 共用宏和结构体定义
 */
#ifndef HD_PWL_COMMON_H
#define HD_PWL_COMMON_H
#ifdef _PRE_WLAN_FEATURE_PWL
#include "hd_pwl_frame.h"
#include "wlan_spec.h"
...
#define GCM_AAD_MAX_LEN 48
#define GCM_IV_LEN 12
#define WLAN_SOFT_ENCRY_HEAD_SIZE 34
typedef enum {
