...
typedef enum {
    ...
    DMAC_WLAN_CTX_EVENT_SUB_TYPE_MVAP_TRANS_TBL = 43,       /* 多vap切换表下发 */
    DMAC_WLAN_CTX_EVENT_SUB_TYPE_ACTION_FILTER = 44,
...
typedef enum {
    ...
    DMAC_WLAN_CRX_EVNET_SUB_TYPE_EMLSR_OMN_SEND,
    DMAC_WLAN_CRX_EVNET_SUB_TYPE_EMLSR_FORCE_CLOSE,
    ...
    DMAC_WLAN_CRX_EVENT_SUB_TYPE_CFG_WUR_PARAM,
    DMAC_WLAN_CRX_EVENT_SUB_TYPE_WUR_TEARDOWN_EVENT,
    DMAC_WLAN_CRX_EVENT_SUB_TYPE_ALG_MASS_STATS_REPORT,
    DMAC_WLAN_CRX_EVENT_SUB_TYPE_WUR_BT_RELEASE_CHAN,
    DMAC_WLAN_CRX_EVENT_SUB_TYPE_NOTIFY_EMLSR_ALLOWED, /* 上报HOST device状态是否允许进入emlsr */
...
typedef enum {
    CUSTOM_HAL_PHY_CAP_DYN_INTER_FRAME_CFO = BIT0,
    CUSTOM_HAL_PHY_CAP_WIDEBW_MASK = BIT1,
    CUSTOM_HAL_PHY_CAP_RX_DELAY_OPT_MASK = BIT2,
    CUSTOM_HAL_PHY_CAP_BIG_SIGNAL = BIT3,
    CUSTOM_HAL_PHY_CAP_CCA_DET = BIT4,
} enhanced_phy_cap_enum; /* 扩展phy cap特性枚举 */

typedef enum {
    CUSTOM_CHBA_FAST_CONNECT_ENABLE = BIT0,        /* chba极速连接使能 */
    CUSTOM_ACTION_NEGOTIATION_OPTIMIZATION = BIT1, /* 已废弃, 因device rom化而保留定义 */
    CUSTOM_NBW_CAP = BIT2, /* nbw定制化开关 */
    ...
    CUSTOM_CHBA_DBDC_DBAC = BIT8, /* 支持CHBA DBDC+DBAC */
    CUSTOM_DBAC_CHBA_STA_DYNAMIC = BIT9,           /* CHBA+STA DBAC 动态时隙划分开关 */
