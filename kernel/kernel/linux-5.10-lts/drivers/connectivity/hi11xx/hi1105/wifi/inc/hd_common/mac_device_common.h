...
/* 雷达调试模式枚举 */
typedef enum {
    DFS_NO_DEBUG_MODE = 0,     /* 关闭雷达调试模式，会正常跳转信道 */
    DFS_DEBUG_PART_PULSE_NO_SWITCH_MODE = 1,  /* 打开雷达调试模式，不会跳转信道，雷达脉冲打的少 */
    DFS_DEBUG_ALL_PULSE_NO_SWITCH_MODE = WLAN_DFS_EN_ALL_PULSE, /* 打开雷达调试模式，不会跳转信道，打印所有雷达脉冲 */

    DFSMODE_BUTT
} mac_radar_dfsmode_enum;
#endif
...
#define PKT_FILTER_PROGRAM_MAX_LEN 512
#define PKT_FILTER_VERSION         2
#endif
