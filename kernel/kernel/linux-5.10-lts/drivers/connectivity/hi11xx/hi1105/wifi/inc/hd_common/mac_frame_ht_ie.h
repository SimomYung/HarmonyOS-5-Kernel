...
struct mac_hisi_cap_vendor_ie {
    uint32_t bit_11ax_support      : 1,  /* 1:是否支持11AX bit0 */
             ...
             bit_sub_wf_cap         : 1,  /* 1:是否支持子带注水 bit9 */
             bit_vht_3nss_160m_mcs9 : 1,  /* 1:是否支持VHT_3NSS_160M_MCS9 bit10 */
             bit_ersru_he_ltf_num   : 4,  /* 4:ersru_he_ltf_num支持字段 bit11-bit14 */
             bit_11b_plus_cap       : 3,  /* 3:是否支持11b+速率 bit15-bit17       */
             bit_hs_cts_cap         : 1,  /* 1:是否支持HS CTS bit18 */
             bit_11be_support       : 1,  /* 1:是否支持11BE bit19 */
             bit_wur_support        : 1,  /* 1:是否支持wur bit20 */
             bit_emlsr_support      : 1,  /* 1:是否支持emlsr 端管协同场景 bit21 */
             bit_resv               : 10;
} DECLARE_PACKED;
...
struct mac_ext_cap_ie {
    ...
    uint8_t bit_resv5 : 3,
            ...
            bit_resv8 : 1;         /* bit23 */
    uint8_t bit_resv6 : 7,
            bit_interworking : 1; /* bit31:Interworking */
    uint8_t bit_resv7 : 5,
            bit_tdls_support : 1, /* bit37:TDLS Support */
            bit_tdls_prhibited : 1, /* bit38:TDLS Prohibited */
            bit_tdls_channel_switch_prhibited : 1; /* bit39:TDLS Channel Switching Prohibited */

    uint8_t bit_resv9 : 8;
    uint8_t bit_resv10 : 8;

    uint8_t bit_resv11 : 6,
            bit_operating_mode_notification : 1, /* bit62:11ac Operating Mode Notification特性标志 */
            bit_resv12 : 1;
    ...
    uint8_t bit_resv16 : 5,
            bit_twt_request_support : 1,   /* bit77:TWT Requester Support */
            bit_twt_responder_support : 1, /* bit78:TWT Responder Support */
            bit_resv17 : 1;
    uint8_t bit_complete_list_of_nontxbssid_profiles : 1,      /* bit80:Complete List of NonTxBSSID Profiles */
            bit_sae_password_identifiers_in_use : 1,           /* bit81:SAE Password Identifiers In Use */
            bit_sae_password_identifiers_used_exclusively : 1, /* bit82:SAE Password Identifiers Used Exclusively */
            bit_resv18 : 1,
            bit_beacon_protection_enabled : 1,                 /* bit84:Beacon Protection Enabled */
            bit_mirrored_scs : 1,                              /* bit85:Mirrored SCS */
            bit_resv19 : 1,
            bit_local_mac_address_policy : 1;                  /* bit87:Local MAC Address Policy */
} DECLARE_PACKED;
