...
#define MAC_IE_EID_LEN             1  /* EXT_EID 1字节长度 */
...
#define MAC_SEQ_CTL_LEN 2 /* 序列控制字段长度 */
...
#define MAC_ADDBA_EXTENSION_IE_LEN            1 /* ADDBA Extension element len */
/* action帧相关定义 */
...
typedef enum {
    ...
    MAC_AP_TYPE_AGC_COMPABILITY_AP = BIT1,
...
typedef enum {
    ...
    MAC_WUR_ACTION_WUR_WAKEUP_INDICATION = 2,
    MAC_WUR_ACTION_CONFIG_CHECK_WUR_ALLOWED = 3,
    MAC_WUR_ACTION_WUR_SLEEP_PARAM_UPDATE = 4,
...
typedef enum {
    ...
    MAC_DENIED_TID_TO_LINK_MAPPING = 133,
    /* 私有的定义 */
    ...
    MAC_CHBA_CANCEL_CONNECT_RESPONDER = 6207, /* 上层命令取消响应方入网 */
    MAC_CHBA_ASSOC_PRIV_IE_FULL = 6208, /* chba私有ie内存已满 */
    MAC_CHBA_ASSOC_PRIV_IE_SAVE_FAIL = 6209, /* chba私有ie保存失败 */
#endif
...
typedef enum {
    ...
    MAC_EID_REDUCED_NEIGHBOR_REPORT = 201, /* Reduced Neighbor Report IE */
    MAC_EID_FTMP = 206,
#ifdef _PRE_WLAN_FEATURE_11AX
    MAC_EID_TWT = 216,
#endif
    ...
    MAC_EID_RSNX = 244,
    MAC_EID_FRAGMENT_SUB = 254, /* Subelement ID of the Fragment subelement */
    MAC_EID_EXTENSION = 255,
#ifdef _PRE_WLAN_FEATURE_11AX
    MAC_EID_HE = 255,
#endif
#if defined(_PRE_WLAN_FEATURE_11BE) || defined(_PRE_WLAN_FEATURE_11BE_EXT)
    MAC_EID_EHT = MAC_EID_EXTENSION,
#endif
    MAC_EID_MULTILINK = MAC_EID_EXTENSION, /* Multi-link element */
#ifdef _PRE_WLAN_FEATURE_WUR
    MAC_EID_WUR = MAC_EID_EXTENSION,
#endif
} mac_eid_enum;
...
typedef enum {
    ...
    MAC_EID_EXT_WUR_DISCOVERY = 51,
    MAC_EID_EXT_MAX_CHANNEL_SWITCH_TIME = 52, /* Max Channel Switch Time element */
    MAC_EID_EXT_NON_INHERITANCE = 56, /* Multi-link element 非继承IE */
    MAC_EID_EXT_HE_6GHZ_BAND_CAP = 59,

#if defined(_PRE_WLAN_FEATURE_11BE) || defined(_PRE_WLAN_FEATURE_11BE_EXT)
    MAC_EID_EXT_EHT_OPER = 106,      /* EHT Operation element */
    MAC_EID_EXT_EHT_ML = 107,        /* Multi-Link element */
    MAC_EID_EXT_EHT_CAP = 108,       /* EHT Capbilities element */
    MAC_EID_EXT_EHT_TIDTOLINK = 109, /* TID-To-Link Mapping element */
    MAC_EID_EXT_EHT_MLTF = 110,      /* Multi-Link Traffic element */
#endif
