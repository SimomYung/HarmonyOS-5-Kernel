...
typedef struct {
    uint32_t dpd_even_lut[MP12_WLAN_DPD_EVEN_LUT_DATA_LENGTH];
    uint32_t dpd_odd_lut[MP12_WLAN_DPD_ODD_LUT_DATA_LENGTH];
    uint32_t dpd_glue_lut[MP12_WLAN_DPD_GLUE_LUT_DATA_LENGTH];
    uint8_t vga_gain;
    uint8_t bit_dpd_version : 4,
            ...
            bit_rx_lo : 1;
    uint8_t resv[2];  /* 对齐 2 */
} mp12_wlan_cali_dpd_lut_stru;

typedef struct {
    mp12_wlan_cali_dpd_lut_stru dpd_cali_para[WLAN_DPD_TPC_LEVEL_NUM];
} mp12_wlan_cali_dpd_para_stru;
...
typedef struct {
    ...
    mp12_wlan_cali_dpd_para_stru  dpd_cali_data;
#endif
} mp12_wlan_cali_basic_para_stru;

typedef struct {
    mp12_wlan_cali_basic_para_stru cali_data[WLAN_2G_CALI_BAND_NUM];
} mp12_wlan_cali_2g_20m_save_stru;

typedef struct {
    mp12_wlan_cali_basic_para_stru cali_data[WLAN_2G_CALI_BAND_NUM];
} mp12_wlan_cali_2g_40m_save_stru;

typedef struct {
    uint8_t pa_current_data[WLAN_5G_20M_CALI_BAND_NUM];
    uint8_t resv;
    mp12_wlan_cali_basic_para_stru cali_data[WLAN_5G_20M_CALI_BAND_NUM];
} mp12_wlan_cali_5g_20m_save_stru;

typedef struct {
    mp12_wlan_cali_basic_para_stru cali_data[WLAN_5G_20M_CALI_BAND_NUM];
} mp12_wlan_cali_5g_40m_save_stru;

typedef struct {
    mp12_wlan_cali_basic_para_stru cali_data[WLAN_5G_20M_CALI_BAND_NUM];
} mp12_wlan_cali_5g_80m_save_stru;
...
/* 单通道校准数据结构体 */
typedef struct {
    mp12_wlan_cali_2g_20m_save_stru cali_data_2g_20m;
    mp12_wlan_cali_5g_20m_save_stru cali_data_5g_20m;
    mp12_wlan_cali_5g_80m_save_stru cali_data_5g_80m;
...
/* 单信道校准数据结构体 */
typedef struct {
    mp12_wlan_cali_basic_para_stru cali_data[MP12_HD_EVENT_RF_NUM];
