...
typedef struct {
    uint32_t dpd_even_lut[MP1X_WLAN_DPD_EVEN_LUT_DATA_LENGTH];
    uint32_t dpd_odd_lut[MP1X_WLAN_DPD_ODD_LUT_DATA_LENGTH];
    uint32_t dpd_glue_lut[MP1X_WLAN_DPD_GLUE_LUT_DATA_LENGTH];
    uint8_t vga_gain;
    uint8_t bit_dpd_version : 4,
            bit_tx_lo : 1,
            bit_tx_dpd_lo_tx : 1,
            bit_tx_dpd_lo_dpd : 1,
            bit_rx_lo : 1;
    uint8_t resv[2];  /* 对齐 2 */
} mp1x_wlan_cali_dpd_lut_stru;

typedef struct {
    mp1x_wlan_cali_dpd_lut_stru dpd_cali_para[WLAN_DPD_TPC_LEVEL_NUM];
} mp1x_wlan_cali_dpd_para_stru;
...
typedef struct {
    ...
    mp1x_wlan_cali_dpd_para_stru  dpd_cali_data;
#endif
} mp1x_wlan_cali_basic_para_stru;

typedef struct {
    mp1x_wlan_cali_basic_para_stru cali_data[WLAN_2G_CALI_BAND_NUM];
} mp1x_wlan_cali_2g_20m_save_stru;
typedef struct {
    mp1x_wlan_cali_basic_para_stru cali_data[WLAN_2G_CALI_BAND_NUM];
} mp1x_wlan_cali_2g_40m_save_stru;

typedef struct {
    uint8_t pa_current_data[WLAN_5G_20M_CALI_BAND_NUM];
    uint8_t resv;
    mp1x_wlan_cali_basic_para_stru cali_data[WLAN_5G_20M_CALI_BAND_NUM];
} mp1x_wlan_cali_5g_20m_save_stru;

typedef struct {
    mp1x_wlan_cali_basic_para_stru cali_data[WLAN_5G_20M_CALI_BAND_NUM];
} mp1x_wlan_cali_5g_40m_save_stru;

typedef struct {
    mp1x_wlan_cali_basic_para_stru cali_data[WLAN_5G_20M_CALI_BAND_NUM];
} mp1x_wlan_cali_5g_80m_save_stru;

typedef struct {
    mp1x_wlan_cali_basic_para_stru cali_data[WLAN_5G_160M_CALI_BAND_NUM];
} wlan_cali_5g_160m_save_stru;

typedef struct {
    mp1x_wlan_cali_basic_para_stru cali_data[WLAN_6G_20M_CALI_BAND_NUM];
...
typedef struct {
    mp1x_wlan_cali_basic_para_stru cali_data[WLAN_6G_160M_CALI_BAND_NUM];
...
} mp1x_wlan_cali_ctl_para_stru;

/* 非通道相关(或者非带宽相关)校准数据结构体 */
typedef struct {
    wlan_cali_rc_r_c_para_stru rc_r_c_cali_data[HAL_MAX_BAND_NUM][HD_EVENT_RF_NUM];
    wlan_cali_lna_blk_para_stru lna_blk_cali_data[HAL_MAX_BAND_NUM][HD_EVENT_RF_NUM];
    ...
    mp1x_wlan_cali_ctl_para_stru cali_ctl_data;
...
} mp1x_wlan_cali_common_para_stru;
...
typedef struct {
    mp1x_wlan_cali_dpd_lut_stru dpd_cali_para;
...
} mp1x_wlan_cali_rf_20m_para_stru;

/* 扫描(20m)comm数据结构体(不区分通道) */
typedef struct {
    mp1x_wlan_cali_common_para_stru common_cali_data;
    uint8_t open_wifi_cali;
    uint8_t cali_cnt;
    uint16_t fac_cali_chain;
} mp1x_wlan_cali_data_20m_common_para_stru;

/* 单通道校准数据结构体 */
typedef struct {
    mp1x_wlan_cali_2g_20m_save_stru cali_data_2g_20m;
    mp1x_wlan_cali_5g_20m_save_stru cali_data_5g_20m;
    mp1x_wlan_cali_5g_80m_save_stru cali_data_5g_80m;
...
} mp1x_wlan_cali_rf_para_stru;

/* host校准数据结构体 */
typedef struct {
    mp1x_wlan_cali_rf_para_stru rf_cali_data[HD_EVENT_RF_NUM];
    wlan_cali_dbdc_para_stru dbdc_cali_data[HD_EVENT_SLAVE_RF_NUM];
    mp1x_wlan_cali_common_para_stru common_cali_data;
} mp1x_wlan_cali_data_para_stru;

/* 单信道校准数据结构体 */
typedef struct {
    mp1x_wlan_cali_basic_para_stru cali_data[HD_EVENT_RF_NUM];
    wlan_cali_dbdc_basic_para_stru dbdc_cali_data[HD_EVENT_SLAVE_RF_NUM];
} mp1x_wlan_cali_chn_stru;
