...
typedef struct {
    uint32_t dpd_even_lut[WLAN_DPD_EVEN_LUT_DATA_LENGTH];
    uint32_t dpd_odd_lut[WLAN_DPD_ODD_LUT_DATA_LENGTH];
    uint32_t dpd_glue_lut[WLAN_DPD_GLUE_LUT_DATA_LENGTH];
    uint8_t vga_gain;
