...
typedef enum {
    ...
    *************************************************************************/
    ...
    WLAN_CFGID_VAP_ROAM_CONN_STATE_SYN = 242,
    ...
    WLAN_CFGID_SET_LINK_VAP_ALWAYS_RX = 363, /* 常收流程配置link vap的参数 */

    WLAN_CFGID_SET_11BE_WIFI7_BLACKLIST = 364, /* 设置Wifi7黑名单 */
    ...
    WLAN_CFGID_SET_MCSBE = 376,     /* 设置EHT速率 */
    ...
    WLAN_CFGID_TAS_ANT_STATUS_RPT = 407,
#endif
