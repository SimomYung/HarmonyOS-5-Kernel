...
typedef enum {
    ...
    WLAN_CFGID_SET_LP_WAKEUP_TH = 511,   /* 固定当前LP通道常收模式 */
    WLAN_CFGID_SET_LP_EG_ALRX = 512,   /* 配置硬化常收模式 */
    WLAN_CFGID_SET_HW_PM_SWITCH = 513,   /* 配置硬化低功耗开关 */
    ...
    WLAN_CFGID_TAS_ANT_SWITCH = 621,    /* TAS天线切换 */
    ...
    WLAN_CFGID_SET_PKT_FILTER = 779, /* 设置PKT_FILTER PROGRAM */
    ...
    WLAN_CFGID_SET_FASTSLEEP3_PARA = 812, /* 配置fastsleep3相关参数 */
    ...
    WLAN_CFGID_CHBA_SERVICE_ASK_USER_ALL_AWAKE = 850, /* 触发配置user bitmap切换至全醒 */
    ...
    WLAN_CFGID_CHBA_TX_COMPLETE_ASSOC_RSP = 875, /* 发送assoc rsp完成, 极速连接时使用 */
    ...
    WLAN_CFGID_CHBA_CANCEL_CONN_NOTIFY = 880, /* supplicant下发的取消CHBA连接通知 */
#endif
    ...
    WLAN_CFGID_ML_MODE_SWITCH = 904,
    WLAN_CFGID_SET_MLD_ASSOC_MODE = 905,
    WLAN_CFGID_MLSR_WROK_LINK_SWITCH = 906,
    WLAN_CFGID_ML_RECONFIG_REMOVE_LINK = 907,
    WLAN_CFGID_TX_ML_RECONFIG_REQUEST = 908,
#endif
    WLAN_CFGID_CF_END_ENABLE = 909,
    WLAN_CFGID_VSP_NAV_EDCA = 910,
    WLAN_CFGID_WIDEBW_SYN = 911,
    WLAN_CFGID_TX_START_SAME_CHAN_REMAIN_ON_CHAN = 912, /* tx mgmt接口下发同信道监听命令 */
    WLAN_CFGID_RX_START_SAME_CHAN_REMAIN_ON_CHAN = 913, /* ioctl监听接口下发同信道监听命令 */
    WLAN_CFGID_SAME_CHAN_REMAIN_ON_CHAN_H2D_SYNC = 914, /* 同信道监听状态同步 d2h */
    WLAN_CFGID_CANCAL_SAME_CHAN_REMAIN_ON_CHAN_SYNC = 915, /* 取消同信道监听状态同步 */
    WLAN_CFGID_MLD_MODE_SWITCH = 916, /* MLD 模式切换 */
    WLAN_CFGID_SET_TX_RING_TABLE_DUP_EN = 917,
#ifdef _PRE_WLAN_FEATURE_ML
    WLAN_CFGID_MLSR_WROK_LINK_SWITCH_POST_EVENT = 918,
#endif
    WLAN_CFGID_SSI_DELAY_SWITCH_EVENT = 919,
    WLAN_CFGID_SE_REGINFO_MASK = 920, /* 配置寄存器打印屏蔽 */
#ifdef _PRE_WLAN_FEATURE_NBW
    WLAN_CFGID_NBW_SET_USER_BITMAP = 921,
    WLAN_CFGID_NBW_SET_VAP_BITMAP = 922,
#endif
    WLAN_CFGID_SET_PHASE_INCR = 923,
#ifdef _PRE_WLAN_FEATURE_EMLSR
    WLAN_CFGID_EMLSR_ENTER_CHECK_DEVICE_STATE = 924,
#endif
