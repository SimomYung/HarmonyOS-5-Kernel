...
typedef enum {
    ...
    *************************************************************************/
    ...
    WLAN_CFGID_AI_CSMA_EDCA_CFG_RESULT = 2035,
    WLAN_CFGID_AI_CSMA_EDCA_INTERRUPT_REPORT = 2036,
    WLAN_CFGID_STATION_INFO_EXT_CDF_TH = 2037,
    /* mp16独有,0X共用命令勿往此处放置 */
    ...
    WLAN_CFGID_SET_WUR_PARAM,
    WLAN_CFGID_SET_LP_LONG_DTIM,
    WLAN_CFGID_START_ELP_SCAN,
    WLAN_CFGID_SET_OMI_BW_SWITCH,
    WLAN_CFGID_GET_OMI_BW_SWITCH,
    WLAN_CFGID_GET_LOWPOWER_STATISTICS,
    WLAN_CFGID_WUR_BITMAP_SYNC,
    WLAN_CFGID_EMLSR_BITMAP_SYNC,
