...
typedef enum {
    ...
    *************************************************************************/
    ...
    WLAN_CFGID_USER_ML_INFO_SYN = 2003,
#endif
...
#endif
#ifdef _PRE_WLAN_FEATURE_ML
    WLAN_CFGID_VAP_ML_INFO_SYN = 2013,
#endif
    ...
    WLAN_CFGID_RX_MODE_SWITCH_PM = 4034,
    ...
    WLAN_CFGID_SET_ISOLATION = 4039,
    WLAN_CFGID_RING_SWITCH_FAIL_DEBUG = 4040,
    ...
    WLAN_CFGID_SSI_TEST,
    WLAN_CFGID_MP61_PRIV_END,

    /* 07c新增 */
    WLAN_CFGID_MP17C_PRIV_START = WLAN_CFGID_MP61_PRIV_END,
    WLAN_CFGID_CHANGE_VAP_MLD_MODE = WLAN_CFGID_MP17C_PRIV_START,
    WLAN_CFGID_SU_PUNCTURE_EN, /* 使能SU打孔 */
    WLAN_CFGID_EMLSR_ENABLE, /* 发送EMLSR OMN帧 */
    WLAN_CFGID_EMLSR_CAP,
    WLAN_CFGID_EMLSR_CFG_LINK,
    WLAN_CFGID_EMLSR_CFG_SET_DSCR,
    WLAN_CFGID_AL_EMLSR_ENABLE,
    WLAN_CFGID_SET_MLD_KEY_INFO, /* 私有ioctl命令下发mld key info */
    WLAN_CFGID_SET_MLD_VAP_PARAM,
    WLAN_CFGID_ML_TTLM_REQUEST,
    WLAN_CFGID_ML_TTLM_TEARDOWN,
    WLAN_CFGID_ML_TTLM_STATUS,
    WLAN_CFGID_MLD_CAP_SYN,
    WLAN_CFGID_MLD_LINK_SWITCH_ENABLE,
    WLAN_CFGID_WUR_DEBUG,
    WLAN_CFGID_ELP_SCAN_REQ,
    WLAN_CFGID_CHANGE_USER_MLD_MODE,
    WLAN_CFGID_SET_ALWAYS_TX_RING_INFO,
    WLAN_CFGID_WUR_DEBUG_INFO,
    WLAN_CFGID_MP17C_PRIV_END,

    WLAN_CFGID_BUTT,
} wlan_cfgid2_enum;
#endif /* end of wlan_cfg_id_2.h */
