...
#define WLAN_NUM_BIGTK          2
#define WLAN_MAX_IGTK_KEY_INDEX 5
#define WLAN_BIGTK_START_KEY_ID 6
#define WLAN_MAX_BIGTK_KEY_INDEX 7
...
#define MAC_RSN_AKM_SAE_EXT_KEY        CIPHER_SUITE_SELECTOR(0x00, 0x0f, 0xac, 24)
...
typedef enum {
    ...
    /* 以下加密方式非802.11协议定义加密类型，随意定，不影响11i即可 */
    WLAN_80211_CIPHER_SUITE_WAPI = 14,
    WLAN_80211_CIPHER_SUITE_SM4_GCM = 15,
...
typedef enum {
    WLAN_11BPLUS_HALF_MBPS_LDPC = 0,        /* 0.5 Mbps ldpc */
    WLAN_11BPLUS_1_MBPS_LDPC = 1,           /* 1 Mbps ldpc */
    WLAN_11BPLUS_2_POINT_75_MBPS_LDPC = 2,  /* 2.75 Mbps ldpc */
    WLAN_11BPLUS_5_HALF_MBPS_LDPC = 3,      /* 5.5 Mbps ldpc */
    WLAN_11BPLUS_QUARTER_MBPS_POLAR = 4,    /* 0.25 Mbps polar */
    WLAN_11BPLUS_HALF_MBPS_POLAR = 5,       /* 0.5 Mbps poolar */
    WLAN_11BPLUS_1_MBPS_POLAR = 6,          /* 1 Mbps polar */
    WLAN_11BPLUS_2_POINT_75_MBPS_POLAR = 7, /* 2.75 Mbps polar */
    WLAN_11BPLUS_5_HALF_MBPS_POLAR = 8,     /* 5.5 Mbps polar */

    WLAN_11BPLUS_RATE_VALUE_BUTT,
} wlan_11bplus_rate_value_enum;

typedef enum {
    WLAN_11BPLUS_NOT_SUPPORT = 0,    /* 不支持11b+速率 */
    WLAN_11BPLUS_CAP_LDPC = 1,       /* 支持LDPC(0.5 1 2.75 5.5) */
    WLAN_11BPLUS_CAP_POLAR = 2,      /* 支持POLAR(0.25 0.5 1 2.75 5.5) */
    WLAN_11BPLUS_CAP_LDPC_POLAR = 3, /* 支持LDPC(0.5 1 2.75 5.5)和POLAR(0.25 0.5 1 2.75 5.5) */

    WLAN_11BPLUS_CAP_BUTT,
} wlan_11bplus_cap_enum;

typedef enum {
    WLAN_11BPLUS_QUARTER_MBPS_INDEX = 0,     /* MCS0 0.25 Mbps */
    WLAN_11BPLUS_HALF_MBPS_INDEX = 1,        /* MCS1 0.5 Mbps */
    WLAN_11BPLUS_1_MBPS_INDEX = 2,           /* MCS2 1 Mbps */
    WLAN_11BPLUS_2_POINT_75_MBPS_INDEX = 3,  /* MCS3 2.75 Mbps */
    WLAN_11BPLUS_5_HALF_MBPS_INDEX = 4,      /* MCS4 5.5 Mbps */

    WLAN_11BPLUS_RATE_INDEX_BUTT,
} wlan_11bplus_rate_index_enum;

typedef enum {
    WLAN_11BBPLUS_QUARTER_MBPS_INDEX = 0,
    WLAN_11BBPLUS_HALF_MBPS_INDEX = 1,
    WLAN_11BBPLUS_1_MBPS_INDEX = 2,
    WLAN_11BBPLUS_2_MBPS_INDEX = 3,
    WLAN_11BBPLUS_2_POINT_75_MBPS_INDEX = 4,
    WLAN_11BBPLUS_5_HALF_MBPS_INDEX = 5,
    WLAN_11BBPLUS_11_MBPS_INDEX = 6,

    WLAN_11BBPLUS_RATE_INDEX_BUTT,
} wlan_11bbplus_rate_index_enum;

typedef enum {
    WLAN_11ABPLUS_QUARTER_MBPS_INDEX = 0,
    WLAN_11ABPLUS_HALF_MBPS_INDEX = 1,
    WLAN_11ABPLUS_1_MBPS_INDEX = 2,
    WLAN_11ABPLUS_2_POINT_75_MBPS_INDEX = 3,
    WLAN_11ABPLUS_5_HALF_MBPS_INDEX = 4,
    WLAN_11ABPLUS_6_MBPS_INDEX = 5,
    WLAN_11ABPLUS_9_MBPS_INDEX = 6,
    WLAN_11ABPLUS_12_MBPS_INDEX = 7,
    WLAN_11ABPLUS_18_MBPS_INDEX = 8,
    WLAN_11ABPLUS_24_MBPS_INDEX = 9,
    WLAN_11ABPLUS_36_MBPS_INDEX = 10,
    WLAN_11ABPLUS_48_MBPS_INDEX = 11,
    WLAN_11ABPLUS_54_MBPS_INDEX = 12,

    WLAN_11ABPLUS_RATE_INDEX_BUTT,
} wlan_11abplus_rate_index_enum;
#endif
