...
#define hmac_pkt_filter_program_report_event   wlan_oneimage_rename(hmac_pkt_filter_program_report_event)
#define hmac_pkt_filter_program_report_rx_adapt   wlan_oneimage_rename(hmac_pkt_filter_program_report_rx_adapt)
...
#define hmac_config_pkt_filter_cmd   wlan_oneimage_rename(hmac_config_pkt_filter_cmd)
...
#define hmac_config_set_mcsbe   wlan_oneimage_rename(hmac_config_set_mcsbe)
...
#define hmac_config_tas_ant_switch wlan_oneimage_rename(hmac_config_tas_ant_switch)
