...
/* 整个BOARD支持的最大的hal device数目, HOST按最大规格定义,HOST看不见DBDC规格, 用于资源定义 */
...
/*
 * 以下两个成员可以定制化: WLAN_ASSOC_USER_MAX_NUM对应g_us_assoc_max_user WLAN_ASSOC_USER_MAX_NUM对应g_us_active_max_user
*/
#ifdef _PRE_PRODUCT_ID_E5
