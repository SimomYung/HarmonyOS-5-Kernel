...
#define EXPORT_POW_LPF_OFFSET           12
#define EXPORT_POW_UPC_OFFSET           20
...
uint32_t wal_send_cmd_params_to_device(mac_vap_stru *mac_vap, host_cmd_stru *cmd_info, int32_t *params,
    uint32_t cmd_id);
#endif
