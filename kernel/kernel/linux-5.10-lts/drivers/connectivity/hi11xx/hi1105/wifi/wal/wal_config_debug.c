...
{
    return hmac_config_ml_emlsr_enable(mac_vap, len, param);
}
OAL_STATIC uint32_t wal_config_emlsr_cap(mac_vap_stru *mac_vap, uint16_t len, uint8_t *param)
{
    return hmac_config_ml_emlsr_cap(mac_vap, len, param);
}
...
const wal_wid_op_stru g_ast_board_wid_op_debug[] = {
    ...
    { WLAN_CFGID_EMLSR_CAP, OAL_FALSE, { 0 }, NULL, wal_config_emlsr_cap },
