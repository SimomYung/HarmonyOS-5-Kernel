...
struct ieee80211_sband_iftype_data g_sband_iftype_data_info_2g[] = {
    {
        .types_mask = BIT(NL80211_IFTYPE_STATION),
        .he_cap = {
            .has_he = OAL_TRUE,
            .he_cap_elem = {
                .phy_cap_info[0] = BIT(1),   // 支持40MHz
            },
        },
    },
    {
...
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(5, 10, 43))
    .n_iftype_data = sizeof(g_sband_iftype_data_info_2g) / sizeof (struct ieee80211_sband_iftype_data),
    .iftype_data = g_sband_iftype_data_info_2g,
#endif
};
