...
enum wal_vendor_subcmd {
    ...
    PKT_FILTER_SUBCMD_GET_CAPABILITIES = VENDOR_NL80211_SUBCMD_PKT_FILTER_RANGE_START,
    PKT_FILTER_SUBCMD_SET_FILTER,

    WIFI_SUBCMD_HID2D_CONN_NOTIFY = VENDOR_NL80211_SUBCMD_HID2D_RANGE_START,
    WIFI_SUBCMD_HID2D_CONN_READY,
    WIFI_SUBCMD_HID2D_LINK_DETECT,
    WIFI_SUBCMD_HID2D_LINK_DETECT_RESULT,
    WIFI_SUBCMD_HID2D_CANCEL_CONN_NOTIFY, /* chba cancel_connect_notify命令 */
...
extern const struct nla_policy wal_pkt_filter_attr_policy[PKT_FILTER_ATTRIBUTE_MAX + 1];
#endif
...
extern const struct nla_policy wal_chba_cancel_conn_ntf_attr_policy[MAC_CHBA_CANCEL_CONN_NTF_ATTR_MAX + 1];
#endif
#endif
