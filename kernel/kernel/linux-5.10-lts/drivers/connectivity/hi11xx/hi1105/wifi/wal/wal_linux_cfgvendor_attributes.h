...
enum wal_pkt_filter_attributes {
    PKT_FILTER_ATTRIBUTE_VERSION,
    PKT_FILTER_ATTRIBUTE_MAX_LEN,
    PKT_FILTER_ATTRIBUTE_PROGRAM,
    PKT_FILTER_ATTRIBUTE_PROGRAM_LEN,

    /* keep last */
    PKT_FILTER_ATTRIBUTE_LAST,
    PKT_FILTER_ATTRIBUTE_MAX = PKT_FILTER_ATTRIBUTE_LAST - 1,
};
#endif
...
enum wal_chba_conn_ntf_attributes {
    ...
    MAC_CHBA_CONN_NTF_ATTR_CONNT_FLAG, /* CHBA快速连接标记 */
    MAC_CHBA_CONN_NTF_ATTR_ASSOC_PRIV_IE,
    /* keep last */
    MAC_CHBA_CONN_NTF_ATTR_LAST,
    MAC_CHBA_CONN_NTF_ATTR_MAX = MAC_CHBA_CONN_NTF_ATTR_LAST - 1,
};

enum wal_chba_cancel_conn_ntf_attributes {
    MAC_CHBA_CANCEL_CONN_NTF_ATTR_ID = 1,
    MAC_CHBA_CANCEL_CONN_NTF_ATTR_MAC_ADDR,
    /* keep last */
    MAC_CHBA_CANCEL_CONN_NTF_ATTR_LAST,
    MAC_CHBA_CANCEL_CONN_NTF_ATTR_MAX = MAC_CHBA_CONN_NTF_ATTR_LAST - 1,
};
#endif
...
enum wal_roam_trigger_attributes {
    ...
    ROAM_ATTRIBUTE_EXTERNAL_AUTH_MLD_ADDR = 7,
#endif
    /* keep last */
    ROAM_ATTRIBUTE_LAST,
