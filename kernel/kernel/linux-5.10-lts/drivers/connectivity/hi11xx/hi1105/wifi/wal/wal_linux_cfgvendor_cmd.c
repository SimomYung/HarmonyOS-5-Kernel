...
OAL_STATIC const oal_wiphy_vendor_command_stru g_wal_vendor_cmds[] = {
    ...
    {   {   .vendor_id = OUI_VENDOR,
            .subcmd = PKT_FILTER_SUBCMD_GET_CAPABILITIES
        },
        .flags = WIPHY_VENDOR_CMD_NEED_WDEV | WIPHY_VENDOR_CMD_NEED_NETDEV,
        .doit = wal_cfgvendor_pkt_filter_get_capabilities,
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(5, 4, 0))
        .policy = wal_pkt_filter_attr_policy,
        .maxattr = PKT_FILTER_ATTRIBUTE_MAX,
#endif
    },

    {   {   .vendor_id = OUI_VENDOR,
            .subcmd = PKT_FILTER_SUBCMD_SET_FILTER
        },
        .flags = WIPHY_VENDOR_CMD_NEED_WDEV | WIPHY_VENDOR_CMD_NEED_NETDEV,
        .doit = wal_cfgvendor_pkt_filter_set_filter,
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(5, 4, 0))
        .policy = wal_pkt_filter_attr_policy,
        .maxattr = PKT_FILTER_ATTRIBUTE_MAX,
#endif
    ...
    {   {   .vendor_id = OUI_VENDOR,
            .subcmd = WIFI_SUBCMD_HID2D_CANCEL_CONN_NOTIFY
        },
        .flags = WIPHY_VENDOR_CMD_NEED_WDEV | WIPHY_VENDOR_CMD_NEED_NETDEV,
        .doit = wal_cfgvendor_chba_cancel_conn_notify,
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(5, 4, 0))
        .policy = wal_chba_cancel_conn_ntf_attr_policy,
        .maxattr = MAC_CHBA_CANCEL_CONN_NTF_ATTR_MAX,
#endif
    },
#endif
