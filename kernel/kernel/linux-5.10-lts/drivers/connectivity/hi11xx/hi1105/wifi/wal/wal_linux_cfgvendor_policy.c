...
const struct nla_policy wal_pkt_filter_attr_policy[PKT_FILTER_ATTRIBUTE_MAX + 1] = {
    [PKT_FILTER_ATTRIBUTE_PROGRAM] =  { .type = NLA_BINARY,
        .len = sizeof(NLA_U8) * PKT_FILTER_PROGRAM_MAX_LEN },
    [PKT_FILTER_ATTRIBUTE_PROGRAM_LEN] ={ .type = NLA_U32 },
};
#endif
...
#define CHBA_NTF_ATTR_ASSOC_PRIV_IE_LEN 256 /* chba私有app ie命令长度 */
...
const struct nla_policy wal_chba_conn_ntf_attr_policy[MAC_CHBA_CONN_NTF_ATTR_MAX + 1] = {
    ...
    [MAC_CHBA_CONN_NTF_ATTR_CONNT_FLAG] = { .type = NLA_U8 },
    [MAC_CHBA_CONN_NTF_ATTR_ASSOC_PRIV_IE] = { .type = NLA_BINARY,
        .len = sizeof(NLA_U8) * CHBA_NTF_ATTR_ASSOC_PRIV_IE_LEN },
};

const struct nla_policy wal_chba_cancel_conn_ntf_attr_policy[MAC_CHBA_CANCEL_CONN_NTF_ATTR_MAX + 1] = {
    [MAC_CHBA_CANCEL_CONN_NTF_ATTR_ID] = { .type = NLA_U8 },
    [MAC_CHBA_CANCEL_CONN_NTF_ATTR_MAC_ADDR] = { .type = NLA_BINARY,
        .len = sizeof(NLA_U8) * WLAN_MAC_ADDR_LEN },
};
#endif
#endif
