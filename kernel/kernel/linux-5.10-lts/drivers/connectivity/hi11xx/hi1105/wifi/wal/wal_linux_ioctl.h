...
typedef struct {
    ...
    uint32_t tx_failed;
    uint32_t rx_packets;
    uint32_t tx_unicast_bytes;
    uint32_t rx_unicast_bytes;
    uint32_t tx_mcast_bytes;
    uint32_t rx_mcast_bytes;
    uint32_t reserved10[MAX_MCS_CNT];
    uint32_t reserved11[MAX_MCS_CNT];
    uint32_t reserved12;
    uint32_t reserved44;
    uint32_t reserved13;
    uint32_t reserved14;
...
typedef struct {
    uint32_t data_len;                 /* input: how many sta get */
    uint32_t sta_cnt;                  /* output: how many sta get */
    uint32_t channel;                  /* output: channel */
#if defined(CONFIG_COMPAT) && defined(_PRE_HISI_HERTZ)
    compat_uptr_t data;               /* output */
#else
    uint32_t data;               /* output */
#endif
} wal_sta_status_diag_req_stru_compat;

typedef struct {
    uint32_t data_len;                 /* input: how many sta get */
    uint32_t sta_cnt;                  /* output: how many sta get */
    uint32_t channel;                  /* output: channel */
    hmac_user_info_stru *data;        /* output */
} wal_sta_status_diag_req_stru;
...
extern const uint8_t g_set_str_table_size;
...
uint32_t wal_hipriv_set_rate(oal_net_device_stru *net_dev, int8_t *param);
uint32_t wal_hipriv_set_mcs(oal_net_device_stru *net_dev, int8_t *param);
uint32_t wal_hipriv_set_mcsac(oal_net_device_stru *net_dev, int8_t *param);
#ifdef _PRE_WLAN_FEATURE_11AX
uint32_t wal_hipriv_set_mcsax(oal_net_device_stru *net_dev, int8_t *param);
...
uint32_t _wal_hipriv_set_mcsax_er(oal_net_device_stru *net_dev, int8_t *param);
    ...
    uint32_t wal_hipriv_set_mcsbe(oal_net_device_stru *net_dev, int8_t *param);
#endif
uint32_t wal_hipriv_vap_info(oal_net_device_stru *net_dev, int8_t *param);
...
uint32_t wal_hipriv_del_vap(oal_net_device_stru *net_dev, int8_t *param);
uint32_t wal_hipriv_remove_proc(void);
uint32_t wal_alloc_cfg_event(oal_net_device_stru *net_dev, frw_event_mem_stru **event_mem,
                             const void *resp_addr, wal_msg_stru **cfg_msg, uint16_t len_input);
int32_t wal_send_cfg_event(oal_net_device_stru *net_dev, uint8_t msg_type, uint16_t us_len, uint8_t *puc_param,
    oal_bool_enum_uint8 en_need_rsp, wal_msg_stru **response);
uint32_t wal_hipriv_process_rate_params(oal_net_device_stru *net_dev, int8_t *ac_arg, uint32_t arg_len,
...
uint32_t wal_init_chba_netdev(oal_wiphy_stru *wiphy, const char *dev_name);
...
int32_t wal_netdev_down_vap(oal_net_device_stru *net_dev);
...
int32_t wal_regdomain_update_country_code(oal_net_device_stru *net_dev, int8_t *country);
#ifdef _PRE_WLAN_COUNTRYCODE_SELFSTUDY
int32_t wal_regdomain_update_selfstudy_country_code(oal_net_device_stru *net_dev, int8_t *country);
...
#endif
uint8_t wal_hipriv_m2s_switch_get_mcm_chain(uint16_t param_input);
...
int32_t wal_ioctl_get_psm_stat(oal_net_device_stru *net_dev, mac_psm_query_type_enum_uint8 en_query_type,
    wal_wifi_priv_cmd_stru *priv_cmd);
...
uint32_t wal_hipriv_setcountry(oal_net_device_stru *net_dev, int8_t *param);
uint32_t wal_ioctl_set_sta_ps_mode(oal_net_device_stru *cfg_net_dev, int8_t ps_mode);
...
uint32_t wal_hipriv_set_rfch(oal_net_device_stru *net_dev, int8_t *param);
uint32_t wal_hipriv_set_rxch(oal_net_device_stru *net_dev, int8_t *pc_param);
uint32_t wal_hipriv_set_nss(oal_net_device_stru *net_dev, int8_t *param);
...
uint32_t wal_hipriv_set_txpower(oal_net_device_stru *net_dev, int8_t *param);
...
#endif
#ifdef _PRE_WLAN_FEATURE_11D
int32_t wal_regdomain_update_for_dfs(oal_net_device_stru *net_dev, int8_t *country);
int32_t wal_regdomain_update(oal_net_device_stru *net_dev, int8_t *country);
#endif
...
uint32_t wal_hipriv_set_atf_user(oal_net_device_stru *net_dev, int8_t *pc_param);
#endif
oal_bool_enum_uint8 wal_remain_on_chan_param_check(oal_net_device_stru *net_dev, uint16_t center_freq);
int32_t wal_vendor_set_lp_long_dtim_handle(oal_net_device_stru *net_dev, wal_wifi_priv_cmd_stru *priv_cmd,
    int8_t *cmd);
#ifdef _PRE_WLAN_FEATURE_11AX
int32_t wal_vendor_set_omi_bw_switch_handle(oal_net_device_stru *net_dev, wal_wifi_priv_cmd_stru *priv_cmd,
    int8_t *cmd);
#endif
