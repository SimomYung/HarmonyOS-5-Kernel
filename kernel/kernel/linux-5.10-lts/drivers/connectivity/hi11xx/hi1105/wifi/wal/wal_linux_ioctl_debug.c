...
const wal_hipriv_cmd_entry_stru g_ast_hipriv_cmd_debug[] = {
    ...
    { "version", wal_hipriv_get_sw_version },
    ...
    { "hitalk_bg_listen", wal_hipriv_hitalk_bg_listen },
    ...
    */
    ...
    { "al_ru_index",          wal_hipriv_set_ru_index },
    /* 设置ru index: hipriv "vap0 al_ru_index 106tone[ru_size] 2[ru_index] 0[ru_region]" */
    { "al_phase_incr",        wal_hipriv_set_phase_incr },
    /* 设置phase_incr_en和phase_incr: hipriv "al_phase_incr <phase_incr_en> <phase_incr>" */
    { "al_rx",                wal_hipriv_always_rx },  /* 设置常收模式: hipriv "vap0 al_rx <value: 0/1/2/4>" */
    ...
    { "mcsbe", wal_hipriv_set_mcsbe },       /* 设置BE模式下的速率:  hipriv "vap0 mcsax <value>" */
#endif
    ...
    { "pkt_filter_list", wal_hipriv_pkt_filter_list },
#endif
    ...
    /* sh hipriv.sh "p2p0 rx_mgmt_remain_on_channel [center_freq] [band] [duration] [is_exclusive]" */
    { "rx_mgmt_remain_on_channel", wal_hipriv_rx_mgmt_remain_on_channel },
    /* sh hipriv.sh "p2p0 cancel_same_chan_remain_on_chan" */
    { "cancel_same_chan_remain_on_chan", wal_hipriv_cancel_same_chan_remain_on_chan },
#endif
    ...
    { "set_str_ml_tx_mode", wal_hipriv_set_str_ml_tx_mode }, /* ml_lut_id tid ml0dup ml1dup switchen */
    { "set_ml_assoc_mode", wal_hipriv_set_mld_assoc_mode },
    { "switch_mlsr_work_link", wal_hipriv_mlsr_work_link_switch },
    /* sh hipriv.sh "wlan0 remove_link <tbtt_num>" */
    { "remove_link", wal_hipriv_ml_reconfig_remove_link },
    /* sh hipriv.sh "wlan0 tx_reconfig_request <ap_link_id> <op_type>" */
    { "tx_reconfig_request", wal_hipriv_tx_action_ml_reconfig_request },
    /* sh hipriv.sh "wlan0 ttlm_request lkap_mac_addr token dir lkmp_pres_bitmp tid0-to-lk-btmp ... tid7-to-lk-btmp" */
    { "ttlm_request", wal_hipriv_mld_tx_ttlm_request },
    /* sh hipriv.sh "wlan0 ttlm_teardown lkap_mac_addr" */
    { "ttlm_teardown", wal_hipriv_mld_tx_ttlm_teardown },
#ifdef _PRE_WLAN_FEATURE_EMLSR
    { "emlsr_enable", wal_hipriv_emlsr_enable },
    { "set_emlsr_support", wal_hipriv_set_emlsr_cap },
    { "set_emlsr_link", wal_hipriv_cfg_emlsr_link },
    { "al_emlsr_enable", wal_hipriv_al_emlsr_enable },
    { "set_emlsr_dscr", wal_hipriv_cfg_emlsr_dscr },
#endif
#endif
#ifdef _PRE_WLAN_FEATURE_PF_SCH_USER
    { "set_atf_user", wal_hipriv_set_atf_user },
#endif
#ifdef _PRE_WLAN_FEATURE_WUR
    { "wur_debug", wal_hipriv_wur_debug_process },
#endif
#ifdef _PRE_WLAN_FEATURE_11AX
    /* sh hipriv.sh "wlan0 omi_bw_switch <0/1功能开关> <0/1/2/3 带宽>" */
    { "omi_bw_switch", wal_hipriv_omi_bw_switch_cfg},
#endif
};
