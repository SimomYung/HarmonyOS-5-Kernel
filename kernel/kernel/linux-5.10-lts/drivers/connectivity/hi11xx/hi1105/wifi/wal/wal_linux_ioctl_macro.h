...
#define WAL_HIPRIV_EHT_MCS_MIN   0
#define WAL_HIPRIV_EHT_MCS_MAX   15 /* eht协议新增MCS14/15 */
...
#define WAL_HIPRIV_ML_MODE_PARAM 5
...
typedef enum {
    WAL_CFG_MCS_TYPE_MCS,
    WAL_CFG_MCS_TYPE_MCSAC,
    WAL_CFG_MCS_TYPE_MCSAX,
#ifdef  _PRE_WLAN_FEATURE_11AX_ER_SU_DCM
    WAL_CFG_MCS_TYPE_MCSAX_ER,
#endif
    WAL_CFG_MCS_TYPE_MCSBE,
    WAL_CFG_MCS_TYPE_BUTT
} wal_cfg_mcs_type_enum;
