...
struct smartpakit_shutdown_ringtone {
	struct smartpakit_pa_ctl_sequence *shutdown_ringtone_seq;
	/* shutdown ringtone supply */
	struct regulator *regulator_supply;
	struct regulator *ldo_offd_supply;
};
...
struct smartpakit_i2c_priv {
	...
	/* enable virtual pa global addr regs */
	struct smartpakit_reg_ctl_sequence *enable_virtual_pa_regs_seq;
	...
	/* bgc regs */
	struct smartpakit_reg_ctl_sequence *bgc_normal_seq;
	struct smartpakit_reg_ctl_sequence *bgc_low_current_seq;
	unsigned int bgc_reg_mask;

	struct smartpakit_shutdown_ringtone *shutdown_ringtone;
};
...
struct smartpakit_i2c_ctl_ops {
	...
	int (*set_shutdown_ringtone)(struct smartpakit_i2c_priv *priv, bool isFactory);
};
...
enum smartpakit_param_node_type {
	...
	SMARTPAKIT_PARAM_NODE_TYPE_AW_CORRECT_V2,
...
struct smartpakit_priv {
	...
	struct smartpakit_pa_ctl_sequence resume_sequence_v2[SMARTPAKIT_PA_ID_MAX];
	bool initialized_pa_index[SMARTPAKIT_PA_ID_MAX];
