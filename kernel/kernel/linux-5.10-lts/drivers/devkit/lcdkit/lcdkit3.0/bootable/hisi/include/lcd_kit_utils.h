...
#define NEED_READ_GAMMA  2
#define GAMMA_CMD_INX  2
#define ADDR_NUM  12
#define RGB_SIZE_EXT  2
#define RGB_SIZE_NORMAL  16
#define RGB_SIZE  150
#endif
...
struct lcd_kit_aod {
	...
	/* normal aod dimming config */
	u32 anm_dim_support;
	struct lcd_kit_dsi_panel_cmds anm_dim_enter_cmds;
	struct lcd_kit_dsi_panel_cmds anm_dim_exit_cmds;
