...
struct lcd_color_aod_detect {
	...
	struct lcd_kit_dsi_panel_cmds exit_cmds;
	struct lcd_kit_dsi_panel_cmds at_test_1dot5_fps_cmds;
};
...
struct lcd_fact_ops {
	...
	ssize_t (*pmic_detect_show)(struct device *dev,
		struct device_attribute *attr, char *buf);
	ssize_t (*panel_part_refresh_show)(struct device *dev,
		struct device_attribute *attr, char *buf);
	ssize_t (*panel_part_refresh_store)(struct device *dev,
		struct device_attribute *attr, const char *buf, size_t count);
};
...
/* panel partition refresh */
struct lcd_kit_panel_part_refresh {
	u32 current_cmds_index;
	u32 set_cmds_index;
	struct lcd_kit_dsi_panel_cmds off_cmds;
	struct lcd_kit_dsi_panel_cmds on_cmds;
	struct lcd_kit_dsi_panel_cmds on_mmi_cmds;
	struct lcd_kit_dsi_panel_cmds on_top1_bot10_cmds;
	struct lcd_kit_dsi_panel_cmds on_top1_bot30_cmds;
	struct lcd_kit_dsi_panel_cmds on_top1_bot60_cmds;
	struct lcd_kit_dsi_panel_cmds on_top1_bot120_cmds;
	struct lcd_kit_dsi_panel_cmds full_screen_cmds;
	struct lcd_kit_dsi_panel_cmds top1_bot1_cmds;
	struct lcd_kit_dsi_panel_cmds top1_bot10_cmds;
	struct lcd_kit_dsi_panel_cmds top1_bot30_cmds;
	struct lcd_kit_dsi_panel_cmds top1_bot60_cmds;
	struct lcd_kit_dsi_panel_cmds top1_bot120_cmds;
	struct lcd_kit_dsi_panel_cmds top10_bot60_cmds;
	struct lcd_kit_dsi_panel_cmds top1_mid60_bot1_cmds;
	struct lcd_kit_dsi_panel_cmds top1_mid120_bot1_cmds;
};
...
struct lcd_fact_desc {
	...
	/* test delay config */
	struct lcd_test_delay_desc test_delay;
	...
	/* panel partition refresh */
	struct lcd_kit_panel_part_refresh ppr;
};
