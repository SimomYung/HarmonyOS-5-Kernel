...
struct lcd_kit_mipi {
	...
	int dsi1_index;
	int connector_id;
	struct mipi_dsi_rx_params dsi0_rx_params;
	struct mipi_dsi_tx_params dsi0_tx_params;
	struct mipi_dsi_rx_params dsi1_rx_params;
	struct mipi_dsi_tx_params dsi1_tx_params;
};
