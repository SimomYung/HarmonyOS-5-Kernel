...
static void lcd_kit_parse_panel_part_refresh(uint32_t panel_id,
	struct device_node *np)
{
	lcd_kit_parse_dcs_cmds(np, "lcd-kit,ppr-off-cmds",
		"lcd-kit,ppr-cmds-state", &FACT_INFO->ppr.off_cmds);
	lcd_kit_parse_dcs_cmds(np, "lcd-kit,ppr-on-cmds",
		"lcd-kit,ppr-cmds-state", &FACT_INFO->ppr.on_cmds);
	lcd_kit_parse_dcs_cmds(np, "lcd-kit,ppr-on-mmi-cmds",
		"lcd-kit,ppr-cmds-state", &FACT_INFO->ppr.on_mmi_cmds);
	lcd_kit_parse_dcs_cmds(np, "lcd-kit,ppr-on-top1-bot10-cmds",
		"lcd-kit,ppr-cmds-state", &FACT_INFO->ppr.on_top1_bot10_cmds);
	lcd_kit_parse_dcs_cmds(np, "lcd-kit,ppr-on-top1-bot30-cmds",
		"lcd-kit,ppr-cmds-state", &FACT_INFO->ppr.on_top1_bot30_cmds);
	lcd_kit_parse_dcs_cmds(np, "lcd-kit,ppr-on-top1-bot60-cmds",
		"lcd-kit,ppr-cmds-state", &FACT_INFO->ppr.on_top1_bot60_cmds);
	lcd_kit_parse_dcs_cmds(np, "lcd-kit,ppr-on-top1-bot120-cmds",
		"lcd-kit,ppr-cmds-state", &FACT_INFO->ppr.on_top1_bot120_cmds);
	lcd_kit_parse_dcs_cmds(np, "lcd-kit,ppr-full-screen-cmds",
		"lcd-kit,ppr-cmds-state", &FACT_INFO->ppr.full_screen_cmds);
	lcd_kit_parse_dcs_cmds(np, "lcd-kit,ppr-top1-bot1-cmds",
		"lcd-kit,ppr-cmds-state", &FACT_INFO->ppr.top1_bot1_cmds);
	lcd_kit_parse_dcs_cmds(np, "lcd-kit,ppr-top1-bot10-cmds",
		"lcd-kit,ppr-cmds-state", &FACT_INFO->ppr.top1_bot10_cmds);
	lcd_kit_parse_dcs_cmds(np, "lcd-kit,ppr-top1-bot30-cmds",
		"lcd-kit,ppr-cmds-state", &FACT_INFO->ppr.top1_bot30_cmds);
	lcd_kit_parse_dcs_cmds(np, "lcd-kit,ppr-top1-bot60-cmds",
		"lcd-kit,ppr-cmds-state", &FACT_INFO->ppr.top1_bot60_cmds);
	lcd_kit_parse_dcs_cmds(np, "lcd-kit,ppr-top1-bot120-cmds",
		"lcd-kit,ppr-cmds-state", &FACT_INFO->ppr.top1_bot120_cmds);
	lcd_kit_parse_dcs_cmds(np, "lcd-kit,ppr-top10-bot60-cmds",
		"lcd-kit,ppr-cmds-state", &FACT_INFO->ppr.top10_bot60_cmds);
	lcd_kit_parse_dcs_cmds(np, "lcd-kit,ppr-top1-mid60-bot1-cmds",
		"lcd-kit,ppr-cmds-state", &FACT_INFO->ppr.top1_mid60_bot1_cmds);
	lcd_kit_parse_dcs_cmds(np, "lcd-kit,ppr-top1-mid120-bot1-cmds",
		"lcd-kit,ppr-cmds-state", &FACT_INFO->ppr.top1_mid120_bot1_cmds);
}
...
static void lcd_kit_parse_factory_dts(int panel_id, struct device_node *np)
{
	...
	/* panel partition refresh parse */
	lcd_kit_parse_panel_part_refresh(panel_id, np);
}
