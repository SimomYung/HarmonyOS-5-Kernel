...
/* max async dss cmds num */
#define ASYNC_CMDS_MAX 32
...
struct fps_dual_cmd_table {
	int val;
	struct lcd_kit_dsi_panel_cmds *cmds;
	struct lcd_kit_dsi_panel_cmds *part_cmds;
};
...
void lcd_kit_set_bl_cmds(int panel_id, int bl_level,
	struct lcd_kit_dsi_panel_cmds *bl_panel_cmd);
