...
#endif
#ifdef CONFIG_CONTEXTHUB_IO_DIE_PCIE
#include <smart/drivers/io_die/iodie_pcie.h>
#endif
...
#include "power_adapter/huawei_power_platform_resource.h"

#include "huawei_thp_thread.h"
...
/* This "_compat"  is used for compatling 32bit */
...
#define ONE_PACKET_FRAME_SIZE 1024
#define FRAME_HEAD_DATA_LEN 16
...
#define THP_NEED_FOLD_AFT 1
#define THP_NO_NEED_FOLD_AFT 0
...
enum thp_sub_event_type {
	...
	THP_SUB_EVENT_SLIDE_B2T = 7,
	THP_SUB_EVENT_SINGLE_CLICK_UNLOCK = 8,
};
...
struct thp_device_ops {
	...
	int (*spi_transfer)(struct thp_device *tdev, const char *tx_buf, char *rx_buf, unsigned int len);
	...
	int (*second_poweroff)(struct thp_device *tdev);
#if (defined(CONFIG_HUAWEI_THP_MTK) || defined(CONFIG_HUAWEI_THP_QCOM))
...
struct thp_timing_config {
	...
	struct thp_poweron_timing poweron_timing;
...
struct thp_core_data {
	...
	struct mutex daemon_init_mutex;
	...
	u32 shb_slide_b2t_support;
	u32 shb_single_click_unlock_support;
...
#endif
	u32 not_support_cover_mode;
	u32 support_extra_key_event_input;
	u32 support_hand_status_dev;
	...
	/* This flag is used for compatling 32bit */
	bool compat_flag;
	...
	u32 support_quick_fold_unfold;
	u32 support_ic_recovery;
	u32 tp_recovery_count;
...
#endif
	struct thp_power_adapter *power_adapter;
	u32 product_frame_packet_num;
    struct thp_bus_adapter *bus_adapter;
	u32 support_quick_note;
	u32 quick_note;
};
...
extern u8 is_fw_update;
extern int spi_sync_count_in_suspend;
...
void revert_screen_status(void);
