...
void thp_parse_power_on_extra_config(struct device_node *thp_node, struct thp_timing_config *timing)
{
	timing->poweron_timing.need_control_cs_before_poweron = tp_parse_property_u32(thp_node,
		"need_control_cs_before_poweron");
	timing->poweron_timing.need_control_cs_after_poweron = tp_parse_property_u32(thp_node,
		"need_control_cs_after_poweron");
	timing->poweron_timing.need_control_cs_after_rst = tp_parse_property_u32(thp_node, "need_control_cs_after_rst");
	timing->poweron_timing.delay_after_rst_pull_up = tp_parse_property_u32(thp_node, "delay_after_rst_pull_up");
}

void thp_parse_power_off_extra_config(struct device_node *thp_node, struct thp_timing_config *timing)
{
	timing->poweroff_timing.need_control_cs_before_poweroff = tp_parse_property_u32(thp_node,
		"need_control_cs_before_poweroff");
	timing->poweroff_timing.need_control_cs_after_poweroff = tp_parse_property_u32(thp_node,
		"need_control_cs_after_poweroff");
	timing->poweroff_timing.delay_before_rst_pull_down = tp_parse_property_u32(thp_node, "delay_before_rst_pull_down");
	timing->poweroff_timing.delay_after_rst_pull_down = tp_parse_property_u32(thp_node, "delay_after_rst_pull_down");
}

int thp_parse_power_timing(struct device_node *thp_node, struct thp_timing_config *timing)
{
    ...
    thp_parse_power_on_extra_config(thp_node, timing);
    thp_parse_power_off_extra_config(thp_node, timing);
    return NO_ERR;
}
