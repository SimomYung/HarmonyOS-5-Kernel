...
struct thp_poweroff_timing {
	...
	u8 delay_before_rst_pull_down;
	u8 delay_after_rst_pull_down;
	u8 need_control_cs_before_poweroff;
	u8 need_control_cs_after_poweroff;
};
