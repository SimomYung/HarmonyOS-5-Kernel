...
int dubai_register_module_ops(enum dubai_module_t module, void *mops)
{
	...
	case DUBAI_MODULE_GPU:
		...
		break;
	case DUBAI_MODULE_NPU:
		ret = dubai_npu_register_ops(mops);
		break;
