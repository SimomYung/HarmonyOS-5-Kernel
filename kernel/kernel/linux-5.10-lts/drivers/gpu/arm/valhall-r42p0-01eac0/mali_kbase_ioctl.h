...
#define KBASE_IOCTL_AI_FENCE_GET \
	_IOW(KBASE_IOCTL_TYPE, 62, struct kbase_ioctl_ai_fence_info)

#define KBASE_IOCTL_AI_BUFFER_SIZE_GET \
	_IOW(KBASE_IOCTL_TYPE, 63, struct kbase_ioctl_ai_buffer_info)
...
/**
 * struct kbase_ioctl_para_ctx_sw - kbase context swaitch para 
 * @in: input parameters.
 * @in.cmd: The actual cmd like 0--cxt swaitch to front 1--cxt swaitch to backfround 2--init eswap sapce
 * @in.ratio:  reclaim ratio.
 * @in.tgid:       The process tgid.
 * @out: output parameters.
 * @out.background_pages: The number of swaitch to background pages
 *
 * return xx
 */
...
#define KBASE_IOCTL_CONTEXT_SWITCH                                         \
	_IOWR(KBASE_IOCTL_TYPE, 64, struct kbase_ioctl_para_ctx_sw)

/**
 * struct kbase_ioctl_para_get_ctx_pages - kbase get ctx pages 
 * @in: input parameters.
 * @in.tgid: The process tgid
 * @out: output parameters.
 * @out.ctx_pages: The tgid process's context can reclaim  
 *
 * return xx
 */
...
#define KBASE_IOCTL_GET_CTX_PAGES                                         \
	_IOWR(KBASE_IOCTL_TYPE, 65, union kbase_ioctl_para_get_ctx_pages)
#endif
/***************
 * test ioctls *
 ***************/
