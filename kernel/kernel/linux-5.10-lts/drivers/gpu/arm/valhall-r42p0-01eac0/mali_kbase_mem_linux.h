...
extern long kbase_reg_vma_zap_pte(struct kbase_context *ctx, struct kbase_va_region *reg,
				  unsigned long addr, unsigned long len);
#endif

#ifdef CONFIG_LIBLINUX
extern vm_fault_t kbase_mem_fault(struct vm_area_struct *vma, size_t map_start,
				  size_t map_end, struct tagged_addr *pages);
extern unsigned long kbase_unmapped_area(struct vm_unmapped_area_info *info);
