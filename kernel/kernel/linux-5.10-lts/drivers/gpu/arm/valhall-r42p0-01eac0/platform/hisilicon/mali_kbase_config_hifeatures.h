...
/* define features uesed by tODx */
static const enum kbase_hi_feature kbase_hi_feature_todx_r0p0[] = {
	KBASE_FEATURE_MMU_FAULT_FILTERING,
	KBASE_FEATURE_BUCKOFF_PER_FRAME,
	KBASE_FEATURE_STRIPING_GRANUL_SETTING,
	KBASE_FEATURE_MAX_COUNT
...
/* define features uesed by tVAx */
static const enum kbase_hi_feature kbase_hi_feature_tvax_r0p0[] = {
	KBASE_FEATURE_MMU_FAULT_FILTERING,
	KBASE_FEATURE_BUCKOFF_PER_FRAME,
	KBASE_FEATURE_STRIPING_GRANUL_SETTING,
	KBASE_FEATURE_MAX_COUNT
