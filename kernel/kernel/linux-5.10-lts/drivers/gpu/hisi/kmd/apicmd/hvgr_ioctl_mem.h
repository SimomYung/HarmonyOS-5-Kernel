...
#define HVGR_IOCTL_CMD_IMPROT_MEM       (2u)
#define HVGR_IOCTL_CMD_SYNC_MEM         (3u)
#define HVGR_IOCTL_CMD_QUERY_MEM        (4u)
#define HVGR_IOCTL_CMD_RESIZE_MEM       (5u)
#define HVGR_IOCTL_CMD_GET_FD_SIZE_MEM  (6u)
#define HVGR_IOCTL_CMD_ALIAS_MEM        (7u)
#define HVGR_IOCTL_CMD_ADD_PROFILE_MEM  (8u)
#define HVGR_IOCTL_CMD_UVA_OFFSET_MEM   (9u)
#define HVGR_IOCTL_CMD_SPARSE_BIND_MEM  (10u)
#define HVGR_IOCTL_CMD_SPARSE_UNBIND_MEM (11u)
#define HVGR_IOCTL_CMD_CHANGE_ATTR_MEM   (12u)
#define HVGR_IOCTL_CMD_CHANGE_PGID_ATTR  (13u)
#define HVGR_IOCTL_CMD_QUERY_RSV         (14u)
...
#define HVGR_MEM_ATTR_LESS_BANDWIDTH ((u64)1 << 15)

#define HVGR_MEM_ATTR_DUMP_LEVEL_MASK   ((u64)0xF << 16)
#define hvgr_mem_get_dump_level(x)      (((x) & HVGR_MEM_ATTR_DUMP_LEVEL_MASK) >> 16)
#define hvgr_mem_set_dump_level(x)      (((u64)(x) & 0xF) << 16)

#define HVGR_MEM_ATTR_CAPTURE_REPLAY_FLAG   ((u64)1 << 22)
...
#define HVGR_MEM_SAMEVA_TOP_LIMIT       ((u64)0x70DFFFF000) /* HVGR_MEM_SAMEVA_TOP */
#define HVGR_MEM_4G_RSV_OFFSET          ((u64)3U << 12)

#define HVGR_RSV_QUREY_ADD              0x1
#define HVGR_RSV_QUREY_SUB              0x2
...
#define HVGR_IOCTL_QUERY_RSV \
	_IOWR(HVGR_IOCTL_MODULE_MEM, HVGR_IOCTL_CMD_QUERY_RSV, hvgr_ioctl_para_rsv)
