...
#define HVGR_IOCTL_CMD_POLL_TIMEOUT       (HVGR_IOCTL_SCH_SUB_MODULE_SCHED + 10)
...
typedef struct {
	uint32_t timeout_is_normal;
} hvgr_ioctl_para_poll_timeout;

#define HVGR_IOCTL_POLL_TIMEOUT \
	_IOR(HVGR_IOCTL_MODULE_SCH, HVGR_IOCTL_CMD_POLL_TIMEOUT, hvgr_ioctl_para_poll_timeout)
#endif
