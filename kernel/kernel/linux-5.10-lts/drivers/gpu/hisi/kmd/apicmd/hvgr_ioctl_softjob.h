...
#define HVGR_IOCTL_CMD_HTS_CLEAR_EVENT    (HVGR_IOCTL_SCH_SUB_MODULE_SOFTJOB + 16)
...
union hvgr_ioctl_para_hts_clear_event {
	struct {
		uint32_t event_id;
	} in;
};

#define HVGR_IOCTL_HTS_CLEAR_EVENT \
	_IOW(HVGR_IOCTL_MODULE_SCH, HVGR_IOCTL_CMD_HTS_CLEAR_EVENT, union hvgr_ioctl_para_hts_clear_event)
