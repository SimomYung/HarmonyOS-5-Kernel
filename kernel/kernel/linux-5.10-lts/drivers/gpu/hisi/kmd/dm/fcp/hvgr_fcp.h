...
#define FCP_RISCV_TV211_FIRMWARE_NAME     "jmcp_riscv_cf_tv211.bin"
#define FCP_RISCV_TV350_FIRMWARE_NAME     "jmcp_riscv_cf_tv350.bin"
#define FCP_RISCV_TV500_FIRMWARE_NAME     "jmcp_riscv_cf_tv500.bin"
#define FCP_RISCV_TV520_FIRMWARE_NAME     "jmcp_riscv_cf_tv520.bin"
#define FCP_RISCV_TV600_FIRMWARE_NAME     "jmcp_riscv_cf_tv600.bin"

/* the max size of firmware bin */
#if hvgr_version_ge(500)
#define FCP_MAX_SIZE_FIRMWARE      (32 * 1024U)
...
#define FCP_ITCM_SIZE (20 * 1024U)
#define FCP_DTCM_SIZE (16 * 1024U)
/* we need to allocate one more page to store firmware head */
#define FCP_SIZE_IN_PAGE (((FCP_ITCM_SIZE + FCP_DTCM_SIZE) >> 12) + 1)
#define FCP_MEM_SIZE  (FCP_SIZE_IN_PAGE << 12)
#else
...
#if hvgr_version_ge(500)
irqreturn_t hvgr_fcp_irq_handler(int irq, void *data);
#endif
