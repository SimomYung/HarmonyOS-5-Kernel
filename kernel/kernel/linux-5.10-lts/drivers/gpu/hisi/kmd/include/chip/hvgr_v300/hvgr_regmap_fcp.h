...
#define FCP_INT_MASK                      0x0u
#define FCP_INT_UNMASK                    0xFFFFFFFFu
...
#define fcp_reg_base(p) ((uint64_t)((p)->dm_dev.dev_reg.reg_base[2]) - HVGR_REG_BASE2_LEN + \
	((p)->dm_dev.reg_base.fcp_base.fcp_reg_base))
