...
/*
 * hvgr_platform_smmu_bypass - smu bypass process.
 *
 * @param gdev: hvgr pointer.
 */
uint64_t hvgr_platform_smmu_bypass(struct hvgr_device *gdev);

/*
 * hvgr_platform_sec_cfg - set sec config process.
 *
 * @param gdev: hvgr pointer.
 */
uint64_t hvgr_platform_sec_cfg(struct hvgr_device *gdev);
...
/*
 * hvgr_sc_config_remap_register - GPU sc remap process.
 *
 * @param gdev: hvgr pointer.
 */
...
#if defined(CONFIG_HVGR_DFX_SH) || defined(CONFIG_HVGR_VIRTUAL_HOST)
/*
...
/*
 * hvgr_platform_get_sch_unbind_timeout - get unbind out time
 *
 * @param void.
 *
 */
...
/*
 * hvgr_platform_get_sch_cl_unbind_time - get cl unbind out time
 *
 * @param void.
 *
 */
...
/*
 * hvgr_platform_get_sch_fence_timeout - get fence out time
 *
 * @param void.
 *
 */
...
/*
 * hvgr_platform_set_ffap1_drain_th - fix fault unbind bug
 *
 * @param gdev: hvgr pointer.
 *
 */
void hvgr_platform_set_ffap1_drain_th(struct hvgr_device *gdev);

/*
 * hvgr_platform_need_clock_gating - whether config clock gating
 *
 * @param gdev: void
 *
 */
bool hvgr_platform_need_clock_gating(void);

/*
 * hvgr_platform_cbit_constraint_config - config cbit constraint
 *
 * @param gdev: hvgr pointer.
 *
 */
void hvgr_platform_cbit_constraint_config(struct hvgr_device *gdev);

/*
 * hvgr_platform_support_ebit - whether support ebit
 *
 * @param gdev: void
 *
 */
bool hvgr_platform_support_ebit(void);

/*
 * hvgr_platform_need_poweroff_bl - whether pwroff bl
 *
 * @param gdev: void
 *
 */
bool hvgr_platform_need_poweroff_bl(void);
