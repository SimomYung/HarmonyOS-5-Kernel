...
struct hvgr_pool {
	bool inited;
	uint32_t cur_size; /* page num now in pool */
	uint32_t max_size; /* page num can in pool */
	uint32_t water; /* page num always in pool */
	uint32_t threshold; /* page num trigger grow_work */
	uint32_t target_size; /* disposable page num set by user, maybe bigger than max_size */
