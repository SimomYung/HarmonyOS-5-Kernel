 ...
 *
 */
long hvgr_msync_init(struct hvgr_ctx * const ctx);
...
/**
 * hvgr_hts_sch_schedule - Trigger a task scheduling.
 *
 * @gdev: Device pointer
 * @cq_ctx: Queue pointer
 * @type: shedule type, For details, see enum sch_type.
 *
 */
void hvgr_hts_sch_schedule(struct hvgr_device * const gdev, struct hvgr_cq_ctx *cq_ctx,
	enum sch_type type);
