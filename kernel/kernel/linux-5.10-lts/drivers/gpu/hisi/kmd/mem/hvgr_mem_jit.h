...
void hvgr_mem_jit_pool_init(struct hvgr_ctx * const ctx);

void hvgr_mem_jit_pool_term(struct hvgr_ctx * const ctx);

void hvgr_mem_jit_using_to_pool(struct hvgr_ctx *ctx);
