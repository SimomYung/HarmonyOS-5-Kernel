...
#define CORE_MASK_MODE (S_IRUGO | S_IWUSR | S_IWGRP)
#elif defined(CONFIG_HVGR_VIRTUAL)
#define CORE_MASK_MODE (S_IRUGO)
#else
#define CORE_MASK_MODE (S_IRUGO | S_IWUSR)
#endif
...
ssize_t hvgr_pm_set_available_cores(struct hvgr_device *gdev, uint32_t core_mask);
