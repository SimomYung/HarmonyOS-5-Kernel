...
#define hwlog_info(fmt, args...) pr_info("[mcu_hc32l110_i2c]" fmt, ##args)
#define hwlog_err(fmt, args...) pr_err("[mcu_hc32l110_i2c]" fmt, ##args)
...
int mcu_hc32l110_write_byte(struct mcu_hc32l110_device_info *di, u8 reg, u8 value)
{
	...
	hwlog_info("mcu_hc32l110 write reg: 0x%02x, val: %02x\n", reg, value);
...
int mcu_hc32l110_write_rtc_time(struct mcu_hc32l110_device_info *di, struct rtc_time *tm)
{
	int ret;
	int idx = 0;
	u8 rtc_time[MCU_HC32L110_RTC_TIME_LEN] = {0};
	...
	ret = mcu_hc32l110_write_block(di, MCU_HC32L110_TIME_SEC, rtc_time, MCU_HC32L110_RTC_TIME_LEN);
	if (ret) {
...
int mcu_hc32l110_read_rtc_time(struct mcu_hc32l110_device_info *di, struct rtc_time *tm)
{
	...
	ret = mcu_hc32l110_read_block(di, MCU_HC32L110_TIME_SEC, rtc_time, MCU_HC32L110_RTC_TIME_LEN);
	if (ret) {
