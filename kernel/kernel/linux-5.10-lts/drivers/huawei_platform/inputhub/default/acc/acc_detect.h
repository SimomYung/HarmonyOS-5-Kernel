...
#define SC7U22_POWER_DOWN_ERASE_REG		0x7F
#define SC7U22_CHIP_ELECT_DEFAULT 	 	0x00
#define SC7U22_PAGE_SWITCH_VALUE		0x8E
#define SC7U22_SPI_BIAS					0x80
#define SC7U22_SPI_BUF_LEN				2
...
int acc_sensor_pre_detect(struct device_node *dn,struct sensor_detect_manager *sm, int index);
#endif
