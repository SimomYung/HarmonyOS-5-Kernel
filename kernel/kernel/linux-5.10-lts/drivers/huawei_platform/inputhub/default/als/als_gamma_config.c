...
#define NUM_II					2
#define NUM_III					3
#define BITS_16_MASK			0xffff
#define GAMMA_CALI_START		30
#define GAMMA_1_7_LOW_TH		110
#define GAMMA_1_7_HIGH_TH		150
...
typedef struct threshold_map {
	uint8_t phone_type;
	lcd_type_t lcd_type;
	uint8_t tag;
	als_threshold_t thresholds[ALS_THRESHOLD_SIZE];
} threshold_map_t;

unsigned char g_als_manual_gamma[GAMMA_TYPE_NUM] = {0};
...
gamma_map_t g_gamma_map[] = {
	{TAG_ALS, PRODUCT_ALT_B, LCD_BOE, UNKNOWN_DDIC, DEFAULT_LCD_VER, 0, 4095, g_gamma_1_6, g_gamma_1_6, g_gamma_2_2},
	{TAG_ALS, PRODUCT_ALT_B, LCD_VISIONOX, UNKNOWN_DDIC, DEFAULT_LCD_VER, 0, 4095, g_gamma_1_9, g_gamma_1_3, g_gamma_2_4},
	{TAG_ALS1, PRODUCT_ALT_B, LCD_BOE, UNKNOWN_DDIC, DEFAULT_LCD_VER, 0, 4095, g_gamma_1_7, g_gamma_1_7, g_gamma_2_2},
	{TAG_ALS1, PRODUCT_ALT_B, LCD_VISIONOX, UNKNOWN_DDIC, DEFAULT_LCD_VER, 0, 4095, g_gamma_1_9, g_gamma_1_3, g_gamma_2_2},
	{TAG_ALS, PRODUCT_BARRY, LCD_BOE, UNKNOWN_DDIC, DEFAULT_LCD_VER, 0, 4095, g_gamma_2_1, g_gamma_1_9, g_gamma_2_4},
	{TAG_ALS, PRODUCT_BARRY, LCD_VISIONOX, UNKNOWN_DDIC, DEFAULT_LCD_VER, 0, 4095, g_gamma_1_9, g_gamma_2_0, g_gamma_2_4},
	{TAG_ALS, PRODUCT_ALLEN, LCD_BOE, UNKNOWN_DDIC, DEFAULT_LCD_VER, 0, 4095, g_gamma_2_1, g_gamma_1_8, g_gamma_1_9},
	{TAG_ALS, PRODUCT_ALLEN, LCD_VISIONOX, UNKNOWN_DDIC, DEFAULT_LCD_VER, 0, 4095, g_gamma_2_2, g_gamma_2_1, g_gamma_2_2},
	{TAG_ALS, PRODUCT_BLAKE, LCD_VISIONOX, UNKNOWN_DDIC, DEFAULT_LCD_VER, 0, 4095, g_gamma_2_0, g_gamma_2_1, g_gamma_2_2},
	{TAG_ALS, PRODUCT_BLAKE, LCD_BOE, UNKNOWN_DDIC, DEFAULT_LCD_VER, 0, 4095, g_gamma_2_3, g_gamma_1_8, g_gamma_2_0},
	{TAG_ALS, PRODUCT_BLAKE, LCD_HUAXING, UNKNOWN_DDIC, DEFAULT_LCD_VER, 0, 4095, g_gamma_1_8, g_gamma_2_1, g_gamma_2_4},
	{TAG_ALS, PRODUCT_ADELA, LCD_BOE, UNKNOWN_DDIC, DEFAULT_LCD_VER, 0, 4095, g_gamma_2_4, g_gamma_2_4, g_gamma_2_4},
	{TAG_ALS, PRODUCT_ADELA, LCD_HUAXING, UNKNOWN_DDIC, DEFAULT_LCD_VER, 0, 4095, g_gamma_1_4, g_gamma_2_0, g_gamma_2_2},
	{TAG_ALS, PRODUCT_LEM, LCD_BOE, UNKNOWN_DDIC, DEFAULT_LCD_VER, 0, 4095, g_gamma_2_0, g_gamma_1_8, g_gamma_2_2},
	{TAG_ALS, PRODUCT_LEM, LCD_VISIONOX, UNKNOWN_DDIC, DEFAULT_LCD_VER, 0, 4095, g_gamma_2_3, g_gamma_2_4, g_gamma_2_2},
	{TAG_ALS, PRODUCT_LEM, LCD_BOE2, UNKNOWN_DDIC, DEFAULT_LCD_VER, 0, 4095, g_gamma_2_1, g_gamma_2_0, g_gamma_1_9},
	{TAG_ALS, PRODUCT_ADY, LCD_BOE, UNKNOWN_DDIC, DEFAULT_LCD_VER, 800, 4095, g_gamma_2_2, g_gamma_2_2, g_gamma_2_2},
	{TAG_ALS, PRODUCT_ADY, LCD_BOE, UNKNOWN_DDIC, DEFAULT_LCD_VER, 0, 800, g_gamma_2_1, g_gamma_1_5_std, g_gamma_2_2},
	{TAG_ALS, PRODUCT_ADY, LCD_BOE2, UNKNOWN_DDIC, DEFAULT_LCD_VER, 1500, 4095, g_gamma_1_9, g_gamma_1_6, g_gamma_2_0},
	{TAG_ALS, PRODUCT_ADY, LCD_BOE2, UNKNOWN_DDIC, DEFAULT_LCD_VER, 600, 1500, g_gamma_1_8, g_gamma_1_4, g_gamma_2_0},
	{TAG_ALS, PRODUCT_ADY, LCD_BOE2, UNKNOWN_DDIC, DEFAULT_LCD_VER, 0, 600, g_gamma_1_7, g_gamma_1_3, g_gamma_2_0},
	{TAG_ALS, PRODUCT_HBN, LCD_BOE, UNKNOWN_DDIC, DEFAULT_LCD_VER, 600, 4095, g_gamma_2_4, g_gamma_2_2, g_gamma_2_4},
	{TAG_ALS, PRODUCT_HBN, LCD_BOE, UNKNOWN_DDIC, DEFAULT_LCD_VER, 0, 600, g_gamma_2_4, g_gamma_1_5_std, g_gamma_2_4},
	{TAG_ALS, PRODUCT_HBN, LCD_VISIONOX, UNKNOWN_DDIC, DEFAULT_LCD_VER, 500, 4095, g_gamma_2_1, g_gamma_2_0, g_gamma_2_2},
	{TAG_ALS, PRODUCT_HBN, LCD_VISIONOX, UNKNOWN_DDIC, DEFAULT_LCD_VER, 0, 500, g_gamma_1_8, g_gamma_1_6, g_gamma_2_4},

	{TAG_ALS, PRODUCT_ADL, LCD_BOE, UNKNOWN_DDIC, DEFAULT_LCD_VER, 0, 4095, g_gamma_2_4, g_gamma_2_4, g_gamma_2_4},
	{TAG_ALS, PRODUCT_ADL, LCD_HUAXING, UNKNOWN_DDIC, DEFAULT_LCD_VER, 0, 4095, g_gamma_1_4, g_gamma_2_0, g_gamma_2_2},

	{TAG_ALS, PRODUCT_GRL, LCD_BOE, UNKNOWN_DDIC, DEFAULT_LCD_VER, 0, 1000, g_gamma_2_0, g_gamma_2_0, g_gamma_2_1},
	{TAG_ALS, PRODUCT_GRL, LCD_BOE, UNKNOWN_DDIC, DEFAULT_LCD_VER, 1000, 4095, g_gamma_2_3, g_gamma_2_2, g_gamma_2_2},

	{TAG_ALS1, PRODUCT_GRL, LCD_BOE, UNKNOWN_DDIC, DEFAULT_LCD_VER, 0, 1000, g_gamma_2_0, g_gamma_2_0, g_gamma_2_1},
	{TAG_ALS1, PRODUCT_GRL, LCD_BOE, UNKNOWN_DDIC, DEFAULT_LCD_VER, 1000, 4095, g_gamma_2_3, g_gamma_2_2, g_gamma_2_2},

	{TAG_ALS, PRODUCT_PSD, LCD_BOE2, UNKNOWN_DDIC, DEFAULT_LCD_VER, 0, 4095, g_gamma_2_3, g_gamma_2_1, g_gamma_2_2},
	{TAG_ALS, PRODUCT_PSD, LCD_VISIONOX, UNKNOWN_DDIC, DEFAULT_LCD_VER, 0, 4095, g_gamma_2_2, g_gamma_2_2, g_gamma_2_2},
	{TAG_ALS, PRODUCT_PSD, LCD_HUAXING, UNKNOWN_DDIC, DEFAULT_LCD_VER, 0, 4095, g_gamma_2_0, g_gamma_2_0, g_gamma_2_0},

	{TAG_ALS, PRODUCT_CLS, LCD_BOE, DDIC_HISI05, DEFAULT_LCD_VER, 0, 4095, g_gamma_2_0, g_gamma_1_8, g_gamma_2_2},
	{TAG_ALS, PRODUCT_CLS, LCD_BOE, UNKNOWN_DDIC, DEFAULT_LCD_VER, 0, 1200, g_gamma_1_2, g_gamma_1_2, g_gamma_2_0},
	{TAG_ALS, PRODUCT_CLS, LCD_BOE, UNKNOWN_DDIC, DEFAULT_LCD_VER, 1200, 4095, g_gamma_1_8, g_gamma_1_9, g_gamma_2_2},
	{TAG_ALS, PRODUCT_CLS, LCD_VISIONOX, UNKNOWN_DDIC, DEFAULT_LCD_VER, 0, 4095, g_gamma_2_1, g_gamma_2_1, g_gamma_2_1},

	{TAG_ALS, PRODUCT_PLR, LCD_VISIONOX, DDIC_RUIDING, DEFAULT_LCD_VER, 0, 4095, g_gamma_1_7, g_gamma_1_7, g_gamma_2_0},
	{TAG_ALS, PRODUCT_PLR, LCD_VISIONOX, DDIC_HISI, DEFAULT_LCD_VER, 0, 4095, g_gamma_2_2, g_gamma_2_2, g_gamma_2_3},
	{TAG_ALS, PRODUCT_PLR, LCD_BOE, UNKNOWN_DDIC, DEFAULT_LCD_VER, 0, 400, g_gamma_1_2, g_gamma_1_2, g_gamma_1_2},
	{TAG_ALS, PRODUCT_PLR, LCD_BOE, UNKNOWN_DDIC, DEFAULT_LCD_VER, 400, 1000, g_gamma_1_6, g_gamma_1_4, g_gamma_2_1},
	{TAG_ALS, PRODUCT_PLR, LCD_BOE, UNKNOWN_DDIC, DEFAULT_LCD_VER, 1000, 1500, g_gamma_1_8, g_gamma_1_7, g_gamma_2_2},
	{TAG_ALS, PRODUCT_PLR, LCD_BOE, UNKNOWN_DDIC, DEFAULT_LCD_VER, 1500, 4095, g_gamma_1_9, g_gamma_1_8, g_gamma_2_2},
	{TAG_ALS, PRODUCT_PLR, LCD_TIANMA, UNKNOWN_DDIC, DEFAULT_LCD_VER, 0, 4095, g_gamma_1_8, g_gamma_2_3, g_gamma_2_2},

	{TAG_ALS, PRODUCT_PLA, LCD_VISIONOX, DDIC_RUIDING, DEFAULT_LCD_VER, 0, 4095, g_gamma_1_7, g_gamma_1_7, g_gamma_2_0},
	{TAG_ALS, PRODUCT_PLA, LCD_VISIONOX, DDIC_HISI, DEFAULT_LCD_VER, 0, 4095, g_gamma_2_2, g_gamma_2_2, g_gamma_2_3},
	{TAG_ALS, PRODUCT_PLA, LCD_BOE, UNKNOWN_DDIC, DEFAULT_LCD_VER, 0, 1000, g_gamma_1_6, g_gamma_1_4, g_gamma_2_1},
	{TAG_ALS, PRODUCT_PLA, LCD_BOE, UNKNOWN_DDIC, DEFAULT_LCD_VER, 1000, 1500, g_gamma_1_8, g_gamma_1_7, g_gamma_2_2},
	{TAG_ALS, PRODUCT_PLA, LCD_BOE, UNKNOWN_DDIC, DEFAULT_LCD_VER, 1500, 4095, g_gamma_1_9, g_gamma_1_8, g_gamma_2_2},
	{TAG_ALS, PRODUCT_PLA, LCD_BOE_418, UNKNOWN_DDIC, DEFAULT_LCD_VER, 0, 4095, g_gamma_2_1, g_gamma_2_1, g_gamma_2_1},
	{TAG_ALS, PRODUCT_PLA, LCD_TIANMA, UNKNOWN_DDIC, DEFAULT_LCD_VER, 0, 4095, g_gamma_1_8, g_gamma_2_3, g_gamma_2_2},

	{TAG_ALS, PRODUCT_BLS, LCD_VISIONOX, UNKNOWN_DDIC, VERSION_2SD, 0, 4095, g_gamma_1_9, g_gamma_1_8, g_gamma_2_2},
	{TAG_ALS, PRODUCT_BLS, LCD_VISIONOX, UNKNOWN_DDIC, DEFAULT_LCD_VER, 0, 4095, g_gamma_2_0, g_gamma_2_2, g_gamma_2_3},
	{TAG_ALS, PRODUCT_BLS, LCD_BOE, UNKNOWN_DDIC, DEFAULT_LCD_VER, 0, 4095, g_gamma_2_3, g_gamma_1_8, g_gamma_2_0},
	{TAG_ALS, PRODUCT_BLS, LCD_HUAXING, UNKNOWN_DDIC, DEFAULT_LCD_VER, 0, 4095, g_gamma_1_8, g_gamma_2_1, g_gamma_2_4},

	{TAG_ALS, PRODUCT_ICL, LCD_VISIONOX, UNKNOWN_DDIC, DEFAULT_LCD_VER, 0, 4095, g_gamma_2_2, g_gamma_2_3, g_gamma_2_2},
	{TAG_ALS, PRODUCT_ICL, LCD_BOE, UNKNOWN_DDIC, DEFAULT_LCD_VER, 0, 4095, g_gamma_1_4, g_gamma_1_4, g_gamma_2_0},
	{TAG_ALS1, PRODUCT_ICL, LCD_VISIONOX, UNKNOWN_DDIC, DEFAULT_LCD_VER, 0, 4095, g_gamma_2_2, g_gamma_2_0, g_gamma_2_1},
	{TAG_ALS1, PRODUCT_ICL, LCD_BOE, UNKNOWN_DDIC, DEFAULT_LCD_VER, 0, 4095, g_gamma_1_2, g_gamma_1_2, g_gamma_1_5},
	{TAG_ALS1, PRODUCT_ICL, LCD_BOE2, UNKNOWN_DDIC, DEFAULT_LCD_VER, 0, 4095, g_gamma_1_4, g_gamma_1_5, g_gamma_1_7},

	{TAG_ALS, PRODUCT_MIS, LCD_BOE, UNKNOWN_DDIC, DEFAULT_LCD_VER, 0, 4095, g_gamma_2_4, g_gamma_2_0, g_gamma_2_4},
	{TAG_ALS, PRODUCT_MIS, LCD_HUAXING, UNKNOWN_DDIC, DEFAULT_LCD_VER, 0, 4095, g_gamma_2_2, g_gamma_2_2, g_gamma_2_3},

	{TAG_ALS, PRODUCT_MRT, LCD_TIANMA, UNKNOWN_DDIC, DEFAULT_LCD_VER, 0, 4095, g_gamma_1_9, g_gamma_2_3, g_gamma_2_3},
	{TAG_ALS, PRODUCT_MRT, LCD_VISIONOX, UNKNOWN_DDIC, DEFAULT_LCD_VER, 0, 4095, g_gamma_2_3, g_gamma_1_9, g_gamma_2_2},

	{TAG_ALS, PRODUCT_MIA, LCD_BOE, UNKNOWN_DDIC, DEFAULT_LCD_VER, 0, 4095, g_gamma_2_4, g_gamma_2_0, g_gamma_2_4},
	{TAG_ALS, PRODUCT_MIA, LCD_HUAXING, UNKNOWN_DDIC, DEFAULT_LCD_VER, 0, 4095, g_gamma_2_2, g_gamma_2_2, g_gamma_2_3},

	{TAG_ALS, PRODUCT_BRES, LCD_HUAXING, UNKNOWN_DDIC, DEFAULT_LCD_VER, 0, 4095, g_gamma_2_2, g_gamma_2_2, g_gamma_2_3},
	{TAG_ALS, PRODUCT_BRES, LCD_TIANMA, UNKNOWN_DDIC, DEFAULT_LCD_VER, 0, 4095, g_gamma_2_1, g_gamma_2_2, g_gamma_2_3},
	{TAG_ALS, PRODUCT_BRES, LCD_VISIONOX, UNKNOWN_DDIC, DEFAULT_LCD_VER, 0, 4095, g_gamma_1_8, g_gamma_1_8, g_gamma_1_9},

	{TAG_ALS, PRODUCT_HED, LCD_VISIONOX, UNKNOWN_DDIC, DEFAULT_LCD_VER, 0, 4095, g_gamma_2_2, g_gamma_2_1, g_gamma_2_2},
	{TAG_ALS, PRODUCT_HED, LCD_BOE, UNKNOWN_DDIC, DEFAULT_LCD_VER, 0, 1200, g_gamma_1_8, g_gamma_1_4, g_gamma_2_2},
	{TAG_ALS, PRODUCT_HED, LCD_BOE, UNKNOWN_DDIC, DEFAULT_LCD_VER, 1200, 4095, g_gamma_2_0, g_gamma_1_7, g_gamma_2_2},
	{TAG_ALS, PRODUCT_LMU, LCD_VISIONOX, UNKNOWN_DDIC, DEFAULT_LCD_VER, 0, 4095, g_gamma_2_1, g_gamma_1_8, g_gamma_2_3},
	{TAG_ALS, PRODUCT_LMU, LCD_BOE, UNKNOWN_DDIC, DEFAULT_LCD_VER, 0, 1500, g_gamma_2_0, g_gamma_1_4, g_gamma_1_9},
	{TAG_ALS, PRODUCT_LMU, LCD_BOE, UNKNOWN_DDIC, DEFAULT_LCD_VER, 1500, 4095, g_gamma_2_1, g_gamma_1_9, g_gamma_1_9},
	{TAG_ALS, PRODUCT_LMR, LCD_VISIONOX, UNKNOWN_DDIC, DEFAULT_LCD_VER, 0, 4095, g_gamma_2_1, g_gamma_1_8, g_gamma_2_3},
	{TAG_ALS, PRODUCT_LMR, LCD_BOE, UNKNOWN_DDIC, DEFAULT_LCD_VER, 0, 1000, g_gamma_2_1, g_gamma_1_2, g_gamma_2_1},
	{TAG_ALS, PRODUCT_LMR, LCD_BOE, UNKNOWN_DDIC, DEFAULT_LCD_VER, 1000, 1500, g_gamma_2_0, g_gamma_1_4, g_gamma_1_9},
	{TAG_ALS, PRODUCT_LMR, LCD_BOE, UNKNOWN_DDIC, DEFAULT_LCD_VER, 1500, 4095, g_gamma_2_1, g_gamma_1_9, g_gamma_1_9},

	{TAG_ALS, PRODUCT_TLR, LCD_VISIONOX, UNKNOWN_DDIC, DEFAULT_LCD_VER, 0, 1000, g_gamma_1_5, g_gamma_1_4, g_gamma_2_1},
	{TAG_ALS, PRODUCT_TLR, LCD_VISIONOX, UNKNOWN_DDIC, DEFAULT_LCD_VER, 1000, 1800, g_gamma_1_7, g_gamma_1_6, g_gamma_2_1},
	{TAG_ALS, PRODUCT_TLR, LCD_VISIONOX, UNKNOWN_DDIC, DEFAULT_LCD_VER, 1800, 4095, g_gamma_1_9, g_gamma_1_8, g_gamma_2_1},
	{TAG_ALS, PRODUCT_TLR, LCD_BOE, UNKNOWN_DDIC, DEFAULT_LCD_VER, 0, 2500, g_gamma_2_3, g_gamma_1_7, g_gamma_2_2},
	{TAG_ALS, PRODUCT_TLR, LCD_BOE, UNKNOWN_DDIC, DEFAULT_LCD_VER, 2500, 3500, g_gamma_2_3, g_gamma_1_9, g_gamma_2_2},
	{TAG_ALS, PRODUCT_TLR, LCD_BOE, UNKNOWN_DDIC, DEFAULT_LCD_VER, 3500, 4095, g_gamma_2_3, g_gamma_2_1, g_gamma_2_2},
	{TAG_ALS, PRODUCT_TLR, LCD_HUAXING, DDIC_HISI, DEFAULT_LCD_VER, 0, 1000, g_gamma_2_0, g_gamma_2_0, g_gamma_2_4},
	{TAG_ALS, PRODUCT_TLR, LCD_HUAXING, DDIC_HISI, DEFAULT_LCD_VER, 1000, 1600, g_gamma_2_0, g_gamma_2_1, g_gamma_2_4},
	{TAG_ALS, PRODUCT_TLR, LCD_HUAXING, DDIC_HISI, DEFAULT_LCD_VER, 1600, 4095, g_gamma_2_1, g_gamma_2_1, g_gamma_2_2},
	{TAG_ALS, PRODUCT_TLR, LCD_HUAXING, UNKNOWN_DDIC, DEFAULT_LCD_VER, 0, 1000, g_gamma_2_2, g_gamma_2_2, g_gamma_2_2},
	{TAG_ALS, PRODUCT_TLR, LCD_HUAXING, UNKNOWN_DDIC, DEFAULT_LCD_VER, 1000, 1600, g_gamma_2_3, g_gamma_2_3, g_gamma_2_3},
	{TAG_ALS, PRODUCT_TLR, LCD_HUAXING, UNKNOWN_DDIC, DEFAULT_LCD_VER, 1600, 4095, g_gamma_2_4, g_gamma_2_4, g_gamma_2_4},
	{TAG_ALS, PRODUCT_GAI, LCD_VISIONOX, UNKNOWN_DDIC, DEFAULT_LCD_VER, 0, 1000, g_gamma_1_5, g_gamma_1_4, g_gamma_2_1},
	{TAG_ALS, PRODUCT_GAI, LCD_VISIONOX, UNKNOWN_DDIC, DEFAULT_LCD_VER, 1000, 1800, g_gamma_1_7, g_gamma_1_6, g_gamma_2_1},
	{TAG_ALS, PRODUCT_GAI, LCD_VISIONOX, UNKNOWN_DDIC, DEFAULT_LCD_VER, 1800, 4095, g_gamma_1_9, g_gamma_1_8, g_gamma_2_1},
	{TAG_ALS, PRODUCT_GAI, LCD_BOE, UNKNOWN_DDIC, DEFAULT_LCD_VER, 0, 2500, g_gamma_2_3, g_gamma_1_7, g_gamma_2_2},
	{TAG_ALS, PRODUCT_GAI, LCD_BOE, UNKNOWN_DDIC, DEFAULT_LCD_VER, 2500, 3500, g_gamma_2_3, g_gamma_1_9, g_gamma_2_2},
	{TAG_ALS, PRODUCT_GAI, LCD_BOE, UNKNOWN_DDIC, DEFAULT_LCD_VER, 3500, 4095, g_gamma_2_3, g_gamma_2_1, g_gamma_2_2},
	{TAG_ALS, PRODUCT_GAI, LCD_HUAXING, UNKNOWN_DDIC, DEFAULT_LCD_VER, 0, 1000, g_gamma_2_2, g_gamma_2_2, g_gamma_2_2},
	{TAG_ALS, PRODUCT_GAI, LCD_HUAXING, UNKNOWN_DDIC, DEFAULT_LCD_VER, 1000, 1600, g_gamma_2_3, g_gamma_2_3, g_gamma_2_3},
	{TAG_ALS, PRODUCT_GAI, LCD_HUAXING, UNKNOWN_DDIC, DEFAULT_LCD_VER, 1600, 4095, g_gamma_2_4, g_gamma_2_4, g_gamma_2_4},
	{TAG_ALS, PRODUCT_GLB, LCD_BOE, UNKNOWN_DDIC, DEFAULT_LCD_VER, 0, 1000, g_gamma_2_0, g_gamma_2_0, g_gamma_2_1},
	{TAG_ALS, PRODUCT_GLB, LCD_BOE, UNKNOWN_DDIC, DEFAULT_LCD_VER, 1000, 4095, g_gamma_2_3, g_gamma_2_2, g_gamma_2_2},

	{TAG_ALS1, PRODUCT_GLB, LCD_BOE, UNKNOWN_DDIC, DEFAULT_LCD_VER, 0, 1000, g_gamma_2_0, g_gamma_2_0, g_gamma_2_1},
	{TAG_ALS1, PRODUCT_GLB, LCD_BOE, UNKNOWN_DDIC, DEFAULT_LCD_VER, 1000, 4095, g_gamma_2_3, g_gamma_2_2, g_gamma_2_2},

	{TAG_ALS, PRODUCT_SUP, LCD_TIANMA, DDIC_HISI, DEFAULT_LCD_VER, 0, 1000, g_gamma_1_7, g_gamma_2_2, g_gamma_2_2},
	{TAG_ALS, PRODUCT_SUP, LCD_TIANMA, DDIC_HISI, DEFAULT_LCD_VER, 1000, 2000, g_gamma_1_8, g_gamma_2_3, g_gamma_2_3},
	{TAG_ALS, PRODUCT_SUP, LCD_TIANMA, DDIC_HISI, DEFAULT_LCD_VER, 2000, 4095, g_gamma_2_1, g_gamma_2_3, g_gamma_2_3},
	{TAG_ALS, PRODUCT_SUP, LCD_BOE, DDIC_RUIDING, DEFAULT_LCD_VER, 0, 4095, g_gamma_1_9, g_gamma_1_5, g_gamma_2_2},
};

threshold_map_t g_th_table[] = {
	{PLA, LCD_VISIONOX, TAG_ALS, {{462, 1312, 0}, {462, 1312, 0}, {462, 1312, 0}}},
	{PLA, LCD_BOE, TAG_ALS, {{608, 1377, 0}, {608, 1377, 0}, {608, 1377, 0}}},
	{PLA, LCD_BOE_418, TAG_ALS, {{643, 1493, 0}, {643, 1493, 0}, {643, 1493, 0}}},
	{PLA, LCD_TIANMA, TAG_ALS, {{681, 1688, 0}, {681, 1688, 0}, {681, 1688, 0}}},
	{PLR, LCD_VISIONOX, TAG_ALS, {{462, 1312, 0}, {462, 1312, 0}, {462, 1312, 0}}},
	{PLR, LCD_BOE, TAG_ALS, {{608, 1377, 0}, {608, 1377, 0}, {608, 1377, 0}}},
	{PLR, LCD_TIANMA, TAG_ALS, {{681, 1688, 0}, {681, 1688, 0}, {681, 1688, 0}}},
	{ICL, LCD_BOE, TAG_ALS1, {{434, 1333, 0}, {452, 1412, 0}, {383, 1263, 0}}},
	{ICL, LCD_BOE2, TAG_ALS1, {{434, 1333, 0}, {452, 1412, 0}, {383, 1263, 0}}},
	{ICL, LCD_BOE, TAG_ALS, {{464, 1427, 0}, {430, 1340, 0}, {365, 1445, 0}}},
	{ICL, LCD_VISIONOX, TAG_END, {{476, 1463, 0}, {499, 1555, 0}, {499, 1555, 0}}},
	{VDE, LCD_BOE, TAG_END, {{385, 1183, 0}, {385, 1183, 0}, {385, 1183, 0}}},
	{VDE, LCD_VISIONOX, TAG_END, {{459, 1669, 0}, {459, 1669, 0}, {459, 1669, 0}}},
	{MRT, LCD_OTHER, TAG_END, {{708, 1671, 0}, {708, 1671, 0}, {708, 1671, 0}}},
	{MIA, LCD_BOE, TAG_END, {{889, 2099, 0}, {889, 2099, 0}, {889, 2099, 0}}},
	{MIA, LCD_OTHER, TAG_END, {{834, 1960, 0}, {834, 1960, 0}, {834, 1960, 0}}},
	{HED, LCD_BOE, TAG_END, {{638, 1489, 0}, {638, 1489, 0}, {638, 1489, 0}}},
	{HED, LCD_VISIONOX, TAG_END, {{508, 1296, 0}, {508, 1296, 0}, {508, 1296, 0}}},
	{LMR, LCD_BOE, TAG_END, {{638, 1489, 0}, {638, 1489, 0}, {638, 1489, 0}}},
	{LMR, LCD_VISIONOX, TAG_END, {{508, 1296, 0}, {508, 1296, 0}, {508, 1296, 0}}},
	{LMU, LCD_BOE, TAG_END, {{638, 1489, 0}, {638, 1489, 0}, {638, 1489, 0}}},
	{LMU, LCD_VISIONOX, TAG_END, {{508, 1296, 0}, {508, 1296, 0}, {508, 1296, 0}}},
	{GLB, LCD_BOE, TAG_END, {{791, 1601, 0}, {791, 1601, 0}, {791, 1601, 0}}},
	{SUP, LCD_TIANMA, TAG_END, {{794, 1648, 0}, {794, 1648, 0}, {794, 1648, 0}}},
	{SUP, LCD_BOE, TAG_END, {{771, 1634, 0}, {771, 1634, 0}, {771, 1634, 0}}},
};

typedef struct gamma_manual_config_map {
	uint8_t in_para;
	u32 *gamma;
} gamma_manual_map_t;

gamma_manual_map_t g_manual_gmp[] = {
	{GAMMA_12, g_gamma_1_2},
	{GAMMA_13, g_gamma_1_3},
	{GAMMA_14, g_gamma_1_4},
	{GAMMA_15, g_gamma_1_5},
	{GAMMA_16, g_gamma_1_6},
	{GAMMA_17, g_gamma_1_7},
	{GAMMA_18, g_gamma_1_8},
	{GAMMA_19, g_gamma_1_9},
	{GAMMA_20, g_gamma_2_0},
	{GAMMA_21, g_gamma_2_1},
	{GAMMA_22, g_gamma_2_2},
	{GAMMA_23, g_gamma_2_3},
	{GAMMA_24, g_gamma_2_4},
};
...
static void gamma_choice_with_alpha(int tag, struct als_gamma_config *cfg)
{
	uint32_t i;
	uint32_t alpha;
	uint32_t alpha_r;
	...
	for (i = 0; i < DEGAMMA_COEF_LEN; i++) {
		...
		hisi_dss_alsc_init.degamma_lut_r[i] =
			(cfg->r_gamma[i] * alpha_r + ALS_ALPHA_HALF_MAX) / ALS_ALPHA_VAL_MAX;
		hisi_dss_alsc_init.degamma_lut_g[i] =
			(cfg->g_gamma[i] * alpha_g + ALS_ALPHA_HALF_MAX) / ALS_ALPHA_VAL_MAX;
		hisi_dss_alsc_init.degamma_lut_b[i] =
			(cfg->b_gamma[i] * alpha_b + ALS_ALPHA_HALF_MAX) / ALS_ALPHA_VAL_MAX;
#elif defined DKMD_ALSC_NOISE
		if (tag == TAG_ALS) {
			hisi_dkmd_alsc_init.degamma_coef.r_coef[i] =
				(cfg->r_gamma[i] * alpha_r + ALS_ALPHA_HALF_MAX) / ALS_ALPHA_VAL_MAX;
			hisi_dkmd_alsc_init.degamma_coef.g_coef[i] =
				(cfg->g_gamma[i] * alpha_g + ALS_ALPHA_HALF_MAX) / ALS_ALPHA_VAL_MAX;
			hisi_dkmd_alsc_init.degamma_coef.b_coef[i] =
				(cfg->b_gamma[i] * alpha_b + ALS_ALPHA_HALF_MAX) / ALS_ALPHA_VAL_MAX;
		} else {
			hisi_dkmd_alsc1_init.degamma_coef.r_coef[i] =
				(cfg->r_gamma[i] * alpha_r + ALS_ALPHA_HALF_MAX) / ALS_ALPHA_VAL_MAX;
			hisi_dkmd_alsc1_init.degamma_coef.g_coef[i] =
				(cfg->g_gamma[i] * alpha_g + ALS_ALPHA_HALF_MAX) / ALS_ALPHA_VAL_MAX;
			hisi_dkmd_alsc1_init.degamma_coef.b_coef[i] =
				(cfg->b_gamma[i] * alpha_b + ALS_ALPHA_HALF_MAX) / ALS_ALPHA_VAL_MAX;
		}
#endif
	}
...
static bool gamma_choice(int tag, u32 *r_gamma, u32 *g_gamma, u32 *b_gamma)
{
	int i;
...
#elif defined DKMD_ALSC_NOISE
		if (tag == TAG_ALS) {
			hisi_dkmd_alsc_init.degamma_coef.r_coef[i] = r_gamma[i];
			hisi_dkmd_alsc_init.degamma_coef.g_coef[i] = g_gamma[i];
			hisi_dkmd_alsc_init.degamma_coef.b_coef[i] = b_gamma[i];
		} else {
			hisi_dkmd_alsc1_init.degamma_coef.r_coef[i] = r_gamma[i];
			hisi_dkmd_alsc1_init.degamma_coef.g_coef[i] = g_gamma[i];
			hisi_dkmd_alsc1_init.degamma_coef.b_coef[i] = b_gamma[i];
		}
#endif
	}
...
static int als_config_manual_gamma(u32** r_gamma, u32** g_gamma, u32** b_gamma,
	uint8_t manual_gamma[GAMMA_TYPE_NUM])
{
	int i;
	int j;
	...
	hwlog_info("%s: start config manual gamma\n", __func__);
	for (i = 0; i < GAMMA_TYPE_NUM; i++) {
		for (j = 0; j < ARRAY_SIZE(g_manual_gmp); j++) {
			if (manual_gamma[i] != g_manual_gmp[j].in_para)
				continue;
			hwlog_info("%s: %d gamma %u\n", __func__, i, manual_gamma[i]);
			if (i == R_TYPE)
				*r_gamma = g_manual_gmp[j].gamma;
			if (i == G_TYPE)
				*g_gamma = g_manual_gmp[j].gamma;
			if (i == B_TYPE)
				*b_gamma = g_manual_gmp[j].gamma;
			break;
		}
	}
	return 1;
...
static void get_gamma_cali_result(u32 tag, uint32_t mipi, u32** r_gamma, u32** g_gamma, u32** b_gamma)
{
	struct als_device_info *dev_info = NULL;
	dev_info = als_get_device_info(tag);
	uint32_t g_gamma_cali[ALS_GAMMA_CALI_LEN] = {0};
	uint32_t g_gamma_ratio;
	uint32_t *g_gamma_cali_point = &dev_info->als_under_tp_cal_data.nv_type_defult.b[GAMMA_CALI_START];
	if (dev_info == NULL)
		return;

	if(dev_info->als_ud_nv_type == 1) {
		hwlog_info("%s: als_ud_nv_type == 1\n", __func__);
		return;
	} else {
		for (int i = 0; i < ALS_GAMMA_CALI_LEN; i++)
			g_gamma_cali[i] = (g_gamma_cali_point[NUM_II * i + 1]) & BITS_16_MASK;
	}
	if (g_gamma_cali[NUM_II] > 0 && g_product_type == PRODUCT_HED && g_lcd_type == LCD_VISIONOX) {
		g_gamma_ratio = g_gamma_cali[NUM_III] * NUM_THOUSAND / g_gamma_cali[NUM_II];
		if (g_gamma_ratio > GAMMA_1_7_LOW_TH && g_gamma_ratio <= GAMMA_1_7_HIGH_TH) {
			*g_gamma = g_gamma_1_7;
			hwlog_info("%s: g_gamma_1_7\n", __func__);
		}
		if (g_gamma_ratio > GAMMA_1_7_HIGH_TH) {
			*g_gamma = g_gamma_1_6;
			hwlog_info("%s: g_gamma_1_6\n", __func__);
		}
	}
	if (g_gamma_cali[0] > 0 && (g_product_type == PRODUCT_PLA || g_product_type == PRODUCT_PLR) &&
		g_lcd_type == LCD_VISIONOX) {
		if (g_gamma_cali[2] / g_gamma_cali[0] > 0.3) {
			hwlog_info("%s: g_gamma_1_7\n", __func__);
		} else {
			hwlog_info("%s: g_gamma_2_2\n", __func__);
		}
	}
}
...
static void gamma_by_product(u32 tag, uint32_t mipi, u32** r_gamma, u32** g_gamma, u32** b_gamma)
{
	...
	if (als_config_manual_gamma(r_gamma, g_gamma, b_gamma, g_als_manual_gamma))
		return;

	for (i = 0; i < ARRAY_SIZE(g_gamma_map); i++) {
		if (tag == g_gamma_map[i].tag &&
			g_product_type == g_gamma_map[i].product &&
			g_lcd_type == g_gamma_map[i].lcd &&
			(g_gamma_map[i].ddic == UNKNOWN_DDIC || ddic == g_gamma_map[i].ddic) &&
			(panel_version == DEFAULT_LCD_VER ||
			panel_version == g_gamma_map[i].lcd_panel_version) &&
			mipi >= g_gamma_map[i].mipi_low &&
			mipi < g_gamma_map[i].mipi_high) {
...
bool als_gamma_param_config(uint32_t tag, uint32_t mipi)
{
	...
	hwlog_debug("%s nv_data=%u", __func__, nv_data);
	g_product_type = (nv_data & 0xff000) >> 12;
	g_lcd_type = als_get_lcd_info(tag);
	g_sensor_type = nv_version >= EDITION_SENSORFLAG_SHIFT ? (nv_data & 0x00ff) : (nv_data & 0x00f0) >> 4;
	nv_data = ((nv_data & 0x0000ffff) >> 8);
	ddic = als_get_ddic_info(tag);
	if (ddic == DDIC_HISI || ddic == DDIC_HISI05 || (g_product_type == PRODUCT_SUP && ddic == DDIC_RUIDING))
		mipi = mipi / COEF_MIPI_HXX_CXX;
	hwlog_debug("%s gamma type: %d, product %d, lcd %d, sensor %d, ddic %d", __func__,
	...
	if ((nv_data == GAMMA_TYPE_N_BOE) || (nv_data == GAMMA_TYPE_NP_BOE)) {
		if(dev_info->chip_type == ALS_CHIP_AMS_TSL2540_RGB) {
			hwlog_debug("%s chip info G-IR", __func__);
			r_gamma = g_gamma_2_0;
			g_gamma = g_gamma_1_6;
			b_gamma = g_gamma_2_2;
		} else {
	...
	get_gamma_cali_result(tag, mipi, &r_gamma, &g_gamma, &b_gamma);
	need_update = gamma_choice(tag, r_gamma, g_gamma, b_gamma);
	return need_update;
}
...
int als_gamma_update_with_alpha(int tag)
{
	...
	gamma_choice_with_alpha(tag, &g_als_gamma_cfg);
	return 0;
}
...
bool threshold_by_product(uint8_t phone_type, uint8_t lcd_type, int32_t tag)
{
	...
	struct als_device_info *dev_info = NULL;
	dev_info = als_get_device_info(tag);
	for (i = 0; i < ARRAY_SIZE(g_th_table); i++) {
		if ((tag == g_th_table[i].tag || g_th_table[i].tag == TAG_END) &&
			phone_type == g_th_table[i].phone_type &&
			(lcd_type == g_th_table[i].lcd_type || g_th_table[i].lcd_type == LCD_OTHER)) {
			for (j = 0; j < ALS_THRESHOLD_SIZE; j++) {
				dev_info->als_threshold_para_data.threshold[j] = g_th_table[i].thresholds[j];
            }
			hwlog_info("%s: g_th_table %d found success\n", __func__, i);
			return true;
		}
	}
	hwlog_info("%s: g_th_table found fail\n", __func__);
	return false;
}
#endif
