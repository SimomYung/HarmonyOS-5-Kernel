...
#define LTR311_PARA_SIZE_XIAN 16
...
#define SY81135_PARA_SIZE		32
#define SY3135_PARA_SIZE        16
...
#define AMS_TCS3743_PARA_SIZE   94
#define UCS116E0_PARA_SIZE      32
#define COMMON_ALS_SIZE         94
#define ALS_TABLE_LEN           2
...
#define TCS3718_MAX_THRESHOLD_NUM 30
#define TCS3718_MIN_THRESHOLD_NUM 31
...
#define SY81135_MAX_THRESHOLD_NUM 27
#define SY81135_MIN_THRESHOLD_NUM 28

#define STK37670_MAX_THRESHOLD_NUM 30
#define STK37670_MIN_THRESHOLD_NUM 31
...
#define AMS_TCS3743_MAX_THRESHOLD_NUM 30
#define AMS_TCS3743_MIN_THRESHOLD_NUM 31
 
#define UCS116E0_MAX_THRESHOLD_NUM 30
#define UCS116E0_MIN_THRESHOLD_NUM 31
...
typedef struct _sip3642_als_para_table {
	...
	uint8_t tp_lcd_manufacture;
	uint8_t tp_color;
	s16 sip3642_para[SIP3642_PARA_SIZE];
...
typedef struct _tcs3718_als_para_table {
	uint8_t phone_type;
	uint8_t phone_version;
	uint8_t tp_lcd_manufacture;
	uint8_t tp_color;
	/*
	 * give to tmd3718 rgb sensor use,output lux and cct will use these para
	 * the tmd3718_para size must small SENSOR_PLATFORM_EXTEND_DATA_SIZE
	 */
	s16 tcs3718_para[TCS3718_PARA_SIZE];
} tcs3718_als_para_table;
...
typedef struct _sy81135_als_para_table {
	uint8_t phone_type;
	uint8_t phone_version;
	uint8_t tp_lcd_manufacture;
	uint8_t tp_color;
	/* give to sy81135 rgb sensor use,output lux and cct will use these para */
	s16 sy81135_para[SY81135_PARA_SIZE];
} sy81135_als_para_table;

typedef struct _sy3135_als_para_table {
	uint8_t phone_type;
	uint8_t phone_version;
	uint8_t tp_lcd_manufacture;
	uint8_t tp_color;
	/* give to sy3135 two channel sensor use */
	s16 sy3135_para[SY3135_PARA_SIZE];
} sy3135_als_para_table;

typedef struct _stk37670_als_para_table {
	uint8_t phone_type;
	uint8_t phone_version;
	uint8_t tp_lcd_manufacture;
	uint8_t tp_color;
	/* give to stk37670 rgb sensor use,output lux and cct will use these para */
	s16 stk37670_para[STK37670_PARA_SIZE];
} stk37670_als_para_table;
...
typedef struct _ucs116e0_als_para_table {
	uint8_t phone_type;
	uint8_t phone_version;
	uint8_t tp_lcd_manufacture;
	uint8_t tp_color;
	/*
	 * give to ams ucs116e0 rgb sensor use,output lux and cct will use these para
	 * the ucs116e0_para size must small SENSOR_PLATFORM_EXTEND_DATA_SIZE
	 */
	s16 ucs116e0_para[UCS116E0_PARA_SIZE];
} ucs116e0_als_para_table;
 
typedef struct _ams_tcs3743_als_para_table {
	uint8_t phone_type;
	uint8_t phone_version;
	uint8_t tp_lcd_manufacture;
	uint8_t tp_color;
	/*
	 * give to ams tcs3743 rgb sensor use,output lux and cct will use these para
	 * the tcs3743_para size must small SENSOR_PLATFORM_EXTEND_DATA_SIZE
	 */
	s16 ams_tcs3743_para[AMS_TCS3743_PARA_SIZE];
} ams_tcs3743_als_para_table;
...
typedef struct {
	...
	uint8_t tp_lcd_manufacture;
	uint8_t tp_color;
	s16 als_para[COMMON_ALS_SIZE];
} als_para_common_table;
