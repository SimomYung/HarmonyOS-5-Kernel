...
sip1221lr_als_para_table sip1221lr_als_para[] = {
	...
	{ TXZ, V3, DEFAULT_TPLCD, OTHER,
	  { 512, 256, //als, ir normalized_gain
	    1000, 2000, 3000, 4000, // H, A, D, C light
	    23, 23, 23, 23, // H, A, D, C factor
	    21717, 25684, // als_target, ir_target
		10000, 1, // max_threshold, min_threshold
		4, 1, // als_target_ratio, ir_target_ratio
