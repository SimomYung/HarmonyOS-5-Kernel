...
static sip2326_als_para_table sip2326_als_para_diff_tp_color_table[] = {
	...
	{ VDE, V3, DEFAULT_TPLCD, OTHER,
		{512, // normalized gain
		837, -13158, 20700, -8627, 2000, // screen-off para: c/r/g/b/dgf
		1,                            // dgf / ratio
		5690, -4716, 2529, -5526, 100,
		100,                          // normalized atime
		1, 20, -1000, 0, 0, 2776, 12000, 0, 0, -317, 1, 20,
	...
	{ HPR, V3, DEFAULT_TPLCD, OTHER,
		...
		5000, 200,
		-6025, 6, 10032, 6, 11305, 7, 3567, 6, 0, 1, // high X_RGBCW & ratio
		-8568, 6, 12439, 6, -10279, 7, 4101, 6, 0, 1, // Y_RGBCW & ratio
		-17501, 6, 17091, 6, -14453, 6, 6685, 6, 0, 1, // Z_RGBCW & ratio
		-6025, 6, 10032, 6, 11305, 7, 3567, 6, 0, 1, // low X_RGBCW & ratio
		-8568, 6, 12439, 6, -10279, 7, 4101, 6, 0, 1, // Y_RGBCW & ratio
		-17501, 6, 17091, 6, -14453, 6, 6685, 6, 0, 1, // Z_RGBCW & ratio
...
static sip2326_als_para_table sip2326_als1_para_diff_tp_color_table[] = {
	...
	{ ICL, V3, BOE_TPLCD_B12, OTHER,
		{512, // normalized gain
		0, 2251, 5821, -2083, 1000, // screen-off para: c/r/g/b/dgf
		1,                            // dgf / ratio
		5690, -4716, 2529, -5526, 100,
		0, 1, 20, -1000, 0, 0, 2776, 12000, 0, 0, -317, 1, 20,
		3, 26126, 5561, 5856, 3094, // ratio/(target/ration)c/r/g/b
		1800, 600
		}
	},
	{ ICL, V3, BOE_TPLCD, OTHER,
		{512, // normalized gain
		135, -3652, 12797, -4222, 1000, // screen-off para: c/r/g/b/dgf
		1,                            // dgf / ratio
		5690, -4716, 2529, -5526, 100,
		0, 1, 20, -1000, 0, 0, 2776, 12000, 0, 0, -317, 1, 20,
		3, 22716, 4655, 4616, 1627, // ratio/(target/ration)c/r/g/b
		1800, 600
		}
	},
	{ ICL, V3, DEFAULT_TPLCD, OTHER,
		{512, // normalized gain
		0, 4910, 4258, -2935, 1000, // screen-off para: c/r/g/b/dgf
		1,                            // dgf / ratio
		5690, -4716, 2529, -5526, 100,
		0, 1, 20, -1000, 0, 0, 2776, 12000, 0, 0, -317, 1, 20,
		2, 29110, 7097, 7434, 3478, // ratio/(target/ration)c/r/g/b
		1800, 600
		}
	},
};
