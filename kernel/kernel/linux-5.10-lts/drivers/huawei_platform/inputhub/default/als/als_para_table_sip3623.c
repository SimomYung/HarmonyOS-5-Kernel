...
static sip3623_als_para_table sip3623_als_para_diff_tp_color_table[] = {
	...
	{ CLS, V3, BOE_TPLCD, OTHER,
	  { 128, 0, 1265, 3615, -8785, 10, 0, 5690, -4716, 2529, -5526, 100,
	    0, 1, 20, -1000, 0, 0, 2776, 12000, 0, 0, -317, 1, 20, 1, 24320,
	    7702, 6047, 221, 4000, 250 }
	},
	{ CLS, V3, DEFAULT_TPLCD, OTHER,
	  { 128, 0, 1868, 3079, -7638, 10, 0, 5690, -4716, 2529, -5526, 100,
	    0, 1, 20, -1000, 0, 0, 2776, 12000, 0, 0, -317, 1, 20, 1, 24968,
	    7914, 6482, 333, 4000, 250 }
	},
	{ PLR, V3, TM_TPLCD, OTHER,
	  { 128, 0, 442, 3963, -4707, 10, 0, 5690, -4716, 2529, -5526, 100,
	    0, 1, 20, -1000, 0, 0, 2776, 12000, 0, 0, -317, 1, 20, 1, 20508,
	    7194, 5725, 276, 4000, 250 } // TO
	},
	{ PLR, V3, BOE_TPLCD, OTHER,
	  { 128, 0, 950, 3660, -6543, 10, 0, 5690, -4716, 2529, -5526, 100,
	    0, 1, 20, -1000, 0, 0, 2776, 12000, 0, 0, -317, 1, 20, 1, 26001,
	    8377, 6706, 387, 4000, 250 }
	},
	{ PLR, V3, DEFAULT_TPLCD, OTHER,
	  { 128, 0, 1278, 4107, -7077, 10, 0, 5690, -4716, 2529, -5526, 100,
	    0, 1, 20, -1000, 0, 0, 2776, 12000, 0, 0, -317, 1, 20, 1, 20508,
	    7194, 5725, 276, 4000, 250 }
	},
	{ PLA, V3, TM_TPLCD, OTHER,
	  { 128, 0, 442, 3963, -4707, 10, 0, 5690, -4716, 2529, -5526, 100,
	    0, 1, 20, -1000, 0, 0, 2776, 12000, 0, 0, -317, 1, 20, 1, 28676,
	    9373, 7351, 377, 4000, 250 } // TO
	},
	{ PLA, V3, BOE_TPLCD, OTHER,
	  { 128, 0, 167, 4545, -5535, 10, 0, 5690, -4716, 2529, -5526, 100,
	    0, 1, 20, -1000, 0, 0, 2776, 12000, 0, 0, -317, 1, 20, 1, 30746,
	    9536, 7791, 473, 4000, 250 }
	},
	{ PLA, V3, DEFAULT_TPLCD, OTHER,
	  { 128, 0, -620, 5163, -3346, 10, 0, 5690, -4716, 2529, -5526, 100,
	    0, 1, 20, -1000, 0, 0, 2776, 12000, 0, 0, -317, 1, 20, 1, 28676,
	    9373, 7351, 377, 4000, 250 }
	},
	{ ICL, V3, BOE_TPLCD, OTHER,
	  { 128, 0, -741, 7022, -5015, 10, 0, 5690, -4716, 2529, -5526, 100,
	    0, 1, 20, -1000, 0, 0, 2776, 12000, 0, 0, -317, 1, 20, 3, 28772,
	    3101, 2234, 125, 1800, 600 }
	},
	{ ICL, V3, DEFAULT_TPLCD, OTHER,
	  { 128, 0, 883, 4113, -5885, 10, 0, 5690, -4716, 2529, -5526, 100,
	    0, 1, 20, -1000, 0, 0, 2776, 12000, 0, 0, -317, 1, 20, 3, 22774,
	    2973, 2455, 153, 1800, 600 }
	},
	...
	{ DEL, V3, BOE_TPLCD, OTHER,
	  { 128, 0, -741, 7022, -5015, 10, 0, 5690, -4716, 2529, -5526, 100,
	    0, 1, 20, -1000, 0, 0, 2776, 12000, 0, 0, -317, 1, 20, 2, 29365,
	    4367, 3586, 212, 4000, 250 }
	},
	{ DEL, V3, DEFAULT_TPLCD, OTHER,
	  { 128, 39, -154, 5787, -15220, 10, 0, 5690, -4716, 2529, -5526, 100,
	    0, 1, 20, -1000, 0, 0, 2776, 12000, 0, 0, -317, 1, 20, 2, 29365,
	    4367, 3842, 270, 4000, 250 } // TO
	},
};
