...
static dbv_sec_info dbv_sec_info_table[] = {
	...
	{ADY, LCD_BOE, ALS_CHIP_SIP3642, TAG_ALS, {868, 126, 1, 1, 220, 161, 105, 38, 30, 23, 16, 10, 7}},
	{ADY, LCD_VISIONOX, ALS_CHIP_SIP3642, TAG_ALS, {868, 126, 4, 1, 220, 161, 105, 38, 30, 23, 16, 10, 7}},
	{HBN, LCD_BOE, ALS_CHIP_SIP3642, TAG_ALS, {885, 134, 1, 1, 220, 161, 105, 38, 30, 23, 16, 10, 7}},
	{HBN, LCD_VISIONOX, ALS_CHIP_SIP3642, TAG_ALS, {885, 134, 4, 1, 220, 161, 105, 38, 30, 23, 16, 10, 7}},
	...
	{CLS, LCD_BOE, ALS_CHIP_SIP3623, TAG_ALS, {845, 125, 1, 1, 220, 183, 140, 108, 83, 60, 47, 22, 7}},
	{CLS, LCD_VISIONOX, ALS_CHIP_SIP3623, TAG_ALS, {845, 125, 4, 1, 220, 171, 140, 99, 74, 52, 34, 19, 9}},
	{CLS, LCD_BOE, ALS_CHIP_AMS_TCS3718_RGB, TAG_ALS, {839, 125, 1, 1, 220, 183, 140, 108, 83, 60, 47, 22, 7}},
	{CLS, LCD_VISIONOX, ALS_CHIP_AMS_TCS3718_RGB, TAG_ALS, {839, 125, 4, 1, 220, 171, 140, 99, 74, 52, 34, 19, 9}},
	{PLR, LCD_BOE, ALS_CHIP_SIP3623, TAG_ALS, {893, 68, 1, 2, 220, 190, 160, 131, 101, 75, 48, 26, 9}},
	{PLR, LCD_VISIONOX, ALS_CHIP_SIP3623, TAG_ALS, {893, 68, 4, 1, 190, 140, 87, 38, 30, 21, 15, 9, 5}},
	{PLR, LCD_BOE, ALS_CHIP_AMS_TCS3718_RGB, TAG_ALS, {893, 68, 1, 2, 220, 190, 160, 131, 101, 75, 48, 26, 9}},
	{PLR, LCD_VISIONOX, ALS_CHIP_AMS_TCS3718_RGB, TAG_ALS, {893, 68, 4, 1, 190, 155, 130, 100, 76, 51, 30, 13, 7}},
	{PLA, LCD_BOE, ALS_CHIP_SIP3623, TAG_ALS, {898, 75, 1, 2, 220, 190, 160, 131, 101, 75, 48, 26, 9}},
	{PLA, LCD_BOE_418, ALS_CHIP_SIP3623, TAG_ALS, {898, 75, 1, 2, 220, 190, 160, 131, 101, 75, 48, 26, 9}},
	{PLA, LCD_VISIONOX, ALS_CHIP_SIP3623, TAG_ALS, {898, 75, 4, 1, 180, 145, 125, 100, 76, 51, 31, 9, 5}},
	{PLA, LCD_BOE, ALS_CHIP_AMS_TCS3718_RGB, TAG_ALS, {893, 68, 1, 2, 220, 190, 160, 131, 101, 75, 48, 26, 9}},
	{PLA, LCD_VISIONOX, ALS_CHIP_AMS_TCS3718_RGB, TAG_ALS, {893, 68, 4, 1, 190, 155, 130, 100, 76, 51, 30, 13, 7}},
	{ICL, LCD_BOE, ALS_CHIP_AMS_TCS3718_RGB, TAG_ALS, {726, 111, 1, 1, 230, 194, 156, 126, 90, 54, 29, 10, 5}},
	{ICL, LCD_VISIONOX, ALS_CHIP_AMS_TCS3718_RGB, TAG_ALS, {726, 111, 4, 1, 228, 190, 151, 120, 90, 56, 33, 10, 5}},
	{ICL, LCD_BOE, ALS_CHIP_SIP3623, TAG_ALS, {726, 111, 1, 1, 230, 194, 156, 126, 90, 54, 29, 10, 5}},
	{ICL, LCD_VISIONOX, ALS_CHIP_SIP3623, TAG_ALS, {726, 111, 4, 1, 228, 190, 151, 120, 90, 56, 33, 10, 5}},
	{ICL, LCD_BOE, ALS_CHIP_SIP2326, TAG_ALS1, {1691, 65, 1, 1, 230, 194, 156, 126, 90, 54, 29, 10, 5}},
	{ICL, LCD_BOE2, ALS_CHIP_SIP2326, TAG_ALS1, {1691, 65, 9, 1, 230, 194, 156, 126, 90, 54, 29, 10, 5}},
	{ICL, LCD_VISIONOX, ALS_CHIP_SIP2326, TAG_ALS1, {1691, 65, 4, 1, 228, 190, 151, 120, 90, 56, 33, 10, 5}},
	{ICL, LCD_BOE, ALS_CHIP_TCS3410, TAG_ALS1, {1691, 65, 1, 2, 198, 165, 138, 111, 79, 39, 22, 9, 5}},
	{ICL, LCD_BOE2, ALS_CHIP_TCS3410, TAG_ALS1, {1691, 65, 9, 2, 198, 165, 138, 111, 79, 39, 22, 9, 5}},
	{ICL, LCD_VISIONOX, ALS_CHIP_TCS3410, TAG_ALS1, {1691, 65, 4, 2, 198, 165, 138, 111, 79, 39, 22, 9, 5}},
	{BRES, LCD_HUAXING, ALS_CHIP_LTR311, TAG_ALS, {746, 62, 7, 1, 220, 192, 159, 127, 102, 74, 56, 31, 4}},
	{BRES, LCD_HUAXING, ALS_CHIP_SYH399, TAG_ALS, {747, 62, 7, 1, 220, 192, 159, 127, 102, 74, 56, 31, 4}},
	{BRES, LCD_VISIONOX, ALS_CHIP_LTR311, TAG_ALS, {748, 60, 4, 1, 220, 192, 159, 127, 102, 74, 56, 31, 4}},
	{BRES, LCD_VISIONOX, ALS_CHIP_SYH399, TAG_ALS, {750, 59, 4, 1, 220, 192, 159, 127, 102, 74, 56, 31, 4}},
	{BRES, LCD_TIANMA, ALS_CHIP_LTR311, TAG_ALS, {746, 62, 6, 1, 220, 192, 159, 127, 102, 74, 56, 31, 4}},
	{BRES, LCD_TIANMA, ALS_CHIP_SYH399, TAG_ALS, {747, 62, 6, 1, 220, 192, 159, 127, 102, 74, 56, 31, 4}},
	{VDE, LCD_BOE, ALS_CHIP_SIP2326, TAG_ALS, {993, 47, 1, 0, 200, 170, 140, 110, 80, 50, 25, 13, 6}},
	{VDE, LCD_VISIONOX, ALS_CHIP_SIP2326, TAG_ALS, {993, 47, 4, 0, 200, 170, 140, 110, 80, 50, 25, 13, 6}},
	{VDE, LCD_BOE, ALS_CHIP_TCS3410, TAG_ALS, {993, 47, 1, 0, 200, 170, 140, 110, 80, 50, 25, 13, 6}},
	{VDE, LCD_VISIONOX, ALS_CHIP_TCS3410, TAG_ALS, {993, 47, 4, 0, 200, 170, 140, 110, 80, 50, 25, 13, 6}},
	{LMR, LCD_VISIONOX, ALS_CHIP_AMS_TCS3743, TAG_ALS, {678, 218, 4, 0, 220, 171, 140, 99, 74, 52, 34, 19, 9}},
	{LMR, LCD_BOE, ALS_CHIP_AMS_TCS3743, TAG_ALS, {678, 218, 1, 0, 220, 190, 160, 131, 101, 75, 48, 26, 9}},
	{LMR, LCD_VISIONOX, ALS_CHIP_SIP3642, TAG_ALS, {681, 225, 4, 0, 220, 171, 140, 99, 74, 52, 34, 19, 9}},
	{LMR, LCD_BOE, ALS_CHIP_SIP3642, TAG_ALS, {681, 225, 1, 0, 220, 190, 160, 131, 101, 75, 48, 26, 9}},
	{LMU, LCD_VISIONOX, ALS_CHIP_AMS_TCS3743, TAG_ALS, {678, 218, 4, 0, 220, 171, 140, 99, 74, 52, 34, 19, 9}},
	{LMU, LCD_BOE, ALS_CHIP_AMS_TCS3743, TAG_ALS, {678, 218, 1, 0, 220, 190, 160, 131, 101, 75, 48, 26, 9}},
	{LMU, LCD_VISIONOX, ALS_CHIP_SIP3642, TAG_ALS, {681, 225, 4, 0, 220, 171, 140, 99, 74, 52, 34, 19, 9}},
	{LMU, LCD_BOE, ALS_CHIP_SIP3642, TAG_ALS, {681, 225, 1, 0, 220, 190, 160, 131, 101, 75, 48, 26, 9}},
	{HED, LCD_VISIONOX, ALS_CHIP_AMS_TCS3743, TAG_ALS, {870, 141, 4, 0, 220, 171, 140, 99, 74, 52, 34, 19, 9}},
	{HED, LCD_BOE, ALS_CHIP_AMS_TCS3743, TAG_ALS, {870, 141, 1, 0, 220, 190, 160, 131, 101, 75, 48, 26, 9}},
	{HED, LCD_VISIONOX, ALS_CHIP_SIP3642, TAG_ALS, {884, 146, 4, 0, 220, 171, 140, 99, 74, 52, 34, 19, 9}},
	{HED, LCD_BOE, ALS_CHIP_SIP3642, TAG_ALS, {884, 146, 1, 0, 220, 190, 160, 131, 101, 75, 48, 26, 9}},
	{MRT, LCD_TIANMA, ALS_CHIP_TSL2585, TAG_ALS, {867, 145, 6, 1, 220, 192, 159, 127, 102, 74, 56, 31, 4}},
	{MRT, LCD_VISIONOX, ALS_CHIP_TSL2585, TAG_ALS, {865, 145, 4, 1, 220, 192, 159, 127, 102, 74, 56, 31, 4}},
	{MRT, LCD_TIANMA, ALS_CHIP_SIP1226, TAG_ALS, {867, 145, 6, 1, 220, 192, 159, 127, 102, 74, 56, 31, 4}},
	{MRT, LCD_VISIONOX, ALS_CHIP_SIP1226, TAG_ALS, {865, 145, 4, 1, 220, 192, 159, 127, 102, 74, 56, 31, 4}},
	{MIA, LCD_HUAXING, ALS_CHIP_SYH399, TAG_ALS, {851, 137, 7, 1, 220, 192, 159, 127, 102, 74, 56, 31, 4}},
	{MIA, LCD_BOE, ALS_CHIP_SYH399, TAG_ALS, {849, 138, 1, 1, 220, 192, 159, 127, 102, 74, 56, 31, 4}},
	{MIA, LCD_HUAXING, ALS_CHIP_LTR311, TAG_ALS, {851, 137, 7, 1, 220, 192, 159, 127, 102, 74, 56, 31, 4}},
	{MIA, LCD_BOE, ALS_CHIP_LTR311, TAG_ALS, {850, 136, 1, 1, 220, 192, 159, 127, 102, 74, 56, 31, 4}},
	{TLR, LCD_VISIONOX, ALS_CHIP_TSL2585, TAG_ALS, {696, 103, 4, 1, 213, 175, 139, 102, 69, 42, 27, 18, 5}},
	{TLR, LCD_BOE, ALS_CHIP_TSL2585, TAG_ALS, {693, 102, 1, 1, 213, 175, 139, 102, 69, 42, 27, 18, 5}},
	{TLR, LCD_HUAXING, ALS_CHIP_TSL2585, TAG_ALS, {689, 107, 7, 1, 213, 175, 139, 102, 69, 42, 27, 18, 5}},
	{TLR, LCD_VISIONOX, ALS_CHIP_SIP1225, TAG_ALS, {696, 103, 4, 1, 213, 175, 139, 102, 69, 42, 27, 18, 5}},
	{TLR, LCD_BOE, ALS_CHIP_SIP1225, TAG_ALS, {693, 102, 1, 1, 213, 175, 139, 102, 69, 42, 27, 18, 5}},
	{TLR, LCD_HUAXING, ALS_CHIP_SIP1225, TAG_ALS, {689, 107, 7, 1, 213, 175, 139, 102, 69, 42, 27, 18, 5}},
	{TLR, LCD_VISIONOX, ALS_CHIP_SIP1226, TAG_ALS, {696, 103, 4, 1, 213, 175, 139, 102, 69, 42, 27, 18, 5}},
	{TLR, LCD_BOE, ALS_CHIP_SIP1226, TAG_ALS, {693, 102, 1, 1, 213, 175, 139, 102, 69, 42, 27, 18, 5}},
	{TLR, LCD_HUAXING, ALS_CHIP_SIP1226, TAG_ALS, {689, 107, 7, 1, 213, 175, 139, 102, 69, 42, 27, 18, 5}},
};
#endif
...
// als dbv para: sensorhub / 1000
#define DATA_SCALE        1000
#define PIC_TYPE_NUM      3
#define LEVEL_NUM         10

enum nine_point_dbv_index {
	P_START,
	P_1ST,
	P_2ND,
	P_3RD,
...
static unsigned short g_dbv_ratio[PIC_TYPE_NUM][LEVEL_NUM] = {0};
static als_para_common_table g_als_para_tbl = {0};
...
static int als_extract_dbv_data(const char *buf, unsigned short dbv_ratio[PIC_TYPE_NUM][LEVEL_NUM])
{
	int ret;
	int pic_type = 0;
	int level = 0;
	...
	char *split = NULL;
	char *context = NULL;
	char temp_buf[MAX_STR_SIZE] = {0};

	ret = memcpy_s(temp_buf, MAX_STR_SIZE, buf, strlen(buf));
	if (ret != EOK) {
		hwlog_err("%s strtou16 fail\n", __func__);
		return ret;
	}
	split = strtok_s(temp_buf, ",", &context);
	while (split != NULL) {
		if (kstrtou16(split, 0, &val)) {
			hwlog_err("%s strtou16 fail\n", __func__);
			return -EINVAL;
		}
		g_dbv_ratio[pic_type][level] = val;
		level++;
		if (level == LEVEL_NUM) {
			pic_type++;
			level = 0;
	...
	if (pic_type != PIC_TYPE_NUM || level != 0) {
		hwlog_err("%s: wrong value input, pic_type %d, level %d\n", __func__, pic_type, level);
		return -EINVAL;
	}
	return ret;
}

ssize_t als_dbv_ratio_store(int32_t tag, struct device *dev,
	struct device_attribute *attr, const char *buf, size_t count)
{
	int ret;
	struct write_info pkg_ap = {0};
	...
	if (!als_get_device_info(tag))
		return -1;
	if (!buf) {
		hwlog_err("%s: buf is NULL\n", __func__);
		return -EINVAL;
	}
	if (als_extract_dbv_data(buf, g_dbv_ratio))
		return -EINVAL;

	spkt.subcmd = SUB_CMD_CONFIG_DBV_RATIO;
	pkg_ap.tag = tag;
	pkg_ap.cmd = CMD_CMN_CONFIG_REQ;
	pkg_ap.wr_buf = &shd[1];
	pkg_ap.wr_len = sizeof(g_dbv_ratio) + SUBCMD_LEN;
	if (memcpy_s(spkt.para, sizeof(spkt.para), g_dbv_ratio, sizeof(g_dbv_ratio)) != EOK)
		return -1;
	hwlog_info("%s: start config dbv ratio\n", __func__);
	ret = write_customize_cmd(&pkg_ap, &pkg_mcu, true);
	if (ret) {
		hwlog_err("%s: send pkg to mcu fail, ret=%d\n", __func__, ret);
		return -1;
	...
	hwlog_info("%s: mcu return %d.\n", __func__, pkg_mcu.errno);
	return count;
}

ssize_t als_dbv_ratio_show(int32_t tag, struct device *dev,
	struct device_attribute *attr, char *buf)
{
	int i;
	int ret;
	...
	char *data_buf = buf;
	(void)memset_s(buf, MAX_STR_SIZE, 0, MAX_STR_SIZE);
	for (i = 0; i < PIC_TYPE_NUM; i++) {
		char temp_buf[MAX_STR_SIZE] = {0};
		ret = snprintf_s(temp_buf, MAX_STR_SIZE, MAX_STR_SIZE - 1,
			"%u, %u, %u, %u, %u, %u, %u, %u, %u, %u\n",
			g_dbv_ratio[i][P_START], g_dbv_ratio[i][P_1ST],
			g_dbv_ratio[i][P_2ND], g_dbv_ratio[i][P_3RD],
			g_dbv_ratio[i][P_4TH], g_dbv_ratio[i][P_5TH],
			g_dbv_ratio[i][P_6TH], g_dbv_ratio[i][P_7TH],
			g_dbv_ratio[i][P_8TH], g_dbv_ratio[i][P_9TH]);
		if (ret <= 0) {
			hwlog_err("%s snprintf fail\n", __func__);
			return 0;
		}
		ret = memcpy_s(data_buf, MAX_STR_SIZE - strlen(buf) - 1, temp_buf, strlen(temp_buf));
		if (ret != EOK) {
			hwlog_err("%s memcpy_s fail\n", __func__);
			return 0;
		}
		data_buf += strlen(temp_buf);
	}
	hwlog_info("data_buf len %d\n", strlen(buf));
	return strlen(buf);
}

static int als_extract_gamma_data(const char *buf, uint8_t manual_gamma[GAMMA_TYPE_NUM])
{
	int ret;
	int level = 0;
	uint8_t val;
	...
	split = strtok_s(temp_buf, ",", &context);
	while (split != NULL) {
		if (kstrtou8(split, 0, &val)) {
			hwlog_err("%s kstrtou8 fail\n", __func__);
			return -EINVAL;
		}
		if (val < GAMMA_12 || val > GAMMA_24) {
			hwlog_err("%s val err %u\n", __func__, val);
			break;
		}
		manual_gamma[level] = val;
		level++;
		if (level > GAMMA_TYPE_NUM)
			break;
		split = strtok_s(NULL, ",", &context);
	}
	if (level != GAMMA_TYPE_NUM) {
		hwlog_err("%s: wrong value input %d\n", __func__, level);
		return -EINVAL;
	}
	hwlog_info("%s: start manual config gamma %d %d %d\n", __func__,
		manual_gamma[R_TYPE],
		manual_gamma[G_TYPE],
		manual_gamma[B_TYPE]);
	return ret;
...
ssize_t als_manual_gamma_store(int32_t tag, struct device *dev,
	struct device_attribute *attr, const char *buf, size_t count)
{
	if (!als_get_device_info(tag))
		return -1;
	...
	if (als_extract_gamma_data(buf, g_als_manual_gamma))
		return -EINVAL;
	return count;
}

ssize_t als_manual_gamma_show(int32_t tag, struct device *dev,
	struct device_attribute *attr, char *buf)
{
	// gamma_r(2bytes),gamma_g(2bytes),gamma_b(2bytes)
	return snprintf_s(buf, MAX_STR_SIZE, MAX_STR_SIZE - 1, "%u,%u,%u\n",
		g_als_manual_gamma[R_TYPE],
		g_als_manual_gamma[G_TYPE],
		g_als_manual_gamma[B_TYPE]);
}

static int als_extract_lux_cct_para(const char *buf, als_para_common_table* para)
{
	int ret;
	int level = 0;
	short val;
	...
	split = strtok_s(temp_buf, ",", &context);
	while (split != NULL) {
		if (kstrtos16(split, 0, &val)) {
			hwlog_err("%s strtos16 fail\n", __func__);
			return -EINVAL;
		}
		para->als_para[level] = val;
		level++;
		if (level > COMMON_ALS_SIZE)
			break;
		split = strtok_s(NULL, ",", &context);
	}
	if (level != COMMON_ALS_SIZE) {
	...
	for (i = 0; i < COMMON_ALS_SIZE; i++)
		hwlog_info("%s: start screen_off_and_cct_data %d\n", __func__,
			para->als_para[i]);
	return ret;
}

ssize_t als_screen_off_and_cct_manual_store(int32_t tag, struct device *dev,
	struct device_attribute *attr, const char *buf, size_t count)
{
	int ret;
	struct write_info pkg_ap = {0};
	struct read_info pkg_mcu = {0};
	pkt_sensors_parameter_t para = {0};
	...
	if (als_extract_lux_cct_para((uint8_t *)buf, &g_als_para_tbl)) {
		hwlog_err("%s: extract fail\n", __func__);
		return -EINVAL;
	}
	if (memcpy_s(para.data, sizeof(para.data), g_als_para_tbl.als_para,
		sizeof(g_als_para_tbl.als_para)) != EOK) {
		hwlog_err("%s: memcpy_s fail %d %d \n", __func__,
			sizeof(para.data), sizeof(g_als_para_tbl.als_para));
		return -1;
	}
	para.sub_cmd = SUB_CMD_CONFIG_SCREEN_OFF_PARA_TABLE;
	pkg_ap.tag = tag;
	pkg_ap.cmd = CMD_CMN_CONFIG_REQ;
	pkg_ap.wr_buf = &para;
	pkg_ap.wr_len = sizeof(para);

	hwlog_info("%s: start config lux and cct para\n", __func__);
	ret = write_customize_cmd(&pkg_ap, &pkg_mcu, true);
	if (ret) {
		hwlog_err("%s: send pkg to mcu fail, ret=%d\n", __func__, ret);
		return -1;
...
ssize_t als_screen_off_and_cct_manual_show(int32_t tag, struct device *dev,
	struct device_attribute *attr, char *buf)
{
	int i;
	int ret;
	s16 *para = g_als_para_tbl.als_para;

	char *data_buf = buf;
	(void)memset_s(buf, MAX_STR_SIZE, 0, MAX_STR_SIZE);
	for (i = 0; i < COMMON_ALS_SIZE; i += (P_9TH + 1)) {
		char temp_buf[MAX_STR_SIZE] = {0};
		ret = snprintf_s(temp_buf, MAX_STR_SIZE, MAX_STR_SIZE - 1,
			"%d %d %d %d %d, %d %d %d %d %d\n", para[i + P_START],
			para[i + P_1ST], para[i + P_2ND], para[i + P_3RD],
			para[i + P_4TH], para[i + P_5TH], para[i + P_6TH],
			para[i + P_7TH], para[i + P_8TH], para[i + P_9TH]);
		if (ret <= 0) {
			hwlog_err("%s snprintf fail\n", __func__);
			return 0;
		}
...
void als_send_light_to_sensorhub(struct work_struct *als_work)
{
	...
	if (als_gamma_param_config(target_als, bright_para->als_bright.mipi_level)) {
		hwlog_info("%s: dkmd_alsc_update_degamma_coef tag=%d\n", __func__, target_als);
		if (target_als == TAG_ALS)
			dkmd_alsc_update_degamma_coef(&hisi_dkmd_alsc_init.degamma_coef, bright_para->als_bright.panel_id);
		else
			dkmd_alsc_update_degamma_coef(&hisi_dkmd_alsc1_init.degamma_coef, bright_para->als_bright.panel_id);
	}
#endif
...
static uint32_t als_ud_coef_block_xy_for_grl(struct als_platform_data *pf_data,
	...
	int block_xy)
{
	if (pf_data->als_phone_type != GRL && pf_data->als_phone_type != GLB)
		return 0;
	// process grl  glb y
	if (block_xy == BLOCK_Y) {
		if (head->tag == TAG_ALS)
	...
	struct als_device_info *dev_info, const struct pkt_header *head)
{
	...
	if (pf_data->als_phone_type == ALTB && head->tag == TAG_ALS1) {
		y = get_reduce_data(ALTB_BOE_VXN_RESOLUTION,
			dev_info->als_under_tp_cal_data.x);
	} else if (pf_data->als_phone_type == ICL && head->tag == TAG_ALS1) {
		y = get_reduce_data(ICL_BOE_VXN_RESOLUTION,
			dev_info->als_under_tp_cal_data.x);
	} else {
