...
enum de_iocfg_type {
	...
	IOCFG_TYPE_AOD_SAFEFRAME_PARAM = 9,
	IOCFG_TYPE_DEMURA_PARAM = 10,
	IOCFG_TYPE_SPR_GAMMA_PARAM = 11,
	IOCFG_TYPE_DBI_COMPENSATION_PARAM = 12,
	IOCFG_TYPE_DDIC_DEMURA_PARAM = 13,
	IOCFG_TYPE_ODC_PARAM = 14,
	IOCFG_TYPE_AOD_TYPE_PARAM = 15,
	IOCFG_TYPE_MAX,
};
/* -------------------- end -------------------- */
