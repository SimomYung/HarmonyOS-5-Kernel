...
#define ANGULAR_RATE_SENSITIVITY_ARR_LEN 2
#define GYRO_STATIC_CALI_LENGTH 3
#define GYRO_DYN_CALIBRATE_END_ORDER  5
#define GYRO_CALIB_DATA_LEN	24
...
struct gyro_platform_data {
	...
	uint32_t angular_rate_sensitivity[ANGULAR_RATE_SENSITIVITY_ARR_LEN];
#endif
...
struct gyro_device_info {
	...
	int32_t gyro_calib_data[GYRO_CALIB_DATA_LEN];
