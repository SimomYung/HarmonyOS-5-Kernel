...
#define PDC_SIZE 27
#define HALL_STATE_GPIO 195
#define HALL1_STATE_GPIO 246
...
#if defined(CHA_MAG_DETACH) || \
	defined(BBK_MAG_DETACH) || \
	defined(NSV_MAG_DETACH) || \
	defined(XIAN_MAG_DETACH) || \
	defined(CONFIG_INPUTHUB_MAG_EXTEND_DATA)
