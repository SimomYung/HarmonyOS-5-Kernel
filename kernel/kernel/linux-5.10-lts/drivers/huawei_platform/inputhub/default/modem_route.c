...
void connect_pcie_icc_sensorhub_route(struct hw_ap_cp_route_t *ap_cp_route)
{
	...
	memset_s(&icc_route, sizeof(struct hw_ap_cp_route_t), 0, sizeof(struct hw_ap_cp_route_t));
	memcpy_s(&icc_route, sizeof(struct hw_ap_cp_route_t), ap_cp_route, sizeof(struct hw_ap_cp_route_t));
