...
struct ps_platform_data {
	...
	int pwindows_value;                 /* pwindows default value */
	int pwave_value;                    /* pwave default value */
	int threshold_value;
	...
	uint16_t ps_calib_20cm_threshold;   /* 20cm min threshold */
	uint16_t ps_calib_5cm_threshold;    /* 5cm min threshold */
	uint16_t ps_calib_3cm_threshold;    /* 3cm min threshold */
	...
	uint16_t pwindows_max_threshold;
	uint16_t pwindows_min_threshold;
	uint16_t pwave_max_threshold;
	uint16_t pwave_min_threshold;
	uint16_t ps_calib_20cm_min_threshold;
	uint16_t ps_calib_5cm_min_threshold;
	uint16_t ps_calib_3cm_min_threshold;
	uint16_t default_xtalk;
	uint8_t offset_min_map;
#endif
};
