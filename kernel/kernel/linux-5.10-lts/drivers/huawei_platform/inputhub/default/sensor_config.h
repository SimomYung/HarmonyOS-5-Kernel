...
#define CAP_PROX_CALIDATA_NV_SIZE 64
...
#define CAP_PROX1_CALIDATA_NV_SIZE 64
#define CAP_PROX1_NV_NAME  "CSENSOR1"

#define COVER_CALIDATA_NV_NUM 471
#define COVER_CALIDATA_NV_SIZE 104
#define COVER_NV_NAME  "RSV471"
...
#define ALS_THRESHOLD_SIZE 3

#define ALS_GAMMA_CALI_LEN 4
...
struct als_under_tp_nv_type{
	...
	int b[ALS_UNDER_TP_B_COUNT]; /* 48 algrothm para, last 18 is gamma*/
};
...
struct als_under_tp_default_data {
...
typedef struct als_threshold {
	short low_th;
	short mid_th;
	short high_th;
} als_threshold_t;
struct als_threshold_para
{
	als_threshold_t threshold[ALS_THRESHOLD_SIZE];
};
...
enum {
	...
	ALS_CHIP_SIP3642,
	ALS_CHIP_SIP1226,
	ALS_CHIP_STK37670_RGB,
	ALS_CHIP_STK31862,
	ALS_CHIP_SIP1221LR,
	ALS_CHIP_HX32062SECR,
	ALS_CHIP_AMS_TCS3743,
	ALS_CHIP_UCS116E0,
	ALS_CHIP_SY3135,
	ALS_CHIP_SY81135_RGB,
};
...
struct als_device_info {
	...
	uint8_t als_use_default_nv;
	enum ret_type als_calibration_res;
	als_run_stop_para_t als_ud_data_upload;
	struct als_under_tp_calidata als_under_tp_cal_data;
	struct als_threshold_para als_threshold_para_data;
};
