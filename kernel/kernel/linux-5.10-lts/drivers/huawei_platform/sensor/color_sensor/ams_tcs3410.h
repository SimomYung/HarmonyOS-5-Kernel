...
#define TCS3410_SAMPLE_TIME_1K      719
#define ALS_NR_SAMPLES_1K           99
#define FD_NR_SAMPLES_1K            100
#define MAX_BUFFER_SIZE_1K          256
#define TCS3410_SAMPLE_TIME_2K      359
#define ALS_NR_SAMPLES_2K           199
#define FD_NR_SAMPLES_2K            200
#define ALS_QUICK_SAMPLE_TIME       14
#define FD_QUICK_NR_SAMPLES         15
#define ALS_DARK_DATA               30
#define MAX_BUFFER_SIZE_2K          512
#define CLOCK_DELAY_TIME            50
#define VSYNC_CFG_VAL               0x4
#define TRIGGER_MODE_VAL            0x5
#define INVALID_DENOMINATOR         0
#define HIGH_THRESHOLD              14305567 // (1.38889 + 1.38889 * 3%) * 10000000
#define LOW_THRESHOLD               13472233 // (1.38889 - 1.38889 * 3%) * 10000000
#define BUFF_LEN                    2
#define TIME_CONVERSION             10000
#define SAMPLE_2KHZ                 5000000000 // 500us*10000000
#define SAMPLE_1KHZ                 10000000000 // 1000us*10000000
#define FLK_CALI_POLLING_TIME       50
#define SW_VSYNC_TRIGGER            1
...
#define ALS_FAST_POLLING_TIME       10
#define ALS_POLLING_CNT             20
#define ALS_NORMAL_POLLING_TIME     90
...
#define EACH_TIME_WAIT_TIME         2
#define WAIT_TIME_MAX               70
...
#define STEP0_C_VAL_100             100
#define STEP1_C_VAL_1000            1000
#define CANNEL_MAX_CONT             65535
#define IDLE_STEP                   0
#define ENTER_STEP0                 1
#define ENTER_STEP1                 2
// Register map
...
struct tcs3410_ctx {
	...
	uint8_t enable;
	uint8_t step;
	uint8_t fd_delay_enable;
	bool is_change_gain;
	uint8_t als_first_report;
	uint32_t step0_c_val;
	uint32_t step1_c_val;
