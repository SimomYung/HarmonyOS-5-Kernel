...
void tcs3430_als_timer_handle(struct timer_list *t)
{
...
static uint32_t tcs3430_als_cali_rgbc(struct rgb_cali_tar_t *cali_val)
{
	uint32_t result;
...
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(5, 10, 0))
	timer_setup(&chip->work_timer, tcs3430_als_timer_handle, 0);
#else
