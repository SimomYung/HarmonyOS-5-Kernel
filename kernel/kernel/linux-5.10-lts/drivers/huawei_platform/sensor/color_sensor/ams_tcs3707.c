...
static void tcs3707_als_timer_wrk(struct timer_list *t)
{
...
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(5, 10, 0))
static void tcs3707_flc_timer_wrk(struct timer_list *t)
{
...
static uint32_t tcs3707_als_cali_rgbc(struct rgb_cali_tar_t *cali_val)
{
	uint32_t result;
