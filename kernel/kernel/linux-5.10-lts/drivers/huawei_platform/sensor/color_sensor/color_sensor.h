...
#define DEFAULT_FLk_DATA_SIZE          1024
#define DEFAULT_FLK_DATA_LEN           256
#define NV_READ_TAG                    1
#define NV_WRITE_TAG                   0
#define CONVERT_INT_TO_CHAR            4
...
#define RGB_I2C_ERR_DMD_PRINT_CNT_MAX   500
#define RGB_DMD_REPORT_MAX_CNT          20
#define FLK_ID                          0
#define RGB_ID                          1
...
enum report_type {
	...
	AWB_SENSOR_RAW_SEQ_TYPE_TCS3410 = 10,
	AWB_SENSOR_RAW_SEQ_TYPE_SIP2326 = 11,
...
struct color_chip {
	...
	struct timer_list fd_cali_timer;
	struct work_struct fd_cali_work;
	struct device *dev;
