...
{
	int max_thr = BU27006_FLC_1K_HIGH_LEVEL;
...
static void bu27006_als_timer_wrk(struct timer_list *t)
{
...
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(5, 10, 0))
static void bu27006_flc_timer_wrk(struct timer_list *t)
{
...
static uint32_t bu27006_als_cali_rgb(struct rgb_cali_tar_t *cali_val)
{
	uint32_t result;
