...
#define SHORT_ITIME 5
#define FLICKER_ITIME_2K 500 //us, flicker inte-time,
#define FLICKER_ITIME_1K 1000 //us, flicker inte-time,
#define DEFAULT_IGAIN 128
#define DEFAULT_IGAIN_COUNT 9
#define FIRST_IGAIN 12
...
#define SATURATION_LOW_PERCENT 60
#define SATURATION_HIGH_PERCENT 85
...
#define CALI_ACCORD_1K 1
#define CALI_ACCORD_2K 2

#define REPORT_FIFO_LEN 256
...
#define AUTOZERO_TIMER_OFFSET 15
#define FIRST_FLAG_MAX_COUNT 20
...
#define FREQUENCY_TOLERANCE_PERCENT 10 // Deviation Threshold（10/1000）
...
struct sip2326_als_ctx_t {
	...
	uint32_t cpl0;
	uint32_t cpl1;
	bool first_flag_after_enable;
	struct sip2326_adc_data_t adc_data;
	uint8_t first_flag_count;
	uint32_t curr_itime;
};
...
struct sip2326_flicker_cali_ctx_t {
	uint32_t time_start;
	uint32_t time_end;
	uint16_t fd_timer_cnt;
	uint16_t fd_data_cnt;
	uint16_t target_data_cnt;
	UINT8 fd_cali_freq;
};
...
struct sip2326_ctx {
	...
	struct sip2326_flicker_cali_ctx_t flc_cali_ctx;
};
