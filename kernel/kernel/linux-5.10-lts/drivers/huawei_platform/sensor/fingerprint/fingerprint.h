...
#define EVENT_FINGER_NAV_DOWN     121
#define EVENT_FINGER_NAV_UP   122
#define EVENT_FINGER_NAV_CILCK   123
#define EVENT_FINGER_NAV_DOWN_SECOND   124
#define EVENT_FINGER_NAV_FINISH   125
#define EVENT_FINGER_NAV_HOLD   126
#define EVENT_FINGER_NAV_TOUCH	127
#define EVENT_FINGER_OPEN_AFT   200
#define EVENT_FINGER_CLOSE_AFT  201
...
#define FP_IOC_CMD_FINGER_POSITION_EVENT      _IO(FP_IOC_MAGIC, 32)
...
enum fp_lcd_state {
	FP_LCD_STATE_NULL = -1,
	FP_LCD_POWER_ON = 11,
	FP_LCD_BACKLIGHT_ON = 12,
	FP_LCD_POWER_OFF = 31,
	FP_LCD_BACKLIGHT_OFF = 32,
};
...
struct fingerprint_position_info {
	int finger_rel_x;
	int finger_rel_y;
};
