...
#define REG_VALUE 2
#define REG_MAX 3
#define UPDATE_EVT_APPEND_MAX 20
#define UPDATE_EVT_MAX 70
#define HI1162_ROMLOADER_TYPE 0
#define HI1162_CODELOADER_TYPE 1
#define HI1162_RESET_WAIT_TIME 1000

#define HI1162_OTA_FW_BASE 0x300
#define HI1162_SPARKLINK_STR_LEN 9
#define HI1162_OTA_FW_OFFSET (HI1162_OTA_FW_BASE + HI1162_SPARKLINK_STR_LEN)
#define HI1162_OTA_PATH "sparklink/hi1162OTA.bin"
#define HI1162_FAULT_APP_VERSION 0x0
...
#define HI1162_IRQ_RINGING_REPORT             BIT(3)
...
struct hi1162_device_info {
	...
	int reset_gpio;
	int irq_gpio;
	unsigned int power_always_on;
	int buck_boost_en_gpio;
	int i2c_switch_gpio;
	int pmu_116x_pwr_gpio;
	int pmu_shutdown_alive_gpio;
	u16 irq_val;
	int wakeup_gpio;
	int irq;
	bool irq_active;
	...
	unsigned int support_gpio_reverse;
	unsigned int support_ringing;
	unsigned int support_update_in_air;
	unsigned int uart_desc;
