	...
	struct device_node *np)
{
	...
	(void)power_dts_read_u32(power_dts_tag(HWLOG_TAG), np,
		"pogopin_charge_iin", &di->pogopin_iin, POGOPIN_IIN_CURRENT);

	(void)power_dts_read_u32(power_dts_tag(HWLOG_TAG), np,
		"pogopin_charge_ichg", &di->pogopin_ichg, POGOPIN_ICHG_CURRENT);
