...
#ifdef CONFIG_TCPC_RT1715
/* Cable auth err conde */
#define PD_AUTH_COMM_ERR   (-1)
#define PD_AUTH_SWAP_ERR   (-2)
#define PD_AUTH_VCONN_ERR  (-3)
#define PD_AUTH_SEND_ERR   (-4)
#endif
...
#ifdef CONFIG_TCPC_RT1715
static inline int tcpm_get_cable_uvdm(
	void *client, uint32_t *data, uint8_t cnt)
{
	return TCPM_ERROR_NO_IMPLEMENT;
}
#endif
