...
#define AW_WORK_DELAY_500MS				(500)
#define AW_WORK_DELAY_1S				(1000)
#define AW_DELAY_1000US					(1000)
#define AW_DELAY_2000US					(2000)
#define AW_DELAY_8000US					(8000)
#define AW_DELAY_8500US					(8500)
...
#define AW_HAPTIC1_NAME                "haptics1"
...
#define AW_IGNORE_STOP_CMD_TIME                 30
#define AW_MID_F0_VAL                           170
#define AW_F0_LOW_VAL                           160
#define AW_F0_HIGH_VAL                          180
#define AW_F0_DATA_COFF                         10
#define AW_F0_INTERVAL_BIAS                     3
#define AW_CAL_INTE_F0_BIAS                     1
...
#define AW_DMD_REPORT_MAX_CNT               20

#define AW8692X_REG_SYSINTM                 3
#define AW8692X_REG_SYSINTM_RESET           0xff
#define AW8692X_ALL_REG                     0x7c
...
struct aw_haptic_func {
	...
	void (*short_ram_brk_cfg_set)(struct aw_haptic *);
	void (*long_ram_brk_cfg_set)(struct aw_haptic *);
