...
#define FXZ_START_CMD_FAC _IO(RF_IOCTL_MAGIC_FAC, 6)
#define FXZ_STOP_CMD_FAC _IO(RF_IOCTL_MAGIC_FAC, 7)
...
#define FXZ_START_CMD_RELEASE _IO(RF_IOCTL_MAGIC_RELEASE, 4)
#define FXZ_STOP_CMD_RELEASE _IO(RF_IOCTL_MAGIC_RELEASE, 5)
