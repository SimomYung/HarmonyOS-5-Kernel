...
struct ps_core_s {
	...
	int32_t core_en_gpio; // GPIO226 for ws_x1 1V2 and 3V3

	int32_t radio_avdd_en; // GPIO81 for ws_x1 avdd en
	int32_t lna_ldo_num; // LDO53 2.85V for ws_x1 LNA
	int32_t lna_ldo_vol;
