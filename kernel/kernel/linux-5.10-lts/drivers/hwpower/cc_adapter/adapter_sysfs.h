...
#define ADAPTER_BUF_MAX_SIZE 128
...
struct adapter_sysfs_show_struct {
	int (*process)(struct adapter_sysfs_dev *di, char *buf, size_t offset);
	size_t offset;
};
