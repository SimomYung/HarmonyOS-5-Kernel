...
static void wlrx_parse_rx_ic_cfg(struct wlrx_dts *dts)
{
	...
	(void)power_dts_read_u32(power_dts_tag(HWLOG_TAG), np,
		"wired_5votg_restore_delay", (u32 *)&dts->wired_5votg_restore_delay, 0);
}
...
static int wlrx_parse_basic_cfg(const struct device_node *np, struct wlrx_dts *dts)
{
	...
	(void)power_dts_read_u32(power_dts_tag(HWLOG_TAG), np,
		"wired_close_5votg", (u32 *)&dts->wired_close_5votg, 0);
	wlrx_parse_rx_ic_cfg(dts);
