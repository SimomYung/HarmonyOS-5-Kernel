...
/* pwr_type: 5VBST_RVSSC_CP */
const struct wltx_pwr_attr g_attr11[] = {
	{ PWR_SW_BY_VBUS_ON,  true,  PWR_SRC_5VBST },
	{ PWR_SW_BY_VBUS_OFF, true,  PWR_SRC_5VBST },
	{ PWR_SW_BY_OTG_ON,   false, PWR_SRC_5VBST },
	{ PWR_SW_BY_OTG_OFF,  true,  PWR_SRC_5VBST },
...
/* pwr_type: 5VBST_9VOTG */
const struct wltx_pwr_attr g_attr12[] = {
	{ PWR_SW_BY_VBUS_ON,  true,  PWR_SRC_5VBST },
	{ PWR_SW_BY_VBUS_OFF, true,  PWR_SRC_9VOTG },
	{ PWR_SW_BY_OTG_ON,   true,  PWR_SRC_5VBST },
	{ PWR_SW_BY_OTG_OFF,  true,  PWR_SRC_9VOTG }
};

/* pwr_type: 5VBST_5VBST_9VOTG */
const struct wltx_pwr_attr g_attr13[] = {
	{ PWR_SW_BY_VBUS_ON,  true,  PWR_SRC_5VBST },
	{ PWR_SW_BY_VBUS_OFF, true,  PWR_SRC_5VBST },
	{ PWR_SW_BY_OTG_ON,   true,  PWR_SRC_5VBST },
	{ PWR_SW_BY_OTG_OFF,  true,  PWR_SRC_5VBST },
	{ PWR_SW_BY_SOC_HIGH, true,  PWR_SRC_9VOTG },
	{ PWR_SW_BY_PREVFOD,  true,  PWR_SRC_5VBST }
};

/* pwr_type: 5VBST_VBUS_OTG_CP2 */
const struct wltx_pwr_attr g_attr14[] = {
	{ PWR_SW_BY_VBUS_ON,  true,  PWR_SRC_5VBST },
	{ PWR_SW_BY_VBUS_OFF, true,  PWR_SRC_OTG_CP },
	{ PWR_SW_BY_OTG_ON,   true, PWR_SRC_5VBST },
	{ PWR_SW_BY_OTG_OFF,  true,  PWR_SRC_OTG_CP },
...
static struct {
	...
	{ WL_TX_PWR_5VBST_RVSSC_CP, "5VBST_RVSSC_CP", g_attr11, ARRAY_SIZE(g_attr11) },
	{ WL_TX_PWR_5VBST_9VOTG, "5VBST_9VOTG", g_attr12, ARRAY_SIZE(g_attr12) },
	{ WL_TX_PWR_5VBST_5VBST_9VOTG, "5VBST_5VBST_9VOTG", g_attr13, ARRAY_SIZE(g_attr13) },
	{ WL_TX_PWR_5VBST_VBUS_OTG_CP2, "5VBST_VBUS_OTG_CP2", g_attr14, ARRAY_SIZE(g_attr14) }
};
...
static void wltx_update_soc_high_scn(struct wltx_dev_info *di)
{
	...
	if (!dts || ((dts->pwr_type != WL_TX_PWR_5VBST_OTG_RVSSC_CP) &&
		...
		(dts->pwr_type != WL_TX_PWR_5VBST_5VBST_9VOTG)))
		return;
...
int wltx_enable_pwr_supply(void)
{
	...
	if (wltx_pwr_need_set_init_pwr_src()) {
		wltx_cap_set_exp_id(WLTRX_IC_MAIN, WLTX_DFLT_CAP);
		src = dts->init_pwr_src;
	}
...
void wltx_enable_extra_pwr_supply(void)
{
	...
	case WL_TX_PWR_5VBST_VBUS_OTG_CP2:
...
int wltx_pwr_prevfod_switch_pwr_handler(void)
{
	struct wltx_dev_info *di = wltx_get_dev_info();
	struct wltx_dts *dts = wltx_get_dts();
	const struct wltx_pwr_attr *attr = NULL;

	if (!di || !dts)
		return -EINVAL;

	if (di->rx_product_id != dts->product_id)
		return -ENOTSUPP;

	di->can_switch_pwr_src = true;
	attr = wltx_get_pwr_attr(dts->pwr_type, di->cur_pwr_sw_scn);
	if (!attr->need_sw || (attr->src == di->cur_pwr_src))
		return -ENOTSUPP;
...
bool wltx_pwr_need_set_init_pwr_src(void)
{
	struct wltx_dev_info *di = wltx_get_dev_info();
	struct wltx_dts *dts = wltx_get_dts();
