...
#define SC8565_DEVICE_VER                         0xA0
#define BK1865_DEVICE_VER                         0xA5
...
#define BK1865_DEVICE_ID_BK1865                   0x2D
...
struct sc8562_device_info {
	...
	int lvc_switching_frequency;
	int sc_switching_frequency;
	int sc4_switching_frequency;
	int sense_r_actual;
	int sense_r_config;
	int dts_scp_support;
	int dts_fcp_support;
