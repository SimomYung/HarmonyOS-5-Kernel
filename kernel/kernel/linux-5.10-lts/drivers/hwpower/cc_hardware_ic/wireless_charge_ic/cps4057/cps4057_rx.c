...
static int cps4057_rx_get_ping_fop(int *fop, void *dev_data)
{
	return cps4057_read_word(CPS4057_RX_PING_FOP_VAL_ADDR, (u16 *)fop);
}

static int cps4057_rx_get_ping_vrect(int *vrect, void *dev_data)
{
	return cps4057_read_word(CPS4057_RX_PING_VRECT_VAL_ADDR, (u16 *)vrect);
}
...
static struct wlrx_ic_ops g_cps4057_rx_ic_ops = {
	...
	.get_ping_fop           = cps4057_rx_get_ping_fop,
	.get_ping_vrect         = cps4057_rx_get_ping_vrect,
