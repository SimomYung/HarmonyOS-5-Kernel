...
/* for force to full bridge*/
#define CPS4067_TX_FORCE_FULL_BRIDGE          0
...
enum cps4067_dummy_iload {
	...
	CPS4067_DUMMY_ILOAD_12V_NO_MOD,
	CPS4067_DUMMY_ILOAD_12V_MOD,
...
struct cps4067_dev_info {
	...
	u32 rx_prevfod_offset;
	u32 rx_prevfod_offset_unit;
	u32 rx_ss_low_thr;
	bool can_boost;
	u8 force_full_bridge;
};
