...
#define CPS8601_TX_IRQ_FOD_GAP                BIT(14)
/* tx_irq_clr register */
...
#define CPS8601_TX_CMD_SWITCH_MODEM           BIT(7)
#define CPS8601_TX_CMD_SWITCH_MODEM_SHIFT     7
/* func_en register */
...
/* tx_ploss_diff_min register */
#define CPS8601_TX_PLOSS_DIFF_MIN_ADDR        0x005C
#define CPS8601_TX_PLOSS_DIFF_MIN_LEN         2
#define CPS8601_TX_PLOSS_DIFF_MIN_VAL         300
/* tx_curr_cnt_max register */
#define CPS8601_TX_CURR_CNT_MAX_ADDR          0x0061
#define CPS8601_TX_CURR_CNT_MAX_LEN           1
#define CPS8601_TX_CURR_CNT_MAX_VAL           3
/* tx_curr_max  register */
#define CPS8601_TX_CURR_MAX_ADDR              0x0064
#define CPS8601_TX_CURR_MAX_VAL               850
/* tx_curr_step register */
#define CPS8601_TX_CURR_STEP_ADDR             0x0066
#define CPS8601_TX_CURR_STEP_LEN              1
#define CPS8601_TX_CURR_STEP_VAL              120
/* tx_fod_limit_power register */
#define CPS8601_TX_LIMIT_POWER_CTL_ADDR       0x006A
#define CPS8601_TX_LIMIT_POWER_CTL_LEN        1
#define CPS8601_TX_LIMIT_POWER_EN             1
/* tx_fod_gap  register */
#define CPS8601_TX_FOD_GAP_ADDR               0x006C
#define CPS8601_TX_FOD_GAP_TH                 100
/* tx_curr_step register */
#define CPS8601_TX_Q_TH_CRC_ADDR              0x0070
#define CPS8601_TX_Q_TH_CRC_LEN               2
/* tx_curr_step register */
#define CPS8601_TX_Q_TH_CNT_LOW_ADDR          0x0072
#define CPS8601_TX_Q_TH_CNT_LOW_LEN           1
/* tx_curr_step register */
#define CPS8601_TX_Q_TH_CNT_HIGH_ADDR         0x0073
#define CPS8601_TX_Q_TH_CNT_HIGH_LEN          1
/* tx_curr_step register */
#define CPS8601_TX_Q_TH_WIDTH_LOW_ADDR        0x0074
#define CPS8601_TX_Q_TH_WIDTH_LOW_LEN         2
/* tx_curr_step register */
#define CPS8601_TX_Q_TH_WIDTH_HIGH_ADDR       0x0076
#define CPS8601_TX_Q_TH_WIDTH_HIGH_LEN        2
/*
 * firmware register
 */
...
#define CPS8601_SRAM_PAGE_SIZE                16
/* fw cmd addr */
...
/* i2c slave addr */
#define CPS8601_I2C_SLAVE_ADDR                0x41
#define CPS8602_I2C_SLAVE_ADDR                0x42
