...
static int mt5735_rx_get_ping_fop(int *fop, void *dev_data)
{
	int ret;

	ret = mt5735_read_word(MT5735_RX_PING_FOP_VAL_ADDR, (u16 *)fop);
	*fop /= MT5735_RX_PING_FOP_VAL_UNIT;
	return ret;
}

static int mt5735_rx_get_ping_vrect(int *vrect, void *dev_data)
{
	return mt5735_read_word(MT5735_RX_PING_VRECT_VAL_ADDR, (u16 *)vrect);
}
...
static struct wlrx_ic_ops g_mt5735_rx_ic_ops = {
	...
	.get_ping_fop           = mt5735_rx_get_ping_fop,
	.get_ping_vrect         = mt5735_rx_get_ping_vrect,
