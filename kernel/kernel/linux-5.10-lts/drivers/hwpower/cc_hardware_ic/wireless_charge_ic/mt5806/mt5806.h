...
#define MT5806_CLEAR_FOD_GAP                 0
#define MT5806_FOD_GAP_SUCC                  1
#define MT5806_FOD_GAP_FAIL                  0
#define MT5806_Q_THRESHOLD_NUM               4
#define MT5806_Q_THRESHOLD_LEN               10
#define MT5806_Q_THRESHOLD_CRC_LEN           2
...
enum mt5806_q_hiview_index {
	MT5806_Q_HIVIEW_BEGIN = 0,
	MT5806_Q_HIVIEW_FAC_WIDTH = MT5806_Q_HIVIEW_BEGIN,
	MT5806_Q_HIVIEW_DYN_WIDTH,
	MT5806_Q_HIVIEW_SPL_WIDTH,
	MT5806_Q_HIVIEW_FLAG,
	MT5806_Q_HIVIEW_MAX,
};
...
struct mt5806_tx_q_threshold_para {
	s16 tx_q_cnt_high;
	s16 tx_q_cnt_low;
	s16 tx_q_width_high;
	s16 tx_q_width_low;
...
union mt5806_tx_q_threshold_data {
	struct mt5806_tx_q_threshold_para tx_q_threshold;
	u8 tx_q_config[MT5806_Q_THRESHOLD_LEN];
};
...
struct mt5806_dev_info {
	...
	union mt5806_tx_q_threshold_data tx_q_th;
