...
#define  BOOTACK_TIMEOPUT_COUNTER	0x08
...
#define CFG_DATA_TIMEOUT_STEP 0x4
#define SDEMMC_TIMING_CTRL_2    0x9a
...
#define  SDHCI_CTRL_HS_HS400		0x0005
#else
...
#define SDHCI_TUNING_MODE_RESERVED	3
	...
	u64			data_timeout;
    int         delay_num;
    u32         bootack_timeoupt_counter;
    u32         cfg_data_timeout_step;
