...
/*========================================================================
      SDC shared DDR 0x11700000 ~ 0x11800000 = 1M
==========================================================================*/
...
/*========================================================================
      SENSORHUB SHMEMEXT 6M None Secure 0x11800000 0x11E00000
==========================================================================*/
/*    |-----Total 6M-----
      |-----1.5M-----|---cell location---|
      |-----0.5M-----|---flp heap alloc--| // flp_batching_loc_data & ddr map data
      |-----1.0M-----|---dump------------|  //rw
      |-----3.0M-----|---AOD-------------|
*/
...
/*========================================================================
      SENSORHUB SHMEM1 FOR IPC 	0x11E00000 ~ 0x11E40000 = 256K
==========================================================================*/
...
/* replay */
/* reuse largeblk end 32K, it only affects when replay in dump/inject mode */
...
/*========================================================================
      SENSORHUB SHMEM FOR LOG BUFFER  0x11E40000 ~ 0x11EC0000 = 512K
==========================================================================*/
...
/*========================================================================
      SENSORHUB DDR RESERVED   0x12600000 ~ 0x13000000  10M Secure
==========================================================================*/
...
/*    |-----Total 10M-----|
      |-----3.496M---|---image------|  //r
      |-----4K-------|---f2l--------|  //r
      |-----1M-------|---ddr code---|  //cacheable,re MPU_REGION_10
      |-----0.5M-----|---ddr data---|  //cacheable,rw MPU_REGION_11
      |-----0.5M-----|---ddr heap---|  //cacheable,rw MPU_REGION_11
      |--0.5M + 448K-|---reserved---|  //rw MPU_REGION_7
      |------64K-----|---ipc shmem--|  //rw
      |-----0.5M-----|---fp image---|  //rw
      |-----3.0M-----|---TP---------|  //rw
*/
...
#define DDR_DATA_BASE_AP                   (DDR_CODE_END_AP + 0x80000)
#define DDR_DATA_SIZE                      (0x80000)
#define DDR_DATA_END_AP                    (DDR_DATA_BASE_AP + DDR_DATA_SIZE)

#define DDR_HEAP_START_AP                  DDR_DATA_END_AP
