...
#define MAX_PERI_MONITOR0_DEVICE	bit_count(MONITOR0_IP_MASK) /* 21 */

#define MONITOR1_IP_MASK	0xFFFFFFFB
#define MAX_PERI_MONITOR1_DEVICE	bit_count(MONITOR1_IP_MASK) /* 31 */

#define MEDIA_MONITOR0_IP_MASK	0x1FFFFFF4
#define MAX_MEDIA_MONITOR0_DEVICE	bit_count(MEDIA_MONITOR0_IP_MASK) /* 26 */

#define MEDIA_MONITOR1_IP_MASK	0x7FF81FFF
#define MAX_MEDIA_MONITOR1_DEVICE	bit_count(MEDIA_MONITOR1_IP_MASK) /* 25 */

#define AO_MONITOR0_IP_MASK	0xFF03FF77
#define MAX_MONITOR_IP_DEVICE_AO	bit_count(AO_MONITOR0_IP_MASK) /* 24 */
...
typedef union
{
    ...
    struct
    {
        unsigned int  peri_vote_vol_rank_0 : 2;  /* bit[0-1]  :  */
...
typedef union
{
    ...
    struct
    {
        unsigned int  peri_vote_vol_rank_8  : 2;  /* bit[0-1]  :  */
...
typedef union
{
    ...
    struct
    {
        unsigned int  peri_vote_vol_valid_0  : 1;  /* bit[0]    :  */
