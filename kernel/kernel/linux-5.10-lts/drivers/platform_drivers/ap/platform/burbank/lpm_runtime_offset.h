...
#define RUNTIME_SHARE_MEM_END_ADDR              (RUNTIME_DDR_VAR_ADDR + RUNTIME_DDR_VAR_SIZE) /* must be divided by 4 */
#define RUNTIME_LPMCU_RUN_VAR_ADDR              RUNTIME_SHARE_MEM_END_ADDR  /* offset 0x100 */
...
#define RUNTIME_SLEEP_TIME_ADDR                 (RUNTIME_SR_VAR_BASE_ADDR + 0x110) /* 32K SLEEP TIME */
...
#else
#define INT_LONG_TIME_TRACK_OFFSET              0x9d4 /* (INT_LONG_TIME_TRACK_BASE - LPMCU_GEN_MNTN_BASE) = 0x20CF4 - 0x20340 */
#define IRQ_MASK_LONG_TIME_TRACK_OFFSET         0xa34 /* (IRQ_MASK_LONG_TIME_TRACK_BASE - LPMCU_GEN_MNTN_BASE) = 0x20D54 - 0x20340 */
#define STACK_BACKUP_SRAM_OFFSET                0x470 /* (STACK_BACKUP_SRAM_BASE - LPMCU_GEN_MNTN_BASE) = 0x20790 - 0x20340 */
#endif
