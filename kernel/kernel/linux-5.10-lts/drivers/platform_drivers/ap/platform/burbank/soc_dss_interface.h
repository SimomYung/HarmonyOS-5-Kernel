 ...
 * Description: soc_dss_interface.h
 * Author: Hisilicon
 * Create: 2019-10-29
 */
...
// Refer to the WCH page but not the Memory Map
...
#define DSS_DPP_GMP_LUT_OFFSET	(0xDE000)//(0x73000)
...
** CLD
*/
#define CLD_OFFSET      (DSS_RCH_D2_DMA_OFFSET) // CLD is supported in DSS D2 channel.
...
** ALSC
*/
#define ALSC_OFFSET                 (DSS_DISP_CH0_OFFSET) // ALSC is supported in DISP_CH0.
...
#define ALSC_ADDR_BLOCK             (0x1A00) // ADDR_BLOCK address range 0x1A00-0x1A74, which contains 30 blocks.
#define ALSC_AVE_BLOCK              (0x1A80) // AVE_BLOCK address range 0x1A80-0x1AF4, which contains 30 blocks.
#define ALSC_COEF_BLOCK_R_OFFSET    (0x1B00) // COEF_BLOCK_R address range 0x1B00-0x1B74, which contains 30 blocks.
#define ALSC_COEF_BLOCK_G_OFFSET    (0x1B80) // COEF_BLOCK_G address range 0x1B80-0x1BF4, which contains 30 blocks.
#define ALSC_COEF_BLOCK_B_OFFSET    (0x1C00) // COEF_BLOCK_B address range 0x1C00-0x1C74, which contains 30 blocks.
#define ALSC_COEF_BLOCK_C_OFFSET    (0x1C80) // COEF_BLOCK_C address range 0x1C80-0x1CF4, which contains 30 blocks.
#define U_DEGAMMA_R_COEF            (0x5000) // DEGAMMA_R_COEF address range 0x5000-0x51FC, which contains 128 blocks.
#define U_DEGAMMA_G_COEF            (0x5400) // DEGAMMA_G_COEF address range 0x5400-0x55FC, which contains 128 blocks.
#define U_DEGAMMA_B_COEF            (0x5800) // DEGAMMA_B_COEF address range 0x5800-0x59FC, which contains 128 blocks.
...
#define ARSR2P_SHARP_CFG3 (0x058) // (0x088)
#define ARSR2P_SHARP_CFG4 (0x05C) // (0x08C)
#define ARSR2P_SHARP_CFG5 (0x060) // (0x090)
#define ARSR2P_SHARP_CFG6 (0x064) // (0x094)
#define ARSR2P_SHARP_CFG7 (0x068) // (0x098)
#define ARSR2P_SHARP_CFG8 (0x06C) // (0x09C)
...
#define SPR_COEFF_OFFSET (0x020) // 0x20-0xAC
#define SPR_BORDERLR_REG (0X0B0) // 0xB0-0xC4
#define SPR_PIXGAIN_REG (0x0C8)
#define SPR_PIXGAIN_REG1 (0x0CC)
#define SPR_BORDER_POSITION0 (0x0D0) // 0xD0-0xDC
#define SPR_R_DIFF_REG (0x0E0) // R:0x0E0, G:+0xC, B:+0xC
#define SPR_R_WEIGHT_REG0 (0x0E4) // R:0x0E0, G:+0xC, B:+0xC
#define SPR_R_WEIGHT_REG1 (0x0E8) // R:0x0E0, G:+0xC, B:+0xC
...
#define DSC_RC_THRE (0x25C) // 0x25C-0x268
#define DSC_RC_PARAM (0x26C)  // 0x25C-0x2A4
