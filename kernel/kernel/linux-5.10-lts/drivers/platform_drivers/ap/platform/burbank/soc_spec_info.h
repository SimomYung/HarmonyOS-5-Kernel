...
typedef union
{
	...
	struct
	{
		unsigned int reserved : 22;     /* bit[0-21]  */
		unsigned int chip_version :  2; /* bit[22-23] */
...
/* 
SOC_ACPU_SCTRL_BASE_ADDR_DEFINE same as SOC_ACPU_SCTRL_BASE_ADDR:
#define SOC_ACPU_SCTRL_BASE_ADDR                                (0xFA89B000)
SOC_LPMCU_SCTRL_BASE_ADDR_DEFINE same as SOC_LPMCU_SCTRL_BASE_ADDR:
...
/* 
SOC_##core_type##_SCTRL_BASE_ADDR_DEFINE is the base, 0x43CUL is the offset
same as:
...
/* es not support, cs/aio chip default spec level1 */
