...
enum bbox_diaginfo_errid {
    ...
    /* vcodec module start 925211600*/
    DMD_SOC_VDEC_START       = 925211600,
    DMD_SOC_VDEC_MCU_CRASH = DMD_SOC_VDEC_START,
    DMD_SOC_VDEC_PXP_TIMEOUT = 925211601,
    DMD_SOC_VDEC_BSP_TIMEOUT = 925211602,
    DMD_SOC_VDEC_SH_CNT      = 925211603,
    DMD_SOC_VDEC_END         = 925211799,

    DMD_SOC_VENC_START       = 925211800,
    DMD_SOC_VENC_END         = 925211999,
    /* vcodec end 925211999*/
	...
	DMD_HIGPU_ENTRY_TIMEOUT = 925212907,
	DMD_HIGPU_SELF_RECOVERY = 925212908,
