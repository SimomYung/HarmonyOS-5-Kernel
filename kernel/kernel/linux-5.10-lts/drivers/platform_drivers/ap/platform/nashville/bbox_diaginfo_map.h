...
/* vcodec start */
__DIAGINFO_MAP(DMD_SOC_VDEC_MCU_CRASH, VDEC, WARNING, HW)
__DIAGINFO_MAP(DMD_SOC_VDEC_PXP_TIMEOUT, VDEC, WARNING, HW)
__DIAGINFO_MAP(DMD_SOC_VDEC_BSP_TIMEOUT, VDEC, WARNING, HW)
__DIAGINFO_MAP(DMD_SOC_VDEC_SH_CNT, VDEC, WARNING, HW)
/* vcodec end */
...
__DIAGINFO_MAP(DMD_HIGPU_ENTRY_TIMEOUT, HIGPU, WARNING, SW)
__DIAGINFO_MAP(DMD_HIGPU_SELF_RECOVERY, HIGPU, INFO, SW)
...
__DIAGINFO_MODULE_MAP(VDEC)
__DIAGINFO_MODULE_MAP(VENC)
