...
struct ch24_addr_map {
	unsigned int capacity_magic;
	unsigned int rankmap_ac;
	unsigned int rankmap_bd;
	unsigned int intlv_area_addr0_gbyte;
	unsigned int intlv_area_addr1_gbyte;
	unsigned int target_intlv_area_sel;
