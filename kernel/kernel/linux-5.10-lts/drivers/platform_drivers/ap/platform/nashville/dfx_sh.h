...
enum sh_type {
	...
	sh_type_cluster_1,
	sh_type_cluster_big,
	sh_type_cluster_2 = sh_type_cluster_big,
...
#define SH_SW_CNT_THRESHOLD_ISP       2
#define SH_SW_CNT_THRESHOLD_GPU_PIM   2
...
static const struct sh_sw_cnt g_sh_sw_cnt[sh_type_max] = 
{
	...
	{ SH_VALUES_NOT_NEEDED, SH_SW_CNT_THRESHOLD_ISP,
	 SH_VALUES_NOT_NEEDED, SH_CFG_ENABLE},
	{ SH_VALUES_NOT_NEEDED, SH_SW_CNT_THRESHOLD_GPU_PIM,
	 SH_VALUES_NOT_NEEDED, SH_CFG_ENABLE},
};

#define SH_CLEAR_INTERVAL_ENABLE_CFG  0b1111111
...
#define SH_CLEAR_INTERVAL_ISP    (1 * 24 * 3600)
#define SH_CLEAR_INTERVAL_GPU_PIM  (30 * 24 * 3600)
...
static const unsigned int g_sh_clear_interval[sh_type_max] = 
{
	...
	SH_CLEAR_INTERVAL_GPU_PIM,
};

#define SH_LU_ENABLE_CFG  SH_CFG_DISABLE

#define SH_DFV_ENABLE      SH_CFG_ENABLE
#define SH_DFV_THRESHOLD   2
...
#define SH_SW_CNT_THRESHOLD_HFRC      0
#define SH_HFRC_ENABLE_CFG            SH_CFG_DISABLE

#define SH_VDEC_ENABLE_CFG  SH_CFG_ENABLE

#define SH_DSS_ENABLE_CFG   SH_CFG_ENABLE
