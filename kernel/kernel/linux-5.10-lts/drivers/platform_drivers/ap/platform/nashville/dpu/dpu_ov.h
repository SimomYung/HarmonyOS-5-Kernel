...
static int g_itm_gamut_p32srgb_coef[MITM_GAMUT_COEF_LEN] = {1254, -229, 0, -42, 1066, 0, -20, -80, 1124};
static int g_itm_gamut_srgb2bt2020_coef[MITM_GAMUT_COEF_LEN] = {10279, 5395, 710, 1132, 15066, 186, 269, 1442, 14673};
...
struct dpu_ov_csc {
	...
	unsigned int rsv[2]; // for cmdlist aligned
};
...
struct dpu_ov_ov {
	...
	DPU_RCH_OV_SCENE_LCNT_CTRL_UNION ov_scene_lcnt_ctrl;
	DPU_RCH_OV_SCENE_LCNT_THR01_UNION ov_scene_lcnt_thro1;
	DPU_RCH_OV_SCENE_LCNT_THR23_UNION ov_scene_lcnt_thr23;
};

struct dpu_ov_ov_scene_lcnt {
	DPU_RCH_OV_SCENE_LCNT_CTRL_UNION scene_lcnt_ctrl;
	DPU_RCH_OV_SCENE_LCNT_THR01_UNION scene_lcnt_thr01;
	DPU_RCH_OV_SCENE_LCNT_THR23_UNION scene_lcnt_thr23;
};
