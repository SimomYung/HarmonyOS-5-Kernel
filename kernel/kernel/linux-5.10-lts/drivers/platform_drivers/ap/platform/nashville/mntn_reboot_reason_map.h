 ...
 * Description: mntn_reboot_reason_map.h
 * Author: Hisilicon
 * Create: 2019-10-29
 */
...
__REBOOT_REASON_MAP(VENC_S_VENCWD, VENCWD)
__REBOOT_REASON_MAP(VDEC_S_VDECWD, VDECWD)
__REBOOT_REASON_MAP(AO_S_AO_WD, AOWD)
__REBOOT_REASON_MAP(DDR_LP_CTRL_S_WD, DDRXPUWD)
__REBOOT_REASON_MAP(SYS_CTRL_S_WD, SYSCTRLWD)
__REBOOT_REASON_MAP(GPU_LP_CTRL_S_WD, GPUXPUWD)
__REBOOT_REASON_MAP(CPU_LP_CTRL_S_WD, CPUXPUWD)
...
__REBOOT_REASON_MAP(AP_S_NOC, SUBTYPE)
...
__REBOOT_REASON_MAP(AP_S_PMU2, SUBTYPE)
...
__REBOOT_REASON_MAP(FFTS_S_EXCEPTION, SUBTYPE)
...
__REBOOT_REASON_MAP(IODIE_S_EXCEPTION, HARDWARE_FAULT)
