...
#define SOC_MID_NPU_LITE_AIV                40
#define SOC_MID_NPU_TINY_AIV                41
...
typedef enum {
    ...
    SMART_ISP_TYPE_AICOLOR,
    SMART_ISP_TYPE_SMART_DME,
    SMART_ISP_TYPE_SMART_FLOW,
...
static smart_isp_rtsq_config_table_t g_smart_isp_sq_table[] = {
    {SMART_ISP_TYPE_SMART_PALETTE, 4, 0},
    {SMART_ISP_TYPE_AIAF, 2, 0},
    {SMART_ISP_TYPE_AIAWB, 4, 0},
    {SMART_ISP_TYPE_AICOLOR, 4, 0},
    {SMART_ISP_TYPE_SMART_DME, 4, 0},
    {SMART_ISP_TYPE_SMART_FLOW, 4, 1},
    {SMART_ISP_TYPE_SMART_MSC, 1, 0},
};
...
static hwts_rtsq_config_item_t g_hwts_config_table[] = {
    ...
    {HWTS_RTSQ_TYPE_NS_AIC, HWTS_HOST_TYPE_TSCPU, HWTS_PRIORITY_GRP_MAX, 18, (void *)g_ns_aic_sq_table, 0},
    ...
    {HWTS_RTSQ_TYPE_SMARTISP, HWTS_HOST_TYPE_TSCPU, HWTS_PRIORITY_GRP_MAX, 19, (void *)g_smart_isp_sq_table, 0},
