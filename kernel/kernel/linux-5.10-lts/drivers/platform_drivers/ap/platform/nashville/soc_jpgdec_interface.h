...
#define MAX_INPUT_WIDTH		15008
#define MAX_INPUT_HEIGHT	15008
...
typedef union {
    ...
    struct {
        uint32_t ns_uarch           : 1 ;    /* [0..0] */
        uint32_t ns_ras             : 1 ;    /* [1..1] */
        uint32_t reserved           : 1 ;    /* [2..2] */
        uint32_t ns_init            : 1 ;    /* [3..3] */
...
typedef union {
    /* Define the struct bits */
    struct {
        uint32_t tcu_qreqn_cg       : 1 ;    /* [0..0] */
        uint32_t tcu_qreqn_pd       : 1 ;    /* [1..1] */
...
typedef union {
    /* Define the struct bits */
    struct {
        uint32_t tcu_qacceptn_cg    : 1 ;    /* [0..0] */
        uint32_t tcu_qdeny_cg       : 1 ;    /* [1..1] */
        uint32_t tcu_qactive_cg     : 1 ;    /* [2..2] */
        uint32_t reserved           : 1 ;    /* [3..3] */
        uint32_t tcu_qacceptn_pd    : 1 ;    /* [4..4] */
        uint32_t tcu_qdeny_pd       : 1 ;    /* [5..5] */
        uint32_t tcu_qactive_pd     : 1 ;    /* [6..6] */
        uint32_t reserved2          : 30 ;   /* [31..7] */
    } bits;
...
typedef union {
    /* Define the struct bits */
    struct {
        uint32_t smmuen             : 1 ;    /* [0..0] */
        uint32_t priqen             : 1 ;    /* [1..1] */
        uint32_t eventqen           : 1 ;    /* [2..2] */
        uint32_t cmdqen             : 1 ;    /* [3..3] */
        uint32_t atschk             : 1 ;    /* [4..4] */
        uint32_t reserved           : 1 ;    /* [5..5] */
        uint32_t vmw                : 3 ;    /* [8..6] */
        uint32_t reserved2          : 22 ;   /* [31..9] */
    } bits;
...
#endif  /* __SOC_JPGDEC_INTERFACE_H__ */
