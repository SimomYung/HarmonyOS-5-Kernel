...
// History       :  AnthonySixta 2020/06/02 09:31:04 Create file
// ******************************************************************************
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    vcpi_cmdlst_sop       : 1   ; /* [7]  */
        unsigned int    vcpi_cmdlst_eop       : 1   ; /* [8]  */
        unsigned int    vcpi_soft_int0        : 1   ; /* [9]  */
        unsigned int    vcpi_soft_int1        : 1   ; /* [10]  */
        unsigned int    vcpi_soft_int2        : 1   ; /* [11]  */
        unsigned int    vcpi_soft_int3        : 1   ; /* [12]  */
        unsigned int    vcpi_lowlatency_slcint : 1   ; /* [13]  */
        unsigned int    vcpi_enhance0_buffull_int : 1   ; /* [14] */
        unsigned int    vcpi_enhance0_pbitsover_int : 1   ; /* [15] */
        unsigned int    vcpi_enhance1_buffull_int : 1   ; /* [16] */
        unsigned int    vcpi_enhance1_pbitsover_int : 1   ; /* [17] */
        unsigned int    vcpi_enhance2_buffull_int : 1   ; /* [18] */
        unsigned int    vcpi_enhance2_pbitsover_int : 1   ; /* [19] */
        unsigned int    vcpi_hts_error_int    : 1   ; /* [20] */
        unsigned int    vcpi_hts_event_int    : 1   ; /* [21] */
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    vcpi_cmdlst_sop_raw   : 1   ; /* [7]  */
        unsigned int    vcpi_cmdlst_eop_raw   : 1   ; /* [8]  */
        unsigned int    vcpi_soft_rint0       : 1   ; /* [9]  */
        unsigned int    vcpi_soft_rint1       : 1   ; /* [10]  */
        unsigned int    vcpi_soft_rint2       : 1   ; /* [11]  */
        unsigned int    vcpi_soft_rint3       : 1   ; /* [12]  */
        unsigned int    vcpi_rint_lowlatency_slcint : 1   ; /* [13]  */
        unsigned int    vcpi_enhance0_buffull_rint : 1   ; /* [14] */
        unsigned int    vcpi_enhance0_pbitsover_rint : 1   ; /* [15] */
        unsigned int    vcpi_enhance1_buffull_rint : 1   ; /* [16] */
        unsigned int    vcpi_enhance1_pbitsover_rint : 1   ; /* [17] */
        unsigned int    vcpi_enhance2_buffull_rint : 1   ; /* [18] */
        unsigned int    vcpi_enhance2_pbitsover_rint : 1   ; /* [19] */
        unsigned int    vcpi_hts_error_rint   : 1   ; /* [20] */
        unsigned int    vcpi_hts_event_rint   : 1   ; /* [21] */
        unsigned int    reserved_0            : 10  ; /* [31..22] */
    } bits;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    reserved0             : 18  ; /* [24..7]  */
        unsigned int    nal_type0             : 3   ; /* [27..25]  */
        unsigned int    Slice_type0           : 2   ; /* [29..28]  */
        unsigned int    IsLastTile0           : 1   ; /* [30]  */
...
/* Define the union U_RESERVED_FUNC_PPFD */
typedef union
{
    /* Define the struct bits */
    struct
    {
        unsigned int    mrg_skip_opt_lcu_cnt  : 16  ; /* [15..0] */
...
typedef union
{
    ...
    struct
    {
        unsigned int    sao2vcpi_mse_cnt      : 18  ; /* [17..0]  */
        unsigned int    sao2vcpi_mse_sumh     : 3   ; /* [20..18]  */
        unsigned int    reserved_0            : 11  ; /* [31..21]  */
    } bits;
...
typedef struct
{
    ...
    volatile unsigned int           RESERVED_FUNC_PMELD          ; /* 0x140 */
    ...
    volatile unsigned int           reserved_32[7]                   ; /* 0x164~0x17c */
    volatile unsigned int           RESERVED_FUNC_PMEINFO_LD[16]     ; /* 0x180 ~0x1bc */
    volatile U_FUNC_PME_MADI_SUM    FUNC_PME_MADI_SUM                ; /* 0x1c0 */
    volatile unsigned int           reserved_34[8]                   ; /* 0x1c4~0x1e0 */
