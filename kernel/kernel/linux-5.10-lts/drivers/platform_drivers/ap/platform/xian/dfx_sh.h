...
#define SH_SW_CNT_THRESHOLD_GPU_PIM   0
...
#define SH_CLEAR_INTERVAL_ENABLE_CFG  0b0111111
...
#define SH_CLEAR_INTERVAL_GPU_PIM  0
...
#define SH_VDEC_ENABLE_CFG  SH_CFG_DISABLE

#define SH_DSS_ENABLE_CFG   SH_CFG_DISABLE
