...
/*****************************************************************************
 ...
 struct description   : PERRSTEN0 Register structure definition
                        Address Offset:0x060 Initial:0x0 Width:32
 register description : 外设软复位使能寄存器0。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union {
    ...
    struct {
        ...
        unsigned int  reserved_19          : 1;  /* bit[28]: xian删除 ufs_dfa_cpu */
        unsigned int  ip_rst_ufs_dfa_sys   : 1;  /* bit[29]:  */
        unsigned int  reserved_20          : 1;  /* bit[30]:  */
        unsigned int  reserved_21          : 1;  /* bit[31]: IP软复位使能：
                                                             0：IP软复位使能状态不变；
                                                             1：IP软复位使能。 */
    } reg;
...
/*****************************************************************************
 ...
 struct description   : PERRSTDIS0 Register structure definition
                        Address Offset:0x064 Initial:0x0 Width:32
 register description : 外设软复位撤离寄存器0。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union {
    ...
    struct {
        ...
        unsigned int  ip_rst_ufs_dfa_sys   : 1;  /* bit[29]:  */
        unsigned int  reserved_20          : 1;  /* bit[30]:  */
        unsigned int  reserved_21          : 1;  /* bit[31]: IP软复位撤离：
                                                             0：IP软复位使能状态不变；
                                                             1：IP软复位撤离。 */
    } reg;
...
/*****************************************************************************
 ...
 struct description   : PERRSTSTAT0 Register structure definition
                        Address Offset:0x068 Initial:0x1 Width:32
 register description : 外设软复位状态寄存器0。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union {
    ...
    struct {
        ...
        unsigned int  reserved_3           : 1;  /* bit[6] :  */
        unsigned int  ip_rst_qic_qcr_mdm   : 1;  /* bit[7] :  */
        unsigned int  reserved_4           : 1;  /* bit[8] : 这个复位其实是ip_rst_qice_gm_gs，不与mdm绑定 */
        unsigned int  reserved_5           : 1;  /* bit[9] :  */
        unsigned int  reserved_6           : 1;  /* bit[10]:  */
        unsigned int  reserved_7           : 1;  /* bit[11]:  */
        unsigned int  reserved_8           : 1;  /* bit[12]:  */
        ...
        unsigned int  ip_rst_ufs_dfa_sys   : 1;  /* bit[29]:  */
        unsigned int  reserved_20          : 1;  /* bit[30]:  */
        unsigned int  reserved_21          : 1;  /* bit[31]: IP软复位使能状态：
                                                             0：IP处于复位撤离状态；
                                                             1：IP处于软复位使能状态。 */
    } reg;
...
/*****************************************************************************
 ...
 struct description   : PEREN12 Register structure definition
                        Address Offset:0x470 Initial:0x00 Width:32
 register description : 外设时钟使能寄存器12。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union {
    ...
    struct {
        ...
        unsigned int  reserved_10             : 8;  /* bit[24-31]: 外设时钟使能控制：
                                                                   0：写0无效果；
                                                                   1：使能IP时钟。 */
    } reg;
...
/*****************************************************************************
 ...
 struct description   : PLL_FSM_NS_VOTE0 Register structure definition
                        Address Offset:0x950 Initial:0x0000 Width:32
 register description : PLL状态机非安全投票寄存器0。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union {
...
/*****************************************************************************
 ...
 struct description   : PLL_FSM_NS_VOTE1 Register structure definition
                        Address Offset:0x954 Initial:0x0000 Width:32
 register description : PLL状态机非安全投票寄存器1。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union {
...
/*****************************************************************************
 ...
 struct description   : HW_DSS_DVFS_STAT Register structure definition
                        Address Offset:0x668 Initial:0x0000 Width:32
 register description : DSS DVFS状态机维测状态寄存器
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union {
...
/*****************************************************************************
 ...
 struct description   : PPLL2_BCTRL0 Register structure definition
                        Address Offset:0xA84 Initial:0x00 Width:32
 register description : PPLL2_B控制寄存器0
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union {
...
/*****************************************************************************
 ...
 struct description   : PPLL2_BCTRL1 Register structure definition
                        Address Offset:0xA88 Initial:0x00 Width:32
 register description : PPLL2_B控制寄存器1
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union {
...
/*****************************************************************************
 ...
 struct description   : PLL_FSM_CTRL1 Register structure definition
                        Address Offset:0xC44 Initial:0x000 Width:32
 register description : PLL_FSM控制寄存器
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union {
...
typedef union {
    ...
    struct {
        ...
        unsigned int  reserved_1       : 5;  /* bit[18-22]:  */
...
/*****************************************************************************
 ...
 struct description   : PLL_FSM_STAT1 Register structure definition
                        Address Offset:0xC4C Initial:0x00 Width:32
 register description : PLL_FSM状态回读寄存器。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union {
...
/*****************************************************************************
 ...
 struct description   : PLL_VOTE_STAT0 Register structure definition
                        Address Offset:0xC50 Initial:0x00 Width:32
 register description : PLL投票状态回读寄存器0。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union {
    ...
    struct {
        ...
        unsigned int  reserved_12     : 5;  /* bit[27-31]: 保留。 */
    } reg;
...
/*****************************************************************************
 ...
 struct description   : PLL_EN_VOTE_CTRL1 Register structure definition
                        Address Offset:0xC60 Initial:0x0000 Width:32
 register description : PLL使能投票寄存器1。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union {
...
/*****************************************************************************
 ...
 struct description   : PLL_EN_VOTE_CTRL2 Register structure definition
                        Address Offset:0xC6C Initial:0x0000 Width:32
 register description : PLL使能投票寄存器1。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union {
...
#endif
#define SOC_PMCTRL_HW_DSS_DVFS_SF_CH_apb_intr_sf_dvfs_clr_START  (0)
#define SOC_PMCTRL_HW_DSS_DVFS_SF_CH_apb_intr_sf_dvfs_clr_END    (0)
#define SOC_PMCTRL_HW_DSS_DVFS_SF_CH_apb_sf_escape_START         (1)
#define SOC_PMCTRL_HW_DSS_DVFS_SF_CH_apb_sf_escape_END           (1)
#define SOC_PMCTRL_HW_DSS_DVFS_SF_CH_apb_sf_next_step_START      (2)
#define SOC_PMCTRL_HW_DSS_DVFS_SF_CH_apb_sf_next_step_END        (2)
#define SOC_PMCTRL_HW_DSS_DVFS_SF_CH_apb_sf_dvfs_en_START        (3)
#define SOC_PMCTRL_HW_DSS_DVFS_SF_CH_apb_sf_dvfs_en_END          (3)
#define SOC_PMCTRL_HW_DSS_DVFS_SF_CH_apb_sf_instr_clr_START      (4)
#define SOC_PMCTRL_HW_DSS_DVFS_SF_CH_apb_sf_instr_clr_END        (4)
