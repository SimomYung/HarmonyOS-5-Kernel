...
#define ISP_CORE_CFG_BASE_ADDR      (0xE0000000)
#define ITCM_BASE                   (0xFFFF0000)
#define DTCM0_BASE                  (0xE0340000)
#define DTCM1_BASE                  (0xE0380000)
...
#define ISP_MAX_REGTYPE_FOR_ISPCPU  (0)
