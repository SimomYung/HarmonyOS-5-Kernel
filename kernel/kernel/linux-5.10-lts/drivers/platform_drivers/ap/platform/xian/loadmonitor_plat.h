...
#define MONITOR0_IP_MASK		0x7001FFC7
#define MAX_PERI_MONITOR0_DEVICE	bit_count(MONITOR0_IP_MASK) /* 17 */

#define MONITOR1_IP_MASK		0xFFCFFFFF
#define MAX_PERI_MONITOR1_DEVICE	bit_count(MONITOR1_IP_MASK) /* 30 */

#define AO_MONITOR0_IP_MASK		0xFFE1FF7F
#define MAX_MONITOR_IP_DEVICE_AO	bit_count(AO_MONITOR0_IP_MASK) /* 27 */
...
#define LOADMONITOR_AO_FREQ		69640000
#define MONITOR_AO_FREQ_CS		69640000
#define LOADMONITOR_AO_CLK		69640
