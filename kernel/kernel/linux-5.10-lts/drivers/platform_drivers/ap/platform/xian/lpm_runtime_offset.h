...
#define RUNTIME_TMP_GPU_HIGH_ADDR			(RUNTIME_VAR_BASE + 0x6F)
#define TMP_GPU_HIGH				(BYTE_REF(RUNTIME_TMP_GPU_HIGH_ADDR))

#define RUNTIME_TMP_DDR_TIME_ADDR			(RUNTIME_VAR_BASE + 0x70)
#define TMP_DDR_TIME				(WORD_REF(RUNTIME_TMP_DDR_TIME_ADDR))
...
#define RUNTIME_DDR_CANNOT_ENTER_DEEPSLEEP_CNT_ADDR      (RUNTIME_SR_VAR_BASE_ADDR + 0x1E8)
#define DDR_CANNOT_ENTER_DEEPSLEEP_CNT             (WORD_REF(RUNTIME_DDR_CANNOT_ENTER_DEEPSLEEP_CNT_ADDR))
#define RUNTIME_MODEM_CANNOT_ENTER_DEEPSLEEP_CNT_ADDR    (RUNTIME_SR_VAR_BASE_ADDR + 0x1EC)
#define MODEM_CANNOT_ENTER_DEEPSLEEP_CNT           (WORD_REF(RUNTIME_MODEM_CANNOT_ENTER_DEEPSLEEP_CNT_ADDR))

/* warning:if add new status at last,must sync modify RUNTIME_SPACE_ADDR_END */
#define RUNTIME_SPACE_ADDR_END			(RUNTIME_MODEM_CANNOT_ENTER_DEEPSLEEP_CNT_ADDR)
...
#define DDR_CANNOT_ENTER_DEEPSLEEP_CNT_OFFSET	(RUNTIME_DDR_CANNOT_ENTER_DEEPSLEEP_CNT_ADDR - RUNTIME_VAR_BASE)
#define MODEM_CANNOT_ENTER_DEEPSLEEP_CNT_OFFSET	(RUNTIME_MODEM_CANNOT_ENTER_DEEPSLEEP_CNT_ADDR - RUNTIME_VAR_BASE)
#define SLEEP_FAIL_ITEM_OFFSET				(RUNTIME_SLOW_WAKE_IRQ_ADDR - RUNTIME_VAR_BASE)
#endif
