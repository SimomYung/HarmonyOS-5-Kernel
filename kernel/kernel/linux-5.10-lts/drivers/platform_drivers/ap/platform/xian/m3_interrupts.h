...
#define IRQ_DDRC0_NORMAL_XPU                         141
...
#define IRQ_EXMBIST_INT                              146
#define IRQ_EXMBIST_RST_INT                          147
...
#define IRQ_ISP_CPU_TO_M3_IPC_TO_LPMCU               152
#define IRQ_ISP_CPU_WDOG_TO_LPMCU                    153
#define IRQ_ISP_CPU_TO_M3_IPC_TO_LPMCU0              154
#define IRQ_ISP_CPU_TO_M3_IPC_TO_LPMCU1              155
#define IRQ_UCE0_RTACTIVE_LPMCU                      156
#define IRQ_UCE0_WDOG_GIC_LPMCU                      157
#define IRQ_ASP_WATCHDOG                             158
...
#define IRQ_PERI_IOC_TO_ACPU0_0                      195
	...
	#define IRQ195_HSDT0_IOC_TO_ACPU0_1                     20
	#define IRQ195_HSDT0_IOC_TO_ACPU1_1                     21
#define IRQ_PERI_IOC_TO_IOMCU_0                      196
	...
	#define IRQ196_HSDT0_IOC_TO_IOMCU_1                     10
#define IRQ_PERI_IOC_TO_MDM_0                        197
	...
	#define IRQ197_HSDT0_IOC_TO_MDM_0                       7
	#define IRQ197_HSDT1_IOC_TO_MDM                         8
	#define IRQ197_HSDT1_IOC_TO_MDM_1                       9
	#define IRQ197_HSDT0_IOC_TO_MDM_1                       10
#define IRQ_PERI_IOC_TO_LPMCU                        198
	...
	#define IRQ198_HSDT0_IOC_TO_LPMCU_0                     5
	...
	#define IRQ198_HSDT0_IOC_TO_LPMCU_1                     10
...
#define IRQ_RTOS_IPC_NS0                             209
	...
	#define IRQ209_RTOS_IPC_NS5                             5
	#define IRQ209_RTOS_IPC_NS7                             6
	#define IRQ209_RTOS_IPC_NS9                             7
	#define IRQ209_RTOS_IPC_NS10                            8
	#define IRQ209_RTOS_IPC_NS11                            9
	#define IRQ209_RTOS_IPC_NS12                            10
	#define IRQ209_RTOS_IPC_NS_MBX22                        11
	#define IRQ209_RTOS_IPC_NS_MBX23                        12
	#define IRQ209_RTOS_IPC_NS_MBX24                        13
	#define IRQ209_RTOS_IPC_NS_MBX25                        14
	#define IRQ209_RTOS_IPC_NS_MBX26                        15
	#define IRQ209_RTOS_IPC_NS_MBX27                        16
	#define IRQ209_RTOS_IPC_NS_MBX28                        17
	#define IRQ209_RTOS_IPC_NS_MBX29                        18
	#define IRQ209_RTOS_IPC_NS_MBX30                        19
	#define IRQ209_RTOS_IPC_NS_MBX31                        20
	#define IRQ209_RTOS_IPC_NS_MBX32                        21
	#define IRQ209_RTOS_IPC_NS_MBX50                        22
	#define IRQ209_RTOS_IPC_NS_MBX51                        23
	#define IRQ209_RTOS_IPC_NS_MBX54                        24
	#define IRQ209_RTOS_IPC_NS_MBX55                        25
	#define IRQ209_RTOS_IPC_NS_MBX57                        26
	#define IRQ209_RTOS_IPC_NS_MBX58                        27
	#define IRQ209_RTOS_IPC_NS_MBX59                        28
	#define IRQ209_RTOS_IPC_NS_MBX60                        29
	#define IRQ209_RTOS_IPC_NS_MBX61                        30
	#define IRQ209_RTOS_IPC_NS_MBX62                        31
#define IRQ_IPC11                                    210
	#define IRQ210_IPC11                                    0
	#define IRQ210_IPC12                                    1
	#define IRQ210_IPC7                                     2
	#define IRQ210_IPC_NS_MBX54                             3
	#define IRQ210_IPC_NS11                                 5
	#define IRQ210_IPC_NS12                                 6
	#define IRQ210_IPC_NS7                                  7
	#define IRQ210_IPC_NS_MBX55                             8
	#define IRQ210_IPC_MBX29                                9
	#define IRQ210_IPC_MBX30                                10
	#define IRQ210_IPC_MBX25                                11
	#define IRQ210_IPC_MBX26                                12
	#define IRQ210_IPC_NS_MBX50                             13
	#define IRQ210_IPC_MBX33                                16
	#define IRQ210_IPC5                                     17
	#define IRQ210_IPC_MBX34                                18
	#define IRQ210_IPC_NS_AO2                               19
	#define IRQ210_IPC9                                     20
	#define IRQ210_IPC_MBX35                                21
	#define IRQ210_IPC_MBX36                                22
	#define IRQ210_IPC_NS5                                  23
	#define IRQ210_IPC_MBX37                                24
	#define IRQ210_IPC_NS9                                  25
	#define IRQ210_I3C4                                     26
	#define IRQ210_I2C2                                     27
	#define IRQ210_IPC_NS10                                 28
	#define IRQ210_IPC10                                    29
#define IRQ_IPF0                                     211
	#define IRQ211_IPF0                                     0
	#define IRQ211_IPF2                                     1
	#define IRQ211_IPF1                                     2
	#define IRQ211_PCR_GPU_GIC_LPMCU                        6
	#define IRQ211_IPC_NS_MBX_AO2                           9
	#define IRQ211_IPC_S_AO5                                10
	#define IRQ211_IPC_NS_MBX58                             12
	#define IRQ211_IPC_NS_MBX59                             13
	#define IRQ211_IPC_NS_MBX60                             14
	#define IRQ211_IPC_NS_MBX61                             15
	#define IRQ211_IPC_NS_MBX62                             16
	#define IRQ211_SPMI0                                    17
	#define IRQ211_SPMI10                                   18
	#define IRQ211_IPC_S_MBX_AO6                            19
	#define IRQ211_UART5                                    20
	#define IRQ211_SPE_C                                    21
	#define IRQ211_PERF_STAT                                22
	#define IRQ211_VBAT_DROP_PROTECT_DB                     23
...
#define IRQ_RTOS_IPC_NS_MBX0                         213
	#define IRQ213_RTOS_IPC_NS_MBX0                         4
	#define IRQ213_RTOS_IPC_NS_MBX1                         5
	#define IRQ213_RTOS_IPC_NS_MBX2                         6
	#define IRQ213_RTOS_IPC_NS_MBX3                         7
	#define IRQ213_RTOS_IPC_NS_MBX4                         8
	#define IRQ213_RTOS_IPC_NS_MBX5                         9
	#define IRQ213_RTOS_IPC_NS_MBX6                         10
	#define IRQ213_RTOS_IPC_NS_MBX7                         11
	#define IRQ213_RTOS_IPC_NS_MBX8                         12
	#define IRQ213_RTOS_IPC_NS_MBX9                         13
	#define IRQ213_RTOS_IPC_NS_MBX10                        14
	#define IRQ213_RTOS_IPC_NS_MBX11                        15
	#define IRQ213_RTOS_IPC_NS_MBX12                        16
	#define IRQ213_RTOS_IPC_NS_MBX13                        17
	#define IRQ213_RTOS_IPC_NS_MBX14                        18
	#define IRQ213_RTOS_IPC_NS_MBX15                        19
	#define IRQ213_RTOS_IPC_NS_MBX16                        20
	#define IRQ213_RTOS_IPC_NS_MBX17                        21
	#define IRQ213_RTOS_IPC_NS_MBX18                        22
	#define IRQ213_RTOS_IPC_NS_MBX19                        23
	#define IRQ213_RTOS_IPC_NS_MBX20                        24
	#define IRQ213_RTOS_IPC_NS_MBX21                        25
	#define IRQ213_RTOS_IPC_NS_MBX63                        26
	#define IRQ213_RTOS_IPC_NS_MBX64                        27
