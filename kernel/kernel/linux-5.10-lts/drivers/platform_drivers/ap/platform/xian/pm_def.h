...
/* define LPMCU_TICKMARK_DYNAMIC_CAL if you want to update SR threshold in some cases */
#define LPMCU_TICKMARK_DYNAMIC_CAL
...
/* gpio_debug_switch to lpm by ipc */
#define ENABLE_IO_DEBUG_SWITCH_WITH_IPC 1

/* clear ddr and modem can't enter deesleep count */
#define CLEAR_DDR_CANNOT_ENTER_DEEPSLEEP_CNT DDR_CANNOT_ENTER_DEEPSLEEP_CNT
#define CLEAR_MODEM_CANNOT_ENTER_DEEPSLEEP_CNT MODEM_CANNOT_ENTER_DEEPSLEEP_CNT

#define SLEEP_FAIL_ITEM SLOW_WAKE_IRQ
