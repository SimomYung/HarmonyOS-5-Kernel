...
/* Register description: 源处理器配置寄存器。
   Bit domain definition UNION:  SOC_IPCNS_MBX_SOURCE_UNION */
#define SOC_IPCNS_MBX_SOURCE_ADDR(base, i)                    ((base) + (i) * 128)

/* Register description: 目的处理器设置寄存器。
   Bit domain definition UNION:  SOC_IPCNS_MBX_DSET_UNION */
#define SOC_IPCNS_MBX_DSET_ADDR(base, i)                      ((base) + 0x004UL + (i) * 128)

/* Register description: 目的处理器清除寄存器。
   Bit domain definition UNION:  SOC_IPCNS_MBX_DCLEAR_UNION */
#define SOC_IPCNS_MBX_DCLEAR_ADDR(base, i)                    ((base) + 0x008UL + (i) * 128)

/* Register description: 目的处理器状态寄存器。
   Bit domain definition UNION:  SOC_IPCNS_MBX_DSTATUS_UNION */
#define SOC_IPCNS_MBX_DSTATUS_ADDR(base, i)                   ((base) + 0x00CUL + (i) * 128)

/* Register description: 邮箱通道模式状态机状态寄存器。
   Bit domain definition UNION:  SOC_IPCNS_MBX_MODE_UNION */
#define SOC_IPCNS_MBX_MODE_ADDR(base, i)                      ((base) + 0x010UL + (i) * 128)

/* Register description: 处理器中断屏蔽寄存器。
   Bit domain definition UNION:  SOC_IPCNS_MBX_IMASK_UNION */
#define SOC_IPCNS_MBX_IMASK_ADDR(base, i)                     ((base) + 0x014UL + (i) * 128)

/* Register description: 处理器中断状态清除寄存器。
   Bit domain definition UNION:  SOC_IPCNS_MBX_ICLR_UNION */
#define SOC_IPCNS_MBX_ICLR_ADDR(base, i)                      ((base) + 0x018UL + (i) * 128)

/* Register description: 发送寄存器。
   Bit domain definition UNION:  SOC_IPCNS_MBX_SEND_UNION */
#define SOC_IPCNS_MBX_SEND_ADDR(base, i)                      ((base) + 0x01CUL + (i) * 128)

/* Register description: 数据0寄存器。
   Bit domain definition UNION:  SOC_IPCNS_MBX_DATA0_UNION */
#define SOC_IPCNS_MBX_DATA0_ADDR(base, i)                     ((base) + 0x020UL + (i) * 128)

/* Register description: 数据1寄存器。
   Bit domain definition UNION:  SOC_IPCNS_MBX_DATA1_UNION */
#define SOC_IPCNS_MBX_DATA1_ADDR(base, i)                     ((base) + 0x024UL + (i) * 128)

/* Register description: 数据2寄存器。
   Bit domain definition UNION:  SOC_IPCNS_MBX_DATA2_UNION */
#define SOC_IPCNS_MBX_DATA2_ADDR(base, i)                     ((base) + 0x028UL + (i) * 128)

/* Register description: 数据3寄存器。
   Bit domain definition UNION:  SOC_IPCNS_MBX_DATA3_UNION */
#define SOC_IPCNS_MBX_DATA3_ADDR(base, i)                     ((base) + 0x02CUL + (i) * 128)

/* Register description: 数据4寄存器。
   Bit domain definition UNION:  SOC_IPCNS_MBX_DATA4_UNION */
#define SOC_IPCNS_MBX_DATA4_ADDR(base, i)                     ((base) + 0x030UL + (i) * 128)

/* Register description: 数据5寄存器。
   Bit domain definition UNION:  SOC_IPCNS_MBX_DATA5_UNION */
#define SOC_IPCNS_MBX_DATA5_ADDR(base, i)                     ((base) + 0x034UL + (i) * 128)

/* Register description: 数据6寄存器。
   Bit domain definition UNION:  SOC_IPCNS_MBX_DATA6_UNION */
#define SOC_IPCNS_MBX_DATA6_ADDR(base, i)                     ((base) + 0x038UL + (i) * 128)

/* Register description: 数据7寄存器。
   Bit domain definition UNION:  SOC_IPCNS_MBX_DATA7_UNION */
#define SOC_IPCNS_MBX_DATA7_ADDR(base, i)                     ((base) + 0x03CUL + (i) * 128)

/* Register description: 数据8寄存器。
   Bit domain definition UNION:  SOC_IPCNS_MBX_DATA8_UNION */
#define SOC_IPCNS_MBX_DATA8_ADDR(base, i)                     ((base) + 0x040UL + (i) * 128)

/* Register description: 数据9寄存器。
   Bit domain definition UNION:  SOC_IPCNS_MBX_DATA9_UNION */
#define SOC_IPCNS_MBX_DATA9_ADDR(base, i)                     ((base) + 0x044UL + (i) * 128)

/* Register description: 数据10寄存器。
   Bit domain definition UNION:  SOC_IPCNS_MBX_DATA10_UNION */
#define SOC_IPCNS_MBX_DATA10_ADDR(base, i)                    ((base) + 0x048UL + (i) * 128)

/* Register description: 数据11寄存器。
   Bit domain definition UNION:  SOC_IPCNS_MBX_DATA11_UNION */
#define SOC_IPCNS_MBX_DATA11_ADDR(base, i)                    ((base) + 0x04CUL + (i) * 128)

/* Register description: CPUj对应Mailbox[32*n+31:32*n]的中断屏蔽状态寄存器。
   Bit domain definition UNION:  SOC_IPCNS_CPUj_IMST_UNION */
#define SOC_IPCNS_CPUj_IMST_ADDR(base, j, n)                  ((base) + 0x8000UL + (j) * 8 + (n) * 256)

/* Register description: CPUj对应Mailbox[32*n+31:32*n]中断原始状态寄存器。
   Bit domain definition UNION:  SOC_IPCNS_CPUj_IRST_UNION */
#define SOC_IPCNS_CPUj_IRST_ADDR(base, j, n)                  ((base) + 0x8004UL + (j) * 8 + (n) * 256)

/* Register description: 有效通道状态寄存器。
   Bit domain definition UNION:  SOC_IPCNS_IPC_MBX_ACTIVE_UNION */
#define SOC_IPCNS_IPC_MBX_ACTIVE_ADDR(base, n)                ((base) + 0x9000UL + (n) * 4)

/* Register description: 低功耗状态寄存器。
   Bit domain definition UNION:  SOC_IPCNS_IPC_LP_STATE_UNION */
#define SOC_IPCNS_IPC_LP_STATE_ADDR(base)                     ((base) + 0x9024UL)

/* Register description: IPC lock寄存器。
   Bit domain definition UNION:  SOC_IPCNS_IPC_LOCK_UNION */
 ...
 ****************************************************************************/
/*****************************************************************************
 struct               : SOC_IPCNS_MBX_SOURCE_UNION
 struct description   : MBX_SOURCE Register structure definition
                        Address Offset:0x000+(i)*128 Initial:0x00000 Width:32
 register description : 源处理器配置寄存器。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union {
...
/*****************************************************************************
 struct               : SOC_IPCNS_MBX_DSET_UNION
 struct description   : MBX_DSET Register structure definition
                        Address Offset:0x004+(i)*128 Initial:0x00000 Width:32
 register description : 目的处理器设置寄存器。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union {
...
/*****************************************************************************
 struct               : SOC_IPCNS_MBX_DCLEAR_UNION
 struct description   : MBX_DCLEAR Register structure definition
                        Address Offset:0x008+(i)*128 Initial:0x00000 Width:32
 register description : 目的处理器清除寄存器。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union {
...
/*****************************************************************************
 struct               : SOC_IPCNS_MBX_DSTATUS_UNION
 struct description   : MBX_DSTATUS Register structure definition
                        Address Offset:0x00C+(i)*128 Initial:0x00000 Width:32
 register description : 目的处理器状态寄存器。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union {
...
/*****************************************************************************
 struct               : SOC_IPCNS_MBX_MODE_UNION
 struct description   : MBX_MODE Register structure definition
                        Address Offset:0x010+(i)*128 Initial:0x000000 Width:32
 register description : 邮箱通道模式状态机状态寄存器。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union {
...
/*****************************************************************************
 struct               : SOC_IPCNS_MBX_IMASK_UNION
 struct description   : MBX_IMASK Register structure definition
                        Address Offset:0x014+(i)*128 Initial:0x00000 Width:32
 register description : 处理器中断屏蔽寄存器。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union {
...
/*****************************************************************************
 struct               : SOC_IPCNS_MBX_ICLR_UNION
 struct description   : MBX_ICLR Register structure definition
                        Address Offset:0x018+(i)*128 Initial:0x00000 Width:32
 register description : 处理器中断状态清除寄存器。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union {
...
/*****************************************************************************
 struct               : SOC_IPCNS_MBX_SEND_UNION
 struct description   : MBX_SEND Register structure definition
                        Address Offset:0x01C+(i)*128 Initial:0x00000 Width:32
 register description : 发送寄存器。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union {
...
/*****************************************************************************
 struct               : SOC_IPCNS_MBX_DATA0_UNION
 struct description   : MBX_DATA0 Register structure definition
                        Address Offset:0x020+(i)*128 Initial:0x00000000 Width:32
 register description : 数据0寄存器。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union {
...
/*****************************************************************************
 struct               : SOC_IPCNS_MBX_DATA1_UNION
 struct description   : MBX_DATA1 Register structure definition
                        Address Offset:0x024+(i)*128 Initial:0x00000000 Width:32
 register description : 数据1寄存器。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union {
...
/*****************************************************************************
 struct               : SOC_IPCNS_MBX_DATA2_UNION
 struct description   : MBX_DATA2 Register structure definition
                        Address Offset:0x028+(i)*128 Initial:0x00000000 Width:32
 register description : 数据2寄存器。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union {
...
/*****************************************************************************
 struct               : SOC_IPCNS_MBX_DATA3_UNION
 struct description   : MBX_DATA3 Register structure definition
                        Address Offset:0x02C+(i)*128 Initial:0x00000000 Width:32
 register description : 数据3寄存器。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union {
...
/*****************************************************************************
 struct               : SOC_IPCNS_MBX_DATA4_UNION
 struct description   : MBX_DATA4 Register structure definition
                        Address Offset:0x030+(i)*128 Initial:0x00000000 Width:32
 register description : 数据4寄存器。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union {
...
/*****************************************************************************
 struct               : SOC_IPCNS_MBX_DATA5_UNION
 struct description   : MBX_DATA5 Register structure definition
                        Address Offset:0x034+(i)*128 Initial:0x00000000 Width:32
 register description : 数据5寄存器。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union {
...
/*****************************************************************************
 struct               : SOC_IPCNS_MBX_DATA6_UNION
 struct description   : MBX_DATA6 Register structure definition
                        Address Offset:0x038+(i)*128 Initial:0x00000000 Width:32
 register description : 数据6寄存器。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union {
...
/*****************************************************************************
 struct               : SOC_IPCNS_MBX_DATA7_UNION
 struct description   : MBX_DATA7 Register structure definition
                        Address Offset:0x03C+(i)*128 Initial:0x00000000 Width:32
 register description : 数据7寄存器。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union {
...
/*****************************************************************************
 struct               : SOC_IPCNS_MBX_DATA8_UNION
 struct description   : MBX_DATA8 Register structure definition
                        Address Offset:0x040+(i)*128 Initial:0x00000000 Width:32
 register description : 数据8寄存器。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union {
...
/*****************************************************************************
 struct               : SOC_IPCNS_MBX_DATA9_UNION
 struct description   : MBX_DATA9 Register structure definition
                        Address Offset:0x044+(i)*128 Initial:0x00000000 Width:32
 register description : 数据9寄存器。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union {
...
/*****************************************************************************
 struct               : SOC_IPCNS_MBX_DATA10_UNION
 struct description   : MBX_DATA10 Register structure definition
                        Address Offset:0x048+(i)*128 Initial:0x00000000 Width:32
 register description : 数据10寄存器。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union {
...
/*****************************************************************************
 struct               : SOC_IPCNS_MBX_DATA11_UNION
 struct description   : MBX_DATA11 Register structure definition
                        Address Offset:0x04C+(i)*128 Initial:0x00000000 Width:32
 register description : 数据11寄存器。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union {
...
/*****************************************************************************
 struct               : SOC_IPCNS_CPUj_IMST_UNION
 struct description   : CPUj_IMST Register structure definition
                        Address Offset:0x8000+(j)*8+(n)*256 Initial:0x00000000 Width:32
 register description : CPUj对应Mailbox[32*n+31:32*n]的中断屏蔽状态寄存器。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union {
...
/*****************************************************************************
 struct               : SOC_IPCNS_CPUj_IRST_UNION
 struct description   : CPUj_IRST Register structure definition
                        Address Offset:0x8004+(j)*8+(n)*256 Initial:0x00000000 Width:32
 register description : CPUj对应Mailbox[32*n+31:32*n]中断原始状态寄存器。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union {
...
/*****************************************************************************
 struct               : SOC_IPCNS_IPC_MBX_ACTIVE_UNION
 struct description   : IPC_MBX_ACTIVE Register structure definition
                        Address Offset:0x9000+(n)*4 Initial:0x00000000 Width:32
 register description : 有效通道状态寄存器。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union {
...
/*****************************************************************************
 struct               : SOC_IPCNS_IPC_LP_STATE_UNION
 struct description   : IPC_LP_STATE Register structure definition
...
/*****************************************************************************
 struct               : SOC_IPCNS_IPC_LOCK_UNION
 struct description   : IPC_LOCK Register structure definition
                        Address Offset:0xA000 Initial:0x00000001 Width:32
 register description : IPC lock寄存器。
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union {
