//******************************************************************************
//  Copyright (C), 2007-2019, Hisilicon Technologies Co., Ltd.
//******************************************************************************
// File name     : soc_venc_reg_interface.h
// Version       : 1.0
// Author        : 
// Created       : 2019-05-17
// Description   : The venc reg interface file
// Function List : soc venc reg interface
// 1 Date        : 2019-01-15
...
typedef struct {
    /* vedu configs regs begin 0xE9280000 offset 0x1000 end 0xE9281000 */
    // volatile S_VEDU_CONFIG_REGS_TYPE  VEDU_REGS;         //[0x00000, 0x02FFF]:4k
    ...
    /* func readback regs  begin 0xE9283000 offset 0x0F40 end 0xE9283F40 */
    // volatile S_FUNC_READBACK_REGS_TYPE FUNC_REGS;         // [0x03000, 0x03FFF]:4k
    ...
    volatile S_RESERVED_REGS_TYPE     DEBUG_RO_REG[3072]; // [0X4000,0X6FFF] 12K
    volatile S_CMDLST_REGS_TYPE       CMD_LIST;           // [0X7000,0X7FFF] 4K
    volatile S_MCU_CTRL_REGS_TYPE     MCU_REGS;           // [0X8000,0X8FFF] 4K
    volatile S_RESERVED_REGS_TYPE     RESERVED0[14336];   // [0x9000  0x16FFF] 56k
    volatile S_RESERVED_REGS_TYPE     RESERVED1[1024];    // [0x17000  0x17FFF] 4k
    volatile S_RESERVED_REGS_TYPE     SMMU_PRE[1024];     // [0x18000  0x18FFF] 4k
    /* NOTE: regs do not continuous */

    /* axidfx regs */
    volatile S_RESERVED_REGS_TYPE     AXIDFX_REGS[1024]; // [0x19000, 0x19FFF] 4k
    volatile S_RESERVED_REGS_TYPE     RESERVED2[1024];   // [0x1A000, 0x1AFFF] 4k
    volatile S_RESERVED_REGS_TYPE     RESERVED3[5120];   // [0x1B000, 0x1FFFF] 20k
    volatile S_RESERVED_REGS_TYPE     SMMU_TBU[4096];    // [0x20000, 0x23FFF] 16k
    volatile S_VE_SUB_CTRL_REGS_TYPE  SUB_CTRL;          // [0x24000, 0x24FFF] 4k
    volatile S_RESERVED_REGS_TYPE     WATCH_DOG[1024];   // [0x25000, 0x25FFF] 4k
    volatile S_RESERVED_REGS_TYPE     TIMER[1024];       // [0x26000, 0x26FFF] 4k
    volatile S_RESERVED_REGS_TYPE     UART[1024];        // [0x27000, 0x27FFF] 4k
    volatile S_RESERVED_REGS_TYPE     RESERVED4[1024];   // [0x28000, 0x28FFF] 4k
    volatile S_RESERVED_REGS_TYPE     IPC[1024];         // [0x29000, 0x29FFF] 4k
    volatile S_RESERVED_REGS_TYPE     RESERVED5[1024];   // [0x2A000, 0x2AFFF] 4k
    volatile S_RESERVED_REGS_TYPE     RESERVED6[1024];   // [0x2B000, 0x2BFFF] 4k
    volatile S_RESERVED_REGS_TYPE     RESERVED7[4096];   // [0x2C000, 0x2FFFF] 16k
    volatile S_RESERVED_REGS_TYPE     MCU_ICTM[8192];    // [0x30000, 0x37FFF] 32K
...
#define SOC_VENC_ITCM_OFFSET        0xE2130000
#define SOC_VENC_ITCM_SIZE          0x10000
