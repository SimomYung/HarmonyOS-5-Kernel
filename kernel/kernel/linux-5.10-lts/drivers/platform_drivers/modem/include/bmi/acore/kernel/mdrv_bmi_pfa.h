...
/**
 * @brief 更新对应端口私有信息，包括pfa_port_comm_attr中的net及net中的pfa_portno和pfa_alloced、priv、pfa_finish_rd *
 * @par 描述:
 * ko动态加载场景，重新配置端口需求
 * @attention
 * <ul><li> NA </li></ul>
 * @param[in] vir_portno、struct pfa_port_comm_attr
 * @retval void
 * @par 依赖:
 * <ul><li>mdrv_bmi_pfa.h：该接口声明所在的头文件。</li></ul>
 * @see NA
...
/**
 * @brief 根据skb添加对应ip 5元组表项，并添加反向去往空口的数据流表项 *
 * @par 描述:
 * 网卡空口方向报文实现上下行IP转发加速
 * @attention
 * <ul><li> NA </li></ul>
 * @param[in] skb，网卡从空口modem收到的报文
 * @retval void
 * @par 依赖:
 * <ul><li>mdrv_bmi_pfa.h：该接口声明所在的头文件。</li></ul>
 * @see NA
