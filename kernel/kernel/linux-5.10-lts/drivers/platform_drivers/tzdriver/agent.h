...
#define TEE_INDICATOR_AGENT_ID 0x494e4443 /* indicate agent id */
#define SYSTEM_UID          1000
#define MS_TO_NS            1000000
#define HASH_FILE_MAX_SIZE (70 * 1024)

enum agent_state_type {
	AGENT_CRASHED = 0,  /* agentd/teecd/ca is crashed, agent is still in global agent list */
	AGENT_REGISTERED,   /* agent is created, ready to add to global agent list, currently it's unused */
	AGENT_READY,        /* agentd/teecd/ca is registered success */
	AGENT_PENDING,      /* agent is unregistered, but it is not freed in tee, it is still in global agent list */
	AGENT_UNREGISTERED, /* agent is unregistered, and it is freed in tee, it is not in global agent list */
};
