...
static int
#endif
scsi_send_eh_cmnd(struct scsi_cmnd *scmd, unsigned char *cmnd,
...
static int
#endif
scsi_eh_tur(struct scsi_cmnd *scmd)
{
...
static int
#endif
scsi_eh_try_stu(struct scsi_cmnd *scmd)
{
