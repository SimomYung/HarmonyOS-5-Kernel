...
int scsi_send_eh_cmnd(struct scsi_cmnd *scmd, unsigned char *cmnd,
			     int cmnd_size, int timeout, unsigned sense_bytes);
int scsi_eh_tur(struct scsi_cmnd *scmd);
int scsi_eh_try_stu(struct scsi_cmnd *scmd);
#endif
...
bool is_dfa_host(struct Scsi_Host *host);
#ifdef CONFIG_DFA_MCQ_OHOS
void dfa_schedule_eh(struct Scsi_Host *shost);
#endif
#endif
