...
#elif CONFIG_UFS_4_0_HC
#define HI1861_VCMD_QUERY_TAG (MCQ_TAG_NUM - 1)
#define DEV_CMD_QUERY_TAG (MCQ_TAG_NUM - 1)
#define SYNCCACHE_CMD_TAG (MCQ_TAG_NUM - 2)
#else
