			     ...
			     int polling_delay)
{
	...
	tz->soc_shell_thermal_enable = false;
	tz->curr_polling_delay = polling_delay;
	tz->polling_count_down = 0;
	tz->soc_shell_thermal_attr_group = NULL;
	tz->soc_shell_thermal_attr_index = -1;
#endif /* CONFIG_THERMAL_SOC_SHELL */
#ifdef CONFIG_OPT_IPA_THERMAL
	tz->optimal_ipa_enable = false;
