...
extern void usb_notify_set_address_err(struct usb_device_info *udev_info);
extern void usb_notify_get_descriptor_err(struct usb_device_info *udev_info);
extern void usb_notify_enum_dev_unknown_err(struct usb_device_info *udev_info);
extern void usb_notify_transfer_err(struct usb_device_info *udev_info);
#else
static inline void usb_notify_set_address_err(struct usb_device_info *udev_info) { };
static inline void usb_notify_get_descriptor_err(struct usb_device_info *udev_info) { };
static inline void usb_notify_enum_dev_unknown_err(struct usb_device_info *udev_info) { };
static inline void usb_notify_transfer_err(struct usb_device_info *udev_info) { };
#endif
