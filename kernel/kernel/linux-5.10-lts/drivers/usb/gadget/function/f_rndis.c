...
#ifdef CONFIG_CHIP_USB_CONFIGFS
#include "../../../../platform_source/basicplatform/drivers/usb/gadget/function-vendor/f_rndis_chip.c"
#else
...
#ifdef CONFIG_CHIP_USB_CONFIGFS
static void rndis_reset_net_device(struct f_rndis_opts *opts)
{
#define ADDR_LEN 36
	...
	/* rollback to the state that after rndis_alloc_inst */
