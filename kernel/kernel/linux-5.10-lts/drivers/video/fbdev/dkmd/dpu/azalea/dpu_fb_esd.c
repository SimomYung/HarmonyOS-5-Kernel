...
#include "dpu_fb.h"
#if defined (CONFIG_LCDKIT_DRIVER) && (defined (CONFIG_HUAWEI_DSM) || defined (CONFIG_HUAWEI_OHOS_DSM))
#include "lcdkit_panel.h"
extern struct lcdkit_esd_error_info g_esd_error_info;
#endif

#if defined (CONFIG_LCD_KIT_DRIVER) && (defined (CONFIG_HUAWEI_DSM) || defined (CONFIG_HUAWEI_OHOS_DSM))
