...
#ifdef CONFIG_HKIP_PROTECT_CRED_BITMAP
...
inline long ksys_mknod(const char __user *filename, umode_t mode,
			      unsigned int dev)
{
...
inline
#endif
long ksys_symlink(const char __user *oldname,
				const char __user *newname)
{
...
inline long ksys_link(const char __user *oldname,
			     const char __user *newname)
{
