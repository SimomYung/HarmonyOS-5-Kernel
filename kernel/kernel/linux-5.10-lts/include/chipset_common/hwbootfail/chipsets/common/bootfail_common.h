...
#define BOOTFAIL_NOTIFY _IOW(BOOT_DETECTOR_IOCTL_BASE, 111, int)
#endif
...
#ifdef CONFIG_CPU_FAULT_HWDEGRADE_CDC
#define READ_SOC_PANIC_INFO _IOR(BOOT_DETECTOR_IOCTL_BASE, 2001, int)
#define WRITE_SOC_PANIC_INFO _IOW(BOOT_DETECTOR_IOCTL_BASE, 2002, int)
#define READ_ECC_NV_INFO _IOR(BOOT_DETECTOR_IOCTL_BASE, 2003, int)
#define WRITE_ECC_NV_INFO _IOW(BOOT_DETECTOR_IOCTL_BASE, 2004, int)
#endif
...
void get_kmsg_log(char *pbuf, unsigned int size);
#ifdef CONFIG_BOOT_DETECTOR_SINGLE_FRAME
void bootfail_callback(unsigned int state, char *log_path, int len);
void bootfail_logs_init(void);
void bootfail_logs_destructor(void);
void boot_detector_device_init(void);
long boot_detector_ioctl(struct file *file, unsigned int cmd, unsigned long arg, unsigned int *is_used);
