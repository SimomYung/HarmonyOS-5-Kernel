...
#define COOLINGCASE_PING_DUTY_DEFAULT    0
#define COOLINGCASE_WORK_FREQ_DEFAULT    0

#define COOLINGCASE_DUTY_DEFAULT         50
#define COOLINGCASE_CAP_MAX_DEFAULT      90
#define COOLINGCASE_CAP_MIN_DEFAULT      20
#define COOLINGCASE_FREQ_LEN             4
#define COOLINGCASE_DUTY_LEN             8
#define COOLINGCASE_CAP_LEN              4
...
#define WIRELESSCASE_STOP_MSG_LEN        1
#define COOLINGCASE_THREE_OPEN_DELAY     5000 /* 5s */
#define COOLINGCASE_THREE_CAP_DELAY      3000 /* 3s */
#define COOLINGCASE_THREE_CAP_HIGH       90   /* high cap of phone */
#define COOLINGCASE_THREE_CAP_LOW        20   /* low cap of phone */
#define COOLINGCASE_THREE_WATCHDOG_DELAY 6000 /* 6s */
#define COOLINGCASE_THREE_HWQI_PKT_DATA  2    /* lenth about cap info data */
#define COOLINGCASE_THREE_ERROR_CAP      90   /* error cap about coolingcase */
...
struct coolingcase_duty_para {
	...
	unsigned int lv_min;
	unsigned int lv_max;
	unsigned int cable_min;
	unsigned int cable_max;
};

struct coolingcase_cap_para {
	unsigned int cable_min;
	unsigned int cable_max;
	unsigned int no_cable_min;
	unsigned int no_cable_max;
};
...
struct wirelesscase_di {
	...
	struct notifier_block  wired_nb;
...
static inline void wirelesscase_send_stop_working_msg(void)
{
}
