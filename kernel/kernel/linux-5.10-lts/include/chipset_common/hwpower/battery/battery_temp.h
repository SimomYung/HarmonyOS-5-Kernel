...
int bat_temp_get_rt_temperature_for_coul(enum bat_temp_id id, int *temp);
...
static inline int bat_temp_get_rt_temperature_for_coul(enum bat_temp_id id, int *temp)
{
	return -EPERM;
}
