...
/* define ic dev name */
#define CHARGE_DEV_SCHARGERV800           "schargerv800"
...
struct charge_device_ops {
	...
	bool (*need_vusb_replace_vbus)(void);
	const char *(*get_dev_name)(void);
	int (*get_vsys_mos_enable)(bool *is_enable);
	int (*set_vsys_mos_enable)(bool enable);
	int (*get_curr_balance_mos_enable)(bool *is_enable);
	int (*set_curr_balance_mos_enable)(bool enable);
