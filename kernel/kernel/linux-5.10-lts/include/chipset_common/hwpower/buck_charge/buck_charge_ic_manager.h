...
static inline int charge_get_vbus_vset(int *volt)
{
	return -ENOTSUPP;
}
...
static inline bool charge_need_vusb_replace_vbus(void)
{
	return false;
}
...
static inline int charge_set_otg_switch_mode_enable(int enable)
{
	return -ENOTSUPP;
}
...
static inline const char *charge_get_dev_name(void)
{
	return NULL;
}

static inline int charge_get_vsys_mos_enable(bool *is_enable)
{
	return -ENOTSUPP;
}

static inline int charge_set_vsys_mos_enable(bool enable)
{
	return -ENOTSUPP;
}

static inline int charge_get_curr_balance_mos_enable(bool *is_enable)
{
	return -ENOTSUPP;
}

static inline int charge_set_curr_balance_mos_enable(bool enable)
{
	return -ENOTSUPP;
}
