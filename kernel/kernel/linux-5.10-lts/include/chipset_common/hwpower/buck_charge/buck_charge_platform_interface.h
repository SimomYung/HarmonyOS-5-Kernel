...
#define BUCK_CHARGE_CORE_VTERM_DEC_MAX                 500
...
static inline int buck_charge_check_batfet_single_status(void)
{
	return 0;
}

static inline int buck_charge_get_vsys_mos_enable(bool *is_enable)
{
}

static inline int buck_charge_set_vsys_mos_enable(bool enable)
{
}

static inline int buck_charge_set_curr_balance_mos_enable(bool *is_enable)
{
}

static inline int buck_charge_set_curr_balance_mos_enable(bool enable)
{
}
