...
#define FORCE_TEST_FLAG                    0x1
#define MULTI_SC_CHECK_FLAG                0x2
...
enum charge_mode_type {
	...
	CHARGE_MODE_TYPE_MAIN_LVC,
	CHARGE_MODE_TYPE_AUX_LVC,
	CHARGE_MODE_TYPE_SC,
...
struct charge_mode_para {
	...
	int time;
	int ext;
	int test_flag; /* bit0: force_test, bit1: multi sc check */
