...
enum power_event_notifier_list {
	...
	POWER_NE_BYPASSBOOST_CP_CTRL,
	POWER_NE_BYPASSBOOST_AP_CTRL,
	POWER_NE_BYPASSBOOST_VOUT_CHANGE,
	...
	/* section: for window shell fold/unfold */
	POWER_NE_WINDOW_SHELL_FOLD,
	POWER_NE_WINDOW_SHELL_UNFOLD,
	/* batt balance check */
	POWER_NE_BATT_BAL_ABNORMAL,
	/* section: for ntc check */
	POWER_NE_WLRX_CR_TEMP_ERR,
	POWER_NE_END,
};
