...
static inline int dc_init_adapter(int mode, int init_vset)
{
	return -EPERM;
}
...
static inline int dc_get_adapter_code(void)
{
	return 0;
}
...
static inline int dc_get_adapter_max_current(int mode, int value)
{
	return 0;
}

static inline bool dc_is_cola_or_fenda_adpter(void)
{
	return false;
}

static inline bool dc_adpt_is_iwatt_adapter(void)
{
	return false;
}
...
static inline bool dc_is_scp_superior(int ratio)
{
	return false;
}

static inline bool dc_is_power_redistributed(void)
{
	return false;
}
...
static inline int dc_set_adapter_voltage(int mode, int *value)
{
	return -EPERM;
}
...
static inline int dc_set_adapter_current(int mode, int value)
{
	return -EPERM;
}
...
static inline int dc_set_adapter_output_disable(void)
{
	return -EPERM;
}
...
static inline const char *dc_get_protocol_str(void)
{
	return "scp";
}
...
static inline int dc_adpt_update_delta_err(int mode, int target_iadap, int ratio, int delta_err)
{
	return -EPERM;
}
...
static inline int dc_adpt_get_time_sc4_pps(void)
{
        return 0;
}
...
static inline void dc_recheck_adapter_antifake(int mode)
{
}

static inline void dc_send_adapter_info_uevent(void)
{
}

static inline void dc_send_power_bank_cap_uevent(int cap)
{
}

static inline void dc_adpt_update_power_bank_cap(void)
{
}
