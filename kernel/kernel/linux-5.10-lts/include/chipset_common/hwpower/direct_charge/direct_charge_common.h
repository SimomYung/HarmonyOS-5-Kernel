...
void dc_comm_set_uevent_send_flag(bool flag);
bool dc_comm_get_uevent_send_flag(void);
#else
...
static inline void dc_comm_set_uevent_send_flag(bool flag)
{
}

static inline bool dc_comm_get_uevent_send_flag(void)
{
	return false;
}
