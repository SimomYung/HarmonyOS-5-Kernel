...
#else
static inline void dc_get_vbat_comp_para(const char *ic_name, struct dc_comp_para *info)
{
}

static inline void dc_comp_parse_dts(struct device_node *np, struct dc_comp_para *info)
{
}

static inline int dc_get_ic_vbat_comp(int ic_role)
{
	return 0;
}

static inline bool dc_use_ic_vbat_comp(void)
{
	return false;
}
