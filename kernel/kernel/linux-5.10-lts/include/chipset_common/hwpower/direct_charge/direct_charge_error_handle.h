...
void dc_set_err_type_cnt(int *buf, enum dc_eh_type type);
int dc_get_err_tpye_cnt(int *buf, enum dc_eh_type type);
void dc_reset_err_type_cnt(int *buf, int size);
#else
...
static inline void dc_set_err_type_cnt(int *buf, enum dc_eh_type type)
{
}

static inline int dc_get_err_tpye_cnt(int *buf, enum dc_eh_type type)
{
	return 0;
}

static inline void dc_reset_err_type_cnt(int *buf, int size)
{
}
