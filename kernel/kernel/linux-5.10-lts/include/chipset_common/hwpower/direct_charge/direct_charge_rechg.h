...
#define DC_RECHARGE_ADAPTER_CURRENT_COM  1000
#define DC_RECHARGE_TARGET_IBAT_DFT      0
...
static inline int dc_rechg_get_ibat(void)
{
	return 0;
}

static inline void dc_rechg_set_enable(int enable, int target_ibat)
{
}
...
static inline bool dc_rechg_check_soc(void)
{
	return false;
}
