...
int multi_ic_check_select_init_mode(struct multi_ic_check_mode_para *para, int *mode, u32 support_path);
...
#else
static inline int mulit_ic_check(int working_mode, int mode, struct multi_ic_check_para *info, int volt_ratio)
{
	return -EPERM;
}

static inline int multi_ic_check_select_tbat_id(struct multi_ic_check_mode_para *para)
{
	return 0;
}

static inline int multi_ic_check_select_init_mode(struct multi_ic_check_mode_para *para, int *mode, u32 support_path)
{
	return -EPERM;
}

static inline void multi_ic_check_set_ic_error_flag(int flag, struct multi_ic_check_mode_para *para)
{
}

static inline int multi_ic_check_ic_status(struct multi_ic_check_mode_para *para)
{
	return -EPERM;
}

static inline void multi_ic_parse_check_para(struct device_node *np, struct multi_ic_check_para *info)
{
}
