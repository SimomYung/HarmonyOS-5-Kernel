...
#define BOOST_CTRL_DISCHG_BOOST    "dischg_boost"
#define BOOST_CTRL_FLASH           "flash"
#define BOOST_CTRL_SCHARGER_GATE1   "scharger_gate1"
#define BOOST_CTRL_SCHARGER_GATE2   "scharger_gate2"
