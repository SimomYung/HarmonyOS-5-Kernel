...
#define HWFCP_USBPD_INFO              0xcf
#define HWFCP_USBPD_DISABLE_MASK      BIT(0)
#define HWFCP_USBPD_DISABLE_SHIFT     0

#define HWFCP_USBPD_DISABLE           1
#define HWFCP_USBPD_ENABLE            0
