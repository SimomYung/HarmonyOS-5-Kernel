...
#define HWSCP_TERMINAL_ID                   0x8c
#define HWSCP_TERMINAL_ID_MASK              (BIT(7) | BIT(6) | BIT(5) | \
	BIT(4) | BIT(3) | BIT(2) | BIT(1) | BIT(0))
#define HWSCP_TERMINAL_ID_SHIFT             0
#define HWSCP_TERMINAL_ID_HW                0xaa
#define HWSCP_TERMINAL_ID_HONOR             0x55
...
#define HWSCP_SSTS_ALLOCATE_MASK            BIT(4)
#define HWSCP_SSTS_ALLOCATE_SHIFT           4
...
#define HWSCP_ALLOCATE_ENABLE               1
#define HWSCP_ALLOCATE_DEFAULE              0
...
#define HWSCP_POWER_ALLOCATE                0xb6
#define HWSCP_SLAVE_SUPPORT_PA_MASK         BIT(1)
#define HWSCP_SLAVE_SUPPORT_PA_SHIFT        1
#define HWSCP_MASTER_SUPPORT_PA_MASK        BIT(0)
#define HWSCP_MASTER_SUPPORT_PA_SHIFT       0
#define HWSCP_SLAVE_SUPPORT_PA              1
#define HWSCP_MASTER_PA_ENABLE              1
#define HWSCP_MASTER_PA_DISABLE             0
...
#define HWSCP_REG_F0                        0xf0
#define HWSCP_REG_F1                        0xf1
#define HWSCP_REG_F2                        0xf2
...
struct hwscp_device_info {
	...
	int terminal_id_rd_flag;
	int adp_sn_rd_flag;
	int pwr_allocate_support_rd_flag;
	int rw_error_flag;
