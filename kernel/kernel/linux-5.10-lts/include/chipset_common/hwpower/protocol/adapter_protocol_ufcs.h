...
#include <chipset_common/hwpower/protocol/adapter_protocol_ufcs_constants.h>
...
enum hwufcs_vdm_control_message {
	...
	HWUFCS_VDM_CTL_MSG_GET_EXPAND_CURRENT,
	HWUFCS_VDM_CTL_MSG_GET_POWER_REDISTRIBUTE,
	HWUFCS_VDM_CTL_MSG_GET_ADP_SN = 0x6,
	HWUFCS_VDM_CTL_MSG_GET_POWER_BANK_CAP,
...
enum hwufcs_vdm_data_message {
	...
	HWUFCS_VDM_DATA_MSG_ADP_SN = 0x6,
	HWUFCS_VDM_DATA_MSG_POWER_BANK_CAP,
...
struct hwufcs_device_info {
	...
	struct hwufcs_source_info_data source_info_data;
...
struct hwufcs_ops {
	...
	bool (*is_ignore_accept_in_auth_encrypt)(void *dev_data);
};
