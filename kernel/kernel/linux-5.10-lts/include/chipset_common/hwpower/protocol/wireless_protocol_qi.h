...
#define HWQI_CMD_TX_POWER                           0x0c /* get tx power */
...
#define HWQI_CMD_GET_FOD_STATUS                     0x8b
#define HWQI_CMD_GET_FOD_KM_KZ                      0x8c
#define HWQI_CMD_SET_TX_VPA_LIM                     0x8d
#define HWQI_CMD_GET_TX_ADAPTER_ERR_CODE            0x8e
#define HWQI_CMD_GET_FOD_RESULT                     0X92 /* get fod result */
#define HWQI_CMD_GET_TX_ADAPTER_ID                  0X93 /* get adapter id */
...
#define HWQI_CMD_GET_TX_SN                          0x5b
...
#define HWQI_CMD_NAK                                0xf0 /* deny a request */
#define HWQI_CMD_ND                                 0xf5 /* unrecognized or invalid request */
...
#define HWQI_HANDSHAKE_ID_HW_SLOT                   0x8855
#define HWQI_HANDSHAKE_ID_HW_SLE                    0x88
#define HWQI_HANDSHAKE_ID_HW_SLOT_SLE               0x55
...
/* cmd 0x5b */
#define HWQI_ACK_TX_SN_LEN                          5
#define HWQI_ACK_TX_SN_S                            1
#define HWQI_ACK_TX_SN_E                            4
...
/* cmd 0x0c */
#define HWQI_PARA_GET_PTX_LEN                       3
#define HWQI_PARA_PTX_S                             1
#define HWQI_PARA_PTX_E                             2
...
#define HWQI_PARA_WIRELESSCASE_STOP_MSG             0x02
...
#define HWQI_CHRG_STATE_MASK                        0x03   /* charge state: bit[0:1]*/
#define HWQI_WLCASE_SOC_SHIFT_BITS                  2      /* wirelesscase soc: bit[2:5]*/
#define HWQI_WLCASE_SOC_MASK                        0x0F
#define HWQI_WLCASE_SOC_INFO_NUM                    2
...
#define HWQI_PARA_TX_EXT_CAP_SUPPORT_QVAL_CALI_MASK BIT(2)
#define HWQI_PARA_TX_EXT_ADAPTER_INFO_MASK          BIT(1)
#define HWQI_PARA_TX_EXT_FOD_INFO_MASK              BIT(2)
...
/* cmd 0x8b */
#define HWQI_PARA_GET_FOD_STATUS_LEN                3
#define HWQI_PARA_GET_FOD_FR                        1
#define HWQI_PARA_GET_FOD_QR                        2

/* cmd 0x8c */
#define HWQI_PARA_GET_FOD_KM_KZ_LEN                 5
#define HWQI_PARA_GET_FOD_KM_L                      1
#define HWQI_PARA_GET_FOD_KM_H                      2
#define HWQI_PARA_GET_FOD_KZ_L                      3
#define HWQI_PARA_GET_FOD_KZ_H                      4
#define HWQI_PARA_GET_FOD_CALI_SUCC_MASK            BIT(7)
#define HWQI_PARA_GET_FOD_CALI_SUCC_SHIFT           7
...
/* cmd 0x8e */
#define HWQI_PARA_GET_ADAPTER_ERR_CODE_LEN          5
#define HWQI_PARA_ADAPTER_ERR_CODE_S                1
#define HWQI_PARA_ADAPTER_ERR_CODE_E                2

/* cmd 0x92 */
#define HWQI_PARA_GET_TX_FOD_RESULT_LEN             5
#define HWQI_PARA_TX_FOD_Q_QP_RATIO_OFFSET          1
#define HWQI_PARA_TX_FOD_LIMIT_POWER_OFFSET         2
#define HWQI_PARA_TX_FOD_QS_OFFSET                  3
#define HWQI_PARA_TX_FOD_FS_OFFSET                  4

/* cmd 0x93 */
#define HWQI_PARA_GET_ADAPTER_ID_LEN                5
#define HWQI_PARA_ADAPTER_ID_S                      1
#define HWQI_PARA_ADAPTER_ID_E                      2
#define HWQI_PARA_ADAPTER_TYPE_OFFSET               3
#define HWQI_PARA_ADAPTER_TYPE_MASK                 0x03
...
#define HWQI_TX_TYPE_P0010                          0x886d
#define HWQI_TX_TYPE_UPGRADE                        0x8877
#define HWQI_TX_TYPE_UPGRADE_FSK                    0x887e
...
/* for wirelesscase soc */
#define HWQI_WLCASE_SOC_MIN_LEVEL                   1
#define HWQI_WLCASE_SOC_MAX_LEVEL                   10
