...
struct wlrx_ic_ops {
	...
	int (*get_prx)(int *prx, void *dev_data);
	...
	int (*get_ping_fop)(int *fop, void *dev_data);
	int (*get_ping_vrect)(int *vrect, void *dev_data);
...
int wlrx_ic_get_ping_fop(unsigned int type, int *fop);
int wlrx_ic_get_ping_vrect(unsigned int type, int *vrect);
...
int wlrx_ic_get_prx(unsigned int type, int *prx);
#else
...
static inline int wlrx_ic_get_ping_fop(unsigned int type, int *fop)
{
	return -EPERM;
}

static inline int wlrx_ic_get_ping_vrect(unsigned int type, int *vrect)
{
	return -EPERM;
}
...
static inline int wlrx_ic_get_prx(unsigned int type, int *prx)
{
    return -EPERM;
}
