...
static inline int wlrx_pwr_eff_init(unsigned int drv_type)
{
	return -ENOTSUPP;
}

static inline void wlrx_pwr_eff_deinit(unsigned int drv_type)
{
}

static inline int wlrx_mon_init(unsigned int drv_type, struct device *dev)
{
}

static inline void wlrx_mon_deinit(unsigned int drv_type)
{
}
