...
/* for tx_alarm reserved info */
#define TX_ALARM_SWITCH_PWR_SRC_MASK    BIT(0)
#define TX_ALARM_SWITCH_PWR_SRC_SHIFT   0
...
bool wltx_alarm_can_swtich_pwr_src(struct wltx_alarm *alarm);
#else
...
static inline bool wltx_alarm_can_swtich_pwr_src(struct wltx_alarm *alarm)
{
	return false;
}
