...
struct wltx_ic_ops {
	...
	int (*set_ping_duty)(u16 ping_duty, void *dev_data);
	int (*switch_modem)(void *dev_data);
	int (*set_rx_type)(void *dev_data, int type);
	int (*get_fod_gap_state)(void *dev_data, u16 *fod_gap_state);
};
...
int wltx_ic_set_ping_duty(unsigned int type, u16 ping_duty);
int wltx_ic_switch_modem(unsigned int type);
int wltx_ic_set_rx_type(unsigned int type, int rx_type);
int wltx_ic_get_fod_gap_state(unsigned int type, u16 *fod_gap_state);
#else
...
static inline int wltx_ic_set_ping_duty(unsigned int type, u16 ping_duty)
{
	return -EPERM;
}

static inline int wltx_ic_switch_modem(unsigned int type)
{
	return -EPERM;
}

static inline int wltx_ic_set_rx_type(unsigned int type, int rx_type)
{
	return -EPERM;
}

static inline int wltx_ic_get_fod_gap_state(unsigned int type, u16 *fod_gap_state)
{
	return -EPERM;
}
