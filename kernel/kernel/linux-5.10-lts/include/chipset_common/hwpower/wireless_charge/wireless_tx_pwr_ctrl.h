...
enum wltx_pwr_type {
	...
	WL_TX_PWR_5VBST_RVSSC_CP,
	WL_TX_PWR_5VBST_9VOTG,
	WL_TX_PWR_5VBST_5VBST_9VOTG,
	WL_TX_PWR_5VBST_VBUS_OTG_CP2,
	WL_TX_PWR_END,
};
...
static inline int wltx_pwr_prevfod_switch_pwr_handler(void)
{
	return -ENOTSUPP;
}

static inline bool wltx_pwr_need_set_init_pwr_src(void)
{
	return false;
}
