...
enum dev_check_type {               /* id */
	...
	DEV_I2C_EXT_GPIO,           /* 48 used in kernel layer */
	DEV_I2C_G_SENSOR_1,         /* 49 used in kernel layer */
	DEV_I2C_GYROSCOPE1,         /* 50 used in kernel layer */
	DEV_I2C_G_SENSOR_2,         /* 51 used in kernel layer */
	DEV_I2C_GYROSCOPE2,         /* 52 used in kernel layer */
	DEV_I2C_L_SENSOR_1,         /* 53 used in kernel layer */
	DEV_I2C_E_USB,              /* 54 used in kernel layer */
	DEV_I2C_SENSOR,             /* 55 used in kernel layer */
	DEV_I2C_PHY,                /* 56 used in kernel layer */
	DEV_I2C_MAX,                /* MAX 57 */
};
...
static const struct dev_detect_type dev_detect_table[] = {
	...
	{ DEV_I2C_EXT_GPIO, "ext_gpio" },            /* id : 48 in number 49 */
	{ DEV_I2C_G_SENSOR_1, "g_sensor1" },         /* id : 49 in number 50 */
	{ DEV_I2C_GYROSCOPE1, "gyroscope1" },        /* id : 50 in number 51 */
	{ DEV_I2C_G_SENSOR_2, "g_sensor2" },         /* id : 51 in number 52 */
	{ DEV_I2C_GYROSCOPE2, "gyroscope2" },        /* id : 52 in number 53 */
	{ DEV_I2C_L_SENSOR_1, "l_sensor1" },         /* id : 53 in number 54 */
	{ DEV_I2C_E_USB, "e_usb" },                  /* id : 54 in number 55 */
	{ DEV_I2C_SENSOR, "sht3x" },                 /* id : 55 in number 56 */
	{ DEV_I2C_PHY, "yt8011" },                   /* id : 56 in number 57 */
};
