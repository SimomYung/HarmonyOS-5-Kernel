...
static inline int get_battery_type_by_id(unsigned int index, char *name, unsigned int name_size)
{
	return -ENOTSUPP;
}
...
static inline int get_battery_sn_by_id(unsigned int index, char *sn_buf,
    unsigned int buf_size, unsigned int *sn_len)
{
	return -ENOTSUPP;
}

static inline int get_battery_activation_info_by_id(unsigned int index, struct activation_info *activation)
{
	return -ENOTSUPP;
}

static inline int set_battery_activation_info_by_id(unsigned int index, struct activation_info activation)
{
	return -ENOTSUPP;
}

static inline int get_battery_cycle_by_id(unsigned int index, u16 *cycle)
{
	return -ENOTSUPP;
}

static inline int set_battery_cycle_by_id(unsigned int index, u16 cycle)
{
	return -ENOTSUPP;
}

static inline int get_battery_real_soh_by_id(unsigned int index, u8 *real_soh)
{
	return -ENOTSUPP;
}

static inline int set_battery_real_soh_by_id(unsigned int index, u8 real_soh)
{
	return -ENOTSUPP;
}

static inline int get_battery_display_soh(u8 *display_soh)
{
	return -ENOTSUPP;
}

static inline int set_battery_display_soh(u8 display_soh)
{
	return -ENOTSUPP;
}
