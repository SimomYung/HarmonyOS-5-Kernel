...
#define WLTX_ABNORMAL_VBAT               3450 /* mV */
...
struct wltx_dev_info {
	...
	struct wltx_vset_para sc12_dts_vset;
	struct wltx_vset_para sc14_dts_vset;
	int pwr_src_vset_level;
	struct wltx_pwr_src_vset_para pwr_src_vset[WLTX_PWR_SRC_VSET_ROW];
	...
	int rxsw_ctrl_ovp;
	unsigned int new_hp_timeout;
	unsigned int abnormal_vbat;
	int tx_third_party_ilim;
};
