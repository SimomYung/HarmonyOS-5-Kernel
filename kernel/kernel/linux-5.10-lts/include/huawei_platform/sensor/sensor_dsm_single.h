...
int sensor_dsm_single_convert_dsm_to_hisysevent(int err_no, int *dsm_error_level,
	char *dsm_domain, char *name, char *key);
int sensor_dsm_single_report_hiview(const char *domain, const char *error_name,
	const char *key, const char *value, unsigned int err_level);
