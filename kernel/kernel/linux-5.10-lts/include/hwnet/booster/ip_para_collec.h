...
#define SINGLE_UID_MASK 1000000 // the single frame uid is > 1000000
...
#define FG_MAX_CUSTOM_APP 10
#define FG_TCP_BITMAP 0x01
#define FG_UDP_BITMAP 0x02
...
#define fg_set_app_type(sk, value) \
	{ \
		(sk)->__sk_common.skc_hwdpi_mark |= (value << 8); \
	}
 
#define fg_init_app_type(sk) \
	{ \
...
#define fg_set_discard_timer(sk, value) \
	{ \
		(sk)->discard_duration = (value); \
	}
#endif

enum ul_timer_threshold {
	CON_UL_TIMER_THR_1 = 630,
	CON_UL_TIMER_THR_2 = 3160,
	CON_UL_TIMER_THR_3 = 9500,
	CON_UL_TIMER_THR_4 = 34800,
	CON_UL_TIMER_THR_BUTT
};
 
enum ul_timer_bitmap {
	CON_UL_TIMER_BIT_1 = 0x00,
	CON_UL_TIMER_BIT_2 = 0x40,
	CON_UL_TIMER_BIT_3 = 0x80,
	CON_UL_TIMER_BIT_4 = 0xC0,
	CON_UL_TIMER_BIT_BUTT
};
 
enum ul_timer_value {
	CON_UL_TIMER_VAL_10 = 10,
	CON_UL_TIMER_VAL_40 = 40,
	CON_UL_TIMER_VAL_100 = 100,
	CON_UL_TIMER_VAL_400 = 400,
	CON_UL_TIMER_VAL_640 = 640,
	CON_UL_TIMER_VAL_3200 = 3200,
	CON_UL_TIMER_VAL_9600 = 9600,
	CON_UL_TIMER_VAL_BUTT
};

struct fg_custom_info {
	uint32_t uid;
	uint8_t protocol_bitmap; /* BIT0:tcp; BIT1:udp */
	uint8_t tcp_retran_discard; /* Bit7 is switch flag, bit0~bit6 is value */
	uint8_t discard_timer;
	uint8_t app_type;
};

struct fg_custom_msg {
	short type; // Event enumeration values
	short len; // The length behind this field, the limit lower 2048
	struct fg_custom_info fg_custom_info_msg;
};
...
/* Tcp recover from the upper layer is defined as:*/
struct tcp_recover_qoe_msg {
	u16 type;
	u16 len;
	u32 qoe_state;
};
