...
const u16 cmd_map_model[CMD_NUM_MAX][MAP_ENTITY_NUM] = {
	...
	{INFER_MODEL_COLLECT_START, IP_PARA_COLLEC},
	{INFER_MODEL_COLLECT_STOP, IP_PARA_COLLEC},
	/* iaware game flow qoe cmd */
	{GAME_FLOW_QOE_CMD, IP_PARA_COLLEC},
	/* tcp recover cmd */
	{TCP_RECOVERY_BASE_ON_APP_CMD, IP_PARA_COLLEC},
	...
	{TCP_PKT_COLLEC_WITH_IP_TYPE_CMD, TCP_PARA_COLLEC},
	...
	{ AP_MSG_QOE_WIFI_SUBCHIP_NTFY, WIFI_PARA_COLLEC},
	...
	{ SMARTCURE_PARA_COLLEC_CMD, TCP_PARA_COLLEC },
	{ LABEL_HIGH_PRIORITY_CMD, IP_PARA_COLLEC }
};
...
static void nl_notify_event(struct res_msg_head *msg)
{
	...
	memcpy_s(&p->msg, msg->len, msg, msg->len);
...
static int __nl_notify_event(struct res_msg_head *msg)
{
	...
	memcpy_s(pdata, msg->len, msg, msg->len);
...
static int __init netlink_handle_module_init(void)
{
	...
	memset_s(&g_ctx.model_cb[0], MODEL_NUM * sizeof(msg_process *), 0, MODEL_NUM * sizeof(msg_process *));
