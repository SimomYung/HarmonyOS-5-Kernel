...
enum msg_rpt_type {
	...
	SMARTCURE_PKT_COUNT_RPT = 21,
	MS_MODEL_PARA_RPT = 22,
	PACKET_QUEUE_STAT_RPT = 23,
    PACKET_QUEUE_ERROR_RPT = 24,
	TCP_ZERO_WINDOW_RPT = 25,
...
enum req_msg_type {
	...
	SMARTCURE_PARA_COLLEC_CMD = 50,
	LABEL_HIGH_PRIORITY_CMD = 51,
	INFER_MODEL_COLLECT_START = 52,
	INFER_MODEL_COLLECT_STOP = 53,
	TCP_RECOVERY_BASE_ON_APP_CMD = 54,
	TCP_PKT_COLLEC_WITH_IP_TYPE_CMD = 55,
	
	// QOE module uses 100 ~200
	AP_MSG_QOE_WIFI_SUBCHIP_NTFY = 103,
