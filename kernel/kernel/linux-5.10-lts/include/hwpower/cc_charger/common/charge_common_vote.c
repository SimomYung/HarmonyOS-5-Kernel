...
static const char * const g_vote_client_name[] = {
	...
	[VOTE_CLIENT_CURR_STATIC_CCCV] = "client:static_cccv",
	[VOTE_CLIENT_CURR_TBAT] = "client:tbat",
	[VOTE_CLIENT_CURR_ADPT] = "client:adpt",
	[VOTE_CLIENT_CURR_CABLE] = "client:cable",
	[VOTE_CLIENT_CURR_CUR_MODE] = "client:cur_mode",
	[VOTE_CLIENT_CURR_TIME] = "client:time",
	[VOTE_CLIENT_CURR_MULTI_IC] = "client:multi_ic",
	[VOTE_CLIENT_CURR_THERMAL] = "client:thermal",
	[VOTE_CLIENT_CURR_BATTERY_CARE] = "client:battery_care",
	[VOTE_CLIENT_CURR_DYNAMIC_CCCV] = "client:dynamic_cccv",
	[VOTE_CLIENT_CURR_BALANCE] = "client:balance",
	[VOTE_CLIENT_CURR_CC_UNSAFE] = "client:cc_unsafe",
};
...
static const int g_dc_current_table[] = {
	VOTE_CLIENT_CURR_STATIC_CCCV,
	VOTE_CLIENT_CURR_TBAT,
	VOTE_CLIENT_CURR_ADPT,
	VOTE_CLIENT_CURR_CABLE,
	VOTE_CLIENT_CURR_CUR_MODE,
	VOTE_CLIENT_CURR_TIME,
	VOTE_CLIENT_CURR_MULTI_IC,
	VOTE_CLIENT_CURR_THERMAL,
	VOTE_CLIENT_CURR_BATTERY_CARE,
	VOTE_CLIENT_CURR_DYNAMIC_CCCV,
	VOTE_CLIENT_CURR_BALANCE,
	VOTE_CLIENT_CURR_CC_UNSAFE,
};
...
static const struct chg_vote_table g_dc_vote_tbl[] = {
	...
	{ VOTE_OBJ_CURRENT, "DC:current", POWER_VOTE_SET_MIN, g_dc_current_table,
		ARRAY_SIZE(g_dc_current_table), NULL, NULL},
};
...
static const char *chg_vote_operator_get_effective_client_locked(const struct chg_vote_table *tbl,
	int tbl_size, unsigned int obj, bool lock_flag)
{
	int idx;
	...
	return power_vote_get_effective_client_locked(tbl[idx].obj_name, lock_flag);
}
...
const char *chg_vote_get_effective_client_locked(unsigned int obj_type, unsigned int obj,
	bool lock_flag)
{
	struct chg_vote_data *data = g_chg_vote_data;
	...
	return chg_vote_operator_get_effective_client_locked(data[obj_type].tbl,
		data[obj_type].tbl_size, obj, lock_flag);
}
