...
#define FACTORY_MODE                      "runmode=factory"
#define POWERDOWN_CHARGING_MODE           "ohos.boot.mode=charger"
#else
#define FACTORY_MODE                      "androidboot.swtype=factory"
#define POWERDOWN_CHARGING_MODE           "androidboot.mode=charger"
...
bool power_cmdline_is_factory_mode(void)
{
	...
	if (strstr(saved_command_line, FACTORY_MODE))
...
bool power_cmdline_is_powerdown_charging_mode(void)
{
	...
	if (strstr(saved_command_line, POWERDOWN_CHARGING_MODE))
