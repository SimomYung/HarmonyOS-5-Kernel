...
struct hisysevent_error_no_map hisysevent_map[] = {
	{ DSM_BATTERY_DETECT_ERROR_NO, POWER_DSM_LEVEL_STATISTIC, "BATTERY", "BAT_ID_DET_ABNORMAL", "CONTENT", 1 },
	...
	{ DSM_UNMATCH_BATTERYS, POWER_DSM_LEVEL_STATISTIC, "BATTERY", "SN_OF_BATTERIES_MISMATCHED", "CONTENT", 1 },
	...
	{ DSM_DUAL_BATTERY_CURRENT_BIAS_DETECT, POWER_DSM_LEVEL_STATISTIC, "BATTERY",
		"DUAL_BAT_CUR_BIAS_DETECT", "CONTENT", 1 },
	{ DSM_DUAL_BATTERY_CAPACITY_DIFFERENT_DETECT, POWER_DSM_LEVEL_STATISTIC, "BATTERY",
		"DUAL_BAT_CAP_DIFF_DETECT", "CONTENT", 1 },
	{ DSM_DUAL_BATTERY_OUT_OF_POSITION_DETECTION, POWER_DSM_LEVEL_FAULT, "BATTERY", "DUAL_BAT_ABSENCE", "CONTENT", 1 },

	/* battery */
	{ ERROR_BATT_NOT_EXIST, POWER_DSM_LEVEL_FAULT, "BATTERY", "BAT_ABSENCE", "CONTENT", 1 },
	{ ERROR_BATT_TEMP_LOW, POWER_DSM_LEVEL_STATISTIC, "BATTERY", "BAT_UNDER_TEMPERATURE", "CONTENT", 1 },
	{ ERROR_BATT_VOLT_HIGH, POWER_DSM_LEVEL_FAULT, "BATTERY", "BAT_OVER_VOLTAGE", "CONTENT", 1 },
	{ ERROR_BATT_VOLT_LOW, POWER_DSM_LEVEL_STATISTIC, "BATTERY", "BAT_UNDER_VOLTAGE", "CONTENT", 1 },
	{ ERROR_BATT_TERMINATE_TOO_EARLY, POWER_DSM_LEVEL_STATISTIC, "BATTERY", "BAT_CUTOFF_EARLY", "CONTENT", 0 },
	{ ERROR_BATT_NOT_TERMINATE, POWER_DSM_LEVEL_STATISTIC, "BATTERY", "BAT_CUTOFF_NEVER", "CONTENT", 0 },
	{ ERROR_BATT_BAD_CURR_SENSOR, POWER_DSM_LEVEL_FAULT, "BATTERY", "BAT_CURRENT_DETECT_ERROR", "CONTENT", 1 },
	{ ERROR_VBUS_VOLT_HIGH, POWER_DSM_LEVEL_STATISTIC, "BATTERY", "VBUS_OVER_VOLTAGE", "CONTENT", 1 },
	{ ERROR_WATCHDOG_RESET, POWER_DSM_LEVEL_STATISTIC, "BATTERY", "WATCHDOG_OVER_TIME", "CONTENT", 0 },
	{ ERROR_CHARGE_CURR_OVERHIGH, POWER_DSM_LEVEL_FAULT, "BATTERY", "CHARGING_CURRENT_LARGE", "CONTENT", 1 },
	{ ERROR_DISCHARGE_CURR_OVERHIGH, POWER_DSM_LEVEL_FAULT, "BATTERY", "DISCHARGING_CURRENT_LARGE", "CONTENT", 1 },
	{ ERROR_CHARGE_CURR_ZERO, POWER_DSM_LEVEL_FAULT, "BATTERY", "RESISTER_CURRENT_ZERO", "CONTENT", 1 },
	{ ERROR_CHARGE_TEMP_FAULT, POWER_DSM_LEVEL_STATISTIC, "BATTERY", "TEMP_FAULT_NOT_CHARGING", "CONTENT", 0 },
	{ ERROR_CHARGE_BATT_TEMP_SHUTDOWN, POWER_DSM_LEVEL_STATISTIC, "BATTERY", "BATT_SHUTDOWN_TEMP", "CONTENT", 1 },
	...
	{ ERROR_FCP_DETECT, POWER_DSM_LEVEL_STATISTIC, "BATTERY", "FCP_DETECT_FAILED", "CONTENT", 1 },
	{ ERROR_FCP_OUTPUT, POWER_DSM_LEVEL_STATISTIC, "BATTERY", "FCP_BOOST_FAILED", "CONTENT", 1 },
	{ ERROR_SWITCH_ATTACH, POWER_DSM_LEVEL_STATISTIC, "BATTERY", "FCP_DEATTACH", "CONTENT", 1 },
	{ ERROR_ADAPTER_OVLT, POWER_DSM_LEVEL_FAULT, "BATTERY", "FCP_OVER_VOLTAGE", "CONTENT", 1 },
	{ ERROR_ADAPTER_OCCURRENT, POWER_DSM_LEVEL_FAULT, "BATTERY", "FCP_OVER_CURRENT", "CONTENT", 1 },
	{ ERROR_ADAPTER_OTEMP, POWER_DSM_LEVEL_FAULT, "BATTERY", "FCP_OVER_TEMPERATURE", "CONTENT", 1 },
	{ ERROR_SAFE_PLOICY_LEARN, POWER_DSM_LEVEL_STATISTIC, "BATTERY", "BAT_FCC_LEARN", "CONTENT", 0 },
	{ ERROR_SAFE_PLOICY_LEARN1, POWER_DSM_LEVEL_STATISTIC, "BATTERY", "BAT_FCC_LEARN_ONLY_90", "CONTENT", 0 },
	{ ERROR_WEAKSOURCE_HAPPEN, POWER_DSM_LEVEL_STATISTIC, "BATTERY", "WEAKSOURCE_HAPPENED", "CONTENT", 0 },
	{ ERROR_SAFE_PLOICY_LEARN2, POWER_DSM_LEVEL_FAULT, "BATTERY", "BAT_FCC_LEARN_ONLY_80", "CONTENT", 1 },
	{ ERROR_SAFE_PLOICY_LEARN3, POWER_DSM_LEVEL_FAULT, "BATTERY", "BAT_FCC_LEARN_ONLY_60", "CONTENT", 1 },
	{ ERROR_BOOST_OCP, POWER_DSM_LEVEL_STATISTIC, "BATTERY", "OTG_OCP", "CONTENT", 1 },
	{ ERROR_CHARGE_I2C_RW, POWER_DSM_LEVEL_FAULT, "BATTERY", "CHARGER_I2C_RW_FAIL", "CONTENT", 1 },
	{ ERROR_BATT_SOC_CHANGE_FAST, POWER_DSM_LEVEL_FAULT, "BATTERY", "BAT_SOC_VARY_TOO_FAST", "CONTENT", 1 },
	{ ERROR_CHARGE_VBAT_OVP, POWER_DSM_LEVEL_FAULT, "BATTERY", "VBAT_OVP", "CONTENT", 0 },
	{ ERROR_SAFE_PLOICY_LEARN4, POWER_DSM_LEVEL_STATISTIC, "BATTERY", "BAT_FCC_LEARN_ONLY_95", "CONTENT", 1 },
	...
	{ DSM_DIRECT_CHARGE_ERR_WITH_NONSTD_CABLE, POWER_DSM_LEVEL_STATISTIC, "BATTERY",
		"DC_FAIL_WITH_NON_STAND_CABLE", "CONTENT", 1 },
	...
	{ DSM_DIRECT_CHARGE_ERR_WITH_STD_CABLE, POWER_DSM_LEVEL_FAULT, "BATTERY",
		"DC_DISABLED_ERROR_EXCEED_TIMES", "CONTENT", 1 },
	{ DSM_DIRECT_CHARGE_USB_PORT_LEAKAGE_CURRENT, POWER_DSM_LEVEL_STATISTIC, "BATTERY",
		"DC_LEAKAGE_CURRENT_OVER_TH", "CONTENT", 0 },
	{ DSM_DIRECT_CHARGE_VBUS_OVP, POWER_DSM_LEVEL_FAULT, "BATTERY", "DC_VBUS_OVP_HAPPENED", "CONTENT", 1 },
	{ DSM_DIRECT_CHARGE_REVERSE_OCP, POWER_DSM_LEVEL_FAULT, "BATTERY", "DC_REVERSE_OCP_HAPPENED", "CONTENT", 1 },
	{ DSM_DIRECT_CHARGE_OTP, POWER_DSM_LEVEL_FAULT, "BATTERY", "DC_OTP_HAPPENED", "CONTENT", 1 },
	{ DSM_DIRECT_CHARGE_INPUT_OCP, POWER_DSM_LEVEL_STATISTIC, "BATTERY", "DC_INPUT_OCP_HAPPENED", "CONTENT", 1 },
	{ DSM_DIRECT_CHARGE_ADAPTER_OTP, POWER_DSM_LEVEL_FAULT, "BATTERY", "DC_ADAPTOR_OTP", "CONTENT", 1 },
	...
	{ ERROR_VBUS_VOL_OVER_13400MV, POWER_DSM_LEVEL_STATISTIC, "BATTERY", "VBUS_OVER_13400MV", "CONTENT", 1 },
	...
	{ ERROR_WIRELESS_RX_OPP, POWER_DSM_LEVEL_STATISTIC, "BATTERY", "WLC_RX_OPP_HAPPENED", "CONTENT", 1 },
	{ ERROR_WIRELESS_RX_CR_TEMP_ERR, POWER_DSM_LEVEL_FAULT, "BATTERY", "WLC_RX_CR_TEMP_ERR", "CONTENT", 1 },
	...
	{ ERROR_BATT_ACR_OVER_THRESHOLD, POWER_DSM_LEVEL_STATISTIC, "BATTERY", "BAT_ACR_OVER_TH", "CONTENT", 1 },
	{ ERROR_NO_BYPASS_BOOST_FAULT, POWER_DSM_LEVEL_FAULT, "BATTERY", "BYPASS_BOOST_ABNORMAL_STATUS", "CONTENT", 1 },
	{ ERROR_NO_BYPASS_BOOST_I2C_TRANS_FAIL, POWER_DSM_LEVEL_FAULT, "BATTERY", "BYPASS_BOOST_I2C_TRANS_FAIL", "CONTENT", 1 },
	...
	{ ERROR_NO_TYPEC_CC_OVP, POWER_DSM_LEVEL_STATISTIC, "BATTERY", "PORT_OVP_IN_CC_SBU_DPDM", "CONTENT", 1 },
	...
	{ DSM_WLPS_GPIO_TXSW, POWER_DSM_LEVEL_FAULT, "BATTERY", "WL_TX_GPIO_CHECK_FAILED", "CONTENT", 1 },
	...
	{ POWER_DSM_CVT_ABNORMAL, POWER_DSM_LEVEL_FAULT, "BATTERY", "BAT_CV_T_SLOPE_OVER_TH", "CONTENT", 0 },
	{ POWER_DSM_FASTFCC_SLOPE_OVER_THRESHOLD, POWER_DSM_LEVEL_FAULT, "BATTERY",
		"FASTFCC_CYCLE_SLOPE_OVER_TH", "CONTENT", 1 },
	{ POWER_DSM_ACR_SLOPE_OVER_THRESHOLD, POWER_DSM_LEVEL_FAULT, "BATTERY", "BAT_ACR_SLOPE_OVER_TH", "CONTENT", 1 },
	{ DSM_MULTI_CHARGE_CURRENT_RATIO_ERROR, POWER_DSM_LEVEL_FAULT, "BATTERY",
		"DC_CUR_BALANCE_FATAL_EXCEPTION", "CONTENT", 1 },
	{ DSM_MULTI_CHARGE_CURRENT_RATIO_WARNING, POWER_DSM_LEVEL_STATISTIC, "BATTERY",
		"DC_CUR_BALANCE_OVER_TH", "CONTENT", 1 },
	...
	{ ERROR_NO_SMPL, POWER_DSM_LEVEL_FAULT, "BATTERY", "SMPL", "CONTENT", 1 },
	...
	{ DSM_DIRECT_CHARGE_SC_FAULT_IBUS_OCP, POWER_DSM_LEVEL_STATISTIC, "BATTERY", "DC_FAULT_IBUS_OCP", "CONTENT", 1 },
	{ DSM_DIRECT_CHARGE_SC_FAULT_TSBAT_OTP, POWER_DSM_LEVEL_STATISTIC, "BATTERY", "DC_FAULT_TSBAT_OTP", "CONTENT", 0 },
	{ DSM_DIRECT_CHARGE_SC_FAULT_VBUS_OVP, POWER_DSM_LEVEL_STATISTIC, "BATTERY", "DC_FAULT_VBUS_OVP", "CONTENT", 1 },
	...
	{ DSM_DIRECT_CHARGE_SC_FAULT_TDIE_OTP, POWER_DSM_LEVEL_STATISTIC, "BATTERY", "DC_FAULT_TDIE_OTP", "CONTENT", 1 },
	{ DSM_DIRECT_CHARGE_SC_FAULT_AC_OVP, POWER_DSM_LEVEL_STATISTIC, "BATTERY", "DC_FAULT_AC_OVP", "CONTENT", 1 },
	...
	/* uscp */
	{ ERROR_NO_USB_SHORT_PROTECT, POWER_DSM_LEVEL_STATISTIC, "BATTERY", "USB_SHORT_PROTECT", "CONTENT", 1 },
	{ ERROR_NO_USB_SHORT_PROTECT_NTC, POWER_DSM_LEVEL_STATISTIC, "BATTERY", "USB_SHORT_PROTECT_NTC", "CONTENT", 1 },
	{ ERROR_NO_USB_SHORT_PROTECT_HIZ, POWER_DSM_LEVEL_STATISTIC, "BATTERY", "USB_SHORT_PROTECT_HIZ", "CONTENT", 1 },
	...
	{ BMSBEHAVIOR_BATTERY_NOT_PRESENT, POWER_DSM_LEVEL_FAULT, "BATTERY", "BAT_NOT_PRESENT", "CONTENT", 0 },
};
