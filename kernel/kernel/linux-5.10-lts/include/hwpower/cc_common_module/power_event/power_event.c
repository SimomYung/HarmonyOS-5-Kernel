...
static const char * const g_power_event_ne_table[POWER_NE_END] = {
	...
	[POWER_NE_WLRX_TX_VERSION] = "wlrx_tx_version",
	/* section: for charger */
	...
	/* section: for auth */
	[POWER_NE_BMS_AUTH_START_FORCE] = "auth_start",
	...
	/* section: for phone fold/unfold */
	[POWER_NE_WINDOW_SHELL_FOLD] = "window_shell_fold",
	[POWER_NE_WINDOW_SHELL_UNFOLD] = "window_shell_unfold",
	/* section: dc batt balance check */
	[POWER_NE_BATT_BAL_ABNORMAL] = "batt_balance_abnormal",
	[POWER_NE_WLRX_CR_TEMP_ERR] = "wlrx_cr_temp_error",
};
