...
/* DPDM_CTRL_MASK reg=0x35 */
#define BK1865_DPDM_CTRL_MASK_REG                 0x35
#define BK1865_DP_DRIVE_MASK                      (BIT(7) | BIT(6) | BIT(5))
#define BK1865_DP_DRIVE_SHIFT                     5
#define BK1865_DP_20K_PD_EN                       1
#define BK1865_DP_0P6V_EN                         2

/* DP_STAT_MASK reg=0x39 */
#define BK1865_DP_STAT_MASK_REG                   0x39

/* DM_STAT_MASK reg=0x3a */
#define BK1865_DM_STAT_MASK_REG                   0x3A
#define BK1865_DPDM_HIGH_THAN_3P0V                BIT(4)
#define BK1865_DPDM_HIGH_THAN_2P2V                BIT(3)
#define BK1865_DPDM_HIGH_THAN_1P35V               BIT(2)
#define BK1865_DPDM_HIGH_THAN_1P0V                BIT(1)
#define BK1865_DPDM_HIGH_THAN_0P325V              BIT(0)
#define BK1865_DPDM_HIGH_THAN_0P0V                0

/* DPDM_POLLING_MASK reg=0x3b */
#define BK1865_DPDM_POLLING_MASK_REG              0x3B
#define BK1865_DPDM_POLLING_EN_MASK               BIT(5)
#define BK1865_DPDM_POLLING_EN_SHIFT              5

/* DPDM_CTRL2_MASK reg=0x3c */
#define BK1865_DPDM_CTRL2_MASK_REG                0x3C
#define BK1865_DPDM_EN_MASK                       BIT(0)
#define BK1865_DPDM_EN_SHIFT                      0
