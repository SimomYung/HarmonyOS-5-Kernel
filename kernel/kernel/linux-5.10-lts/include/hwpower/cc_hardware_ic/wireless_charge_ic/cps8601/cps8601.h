...
#define CPS8601_CLEAR_FOD_GAP                 0
#define CPS8601_FOD_GAP_SUCC                  1
#define CPS8601_FOD_GAP_FAIL                  0
#define CPS8601_Q_THRESHOLD_NUM               4
#define CPS8601_Q_THRESHOLD_LEN               8
#define CPS8601_Q_THRESHOLD_CRC_LEN           2
...
enum cps8601_q_hiview_index {
	CPS8601_Q_HIVIEW_BEGIN = 0,
	CPS8601_Q_HIVIEW_FAC_WIDTH = CPS8601_Q_HIVIEW_BEGIN,
	CPS8601_Q_HIVIEW_DYN_WIDTH,
	CPS8601_Q_HIVIEW_SPL_WIDTH,
	CPS8601_Q_HIVIEW_FLAG,
	CPS8601_Q_HIVIEW_MAX,
};
...
struct cps8601_tx_q_threshold_para {
	u16 tx_q_crc;
	s8 tx_q_cnt_low;
	s8 tx_q_cnt_high;
	u16 tx_q_width_low;
...
union cps8601_tx_q_threshold_data {
	struct cps8601_tx_q_threshold_para tx_q_threshold;
	u8 tx_q_config[CPS8601_Q_THRESHOLD_LEN];
};
...
struct cps8601_dev_info {
	...
	union cps8601_tx_q_threshold_data tx_q_th;
	struct cps8601_firm_info firm_info;
	struct notifier_block event_nb;
	unsigned int ic_type;
	unsigned int default_psy_type;
	unsigned int q_cali_dynamic_en;
	unsigned int q_sample_width_lth;
	unsigned int q_sample_width_hth;
	bool irq_active;
	int gpio_rx_online;
	int gpio_lowpower;
	int gpio_int;
	...
	u8 tx_limit_power_en;
	bool tx_q_threshold_en;
};
