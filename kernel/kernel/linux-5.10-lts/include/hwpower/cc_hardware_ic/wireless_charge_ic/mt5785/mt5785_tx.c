...
static int mt5785_tx_get_curfod_iin(u16 *tx_iin, void *dev_data)
{
	return mt5785_read_word(dev_data, MT5785_TX_CURFOD_IIN_ADDR, tx_iin);
}
...
static struct wltx_ic_ops g_mt5785_tx_ic_ops = {
	...
	.get_curfod_iin         = mt5785_tx_get_curfod_iin,
