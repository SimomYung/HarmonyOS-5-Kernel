...
#define BLKIO_QOS_HIGH	VALUE_QOS_L9
#endif
#ifndef BLKIO_QOS_DEFAULT
#define BLKIO_QOS_DEFAULT	VALUE_QOS_L3
#endif
...
#if defined(CONFIG_MAS_BLK) || defined(CONFIG_MAS_BLK_HM)
...
#if defined(CONFIG_MAS_BKOPS) && defined(CONFIG_MAS_BLK_HM)
int mas_bkops_hm_nofity(void *info, size_t info_size);
#else
static inline int mas_bkops_hm_nofity(void *info, size_t info_size)
{
	return -ENOSYS; 
}
#endif
