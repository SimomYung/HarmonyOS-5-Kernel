...
#include "dma-buf-udk-pal.h"

#define DMA_DEBUG
#ifdef DMA_DEBUG
#define dma_buf_pr_info pr_info
#else
#define dma_buf_pr_info(fmt, ...)
#endif

struct device;
struct dma_buf;
struct dma_buf_attachment;
#define DMA_BUF_UDK_EN 1
/**
...
struct dma_buf_ops {
	...
	long (*set_fd_flags)(struct dma_buf *, int);
};
...
struct dma_buf {
	...
	bool from_udk;  // alloc dma-buf from udk: true; ldk: false
	int fd;
	unsigned int ldk_ptr_refcount;
	void *dev;		// alloced dev when get device from udk
	...
	char attach_process_comm[TASK_COMM_LEN]; /* Name of attach task */
#endif
};
...
#else
static inline u64 dma_buf_get_total_size(void) { return 0; }
static inline u64 dma_get_total_cache(void) { return 0; }
#endif
...
#else
static inline bool dma_buf_is_osh(struct dma_buf *dmabuf) { return false; }
#endif
