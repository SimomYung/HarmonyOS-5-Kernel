...
struct dma_map_ops {
	...
	/*
	 * map_page_batch returns 0 on error and a value > 0 on success.
	 * It should never return a value < 0.
	 */
	int (*map_page_batch)(struct device *dev, struct scatterlist *sgl,
		int count, enum dma_data_direction dir, unsigned long attrs);
	void (*unmap_page_batch)(struct device *dev, struct scatterlist *sgl,
		int count, enum dma_data_direction dir, unsigned long attrs);
#endif
	/*
