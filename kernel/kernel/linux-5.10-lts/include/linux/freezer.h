...
#ifdef CONFIG_LIBLINUX
extern bool try_to_freeze_unsafe(void);
...
{
	liblinux_pal_thread_freezer_count(false, !(current->flags & PF_KTHREAD));
}

static inline void freezer_count(void)
{
	liblinux_pal_thread_freezer_count(true, !(current->flags & PF_KTHREAD));
}
#else
/**
