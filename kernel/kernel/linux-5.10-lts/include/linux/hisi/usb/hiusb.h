...
/* SR: hiusb s3 power down operation */
...
static inline int hiusb_device_event_notifier_register(struct notifier_block *nb)
{
	return 0;
}
...
static inline bool hiusb_check_is_u2_only_by_portid(u32 portid)
{
	return false;
}

/* SR: hiusb s3 power down operation */
static inline void hiusb_set_s3_power_down_flag(bool s3_power_down)
{
	return;
}
static inline bool hiusb_get_s3_power_down_flag(void)
{
	return false;
}
static inline bool hiusb_check_default_port_state_is_off(void)
{
	return false;
}
static enum usb_state hiusb_get_state_of_default_port(void)
{
