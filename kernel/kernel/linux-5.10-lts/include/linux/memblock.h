...
#define MAX_SEC_MEMBLK_SP	1
struct sec_memory_block {
	const char *name;
	phys_addr_t base;
	phys_addr_t size;
};

extern struct sec_memory_block sec_memblk_sp[MAX_SEC_MEMBLK_SP];
#endif
...
{
	return memblock_virt_alloc_try_nid_nopanic(size, 0, MEMBLOCK_LOW_LIMIT,
						MEMBLOCK_ALLOC_ACCESSIBLE,
						nid);
}
