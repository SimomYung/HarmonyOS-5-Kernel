...
#elif defined(CONFIG_PRODUCT_CDC)
#ifdef CONFIG_PARTITION_TARGET_OHOS
#include <cdc_plat_partition_ohos.h>
#else
#include <cdc_plat_partition.h>
#endif
#elif defined(CONFIG_PRODUCT_CDC_ACE)
#if defined(CONFIG_PLAT_PARTITION_CSV2)
#include <cdc_ace_csv2_plat_partition.h>
#else
#ifdef CONFIG_PARTITION_TARGET_OHOS
#include <cdc_ace_plat_partition_ohos.h>
#else
...
#ifdef CONFIG_PARTITION_TARGET_OHOS
#include <plat_csv2_partition_ohos.h>
#else
#include <plat_csv2_partition.h>
#endif
#elif defined(CONFIG_PARTITION_TARGET_OHOS)
#if defined(CONFIG_PRODUCT_IOT_PARTITION) /* for iot */
#include <tv_plat_partition_ohos.h>
#else
