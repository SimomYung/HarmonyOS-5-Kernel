...
static const struct partition partition_table_ufs[] = {
    ...
    {PART_UPDATER_VENDOR,      800 * 1024,    35 * 1024, UFS_PART_3}, /* updater_vendor      35MB p58 */
    {PART_BOOT,                835 * 1024,    46 * 1024, UFS_PART_3}, /* boot                46MB p59 */
    {PART_UPDATER_BOOT,        881 * 1024,    66 * 1024, UFS_PART_3}, /* updater_boot        66MB p60 */
    {PART_UPDATER_BOOT_BAK,    947 * 1024,    66 * 1024, UFS_PART_3}, /* updater_boot_bak    66MB p61 */
    {PART_RESERVED,           1013 * 1024,     9 * 1024, UFS_PART_3}, /* reserved             9MB p62 */
    {PART_THEE,               1022 * 1024,     4 * 1024, UFS_PART_3}, /* thee                 4MB p63 */
    {PART_TZSP,               1026 * 1024,    12 * 1024, UFS_PART_3}, /* tzsp                12MB p64 */
    {PART_UPDATER_RAMDISK_BAK, 1038 * 1024,   64 * 1024, UFS_PART_3}, /* updater_ramdisk_bak 64MB p65 */
    {PART_UPDATER_VENDOR_BAK, 1102 * 1024,    35 * 1024, UFS_PART_3}, /* updater_vendor_bak  35MB p66 */
    {PART_ENG_SYSTEM,         1137 * 1024,    12 * 1024, UFS_PART_3}, /* eng_system          12MB p67 */
    {PART_ENG_CHIPSET,        1149 * 1024,    20 * 1024, UFS_PART_3}, /* eng_chipset         20MB p68 */
    {PART_FW_DTB,             1169 * 1024,    20 * 1024, UFS_PART_3}, /* fw_dtb               8MB p69 */
    {PART_DTBO,               1189 * 1024,    20 * 1024, UFS_PART_3}, /* dtbo                20MB p70 */
    {PART_TRUSTFIRMWARE,      1209 * 1024,     2 * 1024, UFS_PART_3}, /* trustfirmware        2MB p71 */
    {PART_MODEM_FW,           1211 * 1024,   124 * 1024, UFS_PART_3}, /* modem_fw           124MB p72 */
    {PART_MODEM_VENDOR,       1335 * 1024,    30 * 1024, UFS_PART_3}, /* modem_vendor        30MB p73 */
    {PART_MODEM_PATCH_NV,     1365 * 1024,     4 * 1024, UFS_PART_3}, /* modem_patch_nv       4MB p74 */
    {PART_MODEM_DRIVER,       1369 * 1024,    20 * 1024, UFS_PART_3}, /* modem_driver        20MB p75 */
    {PART_MODEMNVM_UPDATE,    1389 * 1024,    16 * 1024, UFS_PART_3}, /* modemnvm_update     16MB p76 */
    {PART_MODEMNVM_CUST,      1405 * 1024,    16 * 1024, UFS_PART_3}, /* modemnvm_cust       16MB p77 */
    {PART_RAMDISK,            1421 * 1024,     3 * 1024, UFS_PART_3}, /* ramdisk              3MB p78 */
    {PART_RVT_SYSTEM,         1424 * 1024,     1 * 1024, UFS_PART_3}, /* rvt_system           1MB p79 */
    {PART_RVT_VENDOR,         1425 * 1024,     1 * 1024, UFS_PART_3}, /* rvt_vendor           1MB p80 */
    {PART_RVT_CHIP_PROD,      1426 * 1024,     1 * 1024, UFS_PART_3}, /* rvt_chip_prod        1MB p81 */
    {PART_RVT_CUST,           1427 * 1024,     1 * 1024, UFS_PART_3}, /* rvt_cust             1MB p82 */
    {PART_RVT_SYS_PROD,       1428 * 1024,     1 * 1024, UFS_PART_3}, /* rvt_sys_prod         1MB p83 */
    {PART_UPDATER_RVT,        1429 * 1024,     2 * 1024, UFS_PART_3}, /* updater_rvt          2MB p84 */
    {PART_UPDATER_BAK_RVT,    1431 * 1024,     2 * 1024, UFS_PART_3}, /* updater_bak_rvt      2MB p85 */
    {PART_RVT,                1433 * 1024,     4 * 1024, UFS_PART_3}, /* rvt                  4MB p86 */
    {PART_KPATCH,             1437 * 1024,     4 * 1024, UFS_PART_3}, /* kpatch               4MB p87 */
    {PART_PATCH,              1441 * 1024,    32 * 1024, UFS_PART_3}, /* patch               32MB p88 */
    {PART_CUST,               1473 * 1024,    88 * 1024, UFS_PART_3}, /* cust                88MB p89 */
    {PART_CHIP_PROD,          1561 * 1024,  3018 * 1024, UFS_PART_3}, /* chip_prod         3018MB p90 */
    {PART_VENDOR,             4579 * 1024,  3284 * 1024, UFS_PART_3}, /* vendor            3284MB p91 */
    {PART_SYS_PROD,           7863 * 1024,  8812 * 1024, UFS_PART_3}, /* sys_prod          8812MB p92 */
    {PART_SYSTEM,            16675 * 1024,  7968 * 1024, UFS_PART_3}, /* system            7968MB p93 */
    {PART_HYPERHOLD,         24643 * 1024,     4 * 1024, UFS_PART_3}, /* hyperhold            4MB p94 */
    {PART_RESERVED5,         24647 * 1024,   747 * 1024, UFS_PART_3}, /* reserved5          747MB p95 */
    {PART_VERSION,           25394 * 1024,   576 * 1024, UFS_PART_3}, /* version            576MB p96 */
    {PART_PRELOAD,           25970 * 1024,  1400 * 1024, UFS_PART_3}, /* preload           1400MB p97 */
    {PART_RESERVED9,         27370 * 1024,   824 * 1024, UFS_PART_3}, /* reserved9          824MB p98 */
    {PART_USERDATA,  28194 * 1024, (12UL) * 1024 * 1024, UFS_PART_3}, /* userdata            12GB p99 */
#else
...
#else
    {PART_BOOT,                796 * 1024,    46 * 1024, UFS_PART_3}, /* boot                46MB p59 */
    {PART_UPDATER_BOOT,        842 * 1024,    66 * 1024, UFS_PART_3}, /* updater_boot        66MB p60 */
    {PART_UPDATER_BOOT_BAK,    908 * 1024,    66 * 1024, UFS_PART_3}, /* updater_boot_bak    66MB p61 */
    {PART_RESERVED,            974 * 1024,    31 * 1024, UFS_PART_3}, /* reserved            55MB p62 */
#endif
    ...
    {PART_RESERVED5,  1493 * 1024,   (134 * 1024 + 512), UFS_PART_3}, /* reserved5        134.5MB p89 */
    {PART_MODULE_UPDATE,  (1627 * 1024 + 512),      512, UFS_PART_3}, /* module_update      512KB p90 */
    {PART_EXT_RVT,            1628 * 1024,     2 * 1024, UFS_PART_3}, /* ext_rvt              2MB p91 */
    {PART_HIBENCH_IMG,        1630 * 1024,   128 * 1024, UFS_PART_3}, /* hibench_img        128MB p92 */
    {PART_HIBENCH_LOG,        1758 * 1024,    32 * 1024, UFS_PART_3}, /* hibench_log         32MB p93 */
    {PART_HIBENCH_DATA,       1790 * 1024,  1000 * 1024, UFS_PART_3}, /* hibench_data      1000MB p94 */
    {PART_FLASH_AGEING,       2790 * 1024,   512 * 1024, UFS_PART_3}, /* flash_ageing       512MB p95 */
    {PART_HIBENCH_LPM3,       3302 * 1024,     2 * 1024, UFS_PART_3}, /* hibench_lpm3         2MB p96 */
    {PART_XLOADER_HITEST,     3304 * 1024,     2 * 1024, UFS_PART_3}, /* xloader_hitest       2MB p97 */
    {PART_CUST,               3306 * 1024,   128 * 1024, UFS_PART_3}, /* cust               128MB p98 */
    {PART_CHIP_PROD,          3434 * 1024,  3018 * 1024, UFS_PART_3}, /* chip_prod         3018MB p99 */
    {PART_VENDOR,             6452 * 1024,  1132 * 1024, UFS_PART_3}, /* vendor            1132MB p100 */
    {PART_SYS_PROD,           7584 * 1024,  8812 * 1024, UFS_PART_3}, /* sys_prod          8812MB p101 */
    {PART_SYSTEM,            16396 * 1024,  4948 * 1024, UFS_PART_3}, /* system            4948MB p102 */
    {PART_HYPERHOLD,         21344 * 1024,     4 * 1024, UFS_PART_3}, /* hyperhold            4MB p103 */
    {PART_VERSION,           21348 * 1024,   576 * 1024, UFS_PART_3}, /* version            576MB p104 */
    {PART_PRELOAD,           21924 * 1024,  1400 * 1024, UFS_PART_3}, /* preload           1400MB p105 */
    {PART_RESERVED6,         23324 * 1024, 27530 * 1024, UFS_PART_3}, /* reserved6         27530MB p106 */
    {PART_USERDATA,  50854 * 1024, (16UL) * 1024 * 1024, UFS_PART_3}, /* userdata              6GB p107 */
#else
    ...
    {PART_AI_MODEL,          19531 * 1024,     2 * 1024, UFS_PART_3}, /* ai_model             2MB p94 */
    {PART_HYPERHOLD,         19533 * 1024,     2 * 1024, UFS_PART_3}, /* hyperhold            2MB p95 */
    {PART_RESERVED5, 19535 * 1024,   (134 * 1024 + 512), UFS_PART_3}, /* reserved5        134.5MB p96 */
    {PART_MODULE_UPDATE, (19669 * 1024 + 512),      512, UFS_PART_3}, /* module_update      512KB p97 */
    {PART_EXT_RVT,           19670 * 1024,     2 * 1024, UFS_PART_3}, /* ext_rvt              2MB p98 */
    {PART_VERSION,           19672 * 1024,   576 * 1024, UFS_PART_3}, /* version            576MB p99 */
    {PART_PRELOAD,           20248 * 1024,  1400 * 1024, UFS_PART_3}, /* preload           1400MB p100 */
    {PART_RESERVED9,         21648 * 1024,  1816 * 1024, UFS_PART_3}, /* reserved9         1816MB p101 */
    {PART_USERDATA,  23464 * 1024, (16UL) * 1024 * 1024, UFS_PART_3}, /* userdata            16GB p102 */
#endif
#endif
#endif
    {"0", 0, 0, 0},
