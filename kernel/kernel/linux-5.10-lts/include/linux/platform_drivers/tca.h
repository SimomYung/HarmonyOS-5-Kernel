...
static inline bool hiusb_port_is_suspend_state(void) { return false; }
#endif
...
int usb_mode_register_notifier(struct notifier_block *nb);
int usb_mode_unregister_notifier(struct notifier_block *nb);
int usb_mode_call_notifiers(int val, void *v);
#else
static inline int usb_mode_register_notifier(struct notifier_block *nb) { return 0; }
static inline int usb_mode_unregister_notifier(struct notifier_block *nb) { return 0; }
static inline int usb_mode_call_notifiers(int val, void *v) { return 0; }
#endif /* CONFIG_USB_CONFIG_PRODUCT_PC */
