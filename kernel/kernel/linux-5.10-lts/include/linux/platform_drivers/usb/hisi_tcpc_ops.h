...
#if defined(CONFIG_HISI_TCPC) || defined(CONFIG_KIRIN_TCPC)
...
#else
static inline void hisi_tcpc_reg_ops_register(struct hisi_tcpc_reg_ops *reg_ops){}
static inline void hisi_tcpc_irq_gpio_register(int irq_gpio){}
