...
#if defined(CONFIG_TCPC_VSAFE0V_DETECT_SUPPORT) || defined(CONFIG_KIRIN_TCPC_VSAFE0V_DETECT_SUPPORT)
	TCPC_VBUS_SAFE0V = 0,
	TCPC_VBUS_INVALID,
	TCPC_VBUS_VALID,
#else
...
#if defined(CONFIG_TYPEC_CAP_DBGACC_SNK_SUPPORT) || defined(CONFIG_KIRIN_TYPEC_CAP_DBGACC_SNK_SUPPORT)
	case TYPEC_ATTACHED_DBGACC_SNK: return "DBGACC_SNK";
#endif
#if defined(CONFIG_TYPEC_CAP_CUSTOM_SRC_SUPPORT) || defined(CONFIG_KIRIN_TYPEC_CAP_CUSTOM_SRC_SUPPORT)
