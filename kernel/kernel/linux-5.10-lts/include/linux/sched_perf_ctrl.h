...
int perf_ctrl_get_key_ffrt_task(void __user *uarg);

#ifdef CONFIG_PID_SCHED_CTRL
int perf_ctrl_get_task_cluster_util(void __user *uarg);
int perf_ctrl_get_top_pid_util(void __user *uarg);
int perf_ctrl_set_top_pid_preferred_cluster(void __user *uarg);
int perf_ctrl_set_cluster_min_freq(void __user *uarg);
#else
static inline int perf_ctrl_get_task_cluster_util(void __user *uarg __maybe_unused)
{
	return -EFAULT;
}
static inline int perf_ctrl_get_top_pid_util(void __user *uarg __maybe_unused)
{
	return -EFAULT;
}
static inline int perf_ctrl_set_top_pid_preferred_cluster(void __user *uarg __maybe_unused)
{
	return -EFAULT;
}
static inline int perf_ctrl_set_cluster_min_freq(void __user *uarg __maybe_unused)
{
	return -EFAULT;
}
#endif
