...
struct thermal_zone_device {
	...
	bool soc_shell_thermal_enable;
	bool soc_shell_thermal_static_power;
	int curr_polling_delay;
	int polling_count_down;
	int soc_shell_thermal_attr_index;
	struct attribute_group *soc_shell_thermal_attr_group;
#endif /* CONFIG_THERMAL_SOC_SHELL */
#ifdef CONFIG_OPT_IPA_THERMAL
	bool optimal_ipa_enable;
