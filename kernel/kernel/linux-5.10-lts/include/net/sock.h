...
#if (defined(CONFIG_HW_HIGH_PRIORITY_LABEL) || defined(CONFIG_HW_DPIMARK_MODULE))
...
#define sk_rmem_alloc sk_backlog.rmem_alloc
	...
	struct sk_event_list __rcu *events;
#endif
};
...
#ifdef PAC_FWCFI_SYSSERVICE
		PAC_FECFI_XPAC_SIGN(negative_advice, android_dst_ops_negative_advice_new_t);
#endif
