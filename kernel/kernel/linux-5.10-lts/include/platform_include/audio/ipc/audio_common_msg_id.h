...
enum AUDIO_COMMON_MSG_ENUM {
    /* dsp and tsp message id */
    ID_VOICE_AUDIO_CALL_START_IND = 0xC2A0,
    ID_VOICE_AUDIO_CALL_STOP_IND = 0xC2A1,
    ID_VOICE_AUDIO_CALL_PARAM_CONFIG_IND = 0xC2A2,
    ID_VOICE_AUDIO_PCM_DATA = 0xC2A3,
    ID_VOICE_AUDIO_DIAG_CONN_STATE_IND = 0xC2A4,
    ID_VOICE_AUDIO_HOOK_CONFIG_IND = 0xC2A5,
    ID_AUDIO_VOICE_PCM_DATA = 0xC2B0,
    ...
    ID_AP_NOTIFY_HIFI_MULTI_CHANNEL_STREAM_TYPE = 0xDD32,
    ID_AUDIO_UPDATE_DSP_LOOP_IN_BUFF    = 0xDD33,
    ID_AUDIO_UPDATE_DSP_LOOP_OUT_BUFF   = 0xDD34,

    ID_AP_AUDIO_SET_EC_CHANNEL_CMD      = 0xDD35,
    ...
    ID_AP_AUDIO_AVLPP_START_READY_CMD   = 0xDD87,
    ID_AUDIO_UPDATE_AVLPP_BUFF_CMD      = 0xDD88,
    ...
    ID_AUDIO_MIXER_READ_REQ             = 0xDDAE,

    ID_DSP_HOOK_RECV_DATA_CMD             = 0xDDAF,
    ID_DSP_HOOK_A2DP_DATA_CMD             = 0xDDB0,
    ...
    ID_AUDIO_UPDATE_VOICE_PLAY_BUFF_CMD    = 0xDDBA,
    ID_AUDIO_UPDATE_VOICE_CAPTURE_BUFF_CMD = 0xDDBB,
    ID_AUDIO_VOICE_STREAM_START_CMD = 0xDDBC,

    ID_AUDIO_BT_OFFLOAD_WEAR_SEND_TO_MCU_CMD = 0xDDBD,
    ID_AUDIO_SILENCE_STREAM_DELAY_STOP_CMD = 0xDDBE,
    ID_AUDIO_SILENCE_STREAM_WRITE_CMD = 0xDDBF,
    ...
    ID_AUDIO_NOTIFY_HIFI_SENSORHUB_RECOVERY_START = 0xDDE0,
    /* VOICE ENUM START */
    /* A核通知HIFI C 核复位消息ID */
    ...
    /* Obtaining HiFi Combine Noise Parameters */
    ID_AP_HIFI_REQUEST_COMBINE_NOISE_REQ   = 0xDEFD, /* ap request voice msg */
    ID_HIFI_AP_SEND_COMBINE_NOISE_PARA     = 0xDEFE, /* dsp replay voice msg */
    ID_HIFI_REQUEST_COMBINE_NOISE_VOICE_PARA_CMD = 0xDEFF,
    /* Obtaining HiFi Call Status Parameters */
    ...
    ID_DSP_AP_SPATIAL_AUDIO_ALG_INIT  = 0xDF6E,
    ...
    ID_AP_DSP_SET_IO_SAMPLE_RATE_CMD       = 0xDF79,
    ...
    ID_HIFI_ULTRASONIC_MISTOUCH_IN_PROCESS   = 0xFD44,
    ...
    /* AUDIO NN */
    ID_AP_DSP_AUDIO_NN_INIT_REQ    = 0xFD53,       /* acpu->dsp */
    ID_DSP_AP_AUDIO_NN_INIT_CNF    = 0xFD54,       /* dsp->acpu */
    ID_AP_DSP_AUDIO_NN_DEINIT_REQ  = 0xFD55,       /* acpu->dsp */
    ID_DSP_AP_AUDIO_NN_DEINIT_CNF  = 0xFD56,       /* dsp->acpu */
    ID_AP_DSP_AUDIO_NN_SET_PARAMS_REQ = 0xFD57,    /* acpu->dsp */
    ID_DSP_AP_AUDIO_NN_SET_PARAMS_CNF = 0xFD58,    /* dsp->acpu */
    ID_DSP_AP_NN_ROUTE_VOICE_MODULE_CHANGE   = 0xFD59, /* dsp->acpu */
    ID_AUDIO_NN_HTS_EVENT_ISR = 0xFD5A, /* dsp->dsp */
    ID_AUDIO_NN_IDLE_CHECK_CMD = 0xFD5B, /* dsp->dsp */
    ...
    ID_DSP_POPNOISE_WAKEUP_DECODE = 0xFF18,

    ID_AUDIO_VOIP_CONFIG_RELOAD = 0xFF19,

    /* save total log */
    ID_DSP_AP_SAVE_TOTAL_LOG = 0xFF20, /* dsp->acpu */
    ID_AP_DSP_TOTAL_LOG_SAVING = 0xFF21, /* acpu->dsp */
    ID_DSP_AUDIO_SAVE_TOTAL_LOG = 0xFF22, /* for saving total log */

    /* popnoise wakeup */
    ID_DSP_POPNOISE_WAKEUP_INIT = 0xFF23,
    ID_DSP_POPNOISE_WAKEUP_DEINIT = 0xFF24,

    /* TAG_HIFI GT mode audio */
    ID_AUDIO_UPDATE_LOCAL_NOTIFY_BUFF_CMD = 0xFF25,
    ID_AUDIO_UPDATE_LOCAL_PLAYER_BUFF_CMD = 0xFF26,
    ID_AUDIO_UPDATE_LOCAL_CAPTURE_BUFF_CMD = 0xFF27,

    /* bt combined denoising */
    ID_AP_DSP_BT_COMBINED_DENOISING_CMD = 0xFF28,
    ID_AP_DSP_BT_COMBINED_DENOISING_CNF = 0xFF29,
    ID_DSP_BT_COMBINED_DENOISING_HOOK_DATA_CMD = 0xFF30,
    ID_AP_AUDIO_CMD_SET_VOLUME = 0xFF31,
    ID_DSP_BT_COMBINED_DENOISING_DECODE_DATA_CMD = 0xFF32,
    ID_DSP_BT_COMBINED_DENOISING_SWTICH_NVID_CMD = 0xFF33,

    /* wakeup conformer */
    ID_WAKEUP_CONFORMER_DECODE = 0xFF34,
    ID_WAKEUP_CONFORMER_CAL_FEATS = 0xFF35,
    ID_WAKEUP_CONFORMER_RESULT = 0xFF36,

    /* audio data injection */
    ID_AP_DSP_AUDIO_INJECT_DATA_REQ = 0xFF37,
    ID_DSP_AP_AUDIO_INJECT_DATA_CNF = 0xFF38,
    ID_DSP_AP_NOTIFY_INJECT_DATA_CMD = 0xFF39,

    /* STR mode notify */
    ID_AP_DSP_STR_MODE_NOTIFY_CMD = 0xFF3A, /* acpu->dsp */

    /* blow detection (LPC) */
    ID_AP_DSP_LPC_BLOW_COGNITION_UPDATE_CMD = 0xFF40,
    ID_DSP_AP_LPC_BLOW_COGNITION_RES_CMD = 0xFF41,

    /* audio haptic  */
    ID_AP_DSP_AUDIO_HAPTIC_START_CMD = 0xFF42,
    ID_AP_DSP_AUDIO_HAPTIC_STOP_CMD = 0xFF43,
    ID_AP_DSP_AUDIO_HAPTIC_UPDATE_SHARE_BUF_CMD = 0xFF44,
    ID_AP_DSP_AUDIO_HAPTIC_SET_PARAMS_CMD = 0xFF45,
    ID_AP_DSP_AUDIO_HAPTIC_START_F0_CMD = 0xFF46,
    ID_DSP_AP_AUDIO_HAPTIC_START_CNF_CMD = 0xFF47,
    ID_DSP_AP_AUDIO_HAPTIC_REQ_DATA_CMD = 0xFF48,
    ID_DSP_AP_AUDIO_HAPTIC_PLAY_DONE_CMD = 0xFF49,
    ID_DSP_AP_AUDIO_HAPTIC_START_F0_CNF_CMD = 0xFF4A,
    ID_AUDIO_HAPTIC_UPDATE_BUFF_CMD = 0xFF4B,
    ID_AUDIO_HAPTIC_PLAY_DONE_CMD = 0xFF4C,
    ID_AUDIO_HAPTIC_F0_FINISH_CMD = 0xFF4D,
    ID_AUDIO_HAPTIC_OM_DMA_ISR_CMD = 0xFF4E,

    /* iodie status return */
    ID_DSP_AP_IODIE_STATUS_RSP = 0xFF51,
    ID_AP_DSP_IODIE_EXPECTION_RSP = 0xFF52,
    /* I2S stop trans */
    ID_AP_DSP_IODIE_I2S_STOP_TRANSTER = 0xFF53,
    /* resume trans */
    ID_AP_DSP_IODIE_RESUMING_TRANSMISSION = 0xFF54,
    /* open config I2S div */
    ID_AP_DSP_IODIE_I2S1_OPEN_FRE_DIV = 0xFF55,
     /* close  config I2S div */
    ID_AP_DSP_IODIE_I2S1_CLOSE_FRE_DIV = 0xFF56,
    /* stop service trans */
    ID_AP_DSP_IODIE_STOP_TRANSTER = 0xFF57,
    ID_DSP_AP_IODIE_GET_DSP_INFO_ACK = 0xFF58,
    ID_AP_DSP_IODIE_STOP_TRANSTER_ACK = 0xFF59,

    /* audio haptic sync */
    ID_AP_DSP_AUDIO_HAPTIC_SYNC_SET_PARA_CMD = 0xFF5A,
    ID_AUDIO_HAPTIC_SYNC_STREAM_START_CMD = 0xFF5B,
    ID_AUDIO_HAPTIC_SYNC_BEGIN_SYNC_CMD = 0xFF5C,

    /* runtime lite */
    ID_AP_DSP_RTLITE_CREATE_SESSION_REQ = 0xFF60,  /* acpu->dsp */
    ID_DSP_AP_RTLITE_CREATE_SESSION_CNF = 0xFF61,  /* dsp->acpu */
    ID_AP_DSP_RTLITE_SET_NODE_CONFIG_REQ = 0xFF62,  /* acpu->dsp */
    ID_DSP_AP_RTLITE_SET_NODE_CONFIG_CNF = 0xFF63,  /* dsp->acpu */
    ID_AP_DSP_RTLITE_START_SESSION_REQ = 0xFF64,  /* acpu->dsp */
    ID_DSP_AP_RTLITE_START_SESSION_CNF = 0xFF65,  /* dsp->acpu */
    ID_AP_DSP_RTLITE_STOP_SESSION_REQ = 0xFF66,  /* acpu->dsp */
    ID_DSP_AP_RTLITE_STOP_SESSION_CNF = 0xFF67,  /* dsp->acpu */
    ID_AP_DSP_RTLITE_DESTROY_SESSION_REQ = 0xFF68,  /* acpu->dsp */
    ID_DSP_AP_RTLITE_DESTROY_SESSION_CNF = 0xFF69,  /* dsp->acpu */
    /* audio emotion cognition */
    ID_DSP_AP_EMOTION_COGNITION_RES_CMD = 0xFF71,

    ID_DSP_AP_ENV_SOUND_COGNITION_NOTIFY_CMD = 0xFF70,

    /* sle module msg */
    ID_AP_DSP_SET_SLE_PARAM_CMD = 0xFF80,
    ID_DSP_NEARLINK_HANDLE_MSG_CMD = 0xFF81,
};
