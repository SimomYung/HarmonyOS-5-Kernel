...
#define DIAGINFO_STRING_MAX_LEN			768
...
static inline int get_bbox_diaginfo_write_async_flag(void)
{
	return 0;
};
static inline void reset_diaginfo_ap_state(void)
{
	return;
};
static inline void bbox_save_diaginfo_log(u32 excep_type, u32 excep_subtype, const char *date)
{
	return;
};
#endif
