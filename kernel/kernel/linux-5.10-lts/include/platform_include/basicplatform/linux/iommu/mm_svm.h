...
static inline void arm_smmu_media1_tcu_dump(void) {}
static inline void arm_smmu_media1_tcu_conn_status_dump(void) {}
static inline bool is_npu_svm_eventb_received(void) { return true; }
#else
...
struct mm_svm *mm_svm_bind_task(struct device *dev, u32 pid, u16 ssid);
