...
#define CAP_PARA_LOW_TEMP_LEVEL    2
...
#define OFF_FIND_FLAG_ON           1
#define OFF_FIND_FLAG_OFF          0
#define BASP_MAP_ON                1
...
#else
static inline int bci_show_capacity(void)
{
	return -EPERM;
}
#endif /* CONFIG_BCI_BATTERY */
#endif
