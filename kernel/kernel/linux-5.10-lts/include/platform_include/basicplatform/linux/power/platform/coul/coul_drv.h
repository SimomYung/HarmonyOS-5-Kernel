...
struct coulometer_ops {
	...
	int (*set_off_find)(int flag);
	int (*get_off_find)(void);
};
...
int coul_drv_battery_set_off_find(int);
...
static inline int coul_drv_battery_set_off_find(int)
{
	return 0;
}

static inline int coul_drv_battery_get_off_find(void)
{
	return 0;
}

static inline int batt_mode_register_notifier(struct notifier_block *nb)
{
	return 0;
}

static inline int batt_mode_unregister_notifier(struct notifier_block *nb)
{
	return 0;
}

static inline int send_batt_mode_change_event(unsigned long events)
{
	return 0;
}

static inline int coul_drv_battery_discharge_cc(void)
{
	return 0;
}
