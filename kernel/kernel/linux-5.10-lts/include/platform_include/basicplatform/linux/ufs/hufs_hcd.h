...
#if defined(CONFIG_SCSI_UFS_AQUILA) || defined(CONFIG_SCSI_UFS_ARA) || defined(CONFIG_SCSI_UFS_ORION) || \
	defined(CONFIG_SCSI_UFS_PICTOR) || defined(CONFIG_SCSI_UFS_AURIGA)
...
#define UFS_CCBUS_LIMIT_IDLE 0x100000
#define UFS_CCBUS_LIMIT_BUSY 0x200000
...
#define VS_AH8_ENTER_INTR UFS_BIT(1)
...
#define UFS_VS_ENABLE_INTRS                                                    \
	(VS_IS_IO_TIMEOUT | VS_AH8_ENTER_INTR | AH8_ENTER_REQ_CNF_FAIL_INTR |                      \
...
#define HSDT1_INTR_MPHY_GIC_BIT 2
#define HSDT1_INTR_UNIPRO_GIC_BIT 1
#define HSDT1_INTR_UFSHC_GIC_BIT 0
...
extern void ufshcd_fbex_gen_sk(struct work_struct *work);
#endif
#else
...
#define UFS_HWLOCK_ID 48 // RESOURCE6_LOCK,ID0
#define UFS_HWLOCK_TIMEOUT 10 // 10ms
#define UFS_LDK_CMD_EXIST_BIT (1 << 6)
#define UFS_UDK_CMD_EXIST_BIT (1 << 7)
#define UFS_LOW_POWER_VOTE_BIT (1 << 8)
#define UFS_CMD_EXIST_BIT (UFS_LDK_CMD_EXIST_BIT | UFS_UDK_CMD_EXIST_BIT)
#define UFS_LDK_CMD_EXIST_MASK (UFS_LDK_CMD_EXIST_BIT << 16)
#define UFS_UDK_CMD_EXIST_MASK (UFS_UDK_CMD_EXIST_BIT << 16)
#define UFS_CMD_EXIST_MASK (UFS_LDK_CMD_EXIST_MASK | UFS_UDK_CMD_EXIST_MASK)
#define UFS_LOW_POWER_VOTE_MASK (UFS_LOW_POWER_VOTE_BIT << 16)
