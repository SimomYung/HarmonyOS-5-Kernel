...
#define ACTRL_HSDT0_MEM_CTRL0_OFFSET 0x478
#define ACTRL_HSDT1_MEM_CTRL0 0x474

/* AO CRG register */
#define AO_CRG_SCCLKDIV5                 0x264
#define AO_CRG_SCPEREN6                  0x1D0
#define AO_CRG_SCPERDIS6                 0x1D4
#define AO_CRG_SCPERSTAT6                0x1DC
...
#define SCTRL_SCEFUSEDATA3_OFFSET 0x010
#define SCTRL_SCEFUSEDATA8_OFFSET 0x060
#define SCTRL_SCEFUSEDATA9_OFFSET 0x064
...
#define BIT_SCTRL_SCBAKDATA1_MSPC_READY UFS_BIT(0)
#else
#define BIT_SCTRL_SCBAKDATA1_MSPC_READY UFS_BIT(13)
#endif
#if defined(CONFIG_SCSI_UFS_LOW_POWER_VOTE) || defined(CONFIG_UFS_LOW_POWER_VOTE_STATUS_SYNC)
#define SOC_PMCTRL_VDDC_MEM_VOTE_VOL_RANK_SFT_1_ADDR(base)    ((base) + 0x3C4UL)
#define SOC_PMCTRL_VDDC_MEM_VOTE_VOL_VALID_ADDR(base)         ((base) + 0x3D0UL)
#define SOC_PMCTRL_VDDC_MEM_VOTE_SFT_CHG_ADDR(base)           ((base) + 0x3D4UL)
#define SOC_PMCTRL_VDDC_MEM_VOL_STABLE_ADDR(base)             ((base) + 0x3E0UL)
#define SOC_PMCTRL_FREQ_VOTE_G0_ADDR(base)            		  ((base) + (0x240))
#define SOC_PMCTRL_VDDC_MEM_VOL_SFT_CLR_ADDR(base)            ((base) + 0x3DCUL)
enum peri_mem_vol_level {
	PERI_MEM_VOL_LEVEL0 = 0,   /* 0.75V (或者0.72) */
	PERI_MEM_VOL_LEVEL1,       /* ISP R8 AVS电压档位 */
	PERI_MEM_VOL_LEVEL2,       /* 0.8V */
	PERI_MEM_VOL_END
};
#define PERI_MEM_DFA	 		6
#endif
...
#if defined(CONFIG_SCSI_UFS_ORION) || defined(CONFIG_SCSI_UFS_PICTOR) || defined(CONFIG_SCSI_UFS_AURIGA)
#define GT_PCLK_AUTODIV_UFS_DFA_SYS (UFS_BIT(24) | UFS_BIT(25))
#else
...
#define UFS_DFA_SYS_DIV_AUTO_CFG_UFS (0x1f << 21)
#define UFS_DFA_SYS_DIV_AUTO_CFG_DFA (0x3f << 21)
/*
...
#define DFA_SYS_CLK_DIV_0 0x0A8
#define DFA_SYS_CLK_DIV_8 0x0FC00180
#if defined(CONFIG_SCSI_UFS_ORION) || defined(CONFIG_SCSI_UFS_PICTOR) || defined(CONFIG_SCSI_UFS_AURIGA)
#define MPHY_SYS_CLK_DIV 0x001E0002
#else
...
/* hsdt xcltrl define */
#define HSDT0_QIC_NOPENDING_COMBO 0x0
#define HSDT0_QIC_RD_NOPENDING_DFA_0 0x18
#define HSDT0_QIC_WR_NOPENDING_DFA_0 0x1C
#define HSDT0_QIC_RT_NOPENDING_DFA_0 0x20
#define HSDT0_QIC_TB_NOPENDING_DFA_0 0x24
...
#define DIV_UFS_SYS_SUBSYS_HSDT1_1FREQ 0xFC000000
...
#define GT_PCLK_AUTODIV_UFS_SYS_SUBSYS_HSDT1 UFS_BIT(2)
#define UFS1_PERI_AUTODIV1_OFFSET 0x354
#define UFS_SYS_SUBSYS_HSDT1_IDLE_BYPASS 0x1
#define UFS_SYS_SUBSYS_HSDT1_DIV_AUTO_CFG_MASK 0x7E00000
#define UFS_SYS_SUBSYS_HSDT1_DIV_AUTO_CFG_UFS (0x1f << 21)
...
#define USE_HS_GEAR5 UFS_BIT(24)
...
struct hufs_host {
	...
	struct clk *clk_ufs_dfa_sys;
	struct clk *clk_ufs_dfa_cpu;
	struct clk *clk_ufs_sys_subsys_hsdt1;
	struct clk *clk_ufs0phy_ref;
	struct clk *clk_ufs1phy_ref;
...
void ufs_dfa_ccbus_vote(struct ufs_hba *hba, bool idle);
