...
typedef struct _tag_hwlaser_calibration_data_L5 { /* mxs */
    hwlaser_calibration_xtalk mt380x_xtalk_calib_data;
    hwlaser_calibration_offset mt380x_offset_calib_data;
} hwlaser_calibration_data_L5;
...
typedef struct __tag_hwlaser_calibration_data {
    ...
    union laser_calibration_data{
        ...
        hwlaser_calibration_data_L5  dataL5; /* mxs */
    }u;
...
typedef struct _mt380x_measurement_data_t {
	int16_t milimeter;
	uint32_t confidence;
	uint8_t status;
	uint32_t noise;
} mt380x_measurement_data_t;
...
typedef struct _tag_hwlaser_ranging_data
{
    ...
    mt380x_measurement_data_t m_data;
