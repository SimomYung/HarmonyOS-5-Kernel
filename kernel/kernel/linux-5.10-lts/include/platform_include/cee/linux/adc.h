...
extern int iodie_adc_get_volt(int adc_channel);
extern int get_iodie_hkadc_boardid(int hk_num, int hk_ios[], int *boarid);
#else
static inline int iodie_adc_get_volt(int adc_channel)
{
	return -1;
}

static inline int get_iodie_hkadc_boardid(int hk_num, int hk_ios[], int *boarid)
{
	return -1;
}
#endif /* CONFIG_IODIE_HKADC */
