...
#define PC_NOKASLR_STR_MAX_LEN		256
struct nvic_type {
...
#else
static inline int get_peri_data(void *data)
{
	(void)data;
	return 0;
};
static inline int parse_peri_info_from_rdr(const void *bbox_base, size_t size, char *out_buf, size_t buf_size)
{
	(void)(bbox_base);
	(void)(size);
	(void)(out_buf);
