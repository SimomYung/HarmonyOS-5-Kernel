...
#define LB_FID_SET_PGID                 make_fid(FID_LB_GROUP, 0x05)
#define LB_FID_SET_CGID                 make_fid(FID_LB_GROUP, 0x06)
#define LB_FID_POWERUP                  make_fid(FID_LB_GROUP, 0x07)
#define LB_FID_POWERDOWN                make_fid(FID_LB_GROUP, 0x08)
#define LB_FID_PARTPOWERUP              make_fid(FID_LB_GROUP, 0x09)
#define LB_FID_PARTPOWERDOWN            make_fid(FID_LB_GROUP, 0x0a)
#define LB_FID_LPPOWERUP                make_fid(FID_LB_GROUP, 0x0b)
#define LB_FID_LPPOWERDOWN              make_fid(FID_LB_GROUP, 0x0c)
#define LB_FID_PGID_REQUEST             make_fid(FID_LB_GROUP, 0x0d)
#define LB_FID_PGID_RELEASE             make_fid(FID_LB_GROUP, 0x0e)
#define LB_FID_READ_TEST                make_fid(FID_LB_GROUP, 0x10)
#define LB_FID_WRITE_TEST               make_fid(FID_LB_GROUP, 0x11)
#define LB_FID_MPAM_WAY_ENABLE          make_fid(FID_LB_GROUP, 0x12)
...
#define FID_BL31_DISPLAY_AAE_CMDLIST_BUILD               make_fid(FID_DISPLAY_GROUP, 0x0e)
