...
#define FID_CRYPTO_ENGINE_GROUP              0x31
...
#define FID_SAFETY_ISLAND_GROUP              0x3d
 ...
 */
#define LB_FID_VALUE                    make_fid(FID_LB_GROUP, 0x00)
#define LB_FID_IS_LITE                  make_fid(FID_LB_GROUP, 0x01)
#define LB_FID_GET_EFUSE                make_fid(FID_LB_GROUP, 0x02)
#define LB_FID_EXCLUSIVE_ENABLE         make_fid(FID_LB_GROUP, 0x03)
#define LB_FID_EXCLUSIVE_BYPASS         make_fid(FID_LB_GROUP, 0x04)
#define LB_FID_PGID_REQUEST             make_fid(FID_LB_GROUP, 0x05)
#define LB_FID_PGID_RELEASE             make_fid(FID_LB_GROUP, 0x06)
#define LB_FID_MPAM_WAY_ENABLE          make_fid(FID_LB_GROUP, 0x07)
#define LB_FID_REMOTE_SC_ENABLE         make_fid(FID_LB_GROUP, 0x08)
#define LB_FID_REMOTE_SC_BYPASS         make_fid(FID_LB_GROUP, 0x09)

#define LB_FID_READ_TEST                make_fid(FID_LB_GROUP, 0x30)
#define LB_FID_WRITE_TEST               make_fid(FID_LB_GROUP, 0x31)
#define LB_FID_POWERUP                  make_fid(FID_LB_GROUP, 0x32)
#define LB_FID_POWERDOWN                make_fid(FID_LB_GROUP, 0x33)
#define LB_FID_PARTPOWERUP              make_fid(FID_LB_GROUP, 0x34)
#define LB_FID_PARTPOWERDOWN            make_fid(FID_LB_GROUP, 0x35)
#define LB_FID_LPPOWERUP                make_fid(FID_LB_GROUP, 0x36)
#define LB_FID_LPPOWERDOWN              make_fid(FID_LB_GROUP, 0x37)
#define LB_FID_SET_GLB_WAYS             make_fid(FID_LB_GROUP, 0x38)
#define LB_FID_CACHE_TO_SYNCBUF      	make_fid(FID_LB_GROUP, 0x39)
#define LB_FID_SYNCBUF_TO_CACHE      	make_fid(FID_LB_GROUP, 0x3A)
 ...
 */
#define PMU_RESTRICTION_TEST            make_fid(FID_SECTEST_GROUP, 0x02)
...
#define BL31_HIBERNATE_FREEZE_INIT_V2        make_fid(FID_HIBERNATE_GROUP, 0x10)
#define BL31_HIBERNATE_FREEZE_BACKUP_V2      make_fid(FID_HIBERNATE_GROUP, 0x11)
#define BL31_HIBERNATE_FREEZE_FINISH_V2      make_fid(FID_HIBERNATE_GROUP, 0x12)
#define BL31_HIBERNATE_RESTORE_INIT_V2       make_fid(FID_HIBERNATE_GROUP, 0x13)
#define BL31_HIBERNATE_RESTORE_DATA_V2       make_fid(FID_HIBERNATE_GROUP, 0x14)
#define BL31_HIBERNATE_RESTORE_FINISH_V2     make_fid(FID_HIBERNATE_GROUP, 0x15)
...
/*
 * sils
 * 0xc3003d00 ~ 0xc3003dff
 */
 #define FID_BL31_SAFETY_ISLAND_CHECK_SLT   make_fid(FID_SAFETY_ISLAND_GROUP, 0x03)
 #define FID_BL31_SAFETY_ISLAND_TEST        make_fid(FID_SAFETY_ISLAND_GROUP, 0xFF)
 ...
 */
#define FID_DRAM_AVS_CORE_VOLT_GET            make_fid(FID_DDR_GROUP, 0x00)
#define FID_QIC_TBD_SEC_INT_HANDLER           make_fid(FID_DDR_GROUP, 0x01)
...
#define FID_BL31_TEEOS_RESET_PREPROCESS      make_fid(FID_TEEOS_INDEPENDENT_RESET_GROUP, 0x02)
...
#define FID_BL31_CRYPTO_ENGINE_REE_CLK_CTRL make_fid(FID_CRYPTO_ENGINE_GROUP, 0x03)
