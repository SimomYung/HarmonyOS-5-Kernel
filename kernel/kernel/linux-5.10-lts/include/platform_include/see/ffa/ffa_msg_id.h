...
#define FID_NPU_PM_KERNEL_GROUP              0x4e
#define FID_EFUSE_TC_GROUP                   0x4f
#define FID_MAILBOX_GROUP					 0x47
#define FID_FFRT_GROUP                       0x50
#define FID_BL31_MAXGROUP                    0x60 /* max group */
...
#define ISP_FN_SEND_SPI_TO_ISPCPU            make_fid(FID_ISP_GROUP, 0x25)
#define ISP_FN_SET_ISPCPU_CLK                make_fid(FID_ISP_GROUP, 0x26)
#define ISP_FN_RESET_ISPCPU                  make_fid(FID_ISP_GROUP, 0x27)
...
#define IPP_FID_VBUSPWRUP               make_fid(FID_IPP_GROUP, 0x04)
#define IPP_FID_VBUSPWRDN               make_fid(FID_IPP_GROUP, 0x05)
#define IPP_FID_IPPPWRUP                make_fid(FID_IPP_GROUP, 0x06)
#define IPP_FID_IPPPWRDN                make_fid(FID_IPP_GROUP, 0x07)
#define IPP_FID_TIMEOUTDUMP             make_fid(FID_IPP_GROUP, 0x08)
#define IPP_FID_MAXTYPE                 make_fid(FID_IPP_GROUP, 0x09)
/*
 * ivp
...
#define THERMAL_FID_TSENSOR_LU               make_fid(FID_THERMAL_GROUP, 0x02)
/* calculation */
#define THERMAL_FID_TZSP_DEVICE_INFO         make_fid(FID_THERMAL_GROUP, 0x10)
#define THERMAL_FID_POWER_CPU_COUNTER        make_fid(FID_THERMAL_GROUP, 0x11)
#define THERMAL_FID_POWER_GPU_COUNTER        make_fid(FID_THERMAL_GROUP, 0x12)
#define THERMAL_FID_POWER_NPU_COUNTER        make_fid(FID_THERMAL_GROUP, 0x13)
#define THERMAL_FID_POWER_CPU_LOAD           make_fid(FID_THERMAL_GROUP, 0x14)
#define THERMAL_FID_POWER_GPU_LOAD           make_fid(FID_THERMAL_GROUP, 0x15)
#define THERMAL_FID_TEMP_NTC_TEMP            make_fid(FID_THERMAL_GROUP, 0x16)
#define THERMAL_FID_POWER_ESTIMATE           make_fid(FID_THERMAL_GROUP, 0x17)
#define THERMAL_FID_SOC_TEMP_PREDICTION      make_fid(FID_THERMAL_GROUP, 0x18)
#define THERMAL_FID_SHELL_TEMP_PREDICTION    make_fid(FID_THERMAL_GROUP, 0x19)
#define THERMAL_FID_POWER_BUDGET             make_fid(FID_THERMAL_GROUP, 0x1A)
...
#define L3C_WRITE_PPDMODE                   make_fid(FID_L3CACHE_GROUP, 0x0C)
#define L3C_WRITE_HIT_DNTH0                 make_fid(FID_L3CACHE_GROUP, 0x0D)
#define L3C_WRITE_HIT_DNTH1                 make_fid(FID_L3CACHE_GROUP, 0x0E)
#define L3C_WRITE_MISS_UPTH0                make_fid(FID_L3CACHE_GROUP, 0x0F)
#define L3C_WRITE_MISS_UPTH1                make_fid(FID_L3CACHE_GROUP, 0x10)
#define L3C_READ_HIT_DNTH0                  make_fid(FID_L3CACHE_GROUP, 0x11)
#define L3C_READ_HIT_DNTH1                  make_fid(FID_L3CACHE_GROUP, 0x12)
#define L3C_READ_MISS_UPTH0                 make_fid(FID_L3CACHE_GROUP, 0x13)
#define L3C_READ_MISS_UPTH1                 make_fid(FID_L3CACHE_GROUP, 0x14)
#define L3C_READ_MISSCNT                    make_fid(FID_L3CACHE_GROUP, 0x15)
#define L3C_READ_HITCNT                     make_fid(FID_L3CACHE_GROUP, 0x16)
#define L3C_READ_WAYISO                     make_fid(FID_L3CACHE_GROUP, 0x17)
#define L3C_WRITE_WAYISO                    make_fid(FID_L3CACHE_GROUP, 0x18)
#define L3C_READ_LIT_L2_WAYISO              make_fid(FID_L3CACHE_GROUP, 0x19)
#define L3C_WRITE_LIT_L2_WAYISO             make_fid(FID_L3CACHE_GROUP, 0x1A)
#define L3C_READ_BIG_L2_WAYISO              make_fid(FID_L3CACHE_GROUP, 0x1B)
#define L3C_WRITE_BIG_L2_WAYISO             make_fid(FID_L3CACHE_GROUP, 0x1C)
#define L3C_READ_HC_E_PWRCTRL               make_fid(FID_L3CACHE_GROUP, 0x1D)
#define L3C_WRITE_HC_E_PWRCTRL              make_fid(FID_L3CACHE_GROUP, 0x1E)
#define L3C_READ_HC_E_PWRSTAT               make_fid(FID_L3CACHE_GROUP, 0x1F)
#define L3C_READ_HC_E_RETCTRL               make_fid(FID_L3CACHE_GROUP, 0x20)
#define L3C_WRITE_HC_E_RETCTRL              make_fid(FID_L3CACHE_GROUP, 0x21)
#define L3C_WRITE_HC_E_PPDMODE              make_fid(FID_L3CACHE_GROUP, 0x22)
#define L3C_WRITE_HC_E_HIT_DNTH0            make_fid(FID_L3CACHE_GROUP, 0x23)
#define L3C_WRITE_HC_E_HIT_DNTH1            make_fid(FID_L3CACHE_GROUP, 0x24)
#define L3C_WRITE_HC_E_MISS_UPTH0           make_fid(FID_L3CACHE_GROUP, 0x25)
#define L3C_WRITE_HC_E_MISS_UPTH1           make_fid(FID_L3CACHE_GROUP, 0x26)
#define L3C_READ_HC_E_HIT_DNTH0             make_fid(FID_L3CACHE_GROUP, 0x27)
#define L3C_READ_HC_E_HIT_DNTH1             make_fid(FID_L3CACHE_GROUP, 0x28)
#define L3C_READ_HC_E_MISS_UPTH0            make_fid(FID_L3CACHE_GROUP, 0x29)
#define L3C_READ_HC_E_MISS_UPTH1            make_fid(FID_L3CACHE_GROUP, 0x2A)
#define L3C_READ_HC_E_MISSCNT               make_fid(FID_L3CACHE_GROUP, 0x2B)
#define L3C_READ_HC_E_HITCNT                make_fid(FID_L3CACHE_GROUP, 0x2C)
#define L3C_READ_HC_E_WAYISO                make_fid(FID_L3CACHE_GROUP, 0x2D)
#define L3C_WRITE_HC_E_WAYISO               make_fid(FID_L3CACHE_GROUP, 0x2E)
#define L3C_READ_HC_E_TAG_HASH              make_fid(FID_L3CACHE_GROUP, 0x2F)
#define L3C_WRITE_HC_E_TAG_HASH             make_fid(FID_L3CACHE_GROUP, 0x30)
...
#define NPU_CONNECT_FFRT_MODE_FFAP1              make_fid(FID_NPU_GROUP, 0x23)
#define NPU_DISCONNECT_FFRT_MODE_FFAP1           make_fid(FID_NPU_GROUP, 0x24)
#define NPU_POWER_TIMEOUT_DUMP                   make_fid(FID_NPU_GROUP, 0x25)
#define NPU_EXCEPTION_DISABLE_PDC                make_fid(FID_NPU_GROUP, 0x26)
/*
 * secure io
...
#define SECURE_ENG_READ                      make_fid(FID_SECIO_GROUP, 0x08)
#define SECURE_ENG_WRITE                     make_fid(FID_SECIO_GROUP, 0x09)
#define IOMCU_I2C_RST_FID                    make_fid(FID_SECIO_GROUP, 0x0A)
#define SECURE_IODIE_GPIO_CONFIG             make_fid(FID_SECIO_GROUP, 0x0B)
#define SECURE_IODIE_IOMG_CONFIG             make_fid(FID_SECIO_GROUP, 0x0C)
#define IODIE_HIPHYIO_SPI_FID                make_fid(FID_SECIO_GROUP, 0x0D)
#define IODIE_HIPHYIO_DRV_FID                make_fid(FID_SECIO_GROUP, 0x0E)
#define SECURE_IODIE_GET_CONFIG              make_fid(FID_SECIO_GROUP, 0x0F)
#define SECURE_IODIE_SET_CONFIG              make_fid(FID_SECIO_GROUP, 0x10)
#define IODIE_HIPHYIO_I2C_FID                make_fid(FID_SECIO_GROUP, 0x11)
...
#define EFUSE_TZSP_KERNEL_WR_MDM_SLTFLG             make_fid(FID_EFUSEKERNEL_GROUP, 0x1a)
#define EFUSE_TZSP_KERNEL_RD_HEAVY_RT               make_fid(FID_EFUSEKERNEL_GROUP, 0x1b)
#define EFUSE_TZSP_KERNEL_WR_OEM_INFO               make_fid(FID_EFUSEKERNEL_GROUP, 0x1c)
 ...
 */
#define FID_REAL_TIME_PERI_DATA         make_fid(FID_PERI_DATA_GROUP, 0x00U)
#define FID_RDR_PERI_DATA               make_fid(FID_PERI_DATA_GROUP, 0x01U)
 ...
 */
#define FID_BL31_SET_SR_POSITION             make_fid(FID_LP_GROUP, 0x17)
 ...
 */
#define VDEC_FID_CLEAR_SD                   make_fid(FID_VDEC_GROUP, 0x00)
#define VDEC_FID_ADD_SD                     make_fid(FID_VDEC_GROUP, 0x01)
...
#define FID_PCIE_ADJUST_VOLT				make_fid(FID_PCIE_GROUP, 0x09)
#define FID_PCIE_POWER_CTRL_LDO		    make_fid(FID_PCIE_GROUP, 0xA)
#define FID_PCIE_QOS_ADAPAT		    make_fid(FID_PCIE_GROUP, 0xB)
...
#define FID_ACTRL_AO_MEM_CONFIG           	 make_fid(FID_UFS_GROUP, 0x03)
#define FID_DFA_HSDT_STATUS_CHECK            make_fid(FID_UFS_GROUP, 0x04)
#define FID_DFA_POWER_ON                     make_fid(FID_UFS_GROUP, 0x05)
#define FID_DFA_POWER_OFF                    make_fid(FID_UFS_GROUP, 0x06)
#define FID_ACTRL_HSDT1_MEM_CONFIG           make_fid(FID_UFS_GROUP, 0x07)
...
#define FID_BL31_DISPLAY_AAE_SEC_CONFIG                  make_fid(FID_DISPLAY_GROUP, 0x0e)
#define FID_BL31_DISPLAY_XPU_AAE_MSG_HANDLE              make_fid(FID_DISPLAY_GROUP, 0x0f)
#define FID_BL31_DISPLAY_DOZE1_CONFIG                    make_fid(FID_DISPLAY_GROUP, 0x10)

/* sdcu */
#define SDCU_FID_POWER_ON                    make_fid(FID_SDCU_GROUP, 0x00)
#define SDCU_FID_POWER_OFF                   make_fid(FID_SDCU_GROUP, 0x01)
#define SDCU_FID_FREQ_VOTE                   make_fid(FID_SDCU_GROUP, 0x02)
...
#define SPI_NOR_SEC_READ_UNIQUE_ID  make_fid(FID_SPI_NOR_GROUP, 0x0D)
#define SPI_NOR_SEC_READ_JEDEC_ID   make_fid(FID_SPI_NOR_GROUP, 0x0E)

#define SPI_NOR_SET_ROOT_KEY        make_fid(FID_SPI_NOR_GROUP, 0x16)
#define SPI_NOR_GET_ROOT_KEY_STATUS make_fid(FID_SPI_NOR_GROUP, 0x17)
#define SPI_NOR_UPDATE_HMAC_KEY     make_fid(FID_SPI_NOR_GROUP, 0x18)

#define SPI_NOR_SEC_WRITE_ZERO     make_fid(FID_SPI_NOR_GROUP, 0x20)
...
#define FID_LP_CPU_DVFS_GET_FV_INFO          make_fid(FID_LP_CPU_GROUP, 0x0E)
#define FID_LP_CPU_RTB_YLD_RATE_VOLT         make_fid(FID_LP_CPU_GROUP, 0x0f)
/*
 * clk
...
#define FID_LP_DDR_STAT_SET                   make_fid(FID_DDR_GROUP, 0x02)

#define FID_DDR_SCENE_SET                     make_fid(FID_DDR_GROUP, 0x03)
#define FID_QDBES_SET                         make_fid(FID_DDR_GROUP, 0x04)
#define FID_DDR_ULL_GET                       make_fid(FID_DDR_GROUP, 0x05)
...
#define FFTS_RESTORE                   make_fid(FID_FFRT_GROUP, 0x05)
...
/*
 * mailbox
 * 0xc3004700 ~ 0xc3004700
 */
#define FID_MAILBOX_SYNC_SEND                make_fid(FID_MAILBOX_GROUP, 0x00)
#define FID_MAILBOX_REMAPID_INIT             make_fid(FID_MAILBOX_GROUP, 0x01)
...
#define FID_TCP_ENABLE_IRQ              make_fid(FID_TCP_GROUP, 0x07)
#define FID_TCP_DISABLE_IRQ             make_fid(FID_TCP_GROUP, 0x08)

/*
 * pcie
 * 0xc3004e00 ~ 0xc3004eff
 */
#define NPU_PM_TZSP_KERNEL_RD_AVS            make_fid(FID_NPU_PM_KERNEL_GROUP, 0x00)
