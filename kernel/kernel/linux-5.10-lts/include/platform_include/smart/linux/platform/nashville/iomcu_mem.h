...
#define DDR_ONCE_LOADER_BASE_AP                        (DDR_RESERVE_ADDR_AP)
#define DDR_ONCE_LOADER_SIZE                           (0x200000)
#define DDR_ONCE_LOADER_END_AP                         (DDR_ONCE_LOADER_BASE_AP + DDR_ONCE_LOADER_SIZE)

#define DDR_CODE_BASE_AP                   			 	 DDR_ONCE_LOADER_END_AP
...
#define DDR_HEAP_SIZE                      			 	 (0x5FE000)
#define DDR_HEAP_END_AP                    			 	 (DDR_HEAP_START_AP + DDR_HEAP_SIZE)

#define DDR_F2L_CONFIG_ADDR_AP             			 	 DDR_HEAP_END_AP
...
#define DDR_RESERVED_END_AP                            (DDR_F2L_RANDOM_DATA_END_AP + DDR_RESERVED_4K_SIZE)

#define DDR_IPCNS_SHM_RX_START_AP          			 	 DDR_RESERVED_END_AP
