...
extern int mas_scsi_execute(struct scsi_device *sdev, const unsigned char *cmd,
		 int data_direction, void *buffer, unsigned bufflen,
		 unsigned char *sense, struct scsi_sense_hdr *sshdr,
		 int timeout, int retries, u64 flags, u64 mas_flags,
		 req_flags_t rq_flags, int *resid);
static inline int
mas_scsi_execute_req_with_flags(struct scsi_device *sdev, const unsigned char *cmd,
	int data_direction, void *buffer, unsigned bufflen,
	struct scsi_sense_hdr *sshdr, int timeout,
	int retries, u64 flags, u64 mas_flags, int *resid)
{
	return mas_scsi_execute(sdev, cmd, data_direction, buffer, bufflen, NULL,
		sshdr, timeout, retries, flags, mas_flags, 0, resid);
}
#endif
