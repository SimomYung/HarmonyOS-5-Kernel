...
#define VIP_BOOSTED		(1U << 0)
#define RAISED_KTHREAD		(1U << 1)
#define LONG_RT_DOWNGRADE	(1U << 2)
#define BINDER_DEFERRED_RESTORE	(1U << 3)
#define DEFERRED_BOOST_ON_SCHED_OUT (1U << 4)
...
void check_deferred_vip_boost(struct task_struct *p);
