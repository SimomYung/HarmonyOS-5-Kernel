...
void cpufreq_get_coloc_grp_util(const struct cpumask *policy_cpus, u32 *util);
...
ssize_t coloc_grp_window_size_show(struct kobject *kobj,
		struct kobj_attribute *kattr, char *buf);
ssize_t coloc_grp_window_size_store(struct kobject *kobj,
