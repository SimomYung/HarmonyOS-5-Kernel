...
static struct ctl_table kern_table[] = {
...
#ifdef CONFIG_HW_CGROUP_WORKINGSET_FAULT_AROUND
	{
		.procname	= "ws_fault_around",
		.data		= &g_sysctl_ws_fault_around_enabled,
		.maxlen		= sizeof(int),
		.mode		= 0644,
	...
	{
		.procname	= "user_handle_freezing",
		.data		= &sysctl_user_handle_freezing,
		.maxlen		= sizeof(unsigned int),
		.mode		= 0644,
		.proc_handler	= proc_dointvec_minmax,
		.extra1		= SYSCTL_ZERO,
	...
	{
		.procname	= "sched_rt_soft_runtime_us",
		.data		= &sysctl_sched_rt_soft_runtime,
		.maxlen		= sizeof(int),
		.mode		= 0644,
		.proc_handler	= sched_rt_handler,
	},
	{
		.procname	= "sched_target_downgrade_prio",
		.data		= &sysctl_sched_target_downgrade_nice,
		.maxlen		= sizeof(int),
		.mode		= 0644,
		.proc_handler	= sched_target_downgrade_nice_handler,
	},
#endif
	{
...
static struct ctl_table vm_table[] = {
	...
	{
		.procname	= "step_free_kbytes",
		.data		= &step_free_kbytes,
		.maxlen		= sizeof(step_free_kbytes),
		.mode		= 0644,
		.proc_handler	= step_free_kbytes_sysctl_handler,
		.extra1		= SYSCTL_ZERO,
	},
#endif
	{
