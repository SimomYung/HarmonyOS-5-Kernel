...
enum cfg80211_event_type {
	...
	EVENT_DRV_VOWIFI, // CONFIG_HW_VOWIFI
	EVENT_DRV_ANT, // CONFIG_HW_ABS
	EVENT_DRV_MSS, // CONFIG_HW_WIFI_MSS
	EVENT_DRV_TAS_RSSI, // CONFIG_HW_WIFI_RSSI
	EVENT_DRV_WIFI_EVENT, // CONFIG_HW_WIFI_EVENT
};
