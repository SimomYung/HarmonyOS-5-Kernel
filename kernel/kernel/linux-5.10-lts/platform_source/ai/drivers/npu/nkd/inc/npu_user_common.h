...
/* sink stream strategy */
#define STREAM_STRATEGY_SINK       (0x1 << 0)
#define STREAM_STRATEGY_LONG       (0x1 << 1)

/* non-sink stream strategy */
#define STREAM_STRATEGY_NONSINK    (0x0)
#define STREAM_STRATEGY_ASYNC      (0x1 << 16)
...
struct npu_set_model_bandwidth_info {
	u16 model_id;
	u16 mode;
};
