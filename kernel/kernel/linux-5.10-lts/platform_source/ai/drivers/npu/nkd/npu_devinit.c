...
#ifdef NPU_ARCH_V100
	mutex_init(&dev_ctx->pm.proc_index_mutex);
#else
...
#ifdef NPU_ARCH_V100
	mutex_destroy(&dev_ctx->pm.proc_index_mutex);
#endif
...
#endif
#ifdef NPU_ARCH_V100
	dev_ctx->pm.pm_bitmap = 0;
	dev_ctx->pm.proc_index_bitmap = 0;
	npu_drv_info("pm_bitmap init");
#else
