 ...
 * ISPNN_SHARED = 3        :null;                    null;                       need all subips
 * INIT = 4                :null;                    not support idle powerdown; need all except NPU_IP_AICORE_GE
 * NPU_NONSEC_GE = 5       :null;                    null;                       null
 * NPU_NONSEC_EFF = 6      :null;                    null;                       null
 * NPU_NONSEC_TS = 7       :null;                    not support idle powerdown; need all except NPU_IP_AICORE_GE
 * NPU_FFRT = 8            :null;                    null;                       need all subips
 * NPU_FFRT_GE = 9         :null;                    null;                       null
 * NPU_FFRT_EFF = 10       :null;                    null;                       null
...
u32 g_pm_interfram_idle_subip = 0;
