...
#define NPU_HTS_EVENT_MAX_ID            1024
#define NPU_HTS_EVENT_MAX_DST_ID        2

#define NPU_MAX_NOTIFY_ID               512
#define NPU_NOTIFY_ID_START             0
#define NPU_NOTIFY_ID_CNT               (NPU_MAX_NOTIFY_ID - NPU_NOTIFY_ID_START)
