...
#define SOCDSP_TOTAL_LOG_PATH "/data/hisi_logs/socdsp_total_log/"
#else
#define SOCDSP_TOTAL_LOG_PATH (CONFIG_BBOX_LOG_DIR "socdsp_total_log/")
#endif

#define SOCDSP_TOTAL_LOG_FILE "socdsp_log.bin"
