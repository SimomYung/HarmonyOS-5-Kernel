...
#endif
#define HIFI_MISC_IOCTL_AUDIO_EFFECT_HISTEN_PARAMS   _IOWR('A',  0x85, struct misc_io_sync_param)
#define HIFI_MISC_IOCTL_GET_DSP_TIME_INFO   _IOWR('A',  0x86, struct dsp_time_info)
#define HIFI_MISC_IOCTL_PSZ_SCENE_PARAMS _IOWR('A', 0x87, struct misc_io_async_param)
#define HIFI_MISC_IOCTL_PSZ_CALIB_PARAMS _IOWR('A', 0x88, struct misc_io_async_param)
