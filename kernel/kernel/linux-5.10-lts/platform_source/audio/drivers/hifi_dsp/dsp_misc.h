...
#define NVPARAM_COUNT_EXP    900         /* HIFI expanding NV size is 900 */
...
#define NVPARAM_TOTAL_SIZE_EXP   ((NVPARAM_NUMBER * NVPARAM_COUNT_EXP + NVPARAM_START + NVPARAM_TAIL) * sizeof(unsigned short))
