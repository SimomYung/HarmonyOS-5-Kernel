...
static void voice_dmd_update_imonitor(unsigned int type, unsigned int eventid, unsigned int msg_type, struct voice_3a_dmd_om *dmd_data)
{
    ...
    ret = sprintf_s(adsp_dmd, sizeof(adsp_dmd), "3a error type: %u error: %u nvid: %u dat1: %u dat2: %u\n", msg_type, dmd_data->recv_msg, dmd_data->nvid,
        dmd_data->data1, dmd_data->data2);
    if (ret <= 0) {
