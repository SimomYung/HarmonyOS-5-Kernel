...
static struct rdr_exception_info_s audio_exception_info[] = {
	{
		...
		.e_save_log_flags   = (unsigned int)(RDR_SAVE_LOGBUF | RDR_SAVE_DMESG | RDR_SAVE_CONSOLE_MSG),
	},
	{
	...
	},
	{
		...
		.e_process_priority = RDR_ERR,
#ifdef RDR_QIC_ASP_BUS_REGISTER
		.e_reboot_priority  = RDR_REBOOT_NOW,
#else
		.e_reboot_priority  = RDR_REBOOT_NO,
#endif
...
#ifdef CONFIG_DFX_SEC_QIC_V300_MODID_REGISTER
#ifdef RDR_QIC_ASP_BUS_REGISTER
	dfx_qic_modid_register(SOC_ASP_HIFI_MID, SOC_ASP_HIFI_MID, QIC_ASP_BUS, RDR_AUDIO_ASP_QIC_MODID);
	dfx_qic_modid_register(SOC_ASP_DMA_USB_HDMI_MID, SOC_ASP_DMA_USB_HDMI_MID, QIC_ASP_BUS, RDR_AUDIO_ASP_QIC_MODID);
#endif
#endif
