...
#define DSP_UNSEC_RESERVE_ADDR (HISI_WEAR_BT_OFFLOAD_IPC_SHARE_BUFF_ADDR + HISI_WEAR_BT_OFFLOAD_IPC_SHARE_BUFF_SIZE)
...
#define DRV_DSP_AUTO_DIV_ENABLE_ADDR    (DRV_DSP_WLP_STATUS_ADDR + 4)
