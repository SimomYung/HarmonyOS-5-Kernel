...
#if defined(CONFIG_PRODUCT_CDC) || defined(CONFIG_PRODUCT_CDC_ACE) || defined(CONFIG_RDA_AUDIO_DRIVERS)
#define PCM_PLAY_BUFF_USED_SIZE            0x160000
#else
#define PCM_PLAY_BUFF_USED_SIZE            0x13C000
#endif

#ifdef CONFIG_HISI_VOICE_NVPARAM_SUPPORT_EXP
#define DSP_AP_NV_DATA_SIZE                0x71800
#else
...
#define CODEC_DSP_OM_DMA_BUFFER_SIZE       0x0
#define CODEC_DSP_OM_DMA_CONFIG_SIZE       0x0
#define CODEC_DSP_SOUNDTRIGGER_TOTAL_SIZE  0x0
#define DSP_PCM_UPLOAD_BUFFER_SIZE         0x0
#define AP_AUDIO_PA_BUFF_SIZE              0x0
#ifndef CONFIG_HIFI_WATCH_WAKEUP
#define AP_AUDIO_WAKEUP_MODEL_SIZE         0x0
#else
#define AP_AUDIO_WAKEUP_MODEL_SIZE         0x1000
#endif
#define AP_AUDIO_LP_WAKEUP_RINGBUFEER_SIZE 0x0
#define AP_AUDIO_LP_WAKEUP_CAPTURE_SIZE    0x0
#define AP_VIRTUAL_CALL_DOWNLINK_SIZE      0x0
#define AP_VIRTUAL_CALL_UPLINK_SIZE        0x0
#define DSP_PARA_DOWNLOAD_BUFFER_SIZE      0x0
#else
...
#ifndef CONFIG_UPLOAD_CHANNEL_COUNT
#define CONFIG_UPLOAD_CHANNEL_COUNT 1
#endif

#if (CONFIG_UPLOAD_CHANNEL_COUNT == 4)
#define AP_AUDIO_WAKEUP_RINGBUFEER_SIZE    (0x1E000 * 2)
#define AP_AUDIO_WAKEUP_CAPTURE_SIZE       0xC000
#elif defined CONFIG_DSP_VAD_WAKEUP
...
#define AP_AUDIO_WAKEUP_RINGBUFEER_SIZE    0x0
#define AP_AUDIO_WAKEUP_CAPTURE_SIZE       0x0
#else
#define AP_AUDIO_WAKEUP_RINGBUFEER_SIZE    0x1E000
#define AP_AUDIO_WAKEUP_CAPTURE_SIZE       0x3000
#endif
...
#ifdef CONFIG_HIFI_MEMORY_15M
#define HISI_WEAR_BT_OFFLOAD_IPC_SHARE_BUFF_SIZE 0x1800
#else
#define HISI_WEAR_BT_OFFLOAD_IPC_SHARE_BUFF_SIZE 0x0
#endif
...
#ifdef CONFIG_HIFI_HISTEN_OFFLOAD
#define DSP_AUDIO_EFFECT_HISTEN_PARAM_BUFF_SIZE   0xA000
#else
#define DSP_AUDIO_EFFECT_HISTEN_PARAM_BUFF_SIZE 0x0
#endif
...
#define DSP_AUDIO_EFFECT_HISTEN_PARAM_ADDR (HIFI_NN_DSP_ROUTE_OUTPUT_ADDR + NN_DSP_ROUTE_OUTPUT_BUFFER_SIZE)
#define HISI_WEAR_BT_OFFLOAD_IPC_SHARE_BUFF_ADDR (DSP_AUDIO_EFFECT_HISTEN_PARAM_ADDR + DSP_AUDIO_EFFECT_HISTEN_PARAM_BUFF_SIZE)
#ifdef CONFIG_AUDIO_HAPTIC
#define DSP_HAPTIC_DATA_BUF_ADDR (ALIGN_UP((HISI_WEAR_BT_OFFLOAD_IPC_SHARE_BUFF_ADDR + \
    HISI_WEAR_BT_OFFLOAD_IPC_SHARE_BUFF_SIZE), PAGE_SIZE))
#define DSP_HAPTIC_DATA_BUF_SIZE 0x3000
#else
#define DSP_HAPTIC_DATA_BUF_ADDR (HISI_WEAR_BT_OFFLOAD_IPC_SHARE_BUFF_ADDR + HISI_WEAR_BT_OFFLOAD_IPC_SHARE_BUFF_SIZE)
#define DSP_HAPTIC_DATA_BUF_SIZE 0x0
#endif
#ifdef AUDIO_DATA_INJECTION_SUPPORT
/* align to page size for memory mapping */
#define DSP_DATA_INJECTION_ADDR ALIGN_UP((DSP_HAPTIC_DATA_BUF_ADDR + DSP_HAPTIC_DATA_BUF_SIZE), PAGE_SIZE)
#define DSP_DATA_INJECTION_BUFF_SIZE (ALIGN_UP( \
    (DSP_UNSEC_REGION_SIZE - (DSP_DATA_INJECTION_ADDR - DSP_UNSEC_BASE_ADDR)), PAGE_SIZE) - PAGE_SIZE)
#define DSP_UNSEC_RESERVE_ADDR (DSP_DATA_INJECTION_ADDR + DSP_DATA_INJECTION_BUFF_SIZE)
#else
#define DSP_UNSEC_RESERVE_ADDR (DSP_HAPTIC_DATA_BUF_ADDR + DSP_HAPTIC_DATA_BUF_SIZE)
#endif

#ifdef CONFIG_HIFI_MEMORY_15M
#define PCM_OM_BUFF_LOCATION             (HISI_WEAR_BT_OFFLOAD_IPC_SHARE_BUFF_ADDR + HISI_WEAR_BT_OFFLOAD_IPC_SHARE_BUFF_SIZE)
#else
...
#define DRV_DSP_UART_TO_MEM_LEN_ADDR        (DRV_DSP_SCREEN_STATUS + DRV_DSP_SCREEN_STATUS_SIZE)
#define DRV_DSP_SERVICE_ACTIVE_ADDR         (DRV_DSP_UART_TO_MEM_LEN_ADDR + 4)
#define DRV_DSP_WLP_STATUS_ADDR             (DRV_DSP_SERVICE_ACTIVE_ADDR + 4)
#define DRV_DSP_ANA_CODEC_EFUSE_STATUS_ADDR (DRV_DSP_WLP_STATUS_ADDR + 4)
#define DRV_AP_IODIE_SHAMEM_ADDR            (DRV_DSP_ANA_CODEC_EFUSE_STATUS_ADDR + 4)
#define DRV_DSP_AUTO_DIV_ENABLE_ADDR        (DRV_AP_IODIE_SHAMEM_ADDR + 4)
#define DRV_DSP_FLAG_DATA_RESERVED          (DRV_DSP_AUTO_DIV_ENABLE_ADDR + 4)

#ifdef CONFIG_HIFI_MEMORY_15M
#define DSP_IMAGE_OCRAMBAK_SIZE        0x0
#else
...
#define DSP_AUDIO_PSZ_SCENE_ADDR       DSP_AUDIO_EFFECT_PARAM_ADDR
#define DSP_AUDIO_PSZ_SCENE_SIZE       DSP_AUDIO_EFFECT_PARAM_BUFF_SIZE
#define DSP_AUDIO_PSZ_CALIB_OFFSET     280
#define DSP_AUDIO_PSZ_CALIB_ADDR       (DSP_AUDIO_EFFECT_PARAM_ADDR + DSP_AUDIO_PSZ_CALIB_OFFSET)
#define DSP_AUDIO_PSZ_CALIB_SIZE       380
