...
#ifndef __ASP_CODEC_ANA_V7_REG_DEF_H__
#define __ASP_CODEC_ANA_V7_REG_DEF_H__

#define PAGE_VIRCODEC_ANA          0x9000
#define PAGE_VIRCODEC_ANA_END      (PAGE_VIRCODEC_ANA + VIR_ANA_REG_CNT - 1)
#define PAGE_ANACODEC              0xC000
#define PAGE_ANACODEC_END          0xC04c
#define PAGE_ANACTRL               0x0
#define PAGE_ANACTRL_END           0x583
#define PAGE_ANAHKADC              0x2000
#define PAGE_ANAHKADC_END          0x2010

/* ANA_CODEC Base address of Module's Register */
#define CODEC_ANA_V7_BASE                       (0x0)

/******************************************************************************/
/*                      DCODEC_ANA_V7 ANA_CODEC Registers' Definitions       */
/******************************************************************************/

#define CLK_EN_CFG_REG         (CODEC_ANA_V7_BASE + 0xC000) /* 时钟使能配置寄存器。 */
...
#define CLK_EDGE_CFG_REG       (CODEC_ANA_V7_BASE + 0xC001) /* 数模接口时钟沿选择。 */
...
#define AU_LOOPBACK_CFG_REG   (CODEC_ANA_V7_BASE + 0xC002) /* AU接口环回控制。 */
#define ADC_LOOPBACK_LEN    2
#define ADC_LOOPBACK_OFFSET 2
#define DAC_LOOPBACK_LEN    2
#define DAC_LOOPBACK_OFFSET 0

#define DAC_CHAN_CTRL_REG      (CODEC_ANA_V7_BASE + 0xC003) /* DAC通路配置。 */
...
#define ADC_CHAN_CTRL_REG      (CODEC_ANA_V7_BASE + 0xC004) /* ADC通路配置。 */
...
#define AU_MAD_REG            (CODEC_ANA_V7_BASE + 0xC005) /* ADC通路配置。 */
...
#define AU_MAD_CIC_GAIN_REG   (CODEC_ANA_V7_BASE + 0xC006) /* CIC增益配置。 */
#define MAD_CIC_GAIN_LEN    6
#define MAD_CIC_GAIN_OFFSET 0

#define ANA_IRQ_SIG_STAT_REG   (CODEC_ANA_V7_BASE + 0xC007) /* 模拟中断原始状态寄存器。 */
...
#define ANA_IRQM_REG0_REG      (CODEC_ANA_V7_BASE + 0xC008) /* ANA_IRQ_REG中断屏蔽寄存器。 */
...
#define ANA_IRQ_REG0_REG       (CODEC_ANA_V7_BASE + 0xC009) /* 模拟中断寄存器。0，写1清，读上报中断信息。 */
...
#define DEB_CNT_HS_DET_CFG_REG (CODEC_ANA_V7_BASE + 0xC00A) /* hs_det_irq去抖配置。 */
...
#define DEB_CNT_HS_MIC_CFG_REG (CODEC_ANA_V7_BASE + 0xC00B) /* hs_mic_irq去抖配置。 */
...
#define CODEC_ANA_RW1_REG      (CODEC_ANA_V7_BASE + 0xC00C) /* vref/ctcm/ibias模块使能。 */
#define IBIAS_PD_LEN      1
#define IBIAS_PD_OFFSET   2
#define AVREF_SEL_LEN     2
#define AVREF_SEL_OFFSET  0

#define CODEC_ANA_RW2_REG      (CODEC_ANA_V7_BASE + 0xC00D) /* micpga使能。 */
...
#define CODEC_ANA_RW3_REG      (CODEC_ANA_V7_BASE + 0xC00E) /* adc使能。 */
...
#define CODEC_ANA_RW4_REG      (CODEC_ANA_V7_BASE + 0xC00F) /* dac使能。 */
...
#define CODEC_ANA_RW5_REG      (CODEC_ANA_V7_BASE + 0xC010) /* headphone使能。 */
...
#define CODEC_ANA_RW6_REG      (CODEC_ANA_V7_BASE + 0xC011) /* earphone/lineout使能。 */
...
#define CODEC_ANA_RW7_REG      (CODEC_ANA_V7_BASE + 0xC012) /* micbias使能。 */
...
#define CODEC_ANA_RW8_REG      (CODEC_ANA_V7_BASE + 0xC013) /* mbhd使能。 */
...
#define CODEC_ANA_RW9_REG      (CODEC_ANA_V7_BASE + 0xC014) /* mainpga配置。 */
...
#define CODEC_ANA_RW10_REG     (CODEC_ANA_V7_BASE + 0xC015) /* auxpga配置。 */
...
#define CODEC_ANA_RW11_REG     (CODEC_ANA_V7_BASE + 0xC016) /* mic3pga配置。 */
...
#define CODEC_ANA_RW12_REG     (CODEC_ANA_V7_BASE + 0xC017) /* adcl配置。 */
...
#define CODEC_ANA_RW13_REG     (CODEC_ANA_V7_BASE + 0xC018) /* adcl配置。 */
...
#define CODEC_ANA_RW14_REG     (CODEC_ANA_V7_BASE + 0xC019) /* adcr配置。 */
...
#define CODEC_ANA_RW15_REG     (CODEC_ANA_V7_BASE + 0xC01A) /* adcr配置。 */
...
#define CODEC_ANA_RW16_REG     (CODEC_ANA_V7_BASE + 0xC01B) /* adc3配置。 */
...
#define CODEC_ANA_RW17_REG     (CODEC_ANA_V7_BASE + 0xC01C) /* adc3配置。 */
...
#define CODEC_ANA_RW18_REG     (CODEC_ANA_V7_BASE + 0xC01D) /* dac配置。 */
...
#define CODEC_ANA_RW19_REG     (CODEC_ANA_V7_BASE + 0xC01E) /* chargepump配置。 */
...
#define CODEC_ANA_RW20_REG     (CODEC_ANA_V7_BASE + 0xC01F) /* hp mixer输入选择。 */
...
#define CODEC_ANA_RW21_REG     (CODEC_ANA_V7_BASE + 0xC020) /* hp增益选择。 */
#define HSL_GAIN_LEN    4
#define HSL_GAIN_OFFSET 4
#define HSR_GAIN_LEN    4
#define HSR_GAIN_OFFSET 0

#define CODEC_ANA_RW22_REG     (CODEC_ANA_V7_BASE + 0xC021) /* hp配置。 */
...
#define CODEC_ANA_RW23_REG     (CODEC_ANA_V7_BASE + 0xC022) /* hp配置。 */
...
#define CODEC_ANA_RW24_REG     (CODEC_ANA_V7_BASE + 0xC023) /* hp pop配置。 */
...
#define CODEC_ANA_RW25_REG     (CODEC_ANA_V7_BASE + 0xC024) /* ep mixer配置。 */
...
#define CODEC_ANA_RW26_REG     (CODEC_ANA_V7_BASE + 0xC025) /* earphone配置。 */
#define EAR_CM_CTRL_LEN    1
#define EAR_CM_CTRL_OFFSET 4
#define EAR_GAIN_LEN       4
#define EAR_GAIN_OFFSET    0

#define CODEC_ANA_RW27_REG     (CODEC_ANA_V7_BASE + 0xC026) /* lineout mixer配置。 */
...
#define CODEC_ANA_RW28_REG     (CODEC_ANA_V7_BASE + 0xC027) /* lineout配置。 */
#define LOUT_VCM_CTRL_LEN    1
#define LOUT_VCM_CTRL_OFFSET 4
#define LOUT_GAIN_LEN        4
#define LOUT_GAIN_OFFSET     0

#define CODEC_ANA_RW29_REG     (CODEC_ANA_V7_BASE + 0xC028) /* himicbias配置。 */
...
#define CODEC_ANA_RW30_REG     (CODEC_ANA_V7_BASE + 0xC029) /* micbias1配置。 */
...
#define CODEC_ANA_RW31_REG     (CODEC_ANA_V7_BASE + 0xC02A) /* micbias2配置。 */
...
#define CODEC_ANA_RW32_REG     (CODEC_ANA_V7_BASE + 0xC02B) /* 耳机插入检测配置。 */
...
#define CODEC_ANA_RW33_REG     (CODEC_ANA_V7_BASE + 0xC02C) /* 耳机拔出pop配置。 */
...
#define CODEC_ANA_RW34_REG     (CODEC_ANA_V7_BASE + 0xC02D) /* mbhd ref配置。 */
...
#define CODEC_ANA_RW35_REG     (CODEC_ANA_V7_BASE + 0xC02E) /* adc/dac时钟验配置。 */
...
#define CODEC_ANA_RW36_REG     (CODEC_ANA_V7_BASE + 0xC02F) /* rx通路chop时钟配置。 */
...
#define CODEC_ANA_RW37_REG     (CODEC_ANA_V7_BASE + 0xC030) /* tx通路chop时钟配置。 */
...
#define CODEC_ANA_RW38_REG     (CODEC_ANA_V7_BASE + 0xC031) /* cp/pop时钟配置。 */
...
#define CODEC_ANA_RW39_REG     (CODEC_ANA_V7_BASE + 0xC032) /* capless时钟配置。 */
...
#define CODEC_ANA_RW40_REG     (CODEC_ANA_V7_BASE + 0xC033) /* 偏置电流配置。 */
...
#define CODEC_ANA_RW41_REG     (CODEC_ANA_V7_BASE + 0xC034) /* CODEC_ANA_RW41偏置电流配置。 */
...
#define CODEC_ANA_RW46_REG     (CODEC_ANA_V7_BASE + 0xC039) /* CODEC_ANA_RW46偏置电流配置。 */
#define IB05_EARMIX_ADJ_LEN    3
#define IB05_EARMIX_ADJ_OFFSET 4
#define IB05_EAR_ADJ_LEN       3
#define IB05_EAR_ADJ_OFFSET    0

#define CODEC_ANA_RW47_REG     (CODEC_ANA_V7_BASE + 0xC03A) /* CODEC_ANA_RW47偏置电流配置。 */
#define IB05_LO_ADJ_LEN         3
#define IB05_LO_ADJ_OFFSET      4
#define IB05_LOLOGIC_ADJ_LEN    3
#define IB05_LOLOGIC_ADJ_OFFSET 0

#define CODEC_ANA_RW48_REG     (CODEC_ANA_V7_BASE + 0xC03B) /* CODEC_ANA_RW48偏置电流配置。 */
#define IB05_MICB_ADJ_LEN    3
#define IB05_MICB_ADJ_OFFSET 0

#define CODEC_ANA_RW49_REG     (CODEC_ANA_V7_BASE + 0xC03C) /* CODEC_ANA_RW49偏置电流配置。 */
#define IB05_LOMIX_ADJ_LEN       3
#define IB05_LOMIX_ADJ_OFFSET    4
#define IB05_DACS_I2V_ADJ_LEN    3
#define IB05_DACS_I2V_ADJ_OFFSET 0

#define CODEC_ANA_RW50_REG     (CODEC_ANA_V7_BASE + 0xC03D) /* CODEC_ANA_RW50偏置电流配置。 */
#define CODEC_ANA_RW_50_LEN    8
#define CODEC_ANA_RW_50_OFFSET 0

#define CODEC_ANA_RW51_REG     (CODEC_ANA_V7_BASE + 0xC03E) /* CODEC_ANA_RW51。 */
#define CODEC_ANA_RW_51_LEN    8
#define CODEC_ANA_RW_51_OFFSET 0

#define CODEC_ANA_RW52_REG     (CODEC_ANA_V7_BASE + 0xC03F) /* CODEC_ANA_RW52。 */
#define CODEC_ANA_RW_52_LEN    8
#define CODEC_ANA_RW_52_OFFSET 0

#define CODEC_ANA_RW53_REG     (CODEC_ANA_V7_BASE + 0xC040) /* MADSDM积分器偏置电流 */
#define CODEC_ANA_RW54_REG     (CODEC_ANA_V7_BASE + 0xC041) /* MADSDM PGA偏置电流 */
#define CODEC_ANA_RW55_REG     (CODEC_ANA_V7_BASE + 0xC042) /* MAD ADC通路配置。 */
#define CODEC_ANA_RW56_REG     (CODEC_ANA_V7_BASE + 0xC043) /* MAD ADC通路配置。 */
#define CODEC_ANA_RW57_REG     (CODEC_ANA_V7_BASE + 0xC044) /* MAD ADC通路配置。 */
#define CODEC_ANA_RW58_REG     (CODEC_ANA_V7_BASE + 0xC045) /* MAD ADC通路配置。 */
#define VCM_MAD_LP_EN_LEN 1
#define VCM_MAD_LP_EN_OFFSET 6
#define MAD_PGA_SEL_LEN 4
#define MAD_PGA_SEL_OFFSET 0

#define CODEC_ANA_RW59_REG     (CODEC_ANA_V7_BASE + 0xC046) /* MAD ADC通路配置。 */
#define PGA_LEN 5
#define PGA_OFFSET 0

#define CODEC_ANA_RW60_REG     (CODEC_ANA_V7_BASE + 0xC047) /* MAD ADC通路配置。 */
...
#define CODEC_ANA_RW61_REG     (CODEC_ANA_V7_BASE + 0xC048) /* MAD CLK通路配置。 */
#define CODEC_ANA_RW62_REG     (CODEC_ANA_V7_BASE + 0xC049) /* MAD ADC通路配置。 */
#define DIN_MAD_MIC_LEN 1
#define DIN_MAD_MIC_OFFSET 0

#define CODEC_ANA_RW63_REG     (CODEC_ANA_V7_BASE + 0xC04A) /* CODEC_ANA_RW63 */

#define CODEC_ANA_RO01_REG     (CODEC_ANA_V7_BASE + 0xC04B) /* CODEC_ANA_RO01。 */
#define CODEC_ANA_RO_01_LEN    8
#define CODEC_ANA_RO_01_OFFSET 0

#define CODEC_ANA_RO02_REG     (CODEC_ANA_V7_BASE + 0xC04C) /* CODEC_ANA_RO02。 */
...
#define CODEC_ANA_V7_CTRL_REGB_BASE                       (0x400)

#define CTRL_REGB_CLASSD_CTRL0_REG      (CODEC_ANA_V7_CTRL_REGB_BASE + 0x180) /* CLASSD控制寄存器0 */
...
#define CTRL_REGB_CLASSD_CTRL1_REG      (CODEC_ANA_V7_CTRL_REGB_BASE + 0x181) /* CLASSD控制寄存器1 */
...
#define CTRL_REGB_CLASSD_CTRL2_REG      (CODEC_ANA_V7_CTRL_REGB_BASE + 0x182) /* CLASSD控制寄存器2 */
#define CTRL_REGB_CLASSD_RESERVE0_LEN    4
#define CTRL_REGB_CLASSD_RESERVE0_OFFSET 0

/* XOADC Base address of Module's Register */
#define CODEC_V7_PMU_XOADC_BASE                       (0x0)

#define CTRL_REG_DIG_IO_DS_CODEC_CFG_REG  (CODEC_V7_PMU_XOADC_BASE + 0x3DC) /* 数字CODEC IO驱动配置寄存器 */

#define CTRL_REG_DIG_IO_DS_SEL1_CODEC_CFG_REG  (CODEC_V7_PMU_XOADC_BASE + 0x3DE)

#endif /* __CODEC_ANA_V7_REG_DEF_H__ */
