...
#define PAGE_ACTRL            clear_31_bit(0xFDB22000)

#define PAGE_SOCSMARTPA1      (PAGE_SOCCODEC + 0x2000)
#define SPA1BYPASS_CFG        (PAGE_SOCSMARTPA1 + 0x0)
#define SPA1_IDF_CG_EN_OFFSET                30
#define SPA1_IDF_CG_EN_LEN                   1
#define SPA1_RGC_CG_EN_OFFSET                23
#define SPA1_RGC_CG_EN_LEN                   1
#define SPA1_BYPASS_EN_OFFSET                15
#define SPA1_BYPASS_EN_LEN                   16
#define IV_DATA_SEL1          (PAGE_SOCSMARTPA1 + 0x4)
#define SPA1_SMARTPA_PROTECT_CLK_RST_EN_OFFSET   15
#define SPA1_IV_DATA_SEL_CLK_RST_EN_LEN          17
#define SPA1_PARAMS_PASSTHROUGH_EN_OFFSET        12
#define SPA1_PARAMS_PASSTHROUGH_EN_LEN           1
#define SPA1_SPA_I_DATA_SEL_OFFSET               4
#define SPA1_SPA_I_DATA_SEL_OFFSET_LEN           4
#define SPA1_SPA_V_DATA_SEL_OFFSET               0
...
#define PAGE_SOCSMARTPA2      (PAGE_SOCCODEC + 0x2800)
#define SPA2BYPASS_CFG        (PAGE_SOCSMARTPA2 + 0x0)
#define SPA2_IDF_CG_EN_OFFSET                30
#define SPA2_IDF_CG_EN_LEN                   1
#define SPA2_RGC_CG_EN_OFFSET                23
#define SPA2_RGC_CG_EN_LEN                   1
#define SPA2_BYPASS_EN_OFFSET                15
#define SPA2_BYPASS_EN_LEN                   16
#define IV_DATA_SEL2          (PAGE_SOCSMARTPA2 + 0x4)
#define SPA2_SMARTPA_PROTECT_CLK_RST_EN_OFFSET   15
#define SPA2_IV_DATA_SEL_CLK_RST_EN_LEN          17
#define SPA2_PARAMS_PASSTHROUGH_EN_OFFSET        12
#define SPA2_PARAMS_PASSTHROUGH_EN_LEN           1
#define SPA2_SPA_I_DATA_SEL_OFFSET               4
#define SPA2_SPA_I_DATA_SEL_OFFSET_LEN           4
#define SPA2_SPA_V_DATA_SEL_OFFSET               0
...
#define PAGE_SOCSMARTPA3      (PAGE_SOCCODEC + 0x3000)
#define SPA3BYPASS_CFG        (PAGE_SOCSMARTPA3 + 0x0)
#define SPA3_IDF_CG_EN_OFFSET                30
#define SPA3_IDF_CG_EN_LEN                   1
#define SPA3_RGC_CG_EN_OFFSET                23
#define SPA3_RGC_CG_EN_LEN                   1
#define SPA3_BYPASS_EN_OFFSET                15
#define SPA3_BYPASS_EN_LEN                   16
#define IV_DATA_SEL3          (PAGE_SOCSMARTPA3 + 0x4)
#define SPA3_SMARTPA_PROTECT_CLK_RST_EN_OFFSET   15
#define SPA3_IV_DATA_SEL_CLK_RST_EN_LEN          17
#define SPA3_PARAMS_PASSTHROUGH_EN_OFFSET        12
#define SPA3_PARAMS_PASSTHROUGH_EN_LEN           1
#define SPA3_SPA_I_DATA_SEL_OFFSET               4
#define SPA3_SPA_I_DATA_SEL_OFFSET_LEN           4
#define SPA3_SPA_V_DATA_SEL_OFFSET               0
...
#define PAGE_SOCSMARTPA4      (PAGE_SOCCODEC + 0x3800)
#define SPA4BYPASS_CFG        (PAGE_SOCSMARTPA4 + 0x0)
#define SPA4_IDF_CG_EN_OFFSET                30
#define SPA4_IDF_CG_EN_LEN                   1
#define SPA4_RGC_CG_EN_OFFSET                23
#define SPA4_RGC_CG_EN_LEN                   1
#define SPA4_BYPASS_EN_OFFSET                15
#define SPA4_BYPASS_EN_LEN                   16
#define IV_DATA_SEL4          (PAGE_SOCSMARTPA4 + 0x4)
#define SPA4_SMARTPA_PROTECT_CLK_RST_EN_OFFSET   15
#define SPA4_IV_DATA_SEL_CLK_RST_EN_LEN          17
#define SPA4_PARAMS_PASSTHROUGH_EN_OFFSET        12
#define SPA4_PARAMS_PASSTHROUGH_EN_LEN           1
#define SPA4_SPA_I_DATA_SEL_OFFSET               4
#define SPA4_SPA_I_DATA_SEL_OFFSET_LEN           4
#define SPA4_SPA_V_DATA_SEL_OFFSET               0
...
#define ACTRL_END             0x30
#define MTCMOS_ACK_AO         (PAGE_ACTRL + 0x28)
...
#define SIF_CLKEN_OFFSET                          8
#define SIF_CLKEN_LEN                             1
...
#define S1_I2S_TDM_MODE_OFFSET                    6
#define S1_I2S_TDM_MODE_LEN                       2
...
#define FS_SPA4_UP_AFIFO_OFFSET                   6
#define FS_SPA4_UP_AFIFO_LEN                      2
...
#define DACL_SRCUP_DIN_SEL_OFFSET                 15
#define DACL_SRCUP_DIN_SEL_LEN                    1
#define DACR_SRCUP_DIN_SEL_OFFSET                 16
#define DACR_SRCUP_DIN_SEL_LEN                    1
...
#define ADC_ULTR_CIC_DIN_SEL_OFFSET               29
#define ADC_ULTR_CIC_DIN_SEL_LEN                  3
