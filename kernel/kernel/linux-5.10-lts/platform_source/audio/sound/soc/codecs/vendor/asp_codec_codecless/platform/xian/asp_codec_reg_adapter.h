...
#define FS_AUDIO_0_DN_AFIFO_REG             FS_CTRL6_REG
#define FS_AUDIO_1_DN_AFIFO_REG             FS_CTRL6_REG
#define FS_AUDIO_3_DN_AFIFO_REG             FS_CTRL8_REG
#define FS_CODEC_3_DN_AFIFO_REG             FS_CTRL8_REG
#define FS_ULTR_UP_AFIFO_REG                FS_CTRL1_REG
...
#define S1_I2S_TDM_MODE_OFFSET              S1_TDM_MODE_OFFSET
#define S1_I2S_TDM_MODE_LEN                 S1_TDM_MODE_LEN
#define FS_SPA4_UP_AFIFO_OFFSET             FS_SPA_4_UP_AFIFO_OFFSET
#define FS_SPA4_UP_AFIFO_LEN                FS_SPA_4_UP_AFIFO_LEN
...
#define SPA_PROTECT_WAY_CLK_EN_REG          CODEC_VIR3_REG_ADDR
#define SPA_PROTECT_WAY_CLK_EN_OFFSET       SPA_PROTECT_WAY_CLK_EN_BIT
#define SPA_BYPASS_CTRL_REG                 CODEC_VIR3_REG_ADDR
#define SPA0_BYPASS_OFFSET                  SPA0_BYPASS_BIT
#define SPA1_BYPASS_OFFSET                  SPA1_BYPASS_BIT
#define SPA2_BYPASS_OFFSET                  SPA2_BYPASS_BIT
#define SPA3_BYPASS_OFFSET                  SPA3_BYPASS_BIT
#define SPA1_PARAMS_PASSTHROUGH_EN_REG      CODEC_VIR3_REG_ADDR
#define SPA2_PARAMS_PASSTHROUGH_EN_REG      CODEC_VIR3_REG_ADDR
#define SPA3_PARAMS_PASSTHROUGH_EN_REG      CODEC_VIR3_REG_ADDR
#define SPA4_PARAMS_PASSTHROUGH_EN_REG      CODEC_VIR3_REG_ADDR
#define SPA1_CG_EN_CFG                      CODEC_VIR3_REG_ADDR
#define SPA1_PRE_PROCESS_CG_EN_OFFSET       SPA1_PRE_PROCESS_CG_EN_BIT
#define SPA1_CFG_EN_LEN                     VIR_ASP_REG_LEN
#define SPA2_CG_EN_CFG                      CODEC_VIR3_REG_ADDR
#define SPA2_PRE_PROCESS_CG_EN_OFFSET       SPA2_PRE_PROCESS_CG_EN_BIT
#define SPA2_CFG_EN_LEN                     VIR_ASP_REG_LEN
#define SPA3_CG_EN_CFG                      CODEC_VIR3_REG_ADDR
#define SPA3_PRE_PROCESS_CG_EN_OFFSET       SPA3_PRE_PROCESS_CG_EN_BIT
#define SPA3_CFG_EN_LEN                     VIR_ASP_REG_LEN
#define SPA4_CG_EN_CFG                      CODEC_VIR3_REG_ADDR
#define SPA4_PRE_PROCESS_CG_EN_OFFSET       SPA4_PRE_PROCESS_CG_EN_BIT
#define SPA4_CFG_EN_LEN                     VIR_ASP_REG_LEN
/* vir reg end */
