...
#define ASP_CFG_R_HIFIDSP_CLK_DIV_AUTO_REG       0x14c
...
#define ASP_CFG_R_GATE1_EN_REG           	     0x404
#define ASP_CFG_R_GATE1_DIS_REG                  0x408
...
#define ASP_CFG_GT_AUDIO_NEW_PLL_OFFSET         0
...
#define HIFIDSP_CLK_AUTO_DIV_MASK          0x700
#define HIFIDSP_CLK_DIV_16_OFFSET          10
#define HIFIDSP_CLK_DIV_16_BIT             BIT(HIFIDSP_CLK_DIV_16_OFFSET)

enum asp_hdmi_interface {
	ASP_HDMI_SPDIF = 0,
	ASP_HDMI_I2S,
};
...
void asp_cfg_dp_module_enable(enum asp_hdmi_interface type);
void asp_cfg_dp_module_disable(enum asp_hdmi_interface type);
unsigned int asp_cfg_get_irq_value(void);
#ifdef CONFIG_CHARPRO_IP_PLATFORM
void asp_cfg_dsp_auto_div_enable(void);
void asp_cfg_dsp_auto_div_disable(void);
#endif
