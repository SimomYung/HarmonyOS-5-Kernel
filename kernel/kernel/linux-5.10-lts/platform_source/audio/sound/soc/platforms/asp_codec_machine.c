...
SND_SOC_DAILINK_DEFS(analog_less_machine_pb_normal,
	...
	DAILINK_COMP_ARRAY(COMP_CODEC(NULL, DAI_LINK_CODECLESS_DAI_NAME)),
...
SND_SOC_DAILINK_DEFS(analog_less_machine_multi_channel,
	DAILINK_COMP_ARRAY(COMP_CPU("asp-pcm-multi-channel")),
	DAILINK_COMP_ARRAY(COMP_CODEC(NULL, DAI_LINK_CODECLESS_DAI_NAME)),
	DAILINK_COMP_ARRAY(COMP_PLATFORM(NULL)));
...
SND_SOC_DAILINK_DEFS(codec_ana_machine_normal,
	...
	DAILINK_COMP_ARRAY(COMP_CODEC(DLC_CODEC_NAME_ANA, DAI_LINK_ANA_CODEC_DAI_NAME)),
	DAILINK_COMP_ARRAY(COMP_PLATFORM("snd-soc-dummy")));

SND_SOC_DAILINK_DEFS(analog_less_machine_pc_btsco,
	DAILINK_COMP_ARRAY(COMP_CPU("asp-pcm-bt")),
	DAILINK_COMP_ARRAY(COMP_CODEC(NULL, DAI_LINK_CODECLESS_DAI_NAME)),
	DAILINK_COMP_ARRAY(COMP_PLATFORM(NULL)));

SND_SOC_DAILINK_DEFS(analog_less_machine_pc_hdmi,
	DAILINK_COMP_ARRAY(COMP_CPU("asp-pcm-hdmi")),
	DAILINK_COMP_ARRAY(COMP_CODEC(NULL, DAI_LINK_CODECLESS_DAI_NAME)),
	DAILINK_COMP_ARRAY(COMP_PLATFORM(NULL)));

SND_SOC_DAILINK_DEFS(analog_less_machine_pc_fm,
	DAILINK_COMP_ARRAY(COMP_CPU("snd-soc-dummy-dai")),
	DAILINK_COMP_ARRAY(COMP_CODEC(NULL, DAI_LINK_CODECLESS_DAI_NAME)),
	DAILINK_COMP_ARRAY(COMP_PLATFORM("snd-soc-dummy")));
...
static struct snd_soc_dai_link g_codecless_pc_link[] = {
	{}, /* is used for third codec dailink */
	{
		.name           = "analog_less_machine_pc_btsco",
		.stream_name    = "analog_less_machine_pc_btsco",
		SND_SOC_DAILINK_REG(analog_less_machine_pc_btsco),
		.nonatomic      = true,
	},
	{
		.name           = "analog_less_machine_pc_fm",
		.stream_name    = "analog_less_machine_pc_fm",
		SND_SOC_DAILINK_REG(analog_less_machine_pc_fm),
		.nonatomic      = true,
	},
	{
		.name           = "analog_less_machine_pc_hdmi",
		.stream_name    = "analog_less_machine_pc_hdmi",
		SND_SOC_DAILINK_REG(analog_less_machine_pc_hdmi),
		.nonatomic      = true,
	},
};
...
static struct snd_soc_dai_link g_analog_less_dai_link[] = {
	...
	{
		.name           = "analog_less_machine_multi_channel",
		.stream_name    = "analog_less_machine_multi_channel",
		SND_SOC_DAILINK_REG(analog_less_machine_multi_channel),
	},
};
...
static struct snd_soc_card g_codecless_pc_card = {
	.name      = ASP_CODEC_MACHINE_CARD_NAME,
	.dai_link  = g_codecless_pc_link,
	.num_links = ARRAY_SIZE(g_codecless_pc_link),
	.owner = THIS_MODULE,
};
...
static int analog_less_probe(struct platform_device *pdev)
{
	...
	if (of_property_read_bool(pdev->dev.of_node, "huawei,extern_codec_type")) {
		AUDIO_LOGI("This platform has extern codec\n");
		card = &g_codecless_pc_card;
		hwcxext_codec_set_dailink_in_machine_driver(pdev, &g_codecless_pc_link[0]);
	}
