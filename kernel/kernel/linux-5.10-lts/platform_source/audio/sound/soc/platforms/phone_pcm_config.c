...
#define AUIDO_PCM_MULTI_CHANNEL_MAX_CHANNELS 16
...
#define AUIDO_PCM_CP_MAX_CHANNELS  16
/* Assume the FIFO size */
...
static struct snd_soc_dai_driver g_audio_pcm_dai[] = {
	...
	{
		.name = "asp-pcm-multi-channel",
		.playback = {
			.stream_name  = "asp-pcm-multi-channel Playback",
			.channels_min = AUIDO_PCM_PB_MIN_CHANNELS,
			.channels_max = AUIDO_PCM_MULTI_CHANNEL_MAX_CHANNELS,
			.rates        = AUIDO_PCM_PB_RATES,
			.formats      = AUIDO_PCM_PB_FORMATS
		},
	},
...
/* define the capability of playback channel for multi channel device */
static const struct snd_pcm_hardware g_audio_pcm_hardware_multi_channel_playback = {
	.info             = SNDRV_PCM_INFO_INTERLEAVED
		| SNDRV_PCM_INFO_NONINTERLEAVED
		| SNDRV_PCM_INFO_MMAP
		| SNDRV_PCM_INFO_MMAP_VALID
...
static const struct snd_pcm_hardware *g_audio_pcm_hw_info[PCM_DEVICE_TOTAL][PCM_STREAM_MAX] = {
	...
	{ &g_audio_pcm_hardware_multi_channel_playback, NULL }, /* PCM_DEVICE_MULTI_CHANNEL */
};
