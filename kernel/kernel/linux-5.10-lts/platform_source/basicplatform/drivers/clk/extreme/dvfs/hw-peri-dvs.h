...
#define MAX_PERI_DVS_DUMP_REG_NUM      9
#define MAX_PERIMEM_DVS_DUMP_REG_NUM   6
#define MAX_PERI_MEDIA_DVS_DUMP_REG_NUM   9
...
#define INVALID_REG_ADDR               0xFFF

#define STABLE_MASK   0xFFFFFFFF
...
enum {
	...
	DVS_VAU_STABLE_REG,  /* vau stable reg addr */
	DVS_MAX_REG,
};
...
struct peri_dvs_config {
	...
	unsigned int  peri_m1_dvs_enabled;
	unsigned int  peri_m2_dvs_enabled;
	unsigned int  peri_m1_dis_buck_volt;
	unsigned int  peri_m2_dis_buck_volt;
	unsigned int  dvfs_reg_num;
	unsigned int  peri_dvs_wait_vau;
	unsigned int  stable_timeout_bugon;
	...
	int dump_peri_m1_reg_num;
	unsigned int dump_peri_m1_reg[MAX_PERI_MEDIA_DVS_DUMP_REG_NUM];
	int dump_peri_m2_reg_num;
	unsigned int dump_peri_m2_reg[MAX_PERI_MEDIA_DVS_DUMP_REG_NUM];
#endif
};
