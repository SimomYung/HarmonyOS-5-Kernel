...
static const struct pmu_clock pmu_clks[] = {
	{ CLK_GATE_ABB_192, "clk_abb_192", "clkin_sys", 0x06B, 0, pmu_clk_flag(1, 9), 0, "clk_abb_192" },
...
#ifdef CONFIG_CLK_HIBERNATION
	(void)plat_clk_hibernate_sr_init();
#endif
