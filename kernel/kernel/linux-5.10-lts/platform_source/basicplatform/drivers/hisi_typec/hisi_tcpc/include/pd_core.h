...
#define EXT_HDR_SIZE	2
#define EXT_MSG_DATA_SIZE(obj)	(obj * sizeof(uint32_t) - EXT_HDR_SIZE)
...
#define PD_DISCOVER_ID_COUNT	20
#define PD_RETRY_COUNT 3
#define PD_RETRY_COUNT_30 2
...
typedef struct __pd_port {
	...
	bool cable_vconn_back;
#endif
	bool power_cable_present;
	bool cable_communicated;
#ifdef CONFIG_USB_PD_RESET_CABLE
	bool reset_cable;
	bool detect_emark;
	int vswap_ret;
	...
	uint8_t pd_sink_get_sink_cap_cnt;
	uint8_t pd_source_get_sink_cap_cnt;
...
/* ALT Mode */
...
#endif /* CONFIG_KIRIN_USB_PD_ALT_MODE_DFP_SUPPORT */
	...
	bool custom_dbgacc;
#endif /* CONFIG_KIRIN_USB_PD_CUSTOM_DBGACC_SUPPORT */
...
static inline uint8_t hisi_pd_get_fix_battery_nr(pd_port_t *pd_port)
{
	return PD_SCEDB_FIX_BAT_NR(pd_port->bat_nr);
}

static inline uint8_t hisi_pd_get_swap_battery_nr(pd_port_t *pd_port)
{
...
struct pd_battery_info *hisi_pd_get_battery_info(pd_port_t *pd_port, enum pd_battery_reference ref);
/* ---- Send PD Message ----*/
