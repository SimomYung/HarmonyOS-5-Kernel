...
uint8_t hisi_pd_dpm_get_ready_reaction(pd_port_t *pd_port);
...
/* ---- Defult : Response Hw PD Request ---- */
int hisi_pd_dpm_is_during_dp(pd_port_t *pd_port);
...
int pd_dpm_ufp_attempt_discover_cable(pd_port_t *pd_port, pd_event_t *pd_event);
