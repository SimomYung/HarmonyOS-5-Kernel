...
void hisi_pe_snk_transition_to_default_exit(
		pd_port_t *pd_port, pd_event_t *pd_event);
#ifdef CONFIG_KIRIN_PD_REV30
void hisi_pe_snk_send_not_supported_entry(pd_port_t *pd_port, pd_event_t *pd_event);
void hisi_pe_snk_not_supported_received_entry(pd_port_t *pd_port, pd_event_t *pd_event);
void hisi_pe_snk_chunk_received_entry(pd_port_t *pd_port, pd_event_t *pd_event);
#ifdef CONFIG_KIRIN_PD_REV30_ALERT_REMOTE
...
#endif
void hisi_pe_snk_give_sink_cap_ext_entry(pd_port_t *pd_port, pd_event_t *pd_event);
#endif /* CONFIG_KIRIN_PD_REV30 */
