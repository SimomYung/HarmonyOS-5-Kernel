...
bool hisi_pd_get_deferred_tcp_event_ex(struct tcpc_device *tcpc, struct tcp_dpm_event *tcp_event);
bool hisi_pd_put_deferred_tcp_event_ex(struct tcpc_device *tcpc, const struct tcp_dpm_event *tcp_event);
...
enum pd_ctrl_msg_type {
	...
	/* 14-15 Reserved */
#ifdef CONFIG_HIPD_REV3_1
	PD_CTRL_DATA_RESET	= 14,
	PD_CTRL_RESET_CPL	= 15,
#else
	PD_CTRL_RESERVED_14	= 14,
	PD_CTRL_RESERVED_15	= 15,
#endif
...
static inline bool pd_event_ctrl_msg_match(
		pd_event_t *pd_event, uint8_t msg)
{
...
static inline bool pd_event_hw_msg_match(pd_event_t *pd_event, uint8_t msg)
{
	return pd_event_msg_match(pd_event, PD_EVT_HW_MSG, msg);
}

static inline bool pd_event_pe_msg_match(pd_event_t *pd_event, uint8_t msg)
{
