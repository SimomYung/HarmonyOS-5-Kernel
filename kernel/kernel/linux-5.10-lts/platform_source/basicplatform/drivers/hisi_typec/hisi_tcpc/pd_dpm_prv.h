...
static inline bool dpm_check_data_msg_event(pd_event_t *pd_event, uint8_t msg)
{
	return pd_event_data_msg_match(pd_event, msg);
}

static inline bool dpm_check_ctrl_msg_event(pd_event_t *pd_event, uint8_t msg)
{
	return pd_event_ctrl_msg_match(pd_event, msg);
}

static inline bool dpm_check_hw_msg_event(pd_event_t *pd_event, uint8_t msg)
{
	return pd_event_hw_msg_match(pd_event, msg);
}

static inline bool dpm_check_pe_msg_event(pd_event_t *pd_event, uint8_t msg)
{
	return pd_event_pe_msg_match(pd_event, msg);
}

static inline bool dpm_check_timer_msg_event(pd_event_t *pd_event, uint8_t msg)
{
	return pd_event_timer_msg_match(pd_event, msg);
}
