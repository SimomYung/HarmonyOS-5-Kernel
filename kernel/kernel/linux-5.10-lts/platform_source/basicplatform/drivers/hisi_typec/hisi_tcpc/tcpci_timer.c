...
#endif	/* CONFIG_KIRIN_PD_REV30_PPS_SOURCE */
...
#endif	/* CONFIG_KIRIN_PD_REV30_PPS_SINK */
#endif	/* CONFIG_KIRIN_PD_REV30 */
...
#ifdef CONFIG_KIRIN_TCPC_VSAFE0V_DETECT_SUPPORT
 ...
 */
static uint32_t tcpc_timer_timeout[PD_TIMER_NR] = {
#ifdef CONFIG_KIRIN_POWER_DELIVERY_SUPPORT
...
#ifdef CONFIG_KIRIN_PD_REV30
	TIMEOUT_VAL(30), /* PD_TIMER_SENDER_RESPONSE */
#else
	TIMEOUT_RANGE(24, 30), /* PD_TIMER_SENDER_RESPONSE */
#endif
	TIMEOUT_RANGE(120, 150), /* PD_TIMER_SINK_ACTIVITY */ // Todo SinkEPRKeepAlive ?
	TIMEOUT_RANGE(100, 100), /* PD_TIMER_SINK_REQUEST */
	TIMEOUT_RANGE(310, 620), /* PD_TIMER_SINK_WAIT_CAP */
	TIMEOUT_RANGE(40, 50), /* PD_TIMER_SOURCE_ACTIVITY */  // Todo
	TIMEOUT_RANGE(100, 200), /* PD_TIMER_SOURCE_CAPABILITY */
	TIMEOUT_VAL(20), /* PD_TIMER_SOURCE_START */
#ifdef CONFIG_KIRIN_PD_REV30
	TIMEOUT_VAL(100), /* PD_TIMER_VCONN_ON */ // TEST.PD.PROT.SRC.08 VCONN_Swap Response
#else
	TIMEOUT_VAL(50), /* PD_TIMER_VCONN_ON */
#endif
...
#ifdef CONFIG_KIRIN_PD_REV30
	TIMEOUT_RANGE(40, 50), /* PD_TIMER_CK_NOT_SUPPORTED */
#ifdef CONFIG_KIRIN_PD_REV30_COLLISION_AVOID
	TIMEOUT_RANGE(16, 20), /* PD_TIMER_SINK_TX */
#endif	/* CONFIG_KIRIN_PD_REV30_COLLISION_AVOID */
#ifdef CONFIG_KIRIN_PD_REV30_PPS_SOURCE
	TIMEOUT_RANGE(12000, 15000), /* PD_TIMER_SOURCE_PPS_TIMEOUT */
#endif	/* CONFIG_KIRIN_PD_REV30_PPS_SOURCE */
#endif	/* CONFIG_KIRIN_PD_REV30 */
...
#ifdef CONFIG_KIRIN_PD_REV30
#ifdef CONFIG_KIRIN_PD_REV30_COLLISION_AVOID
	TIMEOUT_VAL(5000), /* PD_TIMER_DEFERRED_EVT */
#ifdef CONFIG_KIRIN_PD_REV30_SNK_FLOW_DELAY_STARTUP
	TIMEOUT_VAL(300), /* PD_TIMER_SNK_FLOW_DELAY */
#endif	/* CONFIG_KIRIN_PD_REV30_SNK_FLOW_DELAY_STARTUP */
#endif	/* CONFIG_KIRIN_PD_REV30_COLLISION_AVOID */
#ifdef CONFIG_KIRIN_PD_REV30_PPS_SINK
	TIMEOUT_VAL(6000), /* PD_TIMER_PPS_REQUEST */
#endif	/* CONFIG_KIRIN_PD_REV30_PPS_SINK */
#endif	/* CONFIG_KIRIN_PD_REV30 */
...
#ifdef CONFIG_HISI_ADAPTER_DETECT
	TIMEOUT_VAL(400), /* TYPEC_TIMER_CC_WAITFOR_VBUS */
#endif
#ifdef CONFIG_REVERSE_CHARGE
...
#endif
#else /* CONFIG_KIRIN_POWER_DELIVERY_SUPPORT */
	/* TYPEC-RT-TIMER */
	TYPEC_RT_TIMER_SAFE0V_DLY_TOUT, /* TYPEC_RT_TIMER_SAFE0V_DELAY */
	TIMEOUT_VAL(650), /* TYPEC_RT_TIMER_SAFE0V_TOUT */
	TIMEOUT_VAL(450), /* TYPEC_RT_TIMER_SAFE5V_TOUT */
	...
	case PD_TIMER_VSAFE0V_TOUT:
		{
			...
			if (tcpc_dev->pd_port.vdf_flags & VDF_FLAGS_PD_31_CERTIFICATION_MASK)
				vbus_level_check = tcpci_check_vsafe0v(tcpc_dev, true);
			else
				vbus_level_check = !tcpci_check_vbus_valid(tcpc_dev);
			if (vbus_level_check)
				hisi_pd_put_vbus_safe0v_event(tcpc_dev);
		}
		break;
...
#ifdef CONFIG_KIRIN_PD_REV30_PPS_SINK
static enum hrtimer_restart tcpc_timer_pps_request(struct hrtimer *timer)
{
	int index = PD_TIMER_PPS_REQUEST;
	struct tcpc_device *tcpc_dev = tcpc_hrtimer_to_dev(timer, index);
...
#ifdef CONFIG_KIRIN_PD_REV30_PPS_SOURCE
static enum hrtimer_restart tcpc_timer_src_pps_timeout(struct hrtimer *timer)
{
...
#ifdef CONFIG_KIRIN_PD_REV30_COLLISION_AVOID
static enum hrtimer_restart tcpc_timer_snk_tx(struct hrtimer *timer)
{
...
static enum hrtimer_restart tcpc_timer_ck_not_support(struct hrtimer *timer)
{
...
#ifdef CONFIG_KIRIN_PD_REV30
	[PD_TIMER_CK_NOT_SUPPORTED] = tcpc_timer_ck_not_support,
#ifdef CONFIG_KIRIN_PD_REV30_COLLISION_AVOID
	[PD_TIMER_SINK_TX] = tcpc_timer_snk_tx,
#endif
#ifdef CONFIG_KIRIN_PD_REV30_PPS_SOURCE
	[PD_TIMER_SOURCE_PPS_TIMEOUT] = tcpc_timer_src_pps_timeout,
#endif
#endif
...
#ifdef CONFIG_KIRIN_PD_REV30
#ifdef CONFIG_KIRIN_PD_REV30_COLLISION_AVOID
	[PD_TIMER_DEFERRED_EVT] = tcpc_timer_deferred_evt,
#ifdef CONFIG_KIRIN_PD_REV30_SNK_FLOW_DELAY_STARTUP
	[PD_TIMER_SNK_FLOW_DELAY] = tcpc_timer_snk_flow_delay,
#endif
#endif
#ifdef CONFIG_KIRIN_PD_REV30_PPS_SINK
	[PD_TIMER_PPS_REQUEST] = tcpc_timer_pps_request,
#endif
#endif
...
int hisi_tcpc_certification_timer_pre_init(struct tcpc_device *tcpc_dev)
{
	int index;
	D("+\n");
	index = PD_TIMER_SENDER_RESPONSE;
	tcpc_timer_timeout[index] = TIMEOUT_RANGE(27, 33); /* PD_TIMER_SENDER_RESPONSE */ //TEST.PD.PROT.SRC.02 Get_Source_Cap No Request;
	index = TYPEC_TIMER_ERROR_RECOVERY;
	tcpc_timer_timeout[index] = TIMEOUT_RANGE(10, 10); /* TYPEC_TIMER_ERROR_RECOVERY */
	D("-\n");
	return 0;
}
