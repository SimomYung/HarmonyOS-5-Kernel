...
#define IPC_AOMBX0_TO_LPMCU 31 << 8
#define IPC_SET_ECLEAR    1
...
#define ipc_mbx_mid2(mdev, spc) (((mdev) << (spc)) + 0x54)
#define ipc_mbx_erecord1(mdev, spc) (((mdev) << (spc)) + 0x58)
#define ipc_mbx_erecord2(mdev, spc) (((mdev) << (spc)) + 0x5c)
#define ipc_mbx_eclear(mdev, spc) (((mdev) << (spc)) + 0x60)
#endif
