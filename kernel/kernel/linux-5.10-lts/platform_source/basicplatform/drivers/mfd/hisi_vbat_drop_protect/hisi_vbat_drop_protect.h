...
#elif defined CONFIG_HISI_VBAT_DROP_PRT_CHS
#include "hisi_vbat_drop_protect_chs.h"
#elif defined CONFIG_HISI_VBAT_DROP_PRT_XIA
#include "hisi_vbat_drop_protect_xia.h"
#endif
...
struct perf_limit_info {
	unsigned int soc_l;
	unsigned int soc_h;
	unsigned int perf_lower_limit;
};
...
struct hisi_vbat_drop_protect_dev {
	...
	struct perf_limit_info  *perf_limit;
	...
	unsigned int            perf_limit_info_num;
	int                     vbat_drop_irq;
	int                     xpu_ctrl;
};
