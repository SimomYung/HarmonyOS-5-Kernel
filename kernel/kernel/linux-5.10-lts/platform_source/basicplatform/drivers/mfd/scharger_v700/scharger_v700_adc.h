...
#define REG_DP_APP_DET_CFG        (REG_DET_TOP_CFG_REG_0_ADDR(REG_ANA_BASE))
#define DA_APP_DET_CHSEL          (BIT(REG_DET_TOP_CFG_REG_0_da_app_det_chsel_START))
#define DA_APP_DET_EN             (BIT(REG_DET_TOP_CFG_REG_0_da_app_det_en_START))
