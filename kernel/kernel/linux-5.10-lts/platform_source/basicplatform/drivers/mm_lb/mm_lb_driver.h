...
#ifdef CONFIG_MM_LB_V400
void dmc_clk_auto_gt_bypass(void);
void dmc_clk_auto_gt_enable(void);
#else
static inline void dmc_clk_auto_gt_bypass(void) { };
static inline void dmc_clk_auto_gt_enable(void) { };
#endif
