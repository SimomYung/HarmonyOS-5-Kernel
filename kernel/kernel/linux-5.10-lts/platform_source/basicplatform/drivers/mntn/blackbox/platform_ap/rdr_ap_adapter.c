...
struct rdr_exception_info_s g_einfo[] = {
	...
	{ { 0, 0 }, MODID_AP_S_NOC, MODID_AP_S_NOC, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_NOC, NOC_RESERVED, (u32)RDR_UPLOAD_YES, "ap", "ap",
	 0, 0, 0 },
	{ { 0, 0 }, MODID_AP_S_NOC_CPU_RTM, MODID_AP_S_NOC_CPU_RTM, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_NOC, NOC_CPU_RTM, (u32)RDR_UPLOAD_YES, "ap", "ap",
	 0, 0, 0 },
	{ { 0, 0 }, MODID_AP_S_NOC_PERF_STAT, MODID_AP_S_NOC_PERF_STAT, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_NOC, NOC_PERF_STAT, (u32)RDR_UPLOAD_YES, "ap", "ap",
	 0, 0, 0 },
	{ { 0, 0 }, MODID_AP_S_NOC_IPF, MODID_AP_S_NOC_IPF, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_NOC, NOC_IPF, (u32)RDR_UPLOAD_YES, "ap", "ap",
	 0, 0, 0 },
	{ { 0, 0 }, MODID_AP_S_NOC_DJTAG_M, MODID_AP_S_NOC_DJTAG_M, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_NOC, NOC_DJTAG_M, (u32)RDR_UPLOAD_YES, "ap", "ap",
	 0, 0, 0 },
	{ { 0, 0 }, MODID_AP_S_NOC_AO_TCP, MODID_AP_S_NOC_AO_TCP, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_NOC, NOC_AO_TCP, (u32)RDR_UPLOAD_YES, "ap", "ap",
	 0, 0, 0 },
	{ { 0, 0 }, MODID_AP_S_NOC_QSPI, MODID_AP_S_NOC_QSPI, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_NOC, NOC_QSPI, (u32)RDR_UPLOAD_YES, "ap", "ap",
	 0, 0, 0 },
	{ { 0, 0 }, MODID_AP_S_NOC_GICV600, MODID_AP_S_NOC_GICV600, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_NOC, NOC_GICV600, (u32)RDR_UPLOAD_YES, "ap", "ap",
	 0, 0, 0 },
	{ { 0, 0 }, MODID_AP_S_NOC_SPI3_DMA, MODID_AP_S_NOC_SPI3_DMA, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_NOC, NOC_SPI3_DMA, (u32)RDR_UPLOAD_YES, "ap", "ap",
	 0, 0, 0 },
	{ { 0, 0 }, MODID_AP_S_NOC_TOP_CSSYS, MODID_AP_S_NOC_TOP_CSSYS, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_NOC, NOC_TOP_CSSYS, (u32)RDR_UPLOAD_YES, "ap", "ap",
	 0, 0, 0 },
	{ { 0, 0 }, MODID_AP_S_NOC_IOMCU, MODID_AP_S_NOC_IOMCU, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_NOC, NOC_IOMCU, (u32)RDR_UPLOAD_YES, "ap", "ap",
	 0, 0, 0 },
	{ { 0, 0 }, MODID_AP_S_NOC_SOCP, MODID_AP_S_NOC_SOCP, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_NOC, NOC_SOCP, (u32)RDR_UPLOAD_YES, "ap", "ap",
	 0, 0, 0 },
	{ { 0, 0 }, MODID_AP_S_NOC_USB3, MODID_AP_S_NOC_USB3, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_NOC, NOC_USB3, (u32)RDR_UPLOAD_YES, "ap", "ap",
	 0, 0, 0 },
	{ { 0, 0 }, MODID_AP_S_NOC_ASP, MODID_AP_S_NOC_ASP, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_NOC, NOC_ASP, (u32)RDR_UPLOAD_YES, "ap", "ap",
	 0, 0, 0 },
	{ { 0, 0 }, MODID_AP_S_NOC_DMAC, MODID_AP_S_NOC_DMAC, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_NOC, NOC_DMAC, (u32)RDR_UPLOAD_YES, "ap", "ap",
	 0, 0, 0 },
	{ { 0, 0 }, MODID_AP_S_NOC_FFTS, MODID_AP_S_NOC_FFTS, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_NOC, NOC_FFTS, (u32)RDR_UPLOAD_YES, "ap", "ap",
	 0, 0, 0 },
	{ { 0, 0 }, MODID_AP_S_NOC_SPE, MODID_AP_S_NOC_SPE, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_NOC, NOC_SPE, (u32)RDR_UPLOAD_YES, "ap", "ap",
	 0, 0, 0 },
	{ { 0, 0 }, MODID_AP_S_NOC_MAA, MODID_AP_S_NOC_MAA, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_NOC, NOC_MAA, (u32)RDR_UPLOAD_YES, "ap", "ap",
	 0, 0, 0 },
	{ { 0, 0 }, MODID_AP_S_NOC_POWER_STAT, MODID_AP_S_NOC_POWER_STAT, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_NOC, NOC_POWER_STAT, (u32)RDR_UPLOAD_YES, "ap", "ap",
	 0, 0, 0 },
	{ { 0, 0 }, MODID_AP_S_NOC_MSPC, MODID_AP_S_NOC_MSPC, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_NOC, NOC_MSPC, (u32)RDR_UPLOAD_YES, "ap", "ap",
	 0, 0, 0 },
	{ { 0, 0 }, MODID_AP_S_NOC_LPMCU, MODID_AP_S_NOC_LPMCU, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_NOC, NOC_LPMCU, (u32)RDR_UPLOAD_YES, "ap", "ap",
	 0, 0, 0 },
	{ { 0, 0 }, MODID_AP_S_NOC_EICC, MODID_AP_S_NOC_EICC, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_NOC, NOC_EICC, (u32)RDR_UPLOAD_YES, "ap", "ap",
	 0, 0, 0 },
	{ { 0, 0 }, MODID_AP_S_NOC_SDIO, MODID_AP_S_NOC_SDIO, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_NOC, NOC_SDIO, (u32)RDR_UPLOAD_YES, "ap", "ap",
	 0, 0, 0 },
	{ { 0, 0 }, MODID_AP_S_NOC_NPU, MODID_AP_S_NOC_NPU, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_NOC, NOC_NPU, (u32)RDR_UPLOAD_YES, "ap", "ap",
	 0, 0, 0 },
	{ { 0, 0 }, MODID_AP_S_NOC_GPU, MODID_AP_S_NOC_GPU, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_NOC, NOC_GPU, (u32)RDR_UPLOAD_YES, "ap", "ap",
	 0, 0, 0 },
	{ { 0, 0 }, MODID_AP_S_NOC_ACPU, MODID_AP_S_NOC_ACPU, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_NOC, NOC_ACPU, (u32)RDR_UPLOAD_YES, "ap", "ap",
	 0, 0, 0 },
	{ { 0, 0 }, MODID_AP_S_NOC_ISP, MODID_AP_S_NOC_ISP, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_NOC, NOC_ISP, (u32)RDR_UPLOAD_YES, "ap", "ap",
	 0, 0, 0 },
	{ { 0, 0 }, MODID_AP_S_NOC_VENC, MODID_AP_S_NOC_VENC, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_NOC, NOC_VENC, (u32)RDR_UPLOAD_YES, "ap", "ap",
	 0, 0, 0 },
	{ { 0, 0 }, MODID_AP_S_NOC_VDEC, MODID_AP_S_NOC_VDEC, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_NOC, NOC_VDEC, (u32)RDR_UPLOAD_YES, "ap", "ap",
	 0, 0, 0 },
	{ { 0, 0 }, MODID_AP_S_NOC_DSS, MODID_AP_S_NOC_DSS, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_NOC, NOC_DSS, (u32)RDR_UPLOAD_YES, "ap", "ap",
	 0, 0, 0 },
	{ { 0, 0 }, MODID_AP_S_NOC_MEDIA, MODID_AP_S_NOC_MEDIA, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_NOC, NOC_MEDIA, (u32)RDR_UPLOAD_YES, "ap", "ap",
	 0, 0, 0 },
	{ { 0, 0 }, MODID_AP_S_NOC_IDI2AXI, MODID_AP_S_NOC_IDI2AXI, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_NOC, NOC_IDI2AXI, (u32)RDR_UPLOAD_YES, "ap", "ap",
	 0, 0, 0 },
	{ { 0, 0 }, MODID_AP_S_NOC_MUDP, MODID_AP_S_NOC_MUDP, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_NOC, NOC_MUDP, (u32)RDR_UPLOAD_YES, "ap", "ap",
	 0, 0, 0 },
	{ { 0, 0 }, MODID_AP_S_NOC_SYSCACHE, MODID_AP_S_NOC_SYSCACHE, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_NOC, NOC_SYSCACHE, (u32)RDR_UPLOAD_YES, "ap", "ap",
	 0, 0, 0 },
	{ { 0, 0 }, MODID_AP_S_NOC_MODEM, MODID_AP_S_NOC_MODEM, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_NOC, NOC_MODEM, (u32)RDR_UPLOAD_YES, "ap", "ap",
	 0, 0, 0 },
	{ { 0, 0 }, MODID_AP_S_NOC_MID_MSG, MODID_AP_S_NOC_MID_MSG, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_NOC, NOC_MID_MSG, (u32)RDR_UPLOAD_YES, "ap", "ap",
	 0, 0, 0 },
	{ { 0, 0 }, MODID_AP_S_NOC_DFA, MODID_AP_S_NOC_DFA, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_NOC, NOC_DFA, (u32)RDR_UPLOAD_YES, "ap", "ap",
	 0, 0, 0 },
	{ { 0, 0 }, MODID_AP_S_NOC_PCIE, MODID_AP_S_NOC_PCIE, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_NOC, NOC_PCIE, (u32)RDR_UPLOAD_YES, "ap", "ap",
	 0, 0, 0 },
	{ { 0, 0 }, MODID_AP_S_NOC_TEE, MODID_AP_S_NOC_TEE, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_NOC, NOC_TEE, (u32)RDR_UPLOAD_YES, "ap", "ap",
	 0, 0, 0 },
#else
	{ { 0, 0 }, MODID_AP_S_NOC, MODID_AP_S_NOC, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	...
	{ { 0, 0 }, MODID_AP_S_DDRC_SEC, MODID_AP_S_DDRC_SEC, RDR_ERR,
	 ...
	 "ap", 0, 0, 0 },
#ifdef CONFIG_SEC_REGION_MNTN
	{ { 0, 0 }, MODID_DDR_SEC_CPU_RTM, MODID_DDR_SEC_CPU_RTM, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_DDRC_SEC, DDR_SEC_CPU_RTM, (u32)RDR_UPLOAD_YES, "ap",
	 "ap", 0, 0, 0 },
	{ { 0, 0 }, MODID_DDR_SEC_PERF_STAT0, MODID_DDR_SEC_PERF_STAT0, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_DDRC_SEC, DDR_SEC_PERF_STAT0, (u32)RDR_UPLOAD_YES, "ap",
	 "ap", 0, 0, 0 },
	{ { 0, 0 }, MODID_DDR_SEC_IPF, MODID_DDR_SEC_IPF, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_DDRC_SEC, DDR_SEC_IPF, (u32)RDR_UPLOAD_YES, "ap",
	 "ap", 0, 0, 0 },
	{ { 0, 0 }, MODID_DDR_SEC_DJTAG_M, MODID_DDR_SEC_DJTAG_M, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_DDRC_SEC, DDR_SEC_DJTAG_M, (u32)RDR_UPLOAD_YES, "ap",
	 "ap", 0, 0, 0 },
	{ { 0, 0 }, MODID_DDR_SEC_AO_TCP, MODID_DDR_SEC_AO_TCP, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_DDRC_SEC, DDR_SEC_AO_TCP, (u32)RDR_UPLOAD_YES, "ap",
	 "ap", 0, 0, 0 },
	{ { 0, 0 }, MODID_DDR_SEC_QSPI, MODID_DDR_SEC_QSPI, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_DDRC_SEC, DDR_SEC_QSPI, (u32)RDR_UPLOAD_YES, "ap",
	 "ap", 0, 0, 0 },
	{ { 0, 0 }, MODID_DDR_SEC_GICV600, MODID_DDR_SEC_GICV600, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_DDRC_SEC, DDR_SEC_GICV600, (u32)RDR_UPLOAD_YES, "ap",
	 "ap", 0, 0, 0 },
	{ { 0, 0 }, MODID_DDR_SEC_SPI3_DMA, MODID_DDR_SEC_SPI3_DMA, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_DDRC_SEC, DDR_SEC_SPI3_DMA, (u32)RDR_UPLOAD_YES, "ap",
	 "ap", 0, 0, 0 },
	{ { 0, 0 }, MODID_DDR_SEC_TOP_CSSYS, MODID_DDR_SEC_TOP_CSSYS, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_DDRC_SEC, DDR_SEC_TOP_CSSYS, (u32)RDR_UPLOAD_YES, "ap",
	 "ap", 0, 0, 0 },
	{ { 0, 0 }, MODID_DDR_SEC_IOMCU_M7, MODID_DDR_SEC_IOMCU_M7, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_DDRC_SEC, DDR_SEC_IOMCU_M7, (u32)RDR_UPLOAD_YES, "ap",
	 "ap", 0, 0, 0 },
	{ { 0, 0 }, MODID_DDR_SEC_SOCP, MODID_DDR_SEC_SOCP, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_DDRC_SEC, DDR_SEC_SOCP, (u32)RDR_UPLOAD_YES, "ap",
	 "ap", 0, 0, 0 },
	{ { 0, 0 }, MODID_DDR_SEC_USB3, MODID_DDR_SEC_USB3, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_DDRC_SEC, DDR_SEC_USB3, (u32)RDR_UPLOAD_YES, "ap",
	 "ap", 0, 0, 0 },
	{ { 0, 0 }, MODID_DDR_SEC_ASP_DMA_HDMI, MODID_DDR_SEC_ASP_DMA_HDMI, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_DDRC_SEC, DDR_SEC_ASP_DMA_HDMI, (u32)RDR_UPLOAD_YES, "ap",
	 "ap", 0, 0, 0 },
	{ { 0, 0 }, MODID_DDR_SEC_DMAC, MODID_DDR_SEC_DMAC, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_DDRC_SEC, DDR_SEC_DMAC, (u32)RDR_UPLOAD_YES, "ap",
	 "ap", 0, 0, 0 },
	{ { 0, 0 }, MODID_DDR_SEC_ASP_LINGLONG, MODID_DDR_SEC_ASP_LINGLONG, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_DDRC_SEC, DDR_SEC_ASP_LINGLONG, (u32)RDR_UPLOAD_YES, "ap",
	 "ap", 0, 0, 0 },
	{ { 0, 0 }, MODID_DDR_SEC_FFTS, MODID_DDR_SEC_FFTS, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_DDRC_SEC, DDR_SEC_FFTS, (u32)RDR_UPLOAD_YES, "ap",
	 "ap", 0, 0, 0 },
	{ { 0, 0 }, MODID_DDR_SEC_SPE, MODID_DDR_SEC_SPE, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_DDRC_SEC, DDR_SEC_SPE, (u32)RDR_UPLOAD_YES, "ap",
	 "ap", 0, 0, 0 },
	{ { 0, 0 }, MODID_DDR_SEC_MAA, MODID_DDR_SEC_MAA, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_DDRC_SEC, DDR_SEC_MAA, (u32)RDR_UPLOAD_YES, "ap",
	 "ap", 0, 0, 0 },
	{ { 0, 0 }, MODID_DDR_SEC_POWER_STAT, MODID_DDR_SEC_POWER_STAT, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_DDRC_SEC, DDR_SEC_POWER_STAT, (u32)RDR_UPLOAD_YES, "ap",
	 "ap", 0, 0, 0 },
	{ { 0, 0 }, MODID_DDR_SEC_MSPC, MODID_DDR_SEC_MSPC, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_DDRC_SEC, DDR_SEC_MSPC, (u32)RDR_UPLOAD_YES, "ap",
	 "ap", 0, 0, 0 },
	{ { 0, 0 }, MODID_DDR_SEC_DDR_LPCTRL, MODID_DDR_SEC_DDR_LPCTRL, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_DDRC_SEC, DDR_SEC_DDR_LPCTRL, (u32)RDR_UPLOAD_YES, "ap",
	 "ap", 0, 0, 0 },
	{ { 0, 0 }, MODID_DDR_SEC_EICC, MODID_DDR_SEC_EICC, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_DDRC_SEC, DDR_SEC_EICC, (u32)RDR_UPLOAD_YES, "ap",
	 "ap", 0, 0, 0 },
	{ { 0, 0 }, MODID_DDR_SEC_IOMCU_DMA, MODID_DDR_SEC_IOMCU_DMA, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_DDRC_SEC, DDR_SEC_IOMCU_DMA, (u32)RDR_UPLOAD_YES, "ap",
	 "ap", 0, 0, 0 },
	{ { 0, 0 }, MODID_DDR_SEC_SDIO, MODID_DDR_SEC_SDIO, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_DDRC_SEC, DDR_SEC_SDIO, (u32)RDR_UPLOAD_YES, "ap",
	 "ap", 0, 0, 0 },
	{ { 0, 0 }, MODID_DDR_SEC_LPMCU, MODID_DDR_SEC_LPMCU, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_DDRC_SEC, DDR_SEC_LPMCU, (u32)RDR_UPLOAD_YES, "ap",
	 "ap", 0, 0, 0 },
	{ { 0, 0 }, MODID_DDR_SEC_NPU, MODID_DDR_SEC_NPU, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_DDRC_SEC, DDR_SEC_NPU, (u32)RDR_UPLOAD_YES, "ap",
	 "ap", 0, 0, 0 },
	{ { 0, 0 }, MODID_DDR_SEC_GPU, MODID_DDR_SEC_GPU, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_DDRC_SEC, DDR_SEC_GPU, (u32)RDR_UPLOAD_YES, "ap",
	 "ap", 0, 0, 0 },
	{ { 0, 0 }, MODID_DDR_SEC_FCM, MODID_DDR_SEC_FCM, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_DDRC_SEC, DDR_SEC_FCM, (u32)RDR_UPLOAD_YES, "ap",
	 "ap", 0, 0, 0 },
	{ { 0, 0 }, MODID_DDR_SEC_ISP, MODID_DDR_SEC_ISP, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_DDRC_SEC, DDR_SEC_ISP, (u32)RDR_UPLOAD_YES, "ap",
	 "ap", 0, 0, 0 },
	{ { 0, 0 }, MODID_DDR_SEC_VENC, MODID_DDR_SEC_VENC, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_DDRC_SEC, DDR_SEC_VENC, (u32)RDR_UPLOAD_YES, "ap",
	 "ap", 0, 0, 0 },
	{ { 0, 0 }, MODID_DDR_SEC_VDEC, MODID_DDR_SEC_VDEC, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_DDRC_SEC, DDR_SEC_VDEC, (u32)RDR_UPLOAD_YES, "ap",
	 "ap", 0, 0, 0 },
	{ { 0, 0 }, MODID_DDR_SEC_DSS, MODID_DDR_SEC_DSS, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_DDRC_SEC, DDR_SEC_DSS, (u32)RDR_UPLOAD_YES, "ap",
	 "ap", 0, 0, 0 },
	{ { 0, 0 }, MODID_DDR_SEC_MEDIA1, MODID_DDR_SEC_MEDIA1, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_DDRC_SEC, DDR_SEC_MEDIA1, (u32)RDR_UPLOAD_YES, "ap",
	 "ap", 0, 0, 0 },
	{ { 0, 0 }, MODID_DDR_SEC_MEDIA2, MODID_DDR_SEC_MEDIA2, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_DDRC_SEC, DDR_SEC_MEDIA2, (u32)RDR_UPLOAD_YES, "ap",
	 "ap", 0, 0, 0 },
	{ { 0, 0 }, MODID_DDR_SEC_IDI2AXI, MODID_DDR_SEC_IDI2AXI, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_DDRC_SEC, DDR_SEC_IDI2AXI, (u32)RDR_UPLOAD_YES, "ap",
	 "ap", 0, 0, 0 },
	{ { 0, 0 }, MODID_DDR_SEC_IPP_SUBSYS, MODID_DDR_SEC_IPP_SUBSYS, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_DDRC_SEC, DDR_SEC_IPP_SUBSYS, (u32)RDR_UPLOAD_YES, "ap",
	 "ap", 0, 0, 0 },
	{ { 0, 0 }, MODID_DDR_SEC_SYSTEM_CACHE, MODID_DDR_SEC_SYSTEM_CACHE, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_DDRC_SEC, DDR_SEC_SYSTEM_CACHE, (u32)RDR_UPLOAD_YES, "ap",
	 "ap", 0, 0, 0 },
	{ { 0, 0 }, MODID_DDR_SEC_MODEM, MODID_DDR_SEC_MODEM, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_DDRC_SEC, DDR_SEC_MODEM, (u32)RDR_UPLOAD_YES, "ap",
	 "ap", 0, 0, 0 },
	{ { 0, 0 }, MODID_DDR_SEC_HTS_MSG, MODID_DDR_SEC_HTS_MSG, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_DDRC_SEC, DDR_SEC_HTS_MSG, (u32)RDR_UPLOAD_YES, "ap",
	 "ap", 0, 0, 0 },
	{ { 0, 0 }, MODID_DDR_SEC_FFTS_MSG, MODID_DDR_SEC_FFTS_MSG, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_DDRC_SEC, DDR_SEC_FFTS_MSG, (u32)RDR_UPLOAD_YES, "ap",
	 "ap", 0, 0, 0 },
	{ { 0, 0 }, MODID_DDR_SEC_FFA2_MSG, MODID_DDR_SEC_FFA2_MSG, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_DDRC_SEC, DDR_SEC_FFA2_MSG, (u32)RDR_UPLOAD_YES, "ap",
	 "ap", 0, 0, 0 },
	{ { 0, 0 }, MODID_DDR_SEC_FFA1_MSG, MODID_DDR_SEC_FFA1_MSG, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_DDRC_SEC, DDR_SEC_FFA1_MSG, (u32)RDR_UPLOAD_YES, "ap",
	 "ap", 0, 0, 0 },
	{ { 0, 0 }, MODID_DDR_SEC_DFA, MODID_DDR_SEC_DFA, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_DDRC_SEC, DDR_SEC_DFA, (u32)RDR_UPLOAD_YES, "ap",
	 "ap", 0, 0, 0 },
	{ { 0, 0 }, MODID_DDR_SEC_MUDP, MODID_DDR_SEC_MUDP, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_DDRC_SEC, DDR_SEC_MUDP, (u32)RDR_UPLOAD_YES, "ap",
	 "ap", 0, 0, 0 },
	{ { 0, 0 }, MODID_DDR_SEC_PCIE, MODID_DDR_SEC_PCIE, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_DDRC_SEC, DDR_SEC_PCIE, (u32)RDR_UPLOAD_YES, "ap",
	 "ap", 0, 0, 0 },
	{ { 0, 0 }, MODID_DDR_SEC_MSPE, MODID_DDR_SEC_MSPE, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_DDRC_SEC, DDR_SEC_MSPE, (u32)RDR_UPLOAD_YES, "ap",
	 "ap", 0, 0, 0 },
#endif
	...
	{ { 0, 0 }, MODID_AP_S_PANIC_INSTRUCTION_ABORT, MODID_AP_S_PANIC_INSTRUCTION_ABORT, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_PANIC, HI_APPANIC_INSTRU_ABORT, (u32)RDR_UPLOAD_YES,
	 "ap", "ap", 0, 0, 0 },
	{ { 0, 0 }, MODID_AP_S_PANIC_DATA_ABORT, MODID_AP_S_PANIC_DATA_ABORT, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_PANIC, HI_APPANIC_DATA_ABORT, (u32)RDR_UPLOAD_YES,
	 "ap", "ap", 0, 0, 0 },
	{ { 0, 0 }, MODID_AP_S_PANIC_SERROR, MODID_AP_S_PANIC_SERROR, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_PANIC, HI_APPANIC_SERROR, (u32)RDR_UPLOAD_YES,
	 "ap", "ap", 0, 0, 0 },
	{ { 0, 0 }, MODID_AP_S_PANIC_HUNGTASK, MODID_AP_S_PANIC_HUNGTASK, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_AP, RDR_AP, RDR_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_PANIC, HI_APPANIC_HUNGTASK, (u32)RDR_UPLOAD_YES,
	 "ap", "ap", 0, 0, 0 },
#endif
};
#else
struct rdr_exception_info_s g_einfo[] = {
	{ { 0, 0 }, MODID_AP_S_PANIC, MODID_AP_S_PANIC, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_RDA_AP, RDR_RDA_AP, RDR_RDA_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_PANIC, HI_APPANIC_RESERVED, (u32)RDR_UPLOAD_YES, "ap", "ap",
	 0, 0, 0 },
	{ { 0, 0 }, MODID_AP_S_PANIC_GPU, MODID_AP_S_PANIC_GPU, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_RDA_AP, RDR_RDA_AP, RDR_RDA_AP,
	...
	{ { 0, 0 }, MODID_AP_S_DDRC_SEC, MODID_AP_S_DDRC_SEC, RDR_ERR,
	 ...
	 "ap", 0, 0, 0 },
	{ { 0, 0 }, MODID_AP_S_COMBINATIONKEY, MODID_AP_S_COMBINATIONKEY,
	 RDR_ERR, RDR_REBOOT_NOW, RDR_RDA_AP, RDR_RDA_AP, RDR_RDA_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_COMBINATIONKEY, 0, (u32)RDR_UPLOAD_YES,
	 "ap", "ap", 0, 0, 0 },
	{ { 0, 0 }, MODID_AP_S_MAILBOX, MODID_AP_S_MAILBOX, RDR_WARN,
	 RDR_REBOOT_NO, RDR_RDA_AP, 0, RDR_RDA_AP,
	 (u32)RDR_REENTRANT_DISALLOW, (u32)AP_S_MAILBOX, 0, (u32)RDR_UPLOAD_YES, "ap",
	 "ap", 0, 0, 0 },
	{ { 0, 0 }, MODID_AP_S_PMU, MODID_AP_S_PMU, RDR_ERR,
	 RDR_REBOOT_NOW, RDR_RDA_AP, RDR_RDA_AP, RDR_RDA_AP,
...
unsigned int *get_ap_trace_mem_size_tbl(unsigned int *max_len)
{
	*max_len = sizeof(g_dump_buffer_size_tbl)/sizeof(g_dump_buffer_size_tbl[0]);
	return g_dump_buffer_size_tbl;
}
...
static unsigned char *get_rdr_ap_dump_start_addr(void)
{
	...
	BB_PRINT_ERR("[%s], ap log offset is 0x%lx\n", __func__, ALIGN(sizeof(*g_rdr_ap_root), timers * SIZE_1K));
...
void save_lb_master_state_memory(void)
{
	int iret;
	unsigned int len;
	char fullpath_arr[LOG_PATH_LEN] = "";
	...
	strncat(&dst_str[len], "/lb_master_state.bin", (LOG_PATH_LEN - 1 - len));
	iret = rdr_copy_file_apend(dst_str, SRC_LB_MASTER_STATE_MEMORY);
	if (iret)
		BB_PRINT_ERR("[%s], save lb_master_state.bin error, ret = %d\n", __func__, iret);
}
#endif
...
#ifdef CONFIG_CLOCK_DFX_LOG_SAVE
void save_clock_logbuff(void)
{
	int iret;
	unsigned int len;
	char fullpath_arr[LOG_PATH_LEN] = "";
	...
	if (strncat_s(fullpath_arr, LOG_PATH_LEN,
		...
		BB_PRINT_ERR("[%s]:strncat_s fullpath fail!\n", __func__);
		return;
	}
	BB_PRINT_PN("[%s]: %s\n", __func__, fullpath_arr);
	...
	iret = memcpy_s(dst_str, LOG_PATH_LEN - 1, fullpath_arr, len + 1);
	if (iret != EOK) {
		BB_PRINT_ERR("[%s]:memcpy_s dst_str fail!\n", __func__);
		return;
	}

	if (strncat_s(&dst_str[len], LOG_PATH_LEN - len, "/clock_mntn.bin",
		strlen("/clock_mntn.bin") + 1) != EOK) {
		BB_PRINT_ERR("[%s]:strncat_s dst_str fail!\n", __func__);
		return;
	}
	iret = rdr_copy_file_apend(dst_str, CLOCK_MNTN_LOG_FILE);
	if (iret)
		BB_PRINT_ERR("[%s], save clock_mntn.bin error, ret = %d\n", __func__, iret);
}
#endif
...
#else
	g_dfx_ap_addr =
		(uintptr_t)dfx_bbox_map(g_current_info.log_addr , g_current_info.log_len);
#endif
	if (!g_dfx_ap_addr) {
