...
#define RDR_VERSION             ((RDR_SMP_FLAG << 16) | (0x207 << 0))  /* v207 2024.2.6 */

/* when RDR_BASEINFO_SIZE is modified, BOARD_COLD_START_ADDR must be modified correspondingly */
#define RDR_BASEINFO_SIZE       0x2A0
...
enum RDR_AREA_LIST {
	...
	RDR_AREA_DFA  = 0x17,
	RDR_AREA_VDEC = 0x18,
	RDR_AREA_DDR_SEC  = 0x19,
	RDR_AREA_MAXIMUM = 0x1a
};
