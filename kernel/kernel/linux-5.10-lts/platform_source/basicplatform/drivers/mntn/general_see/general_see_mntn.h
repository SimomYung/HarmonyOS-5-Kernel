...
enum hisee_msg_type {
	...
	MSPC_MSG_POWEROFF_FAIL,
	MSPC_MSG_TEE_ERR_NOTIFY,
	HISEE_TYPE_END
};
...
enum hisee_mntn_smc_cmd {
	...
	HISEE_SMC_SET_SEPLAT_STATUS, /* set seplat status */
#endif
};
...
#define MSPC_POWEROFF_ERR   IPC_CMD(OBJ_LPM3, OBJ_GENERAL_SE, CMD_NOTIFY, MSPC_MSG_POWEROFF_FAIL)
#define MSPC_TEE_ERR_NOTIFY IPC_CMD(OBJ_LPM3, OBJ_GENERAL_SE, CMD_NOTIFY, MSPC_MSG_TEE_ERR_NOTIFY)
