...
struct phy_priv {
	...
	uint32_t termctrl;
	uint32_t pll0sscgctrl;
	uint32_t pll0sscginitialr0;
	uint32_t pll0sscgcntr0;
	uint32_t pll0sscgcnt2r0;
	uint32_t txvcmctrl;
	uint32_t statictermctrl;
	uint32_t phy_para_bitmap;
	uint32_t pll0_reserved;
	uint32_t pll1_reserved;
	uint32_t rx_top_bias_sel;
	uint32_t rx_pma_dig_debug;
	uint32_t pcs_status;
