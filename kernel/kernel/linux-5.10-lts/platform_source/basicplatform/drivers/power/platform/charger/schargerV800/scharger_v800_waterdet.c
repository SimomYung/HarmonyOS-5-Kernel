 ...
 * Description: Device driver for schargerV800 waterdet
 *
...
static struct scharger_water_det *g_water_det = NULL;
...
static int is_port_water_detected(void)
{
	...
	sbu1 = scharger_v800_get_sbu1_res();
	sbu2 = scharger_v800_get_sbu2_res();
	dplus = scharger_v800_get_dp_res();
...
static void scharger_water_det_shutdown(struct platform_device *pdev)
{
}

static const struct of_device_id scharger_water_det_of_match[] = {
	{
		.compatible = "hisilicon,scharger-v800-water-detect",
		.data = NULL
	},
	{},
};
...
static struct platform_driver scharger_water_det_driver = {
	...
	.shutdown = scharger_water_det_shutdown,
	.driver = {
		.name = "scharger-v800-water-det",
		.owner = THIS_MODULE,
		.of_match_table = scharger_water_det_of_match,
	},
};
...
MODULE_DESCRIPTION("scharger v800 water det driver");