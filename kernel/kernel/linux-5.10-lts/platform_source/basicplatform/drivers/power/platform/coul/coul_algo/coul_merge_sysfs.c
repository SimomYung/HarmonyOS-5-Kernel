...
static void show_each_battery_log_head(char *buf, size_t dest_max)
{
	...
	ret = snprintf_s(buf + len, dest_max - len, dest_max - len - 1, "%s",
		"VOL_0  CUR_0  ufSOC_0  SOC_0  RM_0    FCC_0  Qmax_0  UUC_0  CC_0     ccT_0   dRC_0  "
	...
	len = strlen(buf);
	ret = snprintf_s(buf + len, dest_max - len, dest_max - len - 1, "%s",
		"VOL_1  CUR_1  ufSOC_1  SOC_1  RM_1    FCC_1  Qmax_1  UUC_1  CC_1     ccT_1   dRC_1  "
	...
	len = strlen(buf);
	ret = snprintf_s(buf + len, dest_max - len, dest_max - len - 1, "%s",
		"VOL_2  CUR_2  ufSOC_2  SOC_2  RM_2    FCC_2  Qmax_2  UUC_2  CC_2     ccT_2   dRC_2  "
