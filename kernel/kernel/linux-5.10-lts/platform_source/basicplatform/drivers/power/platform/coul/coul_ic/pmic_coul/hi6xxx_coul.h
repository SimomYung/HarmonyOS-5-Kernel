...
#elif defined(CONFIG_COUL_PMIC6X56V200)
#include "hi6556v200_coul.h"
#elif defined(CONFIG_COUL_PMIC6X55V800)
#include "hi6555v800_coul.h"
#else
#include "hi6421v900_coul.h"
#endif
...
struct coul_vbat_drop {
	unsigned int vbat_drop_en;
	unsigned int vbat_drop_th;
};
...
struct coul_device_info {
	...
	struct coul_vbat_drop vbat_drop;
	int temp_from_hkadc;
	int adc_batt_temp;
};
