...
#define MAX_REG_BIT_WIDTH 0x20
#define MAX_QIC_INTR_NAME_LEN 0x30
struct qic_tb_info {
	char *tb_name;
	u32  mmidx_num;
	u32  *start_addr_head;
...
struct qic_common_reg {
	void __iomem *lite_crg_common_ctrl1;
};
#endif
...
struct dfx_sec_qic_device {
	...
	struct qic_common_reg *common_reg;
#endif
	u32 sub_intr_number;
