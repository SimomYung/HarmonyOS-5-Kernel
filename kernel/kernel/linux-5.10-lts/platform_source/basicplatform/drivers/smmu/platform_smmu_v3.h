...
#define TG_4KB				12
#define TG_USING_4KB			1
#define TTL_USING_ZERO			0
#define NUM_PAGES			0
#define INVALID_NUM			1
#define INVALID_SCALE			0
...
#define ARM_SMMU_EVTYPER0		0x2400
#define INIT_TEST_VALUE			0xa5

/* PMU register */
#define REG_ADDR_BIT_LEN		4
#ifdef CONFIG_SMMU_PMU_TCU
#define ARM_SMMU_PMCG_SCR		0x2df8
#define FILTER_SEC_SID_BIT		30
#define FILTER_SID_SPAN			29
#define ARM_SMMU_PMCG_SMR		0x2a00
#define ARM_SMMU_PMCG_EVCNTR_BASE	0x22000
#define ARM_SMMU_PMCG_CNTENSET0_0	0x2c00
#define CNTENSET0_0_ENABLE		0xf
#define ARM_SMMU_EVTYPER_BASE		0x2400
#define ARM_SMMU_PMCG_CR		0x2e04
#define ARM_SMMU_PMCG_CAPR		0x22d88
#define ARM_SMMU_PMCG_SVR_BASE		0x22600
#define TCU_EVTID_CLK_CYCLE_CNT		0x0
#define TCU_EVTID_FROM_MASTER		0x1
#define TCU_EVTID_L1_ID_HIT_CNT		0x82
#define TCU_EVTID_L1_ID_NOHIT_CNT	0x83
#define PMCG_SVR_NUM			4
#define PMCG_EVENT_CNT_NUM		4
#endif /* CONFIG_SMMU_PMU_TCU */

#ifdef CONFIG_SMMU_PMU_TBU
#define TBU_PMU_CNT_CFG_BASE		0x2400
#define PMU_OVCAP_EN_BIT		9
#define PMU_CNT_EN_BIT			8
#define TBU_PMU_CFG_ADDR		0x2600
#define TBU_PMU_CAPR_ADDR		0x2604
#define TBU_PMU_EVSVR_BASE		0x2200
#define TBU_EVENT_CNT_NUM		4
#define TBU_EVTID_LKUP_CNT		0x80
#define TBU_EVTID_MISS_CNT		0x81
#define TBU_EVTID_LKUP_PREF_CNT		0x82
#define TBU_EVTID_MISS_PREF_CNT		0x83
#define TBU_REG_STEP_CNT		4
#endif /* CONFIG_SMMU_PMU_TBU */
...
#define PICE_9030_RESERVED_MEM_STEP	0x1000
#define PCIE_Q_REVERSED_PG_NUMS		2
/*
 * Context descriptors.
 *
...
#define CMDQ_TLBI_RANGE_SCALE_MIN	0
#define CMDQ_TLBI_RANGE_SCALE_MID	9
#define CMDQ_TLBI_RANGE_SCALE_MAX	18
...
#define CMDQ_TLBI_0_NUM_SHIFT		12
#define CMDQ_TLBI_0_SCALE_SHIFT		20
#define CMDQ_TLBI_1_TG			10
#define CMDQ_TLBI_1_TTL			8
...
#define ARM_SMMU_IRPT_TTW_RSP_ERR_PLD_0	(MM_TOP_CTL_BASE + 0x208)
#define ARM_SMMU_IRPT_TTW_RSP_ERR_PLD_1	(MM_TOP_CTL_BASE + 0x20c)
...
#define TCU_TTW_RSP_ERR_CLR		BIT(8)
...
#define TCU_MEDIA1_LOCK_ID		71
#define TCU_MEDIA2_LOCK_ID		72
#define TCU_PCIE_LOCK_ID		73
#define INVALID_LOCK_ID			-1
#define TCU_HWLOCK_MAX			4
#define TCU_VOTE_MAX			2
#define IOMCU_TCU_MEDIA1_PW_BIT		9
#define IOMCU_TCU_MEDIA2_PW_BIT		1
#define AP_TCU_MEDIA1_PW_BIT		8
#define AP_TCU_MEDIA2_PW_BIT		0
#define REG_MASK_SHIFT			16
#define TCU_HWLOCK_TIMEOUT		1000 /* 1000ms */
#endif

#define TCU_PW_OFF_DELAY_TIMES		1000 /* 1000us */
...
#define ARM_SMMU_MAX_VMIDS		(1 << 16)
	...
	enum power_mode			pw_mode;
#ifdef CONFIG_SMMU_SUPPORT_AOD
	/* AOD scenarios: mutually exclusive with IOMCU power-ops */
	struct hwspinlock		*tcu_media_hwlock;
	void				*tcu_pw_vote_reg_vbase;
	u8				pw_vote_bit[TCU_VOTE_MAX];
#endif
	/* pa reserved */
	u32				ste_base_reseved;
	atomic_t			pw_off_irpt_sync;
	struct arm_smmu_media_dump	media1_ctrl_reg_dump;
};

#ifdef CONFIG_MM_IOMMU_FAULT
struct arm_smmu_stream_data {
	u32				id;
...
#ifdef CONFIG_MM_IOMMU_FAULT
	struct device			*dev;
	struct arm_smmu_stream_data	*streams;
	bool				stall_enabled;
#endif
	u32             *sids;
	u32             num_sids;
