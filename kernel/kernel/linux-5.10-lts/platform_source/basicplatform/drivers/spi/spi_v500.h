...
#define SPI_DMA_TRANS_STAT(r) ((r) + 0x1D4)     /* exclusive dma trans stat */
#else
...
#define SPI_DMA_TRANS_STAT(r) ((r) + 0x104)     /* exclusive dma trans stat */
#endif
...
#define WAIT_FOR_COMPLETION  (HZ * 2)

// for spi5 dma sel
#define SPI_DMA_SEL_OFFSET 0x400
#define SPI_SET_PERI_DMA   0x2000200
...
struct hs_spi_controller {
	...
	int sel_dma;
	void __iomem   *actrlbase;
	bool hardware_locked;
	unsigned int spi_sleep_use_doze;
