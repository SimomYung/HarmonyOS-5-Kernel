		...
		unsigned int sect_dtsi_len)
{
	...
	break;
	default: {
		ivp_err("unsupported section type %u", image_sect->type);
		return -EINVAL;
	}
	}
		...
		struct image_section_header *sect_header)
{
	...
	(void)memset_s(sect_header, img_sect_head_len * IVP_IMAGE_MAX_SECT_NUM, 0,
		img_sect_head_len * IVP_IMAGE_MAX_SECT_NUM);
