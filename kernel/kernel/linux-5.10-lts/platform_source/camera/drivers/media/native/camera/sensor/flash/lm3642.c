...
define_kernel_flash_mutex(lm3642);
...
static int hw_lm3642_torch_brightness_set(struct led_classdev *cdev,
	...
	struct device *dev)
{
	...
	flash_ctrl->cdev_torch.brightness_set_blocking = hw_lm3642_torch_brightness_set;
