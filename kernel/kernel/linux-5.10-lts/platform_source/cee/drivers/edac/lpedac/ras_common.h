...
#define CPU_PLL_SOURCE_SHIFT  49
#define CPU_PLL_SOURCE_MASK  0x1

#define CLK_SEL_APLL 1
#define CLK_SEL_PPLL0 0
...
static struct rdr_exception_info_s cpu_edac_einfo[] = {
	...
	DEFINE_CPU_EDAC_EINFO(CPU12_CE)
	DEFINE_CPU_EDAC_EINFO(CPU12_UE)
	DEFINE_CPU_EDAC_EINFO(CPU13_CE)
	DEFINE_CPU_EDAC_EINFO(CPU13_UE)
	DEFINE_CPU_EDAC_EINFO(CPU14_CE)
	DEFINE_CPU_EDAC_EINFO(CPU14_UE)
	DEFINE_CPU_EDAC_EINFO(CPU15_CE)
	DEFINE_CPU_EDAC_EINFO(CPU15_UE)
	DEFINE_CPU_EDAC_EINFO(CPU16_CE)
	DEFINE_CPU_EDAC_EINFO(CPU16_UE)
	DEFINE_CPU_EDAC_EINFO(CPU17_CE)
	DEFINE_CPU_EDAC_EINFO(CPU17_UE)
	DEFINE_CPU_EDAC_EINFO(CPU18_CE)
	DEFINE_CPU_EDAC_EINFO(CPU18_UE)
	DEFINE_CPU_EDAC_EINFO(CPU19_CE)
	DEFINE_CPU_EDAC_EINFO(CPU19_UE)
