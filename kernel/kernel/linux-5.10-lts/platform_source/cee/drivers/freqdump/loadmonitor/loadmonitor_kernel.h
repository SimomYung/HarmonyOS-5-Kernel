...
#define DUBAI_IOCTL_GET_LITE_SIZE_INFO	_IOR(BDAT_IOC_MAGIC, 0x2e, struct lite_data_size)
#define DUBAI_IOCTL_GET_LITE_DATA_INFO	_IOC(IOC_OUT, BDAT_IOC_MAGIC, 0x2f, sizeof(struct lite_channel_data) * LITE_VOTE_DATA)
#endif
