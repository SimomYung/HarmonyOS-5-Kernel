...
enum peripheral_temp_chanel {
	...
	DETECT_PA_3_CHANEL,
	DETECT_BJEH_CHANEL,
	DETECT_TCXO_BDS_CHANEL,
	DETECT_TCXO_GNSS_CHANEL
};
...
char *peripheral_chanel[] = {
	...
	[DETECT_PA_3_CHANEL] = "pa_3",
	[DETECT_BJEH_CHANEL] = "bjeh",
	[DETECT_TCXO_BDS_CHANEL] = "tcxo_bds",
	[DETECT_TCXO_GNSS_CHANEL] = "tcxo_gnss"
};
