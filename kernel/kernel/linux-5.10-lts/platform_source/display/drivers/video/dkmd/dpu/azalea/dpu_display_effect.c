	...
	display_engine_sync_ud_fingerprint_backlight_t *param)
{
	...
	max_level = (dpufd->panel_info.dbv_max > dpufd->panel_info.bl_max) ?
		dpufd->panel_info.dbv_max : dpufd->panel_info.bl_max;
	if ((param->hbm_level < dpufd->panel_info.bl_min) ||
		(param->hbm_level > max_level) ||
		(param->current_level < dpufd->panel_info.bl_min) ||
		(param->current_level > max_level)) {
