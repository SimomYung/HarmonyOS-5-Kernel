...
{
	dpu_dvfs_enable_core_clock(true);
	dpu_legacy_direct_vote(comp->index, DPU_CORE_LEVEL_ON, false);
	composer_regulator_enable(comp_mgr);
	...
	set_reg(DPU_SDMA_DBG_CTRL0_ADDR(comp_mgr->dpu_base + DPU_SDMA_OFFSET, 0), 1, 1, 20);
	set_reg(DPU_SDMA_DBG_CTRL0_ADDR(comp_mgr->dpu_base + DPU_SDMA_OFFSET, 1), 1, 1, 20);
	set_reg(DPU_SDMA_DBG_CTRL0_ADDR(comp_mgr->dpu_base + DPU_SDMA_OFFSET, 2), 1, 1, 20);
	set_reg(DPU_SDMA_DBG_CTRL0_ADDR(comp_mgr->dpu_base + DPU_SDMA_OFFSET, 3), 1, 1, 20);
