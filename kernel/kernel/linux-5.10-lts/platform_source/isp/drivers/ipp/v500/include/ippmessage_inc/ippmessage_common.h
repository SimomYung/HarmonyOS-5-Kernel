...
typedef enum {
	...
	// UT test mode
	ENH_ONLY           = 6,
	ARFEATURE_ONLY     = 7, // same ENH_ARF(enh disable) ; liang -can delete
	MATCHER_ONLY       = 8,
	MC_ONLY            = 9,
	ARF_MATCHER        = 10, // same ENH_ARF_MATCHER(enh disable)
	MATCHER_MC         = 11,
	ARF_MATCHER_MC     = 12, // same ENH_ARF_MATCHER_MC(enh disable)
	WORK_MODULE_MAX,
} work_module_e;
