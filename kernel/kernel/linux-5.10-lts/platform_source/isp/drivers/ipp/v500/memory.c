...
unsigned int g_mem_offset[WORK_MODULE_MAX][MEM_ID_MAX] = {
	...
	[MATCHER_ONLY] = {
		[MEM_ID_CMDLST_BUF_REORDER  ] = align_up(CMDLST_BUFFER_SIZE * CMDLST_STRIPE_RDR_CMP_NUM, CVDR_ALIGN_BYTES),
		[MEM_ID_CMDLST_BUF_COMPARE  ] = align_up(CMDLST_BUFFER_SIZE * CMDLST_STRIPE_RDR_CMP_NUM, CVDR_ALIGN_BYTES),
	...
	[MC_ONLY] = {
		[MEM_ID_CMDLST_BUF_MC       ] = align_up(CMDLST_BUFFER_SIZE * CMDLST_STRIPE_MC_NUM, CVDR_ALIGN_BYTES),
	...
	[KLT_ONLY] = {
		[MEM_ID_CMDLST_BUF_KLT      ] = align_up(CMDLST_BUFFER_SIZE * CMDLST_STRIPE_KLT_NUM, CVDR_ALIGN_BYTES),
