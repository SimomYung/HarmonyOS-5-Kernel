...
#define IPP_TOP_HTS_MST_IRQ_SEL_REG        0xA0  /* hts master irq select */
...
#define IPP_TOP_JPGENC_IRQ_REG1_REG        0x10C /* IRQ related cfg register */
...
#define IPP_TOP_JPGDEC_IRQ_REG1_REG        0x18C /* IRQ related cfg register */
