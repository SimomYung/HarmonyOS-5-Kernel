...
int ipp_path_request_handler(struct msg_req_ipp_cmd_req_t *req)
{
	...
	if (global_info.klt_en == 1 && global_info.mc_en == 1) {
		cmdlst_channel_value = (1 << ACTIVE_TOKEN_NBR_EN_SHIFT);
	...
	if (global_info.klt_en == 0 && global_info.mc_en == 1) {
