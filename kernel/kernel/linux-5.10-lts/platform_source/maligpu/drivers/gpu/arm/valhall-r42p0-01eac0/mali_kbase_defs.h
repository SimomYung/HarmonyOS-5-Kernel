...
struct kbase_pm_device_data {
	...
	atomic_t cs_fault_work_flag;
	atomic_t runtime_sh_flag;
	struct workqueue_struct *sh_cs_fault_wq;
	struct work_struct sh_cs_fault_work;
#endif /* CONFIG_GPU_EWP_HEAL */
};
...
struct kbase_context_switch {
	...
	enum context_swtich_status status;
	struct mutex context_switch_mutex;
...
#ifdef CONFIG_MALI_GPU_RECLAIM
	/* context switch  */
	struct kbase_context_switch kctx_sw;
#endif
};
