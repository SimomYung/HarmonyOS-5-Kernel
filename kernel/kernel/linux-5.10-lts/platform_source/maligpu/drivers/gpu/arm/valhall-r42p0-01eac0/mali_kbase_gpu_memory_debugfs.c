...
#else
static const struct proc_ops kbasep_gpu_memory_debugfs_fops = {
	.proc_open = kbasep_gpu_memory_debugfs_open,
	.proc_read = seq_read,
...
{
	kbdev->gpu_dev_data.proc_gpu_memory_dentry = proc_create("gpu_memory", S_IRUGO,
