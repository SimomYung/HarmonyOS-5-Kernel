...
/* For OHOS,report dmd every 10 times. */
#define CS_FAULT_DMD_TIMES 10
#define CS_FAULT_DMD_PROGRESS_TIMER_TIMES 1
#else
#define CS_FAULT_DMD_TIMES 1000
#define CS_FAULT_DMD_PROGRESS_TIMER_TIMES 1
#endif
...
#define DSM_GPU_MMU_FLUSH_FAILED 922002007
...
/**
 * kbase_pm_cs_faults_proc - process cs faults worker
