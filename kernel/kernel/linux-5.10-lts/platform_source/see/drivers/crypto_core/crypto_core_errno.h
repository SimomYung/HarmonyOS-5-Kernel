 ...
 * Description: Define Crypto Core errno number.
 * Create: 2019/11/16
 */

#ifndef CRYPTO_CORE_ERRNO_H
#define CRYPTO_CORE_ERRNO_H
...
#define MSPC_LCS_EFUSE_POS_ERROR             MSPC_ERRCODE(0x4A)
#define MSPC_SET_LCS_VALUE_ERROR             MSPC_ERRCODE(0x4B)
#define MSPC_WRITE_FILE_ERROR                MSPC_ERRCODE(0x4C)
#define MSPC_REGISTER_WAKEUP_ERROR           MSPC_ERRCODE(0x4D)
#define MSPC_DISABLE_STATE_ERROR             MSPC_ERRCODE(0x4E)
#define MSPC_UNSUPPORT_PUBSSD_ERROR          MSPC_ERRCODE(0x4F)
...
#define MSPC_FACTORY_TASK_STATE_ERROR        MSPC_ERRCODE(0x0107)
#define MSPC_FACTORY_TASK_RUNNING_ERROR      MSPC_ERRCODE(0x0108)
