...
enum mspc_smc_cmd {
	...
	CRYPTO_CORE_SMC_DEV_TEST             = 0x21, /* developer test */
	MSPC_SMC_GET_RPMB_KEY_STATUS         = 0x27,
	MSPC_SMC_GET_BL2_RECORD              = 0x2B,
	MSPC_SMC_CHECK_TRANSFER_FLAG         = 0x34,
	MSPC_SMC_GET_BL2_RECORD_NUM          = 0x3D,
