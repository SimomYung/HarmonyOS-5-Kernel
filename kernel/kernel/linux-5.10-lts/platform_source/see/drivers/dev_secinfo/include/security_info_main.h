...
#define EMPOWER_CERT_BYTES               0x2000
...
#define SECURUTY_INFO_GET_ROTPK_HASH \
	_IOW(SECURITY_INFO_IOCTL_MAGIC, 4, struct dev_rotpk_hash)

#define SECURUTY_INFO_GET_UAPP_BINDFILE_POS \
	_IOW(SECURITY_INFO_IOCTL_MAGIC, 5, struct uapp_bindfile_pos)

#define SECURUTY_INFO_GET_EMPOWER_CERT_POS \
	_IOW(SECURITY_INFO_IOCTL_MAGIC, 6, struct dev_file_pos)
...
#define SECURUTY_INFO_UPDATE_ALL_NVCNT \
	_IOR(SECURITY_INFO_IOCTL_MAGIC, 13, u32)

#ifdef CONFIG_MODULE_UPDATE
#define SECURUTY_INFO_MODULE_UPDATE_VERIFY_BINDFILE \
	_IOW(SECURITY_INFO_IOCTL_MAGIC, 14, struct module_update_bindfile)

#define SECURUTY_INFO_MODULE_UPDATE_VERIFY_HASH \
	_IOW(SECURITY_INFO_IOCTL_MAGIC, 15, struct module_update_img_hash)
#endif

#define SECURUTY_INFO_UPDATE_HUK2_ENHANCE_CNT \
	_IOW(SECURITY_INFO_IOCTL_MAGIC, 16, u32)

#define SECURUTY_INFO_VERIFY_EMPOWER_CERT \
	_IOW(SECURITY_INFO_IOCTL_MAGIC, 17, struct empower_cert)
