...
static const struct ioctl_security_info_func_t g_security_info_tbl[] = {
	...
	{
		SECURUTY_INFO_GET_EMPOWER_CERT_POS,
		"get empower cert pos",
		security_info_get_empower_cert_pos,
	},
	{
	...
	{
		SECURUTY_INFO_UPDATE_ALL_NVCNT,
		"update_all_nvcnt",
		security_info_update_all_nvcnt,
	},
	{
		SECURUTY_INFO_UPDATE_HUK2_ENHANCE_CNT,
		"update_huk2_enhance_cnt",
		security_info_update_huk2_enhance_cnt,
	},
#ifdef CONFIG_MODULE_UPDATE
	{
		SECURUTY_INFO_MODULE_UPDATE_VERIFY_BINDFILE,
		"module update verify bindfile",
		module_update_verify_bindfile,
	},
	{
		SECURUTY_INFO_MODULE_UPDATE_VERIFY_HASH,
		"module update verify image hash",
		module_update_verify_hash,
	},
#endif
	{
		SECURUTY_INFO_VERIFY_EMPOWER_CERT,
		"verify empower cert",
		security_info_verify_empower_cert,
	},
};
