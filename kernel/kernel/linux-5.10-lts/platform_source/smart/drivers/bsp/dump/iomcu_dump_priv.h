...
#ifdef CONFIG_USER_DUMP_BUFFER
#ifdef CONFIG_CONTEXTHUB_QIC_ERR_IGNORE
#define SENSORHUB_DUMP_BUFF_ADDR DDR_AOD_BASE_AP
#define SENSORHUB_DUMP_BUFF_SIZE DDR_AOD_SIZE
#else
#define SENSORHUB_DUMP_BUFF_ADDR DDR_LOG_BUFF_ADDR_AP
#define SENSORHUB_DUMP_BUFF_SIZE (DDR_LOG_BUFF_SIZE + DDR_AOD_SIZE)
#endif
#else
#define SENSORHUB_DUMP_BUFF_ADDR DDR_LOG_BUFF_ADDR_AP
