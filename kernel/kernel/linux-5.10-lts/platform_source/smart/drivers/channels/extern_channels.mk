...
obj-$(CONFIG_CONTEXTHUB_LPC)   += smart_lpc/
...
obj-$(CONFIG_IO_DIE_PCIE_DEBUG) += io_die/pcie/iodie_pcie_dbg.o
obj-$(CONFIG_CONTEXTHUB_IO_DIE_PCIE) += io_die/iodie_node.o
endif
...
obj-$(CONFIG_CONTEXTHUB_IO_DIE_PCIE) += io_die/pcie/iodie_pcie_sync.o
ifeq ($(CONFIG_DFX_DEBUG_FS),y)
obj-$(CONFIG_CONTEXTHUB_IO_DIE_PCIE) += io_die/pcie/iodie_pcie_test.o
obj-$(CONFIG_CONTEXTHUB_IO_DIE_PCIE) += io_die/pcie/iodie_rdv_dbg.o
endif
obj-$(CONFIG_CONTEXTHUB_IO_DIE_HIPHYIO) += io_die/hiphyio/iodie_intr_hub.o
obj-$(CONFIG_CONTEXTHUB_IO_DIE_HIPHYIO) += io_die/hiphyio/iodie_dev.o
obj-$(CONFIG_CONTEXTHUB_IO_DIE_HIPHYIO) += io_die/hiphyio/iodie_drv.o
obj-$(CONFIG_CONTEXTHUB_IO_DIE_HIPHYIO) += io_die/hiphyio/iodie_hiphyio_hal.o
ifeq ($(CONFIG_DFX_DEBUG_FS),y)
obj-$(CONFIG_CONTEXTHUB_IO_DIE_HIPHYIO) += io_die/hiphyio/iodie_hiphyio_debug.o
obj-$(CONFIG_CONTEXTHUB_IO_DIE_HIPHYIO) += io_die/iodie_rdv.o
endif