...
enum dtsi_ddr_prop_num {
	...
	DTSI_DDR_SENSORHUB_DUMP_BUFF_ADDR_AP,
#endif
#ifdef CONFIG_SENSOR_DIRECT_CHANNEL_EXPAND
	DTSI_DDR_SHMEM_SDC_GRAVITY_ADDR_AP,
	DTSI_DDR_SHMEM_SDC_MAGNETIC_FIELD_UNCALIBRATED_ADDR_AP,
	DTSI_DDR_SHMEM_SDC_GEOMAGNETIC_ROTATION_VECTOR_ADDR_AP,
	DTSI_DDR_SHMEM_SDC_GYROSCOPE_UNCALIBRATED_ADDR_AP,
	DTSI_DDR_SHMEM_SDC_ACCELEROMETER_UNCALIBRATED_ADDR_AP,
	DTSI_DDR_SHMEM_SDC_ACCELEROMETER1_ADDR_AP,
	DTSI_DDR_SHMEM_SDC_GYROSCOPE1_ADDR_AP,
	DTSI_DDR_SHMEM_SDC_ACCELEROMETER2_ADDR_AP,
	DTSI_DDR_SHMEM_SDC_GYROSCOPE2_ADDR_AP,
#endif
#ifdef CONFIG_SENSOR_DIRECT_CHANNEL_EXPAND_V1
	DTSI_DDR_SHMEM_SDC_GAME_RV_ADDR_AP,
	DTSI_DDR_SHMEM_SDC_PRESSURE_ADDR_AP,
#endif
	DTSI_MAX
};
