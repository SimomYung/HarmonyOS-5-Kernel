...
#define CMD_VENC_WIRLESS_LOWDELAY_INIT  _IOW(IOC_TYPE_VENC, 0x37, struct wireless_lowdelay_init_param)
#define CMD_VENC_WIRLESS_LOWDELAY_GET_FEEDBACK_INFO _IOR(IOC_TYPE_VENC, 0x38, struct wifi_feedback_info)
