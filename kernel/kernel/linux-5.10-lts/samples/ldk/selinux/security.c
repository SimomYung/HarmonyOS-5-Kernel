...
{
	return hmsel_get_policydb();
}

void security_init_sel_struct_size(struct sel_struct_size *sel_struct)
{
	sel_struct->policydb_size	= sizeof(policydb_t);
	sel_struct->hashtab_size	= sizeof(struct hashtab_val);
	sel_struct->hashtab_node_size	= sizeof(struct hashtab_node);
	sel_struct->symtab_size		= sizeof(symtab_t);
	sel_struct->class_datum_size	= sizeof(struct class_datum);
	sel_struct->common_datum_size	= sizeof(struct common_datum);
	sel_struct->constraint_node_size	= sizeof(struct constraint_node);
	sel_struct->constraint_expr_size	= sizeof(struct constraint_expr);
	sel_struct->type_set_size	= sizeof(struct type_set);
	sel_struct->ebitmap_node_size	= sizeof(struct ebitmap_node);
	sel_struct->ebitmap_size	= sizeof(struct ebitmap);
	sel_struct->role_datum_size	= sizeof(struct role_datum);
	sel_struct->user_datum_size	= sizeof(struct user_datum);
	sel_struct->type_datum_size	= sizeof(struct type_datum);
	sel_struct->cond_bool_datum_size	= sizeof(struct cond_bool_datum);
	sel_struct->avtab_key_size	= sizeof(struct avtab_key);
	sel_struct->avtab_ext_perms_size	= sizeof(struct avtab_extended_perms);
	sel_struct->avtab_datum_size	= sizeof(struct avtab_datum);
	sel_struct->avtab_node_size	= sizeof(struct avtab_node);
	sel_struct->avtab_size		= sizeof(struct avtab);
	sel_struct->role_trans_size	= sizeof(struct role_trans);
	sel_struct->role_allow_size	= sizeof(struct role_allow);
	sel_struct->context_size	= sizeof(struct context_struct);
	sel_struct->ocontext_size	= sizeof(struct ocontext);
	sel_struct->genfs_size		= sizeof(struct genfs);
	sel_struct->mls_level_size	= sizeof(struct mls_level);
	sel_struct->mls_range_size	= sizeof(struct mls_range);
	sel_struct->cond_node_size	= sizeof(struct cond_node);
	sel_struct->cond_expr_size	= sizeof(struct cond_expr);
	sel_struct->cond_av_list_size	= sizeof(struct cond_av_list);
}
