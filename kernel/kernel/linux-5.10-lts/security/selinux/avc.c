...
/*
 * Use this macro for isolation so that only hlist related to avc.c
 * will be protected by PAC.
 */
#define PAC_PROTECT_HLIST
...
#ifdef CONFIG_ARM64_PTR_AUTH_DATA_PTR
	*avc = pauth_pacda(&selinux_avc, avc);
#else
	*avc = &selinux_avc;
#endif
}
