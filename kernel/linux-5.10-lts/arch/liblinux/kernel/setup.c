...
int  __init init_eaccess(const char *filename) { return -ENOENT; }
...
int __init init_chdir(const char *filename) { return 0; }
int __init init_chroot(const char *filename) { return 0; }
int __init init_mknod(const char *filename, umode_t mode, unsigned int dev) { return 0; }
int __init init_mount(const char *dev_name, const char *dir_name,
		const char *type_page, unsigned long flags, void *data_page) { return 0; }
int __init init_unlink(const char *pathname) { return 0; }
