...
static pcs_trace_conf g_pcs_conf_table_linkup_phyv2[] = {
    // reg_trace_trigger_port_sel lane num set by caller
    { 0x904, 31, 0, 0x0 },        // trigger_start_mask[31:0]
    { 0x9a4, 31, 16, 0x0 },       // trigger_start_mask[63:32]
    { 0x90c, 31, 0, 0x0 },        // start_trigger_value[31:0]
    { 0x9a8, 31, 16, 0x0 },       // start_trigger_value[63:32]
    { 0x908, 31, 0, 0x0 },        // trigger_stop_mask[31:0]
    { 0x9a4, 14, 0, 0x0 },        // trigger_stop_mask[45:32]
    { 0x910, 31, 0, 0xFFFFFFFF }, // stop_trigger_value[31:0]
    { 0x9a8, 15, 0, 0x7FFF },     // stop_trigger_value[43:32]
    { 0x900, 11, 8, 0x0 },        // reg_trace_state_sel  选择trace不同信号状态
    { 0x900, 1, 1, 0x0 },         // reg_cap_mode  0: 采满即停 1: 循环采集
    { 0x918, 31, 0, 0x0 },        // state_mask0[31:0]
    { 0x91c, 31, 0, 0x0 },        // state_mask1[31:0]
    { 0x920, 31, 0, 0x1FFFF },    // state_mask2[31:0]
    { 0x900, 7, 4, 0x0 },         // set reg_state_cnt_pulse_sel
    { 0x900, 0, 0, 0x1 },         // set reg_trace_start : 1 开始数采
    { 0x604, 2, 2, 0x0 },         // set reg_dfxclk_en : 0
    { 0x604, 2, 2, 0x1 },         // set reg_dfxclk_en : 1
    PCS_TRACE_INFO_LAST
};
