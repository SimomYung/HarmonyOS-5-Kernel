...
struct error_no_map g_wifi_error_no_map[] = {
    ...
    {909030003, "DSM_WIFI_CMD52_ERROR"},
    {909030004, "DSM_WIFI_CMD53_ERROR"},
    {909030005, "DSM_WIFI_SDIO_RESET_COMM_ERR"},
    {909030006, "DSM_WIFI_SDIO_PROBE_ATTACH_ERR"},
    {909030007, "DSM_WIFI_SDIO_FIRMWARE_DL_ERR"},
    {909030008, "DSM_WIFI_DHD_DEV_INIT_IOCTL_ERR"},
    {909030009, "DSM_WIFI_SET_PASSIVE_SCAN_ERR"},
    {909030010, "DSM_WIFI_WLC_SCAN_ERROR"},
    {909030011, "DSM_WIFI_WLC_SET_SCANSUPP_ERR"},
    {909030012, "DSM_WIFI_WLC_GET_CHANNEL_ERR"},
    {909030013, "DSM_WIFI_WLC_SCAN_RESULTS_ERR"},
    {909030014, "DSM_WIFI_WLC_DISASSOC_ERR"},
    {909030015, "DSM_WIFI_WLC_SET_SSID_ERR"},
    {909030016, "DSM_WIFI_SET_CIPHER_ERR"},
    {909030017, "DSM_WIFI_SET_KEY_MGMT_ERR"},
    {909030018, "DSM_WIFI_SET_SHAREDKEY_ERR"},
    {909030019, "DSM_WIFI_OPEN_ERROR"},
    {909030020, "DSM_WIFI_CHIPSET_DAM_WAR"},
    {909030021, "DSM_WIFI_TEM_CTRL"},
    {909030022, "DSM_WIFI_PMIC_CHECK"},
    ...
    {909030035, "DSM_1103_HALT"},
    {909030036, "DSM_WIFI_FEMERROR"},
    {909030037, "DSM_SDIO_TUNNING_ERR"},
    {909030038, "DSM_SDIO_DATA_TIMEOUT"},
    {909030039, "DSM_SDIO_CRC_ERR"},
    {909030040, "DSM_1102A_WIFI_SDIO_ERR"},
    {909030041, "DSM_MP_ONE_TWO_HALT"},
    {909030042, "DSM_1102A_DOWNLOAD_FIRMWARE"},
    {909030043, "PCIE_SWITCH_TO_SDIO_FAIL"},
    {909030044, "PCIE_SWITCH_TO_SDIO_SUCCESS"},
    {909030046, "WIFI_RF_LNA_ERROR"},
    {909030047, "DSM_WIFI_PMU_ERROR"},
    {909030048, "DSM_WIFI_SAW_ERROR"},
};
