...
/* 特性列表 */
OAL_STATIC oam_software_feature_stru g_oam_feature_list[OAM_SOFTWARE_FEATURE_BUTT] = {
    /* 特性宏ID                  特性名缩写 */
    /* 0 */
    { OAM_SF_SCAN,         "scan" },
    { OAM_SF_AUTH,         "auth" },
                            ...
                            oam_mng_ctx_stru *ctx)
{
    ...
    oam_report_mlog_enter(ul_para, pc_string, 0, 0, 0, 0);
#endif
...
#ifdef _PRE_REPORT_MLOG
    oam_report_mlog_enter(ul_para, pc_string, l_param1, 0, 0, 0);
#endif
...
#ifdef _PRE_REPORT_MLOG
    oam_report_mlog_enter(ul_para, pc_string, l_param1, l_param2, 0, 0);
#endif
    ul_ret = oam_log_print_n_param(ul_para, us_line_num,
...
#ifdef _PRE_REPORT_MLOG
    oam_report_mlog_enter(ul_para, pc_string, l_param1, l_param2, l_param3, 0);
#endif
...
#ifdef _PRE_REPORT_MLOG
    oam_report_mlog_enter(ul_para, pc_string, l_param1, l_param2, l_param3, l_param4);
#endif
    /* 参数个数为4 */
