...
#define MP16C_RX_MSDU_DSCR_LEN       48
#define MP16C_D2H_RX_RING_RESET   (MP16C_RING_RESET_NORM_DATA_FREE_RING_MASK | \
                                  MP16C_RING_RESET_SMALL_DATA_FREE_RING_MASK)
...
#define MP16C_TX_RING_INFO_LEN 16
#define MP16C_TX_RING_INFO_WORD_NUM (MP16C_TX_RING_INFO_LEN / sizeof(uint32_t))
typedef union {
    uint32_t words[MP16C_TX_RING_INFO_WORD_NUM];
    struct {
