...
typedef enum {
    ...
    HMAC_NEIGH_SUB_ID_EHT_CAPABILTIY = 199,
    HMAC_NEIGH_SUB_ID_EHT_OPERATION = 200,
    HMAC_NEIGH_SUB_ID_BASIC_MULTI_LINK = 201,
...
struct hmac_bsst_req_mode {
    uint8_t bit_candidate_list_include : 1, /* 是否包含邻居AP列表 */
              ...
              bit_link_removal_imminent : 1,        /* link是否移除，配合bit_termination_include 使用 */
              bit_rev : 2;
} DECLARE_PACKED;
