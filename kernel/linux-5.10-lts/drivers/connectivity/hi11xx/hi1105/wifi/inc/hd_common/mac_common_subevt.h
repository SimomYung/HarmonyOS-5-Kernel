...
typedef enum {
    ...
    DMAC_WLAN_CTX_EVENT_SUB_TYPE_PKT_FILTER_CMD = 29,
    ...
    DMAC_WLAN_CTX_EVENT_SUB_TYPE_UPDATE_WUR = 40,  /* STA收到wur setup resp中是accept时，更新寄存器 */
    DMAC_WLAN_CTX_EVENT_SUB_TYPE_ELP_SCAN_REQ = 41,       /* elp扫描请求 */
    DMAC_WLAN_CTX_EVENT_SUB_TYPE_EMLSR_HMAC2DMAC = 42,       /* EMLSR下发请求 */
...
typedef enum {
    ...
    DMAC_WLAN_DRX_EVENT_SUB_TYPE_RX_SNIFF_INFO,
    ...
    DMAC_WLAN_CRX_EVENT_SUB_TYPE_MLSR_LINK_SWITCH,
    DMAC_WLAN_CRX_EVENT_SUB_TYPE_EMLSR_SWITCH, /* EMLSR向HOST上报所需LINK状态 */
    DMAC_WLAN_CRX_EVENT_SUB_TYPE_MLSR_LINK_SWITCH_POST_EVENT,
    DMAC_WLAN_CRX_EVENT_SUB_TYPE_POWER_OFF_READY,
...
typedef enum {
    ...
    CUSTOM_CFGID_INI_PS_FAST_P2P_CHECK_CNT_ID,
...
typedef enum {
    ...
    CUSTOM_ACTION_NEGOTIATION_OPTIMIZATION = BIT1, /* 已废弃, 因device rom化而保留定义 */
    CUSTOM_PM_FILTER_IPV6 = BIT3,                  /* ipv6过滤开关 */
    CUSTOM_MLD_ENBALE_SINGLE_LINK = BIT4,          /* MLD 单link使能开关 */
    CUSTOM_MLD_ENBALE_EML_CAP = BIT5,              /* MLD EML能力携带开关 */
    CUSTOM_BEACON_PROTECTION = BIT6,               /* beacon保护功能开关 */
    CUSTOM_EHT_DOUBLE_WIFI_DISABLE_MLO_CAP = BIT7, /* 识别对端wifi7端管关闭MLD能力开关 */
} expand_feature_switch_enum; /* 扩展特性枚举 */

enum custom_close_filter_switch {
    CUSTOM_PKT_FILTER_CLOSE_SWITCH,
...
typedef enum {
    ...
    DMAC_MISC_SUB_TYPE_PKT_FILTER_REPORT,
#endif
