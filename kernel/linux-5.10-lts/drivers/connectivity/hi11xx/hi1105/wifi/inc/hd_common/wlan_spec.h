...
#define WLAN_AP_USER_CONNECT_EXTRA_WAIT_TIME (1200) /* APUT有用户关联场景，为保证APUT工作需要频繁回主信道，延长超时时间 */
...
/* 2.5.2 AMPDU功能 */
#define WLAN_AMPDU_RX_EHT_BUFFER_SIZE 1024 /* EHT AMPDU接收端接收缓冲区的buffer size的大小 */
#define WLAN_AMPDU_RX_HE_BUFFER_SIZE 256 /* HE AMPDU接收端接收缓冲区的buffer size的大小 */
...
#define WLAN_AMPDU_TX_EHT_MAX_NUM 1024 /* EHT最大聚合MPDU个数 */
#define WLAN_AMPDU_TX_HE_MAX_NUM 256 /* HE最大聚合MPDU个数 */
...
#define WLAN_HAL0_MULTI_BSSID_IS_EN OAL_FALSE
#define WLAN_HAL0_11BE_IS_EN OAL_TRUE
...
/* 最大支持的ML LINK数 */
#define WLAN_MAX_ML_LINK_NUM 2
#define WLAN_ML_SINGLE_RADIO 1
#define WLAN_LEGACY_ROAM_MODE 0
/* 内核支持的最大AP LINK ID数 & ML IE可声明的最大link id */
#define WLAN_MAX_AP_LINK_ID 15
/* AP携带的link info最大个数 */
#define WLAN_AP_MAX_ML_LINK_INFO_NUM 4
