...
uint32_t wal_set_stbc_cap(mac_vap_stru *mac_vap, uint32_t *params)
{
    ...
    mac_dev->st_device_cap.en_rx_stbc_is_supp = cap_value;
    mac_dev->st_device_cap.en_tx_stbc_is_supp = tx_stbc_cap;
...
uint32_t wal_set_ldpc_cap(mac_vap_stru *mac_vap, uint32_t *params)
{
    ...
    mac_dev->st_device_cap.en_ldpc_is_supp = cap_value;
...
uint32_t wal_set_txbf_cap(mac_vap_stru *mac_vap, uint32_t *params)
{
    ...
    *************************************************************/
    ...
    mac_device->st_device_cap.en_su_bfmee_is_supp = rx_switch;
    mac_device->st_device_cap.en_su_bfmer_is_supp = tx_switch;
