...
static uint32_t wal_config_sta_set_mld_key_info(mac_vap_stru *mac_vap, uint16_t len, uint8_t *param)
{
    return hmac_config_sta_set_mld_key_info(mac_vap, param);
}
#endif
#ifdef _PRE_WLAN_FEATURE_ISOLATION
...
#ifdef _PRE_WLAN_FEATURE_ML
    { WLAN_CFGID_SET_MLD_KEY_INFO, OAL_FALSE, {0}, NULL, wal_config_sta_set_mld_key_info},
#endif
#ifdef _PRE_WLAN_FEATURE_ISOLATION
