...
typedef enum {
    ...
    WAL_WIFI_FEATURE_SUPPORT_EMLSE = 8,
    WAL_WIFI_FEATURE_SUPPORT_POLAR = 9,
    WAL_WIFI_FEATURE_SUPPORT_WUR = 10,
...
#define CMD_STA_GET_MLD_INFO           "CMD_STA_GET_MLD_INFO"
#define CMD_SET_MLD_KEY_INFO           "CMD_SET_MLD_KEY_INFO"
...
#endif
#define CMD_STA_GET_MLD_INFO_LEN                  (OAL_STRLEN(CMD_STA_GET_MLD_INFO))
#define CMD_SET_MLD_KEY_INFO_LEN                  (OAL_STRLEN(CMD_SET_MLD_KEY_INFO))
