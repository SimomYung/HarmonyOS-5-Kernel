...
static int touch_driver_init(struct thp_device *tdev)
{
	...
	rc = of_property_read_u32(touch_node, "send_cmd_retry_delay_ms",
	...
	rc = of_property_read_u32(touch_node, "support_fw_xtal_switch",
	...
	rc = of_property_read_u32(touch_node, "need_extra_system_clk",
