...
#define CQ_CHN_NUM               (0x38)
#define CQ_BC_SEND_MODE          (0x3c)
#define CQ_UPDATE_MCU_IRQ_MASK   (0x40)
#define CQ_CPU_MCU_IRQ_MASK      (0x44)
#define CQ_ASID_ALLOC            (0x48)
#define CQ_ENTRY_DONE_BUF_EN     (0x4c)
#define CQ_SEM_WAIT_POLLING_MODE (0x50)
#define CQ_SUBQ_ENTRY_OS_PRES_L  (0x54)
#define CQ_SUBQ_ENTRY_OS_PRES_H  (0x58)
...
#define CQ_PCQ0_STATUS           (0x80)
#define CQ_PCQ1_STATUS           (0x84)
#define CQ_PCQ2_STATUS           (0x88)
#define CQ_PCQ3_STATUS           (0x8c)
#define CQ_HTS_EVENT_LS_ADDR_L   (0x100)
#define CQ_HTS_EVENT_LS_ADDR_H   (0x104)
#define CQ_HTS_EVENT_LS_ASID     (0x108)
...
#define CQ_ORDER_MODE_EN             (1u << CQ_ORDER_MODE_BIT)
...
#define cq_bind_mmu_lock_addr_lo(chn)  (0x2070 + (chn) * 0x100)
#define cq_bind_mmu_lock_addr_hi(chn)  (0x2074 + (chn) * 0x100)
#define cq_bind_mmu_cmd(chn)           (0x2078 + (chn) * 0x100)
#define cq_bind_mmu_cmd_done(chn)      (0x207c + (chn) * 0x100)
#define cq_bind_cmd(chn)               (0x2080 + (chn) * 0x100)
#define cq_bind_pid(chn)               (0x2084 + (chn) * 0x100)
#define cq_bind_end_flush_l2(chn)      (0x2088 + (chn) * 0x100)

#define cq_bind_status(chn)            (0x2090 + (chn) * 0x100)
...
#define CQ_IRQ_VCQ1              (0x4)

#define NO_CONSUMER_IRQ          1
#define ISSUE_QUEUE_IRQ          2

#define CQ_HTS_EVENT_CMD_START       1
#define CQ_HTS_EVENT_CMD_FINISH      1


#define HTS_EVENT_REFCNT_BASE        0x800
#define HTS_WAIT_OVERTIME            1u
#define WAIT_ENTRY_MAX_NUM           26

/* fence wait timeout mask */
#define CQ_FENCE_WAIT_OVERTIME   (1U << 1)
#define CQ_WAIT_TIMEOUT_MASK     (3U)
