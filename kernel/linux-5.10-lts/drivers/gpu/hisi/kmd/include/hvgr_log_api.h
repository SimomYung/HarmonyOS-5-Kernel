...
#define HVGR_DVFS     (uint32_t)(1U << (uint32_t)HVGR_DVFS_LOG_BIT)
...
#define HVGR_LOG_OPEN_ALL \
	...
	HVGR_SYNC | HVGR_SPEC_LOW | HVGR_FENCE | HVGR_DVFS | HVGR_HTS | HVGR_FCP)
#else
#define HVGR_LOG_OPEN_ALL \
	(HVGR_PM | HVGR_DM | HVGR_MEM | HVGR_CQ | HVGR_DATAN | HVGR_SCH | \
	HVGR_SYNC | HVGR_FENCE | HVGR_DVFS | HVGR_HTS | HVGR_FCP)
#endif
