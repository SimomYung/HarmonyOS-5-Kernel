...
enum global_service_cmd_id {
	...
	GLOBAL_CMD_ID_DSTB_SRV = 0x40,
	GLOBAL_CMD_ID_TA_CONTROL_VERSION = 0x41,
	GLOBAL_CMD_ID_INDICATOR_POWEROFF = 0x50,
...
enum teec_result {
	...
	TEEC_ERROR_VRPMB_AGENT_FAIL              = 0xFFFF7200, /* REE vrpmb agent check magic failed, maybe cache fail  */
	TEEC_ERROR_VRPMB_RW_FAIL                 = 0xFFFF7201, /* REE ssd driver rw failed                               */
	TEEC_ERROR_VRPMB_SUPER_MAC_FAILED        = 0xFFFF7202, /* vrpmb check super block mac failed                     */
	TEEC_ERROR_VRPMB_WRITE_REJECT            = 0xFFFF7203, /* reject write to vrpmb                                  */
	...
	TEE_ERROR_CA_CALLER_ACCESS_DENIED        = 0xFFFF9117, /* CA caller auth fail.                                   */
};
...
enum TEEC_LoginMethod {
	...
	TEEC_LOGIN_CONTAINER_IDENTIFY = 0x8,
