...
#define MCU_FW_VER_ID_MASK 0XC0

#define HARD_RESET_FLAG_BOOT 1
#define HARD_RESET_FLAG_APP 2

#define MCU_HC32L110_RTC_TIME_LEN				7
#define MCU_HC32L110_DATA_INFO_LEN				2
#define MCU_HC32L110_DATA_DEVICE_ID				0
#define MCU_HC32L110_DATA_FLASH_STATUS			1
#define MCU_HC32L110_FLASH_LOCK_RET_TIME		3
#define MCU_HC32L110_FLSAH_UNLOCKED				0x1A
#define MCU_HC32L110_FLSAH_LOCKED				0x1D
#define MCU_HC32L110_FLSAH_LOCK_REG				0x2A
#define MCU_HC32L110_FLSAH_LOCK_CMD			    0x01
