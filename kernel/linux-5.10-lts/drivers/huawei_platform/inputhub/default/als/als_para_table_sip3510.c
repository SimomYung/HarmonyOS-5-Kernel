...
static sip3510_als_para_table sip3510_als_para_diff_tp_color_table[] = {
	...
	{ VDE, V3, DEFAULT_TPLCD, OTHER,
		...
		501, 0, 2306, 0, 1000,          // screen-off para1: c/r/g/b/dgf
		1,                             // dgf / ratio
		31057, 0, 241, 0, 14000, // screen-off para2(ir): c/r/g/b/dgf (unused)
		100,                           // normalized atime
		1, 22, -1000, 0, 0, 2776, 12000, 0, 0, -317, 1, 20,
		8, 18823, 1000, 15368, 1000, // ratio/(target/ration)c/r/g/b
		4000, 10
		}
	},
	{ VDE, VN1, DEFAULT_TPLCD, OTHER,
		{1024, // normalized gain
		-1359, 0, 2364, 0, 1000,          // screen-off para1: c/r/g/b/dgf
		1,                             // dgf / ratio
		97, 0, 834, 0, 1000, // screen-off para2(ir): c/r/g/b/dgf (unused)
		100,                           // normalized atime
		1, 22, -1000, 0, 0, 2776, 12000, 0, 0, -317, 1, 20,
		8, 18823, 1000, 15368, 1000, // ratio/(target/ration)c/r/g/b
		4000, 10
