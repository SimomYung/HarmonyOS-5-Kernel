...
#define MODE3_SWITCH_MODE2_TIME                 40
...
#define DUMMY_ALIGHT_RATION                    140
...
#define CH5_IR_RATION_LIMIT                      5
#define CH5_IR_CHECK_LIMIT                    2000
#define IR_DARK_OFFSET                          12

#define CH2_TO_CHT_RATION                      120
#define CH5_05LUX_LIMIT                         40

#define FLK_AUTO_GAIN_OVER_FLOW_LIMIT_DATA       5
#define FLK_DATA_OFFSET                        300
#define MAX_FLK_COUNT_FOR_DOWN                8000
#define LOW_LIMIT_300                          300
#define LOW_LIMIT_800                          800
#define LOW_LIMIT_1000                        1000
#define NO_UPDATA_ALSVALID_MAX_CNT               5

#define CHECK_WHT_NUM_OF_REG                     7
#define CHECK_NO_DATA_MAX_CNT                   15
#define ALS_IT_INDEX_MAX                         8
#define ALS_GAIN_INDEX_MAX                      11
#define SY3132CS_REG_ALS_CON5_DEF_DATA        0xA3
#define REG_DEFAULT_DATA                      0x00
...
typedef struct sy3132cs_algo_t {
	...
	uint16_t last_raw_data[SY3132CS_CHANNEL_NUMBER];
