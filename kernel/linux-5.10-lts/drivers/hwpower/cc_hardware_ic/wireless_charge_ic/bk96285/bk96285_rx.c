...
static int bk96285_rx_set_half_bridge(struct bk96285_dev_info *di)
{
	...
	ret = bk96285_write_byte(di, BK96285_RX_BRIDGE_CTRL_ADDR, BK96285_RX_HALF_BRIDGE);
	ret += bk96285_write_dword_mask(di, BK96285_RX_CMD_ADDR,
		BK96285_RX_CMD_BRG_SWITCH_MASK, BK96285_RX_CMD_BRG_SWITCH_SHIFT,
		BK96285_RX_CMD_EN);
	return ret;
}
...
static int bk96285_rx_set_full_bridge(struct bk96285_dev_info *di)
{
	...
	ret = bk96285_write_byte(di, BK96285_RX_BRIDGE_CTRL_ADDR, BK96285_RX_FULL_BRIDGE);
	ret += bk96285_write_dword_mask(di, BK96285_RX_CMD_ADDR,
		BK96285_RX_CMD_BRG_SWITCH_MASK, BK96285_RX_CMD_BRG_SWITCH_SHIFT,
		BK96285_RX_CMD_EN);
	return ret;
