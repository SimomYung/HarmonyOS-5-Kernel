...
#define DPU_DFR_EFFECT_DCS_ADDR(base)                 ((base) + DACC_OFFSET + LTPO_FEATURE_BASE_ADDR + (0x68))
...
/* LTPO SEND CMD FLAG */
#define DPU_DFR_SEND_EFFECT_DCS_ADDR(base)            ((base) + DACC_OFFSET + LTPO_FEATURE_BASE_ADDR + (0x74))
#define DPU_DFR_SAFE_FRM_SET_AGAIN_ADDR(base)         ((base) + DACC_OFFSET + LTPO_FEATURE_BASE_ADDR + (0x78))
#define DPU_DFR_DACC_TE_CHECK_ADDR(base)              ((base) + DACC_OFFSET + LTPO_FEATURE_BASE_ADDR + (0x7C))
#define DPU_DFR_SEND_DCS_BY_RISCV_ADDR(base)          ((base) + DACC_OFFSET + LTPO_FEATURE_BASE_ADDR + (0x80))
#define DPU_DFR_INIT_CONFIG_ADDR(base)                ((base) + DACC_OFFSET + LTPO_FEATURE_BASE_ADDR + (0x84))
#define DPU_DFR_TE_MASK_NUM_ADDR(base)                ((base) + DACC_OFFSET + LTPO_FEATURE_BASE_ADDR + (0x88)) /* DDIC mask TE num */
#define DPU_DFR_ISR_TYPE_ADDR(base)                   ((base) + DACC_OFFSET + LTPO_FEATURE_BASE_ADDR + (0x8C))
#define DPU_DFR_DACC_RESUME_ADDR(base)                ((base) + DACC_OFFSET + LTPO_FEATURE_BASE_ADDR + (0x90))
#define DPU_DFR_TE_IDX_ADDR(base)                     ((base) + DACC_OFFSET + LTPO_FEATURE_BASE_ADDR + (0x94))
#define DPU_DFR_DACC_CMDS_ASYNC_ADDR(base)            ((base) + DACC_OFFSET + LTPO_FEATURE_BASE_ADDR + (0x98))
#define DPU_DFR_REFRESH_TYPE_ADDR(base)               ((base) + DACC_OFFSET + LTPO_FEATURE_BASE_ADDR + (0x9C))
...
#define DFR_DACC_CAPTURE_ISR_COUNT(base)              ((base) + DACC_OFFSET + LTPO_FEATURE_BASE_ADDR + DFR_DACC_DFR_DEBUG_ADDR + (0x2C))
