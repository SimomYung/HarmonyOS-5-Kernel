...
drv-y       += pfa/wan/wan.o pfa/wan/lan.o
else
...
drv-y           += dpa_om/om_msg.o dpa_om/dump.o
ifeq ($(strip $(CFG_CONFIG_MODEM_CORESIGHT)),YES)
drv-y           += dpa_om/ocd.o
else
drv-y           += dpa_om/ocd_stub.o
endif
else
drv-y           += dpa_om/om_stub.o
endif

ifeq ($(strip $(CFG_CONFIG_DPA)),YES)
drv-y           += dpa/base/agent.o
drv-y           += dpa/debugfs/debugfs.o
drv-y           += dpa/dump/dump.o
drv-y           += dpa/load/load.o
drv-y           += dpa/nmi/nmi.o
drv-y           += dpa/pm/pm.o
drv-y           += dpa/pm/hal/common.o
drv-y           += dpa/pm/wakeup.o
drv-y           += dpa/pm/rpm.o
endif
