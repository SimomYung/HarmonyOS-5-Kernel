...
static irqreturn_t dwc3_interrupt(int irq, void *_evt)
{
	...
	if (evt == NULL) {
		pr_err("%s: _evt is null, will return IRQ_NONE\n", __func__);
		return IRQ_NONE;
	}
...
static void dwc_gadget_release(struct device *dev)
{
	...
	/*
	 * When dwc3_gadget_init failed dma_alloc_coherent and return with NULL dwc->eps[0],
	 * dwc3_gadget_exit still get non-NULL gadget. This will lead to kernel oops.
	 */
