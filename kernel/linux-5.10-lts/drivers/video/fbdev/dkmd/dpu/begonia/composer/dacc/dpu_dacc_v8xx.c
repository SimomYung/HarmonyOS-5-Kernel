...
static void dpu_dacc_access_timeout_config(char __iomem *dpu_base)
{
	...
	*/
	...
	glb_cfg_ctrl_value = (int32_t)inp32(DPU_GLB_DBG_CFG_CTRL_ADDR(dpu_base + DPU_GLB0_OFFSET));
	dpu_pr_info("glb_cfg_ctrl_value = %d , addr = %#x", glb_cfg_ctrl_value,
		DPU_GLB_DBG_CFG_CTRL_ADDR(dpu_base + DPU_GLB0_OFFSET));
