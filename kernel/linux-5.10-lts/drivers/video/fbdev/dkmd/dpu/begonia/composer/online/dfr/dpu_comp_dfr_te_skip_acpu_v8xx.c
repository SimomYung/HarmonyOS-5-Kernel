...
static struct dfr_ctrl_ops g_dfr_ctrl_ops = {
	...
	.setup_irq = dfr_te_setup_irq,
	.release_irq = dfr_te_release_irq,
	.switch_frm_rate = dfr_te_skip_acpu_switch_frm_rate,
	...
	/* PC */
	.send_dcs_cmds_with_frm = dfr_te_skip_acpu_set_backlight,
};
