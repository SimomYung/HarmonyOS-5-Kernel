...
#define LPM_NOOP_WORK_INTERVAL 1000 /* 1s */
...
#define LPM_SHUTDOWN_SOC_TH    3
#define LPM_SHUTDOWN_CUR_TH    150
...
struct low_power_dev {
	...
	struct notifier_block soc_battery_nb;
