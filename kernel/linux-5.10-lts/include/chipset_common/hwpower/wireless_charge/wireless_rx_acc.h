...
#define WLRX_ACC_REPORT_UPGRADE_TIMES      12
...
static inline struct wlrx_acc_tx_fan_speed *wlrx_acc_get_tx_fan_speed(unsigned int drv_type)
{
	return NULL;
}
...
static inline void wlrx_acc_update_trx_plim_para(unsigned int drv_type, struct wlrx_pctrl *pctrl)
{
}
