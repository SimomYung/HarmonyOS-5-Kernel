...
enum iterm_para_info {
	ITERM_PARA_TEMP_MIN = 0,
	ITERM_PARA_TEMP_MAX,
	ITERM_PARA_TEMP_ICHG,
	ITERM_PARA_TOTAL,
};

struct charge_iterm_data {
	int itemp_min;
	int itemp_max;
	int iterm_temp;
};
...
struct charge_core_info {
	struct device *dev;
	struct charge_iterm_data iterm_para[TEMP_PARA_LEVEL];
