...
#define WL_TX_DEV_NO_BUFF                4
#define TX_ERR_HIVIEW_INFO_LEN           2
#define WL_TX_CLEAR_EVENT_DATA           0
...
enum wireless_dsm_tx_err_type {
	WL_TX_DSM_TX_ERR_FOD = 0,
	WL_TX_DSM_TX_ERR_PING_TIMEOUT,
	WL_TX_DSM_TX_ERR_TOTAL,
};
...
struct wltx_aux_dev_info {
	...
	unsigned int support_keyboard_slot;
