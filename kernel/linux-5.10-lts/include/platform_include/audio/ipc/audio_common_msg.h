...
enum audio_cmd_voice_volume_mode_enum {
    AI_VOICE_TTS_RX = 0,
    AI_VOICE_TTS_TX = 1,
    AI_VOICE_SPKOUT = 2,
    AI_VOICE_MICIN = 3,
...
struct audio_cmd_set_ai_voice_volume_msg {
    unsigned short msg_id;
    unsigned short ai_voice_volume_mode;  // 0:TTS_RX; 1:TTS_TX; 2:SPKOUT; 3:MICIN; else:invalid
    unsigned int ai_voice_volume; // range: 0-32767
};
