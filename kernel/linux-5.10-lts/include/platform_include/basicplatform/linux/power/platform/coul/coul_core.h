...
struct smartstar_coul_device {
	...
	struct delayed_work uefi_coul_ocv_cali_dsm_delayed_work;
	...
	char sn[BATT_SN_LEN];
	int fake_coul_enable;
	int fake_coul_current_enable;
	int fake_coul_max_current_th;
