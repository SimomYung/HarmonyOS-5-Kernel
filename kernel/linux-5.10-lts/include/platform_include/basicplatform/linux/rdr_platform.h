...
typedef enum {
	...
	MODID_AP_S_PANIC_INSTRUCTION_ABORT = 0x80000038,
	MODID_AP_S_PANIC_DATA_ABORT = 0x80000039,
	MODID_AP_S_PANIC_SERROR = 0x8000003a,
	MODID_AP_S_PANIC_HUNGTASK = 0x8000003b,
	...
	MODID_AP_S_CPU12_CE    = 0x80000068,
	MODID_AP_S_CPU12_UE    = 0x80000069,
	MODID_AP_S_CPU13_CE    = 0x8000006a,
	MODID_AP_S_CPU13_UE    = 0x8000006b,
	MODID_AP_S_CPU14_CE    = 0x8000006c,
	MODID_AP_S_CPU14_UE    = 0x8000006d,
	MODID_AP_S_CPU15_CE    = 0x8000006e,
	MODID_AP_S_CPU15_UE    = 0x8000006f,
	MODID_AP_S_CPU16_CE    = 0x80000070,
	MODID_AP_S_CPU16_UE    = 0x80000071,
	MODID_AP_S_CPU17_CE    = 0x80000072,
	MODID_AP_S_CPU17_UE    = 0x80000073,
	MODID_AP_S_CPU18_CE    = 0x80000074,
	MODID_AP_S_CPU18_UE    = 0x80000075,
	MODID_AP_S_CPU19_CE    = 0x80000076,
	MODID_AP_S_CPU19_UE    = 0x80000077,
	MODID_AP_S_CPU01_L2_CE    = 0x80000078,
	MODID_AP_S_CPU01_L2_UE    = 0x80000079,
	MODID_AP_S_CPU23_L2_CE    = 0x8000007a,
	MODID_AP_S_CPU23_L2_UE    = 0x8000007b,
	MODID_AP_S_L3_CE    = 0x8000007c,
	MODID_AP_S_L3_UE    = 0x8000007d,

	/* DDRC_SEC SUBTYPE REASON */
	MODID_DMSS_START        = 0x80000100,
	MODID_DMSS_END          = 0x80000200,

	/* AP_S_NOC SUBTYPE REASON */
	MODID_AP_S_NOC_CPU_RTM      = 0x80000201,
	MODID_AP_S_NOC_PERF_STAT    = 0x80000202,
	MODID_AP_S_NOC_IPF          = 0x80000203,
	MODID_AP_S_NOC_DJTAG_M      = 0x80000204,
	MODID_AP_S_NOC_AO_TCP       = 0x80000205,
	MODID_AP_S_NOC_QSPI         = 0x80000206,
	MODID_AP_S_NOC_GICV600      = 0x80000207,
	MODID_AP_S_NOC_SPI3_DMA     = 0x80000208,
	MODID_AP_S_NOC_TOP_CSSYS    = 0x80000209,
	MODID_AP_S_NOC_IOMCU        = 0x8000020A,
	MODID_AP_S_NOC_SOCP         = 0x8000020B,
	MODID_AP_S_NOC_USB3         = 0x8000020C,
	MODID_AP_S_NOC_ASP          = 0x8000020D,
	MODID_AP_S_NOC_DMAC         = 0x8000020E,
	MODID_AP_S_NOC_FFTS         = 0x8000020F,
	MODID_AP_S_NOC_SPE          = 0x80000210,
	MODID_AP_S_NOC_MAA          = 0x80000211,
	MODID_AP_S_NOC_POWER_STAT   = 0x80000212,
	MODID_AP_S_NOC_MSPC         = 0x80000213,
	MODID_AP_S_NOC_LPMCU        = 0x80000214,
	MODID_AP_S_NOC_EICC         = 0x80000215,
	MODID_AP_S_NOC_SDIO         = 0x80000216,
	MODID_AP_S_NOC_NPU          = 0x80000217,
	MODID_AP_S_NOC_GPU          = 0x80000218,
	MODID_AP_S_NOC_ACPU         = 0x80000219,
	MODID_AP_S_NOC_ISP          = 0x8000021A,
	MODID_AP_S_NOC_VENC         = 0x8000021B,
	MODID_AP_S_NOC_VDEC         = 0x8000021C,
	MODID_AP_S_NOC_DSS          = 0x8000021D,
	MODID_AP_S_NOC_MEDIA        = 0x8000021E,
	MODID_AP_S_NOC_IDI2AXI      = 0x8000021F,
	MODID_AP_S_NOC_MUDP         = 0x80000220,
	MODID_AP_S_NOC_SYSCACHE     = 0x80000221,
	MODID_AP_S_NOC_MODEM        = 0x80000222,
	MODID_AP_S_NOC_MID_MSG      = 0x80000223,
	MODID_AP_S_NOC_DFA          = 0x80000224,
	MODID_AP_S_NOC_PCIE         = 0x80000225,
	MODID_AP_S_NOC_TEE          = 0x80000226,
...
enum {
	...
	GT_WATCH_SHIPMODE = 0x05,       /* shipmode */
...
#define DFX_EXC_INFO_REGS 0
#define DFX_EXC_INFO_ESR  1
struct dfx_exc_info_func_s {
	struct pt_regs *regs;
	u8 flag;
	u64 esr;
	u64 far;
...
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(5,10,0))
static inline void set_exception_info(struct dfx_exc_info_func_s *info) {}
#else
