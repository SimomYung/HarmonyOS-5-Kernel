...
#define DSM_UFS_MPHY_CALIBRATION_INFO       925205510
#endif
#define	DSM_UFS_UIC_TRANS_BIT_ERR_EXCCED        928008029
#define	DSM_UFS_CPORT_TIMEOUT_ERR		928008030
#define	DSM_UFS_DFA_TIMEOUT_ERR		        928008031
...
#define UIC_TRANS_BITS_ERR_FACTOR  100
...
#endif
#define	UFS_UIC_TRANS_BIT_ERR_EXCCED	29
#define	UFS_CPORT_TIMEOUT_ERR		30
#define	UFS_DFA_TIMEOUT_ERR     	31
...
static inline int dsm_ufs_if_uic_err_disable(struct ufs_hba *hba){return 0; };
static inline void dsm_ufs_init(struct ufs_hba *hba) {}
static inline unsigned long dsm_ufs_if_err(struct ufs_hba *hba){return 0;}
