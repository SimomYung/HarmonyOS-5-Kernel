...
#define MQ_MAX_ENTRIES 129
#define QUEUE_EN_OFFSET 31
#define QUEUE_PRIORITY_OFFSET 28
...
#define UFS_AXI_MST_WR_OTD_LOW 0x131C
#define UFS_AXI_MST_WR_OTD_HIG 0x1320
#define UFS_AXI_MST_RD_OTD_LOW 0x1330
#define UFS_AXI_MST_RD_OTD_HIG 0x1334
#define UFS_DMA1_RX_AXI_ERR_ADDRL 0x1300
#define UFS_DMA1_RX_AXI_ERR_ADDRU 0x1304
#define UFS_DMA1_TX_AXI_ERR_ADDRL 0x1308
#define UFS_DMA1_TX_AXI_ERR_ADDRU 0x130C
#define UFS_DMA0_RX_AXI_ERR_ADDRL 0x1340
#define UFS_DMA0_RX_AXI_ERR_ADDRU 0x1344
#define UFS_DMA0_TX_AXI_ERR_ADDRL 0x1348
#define UFS_DMA0_TX_AXI_ERR_ADDRU 0x134C

#define PCTRL_PERI_STAT69 0x10EC

#define MCQ_SYNC_QUEUE_NUM 24

/* mcq dump */
#define PA_DL_IMPL_STATE 0xA011
#define DFX_RMMI_TX_SYM_STATE1 0xD205
#define DFX_RMMI_RX_SYM_STATE1 0xD208
#define PMA_TX_RATE_PWR 0x28064
#define PMA_RX_RATE_PWR 0x28474
#define PMA_TX_TERM 0x280C0
#define PMA_RX_TERM 0x284B8
#define PMA_TOP_FSM 0x20020
#define PMA_TX0_FSM 0x28020
#define PMA_RX0_FSM 0x28420
#define PMA_CS_LOCK_FLAG 0x2040C
#define PMA_API_CSR0 0x80C4
#define PMA_API_CSR1 0x80C8

/* mcq mimo addr */
#define MCQ_HW_DEFAULT_NUM 32
#define MCQ_HW_MIMO_BASE 0x400
#define MCQ_HW_MIMO_SCALE 0x40
#define MCQ_HW_SQD_BASE 0x4000
#define MCQ_HW_SQD_SCALE 0x14
#define MCQ_HW_CQD_BASE 0x4500
#define MCQ_HW_CQD_SCALE 0x8
#define MCQ_HW_CQIS_BASE 0x4600
#define MCQ_HW_CQIS_SCALE 0xC
/* MCQ capability mask */
enum {
...
enum {
	AS_ROUND_ROBIN_PRIORITY = 0x0,
	AS_STRICT_PRIORITY = 0x1
};
...
static inline void ufshcd_ring_sqtp(struct ufs_hw_queue *q)
{
	u32 next_slot = (q->sq_tp_slot % q->max_entries);
...
static inline unsigned long *mcq_tag_bitmap(struct ufs_hba *hba, int tag)
{
	return &hba->mcq_outstanding_reqs[mcq_tag_idx(tag)];
}
