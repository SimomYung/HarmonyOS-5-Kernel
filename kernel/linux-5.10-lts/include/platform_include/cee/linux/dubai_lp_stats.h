...
#if !(defined (CONFIG_DDR_CHAMAELEON) || defined (CONFIG_DDR_CRATER) || defined (CONFIG_DDR_PISCES) || defined (CONFIG_DDR_NORTHERNCROSS))
...
#if (defined (CONFIG_DDR_CHAMAELEON) || defined (CONFIG_DDR_NORTHERNCROSS))
