...
#define IOMMU_RSV_ISP_PRIVATE_MEM  (1 << 16)
#define IOMMU_RSV_ISP_SHARE_MEM    (1 << 17)
#define IOMMU_RSV_ISP_ISPCPU_MEM   (ISP_CPU  << 20)
#define IOMMU_RSV_ISP_ISPCORE_MEM  (OISP_CPU << 20)
#define IOMMU_RSV_ISP_OISP_MEM     (ISP_CORE << 20)
#endif
...
int hisp_mem_map_addr_sec(unsigned int pool, struct hisp_map_info_s *info, struct hisp_mem_info_s *mem);
