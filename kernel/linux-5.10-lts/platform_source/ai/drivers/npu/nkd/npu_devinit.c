...
{
	ffts_hw_proc_block_regist(npu_ffap1_status_hold, npu_proc_block_resource_clear, FFTS_HW_NPU);
	ffts_ffap1_clear_entry_regist(npu_ffts_clear_entry_by_taskidx, FFTS_HW_NPU);
}
