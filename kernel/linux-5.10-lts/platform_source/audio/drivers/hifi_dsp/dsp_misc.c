	...
	const unsigned char *data, unsigned int len)
{
	...
	if (msg->msg_type == SYSCACHE_QUOTA_REQUEST) {
		...
		g_request_flag[msg->mode] = false;
	}

	send_audio_syscache_quota_ack(msg->mode, msg->msg_type);
