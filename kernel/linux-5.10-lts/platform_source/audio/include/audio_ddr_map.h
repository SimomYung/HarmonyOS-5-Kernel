...
#else
#define PCM_PLAY_BUFF_USED_SIZE            0x130000
#endif
...
#define DSP_UNSEC_RESERVE_ADDR (DSP_AUDIO_EFFECT_HISTEN_PARAM_ADDR + DSP_AUDIO_EFFECT_HISTEN_PARAM_BUFF_SIZE)

#ifdef CONFIG_HIFI_MEMORY_15M
#define PCM_OM_BUFF_LOCATION             (DSP_AUDIO_EFFECT_PARAM_ADDR + DSP_AUDIO_EFFECT_PARAM_BUFF_SIZE)
#else
...
#define DRV_DSP_FLAG_DATA_RESERVED      (DRV_DSP_UART_TO_MEM_LEN_ADDR + 4)
