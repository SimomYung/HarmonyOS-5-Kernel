	...
	struct snd_kcontrol *kcontrol, int event)
{
	...
	case SND_SOC_DAPM_PRE_PMU:
		...
		snd_soc_component_update_bits_with_lock(codec, ULTR_ADC_CTRL0_REG,
			BIT(ULTR_ADC_HBFVD_BYPASS_EN_OFFSET) | mask_on_bit(ULTR_ADC_CIC_GAIN_LEN, ULTR_ADC_CIC_GAIN_OFFSET), 
			BIT(ULTR_ADC_HBFVD_BYPASS_EN_OFFSET) | (0x014 << ULTR_ADC_CIC_GAIN_OFFSET));
		break;
