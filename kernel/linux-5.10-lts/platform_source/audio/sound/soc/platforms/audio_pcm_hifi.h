...
#define PCM_DMA_BUF_MMAP_MAX_SIZE (48 * 20 * 4 * 2 * 16)
...
/* 
 * PCM_DEVICE_MAX:
 * The number of pcm devices varies depending on the platform, 
 * the value needs to use the maximum number
 */
#define PCM_DEVICE_MAX              15
