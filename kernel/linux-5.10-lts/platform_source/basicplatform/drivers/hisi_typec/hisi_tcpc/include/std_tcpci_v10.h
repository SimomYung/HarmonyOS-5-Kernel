...
#define TCPC_V10_REG_PD_VER				0x08
#define TCPC_V10_REG_PD_REVER				0x09
 ...
 * TCPC_V10_REG_TCPC_CTRL
 */
#define TCPC_V10_REG_TCPC_CTRL_EN_LOOK4CON_ALERT	(1 << 6)
...
#define TCPC_V10_REG_TRANSMIT_SET(retry_cnt, type)	(((retry_cnt) & 0x3) << 4 | (type))
