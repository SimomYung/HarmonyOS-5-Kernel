...
static struct sdhci_crg_ctrl g_zodiac_crgctrl_cfg_scout[SDHCI_ZODIAC_TIMING_MODE] = {
/*   [clk_src] [clk_dly_sample] [clk_dly_drv] [clk_div] [sample_mode] [max_clk] */
	{ 3200000, 0x1, 0x5, 0x7, 0x0, 400000 }, /* MMC_TIMING_LEGACY */
	{ 964000000, 0x6, 0x4, 0x5, 0x0, 161000000 }, /* MMC_TIMING_MMC_HS */
	{ 964000000, 0x6, 0x4, 0x5, 0x0, 161000000 }, /* MMC_TIMING_SD_HS */
	{ 964000000, 0x5, 0x5, 0x5, 0x0, 161000000 }, /* MMC_TIMING_UHS_SDR12 */
	{ 964000000, 0x5, 0x4, 0x5, 0x0, 161000000 }, /* MMC_TIMING_UHS_SDR25 */
	{ 964000000, 0x0, 0x6, 0x5, 0x0, 161000000 }, /* MMC_TIMING_UHS_SDR50 */
	{ 964000000, 0x0, 0x5, 0x5, 0x0, 161000000 }, /* MMC_TIMING_UHS_SDR104 */
	{0},                                        /* MMC_TIMING_UHS_DDR50 */
	{0},                                        /* MMC_TIMING_MMC_DDR52 */
	{ 964000000, 0x1, 0x5, 0x5, 0x0, 161000000 }, /* MMC_TIMING_MMC_HS200 */
	{0},                                        /* MMC_TIMING_MMC_HS400 */
};
...
int sdhci_zodiac_get_resource(struct platform_device *pdev, struct sdhci_host *host)
{
	...
	if (of_find_property(node, "scout_sd_timing_config", (int *)NULL)) {
		ret = memcpy_s(g_zodiac_crgctrl_cfg, sizeof(g_zodiac_crgctrl_cfg), g_zodiac_crgctrl_cfg_scout,
