...
void rdr_syserr_process_for_ap(u32 modid, u64 arg1, u64 arg2)
{
	...
	if (p_exce_info->e_exce_type == BFM_S_NATIVE_DATA_FAIL) {
		BB_PRINT_ERR("ignore BFM_S_NATIVE_DATA_FAIL, set e_exce_type to AP_S_COLDBOOT\n");
		p_exce_info->e_exce_type = AP_S_COLDBOOT;
	}
#endif
