...
static int coul_work_register(struct smartstar_coul_device *di)
{
	...
	INIT_DELAYED_WORK(&di->uefi_coul_ocv_cali_dsm_delayed_work, uefi_coul_ocv_cali_dsm_work);
	queue_delayed_work(system_power_efficient_wq,
		&di->uefi_coul_ocv_cali_dsm_delayed_work,
...
coul_cancel_work:
	...
	cancel_delayed_work(&di->uefi_coul_ocv_cali_dsm_delayed_work);
	if (di->use_nvme_manager)
		cancel_delayed_work(&di->nvme_library_work);
