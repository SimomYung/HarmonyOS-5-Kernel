...
struct urb_msg {
	...
	__u32 slot_id;
	__u32 pipe;
	__u32 is_vm_urb; /* 0: kmalloc; 1:vmalloc */
...
struct proxy_hcd_client_ops {
	...
	int (*urb_dequeue)(struct proxy_hcd_client *, struct urb *urb, struct urb_msg *);
};
...
int proxy_urb_dequeue(struct proxy_hcd *phcd, struct urb *urb, struct urb_msg *phcd_urb);
