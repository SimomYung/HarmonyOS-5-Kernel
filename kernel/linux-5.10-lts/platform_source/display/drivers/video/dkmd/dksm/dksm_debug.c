...
uint32_t g_debug_pc_dfr_backlight_with_frame = 0;
...
int32_t g_debug_wait_vactive_timeout_ms = 600;
...
module_param_named(debug_pc_dfr_backlight_with_frame, g_debug_pc_dfr_backlight_with_frame, uint, 0640);
