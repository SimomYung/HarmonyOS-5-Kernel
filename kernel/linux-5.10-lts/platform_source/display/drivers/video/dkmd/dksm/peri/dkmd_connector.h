...
struct dkmd_connector_info {
	...
	uint32_t filter_resolution_enable;
	bool support_te;
	...
	void (*get_panel_ppc_config_id_rect_info)(struct dkmd_connector_info *pinfo,
		struct dpu_ppc_config_id_rect_info *ppc_config_id_rect_info, uint32_t config_id_cnt);
	...
	int32_t (*set_device_display_timing)(struct dkmd_connector_info *pinfo, struct edid_support_timing *user_timing);
