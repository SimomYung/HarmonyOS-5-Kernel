...
static int32_t dfr_te_skip_create_cmdlist(struct dpu_comp_dfr_ctrl *dfr_ctrl, int32_t cmdlist_type)
{
	...
	cmdlist_dev_id = dpu_res_get_cmdlist_dev_id();
...
static int32_t dfr_te_skip_setup_dimming_cmdlist(struct dpu_comp_dfr_ctrl *dfr_ctrl)
{
        ...
        cmdlist_dev_id = dpu_res_get_cmdlist_dev_id();
        phy_addr = cmdlist_get_phy_addr(cmdlist_dev_id,
        ...
        phy_addr = cmdlist_get_phy_addr(dpu_res_get_cmdlist_dev_id(),
...
static void dfr_te_skip_update_timestamp(struct dpu_comp_dfr_ctrl *dfr_ctrl)
{
	...
	dpu_pr_debug("display frmId: %llu enable: %d RequestTimeNanos:%llu, cur_time:%llu, timebuf:%d,"
...
int32_t dfr_te_skip_commit(struct dpu_comp_dfr_ctrl *dfr_ctrl)
{
	...
	phy_addr = cmdlist_get_phy_addr(dpu_res_get_cmdlist_dev_id(), priv->cmdlist_scene_id, priv->active_id);
	if (phy_addr == 0) {
...
static struct dfr_ctrl_ops g_dfr_ctrl_ops = {
	...
	.enable_safe_frm_rate = dfr_te_skip_enable_safe_frm_rate,
	.disable_safe_frm_rate = dfr_te_skip_disable_safe_frm_rate,
