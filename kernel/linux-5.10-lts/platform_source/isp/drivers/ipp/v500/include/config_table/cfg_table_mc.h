...
#define MC_COOR_KPT_NUM_MAX     (3200)

typedef mc_en_cfg           mc_en_cfg_t;
typedef mc_imu_cfg          mc_imu_cfg_t;
typedef mc_mc_cfg           mc_ctrl_cfg_t;
typedef mc_threshold_cfg    mc_inlier_thld_t;
typedef mc_inlier_number    mc_inlier_number_t;
typedef mc_kpt_size         mc_kpt_size_cfg_t;
typedef mc_static_cfg2      mc_static_cfg2_t;
typedef mc_ref_prefetch_cfg mc_ref_prefetch_cfg_t;
typedef mc_cur_prefetch_cfg mc_cur_prefetch_cfg_t;
typedef mc_match_points     mc_matched_kpts_cfg_t;
typedef mc_index_cfg        mc_index_pairs_t;    
typedef mc_coordinate_cfg   mc_coordinate_cfg_t;
typedef mc_low_kpt_status   mc_low_kpt_status_t;
...
typedef struct _mc_coord_pairs_cfg_t {
	mc_coordinate_cfg_t  coordinate_cur_ref_pairs[MC_COOR_KPT_NUM_MAX];
...
typedef struct _cfg_tab_mc_t {
	...
	unsigned int           mc_coordinate_addr; // address in cmdlst_buffer
} cfg_tab_mc_t;
