...
#define VDEC_SEG_BUF_ONE_BLOCK_SIZE (8 * 1024 * 1024)
#define VDEC_SEG_BUF_TOTAL_SIZE (128 * 1024 * 1024)

// mcu, size:8M
#define VDEC_MCU_BASE (vdec_plat_reserved_ion_base() + 0x9000000)
#define VDEC_MCU_SIZE (9 * 1024 * 1024)

// ringbuffer, size:32M
#define VDEC_BSP_RING_BUFFER_BASE (vdec_plat_reserved_ion_base() + 0xA000000)
#define BSP_CTU_INFO_RING_SIZE (9 * 1024 * 1024)
#define BSP_CTU_RES_RING_SIZE  (7 * 1024 * 1024)
#define VDEC_BSP_RING_BUFFER_SIZE (2 * (BSP_CTU_INFO_RING_SIZE + BSP_CTU_RES_RING_SIZE))

// msg pool, size:8M
#define VDEC_MSG_POOL_BASE  (vdec_plat_reserved_ion_base() + 0xD000000)
#define VDEC_MSG_POOL_SIZE  (8 * 1024 * 1024)

// bsp sw, size:14K
#define BSP_SW_BUFFER_BASE     (vdec_plat_reserved_ion_base() + 0xE000000)
#define BSP_SW_BUFFER_SIZE     (16 * 1024)

// heap, size:128M
#define VDEC_MCU_HEAP_BASE (vdec_plat_reserved_ion_base() + 0x10000000)
#define VDEC_MCU_HEAP_ONE_BLOCK_SIZE (8 * 1024 * 1024)
...
#define OUTPUT_MSG_QUEUE_SIZE     (OUTPUT_MSG_QUEUE_ONE_CHAN_SIZE * 16)
