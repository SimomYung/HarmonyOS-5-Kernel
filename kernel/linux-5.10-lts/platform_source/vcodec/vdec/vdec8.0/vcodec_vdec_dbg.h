...
#define DBG_TIMER_SATRT() uint64_t _start_time_ = vcodec_osal_get_time_in_us()
#define DBG_TIMER_RESATRT() _start_time_ = vcodec_osal_get_time_in_us()
#define DBG_TIMER_SHOW(msg) dprint(PRN_ALWS, "%s spend time: %lld", msg, vcodec_osal_get_time_in_us() - _start_time_)
#else
#define DBG_TIMER_SATRT()
#define DBG_TIMER_RESATRT()
#define DBG_TIMER_SHOW(msg)
#endif
