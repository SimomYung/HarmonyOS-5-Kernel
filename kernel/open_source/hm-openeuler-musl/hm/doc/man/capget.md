...
This system call is used for getting capabilities of thread whose ID is specified by *hdrp->pid*. Note that only 64-bit capability set with version \_LINUX\_CAPABILITY\_VERSION\_3 is supported.
