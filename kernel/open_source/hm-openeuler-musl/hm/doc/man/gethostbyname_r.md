...
- **h_errnop**
  If this call failed, the error number is stored in *h_errnop*.
...
- **EAGAIN**
  The parameter name is a Non-NULL string and can not find its corresponding host, *h_errnop* will be set to TRY_AGAIN.
  &nbsp;
- **ENOENT**
  The specified host is unknown, *h_errnop* will be set to HOST_NOT_FOUND.
  &nbsp;
- **ERANGE**
  If *buflen* is 0, *h_errnop* will not be set.
