...
Check to see if the wide character is an alphabetic character
...
The iswalpha() function checks to see if the wide character is an alphabetic character.
...
- **non-zero**
  This wide character is an alphabetic character.
&nbsp;
- **0**
  This wide character is not an alphabetic character.
