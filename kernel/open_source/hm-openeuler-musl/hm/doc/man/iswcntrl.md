...
Check to see if the wide character is a control character
...
The iswcntrl() function checks to see if the wide character is a control character.
...
- **non-zero**
  This wide character is a control character.
&nbsp;
- **0**
  This wide character is not a control character.
