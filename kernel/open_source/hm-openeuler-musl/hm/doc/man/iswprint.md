...
Check to see if the wide character is a printing character
...
The iswprint() function checks to see if the wide character is a printing character.
...
- **non-zero**
  This wide character is a printing character.
&nbsp;
- **0**
  This wide character is not a printing character.
