...
Check to see if the wide character is a whitespace character.
...
The iswspace() function checks to see if the wide character is a whitespace character.
...
- **non-zero**
  This wide character is a whitespace character.
&nbsp;
- **0**
  This wide character is not a whitespace character.
