...
Check to see if the wide character is a uppercase character
...
The iswupper() function checks to see if the wide character is a uppercase character.
...
- **non-zero**
  This wide character is a uppercase character.
&nbsp;
- **0**
  This wide character is not a uppercase character.
