...
Check to see if the wide character is a hexadecimal digit character
...
The iswxdigit() function checks to see if the wide character is a hexadecimal digit character.
...
- **non-zero**
  This wide character is a hexadecimal digit character.
&nbsp;
- **0**
  This wide character is not a hexadecimal digit character.
