...
&nbsp;
- **pathname**
The relative pathname in the parent directory.
&nbsp;
- **mode**
...
## Description
The function mkdirat() tries to create a directory in a parent directory.
...
&nbsp;
- **EBADF**
The parameter *dirfd* is an invalid file descriptor.
&nbsp;
- **ENOTDIR**
The parameter *dirfd* refers to an file other than a directory.
