...
&nbsp;
- **buf**
The send message is found in *buf*.
&nbsp;
- **len**
The send message has length *len*.
&nbsp;
- **flags**
...
&nbsp;
- **addrlen**
The address size of the target is given by *addrlen*.
...
- **actual bytes**
On success, these sendto() function return the number of bytes sent.
&nbsp;
- **-1**
