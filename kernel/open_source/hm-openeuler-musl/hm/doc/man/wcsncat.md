...
&nbsp;
- **n**
The number of wide characters that are needed to copy at most.

## Library
libc

## Description
wcsncat() appends at most *n* wide characters of *src* to *dest* and overwrites the terminating null wide byte (L'\0') of *dest*, finally it adds a new terminating null wide byte.
&nbsp;
