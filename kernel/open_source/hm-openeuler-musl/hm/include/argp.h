 ...
 * Author: Huawei RTOS
 * Create: Thu Oct 21 09:55:49 2021
 */
#ifndef _ARGP_H
#define _ARGP_H
...
extern int argp_parse (const struct argp *__restrict argp,
...
extern void argp_help (const struct argp *__restrict argp,
		       FILE *__restrict stream,
		       unsigned flags, char *__restrict name);
extern void argp_error (const struct argp_state *__restrict state,
			const char *__restrict fmt, ...);
extern void argp_failure (const struct argp_state *__restrict state,
