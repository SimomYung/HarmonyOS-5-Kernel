...
/*
 * NOTE:
 * This flag expect to insert random gap between mmap vregions when the feature is supported.
 * If map with fixed/expected address or Hugepage, this flag will be ignore.
 */
#define MAP_GAP        0x200
#define MAP_FILE       0
