...
/* don't call this two functions when dynamic libc, just for compiling */

static void dummy(void)
{
}

static void dummy1(char **envp)
{
}

weak_alias(dummy, hmcrt_posthook);
weak_alias(dummy1, hmcrt_prehook);

/**
 * by default, aux cnt is 32, but we need to use AT_SYSINFO which id is 32,
 * so set AUX_CNT to 38
 */
#undef AUX_CNT
#define AUX_CNT 38
