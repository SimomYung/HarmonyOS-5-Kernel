 ...
 * @brief       This API is called by the user to initialize and deinitialize the error code module and obtain
 *              error codes. Before using this API, you must register functions related to memory allocation and
 *              release. In a single-thread environment, you do not need to register functions related to threads.
 */
...
#define BSL_ERR_NEW_MODULE 0x80 // Start value of the customized level-1 error module. The value 0x80 is 128.
