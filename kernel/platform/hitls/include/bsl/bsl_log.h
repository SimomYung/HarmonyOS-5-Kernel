 ...
 * @brief       Product register releated logs function
 */
...
/**
 * @ingroup bsl_log
 * @brief   Obtain the HiTLS version number.
 * @attention The length of the received version string must be greater than or equal to HITLS_VERSION_LEN.
 * @param   version [OUT] HiTLS current version string.
 * @param   versionLen [IN/OUT] String length of the current HiTLS version.
 ...
 * @return  Level of the binlog. The value can be BSL_LOG_LEVEL_SEC、BSL_LOG_LEVEL_FATAL、BSL_LOG_LEVEL_ERR、
