...
// New algorithm Ids should be added at the end before BSL_CID_MAX
...
typedef enum {
    ...
    BSL_CID_HMAC_SHA3_224 = 349, /* identifies hmac with SHA3_224 */
    BSL_CID_HMAC_SHA3_256 = 350, /* identifies hmac with SHA3_256 */
    BSL_CID_HMAC_SHA3_384 = 351, /* identifies hmac with SHA3_384 */
    BSL_CID_HMAC_SHA3_512 = 352, /* identifies hmac with SHA3_512 */
    BSL_CID_DSAWITHSHA256 = 353, /* identifies signature using SHA256 and DSA */
    BSL_CID_DSAWITHSHA224 = 354, /* identifies signature using SHA224 and DSA */
    BSL_CID_DSAWITHSHA384 = 355, /* identifies signature using SHA384 and DSA */
    BSL_CID_DSAWITHSHA512 = 356, /* identifies signature using SHA512 and DSA */
    BSL_CID_SHA224WITHRSAENCRYPTION = 357, /* identifies signature using SHA224 and RSA */

    BSL_CID_SHA3_224 = 358,
    BSL_CID_SHA3_256 = 359,
    BSL_CID_SHA3_384 = 360,
    BSL_CID_SHA3_512 = 361,
    BSL_CID_SHAKE128 = 362,
    BSL_CID_SHAKE256 = 363,

    BSL_CID_HMAC_MD5_SHA1 = 364,
    BSL_CID_CMAC_AES128 = 365,
    BSL_CID_CMAC_AES192 = 366,
    BSL_CID_CMAC_AES256 = 367,
    BSL_CID_GMAC_AES128 = 368,
    BSL_CID_GMAC_AES192 = 369,
    BSL_CID_GMAC_AES256 = 370,

    BSL_CID_AES128_XTS = 371,
    BSL_CID_AES256_XTS = 372,
    BSL_CID_AES128_WRAP_NOPAD = 373,
    BSL_CID_AES192_WRAP_NOPAD = 374,
    BSL_CID_AES256_WRAP_NOPAD = 375,
    BSL_CID_AES128_WRAP_PAD = 376,
    BSL_CID_AES192_WRAP_PAD = 377,
    BSL_CID_AES256_WRAP_PAD = 378,
    BSL_CID_CHACHA20_POLY1305 = 379,
    BSL_CID_SM4_XTS = 380,
    BSL_CID_SM4_CTR = 381,
    BSL_CID_SM4_GCM = 382,
    BSL_CID_SM4_CFB = 383,
    ...
    BSL_CID_KDFTLS12 = 385,
    BSL_CID_HKDF = 386,

    BSL_CID_RAND_SHA1 = 387,
    BSL_CID_RAND_SHA224 = 388,
    BSL_CID_RAND_SHA256 = 389,
    BSL_CID_RAND_SHA384 = 390,
    BSL_CID_RAND_SHA512 = 391,
    BSL_CID_RAND_SM3 = 392,
    BSL_CID_RAND_HMAC_SHA1 = 393,
    BSL_CID_RAND_HMAC_SHA224 = 394,
    BSL_CID_RAND_HMAC_SHA256 = 395,
    BSL_CID_RAND_HMAC_SHA384 = 396,
    BSL_CID_RAND_HMAC_SHA512 = 397,
    BSL_CID_RAND_AES128_CTR = 398,
    BSL_CID_RAND_AES192_CTR = 399,
    BSL_CID_RAND_AES256_CTR = 400,
    BSL_CID_RAND_AES128_CTR_DF = 401,
    BSL_CID_RAND_AES192_CTR_DF = 402,
    BSL_CID_RAND_AES256_CTR_DF = 403,
    BSL_CID_RAND_SM4_CTR_DF = 404,
    ...
    BSL_CID_DH_RFC2409_768 = 409,
    BSL_CID_DH_RFC2409_1024 = 410,
    BSL_CID_DH_RFC3526_1536 = 411,
    BSL_CID_DH_RFC3526_2048 = 412,
    BSL_CID_DH_RFC3526_3072 = 413,
    BSL_CID_DH_RFC3526_4096 = 414,
    BSL_CID_DH_RFC3526_6144 = 415,
    BSL_CID_DH_RFC3526_8192 = 416,
    BSL_CID_DH_RFC7919_2048 = 417,
    BSL_CID_DH_RFC7919_3072 = 418,
    BSL_CID_DH_RFC7919_4096 = 419,
    BSL_CID_DH_RFC7919_6144 = 420,
    BSL_CID_DH_RFC7919_8192 = 421,
    BSL_CID_ECC_BRAINPOOLP256R1 = 422,
    BSL_CID_ECC_BRAINPOOLP384R1 = 423,
    BSL_CID_ECC_BRAINPOOLP512R1 = 424,
    BSL_CID_SIPHASH64 = 425,
    BSL_CID_SIPHASH128 = 426,
    // New symmetric encryption algo should be added here
    // g_oidTable should be modified accordingly

    // Netscape
    BSL_CID_NETSCAPE = 427,
    BSL_CID_NS_CERTEXT = 428,
    BSL_CID_NS_DATATYPE = 429,
    BSL_CID_NS_CERTTYPE = 430,
    BSL_CID_NS_BASEURL = 431,
    BSL_CID_NS_REVOCATIOPNURL = 432,
    BSL_CID_NS_CAREVOCATIONURL = 433,
    BSL_CID_NS_RENEWALURL = 434,
    BSL_CID_NS_CAPOLICYURL = 435,
    BSL_CID_NS_SSLSERVERNAME = 436,
    BSL_CID_NS_COMMENT = 437,
    BSL_CID_NS_CERTSEQUENCE = 438,
    BSL_CID_NS_SGC = 439,

    BSL_CID_EC192WAPI = 440,
    BSL_CID_CBC_MAC_SM4 = 441,
    BSL_CID_EC_PUBLICKEY = 442,  /* identifies EC_PUBLICKEY */

    BSL_CID_HARDWAREMODULENAME = 443,
...
/**
  * @ingroup bsl_obj
  * @brief To get the common ID of a given OID.
  *
  * @param oidStr [IN] The input OID struct
  *
  * @retval  oid, success
  * @retval  #BSL_CID_UNKNOWN, fail
  */
BslCid BSL_OBJ_GetCID(const BslOidString *oidStr);

/**
  * @ingroup bsl_obj
  * @brief To get the OID corresponding to a common CID.
  *
  * @param ulCID [IN] cid
  *
  * @retval  oid struct, success
  * @retval  NULL, fail
  */
...
/**
  * @ingroup bsl_obj
  * @brief To compare two BslOidString structures.
  *
  * @param pstDestOID [IN] The source oid structure
  * @param pstSrcOID [IN] The destination structure
  *
  * @retval  true, identical
  * @retval  false, distinct
  */
bool BSL_OBJ_CompareOid(const BslOidString *pstDestOID, const BslOidString *pstSrcOID);

/**
  * @ingroup bsl_obj
  * @brief To copy one BslOidString structure onto another.
  *
  * @param pstDestOID [IN] The source oid structure
  * @param pstSrcOID [IN] The destination oid structure
  *
  * @retval  #BSL_SUCCESS
  * @retval  #BSL_INVALID_ARG, invalid parameter.
  * @retval  #BSL_MALLOC_FAIL, memory allocation failed.
  */
int32_t BSL_OBJ_CpyOidOcts(BslOidString *pstDestOID, const BslOidString *pstSrcOID);

/**
  * @ingroup bsl_obj
  * @brief To set the private OID information which will be used in X509 certificates
  *
  * @param aPrvOidInfo [IN] private OID Info
    @param uiCount [IN] the number of private OID Info
  *
  * @retval  BSL_SUCCESS
  * @retval  BSL_INVALID_ARG
  * @retval  BSL_MALLOC_FAIL
  */
int32_t BSL_OBJ_NewPrivateOID(BslPrvOidInfo *aPrvOidInfo, uint32_t uiCount);


/**
 * @defgroup SEC_getPrivateOID
 * @ingroup asn_utilFunctions
 * @par Prototype
 * @code
 * SEC_INT32 SEC_getPrivateOID(void)
 * @endcode
 *
 * @par Purpose
 * To get the private OID information which had be used in X509 certificates
 *
 * @par Description
 * This function gets the private OID information which had be used in X509 certificates.
 *
 *
 * @retval The array of SEC_PRV_OID_INFO_S structures that has private OID data
 *
 * @par Dependency
 * asn-util.h
 *
...
/**
 * @ingroup bsl_obj
 * @brief get hash-id by signature-id
 *
 * @param signAlg [IN] signature-id
 *
 * @retval hash-id
 */
...
/**
 * @ingroup bsl_obj
 * @brief get asymmetric algorithm id by signature-id
 *
 * @param signAlg [IN] signature-id
 *
 * @retval asymmetric algorithm id
 */
BslCid BSL_OBJ_GetAsymAlgIdFromSignId(BslCid signAlg);

/**
 * @ingroup bsl_obj
 * @brief get signature-id by hash-id and asymmetric algorithm id
 *
 * @param asymAlg [IN] asymmetric algorithm id
 * @param hashAlg [IN] hash-id
 *
 * @retval signature-id
 */
...
/**
 * @ingroup bsl_obj
 * @brief get hash-id by hmac-id
 *
 * @param ulAlgType [IN] hmac-id
 *
 * @retval hashID
 */
