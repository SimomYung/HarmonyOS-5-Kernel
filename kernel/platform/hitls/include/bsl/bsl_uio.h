 ...
 * @ingroup bsl
 *
 * @brief   Set the callback function for releasing user data.
 * @details Free uio->userData at BSL_UIO_Free.
 * @param   uio   [IN] UIO object
 * @param   userDataFreeFunc  [IN] Callback function for releasing user data.
 * @retval  BSL_SUCCESS, success.
 * @retval  BSL_NULL_INPUT, invalid null pointer.
 */
 ...
 *
 * @attention Call BSL_UIO_Free to increase the value of reference counting by 1
 * @param   uio [IN] uio object
 *
