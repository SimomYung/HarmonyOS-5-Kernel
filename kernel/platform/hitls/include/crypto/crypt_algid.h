...
typedef enum {
    ...
    CRYPT_MAC_HMAC_MD5_SHA1 = BSL_CID_HMAC_MD5_SHA1,
    ...
    CRYPT_MAC_CMAC_TDES = BSL_CID_CMAC_TDES,
...
typedef enum {
    ...
    CRYPT_PKEY_WAPI_ECDSA = BSL_CID_ECDSA192WITHSHA256,
...
typedef enum {
    ...
    CRYPT_CIPHER_RC2_ECB = BSL_CID_RC2_ECB,
    CRYPT_CIPHER_RC2_CBC = BSL_CID_RC2_CBC,
    CRYPT_CIPHER_RC2_OFB = BSL_CID_RC2_OFB,
    CRYPT_CIPHER_RC2_CFB = BSL_CID_RC2_CFB,

    CRYPT_CIPHER_RC4 = BSL_CID_RC4,
    ...
    CRYPT_CIPHER_DES_ECB = BSL_CID_DES_ECB,
    CRYPT_CIPHER_DES_CBC = BSL_CID_DES_CBC,
    CRYPT_CIPHER_DES_OFB = BSL_CID_DES_OFB,
    CRYPT_CIPHER_DES_CFB = BSL_CID_DES_CFB,

    CRYPT_CIPHER_TDES_ECB = BSL_CID_DES_EDE3_ECB,
    CRYPT_CIPHER_TDES_CBC = BSL_CID_DES_EDE3_CBC,
    CRYPT_CIPHER_TDES_OFB = BSL_CID_DES_EDE3_OFB,
    CRYPT_CIPHER_TDES_CFB = BSL_CID_DES_EDE3_CFB,

    CRYPT_CIPHER_BF_ECB = BSL_CID_BF_ECB,
    CRYPT_CIPHER_BF_CBC = BSL_CID_BF_CBC,
...
typedef enum {
    ...
    CRYPT_ECC_SM9 = BSL_CID_ECC_SM9,
    CRYPT_ECC_192WAPI = BSL_CID_EC192WAPI,
