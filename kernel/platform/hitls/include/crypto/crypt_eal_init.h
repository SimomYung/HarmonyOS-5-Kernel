...
/*
These macros define bit positions of different options
For Example '0b0001' means CPU capability option and '0b0100' means RAND Initialization option.
Thus '0b0001 | 0b0100 = 0b0101 = 5' means CPU capability and BSL initialization option.
*/
