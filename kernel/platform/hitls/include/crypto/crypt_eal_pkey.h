...
/**
 * @ingroup crypt_eal_pkey
 * @brief   Initializes the context of the kem encapsulation algorithm.
 *
 * @param   pkey [IN] Key session
 *
 * @return  CRYPT_SUCCESS.
...
/**
 * @ingroup crypt_eal_pkey
 * @brief   Initializes the context of the kem decapsulation algorithm.
 *
 * @param   pkey [IN] Key session
 *
 * @return  CRYPT_SUCCESS.
...
/**
 * @ingroup crypt_eal_pkey
 * @brief   Encapsulation interface of the key kem.
 *
 * @param   pkey      [IN] Key session
 * @param   cipher     [OUT] Output ciphertext data.
 * @param   cipherLen  [OUT/IN] Input ciphertext data length.
 *
 * @param   sharekey   [OUT] Output shared key.
 * @param   shareLen   [OUT/IN] Shared data length.
 *
 * @return  CRYPT_SUCCESS.
 *          For other error codes see crypt_errno.h.
 */
...
/**
 * @ingroup crypt_eal_pkey
 * @brief   Decapsulation interface of the key kem.
 *
 * @param   pkey      [IN] Key session
 * @param   cipher     [IN] Input ciphertext data.
 * @param   cipherLen  [IN] Input ciphertext data length.
 *
 * @param   sharekey   [OUT] Output shared key.
 * @param   shareLen   [OUT/IN] Shared data length.
 *
