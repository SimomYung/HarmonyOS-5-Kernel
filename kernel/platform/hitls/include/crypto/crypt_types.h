...
typedef enum {
    ...
    CRYPT_CTRL_GET_ECC_PUB_X_BIN,       /**< Get the the bn of x of the ecc public key without padded bin. */
    CRYPT_CTRL_GET_ECC_PUB_Y_BIN,       /**< Get the the bn of y of the ecc public key without padded bin. */
} CRYPT_PkeyCtrl;
