/**
 * @defgroup    hitls_cert_type hitls_cert_type.h
 * @ingroup     tls
...
typedef enum {
    ...
    CERT_STORE_CTRL_SET_VERIFY_FLAGS,   /**< Set the certificate verification flags. (HITLS_X509_VERIFY_Flags) */
    CERT_CTRL_BUTT,
} HITLS_CERT_CtrlCmd;

typedef enum {
    HITLS_X509_VERIFY_FLAG_CHECK_PARTIAL_CHAIN = 0x00002000,
} HITLS_X509_VERIFY_Flags;
