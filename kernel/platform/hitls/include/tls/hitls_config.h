/**
 * @defgroup  hitls_config hitls_config.h
 * @ingroup   tls
...
typedef enum {
    ...
    HITLS_PSK_WITH_NULL_SHA256 = 0x00B0,
...
/**
 * @ingroup hitls_config
 * @brief Create SSL30 configuration items, including the default settings.
 *        The user can call the HITLS_CFG_SetXXX interface to modify the settings.
 * @attention   The default configuration is as follows:
    Version number: HITLS_VERSION_SSL30
    Algorithm suite: HITLS_DHE_RSA_WITH_AES_256_CBC_SHA, HITLS_DHE_RSA_WITH_AES_128_CBC_SHA,
    ...
    This API is a version-specific API. After the configuration context is created, the HITLS_SetVersion,
    HITLS_CFG_SetVersion, HITLS_SetVersionSupport, HITLS_CFG_SetVersionSupport, HITLS_SetMinProtoVersion, or
    HITLS_SetMaxProtoVersion interface cannot be used to set other supported versions.
    Currently, SSL3.0 cannot be negotiated due to insufficient security. Therefore, SSL3.0 is not recommended.
 * @retval  HITLS_Config, object pointer succeeded.
 * @retval  NULL, object application failed.
 * @see HITLS_CFG_FreeConfig
 */
HITLS_Config *HITLS_CFG_NewSSL30Config(void);

/**
 * @ingroup hitls_config
 * @brief Create TLS10 configuration items, including the default settings.
 *        The user can call the HITLS_CFG_SetXXX interface to modify the settings.
 * @attention The default configuration is as follows:
    Version number: HITLS_VERSION_TLS10
    Algorithm suite: HITLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA, HITLS_ECDHE_RSA_WITH_AES_256_CBC_SHA,
 ...
 * @see HITLS_CFG_FreeConfig
 */
HITLS_Config *HITLS_CFG_NewTLS10Config(void);

/**
 * @ingroup hitls_config
 * @brief   Create a TLS11 configuration item, including the default configuration.
 * The user can call the HITLS_CFG_SetXXX interface to modify the configuration.
 * @attention   The default configuration is as follows:
    Version number: HITLS_VERSION_TLS11
    Algorithm suite: HITLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA, HITLS_ECDHE_RSA_WITH_AES_256_CBC_SHA,
    HITLS_DHE_RSA_WITH_AES_256_CBC_SHA, HITLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA,
    HITLS_ECDHE_RSA_WITH_AES_128_CBC_SHA, HITLS_DHE_RSA_WITH_AES_128_CBC_SHA,
    HITLS_RSA_WITH_AES_256_CBC_SHA, HITLS_RSA_WITH_AES_128_CBC_SHA
 ...
 * @see HITLS_CFG_FreeConfig
 */
HITLS_Config *HITLS_CFG_NewTLS11Config(void);
 ...
 * @return  HITLS_CONTINUE_HANDHSAKE: successful. Other values are considered as failure.
 */
 ...
 * @retval  HITLS_SUCCESS, if successful.
 */
int32_t HITLS_CFG_GetDtlsCookieExchangeSupport(const HITLS_Config *config, uint8_t *isSupport);
...
/**
 * @ingroup hitls_config
 * @brief   Set whether to enable the miniaturization function. The function is disabled by default.
 *
 * @param   config [IN/OUT] TLS link configuration.
 * @param   isEnable [IN] Indicates whether to enable the miniaturization function.
 * 0 indicates that the miniaturization function is disabled.
 * Other values indicate that the miniaturization function is enabled.
 * @retval  HITLS_NULL_INPUT, the input parameter pointer is null.
 * @retval  HITLS_SUCCESS, if successful.
 */
int32_t HITLS_CFG_SetMiniaturizationSwitch(HITLS_Config *config, uint8_t isEnable);
