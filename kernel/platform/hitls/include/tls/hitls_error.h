/**
 * @defgroup    hitls_error hitls_error.h
 * @ingroup     tls
 * @copyright   Copyright (c) Huawei Technologies Co., Ltd. 2022-2022. All rights reserved.
 * @brief       Returned values of error codes of the TLS module
 */
...
/**
 * @ingroup tls_errno
 * @brief  The user needs to backout recovery in the scenario where the separation of bearer and control.
 */
#define HITLS_WANT_BACKEP 7
...
typedef enum {
    ...
    HITLS_CM_LINK_WARNING_ALERTED,                 /**< link sent warning alert. */
    ...
    HITLS_MSG_HANDLE_DERVIVE_PRE_MASTER_KEY_FAIL,  /**< Failed to generate the premaster key. */
    ...
    HITLS_MSG_HANDLE_NO_VERIFY_DATA,               /**< No parity data is found. */
    ...
    HITLS_MSG_HANDLE_EMPTY_SESSION_ID,              /**< Receives empty session ID */
    ...
    HITLS_MSG_HANDLE_UNSECURE_GROUP,                /**< Insecure support group. */
    HITLS_MSG_HANDLE_UNSECURE_SECBITS,              /**< Number of security bits of the insecure key */
    HITLS_MSG_HANDLE_RENEGOTIATION_FAIL,            /**< Renegotiation failure */
    HITLS_MSG_HANDLE_SESSION_ID_CTX_ILLEGAL,        /**< Session ID ctx mismatch */
    HITLS_MSG_HANDLE_ERR_GET_UNSIGNEDDATA,          /**< Failed to obtain the signature data */
    HITLS_MSG_HANDLE_VERIFY_DATA_FAIL,              /**< Failed to calculate the check data */
    ...
    HITLS_MSG_HANDLE_PSK_SESSION_INVALID_VERSION,   /**< TLS1.3 psk session version is incorrect */
    ...
    HITLS_MSG_HANDLE_UNSUPPORT_KX_MODE,             /**< TLS1.3 unsupported key exchange mode. */
    ...
    HITLS_PACK_CLIENT_RANDOM_ERR,                   /**< Failed to assemble client_random. */
    ...
    HITLS_PACK_CERTIFICATE_ERR,                     /**< Failed to assemble the certificate. */
    HITLS_PACK_SERVER_RANDOM_ERR,                   /**< Failed to assemble server_random. */
    ...
    HITLS_PARSE_KEY_SHARE_FAIL,                     /**< Failed to parse the keyshare. */
    ...
    HITLS_REC_NEED_CACHE,                          /**< REC requires cache. */
    ...
    HITLS_REC_ERR_ILLEGAL_LABEL,                   /**< Invalid label.  */
    ...
    HITLS_UIO_SET_USE_FAIL,                        /**< Failed to set the UIO object to the active state. */
    ...
    HITLS_CERT_KEY_CTRL_ERR_SET_VERIFY_FLAGS,
    ...
    HITLS_CERT_ERR_LOAD_CERT,                       /**< Failed to load the certificate. */
    HITLS_CERT_ERR_LOAD_KEY,                        /**< Failed to load the private key. */
    ...
    HITLS_CERT_ERR_CERT_CB,                         /**< Failed to invoke cert_cb. */
    ...
    HITLS_CRYPT_ERR_GEN_KEY_PAIR,                  /**< Failed to generate a key pair. */
    HITLS_CRYPT_ERR_GET_ENCAPS_KEY,                /**< Failed to get hybrid key public. */
    HITLS_CRYPT_ERR_GET_CIPHERTEXT,                /**< Failed to get hybrid key cipher text. */
    HITLS_CRYPT_ERR_ENCAPS,                        /**< Key-Encapsulation failure. */
    HITLS_CRYPT_ERR_DECAPS,                        /**< Key-Decapsulation failure. */
    ...
    HITLS_PTO_FAIL_START = 0x020F0001,             /**< PTO feature error code start bit. */
    HITLS_PTO_STATE_ERROR,                         /**< The current state cannot be operated. */
    HITLS_PTO_ERR_UIO_UNSET,                       /**< UIO unset. */
    HITLS_PTO_ERR_UIO_INAPPROPRIATE,               /**< Unsupported UIO type. */
    HITLS_PTO_NOT_ENABLE,                          /**< PTO feature not enabled. */
    HITLS_PTO_NEED_BACKUP,                         /**< The TLS context needs to be backed up. */
    HITLS_PTO_BACKUP_STATE_ERROR,                  /**< Backup is not allowed in the TLS state. */
    HITLS_PTO_ERR_BACKUP_IS_CLIENT_FLAG,           /**< Failed to back up the client Flag. */
    HITLS_PTO_ERR_BACKUP_NEGO_VERSION,             /**< Failed to back up the version. */
    HITLS_PTO_ERR_BACKUP_NEGO_CIPHER,              /**< Failed to back up the algorithm suite. */
    HITLS_PTO_ERR_BACKUP_IS_ETM_FLAG,              /**< Failed to back up the encrypt_then_mac flag. */
    HITLS_PTO_ERR_BACKUP_CLIENT_RANDDOM,           /**< Failed to back up the client random Number. */
    HITLS_PTO_ERR_BACKUP_SERVER_RANDDOM,           /**< Failed to back up random numbers on the server. */
    HITLS_PTO_ERR_BACKUP_MASTER_KEY,               /**< Failed to back up the master Key. */
    HITLS_PTO_ERR_BACKUP_VERIFY_DATA,              /**< Failed to back up the verification data. */
    HITLS_PTO_ERR_BACKUP_HANDSHAKE_MSG,            /**< Failed to back up handshake messages. */
    HITLS_PTO_ERR_BACKUP_HANDSHAKE_EXPECT_RECV_SEQ,/**< Failed to back up the receiving sequence number
                                                        of the handshake message. */
    HITLS_PTO_ERR_BACKUP_RECORD_WRITE_EPOCH,       /**< Failed to back up the epoch in the sending direction
                                                        of the record. */
    HITLS_PTO_ERR_BACKUP_RECORD_READ_EPOCH,        /**< Failed to back up the epoch in the receive direction
                                                        of the record. */
    HITLS_PTO_ERR_BACKUP_RECORD_WRITE_SEQ,         /**< Failed to back up the record sending sequence number. */
    HITLS_PTO_ERR_BACKUP_RECORD_READ_SEQ,          /**< Failed to back up the record receving sequence number. */
    HITLS_PTO_ERR_BACKUP_UIO_FD,                   /**< Failed to back up the UIO FD. */
    HITLS_PTO_ERR_BACKUP_GET_FD,                   /**< Failed to get the fd */
    HITLS_PTO_ERR_BACKUP_UIO_CTX,                  /**< Failed to back up the UIO and context. */
    HITLS_PTO_ERR_BACKUP_GET_PTO_LEN,              /**< Failed to back up the pto len*/
    HITLS_PTO_ERR_RESTORE_IS_CLIENT_FLAG,          /**< Failed to restore the client flag bit. */
    HITLS_PTO_ERR_RESTORE_NEGO_VERSION,            /**< Failed to restore the version. */
    HITLS_PTO_ERR_RESTORE_NEGO_CIPHER,             /**< Failed to restore the algorithm suite. */
    HITLS_PTO_ERR_RESTORE_IS_ETM_FLAG,             /**< Failed to restore the encrypt_then_mac flag. */
    HITLS_PTO_ERR_RESTORE_CLIENT_RANDDOM,          /**< Failed to restore the client random number. */
    HITLS_PTO_ERR_RESTORE_SERVER_RANDDOM,          /**< Failed to restore the server random number. */
    HITLS_PTO_ERR_RESTORE_MASTER_KEY,              /**< Failed to restore the master key. */
    HITLS_PTO_ERR_RESTORE_VERIFY_DATA,             /**< Failed to restore the check data. */
    HITLS_PTO_ERR_RESTORE_HANDSHAKE_MSG,           /**< Failed to restore the handshake message. */
    HITLS_PTO_ERR_RESTORE_HANDSHAKE_EXPECT_RECV_SEQ, /**< Failed to restore the receiving sequence number
                                                          of the handshake message. */
    HITLS_PTO_ERR_RESTORE_RECORD_WRITE_EPOCH,      /**< Fails to restore the epoch in the sending direction
                                                        of the record. */
    HITLS_PTO_ERR_RESTORE_RECORD_READ_EPOCH,       /**< Fails to restore the epoch in the receving direction
                                                        of the record. */
    HITLS_PTO_ERR_RESTORE_RECORD_WRITE_SEQ,        /**< Failed to restore the record sending sequence number. */
    HITLS_PTO_ERR_RESTORE_RECORD_READ_SEQ,         /**< Failed to restore the record receiving sequence number. */
    HITLS_PTO_ERR_RESTORE_UIO_FD,                  /**< Failed to restore the UIO FD. */
    HITLS_PTO_ERR_RESTORE_UIO_CTX,                 /**< Failed to restore the UIO data context. */
    HITLS_PTO_ERR_RESTORE_SET_FD,                  /**< Failed to restore set fd */
    HITLS_PTO_ERR_RESTORE_GET_PTO_LEN,             /**< Failed to restore the pto len */
    ...
    HITLS_TTO_FAIL_START = 0x02110001,             /**< TTO(TLS Traffic Offload) feature error code Start bit. */
    HITLS_TTO_NOT_PERMIT,                          /**< Unsupported the TTO feature in the current scenario. */
    HITLS_TTO_ERR_INVALID_FD,                      /**< Invalid fd. */
    HITLS_TTO_ERR_BACKUP_REC_IN_BUF,               /**< Failed to read the cache for backup records. */
    HITLS_TTO_ERR_BACKUP_REC_W_MAC_KEY,            /**< Failed to back up the MAC key in the sending direction. */
    HITLS_TTO_ERR_BACKUP_REC_R_MAC_KEY,            /**< Failed to back up the MAC key in the receiving direction */
    HITLS_TTO_ERR_BACKUP_REC_W_ENCRYPT_KEY,        /**< Failed to back up the encryption key
                                                        in the sending direction. */
    HITLS_TTO_ERR_BACKUP_REC_R_ENCRYPT_KEY,        /**< Failed to back up the encryption key
                                                        in the receiving direction. */
    HITLS_TTO_ERR_BACKUP_REC_W_IV,                 /**< Failed to back up the IV in the sending direction. */
    HITLS_TTO_ERR_BACKUP_REC_R_IV,                 /**< Failed to back up the IV in the receiving direction. */
    HITLS_TTO_ERR_BACKUP_APP_IN_BUF,               /**< Failed to read the cache of the backup APP. */
    HITLS_TTO_ERR_BACKUP_CLIENT_APP_TRAFFIC_SECRET,  /**< Failed to back up the TLS1.3 client APP traffic secret. */
    HITLS_TTO_ERR_BACKUP_SERVER_APP_TRAFFIC_SECRET,  /**< Failed to back up the TLS1.3 server APP traffic secret. */
    HITLS_TTO_ERR_RESTORE_REC_IN_BUF,              /**< Failed to restore the record read cache. */
    HITLS_TTO_ERR_RESTORE_REC_W_MAC_KEY,           /**< Failed to restore the MAC key in the sending direction. */
    HITLS_TTO_ERR_RESTORE_REC_R_MAC_KEY,           /**< Failed to restore the MAC key in the receive direction. */
    HITLS_TTO_ERR_RESTORE_REC_W_ENCRYPT_KEY,       /**< Failed to restore the encryption key
                                                        in the sending direction. */
    HITLS_TTO_ERR_RESTORE_REC_R_ENCRYPT_KEY,       /**< Failed to restore the encryption key
                                                        in the receiving direction. */
    HITLS_TTO_ERR_RESTORE_REC_W_IV,                /**< Failed to restore the IV in the sending direction. */
    HITLS_TTO_ERR_RESTORE_REC_R_IV,                /**< Failed to restore the IV in the receive direction. */
    HITLS_TTO_ERR_RESTORE_APP_IN_BUF,              /**< Failed to restore the APP read cache. */
    HITLS_TTO_ERR_RESTORE_CLIENT_APP_TRAFFIC_SECRET,  /**< Failed to restore the TLS1.3 client APP traffic secret */
    HITLS_TTO_ERR_RESTORE_SERVER_APP_TRAFFIC_SECRET,  /**< Failed to restore the TLS1.3 server APP traffic secret */
    HITLS_TTO_ERR_RESTORE_CCS_CTX,                 /**< Incorrect TLS CCS context restoration. */
    HITLS_TTO_ERR_RESTORE_HS_CTX,                  /**< Incorrect TLS HS context restoration. */
    HITLS_TTO_ERR_RESTORE_REC_CTX,                 /**< Incorrect TLS REC context restoration. */
    HITLS_TTO_ERR_RESTORE_APP_CTX,                 /**< Incorrect TLS APP context restoration. */
    HITLS_TTO_ERR_RESTORE_ESTABLISHED_REC_CTX,     /**< Incorrect TLS REC context after link establishment. */
    HITLS_TTO_ERR_GET_W_IV_LEN,                    /**< Failed to obtain the IV length in the sending direction. */
    HITLS_TTO_ERR_GEN_W_IV,                        /**< Failed to generate the IV in the sending direction. */
    HITLS_TTO_ERR_SET_W_IV,                        /**< Failed to set the IV in the sending direction. */
    HITLS_TTO_ERR_CMD_UNKNOWN,                     /**< cmd cannot be identified */
    HITLS_TTO_ERR_ASN_DECODE,                      /**< ASN decoding failure. */
    HITLS_TTO_ERR_IMPORT_TLS13_KEY,                /**< TLS1.3 secret Invalid length. */
 ...
 * @retval  HITLS_WANT_BACKEP, in the scenario where the bearer and control are separated,
