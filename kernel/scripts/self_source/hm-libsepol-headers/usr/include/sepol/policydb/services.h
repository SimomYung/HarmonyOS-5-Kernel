...
extern int context_compute_av_norbuf(context_struct_t * scontext,
...
extern int constraint_expr_eval(context_struct_t *scontext,
				context_struct_t *tcontext,
				context_struct_t *xcontext,
				sepol_security_class_t tclass,
				constraint_node_t *constraint);

extern int context_compute_xpermsd(context_struct_t * scontext,
				   context_struct_t * tcontext,
				   sepol_security_class_t tclass,
				   struct sepol_xperms_decision *xpermd);

extern void sepol_compute_xperms_drivers(struct sepol_xperms *xperms,
					 avtab_ptr_t node);
extern int services_compute_xpermd(struct sepol_xperms_decision *xpermd,
				   avtab_ptr_t node);
...
extern int mls_compute_sid_nohkip(const policydb_t *policydb,
