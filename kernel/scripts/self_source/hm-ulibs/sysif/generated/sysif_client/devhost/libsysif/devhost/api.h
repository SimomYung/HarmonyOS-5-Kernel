...
* Using command: ../recipe-sysroot-native/usr/bin/hm-dsl/hm-dsl sysif ../kernel/hongmeng/hm-verif-kernel/ulibs/include/libsysif/devhost/api.sysif -I ../kernel/hongmeng/hm-verif-kernel/ulibs/include --api-dest ../image/usr/include/generated/sysif_client/devhost/libsysif/devhost/api.h --server-dest ../image/usr/include/generated/sysif_server/devhost/libsysif/devhost/server.h --dump-callno ../image/usr/include/generated/dump_info/devhost/libsysif/devhost/l2h_map.h --legacy-mode
* Create: Fri Oct 31 10:38:31 2025
*/
...
struct devhost_mem_info {
	...
	unsigned long long hvgr_total_used;
};
...
raw_static_assert(sizeof(struct thermal_action_arg) <= 96,
                    drvcall_devhost_pm_thermal_action_arg_arg_is_too_large);
raw_static_assert(sizeof(struct hm_actv_buf) <= 96,
...
struct __actvret_drvcall_devhost_pm_thermal_action {
	int action_ret;
};
...
struct __actvret_drvcall_devhost_test_pac_fwcfi_fault_inject {
};
...
union __actvret_drvcall_devhost {
	...
	struct __actvret_drvcall_devhost_pm_thermal_action pm_thermal_action;
	...
	struct __actvret_drvcall_devhost_test_pac_fwcfi_fault_inject test_pac_fwcfi_fault_inject;
...
#define __devhost_method_pm_thermal_action (__ACTV_HIGHTABLE_START + 112)
...
#define __devhost_method_test_pac_fwcfi_fault_inject (__ACTV_HIGHTABLE_START + 182)
...
raw_static_assert(sizeof(struct __actvret_drvcall_devhost_pm_thermal_action) < 512,
            drvcall_devhost_pm_thermal_action_too_many_actvret_data);
...
raw_static_assert(sizeof(struct __actvret_drvcall_devhost_test_pac_fwcfi_fault_inject) < 512,
            drvcall_devhost_test_pac_fwcfi_fault_inject_too_many_actvret_data);
...
extern int __actvcall_drvcall_devhost_pm_thermal_action(unsigned long long __rpc_info, void *__buf, unsigned int action, struct thermal_action_arg arg);


extern int __actvcapcall_drvcall_devhost_pm_thermal_action(rref_t __rref, unsigned long long __rpc_info, void *__buf, unsigned int action, struct thermal_action_arg arg);


static inline int __attribute__((always_inline)) actvxactcall_drvcall_devhost_pm_thermal_action(bool is_xact_fwd, bool is_xact_allow_refwd, unsigned int action, struct thermal_action_arg arg, struct __actvret_drvcall_devhost_pm_thermal_action *__ret)
{
	const unsigned long __callno = __devhost_method_pm_thermal_action;
	int __res;
	unsigned long __stacksz = 0UL;
	struct __arch_actv_stksz_state __stksz_state;
	__stksz_state = __arch_actv_rpc_stksz_init(0, 0);
	__stksz_state = __arch_actv_rpc_stksz_append(__stksz_state, sizeof(unsigned int), __arch_actv_rpc_stksz_alignment(unsigned int));
	__stksz_state = __arch_actv_rpc_stksz_append(__stksz_state, sizeof(struct thermal_action_arg), __arch_actv_rpc_stksz_alignment(struct thermal_action_arg));
	__stacksz = __arch_actv_rpc_stksz_done(__stksz_state);
	do {
		unsigned long long rpc_info = __arch_actv_xact_rpc_info_gen(is_xact_fwd, is_xact_allow_refwd, __callno, sizeof(*__ret), __stacksz / sizeof(unsigned long));
		__res = __actvcall_drvcall_devhost_pm_thermal_action(rpc_info, __ret, action, arg);
	} while (__res == (int)E_HM_ACTIVATION_RPC_RETRY);
	return __res;
}

static inline int __attribute__((always_inline)) actvxactcapcall_drvcall_devhost_pm_thermal_action(bool is_xact_fwd, bool is_xact_allow_refwd, rref_t __rref, unsigned int action, struct thermal_action_arg arg, struct __actvret_drvcall_devhost_pm_thermal_action *__ret)
{
	const unsigned long __callno = __devhost_method_pm_thermal_action;
	int __res;
	unsigned long __stacksz = 0UL;
	...
	do {
		unsigned long long rpc_info = __arch_actv_xact_rpc_info_gen(is_xact_fwd, is_xact_allow_refwd, __callno, sizeof(*__ret), __stacksz / sizeof(unsigned long));
		__res = __actvcapcall_drvcall_devhost_pm_thermal_action(__rref, rpc_info, __ret, action, arg);
	} while (__res == (int)E_HM_ACTIVATION_RPC_RETRY);
	return __res;
}

static inline int __attribute__((always_inline)) actvcall_drvcall_devhost_pm_thermal_action(unsigned int action, struct thermal_action_arg arg, struct __actvret_drvcall_devhost_pm_thermal_action *__ret)
{
	return actvxactcall_drvcall_devhost_pm_thermal_action(false, false, action, arg, __ret);
}

static inline int __attribute__((always_inline)) actvcapcall_drvcall_devhost_pm_thermal_action(rref_t __rref, unsigned int action, struct thermal_action_arg arg, struct __actvret_drvcall_devhost_pm_thermal_action *__ret)
{
	return actvxactcapcall_drvcall_devhost_pm_thermal_action(false, false, __rref, action, arg, __ret);
}
...
extern int __actvcall_drvcall_devhost_test_pac_fwcfi_fault_inject(unsigned long long __rpc_info, void *__buf);


extern int __actvcapcall_drvcall_devhost_test_pac_fwcfi_fault_inject(rref_t __rref, unsigned long long __rpc_info, void *__buf);


static inline int __attribute__((always_inline)) actvxactcall_drvcall_devhost_test_pac_fwcfi_fault_inject(bool is_xact_fwd, bool is_xact_allow_refwd)
{
	const unsigned long __callno = __devhost_method_test_pac_fwcfi_fault_inject;
	int __res;
	unsigned long __stacksz = 0UL;
	struct __arch_actv_stksz_state __stksz_state;
	__stksz_state = __arch_actv_rpc_stksz_init(0, 0);
	...
	do {
		unsigned long long rpc_info = __arch_actv_xact_rpc_info_gen(is_xact_fwd, is_xact_allow_refwd, __callno, 0UL, __stacksz / sizeof(unsigned long));
		__res = __actvcall_drvcall_devhost_test_pac_fwcfi_fault_inject(rpc_info, NULL);
	} while (__res == (int)E_HM_ACTIVATION_RPC_RETRY);
	return __res;
}

static inline int __attribute__((always_inline)) actvxactcapcall_drvcall_devhost_test_pac_fwcfi_fault_inject(bool is_xact_fwd, bool is_xact_allow_refwd, rref_t __rref)
{
	const unsigned long __callno = __devhost_method_test_pac_fwcfi_fault_inject;
	int __res;
	unsigned long __stacksz = 0UL;
	...
	do {
		unsigned long long rpc_info = __arch_actv_xact_rpc_info_gen(is_xact_fwd, is_xact_allow_refwd, __callno, 0UL, __stacksz / sizeof(unsigned long));
		__res = __actvcapcall_drvcall_devhost_test_pac_fwcfi_fault_inject(__rref, rpc_info, NULL);
	} while (__res == (int)E_HM_ACTIVATION_RPC_RETRY);
	return __res;
}

static inline int __attribute__((always_inline)) actvcall_drvcall_devhost_test_pac_fwcfi_fault_inject(void)
{
	return actvxactcall_drvcall_devhost_test_pac_fwcfi_fault_inject(false, false);
}

static inline int __attribute__((always_inline)) actvcapcall_drvcall_devhost_test_pac_fwcfi_fault_inject(rref_t __rref)
{
	return actvxactcapcall_drvcall_devhost_test_pac_fwcfi_fault_inject(false, false, __rref);
}
...
static int __attribute__((alias("__internal_rpccall_retbuf"))) __internal_rpccall ____actvcall_drvcall_devhost_pm_thermal_action(unsigned long long rpc_info, void *__buf, ...);


static int __attribute__((alias("__internal_rpccapcall_retbuf"))) __internal_rpccapcall ____actvcapcall_drvcall_devhost_pm_thermal_action(rref_t __rref, unsigned long long rpc_info, void *__buf, ...);


int __internal_actvcall __actvcall_drvcall_devhost_pm_thermal_action(unsigned long long __rpc_info, void *__buf, unsigned int action, struct thermal_action_arg arg)
{
	int __ret;
	unsigned int __maybe_unused __actv_local_var_action = action;
	struct thermal_action_arg __maybe_unused __actv_local_var_arg = arg;
	__ret = ____actvcall_drvcall_devhost_pm_thermal_action(__rpc_info, __buf, __ARCH_ACTV_RPC_PASS_ARG(action, __actv_local_var_action), __ARCH_ACTV_RPC_PASS_ARG(arg, __actv_local_var_arg));
	return __ret;
}

int __internal_actvcall __actvcapcall_drvcall_devhost_pm_thermal_action(rref_t __rref, unsigned long long __rpc_info, void *__buf, unsigned int action, struct thermal_action_arg arg)
{
	int __ret;
	unsigned int __maybe_unused __actv_local_var_action = action;
	struct thermal_action_arg __maybe_unused __actv_local_var_arg = arg;
	__ret = ____actvcapcall_drvcall_devhost_pm_thermal_action(__rref, __rpc_info, __buf, __ARCH_ACTV_RPC_PASS_ARG(action, __actv_local_var_action), __ARCH_ACTV_RPC_PASS_ARG(arg, __actv_local_var_arg));
	return __ret;
}
...
static int __attribute__((alias("__internal_rpccall_nobuf"))) __internal_rpccall ____actvcall_drvcall_devhost_test_pac_fwcfi_fault_inject(unsigned long long rpc_info, void *__buf, ...);


static int __attribute__((alias("__internal_rpccapcall_nobuf"))) __internal_rpccapcall ____actvcapcall_drvcall_devhost_test_pac_fwcfi_fault_inject(rref_t __rref, unsigned long long rpc_info, void *__buf, ...);


int __internal_actvcall __actvcall_drvcall_devhost_test_pac_fwcfi_fault_inject(unsigned long long __rpc_info, void *__buf)
{
	int __ret;
	__ret = ____actvcall_drvcall_devhost_test_pac_fwcfi_fault_inject(__rpc_info, __buf);
	return __ret;
}

int __internal_actvcall __actvcapcall_drvcall_devhost_test_pac_fwcfi_fault_inject(rref_t __rref, unsigned long long __rpc_info, void *__buf)
{
	int __ret;
	__ret = ____actvcapcall_drvcall_devhost_test_pac_fwcfi_fault_inject(__rref, __rpc_info, __buf);
	return __ret;
}
