...
static int __attribute__((alias("__internal_rpccall_nobuf"))) __internal_rpccall ____actvcall_keycall_keymgr_krctl(unsigned long long rpc_info, void *__buf, ...);


static int __attribute__((alias("__internal_rpccapcall_nobuf"))) __internal_rpccapcall ____actvcapcall_keycall_keymgr_krctl(rref_t __rref, unsigned long long rpc_info, void *__buf, ...);


int __internal_actvcall __actvcall_keycall_keymgr_krctl(unsigned long long __rpc_info, void *__buf, int operation, void *keyring, unsigned long arg)
{
	int __ret;
	int __maybe_unused __actv_local_var_operation = operation;
	__maybe_unused void *__actv_local_var_keyring = keyring;
	unsigned long __maybe_unused __actv_local_var_arg = arg;
	__ret = ____actvcall_keycall_keymgr_krctl(__rpc_info, __buf, __ARCH_ACTV_RPC_PASS_ARG(operation, __actv_local_var_operation), __ARCH_ACTV_RPC_PASS_ARG(keyring, __actv_local_var_keyring), __ARCH_ACTV_RPC_PASS_ARG(arg, __actv_local_var_arg));
	return __ret;
}

int __internal_actvcall __actvcapcall_keycall_keymgr_krctl(rref_t __rref, unsigned long long __rpc_info, void *__buf, int operation, void *keyring, unsigned long arg)
{
	int __ret;
	int __maybe_unused __actv_local_var_operation = operation;
	__maybe_unused void *__actv_local_var_keyring = keyring;
	unsigned long __maybe_unused __actv_local_var_arg = arg;
	__ret = ____actvcapcall_keycall_keymgr_krctl(__rref, __rpc_info, __buf, __ARCH_ACTV_RPC_PASS_ARG(operation, __actv_local_var_operation), __ARCH_ACTV_RPC_PASS_ARG(keyring, __actv_local_var_keyring), __ARCH_ACTV_RPC_PASS_ARG(arg, __actv_local_var_arg));
	return __ret;
}
