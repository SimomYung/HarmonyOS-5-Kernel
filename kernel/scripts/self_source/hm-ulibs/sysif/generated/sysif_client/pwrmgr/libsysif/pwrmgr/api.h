...
static int __attribute__((alias("__internal_rpccall_nobuf"))) __internal_rpccall ____actvcall_pmcall_pac_cfi(unsigned long long rpc_info, void *__buf, ...);


static int __attribute__((alias("__internal_rpccapcall_nobuf"))) __internal_rpccapcall ____actvcapcall_pmcall_pac_cfi(rref_t __rref, unsigned long long rpc_info, void *__buf, ...);


int __internal_actvcall __actvcall_pmcall_pac_cfi(unsigned long long __rpc_info, void *__buf)
{
	int __ret;
	__ret = ____actvcall_pmcall_pac_cfi(__rpc_info, __buf);
	return __ret;
}

int __internal_actvcall __actvcapcall_pmcall_pac_cfi(rref_t __rref, unsigned long long __rpc_info, void *__buf)
{
	int __ret;
	__ret = ____actvcapcall_pmcall_pac_cfi(__rref, __rpc_info, __buf);
	return __ret;
}
