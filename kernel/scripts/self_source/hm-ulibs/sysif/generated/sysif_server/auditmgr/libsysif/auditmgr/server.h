...
* Using command: ../recipe-sysroot-native/usr/bin/hm-dsl/hm-dsl sysif ../kernel/hongmeng/hm-verif-kernel/ulibs/include/libsysif/auditmgr/api.sysif -I ../kernel/hongmeng/hm-verif-kernel/ulibs/include --api-dest ../image/usr/include/generated/sysif_client/auditmgr/libsysif/auditmgr/api.h --server-dest ../image/usr/include/generated/sysif_server/auditmgr/libsysif/auditmgr/server.h --dump-callno ../image/usr/include/generated/dump_info/auditmgr/libsysif/auditmgr/l2h_map.h --legacy-mode
...
__ro_after_init_hdlr union auditmgr_hdlrs_union sysif_auditmgr_actvhdlr_table[__auditmgr_method_MAX * __auditmgr_method_TIMES] = {
	...
	[__auditmgr_method_MAX ... __auditmgr_method_MAX + __auditmgr_method_MIN] = {
		.p_sysif_default_handler = (&sysif_actvhdlr_default_handler)
	},
...
__ro_after_init_hdlr union auditmgr_hdlrs_union sysif_auditmgr_actvhdlr_table[__auditmgr_method_MAX * __auditmgr_method_TIMES] = {
	...
	[2 * __auditmgr_method_MAX ... 2 * __auditmgr_method_MAX + __auditmgr_method_MIN] = {
		.p_sysif_default_handler = (&sysif_actvhdlr_default_handler)
	},
