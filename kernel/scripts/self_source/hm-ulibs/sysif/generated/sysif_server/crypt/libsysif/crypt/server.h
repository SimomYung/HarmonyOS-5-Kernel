...
* Using command: ../recipe-sysroot-native/usr/bin/hm-dsl/hm-dsl sysif ../ulibs/include/libhmsrv_crypt/sysif/api.sysif -I ../ulibs/include --api-dest ../image/usr/include/generated/sysif_client/crypt/libsysif/crypt/api.h --server-dest ../image/usr/include/generated/sysif_server/crypt/libsysif/crypt/server.h --dump-callno ../image/usr/include/generated/dump_info/crypt/libsysif/crypt/l2h_map.h --legacy-mode
...
#define __crypto_method_MAX (__ACTV_HIGHTABLE_START + 10)
...
__ro_after_init_hdlr union crypto_hdlrs_union sysif_crypto_actvhdlr_table[__crypto_method_MAX * __crypto_method_TIMES] = {
	...
	[__crypto_method_MAX ... __crypto_method_MAX + __ACTV_UPCALL_POOL_GRANT_CHANGE - 1U] = {
		.p_sysif_default_handler = (&sysif_actvhdlr_default_handler)
	},
	[__crypto_method_MAX + __ACTV_UPCALL_POOL_GRANT_CHANGE] = {
		.p_sysif_handle_kcall_entry = (&sysif_actv_pool_handle_grant_change)
	},
	[__crypto_method_MAX + __ACTV_UPCALL_POOL_GRANT_CHANGE + 1U ... __crypto_method_MAX + __crypto_method_MIN] = {
		.p_sysif_default_handler = (&sysif_actvhdlr_default_handler)
	},
...
__ro_after_init_hdlr union crypto_hdlrs_union sysif_crypto_actvhdlr_table[__crypto_method_MAX * __crypto_method_TIMES] = {
	...
	[2 * __crypto_method_MAX ... 2 * __crypto_method_MAX + __ACTV_UPCALL_POOL_GRANT_CHANGE - 1U] = {
		.p_sysif_default_handler = (&sysif_actvhdlr_default_handler)
	},
	[2 * __crypto_method_MAX + __ACTV_UPCALL_POOL_GRANT_CHANGE] = {
		.p_sysif_handle_kcall_entry = (&sysif_actv_pool_handle_grant_change)
	},
	[2 * __crypto_method_MAX + __ACTV_UPCALL_POOL_GRANT_CHANGE + 1U ... 2 * __crypto_method_MAX + __crypto_method_MIN] = {
		.p_sysif_default_handler = (&sysif_actvhdlr_default_handler)
	},
