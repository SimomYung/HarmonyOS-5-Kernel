...
__ro_after_init_hdlr union freqmgr_hdlrs_union sysif_freqmgr_actvhdlr_table[__freqmgr_method_MAX * __freqmgr_method_TIMES] = {
	...
	[__freqmgr_method_MAX ... __freqmgr_method_MAX + __ACTV_UPCALL_POOL_GRANT_CHANGE - 1U] = {
		.p_sysif_default_handler = (&sysif_actvhdlr_default_handler)
	},
	[__freqmgr_method_MAX + __ACTV_UPCALL_POOL_GRANT_CHANGE] = {
		.p_sysif_handle_kcall_entry = (&sysif_actv_pool_handle_grant_change)
	},
	[__freqmgr_method_MAX + __ACTV_UPCALL_POOL_GRANT_CHANGE + 1U ... __freqmgr_method_MAX + __freqmgr_method_MIN] = {
		.p_sysif_default_handler = (&sysif_actvhdlr_default_handler)
	},
...
__ro_after_init_hdlr union freqmgr_hdlrs_union sysif_freqmgr_actvhdlr_table[__freqmgr_method_MAX * __freqmgr_method_TIMES] = {
	...
	[2 * __freqmgr_method_MAX ... 2 * __freqmgr_method_MAX + __ACTV_UPCALL_POOL_GRANT_CHANGE - 1U] = {
		.p_sysif_default_handler = (&sysif_actvhdlr_default_handler)
	},
	[2 * __freqmgr_method_MAX + __ACTV_UPCALL_POOL_GRANT_CHANGE] = {
		.p_sysif_handle_kcall_entry = (&sysif_actv_pool_handle_grant_change)
	},
	[2 * __freqmgr_method_MAX + __ACTV_UPCALL_POOL_GRANT_CHANGE + 1U ... 2 * __freqmgr_method_MAX + __freqmgr_method_MIN] = {
		.p_sysif_default_handler = (&sysif_actvhdlr_default_handler)
	},
