...
* Using command: ../recipe-sysroot-native/usr/bin/hm-dsl/hm-dsl sysif ../fs/libtransfs/libsysif/api.sysif -I ../fs/libtransfs/libsysif --api-dest ../image/usr/include/generated/sysif_client/fs/libsysif/transfs/api.h --server-dest ../image/usr/include/generated/sysif_server/fs/libsysif/transfs/server.h --legacy-mode
* Create: Tue Sep 16 04:31:41 2025
*/
...
__ro_after_init_hdlr union fslt_hdlrs_union sysif_fslt_actvhdlr_table[__fslt_method_MAX * __fslt_method_TIMES] = {
	...
	[__ACTV_UPCALL_POOL_GRANT_CHANGE + 1U ... __fslt_method_MIN] = {
		.p_sysif_default_handler = (&sysif_actvhdlr_default_handler)
	},
...
__ro_after_init_hdlr union fslt_hdlrs_union sysif_fslt_actvhdlr_table[__fslt_method_MAX * __fslt_method_TIMES] = {
	...
	[__fslt_method_MAX ... __fslt_method_MAX + __ACTV_UPCALL_POOL_GRANT_CHANGE - 1U] = {
		.p_sysif_default_handler = (&sysif_actvhdlr_default_handler)
	},
	[__fslt_method_MAX + __ACTV_UPCALL_POOL_GRANT_CHANGE] = {
		.p_sysif_handle_kcall_entry = (&sysif_actv_pool_handle_grant_change)
	},
	[__fslt_method_MAX + __ACTV_UPCALL_POOL_GRANT_CHANGE + 1U ... __fslt_method_MAX + __fslt_method_MIN] = {
		.p_sysif_default_handler = (&sysif_actvhdlr_default_handler)
	},
...
__ro_after_init_hdlr union fslt_hdlrs_union sysif_fslt_actvhdlr_table[__fslt_method_MAX * __fslt_method_TIMES] = {
	...
	[2 * __fslt_method_MAX ... 2 * __fslt_method_MAX + __ACTV_UPCALL_POOL_GRANT_CHANGE - 1U] = {
		.p_sysif_default_handler = (&sysif_actvhdlr_default_handler)
	},
	[2 * __fslt_method_MAX + __ACTV_UPCALL_POOL_GRANT_CHANGE] = {
		.p_sysif_handle_kcall_entry = (&sysif_actv_pool_handle_grant_change)
	},
	[2 * __fslt_method_MAX + __ACTV_UPCALL_POOL_GRANT_CHANGE + 1U ... 2 * __fslt_method_MAX + __fslt_method_MIN] = {
		.p_sysif_default_handler = (&sysif_actvhdlr_default_handler)
	},
