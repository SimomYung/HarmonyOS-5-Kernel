...
__ro_after_init_hdlr union hguard_hdlrs_union sysif_hguard_actvhdlr_table[__hguard_method_MAX * __hguard_method_TIMES] = {
	...
	[__hguard_method_MAX ... __hguard_method_MAX + __ACTV_UPCALL_POOL_GRANT_CHANGE - 1U] = {
		.p_sysif_default_handler = (&sysif_actvhdlr_default_handler)
	},
	[__hguard_method_MAX + __ACTV_UPCALL_POOL_GRANT_CHANGE] = {
		.p_sysif_handle_kcall_entry = (&sysif_actv_pool_handle_grant_change)
	},
	[__hguard_method_MAX + __ACTV_UPCALL_POOL_GRANT_CHANGE + 1U ... __hguard_method_MAX + __hguard_method_MIN] = {
		.p_sysif_default_handler = (&sysif_actvhdlr_default_handler)
	},
...
__ro_after_init_hdlr union hguard_hdlrs_union sysif_hguard_actvhdlr_table[__hguard_method_MAX * __hguard_method_TIMES] = {
	...
	[2 * __hguard_method_MAX ... 2 * __hguard_method_MAX + __ACTV_UPCALL_POOL_GRANT_CHANGE - 1U] = {
		.p_sysif_default_handler = (&sysif_actvhdlr_default_handler)
	},
	[2 * __hguard_method_MAX + __ACTV_UPCALL_POOL_GRANT_CHANGE] = {
		.p_sysif_handle_kcall_entry = (&sysif_actv_pool_handle_grant_change)
	},
	[2 * __hguard_method_MAX + __ACTV_UPCALL_POOL_GRANT_CHANGE + 1U ... 2 * __hguard_method_MAX + __hguard_method_MIN] = {
		.p_sysif_default_handler = (&sysif_actvhdlr_default_handler)
	},
