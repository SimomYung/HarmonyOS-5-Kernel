...
__ro_after_init_hdlr union pwrmgr_hdlrs_union sysif_pwrmgr_actvhdlr_table[__pwrmgr_method_MAX * __pwrmgr_method_TIMES] = {
	...
	[__pwrmgr_method_MAX ... __pwrmgr_method_MAX + __ACTV_UPCALL_POOL_GRANT_CHANGE - 1U] = {
		.p_sysif_default_handler = (&sysif_actvhdlr_default_handler)
	},
	[__pwrmgr_method_MAX + __ACTV_UPCALL_POOL_GRANT_CHANGE] = {
		.p_sysif_handle_kcall_entry = (&sysif_actv_pool_handle_grant_change)
	},
	[__pwrmgr_method_MAX + __ACTV_UPCALL_POOL_GRANT_CHANGE + 1U ... __pwrmgr_method_MAX + __pwrmgr_method_MIN] = {
		.p_sysif_default_handler = (&sysif_actvhdlr_default_handler)
	},
...
__ro_after_init_hdlr union pwrmgr_hdlrs_union sysif_pwrmgr_actvhdlr_table[__pwrmgr_method_MAX * __pwrmgr_method_TIMES] = {
	...
	[2 * __pwrmgr_method_MAX ... 2 * __pwrmgr_method_MAX + __ACTV_UPCALL_POOL_GRANT_CHANGE - 1U] = {
		.p_sysif_default_handler = (&sysif_actvhdlr_default_handler)
	},
	[2 * __pwrmgr_method_MAX + __ACTV_UPCALL_POOL_GRANT_CHANGE] = {
		.p_sysif_handle_kcall_entry = (&sysif_actv_pool_handle_grant_change)
	},
	[2 * __pwrmgr_method_MAX + __ACTV_UPCALL_POOL_GRANT_CHANGE + 1U ... 2 * __pwrmgr_method_MAX + __pwrmgr_method_MIN] = {
		.p_sysif_default_handler = (&sysif_actvhdlr_default_handler)
	},
