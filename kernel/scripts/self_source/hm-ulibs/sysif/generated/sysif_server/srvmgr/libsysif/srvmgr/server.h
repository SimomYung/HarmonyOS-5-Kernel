...
* Using command: ../recipe-sysroot-native/usr/bin/hm-dsl/hm-dsl sysif ../kernel/hongmeng/hm-verif-kernel/ulibs/include/libsysif/srvmgr/api.sysif -I ../kernel/hongmeng/hm-verif-kernel/ulibs/include --api-dest ../image/usr/include/generated/sysif_client/srvmgr/libsysif/srvmgr/api.h --server-dest ../image/usr/include/generated/sysif_server/srvmgr/libsysif/srvmgr/server.h --dump-callno ../image/usr/include/generated/dump_info/srvmgr/libsysif/srvmgr/l2h_map.h --legacy-mode
...
__ro_after_init_hdlr union srvmgr_hdlrs_union sysif_srvmgr_actvhdlr_table[__srvmgr_method_MAX * __srvmgr_method_TIMES] = {
	...
	[__srvmgr_method_MAX ... __srvmgr_method_MAX + __srvmgr_method_MIN] = {
		.p_sysif_default_handler = (&sysif_actvhdlr_default_handler)
	},
...
__ro_after_init_hdlr union srvmgr_hdlrs_union sysif_srvmgr_actvhdlr_table[__srvmgr_method_MAX * __srvmgr_method_TIMES] = {
	...
	[2 * __srvmgr_method_MAX ... 2 * __srvmgr_method_MAX + __srvmgr_method_MIN] = {
		.p_sysif_default_handler = (&sysif_actvhdlr_default_handler)
	},
...
#endif
int __actvcall_srvcall_srvmgr_shutdown(unsigned long long __rpc_info, __maybe_unused void *__buf)
{
...
int __actvcapcall_srvcall_srvmgr_shutdown(rref_t __rref, unsigned long long __rpc_info, __maybe_unused void *__buf)
{
	UNUSED(__rref);
	unsigned long credential = __ACTV_CRED_SELFCALL;
	struct sysif_actv_selfcall selfcall = {
...
int __actvcall_srvcall_srvmgr_softreboot(unsigned long long __rpc_info, __maybe_unused void *__buf)
{
	unsigned long credential = __ACTV_CRED_SELFCALL;
	struct sysif_actv_selfcall selfcall = {
		NULL,
...
int __actvcapcall_srvcall_srvmgr_softreboot(rref_t __rref, unsigned long long __rpc_info, __maybe_unused void *__buf)
{
	UNUSED(__rref);
	unsigned long credential = __ACTV_CRED_SELFCALL;
	struct sysif_actv_selfcall selfcall = {
...
int __actvcall_srvcall_srvmgr_reboot(unsigned long long __rpc_info, __maybe_unused void *__buf, struct reboot_args args)
{
	unsigned long credential = __ACTV_CRED_SELFCALL;
	struct sysif_actv_selfcall selfcall = {
		NULL,
...
int __actvcapcall_srvcall_srvmgr_reboot(rref_t __rref, unsigned long long __rpc_info, __maybe_unused void *__buf, struct reboot_args args)
{
	UNUSED(__rref);
	unsigned long credential = __ACTV_CRED_SELFCALL;
	struct sysif_actv_selfcall selfcall = {
...
int __actvcall_srvcall_srvmgr_kexec(unsigned long long __rpc_info, __maybe_unused void *__buf)
{
	unsigned long credential = __ACTV_CRED_SELFCALL;
	struct sysif_actv_selfcall selfcall = {
		NULL,
...
int __actvcapcall_srvcall_srvmgr_kexec(rref_t __rref, unsigned long long __rpc_info, __maybe_unused void *__buf)
{
	UNUSED(__rref);
	unsigned long credential = __ACTV_CRED_SELFCALL;
	struct sysif_actv_selfcall selfcall = {
