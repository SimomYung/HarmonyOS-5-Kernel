...
//config:
//config:config FIX_CHATTR_ARR_OFFSET
//config:	bool "adjust the offset of e2attr_flags_sname_chattr"
//config:	default n
//config:	depends on CHATTR
//config:	help
//config:	The offset of e2attr_flags_sname_chattr may be adjusted,
//config:	due to changes in e2attr_flags_sname array.
//config:	The same for e2attr_flags_value_chattr.
