...
//config:
//config:config FIX_CRONTAB_BUG
//config:	bool "fix bug in crontab"
//config:	default n
//config:	depends on CRONTAB
//config:	help
//config:	solve problem in crontab, Add the processing of deletion failure.
