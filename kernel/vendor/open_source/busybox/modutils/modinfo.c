...
//kbuild:lib-$(CONFIG_FEATURE_MODINFO_SHOW_PKCS7_SIGNATURE) += modinfo-signature.o
...
#if ENABLE_FEATURE_MODINFO_SHOW_PKCS7_SIGNATURE
...
#if ENABLE_FEATURE_MODINFO_SHOW_PKCS7_SIGNATURE
	if (print_mod_sig_id(the_module, len) == FALSE)
		bb_perror_msg("module signature error");
#endif
