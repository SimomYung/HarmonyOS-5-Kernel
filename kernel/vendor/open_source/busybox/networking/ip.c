...
//config:
//config:config FEATURE_IP_SUPPORT_OLD_KERNEL
//config:	bool "ip support kernel 2.x"
//config:	default n
//config:	depends on FEATURE_IP_ADDRESS
//config:	help
//config:	2.x kernel header file has no definition of IFA_F_DADFAILED, If
//config:	you use the 2.x kernel, it is recommended to turn on this option.
