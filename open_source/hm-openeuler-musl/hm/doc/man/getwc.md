...
## Arguments 
- **stream**
The argument *stream* points to a input stream.

## Library
libc

## Description
The getwc() function obtains the next character from an input stream pointed to by *stream* and converts it to the corresponding wide-character code, then advances the associated file position indicator for the stream.
