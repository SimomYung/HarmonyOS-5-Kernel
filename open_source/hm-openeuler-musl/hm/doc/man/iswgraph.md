...
Check to see if the wide character is a graphic character
...
The iswgraph() function checks to see if the wide character is a graphic character.
...
- **non-zero**
  This wide character is a graphic character.
&nbsp;
- **0**
  This wide character is not a graphic character.
