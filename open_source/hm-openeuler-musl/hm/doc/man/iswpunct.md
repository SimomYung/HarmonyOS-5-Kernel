...
Check to see if the wide character is a punctuation or symbolic character
...
The iswpunct() function checks to see if the wide character is a punctuation or symbolic character.
...
- **non-zero**
  This wide character is a punctuation or symbolic character.
&nbsp;
- **0**
  This wide character is not a punctuation or symbolic character.
