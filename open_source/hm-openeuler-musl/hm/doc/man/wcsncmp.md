...
## Description
wcsncmp() checks the first *n* wide characters in *s1* and *s2* to see if they are equal or not. If they are equal then wcsncmp() returns 0. Otherwise a nonzero result is returned.
