...
/*
* By default, only three nameservers can be configured
* Improved MAXNS to support more nameserver.
* Enables users to configure more private servers to query private domain names.
*/
#define RTOS_MAXNS 12

#if defined(RTOS_MAXNS) && RTOS_MAXNS > 0 && RTOS_MAXNS <= 12
#define MAXNS			RTOS_MAXNS
#else
#define MAXNS			3
#endif
