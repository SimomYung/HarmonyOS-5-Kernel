...
__ro_after_init_hdlr union keymgr_hdlrs_union sysif_keymgr_actvhdlr_table[__keymgr_method_MAX * __keymgr_method_TIMES] = {
	...
	[__keymgr_method_MAX ... __keymgr_method_MAX + __ACTV_UPCALL_POOL_GRANT_CHANGE - 1U] = {
		.p_sysif_default_handler = (&sysif_actvhdlr_default_handler)
	},
	[__keymgr_method_MAX + __ACTV_UPCALL_POOL_GRANT_CHANGE] = {
		.p_sysif_handle_kcall_entry = (&sysif_actv_pool_handle_grant_change)
	},
	[__keymgr_method_MAX + __ACTV_UPCALL_POOL_GRANT_CHANGE + 1U ... __keymgr_method_MAX + __keymgr_method_MIN] = {
		.p_sysif_default_handler = (&sysif_actvhdlr_default_handler)
	},
...
__ro_after_init_hdlr union keymgr_hdlrs_union sysif_keymgr_actvhdlr_table[__keymgr_method_MAX * __keymgr_method_TIMES] = {
	...
	[2 * __keymgr_method_MAX ... 2 * __keymgr_method_MAX + __ACTV_UPCALL_POOL_GRANT_CHANGE - 1U] = {
		.p_sysif_default_handler = (&sysif_actvhdlr_default_handler)
	},
	[2 * __keymgr_method_MAX + __ACTV_UPCALL_POOL_GRANT_CHANGE] = {
		.p_sysif_handle_kcall_entry = (&sysif_actv_pool_handle_grant_change)
	},
	[2 * __keymgr_method_MAX + __ACTV_UPCALL_POOL_GRANT_CHANGE + 1U ... 2 * __keymgr_method_MAX + __keymgr_method_MIN] = {
		.p_sysif_default_handler = (&sysif_actvhdlr_default_handler)
	},
...
#endif
int __actvcall_keycall_keymgr_fscrypt_ctrl(unsigned long long __rpc_info, void *__buf, int operation, unsigned long arg_addr, unsigned long arg_size)
{
...
int __actvcapcall_keycall_keymgr_fscrypt_ctrl(rref_t __rref, unsigned long long __rpc_info, void *__buf, int operation, unsigned long arg_addr, unsigned long arg_size)
{
	UNUSED(__rref);
	unsigned long credential = __ACTV_CRED_SELFCALL;
	struct sysif_actv_selfcall selfcall = {
...
int __actvcall_keycall_keymgr_fsverity_ctrl(unsigned long long __rpc_info, void *__buf, int operation, unsigned long arg_addr, unsigned long arg_size)
{
	unsigned long credential = __ACTV_CRED_SELFCALL;
	struct sysif_actv_selfcall selfcall = {
		NULL,
...
int __actvcapcall_keycall_keymgr_fsverity_ctrl(rref_t __rref, unsigned long long __rpc_info, void *__buf, int operation, unsigned long arg_addr, unsigned long arg_size)
{
	UNUSED(__rref);
	unsigned long credential = __ACTV_CRED_SELFCALL;
	struct sysif_actv_selfcall selfcall = {
...
int __actvcall_keycall_keymgr_procfs_read(unsigned long long __rpc_info, void *__buf, int file_id, char *ubuf, unsigned long len)
{
	unsigned long credential = __ACTV_CRED_SELFCALL;
	struct sysif_actv_selfcall selfcall = {
		NULL,
...
int __actvcapcall_keycall_keymgr_procfs_read(rref_t __rref, unsigned long long __rpc_info, void *__buf, int file_id, char *ubuf, unsigned long len)
{
	UNUSED(__rref);
	unsigned long credential = __ACTV_CRED_SELFCALL;
	struct sysif_actv_selfcall selfcall = {
...
int __actvcall_keycall_keymgr_procfs_write(unsigned long long __rpc_info, void *__buf, int file_id, const char *ubuf, unsigned long len)
{
	unsigned long credential = __ACTV_CRED_SELFCALL;
	struct sysif_actv_selfcall selfcall = {
		NULL,
...
int __actvcapcall_keycall_keymgr_procfs_write(rref_t __rref, unsigned long long __rpc_info, void *__buf, int file_id, const char *ubuf, unsigned long len)
{
	UNUSED(__rref);
	unsigned long credential = __ACTV_CRED_SELFCALL;
	struct sysif_actv_selfcall selfcall = {
