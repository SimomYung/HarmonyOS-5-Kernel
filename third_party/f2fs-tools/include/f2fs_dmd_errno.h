...
#ifndef __F2FS_DMD_ERRNO_H__
#define __F2FS_DMD_ERRNO_H__
#ifdef __cplusplus
extern "C" {
#endif
...
/* record_fsync_data error */
#define PR_RECORD_FSYNC_DATA_ERROR			0x38
...
#define PR_VALID_BLOCK_COUNT_MISMATCH_WITH_CP       0X42

#define PR_VALID_NODE_COUNT_MISMATCH_WITH_CP_DE     0X43

#define PR_VALID_NODE_COUNT_MISMATCH_WITH_CP_NAT   0x44

#define PR_VALID_INODE_COUNT_MISMATCH_WITH_CP   0x45

#define PR_SEGMENT_COUNT_MISMATCH_WITH_CP       0x46

#define PR_NEXT_BLOCK_OFFSET_FREE       0X47

#define PR_OTHER_CORRUPT                0x48

#define PR_EXTRA_NEED_FSCK_FLAG_SET     0x49

#define PR_FSCK_TIME_OVERCOST           0x50
