...
#include "../tools/hmfs_tools/hmfs_tools.h"
...
#define HMFS_LARGE_NAT_BITMAP_MIN_SIZE 512 /* HMFS min GB when enable large nat bimtap */
#define HMFS_MIN_COMPRESS_LOG_SIZE 3
