...
static void mkfs_usage()
{
	...
	MSG(0, "  -k make HMFS file system(default f2fs)\n");
	MSG(0, "  -l label\n");
	MSG(0, "  -U uuid\n");
...
{
	static const char *option_string = "qa:c:C:d:e:E:g:hikl:mo:O:rR:s:S:z:t:T:U:Vfw:";
...
int main(int argc, char *argv[])
{
	...
	if (total_size > HMFS_LARGE_NAT_BITMAP_MIN_SIZE) {
		c.large_nat_bitmap = 1;
	}
