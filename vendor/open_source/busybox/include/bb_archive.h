...
#define XATTR_HMMAC_KEY "security.hmmac"
#define XATTR_CAP_KEY "security.capability"
	/* Currently processed file's hmmac and capability value */
	char *tar__hmmac_val;
	size_t tar__hmmac_len;
	char *tar__cap_val;
	size_t tar__cap_len;
#endif
} archive_handle_t;
