...
//usage:       "[-d DELAY] [-nf]" IF_FEATURE_SUPPORT_KEXEC(" [--kexec]")
//usage:#define reboot_full_usage "\n\n"
//usage:       "Reboot the system\n"
//usage:     "\n	-d SEC	Delay interval"
//usage:     "\n	-n	Do not sync"
//usage:     "\n	-f	Force (don't go through init)"
//usage:	IF_FEATURE_SUPPORT_KEXEC(
//usage:     "\n	--kexec	Reboot through kexec, ignored when -f is specified"
//usage:	)
...
int halt_main(int argc UNUSED_PARAM, char **argv)
{
	 ...
	 */
#if ENABLE_FEATURE_SUPPORT_KEXEC
	flags = getopt32long(argv, "d:+nfwi",
		"kexec\0"	No_argument		"\xff"
	, &delay);
#else
