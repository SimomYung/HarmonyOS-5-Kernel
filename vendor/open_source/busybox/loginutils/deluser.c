...
//config:
//config:config FEATURE_DELUSER_BUGFIX_ERR_PRINT
//config:	bool "fix deluser error print"
//config:	default n
//config:	depends on DELUSER
//config:	help
//config:	fix deluser error print (deluser: can't find user in/etc/group)
