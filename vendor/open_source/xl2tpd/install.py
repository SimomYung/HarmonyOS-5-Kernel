...
def do_patch(args, target_dir):
    patch_file = [
        "0001-modify-xl2tpd-for-system-vpn.patch",
...
def main():
    xl2tpd_path = argparse.ArgumentParser()
    xl2tpd_path.add_argument('--gen-dir', help='generate path of xl2tpd')
    xl2tpd_path.add_argument('--source-file', help='xl2tpd source dir')
    args = xl2tpd_path.parse_args()
    cp_dir = args.gen_dir
    copy_file(args.source_file, cp_dir)

    patch_dir = os.path.join(args.gen_dir, "xl2tpd")
